...
pbf.readFields(function (tag, result) {});
pbf.readFields(function (tag, result, pbf) {});
pbf.readFields(function (tag) {}, {}, 1);
pbf.readMessage(function (tag) {});
pbf.readMessage(function (tag, result) {});
pbf.readMessage(function (tag, result, pbf) {});
pbf.readFixed32();
pbf.readSFixed32();
pbf.readFixed64();
pbf.readSFixed64();        
...
pbf.writeRawMessage(function (obj) {});
pbf.writeRawMessage(function (obj, pbf) {});
pbf.writeRawMessage(function (obj) {}, {});
pbf.writeMessage(1, function (obj) {});
pbf.writeMessage(1, function (obj, pbf) {});
pbf.writeMessage(1, function (obj) {}, {});
