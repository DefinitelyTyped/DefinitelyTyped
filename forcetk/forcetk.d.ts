...
declare module forcetk {
    ...
    export class Client {
         ...
         */
        refreshAccessToken(callback: Function, error: Function): XMLHttpRequest
         ...
         */
        ajax(path: string, callback: Function, error?: Function, method?: string, payload?: {}, retry?: boolean): XMLHttpRequest
         ...
         **/
        getChatterFile(path: string, mimetype: string, callback: Function, error?: Function, retry?: boolean): void
         ...
         */
        apexrest(path: string, callback: Function, error?: Function, method?: string, payload?: {}, paramMap?: {}, retry?: boolean): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        versions(callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        resources(callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        describeGlobal(callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        metadata(objtype: string, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        describe(objtype: string, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        create(objtype: string, fields: {}, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        retrieve(objtype: string, id: string, fieldlist: string, callback: Function, error?: Function): void    // XXX
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        upsert(objtype: string, externalIdField: string, externalId: string, fields: {}, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        update(objtype: string, id: string, fields: {}, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        del(objtype: string, id: string, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        query(soql: string, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        queryMore(url: string, callback: Function, error?: Function): XMLHttpRequest
         ...
         * @param [error=null] function to which jqXHR will be passed in case of error
         */
        search(sosl: string, callback: Function, error?: Function): XMLHttpRequest
