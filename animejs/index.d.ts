...
declare namespace anime {
	...
	interface AnimeAnimParams {
		...
		easing ?: EasingsEnum | string | number[];
	...
	function remove (targets : AnimeTarget | AnimeTarget[] ) : void;
	...
	// Timeline
	function timeline (params ?: AnimeInstanceParams | AnimeInstance[]) : AnimeTimelineInstance;
