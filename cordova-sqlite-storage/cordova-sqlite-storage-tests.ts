///<reference path="cordova-sqlite-storage.d.ts"/>
...
function singleStatementTransactions() {
    var db: SQLitePlugin.Database;
...
function asynchronousTransaction() {
    var db: SQLitePlugin.Database;
