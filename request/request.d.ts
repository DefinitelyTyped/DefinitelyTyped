...
{
    init(uri:string, options?:request.Options, callback?:(error:any, response:any, body:any) => void): request.Request;
    init(uri:string, callback?:(error:any, response:any, body:any) => void): request.Request;
    init(options:request.Options, callback?:(error:any, response:any, body:any) => void): request.Request;
}

declare var request:RequestStatic;