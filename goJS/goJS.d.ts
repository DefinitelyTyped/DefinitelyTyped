...
// Definitions by: Barbara Duckworth <https://github.com/barbara42/> and Simon Sarris Barbara Duckworth <https://github.com/simonsarris/>
...
declare module go {
    ...
    */
    class Overview extends Diagram {
        ...
        box: Part;
        /**Gets pr sets whether this overview draws the temporary layers of the observed Diagram.*/
    ...
    */
    class TextBlock extends GraphObject {
        ...
        errorFunction: (tool: TextEditingTool, oldst: string, newstr: string) => void;
    ...
    */
    class Rect {
        ...
        /**
         * This constructor produces a new Rect that covers the two given Points.
         */
        constructor(p1: Point, p2: Point);
        /**
         * This constructor produces a new Rect that is positioned at the given Point p
         * and has a width and height given by the Size s.
         */
    ...
    */
    class Binding {
        ...
        * use an empty string to refer to the root panel of that visual tree.*/
        ...
        static parseEnum(ctor: () => Object, defval: EnumValue): (a: string) => EnumValue;
