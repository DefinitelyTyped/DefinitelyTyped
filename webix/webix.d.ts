...
function $$(id: string|Event|HTMLElement):webix.ui.view;
...
interface i18n{
	...
	parseTimeFormatDate(date:string):void;
	parseTimeFormatStr(date:any):void;
...
interface TreeStore{
	add(obj:any, index:number, pid:string):string;
	changeId(old:string, newid:string):void;
	clearAll():void;
	count():number;
