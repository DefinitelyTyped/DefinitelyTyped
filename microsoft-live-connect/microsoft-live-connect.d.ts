...
declare module Microsoft.Live {
    ...
    interface IEvent {
         ...
         * values are:
         * - public葉he event is visible to anyone who can view the calendar.
         * - private"葉he event is visible only to the event owner.
         * @default "public"
         */
        visibility: string;
    }
    ...
    interface IImageInfo {
         ...
         * full (maximum size: 2048 ﾗ 2048 pixels)
         * - normal (maximum size 800 ﾗ 800 pixels)
         * - album (maximum size 176 ﾗ 176 pixels)
         * - small (maximum size 96 ﾗ 96 pixels)
         */
        type: string;
    }
