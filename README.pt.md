...
Se você está usando as versões 2.0 a 2.9 do TypeScript, você ainda mode tentar instalar os pacotes `@types` &mdash; a maioria dos pacotes não usam as novas funcionalidades chiques do TypeScript.
