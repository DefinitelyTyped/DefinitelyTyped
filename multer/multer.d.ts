...
declare module "multer" {
    ...
    module multer {
        ...
        type Options = {
            ...
            onFileUploadStart?: (file: MulterFile, req: Express.Request, res: Express.Response) => void;
            ...
            onFileUploadData?: (file: MulterFile, data: Buffer, req: Express.Request, res: Express.Response) => void;
            /** Event handler trigger when a file is completely uploaded. A file object is available to the function. */
            onFileUploadComplete?: (file: MulterFile, req: Express.Request, res: Express.Response) => void;
            ...
            onFileSizeLimit?: (file: MulterFile) => void;
