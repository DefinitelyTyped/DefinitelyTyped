...
declare namespace Highmaps {
    ...
    interface AxisOptions {
        ...
        breaks?: AxisBreak[];
        /**
         * If categories are present for the xAxis, names are used instead of numbers for that axis. Since Highmaps 3.0,
        ...
        events?: {
             ...
             * information based on jQuery or MooTools depending on which library is used as the base for Highmaps.
             *
        ...
        maxPadding?: number;
        /**
         * Renamed to minRange as of Highmaps 2.2.
         * @deprecated
         */
        maxZoom?: number;
        /**
         ...
         *
         * If the tickInterval is too dense for labels to be drawn, Highmaps may remove ticks.
         */
        tickInterval?: number;
        /**
    ...
    interface ChartEvents {
         ...
         * library is used as the base for Highmaps. Through event.options you can access the series options that was
         ...
         * event information based on jQuery or MooTools depending on which library is used as the base for Highmaps.
         *
         ...
         *
         * click: function(e) {
         *      console.log(Highmaps.dateFormat('%Y-%m-%d %H:%M:%S', e.xAxis[0].value), e.yAxis[0].value);
         * }
         *
         * The this keyword refers to the Chart object.
         * @since 1.2.0
         ...
         * event information based on jQuery or MooTools depending on which library is used as the base for Highmaps.
         *
         * From version 2.0.4, there is also a second parameter to Highmaps.Chart where a callback function can be passed
         ...
         * depending on which library is used as the base for Highmaps. The default action for the selection event is to
         ...
         *      console.log(
         *          Highmaps.dateFormat('%Y-%m-%d %H:%M:%S', event.xAxis[0].min),
         *          Highmaps.dateFormat('%Y-%m-%d %H:%M:%S', event.xAxis[0].max)
         *      );
     ...
     *
     * Please note that the default way of adding data in Highmaps, without the need of a module, is through the
     * series.data option.
     */
    ...
    interface ExportingContextButton extends Button {
        ...
        onclick?: () => void;
        /**
         * The symbol for the button. Points to a definition function in the Highmaps.Renderer.symbols collection. The
    ...
    interface ExportingOptions {
        ...
        formAttributes?: any;
        /**
         * Path where Highmaps will look for export module dependencies to load on demand if they don't already exist on
        ...
        url?: string;
        /**
         * The pixel width of charts exported to PNG or JPG. As of Highmaps 3.0, the default pixel width is a function of
    ...
    interface GlobalObject {
        ...
        /**
         * Whether to use UTC time for axis scaling, tickmark placement and time display in Highmaps.dateFormat.
    ...
    interface LangObject {
        ...
        /**
         * The default decimal point used in the Highmaps.numberFormat method unless otherwise specified in the function
         * arguments.
         * @default '.'
         * @since 1.2.2
         */
        ...
        loading?: string;
        /**
         * An array containing the months names. Corresponds to the %B format in Highmaps.dateFormat().
        ...
        shortMonths?: string[];
        /**
         * The default thousands separator used in the Highmaps.numberFormat method unless otherwise specified in the
         * function arguments. Since Highmaps 4.1 it defaults to a single space character, which is compatible with ISO
    ...
    interface PlotEvents {
         ...
         * for Highmaps. The default action is to toggle the visibility of the series. This can be prevented by returning
         ...
         * event information based on jQuery or MooTools depending on which library is used as the base for Highmaps. If
    ...
    interface Marker extends MarkerState {
         ...
         *
         * Custom callbacks for symbol path generation can also be added to Highmaps.SVGRenderer.prototype.symbols. The
    ...
    interface PointEvents {
         ...
         * This contains common event information based on jQuery or MooTools depending on which library is used as the base for Highmaps.
    ...
    interface Halo {
        ...
        attributes?: {};
        /**
         * Opacity for the halo unless a specific fill is overridden using the attributes setting. Note that Highmaps is
    ...
    interface SeriesChart {
         ...
         *
         * Since Highmaps 4.1, it can be combined with pointIntervalUnit to draw irregular intervals.
         * @default 1
         */
         ...
         *
         * Since Highmaps 3.0.2, the point placement can also be numeric, where 0 is on the axis value, -0.5 is between
    ...
    /**
     * The heatmap series type. This series type is available both in Highmaps and Highmaps.
    ...
    interface PieChart extends SeriesChart {
         ...
         * point were null.
         *
         * The default value changed from false to true with Highmaps 3.0.
         *
         * @default true
         * @since 2.3.0
         */
         ...
         *
         * Note: in Highmaps < 4.1.2, the percentage was relative to the plot area, not the pie size.
         * @default 0
         * @since 2.0
         */
    ...
    interface TooltipOptions extends SeriesTooltipOptions {
        ...
        shadow?: boolean;
        /**
         * The name of a symbol to use for the border around the tooltip. In Highmaps 3.x and less, the shape was square.
         * @default 'callout'
         * @since 4.0
         */
        shape?: string;
         ...
         * mouse-powered devices and 25 for touch devices. Note that since Highmaps 4.1 the whole plot area by default
    ...
    interface GlobalOptions extends Options {
         ...
         * Highmaps.setOptions to set it before any chart is initiated.
         */
        lang?: LangObject;
    }
     ...
     * object is returned when a chart is created using the Highmaps.Chart() constructor:
     * var chart1 = new Highmaps.Chart(options);
     */
    ...
    interface Chart {
         ...
         * This is the constructor for creating a new chart object.
         * @param {Options} options The chart options
         * @param callback A function to execute when the chart object is finished loading and rendering. In most cases the chart is built in one thread, but in Internet Explorer version 8 or less the chart is sometimes initiated before the document is ready, and in these cases the chart object will not be finished directly after callingnew Highmaps.Chart(). As a consequence, code that relies on the newly built Chart object should always run in the callback. Defining a chart.event.load handler is equivalent.
         * @return {ChartObject}
         */
    ...
    interface ElementObject {
         ...
         * specific to Highmaps, like zIndex and rotation.
         *
         ...
         *
         * Attributes frequently used in Highmaps are fill, stroke, stroke-width.
    ...
    /**
     * Allows direct access to the Highmaps rendering layer in order to draw primitive shapes like circles,
     ...
     * use var renderer = new Highmaps.Renderer(parentNode, width, height); where parentNode is the HTML element where you
     * want to add it.
     *
    ...
    interface RendererObject {
        ...
        /**
         * Draw a label, which is an extended text element with support for border and background. Highmaps creates a g
    ...
    interface Static {
        ...
        /**
         * As Highmaps.Chart, but without need for the new keyword.
         * @since 4.2.0
         */
         ...
         * Highmaps.dateFormats hook, see below.
    ...
    interface PointObject {
         ...
         * @param [boolean] accumulate When true, the selection is added to other selected points. When false, other selected points are deselected. Internally in Highmaps,selected points are accumulated on Control, Shift or Cmd clicking the point.
         * @since 1.2.0
         */
        ...
        series: SeriesObject;
        /**
         * Slice out or set back in a pie chart slice. This is the default way of Highmaps to visualize that a pie point
         * is selected.
    ...
    interface SeriesObject {
         ...
         * @param [boolean] updatePoints - When the updated data is the same length as the existing data, points will be updated instead of replace. This option prevents this, and makes setData behave like it did prior to Highmaps 3.0.10.
         * @since 1.2.0
         */
...
declare var Highmaps: Highmaps.Static;
export = Highmaps;
