...
declare class Mechanism extends HandleObject {
...
declare class Collection<T extends HandleObject> {
...
declare class Slot extends HandleObject implements ISlotInfo {
    slotDescription: string;
    manufacturerID: string;
    flags: number;
    hardwareVersion: IVersion;
...
declare class Module extends BaseObject implements IModuleInfo {
    libFile: string;
    libName: string;
    /**
...
declare class EcdhParams implements IParams {
    /**
...
declare class AesCbcParams implements IParams {
    /**
