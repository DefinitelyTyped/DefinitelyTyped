 ...
 * @template T
 */
interface Collection<T extends BaseObject> extends BaseObject {
...
type SessionObjectCollection = Collection<SessionObject>
    type MechanismCollection = Collection<Mechanism>;
type SlotCollection = Collection<Slot>;
...
export interface Mechanism extends BaseObject {
    /**
...
declare class Module implements BaseObject {
    libFile: string;
    libName: string;
    /**
