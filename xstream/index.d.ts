...
export class MemoryStream<T> {
    ...
    static combine<U>(...args: MemoryStream<U>[]): MemoryStream<U>;
    ...
    static merge<U>(...args: MemoryStream<U>[]): MemoryStream<U>;
...
export class Stream<T> {
    ...
    static combine<U>(...args: Stream<U>[]): Stream<U>;
    ...
    static merge<U>(...args: Stream<U>[]): Stream<U>;
