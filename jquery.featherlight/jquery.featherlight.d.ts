// Type definitions for jQuery Featherlight v1.3.4
...
declare module JQueryFeatherlight {
	interface Config {
		namespace?: string;
		targetAttr?: string;
		variant?: string;
...
interface JQueryStatic {
	featherlight: JQueryFeatherlight.FeatherlightStatic;
}

interface JQuery {
	featherlight: JQueryFeatherlight.JQueryExtension;
}
