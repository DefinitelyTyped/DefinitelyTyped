// Type definitions for JQuery DataTables 1.10.11
...
// - Not all plugins and extension definitions are not typed.
...
declare module DataTables {
    ...
    export interface Settings {
        ...
        */
        ...
        /**
        * This option provides the ability to have a Buttons instance created automatically when a new DataTable is created. You need teh Buttons plug-in
        */
        buttons?: ButtonsSettings | Array<string | ButtonsButtonsSettings>;

        /**
        * Feature control deferred rendering for additional speed of initialisation. Since: 1.10
        */
        deferRender?: boolean | string[];
    ...
    export interface ButtonsSettings {
        ...
        */
        buttons?: ButtonsButtonsSettings | Array<string | ButtonsButtonsSettings>;
    }
    ...
    export interface ButtonsButtonsSettings {
        /**
        * Action to take when the button is activated.
        */
        action?: (e: Event, dt: DataTables, node: JQuery, config: ButtonsSettings) => void;
        
        /**
        * Function that is called when the button is destroyed.
        */
        available?: (dt: DataTables, config: ButtonsButtonsSettings) => boolean;
        ...
        */
        init?: (dt: DataTables, node: JQuery, config: ButtonsSettings) => void;
        
        /**
        * Define an activation key for a button.
        */
        key?: string | ButtonsButtonsKeySettings;
        ...
        */
        text?: (dt: DataTables, node: JQuery, config: ButtonsSettings) => string | string;
        
        /**
        * Button title attribute text.
        */
        titleAttrSince?: string;
        ...
        * Function that is called when the button is destroyed.
        */
        destroy?: (dt: DataTables, node: JQuery, config: ButtonsButtonsSettings) => void;
    }
    
    export interface ButtonsButtonsKeySettings {
        /**
