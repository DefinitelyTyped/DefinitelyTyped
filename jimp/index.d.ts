...
declare module 'jimp' {
	...
	class JimpImage {
		...
		contain(width: number, height: number, mode: ResizeMode, callback?: Callback<JimpImage>): JimpImage
		contain(width: number, height: number, alignBits: number, callback?: Callback<JimpImage>): JimpImage
		...
		cover(width: number, height: number, mode: ResizeMode, callback?: Callback<JimpImage>): JimpImage
		cover(width: number, height: number, alignBits: number, mode?: ResizeMode, callback?: Callback<JimpImage>): JimpImage
		cover(width: number, height: number, alignBits: number, callback?: Callback<JimpImage>): JimpImage
