...
declare namespace Electron {
	...
	class BrowserWindow implements NodeJS.EventEmitter {
		 ...
		 */
		on(event: 'page-title-updated', listener: (event: any) => void): this;
		/**
		 ...
		 */
		on(event: 'close', listener: (event: any) => void): this;
		/**
		 ...
		 */
		on(event: 'app-command', listener: (event: any, command: string) => void): this;
		/**
