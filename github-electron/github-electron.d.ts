...
declare namespace Electron {
	...
	class Screen implements NodeJS.EventEmitter {
		 ...
		 */
		on(event: 'display-added', listener: (event: any, newDisplay: Display) => void): this;
		/**
		 * Emitted when oldDisplay has been removed.
		 */
		on(event: 'display-removed', listener: (event: any, oldDisplay: Display) => void): this;
		/**
		 * Emitted when one or more metrics change in a display.
		 */
		on(event: 'display-metrics-changed', listener: (event: any, display: Display, changedMetrics: DisplayMetrics[]) => void): this;
		/**
