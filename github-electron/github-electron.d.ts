...
declare namespace Electron {
	 ...
	 */
	class DownloadItem implements NodeJS.EventEmitter {
		addListener(event: string, listener: Function): this;
		on(event: string, listener: Function): this;
		once(event: string, listener: Function): this;
		removeListener(event: string, listener: Function): this;
		 ...
		 */
		on(event: 'done', listener: (event: any, state: 'completed' | 'cancelled' | 'interrupted') => void): this;
		/**
	...
	class Session implements NodeJS.EventEmitter {
		 ...
		 */
		on(event: 'will-download', listener: (event: any, item: DownloadItem, webContents: WebContents) => void): this;
		/**
