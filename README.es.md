...
#### Versiones más viejas de TypeScript (3.8 y anteriores)

Definitely Typed solamente prueba paquetes en versiones de TypeScript que son menores a 2 años.
Actualmente, las versiones 3.9 y posteriores están siendo probadas. Si estas usando TypeScript 2.0 a 3.8, puedes intentar instalando paquetes `@types` &mdash; la mayoría de los paquetes no usan los beneficios de Typescript más nuevos. No hay garantía de que funcionen.
