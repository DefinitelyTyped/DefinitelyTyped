...
declare module "mongodb" {
	...
	export interface Collection {
		...
		findOne<T>(callback?: (err: any, result: T) => void): Cursor;
		findOne<T>(selector: any, callback?: (err: any, result: T) => void): Cursor;
		findOne<T>(selector: any, fields: any, callback?: (err: any, result: T) => void): Cursor;
		findOne<T>(selector: any, options: CollectionFindOptions, callback?: (err: any, result: T) => void): Cursor;
		findOne<T>(selector: any, fields: any, options: CollectionFindOptions, callback?: (err: any, result: T) => void): Cursor;
		findOne<T>(selector: any, fields: any, skip: number, limit: number, callback?: (err: any, result: T) => void): Cursor;
		findOne<T>(selector: any, fields: any, skip: number, limit: number, timeout: number, callback?: (err: any, result: T) => void): Cursor;
