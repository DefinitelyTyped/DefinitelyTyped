...
declare module mongodb {
    ...
    export class Db {
        ...
        public close(forceClose?: boolean, callback?: MongoCallback<any>): void;
        public admin(callback: MongoCallback<any>): any;
        public collectionsInfo(collectionName: string, callback?: MongoCallback<any>): void;
        public collectionNames(collectionName: string, options: any, callback?: MongoCallback<any>): void;
        ...
        //public dereference(dbRef: DbRef, callback: MongoCallback<any>): void;

        public logout(options: any, callback?: MongoCallback<any>): void;
        ...
        public authenticate(userName: string, password: string, options: any, callback?: MongoCallback<any>): void;

        public addUser(username: string, password: string, callback?: MongoCallback<any>): void;
        public addUser(username: string, password: string, options: any, callback?: MongoCallback<any>): void;

        public removeUser(username: string, callback?: MongoCallback<any>): void;
        public removeUser(username: string, options: any, callback?: MongoCallback<any>): void;

        public createCollection(collectionName: string, callback?: (err: Error, result: Collection) => void): void;
        public createCollection(collectionName: string, options: CollectionCreateOptions, callback?: MongoCallback<any>): void;

        public command(selector: Object, callback?: MongoCallback<any>): void;
        public command(selector: Object, options: any, callback?: MongoCallback<any>): void;

        public dropCollection(collectionName: string, callback?: MongoCallback<any>): void;
        public renameCollection(fromCollection: string, toCollection: string, callback?: MongoCallback<any>): void;

        public lastError(options: Object, connectionOptions: any, callback: MongoCallback<any>): void;
        public previousError(options: Object, callback: MongoCallback<any>): void;

        // error = lastError
        // lastStatus = lastError

        public executeDbCommand(command_hash: any, callback?: MongoCallback<any>): void;
        public executeDbCommand(command_hash: any, options: any, callback?: MongoCallback<any>): void;

        public executeDbAdminCommand(command_hash: any, callback?: MongoCallback<any>): void;
        public executeDbAdminCommand(command_hash: any, options: any, callback?: MongoCallback<any>): void;

        public resetErrorHistory(callback?: MongoCallback<any>): void;
        public resetErrorHistory(options: any, callback?: MongoCallback<any>): void;
        ...
        public connect(url: string, options: { uri_decode_auth?: boolean; }, callback: MongoCallback<any>): void;
    ...
    export interface Collection {
        ...
        insertOne(doc: Object, options: CollectionInsertOptions, callback: MongoCallback<any>): void;
        ...
        insertMany(docs: DocumentArray, options: CollectionInsertOptions, callback: MongoCallback<any>): void
        ...
        deleteOne(filter: Object, options: CollectionSaveDeleteOptions, callback: MongoCallback<any>): void;
        ...
        deleteMany(filter: Object, options: CollectionSaveDeleteOptions, callback: MongoCallback<any>): void;
        ...
        rename(newName: string, options: CollectionRenameOptions, callback: MongoCallback<any>): void;
        ...
        updateOne(filter: Object, update: Object, options: CollectionUpdateOptions, callback: MongoCallback<any>): void;
        ...
        updateMany(filter: Object, update: Object, options: CollectionUpdateOptions, callback: MongoCallback<any>): void;
        ...
        count(query: Object, options: MongoCountPreferences, callback: MongoCallback<any>): void;
        ...
        findOneAndDelete(filter: Object, options: MongoDeleteOptions, callback: MongoCallback<any>): void;
        ...
        findOneAndReplace(filter: Object, replacement: Object, options: MongoFindUpdateReplaceOptions, callback: MongoCallback<any>): void;
        ...
        findOneAndUpdate(filter: Object, update: Object, options: MongoFindUpdateReplaceOptions, callback: MongoCallback<any>): void;
        ...
        createIndex(fieldOrSpec: string | Object, options: MongoIndexOptions, callback: MongoCallback<any>): void;
        ...
        ensureIndex(fieldOrSpec: string | Object, options: MongoIndexOptions, callback: MongoCallback<any>): void;
        ...
        dropIndex(indexName: string, options: CollectionSaveDeleteOptions, callback: MongoCallback<any>): void;
        ...
        geoHaystackSearch(x: number, y: number, options: CollectionGeoHaystackSearchOptions, callback: MongoCallback<any>): void;
    ...
    export interface Cursor extends Readable {
        ...
        close(): Promise<any>;
        close(callback: MongoCallback<any>): Cursor;
        ...
        count(applySkipLimit: boolean, options: CursorCommentOptions, callback: MongoCallback<any>): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Cursor.html#explain
        explain(): Promise<any>;
        explain(callback: MongoCallback<any>): void;
    ...
    export interface AggregationCursor extends Readable {
        ...
        match(document: any): AggregationCursor;
        ...
        next(cb: AggregationCursorResultCallback<any>): void;
        next(): Promise<any>;
