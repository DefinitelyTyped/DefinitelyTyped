...
/* MongoDB Native Exported Classes
...
declare module "mongodb" {
    ...
    export type DocumentArray = Array<Object>;
    ...
    export class Readable {
        ...
        public pipe(destination: Writable, options?: Object): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Cursor.html#project
        public project(value: number): Cursor;
    ...
    export interface MongoIteratorCallback { (doc: Object): void; }
    export interface MongoEndCallback { (error: MongoError): void; }
    export interface ToArrayCallback { (error: MongoError, documents: DocumentArray): void; }
    export interface MongoResultCallback { (error: MongoError, result: any): void; }
    ...
    export class Cursor extends Readable {
        ...
        private _readPreference: CollectionReadPreference;
        ...
        public close(callback: MongoResultCallback): Cursor;
        ...
        public count(applySkipLimit: boolean, options: CursorCommentOptions, callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Cursor.html#explain
        public explain(): Promise<any>;
        public explain(callback: MongoResultCallback): void;
        ...
        public hasNext(callback: MongoResultCallback): void;
        ...
        public next(callback: MongoResultCallback): void;
        ...
        public sort(keyOrList: string | AnyArray | Object, direction: number): Cursor;
        ...
        public toArray(): Promise<DocumentArray>;
        public toArray(callback: ToArrayCallback): void;
    ...
    // Mongo Client
    interface MongoClientConnectOptions {
    ...
    export class MongoClient {
        public static connect(url: string, options?: MongoClientConnectOptions): Promise<any>;
        public static connect(url: string, options: MongoClientConnectOptions, callback: (error: MongoError, db: Db) => void): void;
        public connect(url: string, options?: MongoClientConnectOptions): Promise<any>;
        public connect(url: string, options: MongoClientConnectOptions, callback: (error: MongoError, db: Db) => void): void;
    }
    ...
    export class ObjectID {
        ...
        public static createFromTime(timeInSeconds: number): ObjectID;
    ...
    export class Binary {
        ...
        public write(string: Buffer | string, offset: number): void;
    }
    ...
    export interface CollectionMapReduceOptions {
        out?: Object;
        query?: Object;
        sort?: Object;
        limit?: number;
    ...
    export interface InitializeOrderedBulkOpOptions extends CollectionSaveDeleteOptions {}
    ...
    export class BulkWriteResult {
        ...
        public getUpsertedIds: ObjectArray;
        public getWriteConcernError: any;
        public getWriteErrorAt: any;
    ...
    export interface UnorderedBulkOperationResultCallback {
        (error: MongoError, result: BulkWriteResult): void;
    }
    ...
    export class FindOperatorsUnordered {
        ...
        public update(doc: Object): UnorderedBulkOperation;
        public updateOne(doc: Object): UnorderedBulkOperation;
    ...
    export class Collection {
        ...
        private readConcern: Object;
        // Get current index hint for collection.
        private hint: Object;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#initializeOrderedBulkOp
        public initializeUnorderedBulkOp(options: InitializeOrderedBulkOpOptions): UnorderedBulkOperation;
        ...
        public insertOne(doc: Object, options: CollectionInsertOptions, callback: MongoResultCallback): void;
        ...
        public insertMany(docs: DocumentArray, options: CollectionInsertOptions, callback: MongoResultCallback): void
        ...
        public deleteOne(filter: Object, options: CollectionSaveDeleteOptions, callback: MongoResultCallback): void;
        ...
        public deleteMany(filter: Object, options: CollectionSaveDeleteOptions, callback: MongoResultCallback): void;
        ...
        public rename(newName: string, options: CollectionRenameOptions, callback: MongoResultCallback): void;
        ...
        public updateOne(filter: Object, update: Object, options: CollectionUpdateOptions, callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#updateMany
        public updateMany(filter: Object, update: Object, options?: CollectionUpdateOptions): Promise<any>;
        public updateMany(filter: Object, update: Object, options: CollectionUpdateOptions, callback: MongoResultCallback): void;
        ...
        public distinct(key: string, query: Object, options: CollectionDistinctOptions, callback: MongoResultCallback): void
        ...
        public count(query: Object, options: MongoCountPreferences, callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#drop
        public drop(): Promise<any>;
        public drop(callback: MongoResultCallback): void;
        ...
        public findOneAndDelete(filter: Object, options: MongoDeleteOptions, callback: MongoResultCallback): void;
        ...
        public findOneAndReplace(filter: Object,
                                 replacement: Object,
                                 options: MongoFindUpdateReplaceOptions,
                                 callback: MongoResultCallback): void;
        ...
        public findOneAndUpdate(filter: Object, update: Object, options: MongoFindUpdateReplaceOptions, callback: MongoResultCallback): void;
        ...
        public createIndex(fieldOrSpec: string | Object, options: MongoIndexOptions, callback: MongoResultCallback): void;
        ...
        public ensureIndex(fieldOrSpec: string | Object, options: MongoIndexOptions, callback: MongoResultCallback): void;
        ...
        public indexInformation(options: {full: boolean}, callback: MongoResultCallback): void;
        ...
        public dropIndex(indexName: string, options: CollectionSaveDeleteOptions, callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#dropIndexes
        public dropIndexes(): Promise<any>;
        public dropIndexes(callback?: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#reIndex
        public reIndex(): Promise<any>;
        public reIndex(callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#mapReduce
        public mapReduce(map: Function | string, reduce: Function | string, options?: CollectionMapReduceOptions): Promise<any>;
        public mapReduce(map: Function | string, reduce: Function | string, options: CollectionMapReduceOptions, callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#group
        public group(keys: Object | Array<any> | Function | Code,
        ...
        public geoHaystackSearch(x: number, y: number, options: CollectionGeoHaystackSearchOptions, callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#indexes
        public indexes(): Promise<any>;
        public indexes(callback: MongoResultCallback): void;

        // http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#aggregate
        public aggregate(pipeline: Array<any>, options?: CollectionAggrigationOptions): Promise<any>;
        public aggregate(pipeline: Array<any>, options: CollectionAggrigationOptions, callback: MongoResultCallback): void;
    ...
    export interface DbAuthenticateOptions {
        username?: string;
        password?: string;
        options?: Object;
    }

    export interface CollectionResultCallback {
        (error: MongoError, collection: Collection): void;
    }
    ...
    export interface DbCollectionsCallback {
        (error: MongoError, collections: CollectionArray): void;
    }
    ...
    export interface MongoCollectionResultCallback {
        (error: MongoError, result: Collection): void;
    }
    ...
    export class Db {
        ...
        public addUser(username: string, password: string, options: DbAddUserOptions, callback?: MongoResultCallback ): void;

        public admin(): Admin;

        public authenticate(username: string, password: string): Promise<any>;
        public authenticate(username: string, password: string, callback?: MongoResultCallback ): void;

        public close(force?: boolean): Promise<any>;
        public close(force?: boolean, callback?: MongoResultCallback ): void;

        public collection(name: string, options?: DbCollectionOptions): Collection;
        public collection(name: string, options: DbCollectionOptions, callback: CollectionResultCallback): void;

        public collections(): Promise<CollectionArray>;
        public collections(callback: DbCollectionsCallback): void;

        public command(command: Object, options?: DbCommandOptions): Promise<any>;
        public command(command: Object, options: DbCommandOptions, callback: MongoResultCallback): Promise<any>;

        // TODO: Define Options
        public createCollection(name: string, options?: Object): Promise<any>;
        public createCollection(name: string, options: Object, callback: MongoCollectionResultCallback): void;

        // TODO: Define Options
        public createIndex(name: string, fieldOrSpec: string | Object, options?: Object): Promise<any>;
        public createIndex(name: string, fieldOrSpec: string | Object, options: Object, callback: MongoResultCallback): void;

        // TODO: Define Options
        public db(name: string, options?: Object): Db;

        public dropCollection(name: string): Promise<any>;
        public dropCollection(name: string, callback: MongoResultCallback): void;

        public dropDatabase(): Promise<any>;
        public dropDatabase(callback: MongoResultCallback): void;

        // TODO: Define Options
        public executeDbAdminCommand(command: Object, options?: Object): Promise<any>;
        public executeDbAdminCommand(command: Object, options: Object, callback: MongoResultCallback): void;

        // TODO: Define Options
        public indexInformation(name: string, options?: Object): Promise<any>;
        public indexInformation(name: string, options: Object, callback: MongoResultCallback): Promise<any>;

        public listCollections(filter: Object, options?:{batchSize: number}): Promise<any>;
        public listCollections(filter: Object, options:{batchSize: number}, callback: MongoResultCallback): void;

        public logout(options?: {dbName: string}): Promise<any>
        public logout(options: {dbName: string}, callback: MongoResultCallback): void;

        public open(): Promise<any>;
        public open(callback: MongoResultCallback): void;

        // TODO: Define Options
        public removeUser(username: string, options?: Object): Promise<any>;
        public removeUser(username: string, options: Object, callback: MongoResultCallback): void;

        public renameCollection(fromCollection: string, toCollection: string, options?: {dropTarget: boolean}): Promise<any>
        public renameCollection(fromCollection: string, toCollection: string, options: {dropTarget: boolean}, callback: MongoResultCallback): void;
...
//    }
//
//    export interface MongoClientConnectSignaturePromise {
//        (url: string, options?: Object) => Promise<any>;
//        (url: string, options: Object, callback: MongoClientConnectCallback): void;
//    }
//
//    export class MongoClient {
//        public static connect:
//        public connect: MongoClientConnectSignaturePromise;
//    }
//
