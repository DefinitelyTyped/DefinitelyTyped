// Type definitions for react-widgets v3.1.3
...
declare module "react-widgets/lib/Combobox" {
	...
	interface ComboBoxProps extends React.Props<ComboBoxClass> {
		/**
		 * The current value of the Combobox. This can be an object (such as a member of the data array) or a primitive value, hinted to by the valueField. The widget value does not need to be in the data, widgets can have values that are not in their list.
		 */
		value?: any;
		/**
		 * Called when the value is changed. If the value is one of the data members that item will be returned. In the case of a value not being found in the data array the string value of the Combobox will be returned.
		 */
		...
		/**
		 * An array of possible values for the Combobox. If an array of objects is provided you should use the valueField and textField props, to specify which object properties comprise the value field (such as an id) and the field used to label the item.
		 */
		data?: any[];
		/**
		...
		valueField?: string;
		/**
		 * Specify which data item field to display in the Combobox and selected item. The textField` prop may also also used as to find an item in the list as you type. Providing an accessor function allows for computed text values
		 */
		textField?: string;
		/**
		 * This component is used to render each possible item in the Combobox. The default component renders the text of the selected item (specified by textfield)
		 */
		...
		/**
		 * Place the Combobox in a read-only mode, If an Array of values is passed in only those values will be read-only.
		 */
		readOnly?: boolean | any[];
		/**
		 * Determines how to group the Combobox. Providing a string will group the data array by that property. You can also provide a function which should return the group value.
		 */
		...
		/**
		 * When true the Combobox will suggest, or fill in, values as you type. The suggestions are always "startsWith", meaning it will search from the start of the textField property
		 */
		suggest?: boolean;
		/**
		 ...
		 * To handle custom filtering techniques provide a function that returns true or false for each passed in item (analogous to the array.filter builtin)
		...
		minLength?: number;
		/**
		 * Whether or not the Combobox is open. When unset (undefined) the Combobox will handle the opening and closing internally. The defaultOpen prop can be used to set an initialization value for uncontrolled widgets.
		 */
		open?: boolean;
		/**
		 * Called fires when the Combobox is about to open or close. onToggle should be used when the open prop is set otherwise the widget will never open or close.
		 */
