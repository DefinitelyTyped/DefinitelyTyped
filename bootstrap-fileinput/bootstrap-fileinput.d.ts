interface JQuery {
    fileinput: (options?: FileInputOptions) => JQuery;
}
...
interface FileInputOptions {
    ...
    */
    initialPreviewConfig?: IFileUploadPreviewConfig[];
    /**
    ...
    */
    layoutTemplates?: IFileUploadLayoutTemplates;
    /**
    the templates configuration for rendering each preview file type.
    */
    previewTemplates?: IFileUploadPreviewTemplates;
    /**
    ...
    */
    previewSettings?: IFileUploadPreviewSettings;
    /**
    ...
    */
    fileTypeSettings?: IFileUploadFileTypeSettings;
    /**
    ...
    */
    previewFileIconSettings?: IFileUploadPreviewFileIconSettings;
    /**
    ...
    */
    previewFileExtSettings?: IFileUploadPreviewFileExtSettings;
    /**
    ...
    */
    fileActionsettings?: IFileUploadFileActionSettings;
    /**
...
interface IFileUploadPreviewConfig {
    /**
...
interface IFileUploadLayoutTemplates {
    /**
...
interface IFileUploadPreviewTemplates {
    /**
...
interface IFileUploadPreviewSettings {
...
interface IFileUploadFileTypeSettings {
...
interface IFileUploadPreviewFileIconSettings {
    [key: string]: string;
}

interface IFileUploadPreviewFileExtSettings {
    [key: string]: (ext: string) => boolean;
}

interface IFileUploadFileActionSettings {
    /**
