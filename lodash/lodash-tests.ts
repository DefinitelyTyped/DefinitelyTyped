...
result = <number[]>_.takeWhile([1, 2, 3], function (num) {
    return num < 3;
});
...
result = <number[]>_.takeRight([1, 2, 3], 2);
result = <number[]>_.takeRightWhile([1, 2, 3], function (num) {
    return num > 1;
});
result = <IFoodOrganic[]>_.takeRightWhile(foodsOrganic, 'organic');
result = <IFoodType[]>_.takeRightWhile(foodsType, { 'type': 'vegetable' });

result = <number>_([1, 2, 3]).last();
result = <number[]>_([1, 2, 3]).takeRight(2).value();
result = <number[]>_([1, 2, 3]).takeRightWhile(function (num) {
    return num < 3;
}).value();
result = <IFoodOrganic[]>_(foodsOrganic).takeRightWhile('organic').value();
result = <IFoodType[]>_(foodsType).takeRightWhile({ 'type': 'fruit' }).value();
