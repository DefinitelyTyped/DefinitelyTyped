...
gridInstance.$canvas = angular.element();
gridInstance.$viewport = angular.element();
gridInstance.$groupPanel = angular.element();
gridInstance.$footerPanel = angular.element();
gridInstance.$headerScroller = angular.element();
gridInstance.$headerContainer = angular.element();
gridInstance.$headers = angular.element();
gridInstance.$topPanel = angular.element();
gridInstance.$root = angular.element();
gridInstance.config = angular.element();
gridInstance.data = {};
