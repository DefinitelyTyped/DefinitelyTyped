// Type definitions for Bing Maps V8 SDK - Directions module (ported from Bing Maps Typescript reference)
...
declare namespace Microsoft.Maps {
    ...
    module Events {
        ...
        */
        export function addHandler(target: Directions.DirectionsManager,
            eventName: string,
         ...
         * @param handler The callback function to handle the event when triggered.
         */
        export function addOne(target: Directions.DirectionsManager,
            eventName: string,
            handler: (eventArg?: Directions.IDirectionsEventArgs | Directions.IDirectionsErrorEventArgs) => void): void;
         ...
         * @returns The handler id.
         */
        export function addThrottledHandler(target: Directions.DirectionsManager,
            eventName: string,
            handler: (eventArg?: Directions.IDirectionsEventArgs | Directions.IDirectionsErrorEventArgs) => void,
            throttleInterval: number): IHandlerId;
    }
}