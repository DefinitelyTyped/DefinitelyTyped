// Type definitions for Bing Maps V8 SDK - Spatial data service module (ported from Bing Maps Typescript reference)
...
declare namespace Microsoft.Maps.SpatialDataService {
    ...
    export module GeoDataAPIManager {
        ...
        export function getBoundary(locations: string | Location | (string | Location)[],
            ...
            callback: (results: IGeoDataResultSet) => void): void;
    }
