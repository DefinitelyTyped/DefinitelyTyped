// Type definitions for Bing Maps V8 SDK - Spatial math module (ported from Bing Maps Typescript reference)
...
declare namespace Microsoft.Maps.SpatialMath {
     ...
     **/
    export function getDestination(origin: Location, bearing: number, distance: number, units?: DistanceUnits):
        Location;
     ...
     **/
    export function getDistanceTo(origin: Location,
        destination: Location,
        units?: DistanceUnits,
        highAccuracy?: boolean): number;
     ...
     **/
    export function getLocationAlongPath(path: Polyline | Location[], distance: number, units?: DistanceUnits):
        Location;
     ...
     **/
    export function getRegularPolygon(origin: Location,
        radius: number,
        numberOfPoints: number,
        units?: DistanceUnits,
        offset?: number): Location[];
...
declare namespace Microsoft.Maps.SpatialMath.Tiles {
...
declare namespace Microsoft.Maps.SpatialMath.Geometry {
     ...
     */
    export function buffer(shape: Location | IPrimitive | (Location | IPrimitive)[],
        distance: number,
        units?: DistanceUnits,
        endCapType?: BufferEndCap,
        options?: IPolygonOptions): IPrimitive | IPrimitive[];
     ...
     * If 3 or more unique Locations are in the data set a Polygon, or array of Polygons will be returned.
     */
    export function concaveHull(shapes: Location | IPrimitive | (Location | IPrimitive)[],
     ...
     */
    export function convexHull(shapes: Location | IPrimitive | (Location | IPrimitive)[], options?: IPolygonOptions):
     ...
     */
    export function delaunayTriangles(shapes: Location | IPrimitive | (Location | IPrimitive)[],
        options?: IPolygonOptions): Polygon[];
     ...
     */
    export function difference(shapeA: IPrimitive | IPrimitive[], shapeB: IPrimitive | IPrimitive[]): IPrimitive |
        IPrimitive[];
     ...
     */
    export function distance(shapeA: Location | IPrimitive | (Location | IPrimitive)[],
        shapeB: Location | IPrimitive | (Location | IPrimitive)[],
        units?: DistanceUnits,
        highAccuracy?: boolean): number;
     ...
     */
    export function intersection(shapeA: IPrimitive | IPrimitive[], shapeB: IPrimitive | IPrimitive[]): IPrimitive |
        IPrimitive[];
     ...
     */
    export function intersects(shapeA: Location | IPrimitive | (Location | IPrimitive)[],
        shapeB: Location | IPrimitive | (Location | IPrimitive)[]): boolean;
     ...
     */
    export function calculateLength(shape: IPrimitive | IPrimitive[], units?: DistanceUnits, highAccuracy?: boolean):
        number;
     ...
     */
    export function nearestLocations(shapeA: Location | IPrimitive | (Location | IPrimitive)[],
        shapeB: Location | IPrimitive | (Location | IPrimitive)[]): Location[];
     ...
     */
    export function shortestLineTo(shapeA: Location | IPrimitive | (Location | IPrimitive)[],
        shapeB: Location | IPrimitive | (Location | IPrimitive)[],
        options?: IPolylineOptions): Polyline;
     ...
     */
    export function snapLocationsToShape(locs: Location | Location[],
        shape: IPrimitive | IPrimitive[],
        tolerance?: number,
        toleranceUnits?: DistanceUnits): Location | Location[];
     ...
     * @param toleranceUnits The distance units of the tolerance value. Default: Meters
     */
    export function snapShapeToShape(shapeToSnap: IPrimitive | IPrimitive[],
        shape: IPrimitive | IPrimitive[],
        tolerance?: number,
        toleranceUnits?: DistanceUnits): void;
     ...
     */
    export function symDifference(shapeA: IPrimitive | IPrimitive[], shapeB: IPrimitive | IPrimitive[]): IPrimitive |
        IPrimitive[];
     ...
     */
    export function voronoiDiagram(shapes: Location | IPrimitive | (Location | IPrimitive)[],
        clipRegion?: LocationRect | Polygon,
        options?: IPolygonOptions): Polygon[];
}