...
#### Vecchie vesioni di TypeScript (3.8 e precedenti)

Definitely Typed testa packages solo su versioni di TypeScript che hanno meno di due anni.
Attualmente vengono testate le versioni 3.9 e successive.
Se stai usando una versiond di TypeScript tra 2.0 e la 3.8, puoi ancora provare ad installare i package `@types`, in quanto la maggior parte di questi non usano le funzionalità più all'avanguardia di Typescript.
