...
interface Html2CanvasStatic {
    ...
    /** 
      ...
      * 
      * @param {any} element The HTML element which will be rendered to the canvas. Use the root element to render the entire window.
      */
    (element: any): void;
    /** 
      * Renders an HTML element to a canvas so that a screenshot can be generated.
      ...
      */
    (element: any, options: Html2Canvas.Html2CanvasOptions): void;
}
