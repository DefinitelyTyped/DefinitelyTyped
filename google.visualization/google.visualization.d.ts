...
// Definitions by: Dan Ludwig <https://github.com/danludwig>, Marc-André Bühler <https://github.com/CodeZombieCH>
...
declare module google {
    ...
    module visualization {
        ...
        class DefaultFormatter {
             ...
             */
            format(data: DataTable, columnIndex: number);
        }
        ...
        export class ColorFormat extends DefaultFormatter {
             ...
             */
            addRange(from: any, to: any, color: string, bgcolor: string);
            /**
        ...
        export class PatternFormat {
             ...
             */
            format(dataTable: DataTable, srcColumnIndices: number[], opt_dstColumnIndex?: number);
        }
