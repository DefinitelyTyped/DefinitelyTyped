...
declare module breeze.core {
    ...
    export function memoize(fn: (...args: any[]) => any): any;
...
declare module breeze {
    ...
    class ComplexType implements IStructuralType {
        ...
        unmappedProperties: DataProperty[];
        validators: Validator[];
        addProperty(dataProperty: DataProperty): any;
    ...
    class EntityQuery {
        ...
        using(obj: core.EnumSymbol): EntityQuery;
    ...
    class MetadataStore {
        ...
        trackUnmappedType(entityCtor: Function, interceptor?: Function): any;
    ...
    class QueryOptions {
        ...
        using(config: core.EnumSymbol): QueryOptions;
    }
    ...
    class Validator {
        ...
        static register(validator: Validator): any;
        static registerFactory(fn: () => Validator, name: string): any;
