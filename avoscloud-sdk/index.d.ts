...
export declare var masterKey: string;
...
export declare class BaseObject implements IBaseObject {
    toJSON(): any;
}
 ...
 */
export declare class ACL extends BaseObject {
 ...
 *   object.save();</pre></p>
 */
export declare class GeoPoint extends BaseObject {
 ...
 */
export declare class Relation extends BaseObject {
 ...
 * interface.</p>
 */
export declare class Object extends BaseObject {
 ...
 */
export declare class Installation extends Object {
 ...
 * documentation</a>.</p>
 */
export declare class Collection<T> extends Events implements IBaseObject {
 ...
 * });</pre></p>
 */
export declare class Query extends BaseObject {
 ...
 * cloud.
 */
export declare class Role extends Object {
 ...
 */
export declare function initialize(applicationId: string, applicationKey: string, masterKey?: string): void;
