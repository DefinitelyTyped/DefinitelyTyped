declare module goog {
    function require(name: 'goog.math.AffineTransform'): typeof goog.math.AffineTransform;
}
...
declare module goog.math {
    ...
    class AffineTransform {
         ...
         *     transformation.
         */
        static getScaleInstance(sx: number, sy: number): goog.math.AffineTransform;
         ...
         */
        static getTranslateInstance(dx: number, dy: number): goog.math.AffineTransform;
         ...
         *     transformation.
         */
        static getShearInstance(shx: number, shy: number): goog.math.AffineTransform;
         ...
         *     transformation.
         */
        static getRotateInstance(theta: number, x: number, y: number): goog.math.AffineTransform;
