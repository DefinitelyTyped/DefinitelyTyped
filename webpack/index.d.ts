...
declare namespace webpack {
    interface Configuration {
        ...
        devtool?: 'cheap-eval-source-map' | 'cheap-source-map' | 'cheap-module-eval-source-map' | 'cheap-module-source-map'| 'eval-source-map'| 'source-map' | 'nosources-source-map';
    ...
    namespace loader {
        ...
        interface Loader extends Function {
            (this: LoaderContext, source: string | Buffer, sourceMap: string | Buffer): string;
        ...
        interface LoaderContext {
            ...
            callback?: (err: Error, content?: string | Buffer, sourceMap?: string | Buffer) => void;


            /**
             * Make this loader async.
             */
            async(): ( (err: Error, content?: string) => void ) | undefined;
