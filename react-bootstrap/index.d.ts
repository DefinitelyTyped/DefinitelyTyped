...
interface SelectCallback {
    (eventKey: any, e: React.SyntheticEvent<any>): void;
    /**
        @deprecated
...
export var BreadcrumbItem: React.ClassicComponentClass<BreadcrumbItemProps>;
...
export var CarouselCaption: React.ClassicComponentClass<CarouselCaptionProps>;
...
export var InputGroup: React.ClassicComponentClass<InputGroupProps>;
...
export var InputGroupAddon: React.ClassicComponentClass<InputGroupAddonProps>;
...
export var InputGroupButton: React.ClassicComponentClass<InputGroupButtonProps>;
