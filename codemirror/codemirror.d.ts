declare var CodeMirror: CM.Static;
...
declare module CM {
    interface Static {
        ...
        on(doc: Doc, eventName: 'cursorActivity', handler: (instance: Editor) => void );
        off(doc: Doc, eventName: 'cursorActivity', handler: (instance: Editor) => void );

        /** Equivalent to the event by the same name as fired on editor instances. */
        on(doc: Doc, eventName: 'beforeSelectionChange', handler: (instance: Editor, selection: { head: Position; anchor: Position; }) => void );
        off(doc: Doc, eventName: 'beforeSelectionChange', handler: (instance: Editor, selection: { head: Position; anchor: Position; }) => void );
    ...
    interface Editor {
        ...
        findPosH(start: Position, amount: number, unit: string, visually: boolean): { line: number; ch: number; hitSide?: boolean; };
        ...
        findPosV(start: Position, amount: number, unit: string): { line: number; ch: number; hitSide?: boolean; };
        ...
        setGutterMarker(line: any, gutterID: string, value: HTMLElement): LineHandle;
        ...
        addWidget(pos: Position, node: HTMLElement, scrollIntoView: boolean);
        ...
        scrollIntoView(pos: Position, margin?: number);
        ...
        cursorCoords(where: Position, mode: string): { left: number; top: number; bottom: number; };
        ...
        coordsChar(object: { left: number; top: number; }, mode?: string): Position;
        ...
        on(eventName: string, handler: (instance: Editor) => void );
        off(eventName: string, handler: (instance: Editor) => void );

        /** Fires every time the content of the editor is changed. */
        on(eventName: 'change', handler: (instance: Editor, change: EditorChangeLinkedList) => void );
        off(eventName: 'change', handler: (instance: Editor, change: EditorChangeLinkedList) => void );
        ...
        on(eventName: 'beforeChange', handler: (instance: Editor, change: EditorChangeCancellable) => void );
        off(eventName: 'beforeChange', handler: (instance: Editor, change: EditorChangeCancellable) => void );

        /** Will be fired when the cursor or selection moves, or any change is made to the editor content. */
        on(eventName: 'cursorActivity', handler: (instance: Editor) => void );
        ...
        on(eventName: 'viewportChange', handler: (instance: Editor, from: number, to: number) => void );
        off(eventName: 'viewportChange', handler: (instance: Editor, from: number, to: number) => void );
        ...
        on(eventName: 'gutterClick', handler: (instance: Editor, line: number, gutter: string, clickEvent: Event) => void );
        off(eventName: 'gutterClick', handler: (instance: Editor, line: number, gutter: string, clickEvent: Event) => void );

        /** Fires whenever the editor is focused. */
        on(eventName: 'focus', handler: (instance: Editor) => void );
        off(eventName: 'focus', handler: (instance: Editor) => void );

        /** Fires whenever the editor is unfocused. */
        on(eventName: 'blur', handler: (instance: Editor) => void );
        off(eventName: 'blur', handler: (instance: Editor) => void );

        /** Fires when the editor is scrolled. */
        on(eventName: 'scroll', handler: (instance: Editor) => void );
        off(eventName: 'scroll', handler: (instance: Editor) => void );

        /** Will be fired whenever CodeMirror updates its DOM display. */
        on(eventName: 'update', handler: (instance: Editor) => void );
        off(eventName: 'update', handler: (instance: Editor) => void );
        ...
        on(eventName: 'renderLine', handler: (instance: Editor, line: number, element: HTMLElement) => void );
        off(eventName: 'renderLine', handler: (instance: Editor, line: number, element: HTMLElement) => void );
    }
    ...
    interface Doc {
        ...
        replaceRange(replacement: string, from: Position, to: Position);
        ...
        getLineNumber(handle: LineHandle): number;
        ...
        extendSelection(from: Position, to?: Position);
        ...
        iterLinkedDocs(fn: (doc: Doc, sharedHist: boolean) => void );
        ...
        markText(from: Position, to: Position, options?: Options.TextMarkerOptions): TextMarker;
        ...
        setBookmark(pos: Position, options?: {
    ...
    interface TextMarker {
        ...
        getOptions(copyWidget: boolean): Options.TextMarkerOptions;
    }
    ...
    interface EditorChangeLinkedList extends EditorChange {
    ...
    module Options {
        interface EditorConfiguration {
            ...
            onDragEvent?: (instance: CM.Editor, event: Event) => boolean;
            ...
            onKeyEvent?: (instance: CM.Editor, event: Event) => boolean;
