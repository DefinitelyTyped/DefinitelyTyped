...
declare namespace CodeMirror {
     ...
     */
    function MergeView(element: HTMLElement, options?: MergeViewEditorConfiguration): MergeViewEditor;
     ...
     * Callback for when stretches of unchanged text are collapsed.
     */
    interface MergeViewCollapser {
        (mergeView: MergeViewEditor, line: number, size: number, mark: TextMarker): void;
    }
    ...
    /**
     * Determines how the view should be updated. If "full" mode is given it clears everything before updating the diff.
     */
    interface DiffViewUpdater {
        (mode: string): void;
    }
