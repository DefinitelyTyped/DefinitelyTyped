...
/*
Electron's _renderers_ provide a different environment than the main worker.
Any missing ambient environmental objects should be accurately reflected in
the type definitions for that environment.

This file pairs with github-electron-main.d.ts, but not github-electron.d.ts (which is the union of both environments)
*/
...
declare namespace Electron {
    ...
    interface ElectronRenderer extends CommonElectron {
...
declare module 'electron' {
    var electron: Electron.ElectronRenderer;
    export = electron;
}

interface NodeRequireFunction {
    (moduleName: 'electron'): Electron.ElectronRenderer;
}
