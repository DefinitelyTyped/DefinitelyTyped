...
declare module THREE {
   ...
   // custom blending src factors
    ...
    export class AnimationClip {
        ...
        CreateFromMorphTargetSequence( name: string, morphTargetSequence: any[], fps: number ): AnimationClip;
        findByName( clipArray: AnimationClip, name: string ): AnimationClip;
        CreateClipsFromMorphTargetSequences( morphTargets: MorphTarget[], fps: number ): AnimationClip[];
    ...
    export class Object3D {
         ...
         */
        position: { enumerable: boolean, value:  Vector3 };

        /**
         * Object's local rotation (Euler angles), in radians.
         */
        rotation: { enumerable: boolean, value:  Euler };

        /**
         * Global rotation.
         */
        quaternion: { enumerable: boolean, value:  Quaternion };

        /**
         * Object's local scale.
         */
        scale: { enumerable: boolean, value: Vector3 };
    ...
    export interface PointMaterialParameters extends MaterialParameters{
        color?: number;
        opacity?: number;
        map?: Texture;
        size?: number;
    ...
    export class PointMaterial extends Material {
        constructor(parameters?: PointMaterialParameters);
        ...
        copy(source: PointMaterial): PointMaterial;
    }
    ...
    export class LOD extends Object3D {
        ...
        levels: { enumerable: boolean, value: any[] }
    ...
    export class Points extends Object3D {
        ...
        constructor(
            geometry: Geometry | BufferGeometry,
            material?: PointMaterial | ShaderMaterial
        );
    ...
    export class WebGLBufferRenderer{
        constructor(_gl, extensions, _infoRender); // WebGLRenderingContext
    ...
    export class WebGLCapabilities{
        constructor(gl, extensions, parameters); // WebGLRenderingContext
