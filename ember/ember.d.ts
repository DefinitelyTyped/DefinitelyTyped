...
declare module Ember {
    ...
    **/
    ...
    var run: {
        ...
        debounce(target: any, method: Function, ...any): void;
        debounce(target: any, method: string, ...any): void;
        end(): void;
        join(target: any, method: Function, ...any): any;
        join(target: any, method: string, ...any): any;
        later(target: any, method: Function, ...any): string;
        later(target: any, method: string, ...any): string;
        ...
        sync(): void;
        throttle(target: any, method: Function, ...any): void;
        throttle(target: any, method: string, ...any): void;
        queues: any[];
    };
