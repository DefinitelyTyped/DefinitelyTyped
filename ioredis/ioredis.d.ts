...
declare module "ioredis" {
    ...
    interface RedisStatic {
        new (port?: number, host?: string, options?: redis.RedisOptions): redis.Redis;
        new (host?: string, options?: redis.RedisOptions): redis.Redis;
        new (options: redis.RedisOptions): redis.Redis;
        new (url: string): redis.Redis;
        (port?: number, host?: string, options?: redis.RedisOptions): redis.Redis;
        (host?: string, options?: redis.RedisOptions): redis.Redis;
        (options: redis.RedisOptions): redis.Redis;
        (url: string): redis.Redis;
    ...
    namespace redis {
        ...
        interface Redis extends NodeJS.EventEmitter, Commander {
            ...
            scanStream(options?: redis.ScanStreamOption): NodeJS.EventEmitter;
            hscanStream(key: string, options?: redis.ScanStreamOption): NodeJS.EventEmitter;
        }
        ...
        interface Cluster extends NodeJS.EventEmitter, Commander {
            new (nodes: { host: string; port: number; }[], options?: redis.ClusterOptions): Redis;
            connect(callback: Function): PromiseLike<any>;
            disconnect(): void;
