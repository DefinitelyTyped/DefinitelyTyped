# DefinitelyTyped [![Build Status](https://travis-ci.org/igorsechyn/DefinitelyTyped.png?branch=hystrixjs_definition)](https://travis-ci.org/borisyankov/DefinitelyTyped)
