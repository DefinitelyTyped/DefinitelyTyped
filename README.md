...
- [Definitely Typed](#definitely-typed)
    - [!!! Important! This repo has recently changed layout! !!!](#-important-this-repo-has-recently-changed-layout-)
    ...
    - [How can I contribute?](#how-can-i-contribute)
        ...
        - [Make a pull request](#make-a-pull-request)
            ...
            - [Running tests](#running-tests)
                - [@arethetypeswrong/cli (`attw`) checks](#arethetypeswrongcli-attw-checks)
            - [Naming](#naming)
            - [`<my-package>-tests.ts`](#my-package-teststs)
                - [Linter: `.eslintrc.json`](#linter-eslintrcjson)
            - [`tsconfig.json`](#tsconfigjson)
                - [`esModuleInterop`/`allowSyntheticDefaultImports`](#esmoduleinteropallowsyntheticdefaultimports)
            - [`package.json`](#packagejson)
                - [Peer dependencies](#peer-dependencies)
            - [`.npmignore`](#npmignore)
            - [Common mistakes](#common-mistakes)
        - [Definition owners](#definition-owners)
    - [The history of Definitely Typed](#the-history-of-definitely-typed)
    - [FAQ](#faq)
        - [What exactly is the relationship between this repository and the `@types` packages on npm?](#what-exactly-is-the-relationship-between-this-repository-and-the-types-packages-on-npm)
        - [I've submitted a pull request. How long until it is merged?](#ive-submitted-a-pull-request-how-long-until-it-is-merged)
        - [I'd like to submit a change to a very popular project, why are they treated differently?](#id-like-to-submit-a-change-to-a-very-popular-project-why-are-they-treated-differently)
        - [My PR is merged; when will the `@types` npm package be updated?](#my-pr-is-merged-when-will-the-types-npm-package-be-updated)
        - [I'm writing a definition that depends on another definition. Should I use `<reference types="" />` or an import?](#im-writing-a-definition-that-depends-on-another-definition-should-i-use-reference-types--or-an-import)
        - [Some packages have a `tsconfig.json` that is missing `"noImplicitAny": true`, `"noImplicitThis": true` or `"strictNullChecks": true`.](#some-packages-have-a-tsconfigjson-that-is-missing-noimplicitany-true-noimplicitthis-true-or-strictnullchecks-true)
        - [Are Files Formatted Automatically?](#are-files-formatted-automatically)
        - [Can I request a definition?](#can-i-request-a-definition)
        - [What about type definitions for the DOM?](#what-about-type-definitions-for-the-dom)
        - [What about type definitions with no matching package?](#what-about-type-definitions-with-no-matching-package)
        - [Should I add an empty namespace to a package that doesn't export a module to use ES6 style imports?](#should-i-add-an-empty-namespace-to-a-package-that-doesnt-export-a-module-to-use-es6-style-imports)
        - [A package uses `export =`, but I prefer to use default imports. Can I change `export =` to `export default`?](#a-package-uses-export--but-i-prefer-to-use-default-imports-can-i-change-export--to-export-default)
        - [I want to use features from very new TypeScript versions.](#i-want-to-use-features-from-very-new-typescript-versions)
        - [I want to add a DOM API not present in TypeScript by default.](#i-want-to-add-a-dom-api-not-present-in-typescript-by-default)
        - [How do Definitely Typed package versions relate to versions of the corresponding library?](#how-do-definitely-typed-package-versions-relate-to-versions-of-the-corresponding-library)
        - [If a library is updated to a new major version with breaking changes, how should I update its type declaration package?](#if-a-library-is-updated-to-a-new-major-version-with-breaking-changes-how-should-i-update-its-type-declaration-package)
        - [How do breaking type changes work if type declaration packages closely track the library package's version?](#how-do-breaking-type-changes-work-if-type-declaration-packages-closely-track-the-library-packages-version)
        - [How do I write definitions for packages that can be used globally and as a module?](#how-do-i-write-definitions-for-packages-that-can-be-used-globally-and-as-a-module)
        - [What about scoped packages?](#what-about-scoped-packages)
    - [License](#license)
