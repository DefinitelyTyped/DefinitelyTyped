...
<details>
<summary>Currently versions 3.9 and above are tested...</summary>

If you're using TypeScript 2.0 to 3.8, you can still try installing `@types` packages &mdash; the majority of packages don't use fancy new TypeScript features.
