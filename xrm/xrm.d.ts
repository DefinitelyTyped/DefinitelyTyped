...
declare module Xrm 
{
    ...
    export module Page
    {
        ...
        export interface EventContext
        {
             ...
             */
            getEventSource(): any;  // Xrm.Page.Attribute | Xrm.Page.Entity
        ...
        export interface EnumAttribute extends Attribute
        {
             ...
             */
            getInitialValue(): number; // number | boolean
        }
         ...
         * @sa  Control
         */
        export interface SubGridControl extends Control
        {
            /**
