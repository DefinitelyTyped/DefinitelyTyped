...
declare module "pem" {
     ...
     */
    function createPrivateKey(keyBitsize: number, options: PrivateKeyCreationOptions, callback: Callback<{ key: string }>): void;
    function createPrivateKey(optionsOrKeyBitsize: number | PrivateKeyCreationOptions, callback: Callback<{ key: string }>): void;
    function createPrivateKey(callback: Callback<{ key: string }>): void;
     ...
     */
    function createDhparam(keyBitsize: number, callback: Callback<{ dhparam: any }>): void;
    function createDhparam(callback: Callback<{ dhparam: any }>): void;
     ...
     */
    function createCSR(options: CSRCreationOptions, callback: Callback<{ csr: string, clientKey: string }>): void;
    function createCSR(callback: Callback<{ csr: string, clientKey: string }>): void;
     ...
     */
    function createCertificate(options: CertificateCreationOptions, callback: Callback<CertificateCreationResult>): void;
    function createCertificate(callback: Callback<CertificateCreationResult>): void;
     ...
     */
    function readCertificateInfo(certificate: string, callback: Callback<CertificateSubjectReadResult>): void;
    function readCertificateInfo(callback: Callback<CertificateSubjectReadResult>): void;
     ...
     */
    function getPublicKey(certificate: string, callback: Callback<{ publicKey: string }>): void;
    function getPublicKey(callback: Callback<{ publicKey: string }>): void;
     ...
     */
    function getFingerprint(certificate: string, hash: HashFunction, callback: Callback<{ fingerprint: string }>): void;
    function getFingerprint(certificate: string, callback: Callback<{ fingerprint: string }>): void;
    function getFingerprint(callback: Callback<{ fingerprint: string }>): void;
     ...
     */
    function getModulus(certificate: string, password: string, callback: Callback<{ modulus: any }>): void;
    function getModulus(certificate: string, callback: Callback<{ modulus: any }>): void;
     ...
     */
    function getDhparamInfo(dh: string, callback: Callback<{ size: any, prime: any }>): void;
     ...
     */
    function createPkcs12(key: string, certificate: string, password: string, options: Pkcs12CreationOptions, callback: Callback<{ pkcs12: any }>): void;
    function createPkcs12(key: string, certificate: string, password: string, callback: Callback<{ pkcs12: any }>): void;
     ...
     */
    function readPkcs12(bufferOrPath: string, options: Pkcs12ReadOptions, callback: Callback<{ pkcs12: any }>): any;
    function readPkcs12(bufferOrPath: string, callback: Callback<{ pkcs12: any }>): any;
     ...
     */
    function verifySigningChain(certificate: string, ca: string[], callback: Callback<boolean>): void;

    /**
     * config the pem module
     * @param {ModuleConfiguration} options
     */
    function config(options: ModuleConfiguration): void;
}
