...
declare module Dropbox {
    ...
    module AuthDriver {
        ...
        class NodeServer extends IAuthDriver {
            ...
            doRequest(request, response): void;
            closeBrowser(response): void;
        }
    }
    ...
    class Client {
        ...
        isAppDeveloper(userId, callbackcallback: (err: ApiError, isAppDeveloper: boolean) => void): XMLHttpRequest;
        isAppDeveloper(userId, appKey, callbackcallback: (err: ApiError, isAppDeveloper: boolean) => void): XMLHttpRequest;
