...
// Definitions by: Evan Larsen <http://nouvosoft.com/> and Judah Gabriel Himango <http://debuggerdotbreak.wordpress.com>
...
declare module "durandal/plugins/router" {
    ...
    /**
      ...
      */
    export var activeRoute: KnockoutObservableAny<any>;
    /**
