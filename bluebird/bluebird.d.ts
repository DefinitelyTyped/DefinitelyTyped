...
// By: Igorbek <https://github.com/Igorbek/>
...
//TODO fix all TODO annotations in the file

//TODO support to have no return statement in handlers to get a Promise<void> (more overloads?)
...
declare class Promise<R> implements Thenable<R> {
     ...
     */
    then<U>(onFulfill:(value:R) => Thenable<U>, onReject:(error:any) => Thenable<U>, onProgress?:(note:any) => any):Promise<U>;
    then<U>(onFulfill:(value:R) => Thenable<U>, onReject?:(error:any) => U, onProgress?:(note:any) => any):Promise<U>;
    then<U>(onFulfill:(value:R) => U, onReject:(error:any) => Thenable<U>, onProgress?:(note:any) => any):Promise<U>;
     ...
     */
    finally(handler:(value:R) => Thenable<R>):Promise<R>;
    finally(handler:(value:R) => R):Promise<R>;

    lastly(handler:(value:R) => Thenable<R>):Promise<R>;
     ...
     */
    done<U>(onFulfilled:(value:R) => Thenable<U>, onRejected:(error:any) => Thenable<U>, onProgress?:(note:any) => any):Promise<U>;
    done<U>(onFulfilled:(value:R) => Thenable<U>, onRejected?:(error:any) => U, onProgress?:(note:any) => any):Promise<U>;
    done<U>(onFulfilled:(value:R) => U, onRejected:(error:any) => Thenable<U>, onProgress?:(note:any) => any):Promise<U>;
    ...
    * });
     ...
     */
    throw(reason:any):Promise<R>;
    thenThrow(reason:any):Promise<R>;
     ...
     */
    //TODO how to model instance.spread()?
    // like Q?
    ...
    */
     ...
     */
    //TODO how to model instance.all()?
    all<U>():Promise<U[]>;
     ...
     */
    //TODO how to model instance.settle()?
    settle<U>():Promise<PromiseInspection<U>[]>;

    /**
     * Same as calling `Promise.any(thisPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
     */
    //TODO how to model instance.any()?
    any<U>():Promise<U>;

    /**
     * Same as calling `Promise.some(thisPromise)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
     */
    //TODO how to model instance.some()?
    some<U>(count:number):Promise<U[]>;

    /**
     * Same as calling `Promise.race(thisPromise, count)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
     */
    //TODO how to model instance.race()?
    race<U>():Promise<U>;
     ...
     */
    //TODO how to model instance.map()?
    map<U>(mapper:(item:R, index:number, arrayLength:number) => Thenable<U>):Promise<U>;
    map<U>(mapper:(item:R, index:number, arrayLength:number) => U):Promise<U>;

    /**
     * Same as calling `Promise.reduce(thisPromise, Function reducer, initialValue)`. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
     */
    //TODO how to model instance.reduce()?
    reduce<U>(reducer:(total:number, current:R, index:number, arrayLength:number) => Thenable<U>, initialValue?:any):Promise<U>;
    reduce<U>(reducer:(total:number, current:R, index:number, arrayLength:number) => U, initialValue?:any):Promise<U>;

    /**
     * Same as calling ``Promise.filter(thisPromise, filterer)``. With the exception that if this promise is bound to a value, the returned promise is bound to that value too.
     */
    //TODO how to model instance.filter()?
    filter<U>(filterer:(item:R, index:number, arrayLength:number) => Thenable<U>):Promise<U>;
    filter<U>(filterer:(item:R, index:number, arrayLength:number) => U):Promise<U>;
}

interface PromiseResolver<R> {
    /**
...
declare module Promise {
    ...
    /*
    function try<R>(fn:() => Thenable<R>, args?:any[], ctx?:any):Promise<R>;
    function try<R>(fn:() => R, args?:any[], ctx?:any):Promise<R>;
    // custom array-like
    function try<R>(fn:() => Thenable<R>, args?:ArrayLike, ctx?:any):Promise<R>;
    function try<R>(fn:() => R, args?:ArrayLike, ctx?:any):Promise<R>;
    */

    function attempt<R>(fn:() => Thenable<R>, args?:any[], ctx?:any):Promise<R>;
    function attempt<R>(fn:() => R, args?:any[], ctx?:any):Promise<R>;
    // custom array-like
    function attempt<R>(fn:() => Thenable<R>, args?:ArrayLike, ctx?:any):Promise<R>;
    function attempt<R>(fn:() => R, args?:ArrayLike, ctx?:any):Promise<R>;
     ...
     */
    function reject(reason:any):Promise<void>;

    /**
     * Create a promise with undecided fate and return a `PromiseResolver` to control it. See resolution?:Promise(#promise-resolution).
     */
    function defer<R>():PromiseResolver<R>;
     ...
     */
    function cast<R>(value:Thenable<R>):Promise<R>;
    function cast<R>(value:R):Promise<R>;

    /**
     * Sugar for `Promise.resolve(undefined).bind(thisArg);`. See `.bind()`.
     */
    function bind(thisArg:any):Promise<void>;
    ...
    function delay<R>(value:Thenable<R>, ms:number):Promise<R>;
    // function delay<R>(value:R, ms:number):Promise<R>;
    ...
    function coroutine<R>(generatorFunction:Function):Function;

    /**
     * Spawn a coroutine which may yield promises to run asynchronous code synchronously. This feature requires the support of generators which are drafted in the next version of the language. Node version greater than `0.11.2` is required and needs to be executed with the `--harmony-generators` (or `--harmony`) command-line switch.
     */
    //TODO fix spawn GeneratorFunction
    function spawn<R>(generatorFunction:Function):Promise<R>;
     ...
     */
    function noConflict():typeof Promise;
    ...
    // function all<R>(values:Thenable<Thenable<R>[]>):Promise<R[]>;
    // promise of array with values
    // function all<R>(values:Thenable<R[]>):Promise<R[]>;
    // array with promises of value
    function all<R>(values:Thenable<R>[]):Promise<R[]>;
    // array with values
    function all<R>(values:R[]):Promise<R[]>;
    ...
    function props(object:Promise<Object>):Promise<Object>;
    // object
    function props(object:Object):Promise<Object>;
    ...
    //TODO enable more overloads
    // promise of array with promises of value
    // function settle<R>(values:Thenable<Thenable<R>[]>):Promise<PromiseInspection<R>[]>;
    // promise of array with values
    // function settle<R>(values:Thenable<R[]>):Promise<PromiseInspection<R>[]>;
    // array with promises of value
    function settle<R>(values:Thenable<R>[]):Promise<PromiseInspection<R>[]>;
    // array with values
    function settle<R>(values:R[]):Promise<PromiseInspection<R>[]>;
    ...
    //TODO enable more overloads
    // promise of array with promises of value
    // function any<R>(values:Thenable<Thenable<R>[]>):Promise<R>;
    // promise of array with values
    // function any<R>(values:Thenable<R[]>):Promise<R>;
    // array with promises of value
    function any<R>(values:Thenable<R>[]):Promise<R>;
    // array with values
    function any<R>(values:R[]):Promise<R>;
    ...
    //TODO enable more overloads
    // promise of array with promises of value
    // function race<R>(values:Thenable<Thenable<R>[]>):Promise<R>;
    // promise of array with values
    // function race<R>(values:Thenable<R[]>):Promise<R>;
    // array with promises of value
    function race<R>(values:Thenable<R>[]):Promise<R>;    
    // array with values
    function race<R>(values:R[]):Promise<R>;
    ...
    //TODO enable more overloads
    // promise of array with promises of value
    // function some<R>(values:Thenable<Thenable<R>[]>, count:number):Promise<R>;
    // promise of array with values
    // function some<R>(values:Thenable<R[]>, count:number):Promise<R[]>;
    // array with promises of value
    function some<R>(values:Thenable<R>[], count:number):Promise<R[]>;
    // array with values
    function some<R>(values:R[], count:number):Promise<R[]>;

    /**
     * Like `Promise.all()` but instead of having to pass an array, the array is generated from the passed variadic arguments.
     */
    //TODO not quite like Promise.all() or does it miss something?
    // variadic array with promises of value
    function join<R>(...values:Thenable<R>[]):Promise<R[]>;
    // variadic array with values
    function join<R>(...values:R[]):Promise<R[]>;
    ...
    //TODO enable more overloads
    // promise of array with promises of value
    // function map<R, U>(values:Thenable<Thenable<R>[]>, mapper:(item:R, index:number, arrayLength:number) => Thenable<U>):Promise<U[]>;
    // function map<R, U>(values:Thenable<Thenable<R>[]>, mapper:(item:R, index:number, arrayLength:number) => U):Promise<U[]>;

    // promise of array with values
    // function map<R, U>(values:Thenable<R[]>, mapper:(item:R, index:number, arrayLength:number) => Thenable<U>):Promise<U[]>;
    // function map<R, U>(values:Thenable<R[]>, mapper:(item:R, index:number, arrayLength:number) => U):Promise<U[]>;
    ...
    // array with values
    function map<R, U>(values:R[], mapper:(item:R, index:number, arrayLength:number) => Thenable<U>):Promise<U[]>;
    function map<R, U>(values:R[], mapper:(item:R, index:number, arrayLength:number) => U):Promise<U[]>;
    ...
    //TODO enable more overloads
    // promise of array with promises of value
    // function reduce<R, U>(values:Thenable<Thenable<R>[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => Thenable<U>, initialValue?:U):Promise<U>;
    // function reduce<R, U>(values:Thenable<Thenable<R>[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => U, initialValue?:U):Promise<U>;

    // promise of array with values
    // function reduce<R, U>(values:Thenable<R[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => Thenable<U>, initialValue?:U):Promise<U>;
    // function reduce<R, U>(values:Thenable<R[]>, reducer:(total:U, current:R, index:number, arrayLength:number) => U, initialValue?:U):Promise<U>;
    ...
    // array with values
    function reduce<R, U>(values:R[], reducer:(total:U, current:R, index:number, arrayLength:number) => Thenable<U>, initialValue?:U):Promise<U>;
    function reduce<R, U>(values:R[], reducer:(total:U, current:R, index:number, arrayLength:number) => U, initialValue?:U):Promise<U>;
    ...
    //TODO enable more overloads
    // promise of array with promises of value
    // function filter<R>(values:Thenable<Thenable<R>[]>, filterer:(item:R, index:number, arrayLength:number) => Thenable<boolean>):Promise<R[]>;
    // function filter<R>(values:Thenable<Thenable<R>[]>, filterer:(item:R, index:number, arrayLength:number) => boolean):Promise<R[]>;

    // promise of array with values
    // function filter<R>(values:Thenable<R[]>, filterer:(item:R, index:number, arrayLength:number) => Thenable<boolean>):Promise<R[]>;
    // function filter<R>(values:Thenable<R[]>, filterer:(item:R, index:number, arrayLength:number) => boolean):Promise<R[]>;
    ...
    // array with values
    function filter<R>(values:R[], filterer:(item:R, index:number, arrayLength:number) => Thenable<boolean>):Promise<R[]>;
    function filter<R>(values:R[], filterer:(item:R, index:number, arrayLength:number) => boolean):Promise<R[]>;
}
