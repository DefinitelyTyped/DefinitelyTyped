...
declare class Libpq {
   ...
   *
   * @returns {boolean} true if data was read. Returns false if there was an error. You can access
   ...
   * {@link Libpq#flush} again. Returns 0 if all data was flushed. Returns -1 if there was an
   * error.
   */
  flush(): number;
   ...
   *
   * @returns {boolean} true if libpq was able to read buffered data & parse a result object, or
   ...
   * data. Returns false if all data has been read from the socket. Once this returns false it is
