...
declare module "react" {
    // Imports from JSX
    import ClassicComponent = JSX.React.ClassicComponent;
    import ClassicComponentClass = JSX.React.ClassicComponentClass;
    import ClassicElement = JSX.React.ClassicElement;
    import ClassicFactory = JSX.React.ClassicFactory;
    import Component = JSX.React.Component;
    import ComponentClass = JSX.React.ComponentClass;
    import ComponentSpec = JSX.React.ComponentSpec;
    import DOMComponent = JSX.React.DOMComponent;
    import DOMElement = JSX.React.DOMElement;
    import DOMFactory = JSX.React.DOMFactory;
    import Factory = JSX.React.Factory;
    import ReactElement = JSX.React.ReactElement;
    import ReactChild = JSX.React.ReactChild;
    import ReactChildren = JSX.React.ReactChildren;
    import ReactNode = JSX.React.ReactNode;
    import ReactPropTypes = JSX.React.ReactPropTypes;
    import HTMLFactory = JSX.React.HTMLFactory;
    import SVGFactory = JSX.React.SVGFactory;
