...
declare namespace reactInputMask {
    export interface ReactInputMaskProps extends __React.HTMLAttributes {
        /**
    ...
    export class ReactInputMask extends __React.Component<ReactInputMaskProps, ReactInputMaskState> {
    }
}
