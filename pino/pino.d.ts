// Type definitions for pino v2.12.3
...
declare module 'pino' {
    ...
    namespace pino {
        ...
        export type LevelLabelsToValues = {[level: string]: number}
        export type LevelValuesToLabels = {[level: number]: string}
        ...
        export type LevelChangeEventListener = (lvl: string, val: number, prevLvl: string, prevVal: number) => void
        export type LevelChangeEvent = 'level-change'
