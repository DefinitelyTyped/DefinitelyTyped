...
import { Animated, TextStyle, ViewProps, ViewStyle, StyleProp } from 'react-native';
...
export type NavigationScreenOption<T> = T | ((navigation: NavigationScreenProp<NavigationRoute>, config: T) => T);
...
export type NavigationScreenComponent<Params = NavigationParams, Options = {}, Props = {}> = React.ComponentType<
    NavigationScreenProps<Params, Options> & Props
> & {
    navigationOptions?: NavigationScreenConfig<Options>;
};

export type NavigationNavigator<State = NavigationState, Options = {}, Props = {}> = React.ComponentType<
    NavigationNavigatorProps<Options, State> & Props
> & {
...
export interface NavigationStackScreenOptions {
    ...
    headerLeft?: React.ReactElement | ((backButtonProps: HeaderBackButtonProps) => React.ReactElement) | null;
...
interface NavigationTabScreenOptionsBase {
    ...
    tabBarIcon?:
        | React.ReactElement
        | ((options: { tintColor: string | null; focused: boolean; horizontal: boolean }) => React.ReactElement | null);
    tabBarLabel?:
        | string
        | React.ReactElement
...
export interface NavigationTabScreenOptions extends NavigationTabScreenOptionsBase {
...
export interface NavigationBottomTabScreenOptions extends NavigationTabScreenOptionsBase {
    tabBarOnPress?: (options: {
        navigation: NavigationScreenProp<NavigationRoute>;
        defaultHandler: () => void;
    }) => void;
...
export type EventType = 'willFocus' | 'didFocus' | 'willBlur' | 'didBlur' | 'action';
...
export interface NavigationScreenProp<S, P = NavigationParams> {
    ...
    navigate(routeNameOrOptions: string, params?: NavigationParams, action?: NavigationAction): boolean;
    openDrawer: () => any;
    closeDrawer: () => any;
    toggleDrawer: () => any;
    ...
    addListener: (eventName: EventType, callback: NavigationEventCallback) => NavigationEventSubscription;
...
export type NavigationStyleInterpolator = (props: NavigationSceneRendererProps) => ViewStyle;
...
export type NavigatorType = 'react-navigation/STACK' | 'react-navigation/TABS' | 'react-navigation/DRAWER';
...
export interface NavigationContainerComponent
    extends React.Component<NavigationContainerProps & NavigationNavigatorProps<any>> {
    dispatch: NavigationDispatch;
}

export interface NavigationContainer
    extends React.ComponentClass<NavigationContainerProps & NavigationNavigatorProps<any>> {
...
export interface BottomTabNavigatorConfig extends NavigationBottomTabRouterConfig, TabViewConfig {
    lazy?: boolean;
    resetOnBlur?: boolean;
    removeClippedSubviews?: boolean;
    initialLayout?: { height: number; width: number };
...
export interface TabBarTopProps {
    ...
    getOnPress: (
        ...
        scene: TabScene
    ) => (args: { previousScene: NavigationRoute; scene: TabScene; jumpToIndex: (index: number) => void }) => void;
...
export namespace StackActions {
    ...
    function replace(options: NavigationReplaceActionPayload): NavigationReplaceAction;

    function completeTransition(payload: NavigationCompleteTransitionActionPayload): NavigationCompleteTransitionAction;
}
...
export interface TransitionerProps {
    ...
    render: (transitionProps: NavigationTransitionProps, prevTransitionProps?: NavigationTransitionProps) => any;
 ...
 */
export function createNavigationContainer(Component: NavigationNavigator<any, any, any>): NavigationContainer;
 ...
 */
export function createAppContainer(Component: NavigationNavigator<any, any, any>): NavigationContainer;
