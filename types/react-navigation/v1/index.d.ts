...
export type NavigationComponent = NavigationScreenComponent<any, any, any> | NavigationNavigator<any, any, any>;
...
export interface NavigationTabScreenOptions {
    ...
    tabBarOnPress?: (options: { scene: TabScene; jumpToIndex: (index: number) => void }) => void;
}
