...
const BasicTabNavigator = createTabNavigator(routeConfigMap, tabNavigatorConfig);
...
const BasicDrawerNavigator = createDrawerNavigator(routeConfigMap, stackNavigatorConfig);
