    ...
    Y.Test.Runner.add(
        new Y.Test.Case({
            ...
            testVector1: function() {
                Y.Assert.areEqual(
                    "7494c2e7104b0879",
                    C.RC4.encrypt(C.enc.Hex.parse("0000000000000000"), C.enc.Hex.parse("0123456789abcdef")).ciphertext
                        .toString(),
                );
            },
            ...
            testVector2: function() {
                Y.Assert.areEqual(
                    "f13829c9de",
                    C.RC4.encrypt(C.enc.Hex.parse("dcee4cf92c"), C.enc.Hex.parse("618a63d2fb")).ciphertext.toString(),
                );
            },
