        ...
        new Y.Test.Case({
            ...
            testDecrypt2: function() {
                Y.Assert.areEqual(
                    "0000000000000000",
                    C.TripleDES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("869efd7f9f265a09") }),
                        C.enc.Hex.parse("010101010101010201010101010101020101010101010102"),
                        { mode: C.mode.ECB, padding: C.pad.NoPadding },
                    ).toString(),
                );
            ...
            testDecrypt3: function() {
                Y.Assert.areEqual(
                    "8000000000000000",
                    C.TripleDES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("95f8a5e5dd31d900") }),
                        C.enc.Hex.parse("010101010101010101010101010101010101010101010101"),
                        { mode: C.mode.ECB, padding: C.pad.NoPadding },
                    ).toString(),
                );
            ...
            testDecrypt4: function() {
                Y.Assert.areEqual(
                    "0000000000000001",
                    C.TripleDES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("166b40b44aba4bd6") }),
                        C.enc.Hex.parse("010101010101010101010101010101010101010101010101"),
                        { mode: C.mode.ECB, padding: C.pad.NoPadding },
                    ).toString(),
                );
            ...
            testHelper: function() {
                ...
                // Test
                Y.Assert.areEqual(
                    C.algo.TripleDES.createEncryptor(C.SHA256("Jefe"), { mode: C.mode.ECB, padding: C.pad.NoPadding })
                        .finalize("Hi There").toString(),
                    C.TripleDES.encrypt("Hi There", C.SHA256("Jefe"), { mode: C.mode.ECB, padding: C.pad.NoPadding })
                        .ciphertext.toString(),
                );
                Y.Assert.areEqual(
                ...
                Y.Assert.areEqual(
                    ...
                    C.TripleDES.encrypt("Hi There", "Jefe", { mode: C.mode.ECB, padding: C.pad.NoPadding }).toString(),
                );
