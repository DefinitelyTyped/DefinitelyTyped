        ...
        new Y.Test.Case({
            ...
            testDecrypt1: function() {
                Y.Assert.areEqual(
                    "0000000000000000",
                    C.DES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("95a8d72813daa94d") }),
            ...
            testDecrypt2: function() {
                Y.Assert.areEqual(
                    "0000000000000000",
                    C.DES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("1de5279dae3bed6f") }),
            ...
            testDecrypt3: function() {
                Y.Assert.areEqual(
                    "0000000000002000",
                    C.DES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("1d1ca853ae7c0c5f") }),
            ...
            testDecrypt4: function() {
                Y.Assert.areEqual(
                    "3232323232323232",
                    C.DES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("ac978c247863388f") }),
            ...
            testDecrypt5: function() {
                Y.Assert.areEqual(
                    "6464646464646464",
                    C.DES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("3af1703d76442789") }),
            ...
            testDecrypt6: function() {
                Y.Assert.areEqual(
                    "9696969696969696",
                    C.DES.decrypt(
                        C.lib.CipherParams.create({ ciphertext: C.enc.Hex.parse("a020003c5554f34c") }),
            ...
            testMultiPart: function() {
                var des = C.algo.DES.createEncryptor(C.enc.Hex.parse("0123456789abcdef"), {
                    mode: C.mode.ECB,
                    padding: C.pad.NoPadding,
                });
            ...
            testHelper: function() {
                ...
                Y.Assert.areEqual(
                    ...
                    C.DES.encrypt("Hi There", C.SHA256("Jefe"), { mode: C.mode.ECB, padding: C.pad.NoPadding })
                        .ciphertext.toString(),
                );
                Y.Assert.areEqual(
