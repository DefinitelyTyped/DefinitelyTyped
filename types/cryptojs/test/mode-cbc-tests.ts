    ...
    Y.Test.Runner.add(
        new Y.Test.Case({
            ...
            testEncryptor: function() {
                ...
                // Compute actual
                var actual = C.AES.encrypt(this.data.message, this.data.key, {
                    iv: this.data.iv,
                    mode: C.mode.CBC,
            ...
            testDecryptor: function() {
                var encrypted = C.AES.encrypt(this.data.message, this.data.key, {
                    iv: this.data.iv,
                    mode: C.mode.CBC,
                    padding: C.pad.NoPadding,
                });
                var decrypted = C.AES.decrypt(encrypted, this.data.key, {
                    iv: this.data.iv,
                    mode: C.mode.CBC,
                    padding: C.pad.NoPadding,
                });
