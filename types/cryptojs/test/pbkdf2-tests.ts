        ...
        new Y.Test.Case({
            ...
            testKeySize128Iterations1200: function() {
                Y.Assert.areEqual(
                    ...
                    C.PBKDF2("password", "ATHENA.MIT.EDUraeburn", { keySize: 128 / 32, iterations: 1200 }).toString(),
                );
            },
            ...
            testKeySize256Iterations1200: function() {
                Y.Assert.areEqual(
                    ...
                    C.PBKDF2("password", "ATHENA.MIT.EDUraeburn", { keySize: 256 / 32, iterations: 1200 }).toString(),
                );
            },
            ...
            testKeySize128Iterations5: function() {
                Y.Assert.areEqual(
                    ...
                    C.PBKDF2("password", C.enc.Hex.parse("1234567878563412"), { keySize: 128 / 32, iterations: 5 })
                        .toString(),
                );
            },
            ...
            testKeySize256Iterations5: function() {
                Y.Assert.areEqual(
                    ...
                    C.PBKDF2("password", C.enc.Hex.parse("1234567878563412"), { keySize: 256 / 32, iterations: 5 })
                        .toString(),
                );
            },
            ...
            testKeySize128Iterations50: function() {
                Y.Assert.areEqual(
                    ...
                    C.PBKDF2(C.enc.Hex.parse("f09d849e"), "EXAMPLE.COMpianist", { keySize: 128 / 32, iterations: 50 })
                        .toString(),
                );
            },
            ...
            testKeySize256Iterations50: function() {
                Y.Assert.areEqual(
                    ...
                    C.PBKDF2(C.enc.Hex.parse("f09d849e"), "EXAMPLE.COMpianist", { keySize: 256 / 32, iterations: 50 })
                        .toString(),
                );
            },
            ...
            testHelper: function() {
                Y.Assert.areEqual(
                    C.algo.PBKDF2.create({ keySize: 128 / 32 }).compute("password", "ATHENA.MIT.EDUraeburn").toString(),
                    C.PBKDF2("password", "ATHENA.MIT.EDUraeburn", { keySize: 128 / 32 }).toString(),
                );
            },
        }),
