        ...
        new Y.Test.Case({
            ...
            testVector7: function() {
                Y.Assert.areEqual(
                    ...
                    C.SHA256("12345678901234567890123456789012345678901234567890123456789012345678901234567890")
                        .toString(),
                );
            },
            ...
            testHmacHelper: function() {
                Y.Assert.areEqual(
                    C.algo.HMAC.create(C.algo.SHA256, C.enc.Hex.parse("0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b0b")).finalize(
                        "Hi There",
                    ).toString(),
