...
declare namespace gapi.client.surveys {
...
declare namespace gapi.client {
    // Load Surveys API v2
    export function load (name: "surveys", version: "v2") : PromiseLike<void>;    
    export function load (name: "surveys", version: "v2", callback: () => any) : void;    
    
    const mobileapppanels: gapi.client.surveys.MobileapppanelsResource; 
    
    const results: gapi.client.surveys.ResultsResource; 
    
    const surveys: gapi.client.surveys.SurveysResource; 
