...
Joi.string().phoneNumber({ defaultCountry: Joi.ref('$country'), format: Joi.ref('$format'), strict: Joi.ref('$strict') }).validate('+123456789', { context: { country: 'US', format: 'e164', strict: true } });
