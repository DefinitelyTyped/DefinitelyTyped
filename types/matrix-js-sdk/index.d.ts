...
export type MembershipType = never | 'ban' | 'invite' | 'join' | 'leave';
...
export class IndexedDBStore extends MemoryStore {
    constructor(opts: { indexedDB: any; dbName?: string; workerScript?: string; workerApi?: any });
}
...
export class MatrixClient extends EventEmitter {
    ...
    getStateEvent(roomId: string, eventType: EventType, stateKey?: string, callback?: MatrixCallback): Promise<object>;
    ...
    requestVerification(userId: string, methods: string[], devices: string[]): Promise<CryptoVerificationBase>;
    ...
    sendEmoteMessage(roomId: string, body: string, txnId: string, callback?: MatrixCallback): Promise<void>;
    sendEvent(
        roomId: string,
        eventType: EventType,
        content: object,
    ...
    sendHtmlEmote(roomId: string, body: string, htmlBody: string, callback?: MatrixCallback): Promise<void>;
    sendHtmlMessage(roomId: string, body: string, htmlBody: string, callback?: MatrixCallback): Promise<void>;
    sendHtmlNotice(roomId: string, body: string, htmlBody: string, callback?: MatrixCallback): Promise<void>;
    sendImageMessage(roomId: string, url: string, info: object, text: string, callback?: MatrixCallback): Promise<void>;
    sendKeyBackup(roomId: string, sessionId: string, version: number, data: object): Promise<void>;
    sendMessage(roomId: string, content: object, txnId: string, callback?: MatrixCallback): Promise<void>;
    sendNotice(roomId: string, body: string, txnId: string, callback?: MatrixCallback): Promise<void>;
    ...
    setRoomAccountData(roomId: string, eventType: EventType, content: object, callback?: MatrixCallback): Promise<void>;
    setRoomDirectoryVisibility(roomId: string, visibility: string, callback?: MatrixCallback): Promise<object>;
