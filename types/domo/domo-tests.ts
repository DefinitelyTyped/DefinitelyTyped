...
var styleSheet = STYLE({ type: "text/css" }, STYLE.on("a", { color: "red" }), STYLE.on("*", { margin: 0, padding: 0 }));
...
var nestedStyles = STYLE({ type: "text/css" }, STYLE.on("a", { color: "red" }, STYLE.on("img", { borderWidth: 0 })));

var normalStyles = STYLE({ type: "text/css" }, STYLE.on("a", { color: "red" }), STYLE.on("a img", { borderWidth: 0 }));
