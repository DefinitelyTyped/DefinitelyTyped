...
export as namespace DMVAST;
export = DMVAST;

declare namespace DMVAST {
    const client: VastClient;
    const parser: VastParser;
    ...
    class tracker {
         ...
         */
        constructor(ad: DMVAST.VastAd, creative: DMVAST.VastCreativeLinear, companion?: DMVAST.VastCreativeCompanion);
        /**
    ...
    interface VastClient {
         ...
         */
        get(url: string, done: (response: DMVAST.VastResponse, error: Error) => void): void;
        get(url: string, options: DMVAST.VastRequestOptions, done: (response: DMVAST.VastResponse, error: Error) => void): void;
    }
    ...
    interface VastParser {
         ...
         */
        load(xml: string, done: (response: DMVAST.VastResponse, error: Error) => void): void;
        load(xml: string, options: DMVAST.VastRequestOptions, done: (response: DMVAST.VastResponse, error: Error) => void): void;
        /**
         ...
         */
        on(eventName: string, listener: (error: DMVAST.VastError) => void): void;
        /**
         ...
         * Hoverwise, in case of no ads, it will be null, and an error as a 2nd parameter is provided.
         */
        parse(url: string, done: (response: DMVAST.VastResponse, error: Error) => void): void;
        parse(url: string, options: DMVAST.VastRequestOptions, done: (response: DMVAST.VastResponse, error: Error) => void): void;
        /**
         * Remove the specified listener for the event named eventName.
         */
        off(eventName: string, listener: (error: DMVAST.VastError) => void): void;
        /**
    ...
    interface VastCreativeCompanion {
        type: string;
