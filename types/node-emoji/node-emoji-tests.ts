...
const coffee: string | undefined = emoji.get('coffee');
...
const emoji_string2: string = emoji.emojify('I :unknown_emoji: :star: :another_one:', {
...
const replaced_emoji: string = emoji.replace('⚠️ 〰️ 〰️ low disk space', (emoji) => `${emoji.emoji}:`);
