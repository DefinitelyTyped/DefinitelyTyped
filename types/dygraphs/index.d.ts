...
declare namespace dygraphs {
    ...
    type dateTicker<T extends HTMLElement> = (
        min: number,
        max: number,
        pixels: number,
    ...
    type numericTicks<T extends HTMLElement> = dateTicker<T>;

    type AnnotationClickHandler<T extends HTMLElement> = (
    ...
    type AnnotationDblClickHandler<T extends HTMLElement> = AnnotationClickHandler<T>;

    type AnnotationMouseOutHandler<T extends HTMLElement> = AnnotationClickHandler<T>;

    type AnnotationMouseOverHandler<T extends HTMLElement> = AnnotationClickHandler<T>;

    interface DataHandler<T extends HTMLElement> {
        /**
         ...
         */
        extractSeries(dygraph: Readonly<Dygraph<T>>, rawData: any, seriesIndex: any): any;
         ...
         *    used if needed.
         */
        rollingAverage(dygraph: Readonly<Dygraph<T>>, unifiedData: any, rollPeriod: any): any;
         ...
         */
        getExtremeYValues(dygraph: Readonly<Dygraph<T>>, unifiedData: any, dateWindow: any): any;
         ...
         * draw the error bars.)
         */
        onPointCreated(dygraph: Readonly<Dygraph<T>>, seriesPoint: any, unifiedDataSample: any): any;
         ...
         */
        onLineEvaluated(dygraph: Readonly<Dygraph<T>>, seriesPoints: any, dataset: any, setName: any): any;
    }
    ...
    interface PerAxisOptions<T extends HTMLElement> {
         ...
         */
        ticker?: dateTicker<T> | numericTicks<T> | null;
    ...
    interface Options<T extends HTMLElement> extends PerSeriesOptions, PerAxisOptions<T> {
         ...
         * @default null
         */
        axes?: Partial<Record<Axis, PerAxisOptions<T>>> | null;

        /**
         * A function to call when the canvas is clicked.
         * @default null
         */
        clickCallback?: ((event: MouseEvent, xval: number, points: ReadonlyArray<Point<T>>) => void) | null;
         ...
         * @default null
         */
        drawCallback?: ((dygraph: Readonly<Dygraph<T>>, is_initial: boolean) => void) | null;
         ...
         * @default null
         */
        legendFormatter?: ((data: LegendData<T>) => string) | null;
         ...
         * @default null
         */
        pointClickCallback?: ((event: MouseEvent, point: Readonly<Point<T>>) => void) | null;
         ...
         */
        underlayCallback?:
            | ((context: CanvasRenderingContext2D, area: Readonly<Area>, dygraph: Readonly<Dygraph<T>>) => void)
            | null;
