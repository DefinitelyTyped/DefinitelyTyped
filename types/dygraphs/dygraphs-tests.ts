...
function twoAxes() {
    ...
    var g = new Dygraph(document.getElementById('demodiv'), data, {
    ...
    var g2 = new Dygraph(document.getElementById('demodiv_y2_primary'), data, {
        labels: ['Date', 'Y1', 'Y2', 'Y3', 'Y4'],
        ylabel: 'Primary y-axis',
        y2label: 'Secondary y-axis',
        series: {
    ...
    var g3 = new Dygraph(document.getElementById('demodiv_two_grids'), data, {
        labels: ['Date', 'Y1', 'Y2', 'Y3', 'Y4'],
        ylabel: 'Primary y-axis',
        y2label: 'Secondary y-axis',
        series: {
    ...
    var g4 = new Dygraph(document.getElementById('demodiv_one'), data, {
        labels: ['Date', 'Y1', 'Y2', 'Y3', 'Y4'],
        labelsKMB: true,
        ylabel: 'Primary y-axis',
        y2label: 'Secondary y-axis',
    ...
    var g5 = new Dygraph(document.getElementById('demodiv_one_right'), data, {
        labels: ['Date', 'Y1', 'Y2', 'Y3', 'Y4'],
        ylabel: 'Primary y-axis',
        y2label: 'Secondary y-axis',
        series: {
...
function perSeries() {
    ...
    var g2 = new Dygraph(document.getElementById('demodiv2'), data, {
        legend: 'always',
        strokeWidth: 2,
        series: {
            parabola: {
    ...
    var g3 = new Dygraph(document.getElementById('demodiv3'), data, {
        strokeWidth: 2,
        series: {
            parabola: {
                strokeWidth: 0.0,
