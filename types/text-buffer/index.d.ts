...
declare namespace TextBuffer {
	...
	namespace Options {
		...
		interface FindMarker {
			...
			startsInRange?: RangeLike|[PointLike, PointLike]|[PointLike, [number, number]]|
				[[number, number], PointLike]|[[number, number], [number, number]];

			/** Only include markers that end inside the given Range. */
			endsInRange?: RangeLike|[PointLike, PointLike]|[PointLike, [number, number]]|
				[[number, number], PointLike]|[[number, number], [number, number]];
			...
			containsRange?: RangeLike|[PointLike, PointLike]|
...
declare module "text-buffer" {
	let tb: TextBuffer.Statics.TextBuffer;
	export = tb;
}
