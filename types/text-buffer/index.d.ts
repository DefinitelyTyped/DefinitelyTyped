...
declare namespace TextBuffer {
	...
	namespace Params {
		...
		interface FindMarkerProps {
			...
			endBufferPosition?: PointLike|[number, number];
	...
	interface PointStatic {
		...
		min(point1: PointLike, point2: PointLike): Point;
		/** Returns the given Point that is earlier in the buffer. */
		min(point1: [number, number], point2: [number, number]): Point;
		/** Returns the given Point that is earlier in the buffer. */
		min(point1: PointLike, point2: [number, number]): Point;
		/** Returns the given Point that is earlier in the buffer. */
		min(point1: [number, number], point2: PointLike): Point;
	}
	...
	interface RangeStatic {
		...
		fromObject(object: RangeLike, copy?: boolean): Range;
		/** Convert any range-compatible object to a Range. */
		fromObject(object: [PointLike, PointLike]): Range;
		/** Convert any range-compatible object to a Range. */
		fromObject(object: [PointLike, [number, number]]): Range;
		/** Convert any range-compatible object to a Range. */
		fromObject(object: [[number, number], PointLike]): Range;
		/** Convert any range-compatible object to a Range. */
		fromObject(object: [[number, number], [number, number]]): Range;

		/** Construct a Range object. */
		new (pointA?: PointLike, pointB?: PointLike): Range;
		/** Construct a Range object. */
		new (pointA: [number, number], pointB?: [number, number]): Range;
		/** Construct a Range object. */
		new (pointA: PointLike, pointB: [number, number]): Range;
		/** Construct a Range object. */
		new (pointA: [number, number], pointB: PointLike): Range;
	...
	interface Range extends RangeLike {
		// Properties
		/** A Point representing the start of the Range. */
		start: PointLike;
	...
	interface MarkerLayer {
		...
		findMarkers(params: {
			startPosition?: PointLike|[number, number],
			endPosition?: PointLike|[number, number],
			containsPoint?: PointLike|[number, number],
			containsRange?: RangeLike|[PointLike, PointLike]|[[number, number], [number, number]]|
				[PointLike, [number, number]]|[[number, number], PointLike]
			startRow?: number,
			endRow?: number,
	...
	interface TextBuffer {
		...
		backwardsScan(regex: RegExp, iterator: (match: object, matchText: string,
			range: Range, stop: Function, replace: Function, leadingContextLines: string[],
			trailingContextLines: string[]) => void): void;
		/** Scan regular expression matches in the entire buffer in reverse order,
		 *  calling the given iterator function on each match.
		 */
		 ...
		 *  iterator function on each match.
		 */
		scanInRange(regex: RegExp, range: RangeLike, iterator: (match: object,
		 ...
		 *  iterator function on each match.
		 */
		scanInRange(regex: RegExp, range: [PointLike, PointLike], iterator: (match: object,
			matchText: string, range: Range, stop: Function, replace: Function,
			leadingContextLines: string[], trailingContextLines: string[]) => void): void;
		/** Scan regular expression matches in a given range , calling the given
		 *  iterator function on each match.
		 ...
		 *  calling the given iterator function on each match.
		 */
		backwardsScanInRange(regex: RegExp, range: RangeLike, iterator: (match: object,
			matchText: string, range: Range, stop: Function, replace: Function, leadingContextLines:
			string[], trailingContextLines: string[]) => void): void;
		/** Scan regular expression matches in a given range in reverse order,
		 *  calling the given iterator function on each match.
		 */
		backwardsScanInRange(regex: RegExp, range: [PointLike, PointLike], iterator: (match: object,
			matchText: string, range: Range, stop: Function, replace: Function, leadingContextLines:
			string[], trailingContextLines: string[]) => void): void;
		/** Scan regular expression matches in a given range in reverse order,
		 *  calling the given iterator function on each match.
		...
		backwardsScanInRange(regex: RegExp, range: [[number, number], [number, number]],
			iterator: (match: object, matchText: string, range: Range, stop: Function,
			replace: Function, leadingContextLines: string[], trailingContextLines: string[]) => void): void;
		/** Scan regular expression matches in a given range in reverse order,
		 *  calling the given iterator function on each match.
		 */
	...
	interface DisplayMarker {
		...
		copy(properties?: { type?: string|null, tailed?: boolean, reversed?: boolean,
			invalidate?: "never"|"surround"|"overlap"|"inside"|"touch", exclusive?: boolean,
			properties?: object }): DisplayMarker;
...
declare module "text-buffer" {
	let tb: TextBuffer.TextBufferStatic;
	export = tb;
}
