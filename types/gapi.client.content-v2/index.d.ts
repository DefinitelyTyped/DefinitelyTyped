...
declare namespace gapi.client {
    ...
    export function load (name: "content", version: "v2") : PromiseLike<void>;    
    export function load (name: "content", version: "v2", callback: () => any) : void;    
    
    const accounts: gapi.client.content.AccountsResource; 
    
    const accountstatuses: gapi.client.content.AccountstatusesResource; 
    
    const accounttax: gapi.client.content.AccounttaxResource; 
    
    const datafeeds: gapi.client.content.DatafeedsResource; 
    
    const datafeedstatuses: gapi.client.content.DatafeedstatusesResource; 
    
    const inventory: gapi.client.content.InventoryResource; 
    
    const orders: gapi.client.content.OrdersResource; 
    
    const products: gapi.client.content.ProductsResource; 
    
    const productstatuses: gapi.client.content.ProductstatusesResource; 
    
    const shippingsettings: gapi.client.content.ShippingsettingsResource; 
