declare module "@zerobounce/zero-bounce-sdk" {
  ...
  export interface GuessFormatPayload {
    domain: string;
    first_name?: string;
    middle_name?: string;
    last_name?: string;
  ...
  export default class ZeroBounceSDK {
    ...
    getScoringFile(fileId: string): Promise<GetFileResponse>;
    deleteFile(fileId: string): Promise<DeleteFileResponse>;
    deleteScoringFile(fileId: string): Promise<DeleteFileResponse>;
    guessFormat(payload: GuessFormatPayload): Promise<GuessFormatResponse>;
  }
}
