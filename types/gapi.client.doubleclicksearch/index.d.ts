...
declare namespace gapi.client.doubleclicksearch {
...
declare namespace gapi.client {
    ...
    const conversion: gapi.client.doubleclicksearch.ConversionResource; 
    
    const reports: gapi.client.doubleclicksearch.ReportsResource; 
    
    const savedColumns: gapi.client.doubleclicksearch.SavedColumnsResource; 
