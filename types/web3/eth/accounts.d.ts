...
export interface Account {
    ...
    signTransaction(tx: Tx, cb?: (err: Error, result: TxSignature) => void): Promise<TxSignature>;
...
export default interface Accounts {
    ...
    signTransaction(tx: Tx, privateKey: string, cb?: (err: Error, result: TxSignature) => void): Promise<TxSignature>;
    recoverTransaction(signature: string): string;
    sign(data: string, privateKey: string): MessageSignature;
