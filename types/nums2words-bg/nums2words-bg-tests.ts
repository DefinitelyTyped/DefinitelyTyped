...
// $ExpectType string
nums2wordsBG.currency("12.34", {separator: "ae ", labelBig: "лв.", labelSmall: "ст.", displayBig: false, displaySmall: true, currency: "rub"});
...
nums2wordsBG.time("1:23:45", { labelHour: "h ", labelMinute: "m ", labelSecond: "s ", separator: ", ", displayHour: true, displayMinute: false, displaySecond: true});
...
// $ExpectType string
nums2wordsBG.date("1.1.1.1", { format: "a/y/d/m", separator: ", ", labels: {d: "d ", w: "w ", m: "m ", y: "y ", a: "a "}}); // "един век, една година, един ден, един месец"
