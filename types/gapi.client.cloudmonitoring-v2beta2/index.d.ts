...
declare namespace gapi.client.cloudmonitoring {
...
declare namespace gapi.client {
    ...
    export function load (name: "cloudmonitoring", version: "v2beta2") : PromiseLike<void>;    
    export function load (name: "cloudmonitoring", version: "v2beta2", callback: () => any) : void;    
    
    const metricDescriptors: gapi.client.cloudmonitoring.MetricDescriptorsResource; 
    
    const timeseries: gapi.client.cloudmonitoring.TimeseriesResource; 
    
    const timeseriesDescriptors: gapi.client.cloudmonitoring.TimeseriesDescriptorsResource; 
