namespace TestApp {
    class TestController {
        constructor($scope: ng.IScope, $document: duScroll.IDocumentService) {
            ...
            $document
                .duScrollTo(positionFromLeft, positionFromTop, durationInMillis, this.invertedEasingFn)
            ...
            $document
                .duScrollTo(someElement, offsetInPixels, durationInMillis, this.invertedEasingFn)
                .then(this.onScrollCompleted);
            ...
            $document
                .duScrollToElement(someElement, offsetInPixels, durationInMillis, this.invertedEasingFn)
                .then(this.onScrollCompleted);
            ...
            $document
                .duScrollToElementAnimated(someElement, offsetInPixels, durationInMillis)
                .then(this.onScrollCompleted);
            $document
                .duScrollToElementAnimated(someElement, offsetInPixels, durationInMillis, this.invertedEasingFn)
                .then(this.onScrollCompleted);

            $document.duScrollTop(positionFromTop);
            $document.duScrollTop(positionFromTop, durationInMillis).then(this.onScrollCompleted);
            $document
                .duScrollTop(positionFromTop, durationInMillis, this.invertedEasingFn)
                .then(this.onScrollCompleted);
            ...
            $document
                .duScrollTopAnimated(positionFromTop, durationInMillis, this.invertedEasingFn)
                .then(this.onScrollCompleted);
            ...
            $document
                .duScrollLeft(positionFromLeft, durationInMillis, this.invertedEasingFn)
                .then(this.onScrollCompleted);
            ...
            $document
                .duScrollLeftAnimated(positionFromLeft, durationInMillis, this.invertedEasingFn)
                .then(this.onScrollCompleted);
    ...
    angular.module('testApp', ['duScroll']).controller('testController', TestController);
}
