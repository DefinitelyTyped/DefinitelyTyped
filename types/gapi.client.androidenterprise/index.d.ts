...
declare namespace gapi.client.androidenterprise {
    ...
    interface EnterprisesResource {
        ...
        getAndroidDevicePolicyConfig(request: {        
            ...
            /** The ID of the enterprise. */
            enterpriseId: string;
        }): gapi.client.Request<AndroidDevicePolicyConfig>;        
...
declare namespace gapi.client {
    ...
    const devices: gapi.client.androidenterprise.DevicesResource; 
    
    const enterprises: gapi.client.androidenterprise.EnterprisesResource; 
    
    const entitlements: gapi.client.androidenterprise.EntitlementsResource; 
    
    const grouplicenses: gapi.client.androidenterprise.GrouplicensesResource; 
    
    const grouplicenseusers: gapi.client.androidenterprise.GrouplicenseusersResource; 
    
    const installs: gapi.client.androidenterprise.InstallsResource; 
    
    const managedconfigurationsfordevice: gapi.client.androidenterprise.ManagedconfigurationsfordeviceResource; 
    
    const managedconfigurationsforuser: gapi.client.androidenterprise.ManagedconfigurationsforuserResource; 
    
    const permissions: gapi.client.androidenterprise.PermissionsResource; 
    
    const products: gapi.client.androidenterprise.ProductsResource; 
    
    const serviceaccountkeys: gapi.client.androidenterprise.ServiceaccountkeysResource; 
    
    const storelayoutclusters: gapi.client.androidenterprise.StorelayoutclustersResource; 
    
    const storelayoutpages: gapi.client.androidenterprise.StorelayoutpagesResource; 
    
    const users: gapi.client.androidenterprise.UsersResource; 
