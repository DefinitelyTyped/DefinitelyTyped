...
declare namespace algoliasearchHelper {
    ...
    export class AlgoliaSearchHelper extends EventEmitter {
        ...
        searchOnce(
            ...
            cb: (error: any, content: SearchResults, state: SearchParameters) => any
        ): undefined;
    ...
    type ManagedParameters = { [K in ValueTypes<SearchParameters['managedParameters']>]: SearchParameters[K] };
    ...
    namespace SearchParameters {
        ...
        type OperatorList = { [k in Operator]?: Array<number | number[]> };
        type Operator = '=' | '>' | '>=' | '<' | '<=' | '!=';
    }
