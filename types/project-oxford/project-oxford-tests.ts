...
describe('Project Oxford Face API Test', function () {
    ...
    describe('#Person', function () {
        ...
        it('creates a Person', function (done) {
            client.face.person
                .create(personGroupId2, [billFaces[0]], 'test-bill', 'test-data')
                .then(function (response) {
        ...
        it('updates a Person', function (done) {
            client.face.person
                .update(personGroupId2, billPersonId, [billFaces[0]], 'test-bill', 'test-data')
                .then(function (response) {
                    assert.ok(true, 'void response expected');
                    done();
                });
        ...
        it('adds a face to a Person', function (done) {
            client.face.person
                .addFace(personGroupId2, billPersonId, billFaces[1], 'test-data')
                .then(function (response) {
                    assert.ok(true, 'void response expected');
                    done();
                })
        ...
        it('updates a face on a Person', function (done) {
            client.face.person
                .updateFace(personGroupId2, billPersonId, billFaces[1], 'test-data')
                .then(function (response) {
                    assert.ok(true, 'void response expected');
                    done();
                })
