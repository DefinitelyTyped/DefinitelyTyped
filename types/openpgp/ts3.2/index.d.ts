...
export namespace openpgp {
     ...
     */
        ...
        namespace crypto {
             ...
             */
            function publicKeyEncrypt(algo: enums.publicKey, pub_params: Array<type.mpi.MPI | type.oid.OID | type.kdf_params.KDFParams>, data: type.mpi.MPI, fingerprint: string): any[];
             ...
             */
            function publicKeyDecrypt(algo: enums.publicKey, key_params: Array<type.mpi.MPI | type.oid.OID | type.kdf_params.KDFParams>, data_params: Array<type.mpi.MPI | type.oid.OID | type.kdf_params.KDFParams>, fingerprint: string): type.mpi.MPI;
    ...
    interface revoke_reasonForRevocation {
        /**
    ...
    namespace message {
         ...
         * @returns list of signer's keyid and validity of signature
         */
        function createVerificationObjects(signatureList: any[], literalDataList: any[], keys: any[], date: Date): Promise<Array<{ keyid: type.keyid.Keyid, valid: boolean }>>;
         ...
         * @returns new message object
         */
        function fromBinary(bytes: Uint8Array | ReadableStream<Uint8Array>, filename?: string, date?: Date, type?: any): Message;
    }

    interface revokeKey_reasonForRevocation {
        /**
         * (optional) flag indicating the reason for revocation
         */
        flag: enums.reasonForRevocation;
     ...
     */
    function initWorker(path: string, n?: number, workers?: any[]): void;

    /**
     * Returns a reference to the async proxy if the worker was initialized with openpgp.initWorker()
     * @returns the async proxy or null if not initialized
     */
    function getWorker(): worker.async_proxy.AsyncProxy | null;
     ...
     */
    function generateKey(option: KeyOptions): Promise<{ key: key.Key, privateKeyArmored: string, publicKeyArmored: string, revocationCertificate: string }>;
     ...
     *          { key:Key, privateKeyArmored:String, publicKeyArmored:String, revocationCertificate:String }
     */
    function reformatKey(privateKey: key.Key, userIds: any[], passphrase?: string, keyExpirationTime?: number, revocationCertificate?: boolean): Promise<Object>;
     ...
     */
    function revokeKey(key?: key.Key, revocationCertificate?: string, reasonForRevocation?: revokeKey_reasonForRevocation): Promise<{
        privateKey: key.Key,
     ...
     */
    function decryptKey(privateKey: key.Key, passphrase: string | any[]): Promise<{ key: key.Key }>;
     ...
     */
    function encryptKey(privateKey: key.Key, passphrase: string | any[]): Promise<{ key: key.Key }>;
     ...
     *          }
     */
    function encrypt(options: EncryptOptions): Promise<EncryptResult>;
     ...
     *          }
     */
    function decrypt(options: DecryptOptions): Promise<DecryptResult>;
     ...
     *          }
     */
    function sign(options: SignOptions): Promise<SignResult>;
     ...
     *          }
     */
    function verify(options: VerifyOptions): Promise<VerifyResult>;
     ...
     */
    function encryptSessionKey(data: Uint8Array, algorithm: string, aeadAlgorithm?: string, publicKeys?: key.Key | key.Key[], passwords?: string | string[], wildcard?: boolean, date?: Date, toUserIds?: any[]): Promise<message.Message>;
     ...
     */
    function decryptSessionKeys(message: message.Message, privateKeys?: key.Key | key.Key[], passwords?: string | string[]): Promise<{ data: Uint8Array, algorithm: string }[] | undefined>;
     ...
     */
    function toArray(param: object): any[] | undefined;
     ...
     */
    function convertStream(data: object, streaming?: 'web' | 'node' | false): object;
     ...
     * @returns the data in the respective format
     */
    function convertStreams(obj: object, streaming: 'web' | 'node' | false, keys: any[]): object;
     ...
     * @returns
     */
    function linkStreams(result: object, message: message.Message, erroringStream: ReadableStream): object;

    /**
     * Wait until signature objects have been verified
     * @param signatures list of signatures
     */
    function prepareSignatures(signatures: object): void;
     ...
     */
    function onError(message: string, error: Error): void;
