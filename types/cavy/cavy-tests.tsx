...
import { hook, wrap, TestScope, WithTestHook, Tester, TestHookStore, useCavy, TestReport } from 'cavy';
    ...
    render() {
        ...
        return (
            <View ref={generateTestHook('View')}>
                <WrappedFunctionComponent ref={generateTestHook('WrappedFunctionComponent')} text="text" />

                <WrappedText ref={generateTestHook('WrappedText')}>Wrapped text</WrappedText>
...
function sampleSpec(spec: TestScope) {
    spec.describe('it has a name and callback', () => {
        ...
        spec.it('it has a name and callback', async () => {
            ...
            const functionComponent = (await spec.findComponent('WrappedFunctionComponent')) as React.Component<
                FCProps
            >;
