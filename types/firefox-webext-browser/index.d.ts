// Type definitions for non-npm package WebExtension Development in FireFox 120.0
...
web_accessible_resources?: string[] | Array<{
resources: string[];
 ...
 */
function testMatchOutcome(request: _TestMatchOutcomeRequest, options?: _TestMatchOutcomeOptions): Promise<_TestMatchOutcomeReturnResult>;
}
...
interface _PlainJSONObject {[key: string]: PlainJSONValue;}
}
 ...
 * @deprecated Unsupported on Firefox at this time.
 */
function removeCachedAuthToken(details: _RemoveCachedAuthTokenDetails): Promise<_RemoveCachedAuthTokenReturnUserinfo>;
...
interface _WebNavigationOnCreatedNavigationTargetEvent<TCallback = (details: _OnCreatedNavigationTargetDetails) => void> {
    addListener(cb: TCallback, filters?: EventUrlFilters): void;
    removeListener(cb: TCallback): void;
    hasListener(cb: TCallback): boolean;
}
...
interface _WebNavigationOnReferenceFragmentUpdatedEvent<TCallback = (details: _OnReferenceFragmentUpdatedDetails) => void> {
    addListener(cb: TCallback, filters?: EventUrlFilters): void;
    removeListener(cb: TCallback): void;
    hasListener(cb: TCallback): boolean;
}
...
interface _WebRequestOnBeforeRequestEvent<TCallback = (details: _OnBeforeRequestDetails) => BlockingResponse | Promise<BlockingResponse> | void> {
...
interface _WebRequestOnBeforeSendHeadersEvent<TCallback = (details: _OnBeforeSendHeadersDetails) => BlockingResponse | Promise<BlockingResponse> | void> {
...
interface _WebRequestOnHeadersReceivedEvent<TCallback = (details: _OnHeadersReceivedDetails) => BlockingResponse | Promise<BlockingResponse> | void> {
...
interface _WebRequestOnAuthRequiredEvent<TCallback = (details: _OnAuthRequiredDetails) => BlockingResponse | Promise<BlockingResponse> | void> {
 ...
 * @deprecated Unsupported on Firefox at this time.
 */
const onChildrenReordered: WebExtEvent<(id: string, reorderInfo: _OnChildrenReorderedReorderInfo) => void> | undefined;
}
 ...
 */
function create(title: string, iconPath: _manifest.ExtensionURL | "", pagePath: _manifest.ExtensionURL): Promise<ExtensionPanel>;
