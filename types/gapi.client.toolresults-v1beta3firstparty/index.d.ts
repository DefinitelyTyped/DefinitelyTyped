// Type definitions for Google Cloud Tool Results firstparty API v1beta3firstparty
...
declare namespace gapi.client.toolresults {
...
declare namespace gapi.client {
    // Load Cloud Tool Results firstparty API v1beta3firstparty
    export function load (name: "toolresults", version: "v1beta3firstparty") : PromiseLike<void>;    
    export function load (name: "toolresults", version: "v1beta3firstparty", callback: () => any) : void;    
    
    const projects: gapi.client.toolresults.ProjectsResource; 
