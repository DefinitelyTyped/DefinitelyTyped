...
app.config(
    ["ngProgressLiteProvider", (ngProgressLiteProvider: ng.progressLite.INgProgressLiteProvider) => {
        ...
        ngProgressLiteProvider.settings.template =
            "<div class=\"ngProgressLite\"><div class=\"ngProgressLiteBar\"><div class=\"ngProgressLiteBarShadow\"></div></div></div>";
    }],
);
