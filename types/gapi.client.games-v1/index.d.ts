...
declare namespace gapi.client.games {
...
declare namespace gapi.client {
    ...
    export function load (name: "games", version: "v1") : PromiseLike<void>;    
    export function load (name: "games", version: "v1", callback: () => any) : void;    
    
    const achievementDefinitions: gapi.client.games.AchievementDefinitionsResource; 
    
    const achievements: gapi.client.games.AchievementsResource; 
    
    const applications: gapi.client.games.ApplicationsResource; 
    
    const events: gapi.client.games.EventsResource; 
    
    const leaderboards: gapi.client.games.LeaderboardsResource; 
    
    const metagame: gapi.client.games.MetagameResource; 
    
    const players: gapi.client.games.PlayersResource; 
    
    const pushtokens: gapi.client.games.PushtokensResource; 
    
    const questMilestones: gapi.client.games.QuestMilestonesResource; 
    
    const quests: gapi.client.games.QuestsResource; 
    
    const revisions: gapi.client.games.RevisionsResource; 
    
    const rooms: gapi.client.games.RoomsResource; 
    
    const scores: gapi.client.games.ScoresResource; 
    
    const snapshots: gapi.client.games.SnapshotsResource; 
    
    const turnBasedMatches: gapi.client.games.TurnBasedMatchesResource; 
