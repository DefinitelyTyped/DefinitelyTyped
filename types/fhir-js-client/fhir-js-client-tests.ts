class Component {
    ...
    observationEntry: FHIR.SMART.Entry = {
        resource: {
            ...
            meta: {
                ...
                profile: ['http://standardhealthrecord.org/fhir/StructureDefinition/shr-observation-Observation'],
                tag: [
                    {
    ...
    oauth2ReadyCallback = (smartClient: FHIR.SMART.SMARTClient) => {
        ...
        api.fetchAllWithReferences(this.searchParameter, this.resolveParameter).then(
            this.fetchAllWithReferencesSuccess,
            this.apiError,
        );
        ...
        if (smartClient.patient) {
            ...
            patientApi
                .fetchAllWithReferences(this.searchParameter, this.resolveParameter)
    ...
    closedSmartOnFhir() {
        ...
        FHIR.oauth2.resolveAuthType(
            this.closedFhirServiceUrl,
            this.oauth2ResolveAuthTypeCallback,
            this.oauth2ResolveAuthTypeErrback,
        );
    }
}
