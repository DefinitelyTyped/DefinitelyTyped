...
export declare function validateProviderHostedRequestToken(requestToken: string, clientSecret: string): Promise<ITypedHash<string>>;
/**
...
//# sourceMappingURL=sptokenutils.d.ts.map