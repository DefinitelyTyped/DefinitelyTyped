 ...
 */
export declare class AdalCertificateFetchClient implements HttpClientImpl {
    private _tenant;
    private _clientId;
    private _thumbprint;
    private _privateKey;
     ...
     */
    constructor(_tenant: string, _clientId: string, _thumbprint: string, _privateKey: string, _resource?: string, _authority?: string, _fetchClient?: HttpClientImpl);
