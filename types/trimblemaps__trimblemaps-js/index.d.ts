...
declare namespace TrimbleMaps {
    ...
    export class Map extends Evented {
        ...
        setStyle(style: TrimbleMaps.Style | string, options?: { diff?: boolean | undefined; localIdeographFontFamily?: string | undefined }): this;
         ...
         */
        queryTerrainElevation(lngLat: TrimbleMaps.LngLatLike, options?: ElevationQueryOptions): number | null;

        setFeatureState(
            feature: FeatureIdentifier | TrimbleMaps.MapboxGeoJSONFeature,
            state: { [key: string]: any },
        ): void;

        getFeatureState(feature: FeatureIdentifier | TrimbleMaps.MapboxGeoJSONFeature): { [key: string]: any };

        removeFeatureState(target: FeatureIdentifier | TrimbleMaps.MapboxGeoJSONFeature, key?: string): void;
    ...
    */
    ...
    export class DragRotateHandler {
        constructor(map: TrimbleMaps.Map, options?: { bearingSnap?: number | undefined; pitchWithRotate?: boolean | undefined });
    ...
    export interface FitBoundsOptions extends TrimbleMaps.FlyToOptions {
        ...
        offset?: TrimbleMaps.PointLike | undefined;
        maxZoom?: number | undefined;
        maxDuration?: number | undefined;
    }
