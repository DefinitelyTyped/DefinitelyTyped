...
declare namespace gapi.client {
    ...
    export function load (name: "vision", version: "v1") : PromiseLike<void>;    
    export function load (name: "vision", version: "v1", callback: () => any) : void;    
    
    const images: gapi.client.vision.ImagesResource; 
