...
declare namespace L {
    ...
    function transformation(a: number, b: number, c: number, d: number): Transformation;

    /** Expects an coefficients array of the form `[a: Number, b: Number, c: Number, d: Number]`. */
    function transformation(coefficients: [number, number, number, number]): Transformation;
    ...
    function latLng(coords: LatLngTuple | [number, number, number] | LatLngLiteral | {lat: number, lng: number, alt?: number | undefined}): LatLng;
    ...
    class SVGOverlay extends Layer { /** SVGOverlay doesn't extend ImageOverlay because SVGOverlay.getElement returns SVGElement */
    ...
    function svgOverlay(svgImage: string | SVGElement, bounds: LatLngBoundsExpression, options?: ImageOverlayOptions): SVGOverlay;
    ...
    class VideoOverlay extends Layer { /** VideoOverlay doesn't extend ImageOverlay because VideoOverlay.getElement returns HTMLImageElement */
    ...
    function videoOverlay(video: string | string[] | HTMLVideoElement, bounds: LatLngBoundsExpression, options?: VideoOverlayOptions): VideoOverlay;
    ...
    class Polyline<T extends GeoJSON.GeometryObject = GeoJSON.LineString | GeoJSON.MultiLineString, P = any> extends Path {
    ...
    type StyleFunction<P = any> = (feature?: GeoJSON.Feature<GeoJSON.GeometryObject, P>) => PathOptions;

    interface GeoJSONOptions<P = any> extends InteractiveLayerOptions {
        /**
     ...
     * an options object.
     */
    function geoJSON<P = any>(geojson?: GeoJSON.GeoJsonObject, options?: GeoJSONOptions<P>): GeoJSON<P>;
    ...
    const extend: typeof Util['extend'];
    const bind: typeof Util['bind'];
    const stamp: typeof Util['stamp'];
    const setOptions: typeof Util['setOptions'];
}
