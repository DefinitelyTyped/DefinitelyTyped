...
// Renames to avoid conflicts with the GeoJSON class of leaflet
import {
...
export namespace PolyUtil {
    export function clipPolygon(points: Point[], bounds: BoundsExpression, round?: boolean): Point[];
}
...
export class InternalPolyline extends Path {
    getLatLngs(): LatLng[];
...
export type StyleFunction = (feature?: GeoJSONFeature<GeoJSONGeometryObject>) => PathOptions;
...
export namespace DomEvent {
    ...
    export function getMousePosition(ev: {clientX: number, clientY: number} /*MouseEvent from lib.d.ts*/, container?: HTMLElement): Point;
...
export class BaseIcon extends Layer {
