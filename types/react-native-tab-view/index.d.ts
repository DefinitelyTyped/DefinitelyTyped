...
import { Animated, StyleProp, ViewStyle, TextStyle, EasingFunction } from 'react-native';
...
export type PagerPanProps<T extends RouteBase = RouteBase> = SceneRendererProps<T> & {
    configureTransition?: TransitionConfigurator;
    animationEnabled?: boolean;
    swipeEnabled?: boolean;
    swipeDistanceThreshold?: number;
...
export type PagerScrollProps<T extends RouteBase = RouteBase> = SceneRendererProps<T> & {
    animationEnabled?: boolean;
    swipeEnabled?: boolean;
    children?: ReactNode;
};
...
export type PagerAndroidProps<T extends RouteBase = RouteBase> = SceneRendererProps<T> & {
    animationEnabled?: boolean;
    swipeEnabled?: boolean;
    children?: ReactNode;
};
...
export type IndicatorProps<T extends RouteBase = RouteBase> = SceneRendererProps<T> & {
    width: Animated.Value;
};

export type TabBarProps<T extends RouteBase = RouteBase> = SceneRendererProps<T> & {
...
export function SceneMap(scenes: { [key: string]: ComponentType<any> }): (props: { route: Route }) => ReactNode;
