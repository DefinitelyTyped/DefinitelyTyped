...
pbkdf2.pbkdf2Sync(passwordString, saltString, 1000, 32, "sha1"); // $ExpectType Buffer || Buffer<ArrayBufferLike>
pbkdf2.pbkdf2Sync(passwordString, saltString, 1000, 32); // $ExpectType Buffer || Buffer<ArrayBufferLike>
...
pbkdf2.pbkdf2Sync(passwordBuffer, saltBuffer, 1000, 32, "sha1"); // $ExpectType Buffer || Buffer<ArrayBufferLike>
pbkdf2.pbkdf2Sync(passwordBuffer, saltBuffer, 1000, 32); // $ExpectType Buffer || Buffer<ArrayBufferLike>
...
pbkdf2.pbkdf2Sync(uint8ArrayPassword, uint8ArraySalt, 1000, 32, "sha1"); // $ExpectType Buffer || Buffer<ArrayBufferLike>
pbkdf2.pbkdf2Sync(uint8ArrayPassword, uint8ArraySalt, 1000, 32); // $ExpectType Buffer || Buffer<ArrayBufferLike>
...
pbkdf2.pbkdf2Sync(dataViewPassword, dataViewSalt, 1000, 32, "sha1"); // $ExpectType Buffer || Buffer<ArrayBufferLike>
pbkdf2.pbkdf2Sync(dataViewPassword, dataViewSalt, 1000, 32); // $ExpectType Buffer || Buffer<ArrayBufferLike>
