...
export class Client {
     ...
     */
    constructor(params: { host: string; username: string; port?: number; password?: string; pkey?: string });
    ...
    load(
        args:
            | string
            | { config: any; action?: 'merge' | 'replace' | 'override' | 'update' | 'set'; format?: 'text' | 'xml' },
