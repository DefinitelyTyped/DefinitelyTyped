...
declare namespace fin {
    var Application: import('./v2/api/application/application').default
    var Clipboard: import('./v2/api/clipboard/clipboard').default
    var ExternalApplication: import('./v2/api/external-application/external-application').default
    var Frame: import('./v2/api/frame/frame').default
    var GlobalHotkey: import('./v2/api/global-hotkey/index').default
    var InterApplicationBus: import('./v2/api/interappbus/interappbus').default
    var Notification: import('./v2/api/notification/notification').default
    var System: import('./v2/api/system/system').default
    var Window: import('./v2/api/window/window').default
