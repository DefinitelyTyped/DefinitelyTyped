...
declare namespace fin {
    ...
    interface OpenFinSystem {
         ...
         */
        getAllWindows(
            callback?: (windowInfoList: WindowDetails[]) => void,
            errorCallback?: (reason: string) => void,
        ): void;
        /**
         ...
         */
        getMousePosition(
            callback?: (mousePosition: VirtualScreenCoordinates) => void,
            errorCallback?: (reason: string) => void,
        ): void;
        /**
        ...
        launchExternalProcess(
            options: ExternalProcessLaunchInfo,
    ...
    interface OpenFinWindow {
         ...
         */
        getState(
            callback?: (state: 'minimized' | 'maximized' | 'restored') => void,
            errorCallback?: (reason: string) => void,
        ): void;
        /**
    ...
    interface LaunchInfo {
        launchMode: 'fin-protocol' | 'fins-protocol' | 'shortcut' | 'command-line' | 'adapter' | 'other' | string;
    }

    type OpenFinTweenType =
        | 'linear'
        | 'ease-in'
        | 'ease-out'
        | 'ease-in-out'
