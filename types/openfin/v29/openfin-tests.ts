...
function test_external_application() {
    ...
    externalApp.removeEventListener(
        'connected',
        previousCallback,
        () => {
            console.log('The unregistration was successful');
...
function test_system() {
    ...
    fin.desktop.System.downloadAsset(
        dirAppAsset,
        (progress) => {
    ...
    const preloadScripts = [{ url: 'http://whatever.com/script.js' }];
    fin.desktop.System.downloadPreloadScripts(
        preloadScripts,
        (info) => {
    ...
    fin.desktop.System.getAllApplications((applicationInfoList) => {
        applicationInfoList.forEach((applicationInfo) => {
            console.log('Showing information for application with uuid: ' + applicationInfo.uuid);
    ...
    // getEntityInfo
    fin.desktop.System.getEntityInfo(
        'uuid',
        'name',
        (info) => {
    ...
    // getFocusedWindow
    fin.desktop.System.getFocusedWindow(
        (win) => {
    ...
    // getMinLogLevel
    fin.desktop.System.getMinLogLevel(
    ...
    fin.desktop.System.launchExternalProcess(
        {
            path: 'C:UsersExampleUserAppDataLocalOpenFinOpenFinRVM.exe',
            arguments: '--version',
            certificate: {
                trusted: true,
    ...
    // readRegistryValue
    fin.desktop.System.readRegistryValue(
        'HKEY_SOMETHING',
        'HARDWARE\\SOMETHING',
        'BootSomething',
        (info) => {
    ...
    fin.desktop.System.launchExternalProcess(
        ...
        (result) => {
            ...
            // release it.
            fin.desktop.System.releaseExternalProcess(
                result.uuid,
                () => {
    ...
    // removeEventListener
    fin.desktop.System.removeEventListener(
        'monitor-info-changed',
        (event) => {
            console.log(event);
        },
    ...
    // updateProxySettings
    fin.desktop.System.updateProxySettings(
        'type',
        'proxyAddress',
        8080,
        () => {
...
function test_system_clipboard() {
    // availableFormats
    fin.desktop.System.Clipboard.availableFormats(
        null,
        (formats) => {
    ...
    // readHtml
    fin.desktop.System.Clipboard.readHtml(
        null,
        (html) => {
    ...
    // readRtf
    fin.desktop.System.Clipboard.readRtf(
        null,
        (rtf) => {
    ...
    // readText
    fin.desktop.System.Clipboard.readText(
        null,
        (text) => {
    ...
    // writeHtml
    fin.desktop.System.Clipboard.writeHtml(
        '<h1>Hello World</h1>',
        null,
        () => {
            console.log('Success!!');
    ...
    // writeRtf
    fin.desktop.System.Clipboard.writeRtf(
        'Hello World!',
        null,
        () => {
            console.log('Success!!');
    ...
    // writeText
    fin.desktop.System.Clipboard.writeText(
        'Hello World',
        null,
        () => {
            console.log('Success!!');
