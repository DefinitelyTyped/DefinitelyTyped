...
function test_global_hot_key() {
    // addEventListener
    fin.desktop.GlobalHotkey.addEventListener(
        'registered',
        (event) => {
    ...
    fin.desktop.GlobalHotkey.isRegistered(
        hotkey,
        (registered) => {
    ...
    // register
    fin.desktop.GlobalHotkey.register(
        hotkey,
        () => {
    ...
    // removeEventListener
    const previousCallback = () => {};
    fin.desktop.GlobalHotkey.removeEventListener(
        'registered',
        previousCallback,
        () => {
            console.log('The unregistration was successful');
    ...
    // unregister
    fin.desktop.GlobalHotkey.unregister(
        hotkey,
        () => {
            console.log('Success');
        },
...
function test_system() {
    ...
    fin.desktop.System.getCrashReporterState(
    ...
    // getRuntimeInfo
    fin.desktop.System.getRuntimeInfo(
        (runtimeInfoObject) => {
    ...
    // startCrashReporter
    fin.desktop.System.startCrashReporter(
        { diagnosticMode: true },
        () => {
            console.log('success');
        },
