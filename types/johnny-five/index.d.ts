...
export class Boards<BoardsIDs extends BoardIdsListType, BoardsConfig extends BoardConfigListType> {
    ...
    each(cb: (boards: IDBoardMap<BoardsIDs[number]> | IDBoardMap<BoardsConfig[number]['id']>) => void): this;
...
type BoardIdsListType = readonly string[];
type BoardConfigListType = readonly { readonly id: string; readonly port?: string }[];
type IDBoardMap<ID extends string> = Record<ID, Board>;
