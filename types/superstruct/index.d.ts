...
declare namespace superstruct {
	interface Config {
		types?: {[type: string]: CustomType};
	}

	type CustomType = (value: any) => boolean|string;

	function isStruct(value: any): boolean;
	...
	function superstruct(config?: Config): struct;
...
declare function superstruct(): void;
