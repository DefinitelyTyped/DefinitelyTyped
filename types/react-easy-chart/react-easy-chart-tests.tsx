...
class PieChartData extends React.Component {
    render(): any {
        return <PieChart data={[{ key: 'A', value: 100 }, { key: 'B', value: 200 }, { key: 'C', value: 50 }]} />;
    }
}
...
class LineChartData extends React.Component {
    render(): any {
        return <LineChart data={[[{ x: 1, y: 20 }, { x: 2, y: 10 }, { x: 3, y: 25 }]]} />;
    }
}
...
class AreaChartData extends React.Component {
    render(): any {
        return <AreaChart data={[[{ x: 1, y: 20 }, { x: 2, y: 10 }, { x: 3, y: 25 }]]} />;
    }
}
...
class ScatterplotMargin extends React.Component {
    render(): any {
        return <ScatterplotChart data={data} margin={{ top: 10, right: 10, bottom: 30, left: 100 }} />;
    }
}
...
const pieData = [{ key: 'Cats', value: 100 }, { key: 'Dogs', value: 200 }, { key: 'Other', value: 50 }];
...
const config = [{ color: '#aaac84' }, { color: '#dce7c5' }, { color: '#e3a51a' }];
...
class LegendStyles extends React.Component {
    render(): any {
        return <Legend data={pieDataCustom} dataId={'key'} config={config} styles={customStyle} horizontal />;
    }
}
