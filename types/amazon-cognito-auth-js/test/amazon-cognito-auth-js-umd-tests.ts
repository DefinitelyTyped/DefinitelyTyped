...
const sessionData: AmazonCognitoIdentity.ICognitoSessionData = {};
new AmazonCognitoIdentity.CognitoAuthSession(sessionData);

const authOptions: AmazonCognitoIdentity.ICognitoAuthOptions = {
...
auth.userhandler; // $ExpectType ICognitoAuthUserHandler
auth.getCognitoConstants(); // $ExpectType ICognitoConstants
