...
export class WebRtcPeer extends EventEmitter {
    ...
    constructor(mode: 'recv' | 'send' | 'sendRecv', options?: object, callback?: (error: string | undefined) => void);
     ...
     */
    processAnswer: (sdpAnswer: string, callback?: (error: string | undefined) => void) => void;
    /**
     ...
     */
    processOffer: (sdpOffer: string, callback?: (error: string | undefined, sdp: string) => void) => void;
    /**
     ...
     */
    addIceCandidate: (iceCandidate: RTCIceCandidate, callback?: (error: string | undefined) => void) => void;
    /**
     ...
     */
    generateOffer: (callback: (error: string | undefined, sdp: string) => void) => void;
    /**
     * Create a WebRtcPeer as receive only.
     */
    static WebRtcPeerRecvonly: (options: object, callback: (error: string | undefined) => void) => WebRtcPeer;

    /**
     * Create a WebRtcPeer as send only.
     */
    static WebRtcPeerSendonly: (options: object, callback: (error: string | undefined) => void) => WebRtcPeer;

    /**
     * Create a WebRtcPeer as send and receive.
     */
    static WebRtcPeerSendrecv: (options: object, callback: (error: string | undefined) => void) => WebRtcPeer;
}
