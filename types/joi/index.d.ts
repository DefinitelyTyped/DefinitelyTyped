...
export interface ValidationErrorItemOverride {
    message?: string;
    type?: string;
    path?: string;
    options?: ValidationOptions;
...
export interface AnySchema<T extends AnySchema<Schema>> {
     ...
     */
    error(err: Error): T;
    error(err: (errors: ValidationErrorItem[]) => string | Error | ValidationErrorItemOverride | ValidationErrorItemOverride[]): T;
}
