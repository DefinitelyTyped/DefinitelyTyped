...
interface MustacheStatic {
     ...
     */
    render(template: string, view: any | Mustache.Context, partials?: any): string;
     ...
     * A function that is used to load partial template on the fly that takes a single argument: the name of the partial.
     */
    to_html(template: string, view: any | Mustache.Context, partials?: any, send?: any): any;
}
...
declare namespace Mustache {
    ...
    export class Writer {
         ...
         * A function that is used to load partial template on the fly that takes a single argument: the name of the partial.
         */
        render(template: string, view: any | Context, partials: any): string;
         ...
         */
        renderTokens(tokens: string[], context: Context, partials: any, originalTemplate: any): string;
    }
}
