...
declare namespace gapi.client {
    // Load Google Cloud Natural Language API v1beta1
    export function load (name: "language", version: "v1beta1") : PromiseLike<void>;    
    export function load (name: "language", version: "v1beta1", callback: () => any) : void;    
