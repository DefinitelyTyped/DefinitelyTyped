...
export interface Nacl {
    ...
    crypto_box: (msg: Message, nonce: Nonce, rcpt: BoxPublicKey, sender: BoxSecretKey) => CipherText;
    crypto_box_open: (cipher: CipherText, nonce: Nonce, sender: BoxPublicKey, rcpt: BoxSecretKey) => Message;
