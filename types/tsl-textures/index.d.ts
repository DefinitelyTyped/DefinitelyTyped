...
export function remapExp(x: FloatInput, fromMin: FloatInput, fromMax: FloatInput, toMin: FloatInput, toMax: FloatInput): Node<'float'>;
...
export function selectPlanar(pos: Vec3Input, selAngles: Vec2Input, selCenter: Vec3Input, selWidth: FloatInput): Node<'float'>;
