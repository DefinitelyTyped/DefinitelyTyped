...
// _.pull
{
    ...
    // @ts-expect-error
    _(readonlyArray).pull();
    // @ts-expect-error
    _(readonlyArray).pull(abcObject);
    // @ts-expect-error
    _(readonlyArray).pull(abcObject, abcObject, abcObject);
    ...
    // @ts-expect-error
    _.chain(readonlyArray).pull();
    // @ts-expect-error
    _.chain(readonlyArray).pull(abcObject);
    // @ts-expect-error
    _.chain(readonlyArray).pull(abcObject, abcObject, abcObject);
...
// _.pullAt
{
    ...
    // @ts-expect-error
    _(readonlyArray).pullAt();
    // @ts-expect-error
    _(readonlyArray).pullAt(1);
    // @ts-expect-error
    _(readonlyArray).pullAt([2, 3], 4);
    ...
    // @ts-expect-error
    _.chain(readonlyArray).pullAt();
    // @ts-expect-error
    _.chain(readonlyArray).pullAt(1);
    // @ts-expect-error
    _.chain(readonlyArray).pullAt([2, 3], 4);
    ...
    // @ts-expect-error
    fp.pullAt(1, readonlyArray);
    // @ts-expect-error
    fp.pullAt([2, 3], readonlyArray);
...
// _.pullAll
{
    ...
    // @ts-expect-error
    _(readonlyArray).pullAll();
    // @ts-expect-error
    _(readonlyArray).pullAll(values);
    ...
    // @ts-expect-error
    _.chain(readonlyArray).pullAll();
    // @ts-expect-error
    _.chain(readonlyArray).pullAll(values);
    ...
    // @ts-expect-error
    fp.pullAll(values, readonlyArray);
...
// _.pullAllWith
{
    ...
    // @ts-expect-error
    _(readonlyArray).pullAllBy();
    // @ts-expect-error
    _(readonlyArray).pullAllBy(values, "a");
    ...
    // @ts-expect-error
    _.chain(readonlyArray).pullAllBy();
    // @ts-expect-error
    _.chain(readonlyArray).pullAllBy(values, "a");
    ...
    fp.pullAllBy((value: AbcObject) => true)(values)(array); // $ExpectType AbcObject[]
    // @ts-expect-error
    fp.pullAllBy("a", values, readonlyArray);
    // @ts-expect-error
    fp.pullAllBy({ a: 42 }, values, readonlyArray);
    // @ts-expect-error
    fp.pullAllBy(["a", 42], values, readonlyArray);
    // @ts-expect-error
    fp.pullAllBy((value: AbcObject) => true, values, readonlyArray);
    // @ts-expect-error
    fp.pullAllBy((value: AbcObject) => true)(values, readonlyArray);
    // @ts-expect-error
    fp.pullAllBy((value: AbcObject) => true, values)(readonlyArray);
    ...
    // @ts-expect-error
    _(readonlyArray).pullAllWith();
    // @ts-expect-error
    _(readonlyArray).pullAllWith(values);
    ...
    // @ts-expect-error
    _.chain(readonlyArray).pullAllWith();
    // @ts-expect-error
    _.chain(readonlyArray).pullAllWith(values);
    ...
    // @ts-expect-error
    fp.pullAllWith((a, b) => true, values, readonlyArray);
    // @ts-expect-error
    fp.pullAllWith((a: AbcObject, b: AbcObject) => true)(values, readonlyArray);
...
// _.remove
{
    ...
    // @ts-expect-error
    _(readonlyArray).remove();
    // @ts-expect-error
    _(readonlyArray).remove(listIterator);
    // @ts-expect-error
    _(readonlyArray).remove("");
    // @ts-expect-error
    _(readonlyArray).remove({ a: 42 });
    
    // @ts-expect-error
    _.chain(readonlyArray).remove();
    // @ts-expect-error
    _.chain(readonlyArray).remove(listIterator);
    // @ts-expect-error
    _.chain(readonlyArray).remove("");
    // @ts-expect-error
    _.chain(readonlyArray).remove({ a: 42 });
    
    // @ts-expect-error
    fp.remove(valueIterator, readonlyArray);
    // @ts-expect-error
    fp.remove(valueIterator)(readonlyArray);
    // @ts-expect-error
    fp.remove("", readonlyArray);
    // @ts-expect-error
    fp.remove({ a: 42 }, readonlyArray);
}
