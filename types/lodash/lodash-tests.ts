...
// _.get
{
    ...
    _({ a: value }).get("a", defValue); // $ExpectType string | boolean
    _({ a: undefined }).get("a", defValue); // $ExpectType boolean
    ...
    _.chain({ a: value }).get("a", defValue); // $ExpectType LoDashExplicitWrapper<string | boolean>
    _.chain({ a: undefined }).get("a", defValue); // $ExpectType LoDashExplicitWrapper<boolean>
