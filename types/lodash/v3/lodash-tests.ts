...
namespace TestGet {
    {
        ...
        maybeResult = _.get<string>('abc', '0');
        result      = _.get<string, string>('abc', '0', '_');
        maybeResult = _.get<string, string>('abc', ['0']);
        result      = _.get<string, string>('abc', ['0'], '_');
        ...
        maybeResult = _('abc').get<string>('0');
    ...
    {
        let result: number;
        let maybeResult: number | undefined;

        maybeResult = _.get<number>([42], '0');
    ...
    {
        let result: boolean;
        let maybeResult: boolean | undefined;

        maybeResult = _.get<boolean>({a: true}, 'a');
        ...
        maybeResult = _({a: true}).get<boolean>('a');
