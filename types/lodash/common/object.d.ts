...
declare module '../index' {
    ...
    interface LoDashImplicitWrapper<TValue> {
         ...
         * @see _.defaults
         */
        defaults<TSource>(source: TSource): LoDashImplicitWrapper<NonNullable<TSource & TValue>>;
    ...
    interface LoDashExplicitWrapper<TValue> {
         ...
         * @see _.defaults
         */
        defaults<TSource>(source: TSource): LoDashExplicitWrapper<NonNullable<TSource & TValue>>;
    ...
    interface LoDashImplicitWrapper<TValue> {
         ...
         * @see _.get
         */
        get<TKey1 extends keyof TValue, TKey2 extends keyof TValue[TKey1]>(path: [TKey1, TKey2]): TValue[TKey1][TKey2];
        ...
        get<
            ...
            TKey2 extends keyof TValue[TKey1],
            TKey3 extends keyof TValue[TKey1][TKey2],
            TKey4 extends keyof TValue[TKey1][TKey2][TKey3]
        >(
            path: [TKey1, TKey2, TKey3, TKey4],
