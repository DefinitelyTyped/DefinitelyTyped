...
declare namespace _ {
    ...
    interface LodashFlow {
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8, f9: (a: R8) => R9, f10: (a: R9) => R10, f11: (a: R10) => R11, f12: (a: R11) => R12, f13: (a: R12) => R13, f14: (a: R13) => R14): (...args: A) => R14;
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8, f9: (a: R8) => R9, f10: (a: R9) => R10, f11: (a: R10) => R11, f12: (a: R11) => R12, f13: (a: R12) => R13, f14: (a: R13) => R14, ...func: Array<lodash.Many<(a: any) => any>>): (...args: A) => any;
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8, f9: (a: R8) => R9, f10: (a: R9) => R10, f11: (a: R10) => R11, f12: (a: R11) => R12, f13: (a: R12) => R13): (...args: A) => R13;
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8, f9: (a: R8) => R9, f10: (a: R9) => R10, f11: (a: R10) => R11, f12: (a: R11) => R12): (...args: A) => R12;
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8, f9: (a: R8) => R9, f10: (a: R9) => R10, f11: (a: R10) => R11): (...args: A) => R11;
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8, R9, R10>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8, f9: (a: R8) => R9, f10: (a: R9) => R10): (...args: A) => R10;
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8, R9>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8, f9: (a: R8) => R9): (...args: A) => R9;
        <A extends any[], R1, R2, R3, R4, R5, R6, R7, R8>(f1: (...args: A) => R1, f2: (a: R1) => R2, f3: (a: R2) => R3, f4: (a: R3) => R4, f5: (a: R4) => R5, f6: (a: R5) => R6, f7: (a: R6) => R7, f8: (a: R7) => R8): (...args: A) => R8;
