...
interface IsEqualWith {
     ...
     * // => true
     */
    (customizer: _.IsEqualCustomizer, value: any): IsEqualWith1x3;
    /**
     * This method is like `_.isEqual` except that it accepts `customizer` which is
     * invoked to compare values. If `customizer` returns `undefined` comparisons are
     * handled by the method instead. The `customizer` is invoked with up to seven arguments:
...
interface IsEqualWith1x2 {
     ...
     * // => true
     */
    (customizer: _.IsEqualCustomizer): IsEqualWith1x3;
    /**
     * This method is like `_.isEqual` except that it accepts `customizer` which is
     * invoked to compare values. If `customizer` returns `undefined` comparisons are
     * handled by the method instead. The `customizer` is invoked with up to seven arguments:
     ...
     * // => true
     */
    (customizer: _.IsEqualCustomizer, other: any): boolean;
}
interface IsEqualWith1x3 {
    /**
     * This method is like `_.isEqual` except that it accepts `customizer` which is
     * invoked to compare values. If `customizer` returns `undefined` comparisons are
     * handled by the method instead. The `customizer` is invoked with up to seven arguments:
...
interface IsEqualWith1x4 {
     ...
     * // => true
     */
    (customizer: _.IsEqualCustomizer): IsEqualWith1x5;
    /**
     * This method is like `_.isEqual` except that it accepts `customizer` which is
     * invoked to compare values. If `customizer` returns `undefined` comparisons are
     * handled by the method instead. The `customizer` is invoked with up to seven arguments:
     ...
     * // => true
     */
    (customizer: _.IsEqualCustomizer, value: any): boolean;
}
interface IsEqualWith1x5 {
    /**
     * This method is like `_.isEqual` except that it accepts `customizer` which is
     * invoked to compare values. If `customizer` returns `undefined` comparisons are
     * handled by the method instead. The `customizer` is invoked with up to seven arguments:
...
interface IsEqualWith1x6 {
     ...
     * // => true
     */
    (customizer: _.IsEqualCustomizer): boolean;
}
