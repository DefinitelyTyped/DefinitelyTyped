...
interface PadStart {
     ...
     * @return Returns the padded string.
     */
    (chars: string, length: number): PadStart1x3;
    /**
     * Pads string on the left side if it’s shorter than length. Padding characters are truncated if they exceed
     * length.
     *
