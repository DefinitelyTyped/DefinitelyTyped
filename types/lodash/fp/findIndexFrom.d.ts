...
interface FindIndex {
     ...
     * @return Returns the index of the found element, else -1.
     */
    <T>(predicate: _.ValueIterateeCustom<T, boolean>, fromIndex: number): FindIndex1x3<T>;
    /**
     * This method is like _.find except that it returns the index of the first element predicate returns truthy
     * for instead of the element itself.
     *
...
interface FindIndex1x1<T> {
     ...
     * @return Returns the index of the found element, else -1.
     */
    (fromIndex: number): FindIndex1x3<T>;
    /**
     * This method is like _.find except that it returns the index of the first element predicate returns truthy
     * for instead of the element itself.
     *
...
interface FindIndex1x2 {
     ...
     * @return Returns the index of the found element, else -1.
     */
    <T>(predicate: _.ValueIterateeCustom<T, boolean>): FindIndex1x3<T>;
    /**
     * This method is like _.find except that it returns the index of the first element predicate returns truthy
     * for instead of the element itself.
     *
...
interface FindIndex1x4<T> {
     ...
     * @return Returns the index of the found element, else -1.
     */
    (predicate: _.ValueIterateeCustom<T, boolean>): FindIndex1x5;
    /**
     * This method is like _.find except that it returns the index of the first element predicate returns truthy
     * for instead of the element itself.
     *
