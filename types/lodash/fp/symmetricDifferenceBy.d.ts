...
interface XorBy {
     ...
     * // => [{ 'x': 2 }]
     */
    <T>(iteratee: _.ValueIteratee<T>, arrays: _.List<T> | null | undefined): XorBy1x3<T>;
    /**
     * This method is like `_.xor` except that it accepts `iteratee` which is
     * invoked for each element of each `arrays` to generate the criterion by which
     * uniqueness is computed. The iteratee is invoked with one argument: (value).
...
interface XorBy1x1<T> {
     ...
     * // => [{ 'x': 2 }]
     */
    (arrays: _.List<T> | null | undefined): XorBy1x3<T>;
    /**
     * This method is like `_.xor` except that it accepts `iteratee` which is
     * invoked for each element of each `arrays` to generate the criterion by which
     * uniqueness is computed. The iteratee is invoked with one argument: (value).
...
interface XorBy1x2<T> {
     ...
     * // => [{ 'x': 2 }]
     */
    (iteratee: _.ValueIteratee<T>): XorBy1x3<T>;
    /**
     * This method is like `_.xor` except that it accepts `iteratee` which is
     * invoked for each element of each `arrays` to generate the criterion by which
     * uniqueness is computed. The iteratee is invoked with one argument: (value).
...
interface XorBy1x4<T> {
     ...
     * // => [{ 'x': 2 }]
     */
    (iteratee: _.ValueIteratee<T>): XorBy1x5<T>;
    /**
     * This method is like `_.xor` except that it accepts `iteratee` which is
     * invoked for each element of each `arrays` to generate the criterion by which
     * uniqueness is computed. The iteratee is invoked with one argument: (value).
