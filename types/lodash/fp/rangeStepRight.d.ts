...
interface RangeRight {
     ...
     * // => []
     */
    (start: number, end: number): RangeRight1x3;
    /**
     * This method is like `_.range` except that it populates values in
     * descending order.
     *
