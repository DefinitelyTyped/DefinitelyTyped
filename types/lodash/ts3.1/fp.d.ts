...
declare namespace _ {
    ...
    interface LodashAt {
        ...
        <T>(
            props: lodash.__,
            object: lodash.Dictionary<T> | lodash.NumericDictionary<T> | null | undefined,
        ): LodashAt1x2<T>;
        <T>(
    ...
    interface LodashContains {
        ...
        <T>(
            target: lodash.__,
            collection: lodash.Dictionary<T> | lodash.NumericDictionary<T> | null | undefined,
        ): LodashContains1x2<T>;
    ...
    type LodashInvertBy1x1<T> = (
        object: lodash.Dictionary<T> | lodash.NumericDictionary<T> | object | null | undefined,
    ) => lodash.Dictionary<string[]>;
    ...
    interface LodashIsArrayLikeObject {
        ...
        (
            value: ((...args: any[]) => any) | lodash.FunctionBase | string | boolean | number | null | undefined,
        ): value is never;
    ...
    interface LodashPartial {
        ...
        <TS extends any[], T1, T2, T3, R>(func: (t1: T1, t2: T2, t3: T3, ...ts: TS) => R): LodashPartial20x1<
            TS,
            T1,
            T2,
            T3,
            R
        >;
        <TS extends any[], T1, T2, T3, R>(func: (t1: T1, t2: T2, t3: T3, ...ts: TS) => R, t1: [T1, T2, T3]): (
            ...ts: TS
        ) => R;
    ...
    interface LodashTransform {
        ...
        <T, TResult>(iteratee: lodash.MemoVoidIteratorCapped<T, TResult>, accumulator: TResult): LodashTransform1x3<
            T,
            TResult
        >;
        ...
        <T, TResult>(iteratee: lodash.__, accumulator: TResult, object: ReadonlyArray<T>): LodashTransform1x6<
            T,
            TResult
        >;
        <T, TResult>(
        ...
        <T, TResult>(iteratee: lodash.__, accumulator: TResult, object: lodash.Dictionary<T>): LodashTransform2x6<
            T,
            TResult
        >;
    }
