...
// _.differenceBy
{
    ...
    _.differenceBy<AbcObject, AbcObject, AbcObject, AbcObject, AbcObject, AbcObject, AbcObject>(
        list,
        arrayParam,
        listParam,
        arrayParam,
...
// _.zip
{
    ...
    fp.zipAll<number | string | boolean>([
        [1, 2],
        ['a', 'b'],
        [true, false],
...
// _.findLast
{
    ...
    _.find(
        [anything as AbcObject, null, undefined],
        (value: AbcObject | null | undefined): value is AbcObject | undefined => value !== null,
    ...
    _([anything as AbcObject, null, undefined]).find(
        (value: AbcObject | null | undefined): value is AbcObject | undefined => value !== null,
    ); // $ExpectType AbcObject | undefined
    ...
    _.chain([anything as AbcObject, null, undefined]).find(
        (value: AbcObject | null | undefined): value is AbcObject | undefined => value !== null,
    );
    ...
    fp.find(['a', 42], dictionary); // $ExpectType AbcObject | undefined
    fp.find((value: AbcObject | null | undefined): value is AbcObject | undefined => value !== null, [
        anything as AbcObject,
        null,
        undefined,
    ]); // $ExpectType AbcObject | undefined
    ...
    _([anything as AbcObject, null, undefined]).findLast(
        (value: AbcObject | null | undefined): value is AbcObject | undefined => value !== null,
    ); // $ExpectType AbcObject | undefined
    ...
    // $ExpectType ObjectChain<AbcObject>
    _.chain([anything as AbcObject, null, undefined]).findLast(
        (value: AbcObject | null | undefined): value is AbcObject | undefined => value !== null,
    );
    ...
    fp.findLast(['a', 42], dictionary); // $ExpectType AbcObject | undefined
    fp.findLast((value: AbcObject | null | undefined): value is AbcObject | undefined => value !== null, [
        anything as AbcObject,
        null,
        undefined,
    ]); // $ExpectType AbcObject | undefined
...
// _.flatMap
{
    ...
    const listIterator = (
        value: number | number[],
        index: number,
        collection: _.List<number | number[]>,
    ): number | number[] => 1;
    const dictionaryIterator = (
        value: number | number[],
        key: string,
        collection: _.Dictionary<number | number[]>,
    ): number | number[] => 1;
    const numericDictionaryIterator = (
        value: number | number[],
        key: string,
        collection: _.NumericDictionary<number | number[]>,
    ): number | number[] => 1;
...
// _.flatMapDeep, _.flatMapDepth
{
    ...
    const stringIterator = (
        value: string,
        index: number,
        collection: _.List<string>,
    ): _.ListOfRecursiveArraysOrValues<string> | string => '';
    const listIterator = (
        value: number | number[],
        index: number,
        collection: _.List<number | number[]>,
    ): _.ListOfRecursiveArraysOrValues<number> | number => 1;
    const dictionaryIterator = (
        value: number | number[],
        key: string,
        collection: _.Dictionary<number | number[]>,
...
// _.memoize
{
    ...
    const testMapCache: _.MapCache = {
        ...
        set(key: string, value: any): _.MapCache {
            return this;
        },
        clear() {},
    };
...
// _.overArgs
{
    ...
    _(func).overArgs(
        (a: number) => true,
        (b: string) => true,
    ); // $ExpectType Function<(...args: any[]) => any>
    _(func).overArgs([(a: number) => true, (b: string) => true]); // $ExpectType Function<(...args: any[]) => any>
    _.chain(func).overArgs(
        (a: number) => true,
        (b: string) => true,
    ); // $ExpectType FunctionChain<(...args: any[]) => any>
...
// _.conforms
{
    ...
    _({ foo: (v: string) => false })
        .conforms()
        .value()({ foo: 'foo' }); // $ExpectType boolean
    _.chain({ foo: (v: string) => false })
        .conforms()
        .value()({ foo: 'foo' }); // $ExpectType boolean
...
{
    {
        const value:
            | string
            | string[]
            | { [index: number]: boolean; length: number }
            | [number, boolean]
            | number
            | { length: string }
            | { a: string }
...
// _.isEqualWith
{
    const customizer = (
        value: any,
        other: any,
        indexOrKey: number | string | symbol | undefined,
        parent: any,
        otherParent: any,
        stack: any,
    ) => true;
...
// _.isMatchWith
{
    const testIsMatchCustiomizerFn = (
        value: any,
        other: any,
        indexOrKey: number | string | symbol,
        object: object,
        source: object,
    ) => true;
...
// _.get
{
    ...
    _.chain({ a: [1] })
        .get('a', [])
        .map((val) => val.toFixed()); // $ExpectType CollectionChain<string>
...
// _.methodOf
{
    ...
    _(abcObject).methodOf(anything, anything, anything) as _.LoDashImplicitWrapper<
        (path: _.Many<_.PropertyName>) => any
    >;
    _.chain(abcObject).methodOf() as _.LoDashExplicitWrapper<(path: _.Many<_.PropertyName>) => any>;
    _.chain(abcObject).methodOf(anything, anything, anything) as _.LoDashExplicitWrapper<
        (path: _.Many<_.PropertyName>) => any
    >;
...
// _.overSome
{
    ...
    _.overEvery(
        (number: number) => true,
        (number: number) => true,
    ); // $ExpectType (...args: number[]) => boolean
    _.overEvery([(number: number) => true]); // $ExpectType (...args: number[]) => boolean
