declare module licensekey {
     ...
     */
    export function createLicense (licenseData: licensekey.CreateData): licensekey.CreateResult;

    /**
     * Validates he provided user license data
     * @param userLicense Must include 'license' field
     */
    export function validateLicense (userLicense: ValidateData): licensekey.LicenseResult;
