...
// Project: https://github.com/gburghardt/jasmine-data_driven_tests, https://github.com/dakolech/jasmine-data_driven_tests
...
interface JasmineDataDrivenTest {
    ...
    <T, U>(description: string, dataset: Array<[T, U]>, assertion: (arg0: T, arg1: U, done: () => void) => void): void;
    <T>(description: string, dataset: T[] | Array<[T]>, assertion: (value: T, done: () => void) => void): void;
}
