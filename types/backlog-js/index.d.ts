...
declare class Request {
    private configure;
    constructor(configure: { host: string; apiKey?: string; accessToken?: string; timeout?: number });
    ...
    request(options: { method: string; path: string; params?: Params | FormData }): Promise<Response>;
...
export class OAuth2 {
    ...
    getAuthorizationURL(options: { host: string; redirectUri?: string; state?: string }): string;
    getAccessToken(options: { host: string; code: string; redirectUri?: string }): Promise<Entity.OAuth2.AccessToken>;
    refreshAccessToken(options: { host: string; refreshToken: string }): Promise<Entity.OAuth2.AccessToken>;
}
