// Type definitions for Google Compute Engine API v1 1.0
...
declare namespace gapi.client.compute {
    ...
    interface ProjectsGetXpnResources {
        ...
        /** [Output Only] This token allows you to get the next page of results for list requests. If the number of results is larger than maxResults, use the nextPageToken as a value for the query parameter pageToken in the next list request. Subsequent list requests will have their own nextPageToken to continue paging through the results. */
        nextPageToken?: string;
        /** Serive resources (a.k.a service projects) attached to this project as their shared VPC host. */
...
declare namespace gapi.client {
    ...
    const acceleratorTypes: gapi.client.compute.AcceleratorTypesResource; 
    
    const addresses: gapi.client.compute.AddressesResource; 
    
    const autoscalers: gapi.client.compute.AutoscalersResource; 
    
    const backendBuckets: gapi.client.compute.BackendBucketsResource; 
    
    const backendServices: gapi.client.compute.BackendServicesResource; 
    
    const diskTypes: gapi.client.compute.DiskTypesResource; 
    
    const disks: gapi.client.compute.DisksResource; 
    
    const firewalls: gapi.client.compute.FirewallsResource; 
    
    const forwardingRules: gapi.client.compute.ForwardingRulesResource; 
    
    const globalAddresses: gapi.client.compute.GlobalAddressesResource; 
    
    const globalForwardingRules: gapi.client.compute.GlobalForwardingRulesResource; 
    
    const globalOperations: gapi.client.compute.GlobalOperationsResource; 
    
    const healthChecks: gapi.client.compute.HealthChecksResource; 
    
    const httpHealthChecks: gapi.client.compute.HttpHealthChecksResource; 
    
    const httpsHealthChecks: gapi.client.compute.HttpsHealthChecksResource; 
    
    const images: gapi.client.compute.ImagesResource; 
    
    const instanceGroupManagers: gapi.client.compute.InstanceGroupManagersResource; 
    
    const instanceGroups: gapi.client.compute.InstanceGroupsResource; 
    
    const instanceTemplates: gapi.client.compute.InstanceTemplatesResource; 
    
    const instances: gapi.client.compute.InstancesResource; 
    
    const licenses: gapi.client.compute.LicensesResource; 
    
    const machineTypes: gapi.client.compute.MachineTypesResource; 
    
    const networks: gapi.client.compute.NetworksResource; 
    
    const projects: gapi.client.compute.ProjectsResource; 
    
    const regionAutoscalers: gapi.client.compute.RegionAutoscalersResource; 
    
    const regionBackendServices: gapi.client.compute.RegionBackendServicesResource; 
    
    const regionCommitments: gapi.client.compute.RegionCommitmentsResource; 
    
    const regionInstanceGroupManagers: gapi.client.compute.RegionInstanceGroupManagersResource; 
    
    const regionInstanceGroups: gapi.client.compute.RegionInstanceGroupsResource; 
    
    const regionOperations: gapi.client.compute.RegionOperationsResource; 
    
    const regions: gapi.client.compute.RegionsResource; 
    
    const routers: gapi.client.compute.RoutersResource; 
    
    const routes: gapi.client.compute.RoutesResource; 
    
    const snapshots: gapi.client.compute.SnapshotsResource; 
    
    const sslCertificates: gapi.client.compute.SslCertificatesResource; 
    
    const subnetworks: gapi.client.compute.SubnetworksResource; 
    
    const targetHttpProxies: gapi.client.compute.TargetHttpProxiesResource; 
    
    const targetHttpsProxies: gapi.client.compute.TargetHttpsProxiesResource; 
    
    const targetInstances: gapi.client.compute.TargetInstancesResource; 
    
    const targetPools: gapi.client.compute.TargetPoolsResource; 
    
    const targetSslProxies: gapi.client.compute.TargetSslProxiesResource; 
    
    const targetTcpProxies: gapi.client.compute.TargetTcpProxiesResource; 
    
    const targetVpnGateways: gapi.client.compute.TargetVpnGatewaysResource; 
    
    const urlMaps: gapi.client.compute.UrlMapsResource; 
    
    const vpnTunnels: gapi.client.compute.VpnTunnelsResource; 
    
    const zoneOperations: gapi.client.compute.ZoneOperationsResource; 
    
    const zones: gapi.client.compute.ZonesResource; 
