...
export as namespace speakeasy;
export = speakeasy;

declare namespace speakeasy {
    ...
    function digest(options: DigestOptions): string;
    function time(options: TotpOptions): string;
    function counter(options: HotpOptions): string;
    function generate_key(options: GenerateOptions): Key;
    function generateSecret(options?: GenerateSecretOptions): Key;
