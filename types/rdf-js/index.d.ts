...
export interface DatasetCore<Q extends BaseQuad = Quad> {
     ...
     */
    match(subject?: Q['subject'], predicate?: Q['predicate'], object?: Q['object'], graph?: Q['graph']): this;
...
export interface Dataset<Q extends BaseQuad = Quad> extends DatasetCore<Q> {
     ...
     * @param graph     The optional exact graph to match.
     */
    deleteMatches(subject?: Q['subject'], predicate?: Q['predicate'], object?: Q['object'], graph?: Q['graph']): this;
