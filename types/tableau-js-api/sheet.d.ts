...
import { FilterOptions, RangeFilterOptions, RelativeDateFilterOptions, HierarchicalFilterOptions, Filter } from './filtering';
...
export class Worksheet extends Sheet {
  ...
  getSummaryDataAsync(options: GetUnderlyingDataOptions): Promise<DataTable>;
  ...
  applyHierarchicalFilterAsync(fieldName: string, values: any | any[] | object, options: HierarchicalFilterOptions): Promise<string>;
