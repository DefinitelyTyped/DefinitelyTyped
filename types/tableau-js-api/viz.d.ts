import { TableauEventName, ToolbarPosition, ToolbarButtonName } from './enums';
import { CustomViewEvent, FilterEvent, MarksEvent, ParameterEvent, StoryPointSwitchEvent, TabSwitchEvent, ToolbarStateEvent, UrlActionEvent, VizResizeEvent } from './viz.event';
import { Workbook } from './workbook';
import { Sheet, SheetInfo } from './sheet';
import { TableauEvent } from './viz.event';

// Define types to use in addEventListener and removeEventListener overloads
type TableauEventCustomView = Extract<TableauEventName, TableauEventName.CUSTOM_VIEW_LOAD | TableauEventName.CUSTOM_VIEW_REMOVE | TableauEventName.CUSTOM_VIEW_SAVE | TableauEventName.CUSTOM_VIEW_SET_DEFAULT>;
type TableauEventFilterChange = Extract<TableauEventName, TableauEventName.FILTER_CHANGE>;
type TableauEventMarks = Extract<TableauEventName, TableauEventName.MARKS_HIGHLIGHT | TableauEventName.MARKS_SELECTION>;
type TableauEventParameterChange = Extract<TableauEventName, TableauEventName.PARAMETER_VALUE_CHANGE>;
type TableauEventStoryPointSwitch = Extract<TableauEventName, TableauEventName.STORY_POINT_SWITCH>;
type TableauEventTabSwitch = Extract<TableauEventName, TableauEventName.TAB_SWITCH>;
type TableauEventToolbarStateChange = Extract<TableauEventName, TableauEventName.TOOLBAR_STATE_CHANGE>;
type TableauEventUrlAction = Extract<TableauEventName, TableauEventName.URL_ACTION>;
type TableauEventVizResize = Extract<TableauEventName, TableauEventName.VIZ_RESIZE>;
