    ...
    render() {
        return (
            <div>
                ...
                <Breadcrumbs />
                <Breadcrumbs style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                ...
                <ProgressMeter />
                <ProgressMeter style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                ...
                <ProgressMeterText />
                <ProgressMeterText style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                <ProgressMeterText />

                <NativeProgress />
                <NativeProgress style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                <NativeProgress max={6} value={10} color={ProgressColors.ALERT} />
                ...
                <ResponsiveNavigation
                    ...
                    onClick={(e) => e.pageX}
                />
                <ResponsiveNavigation breakpoint={42} titleBar={{}} menuIcon={{}} titleBarTitle={{}} topBar={{}} />

                <TitleBar />
                <TitleBar style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />

                <MenuIcon />
                <MenuIcon style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />

                <TitleBarTitle />
                <TitleBarTitle style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                ...
                <Reveal
                    ...
                    onClick={(e) => e.pageX}
                />
                <Reveal isTiny={true} isSmall={true} isLarge={true} isFullscreen={true} />
                ...
                <Switch
                    ...
                    onClick={(e) => e.pageX}
                />
                <Switch size={SwitchSizes.SMALL} id="abba" input={{}} paddle={{}} active={{}} inactive={{}} />

                <SwitchInput />
                <SwitchInput style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                <SwitchInput type={SwitchInputTypes.CHECKBOX} id="blah" />

                <SwitchPaddle />
                <SwitchPaddle style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                <SwitchPaddle />

                <SwitchActive />
                <SwitchActive style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                <SwitchActive text="ahoy-hoy" />

                <SwitchInactive />
                <SwitchInactive style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                ...
                <Slider />
                <Slider style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                <Slider initialStart={2} fill={{}} handle={{}} isVertical={true} isDisabled={false} />

                <TwoHandleSlider />
                <TwoHandleSlider style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
                <TwoHandleSlider
                    initialStart={3}
                    initialEnd={4}
                    minHandle={{}}
                ...
                <SliderHandle />
                <SliderHandle style={{ position: 'absolute' }} className="foo" onClick={(e) => e.pageX} />
