...
export interface RowProps extends FlexboxPropTypes, ReactDOM.HTMLAttributes<HTMLDivElement> {
    upOnSmall?: number;
    upOnMedium?: number;
    upOnLarge?: number;
...
export interface ColumnProps extends FlexboxPropTypes, ReactDOM.HTMLAttributes<HTMLDivElement> {
    upOnSmall?: number;
    small?: number;
    medium?: number;
    large?: number;
