...
class World {
    ...
    addEnemy() {
        ...
        } while (this.usedSpawningPoints.has(spawningPoint) || spawningPoint.squaredDistanceTo(this.player.position) < minSqDistance);
    ...
    intersectRay(ray: YUKA.Ray, intersectionPoint: YUKA.Vector3, normal: YUKA.Vector3 | null = null): CustomObstacle | null {
