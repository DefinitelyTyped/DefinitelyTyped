...
/**
 * Class for representing a fuzzy set that is a singleton.
 * In its range, the degree of membership is always one.
 */
export class SingletonFuzzySet extends FuzzySet {
    /**
