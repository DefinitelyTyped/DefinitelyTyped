 ...
 */
export type MakeKeysOptional<T1, T2 extends keyof T1> = Omit<T1, T2> & Partial<Pick<T1, T2>>;

export type PickPartial<T, Par extends keyof T> = Pick<Partial<T>, Par>;

export type PickPartialRequired<T, Par extends keyof T, Req extends keyof T> = Pick<Partial<T>, Par> &
    Pick<Required<T>, Req>;
 ...
 */
export type MakeKeysNullable<T1, T2 extends keyof T1> = Omit<T1, T2> & { [P in T2]: T1[P] | null };

/**
 * Makes specified keys of an interface Required.
 */
export type MakeKeysRequired<T1, T2 extends keyof T1> = Omit<T1, T2> & Required<Pick<T1, T2>>;
