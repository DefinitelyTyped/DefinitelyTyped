...
declare class MangoPay {
    ...
    isExpired(): boolean;
    method(method: ApiMethod, callback: (...args: any[]) => void, options: MangoPay.RequestOptions): any;
}
...
declare namespace MangoPay {
    ...
    type AVSResult = 'NO_CHECK' | 'NO_MATCH' | 'ADDRESS_MATCH_ONLY' | 'POSTAL_CODE_MATCH_ONLY' | 'FULL_MATCH';
    ...
    interface NoArgMethodOverload<R> {
        ...
        (callback: (data: WithResponse<R>) => void, options?: MethodOptionWithResponse): void;
    ...
    interface MethodOverload<T, R> {
        ...
        (data: T, callback: (data: WithResponse<R>) => void, options: MethodOptionWithResponse): void;
        (data: T, callback: (data: R) => void, options?: MethodOptionWithoutResponse): void;
    }
    ...
    interface TwoArgsMethodOverload<T, U, R> {
        ...
        (data: T, extra: U, callback: (data: WithResponse<R>) => void, options?: MethodOptionWithResponse): void;
        (data: T, extra: U, callback: (data: R) => void, options?: MethodOptionWithoutResponse): void;
    }
    ...
    interface ThreeArgsMethodOverload<T, U, V, R> {
        ...
        (data: T, extra: U, lastArg: V, options?: MethodOptionWithoutResponse): Promise<R>;
        (
            data: T,
            extra: U,
            lastArg: V,
        ...
        (data: T, extra: U, lastArg: V, callback: (data: R) => void, options?: MethodOptionWithoutResponse): void;
    }
    ...
    namespace models {
        ...
        interface DisputeDocumentPage extends disputeDocument.CreateDisputeDocumentPage {}
        ...
        class UboDeclaration extends EntityBase<uboDeclaration.UboDeclarationData> {
            constructor(data: uboDeclaration.CreateUboDeclaration | uboDeclaration.UpdateUboDeclaration);
        }
        ...
        class CardRegistration extends EntityBase<cardRegistration.CardRegistrationData> {
            constructor(data: cardRegistration.CreateCardRegistration | cardRegistration.UpdateCardRegistration);
        }
        ...
        class CardPreAuthorization {
            constructor(
                data: cardPreAuthorization.CardPreAuthorizationData | cardPreAuthorization.UpdateCardPreAuthorization,
            );
        }

        interface CardPreAuthorization extends cardPreAuthorization.CardPreAuthorizationData {}
        ...
        class UserLegal extends EntityBase<user.UserLegalData> {
            PersonType: 'LEGAL';
            constructor(data: MakeKeysRequired<Partial<user.UserLegalData>, user.RequiredUserLegalData>);
        ...
        class UserNatural extends EntityBase<user.UserNaturalData> {
            PersonType: 'NATURAL';
            constructor(data: MakeKeysRequired<Partial<user.UserNaturalData>, user.RequiredUserNaturalData>);
        ...
        interface SettlementTransfer extends settlementTransfer.SettlementTransferData {}
    ...
    namespace bankingAlias {
        ...
        interface CreateIBANBankingAlias
            extends PickPartialRequired<IBANBankingAliasData, 'Tag' | 'CreditedUserId', 'OwnerName' | 'Country'> {}
    }
    ...
    namespace bankAccount {
        ...
        type CreationDetails = OtherDetails | CADetails | GBDetails | IBANDetails | USDetails;
    }
    ...
    namespace disputeDocument {
        ...
        type DocumentStatus = 'CREATED' | 'VALIDATION_ASKED' | 'VALIDATED' | 'REFUSED';
    ...
    namespace cardRegistration {
        ...
        interface CreateCardRegistration
            extends PickPartialRequired<CardRegistrationData, 'CardType' | 'Tag', 'UserId' | 'Currency'> {}
        type UpdateCardRegistration = PickPartial<CardRegistrationData, 'Tag' | 'RegistrationData'>;
    }
    ...
    namespace cardPreAuthorization {
        ...
        >;
        type UpdateCardPreAuthorization = PickPartialRequired<CardPreAuthorizationData, 'Tag', 'PaymentStatus' | 'Id'>;
    }
    ...
    namespace hook {
        ...
        interface UpdateHook extends PickPartialRequired<HookData, 'EventType' | 'Url' | 'Tag', 'Id'> {}
    }
    ...
    namespace report {
        ...
        interface CreateReport
            extends PickPartial<
                ReportData,
                'Tag' | 'CallbackURL' | 'DownloadFormat' | 'Sort' | 'Preview' | 'Filters' | 'Columns'
            > {}
    }
    ...
    namespace mandate {
        ...
        interface CreateMandate
            extends PickPartialRequired<MandateData, 'Tag', 'BankAccountId' | 'Culture' | 'ReturnURL'> {}
    }
    ...
    namespace user {
        ...
        interface CreateUserLegalData
            extends MakeKeysRequired<BaseUserLegalData, RequiredUserLegalData | 'PersonType'> {}

        interface BaseUserNaturalData
            extends PickPartial<
                UserNaturalData,
                RequiredUserNaturalData | 'Address' | 'Occupation' | 'IncomeRange' | 'Tag'
            > {
            PersonType: 'NATURAL';
        }
        ...
        interface CreateUserNaturalData
            extends MakeKeysRequired<BaseUserNaturalData, RequiredUserNaturalData | 'PersonType'> {}
    }

    namespace payIn {
        type PayInPaymentType = ValueOf<IPayInPaymentType>;
        type PayInExecutionType = ValueOf<IPayInExecutionType> | 'EXTERNAL_INSTRUCTION';
        ...
        type PayInData = CardDirectPayInData | CardPreAuthorizedPayInData | CardWebPayInData | BankWireDirectPayInData;
    }
    ...
    namespace dispute {
        ...
        interface SubmitDispute extends PickPartial<DisputeData, 'ContestedFunds'> {}
    ...
    namespace settlementTransfer {
        ...
        interface CreateSettlementTransfer
            extends PickPartialRequired<SettlementTransferData, 'Tag', 'AuthorId' | 'DebitedFunds' | 'Fees'> {}
    }
    ...
    class Users {
         ...
         * Get all users
         */
        getAll: NoArgMethodOverload<Array<user.UserLegalData | user.UserNaturalData>>;
         ...
         * @param options
         */
        createBankAccount: TwoArgsMethodOverload<string, bankAccount.USDetails, bankAccount.USData> &
         ...
         * @param  options
         */
        createKycDocument: TwoArgsMethodOverload<string, kycDocument.CreateKycDocument, kycDocument.KycDocumentData>;
         ...
         * @param options
         */
        getKycDocument: TwoArgsMethodOverload<string, string, kycDocument.KycDocumentData>;
         ...
         * @param options
         */
        updateKycDocument: TwoArgsMethodOverload<string, kycDocument.SubmitKycDocument, kycDocument.KycDocumentData>;
         ...
         * @param options
         */
        createKycPage: ThreeArgsMethodOverload<string, string, kycDocument.CreateKycPage, kycDocument.KycDocumentData>;
         ...
         * @param options
         */
        createKycPageFromFile: ThreeArgsMethodOverload<string, string, string, kycDocument.KycDocumentData>;
         ...
         * @param options
         */
        getPreAuthorizations: MethodOverload<string, cardPreAuthorization.CardPreAuthorizationData[]>;
    }
    ...
    class UboDeclarations {
         ...
         * @param options
         */
        update: MethodOverload<uboDeclaration.UpdateUboDeclaration, uboDeclaration.UboDeclarationData>;
    }
    ...
    class Wallets {
         ...
         * @param options
         */
        create: MethodOverload<wallet.CreateWallet | models.Wallet, wallet.WalletData>;
         ...
         * @param options
         */
        update: MethodOverload<wallet.UpdateWallet | models.Wallet, wallet.WalletData>;
    ...
    class CardRegistrations {
         ...
         * @param options
         */
        create: MethodOverload<cardRegistration.CreateCardRegistration, cardRegistration.CardRegistrationData>;
         ...
         * @param  cardRegistration
         */
        update: MethodOverload<cardRegistration.UpdateCardRegistration, cardRegistration.CardRegistrationData>;
    }
    ...
    class PayIns {
         ...
         * @param options
         */
        create: MethodOverload<payIn.CreateCardDirectPayIn, payIn.CardDirectPayInData> &
         ...
         * @param options
         */
        createRefund: TwoArgsMethodOverload<string, refund.CreatePayInRefund, refund.RefundData>;
    ...
    class Clients {
         ...
         * @param options
         */
        getClientWallet: TwoArgsMethodOverload<wallet.ClientFundsType, CurrencyISO, wallet.ClientWalletData>;
         ...
         * @param options
         */
        getClientWalletsByFundsType: MethodOverload<wallet.ClientFundsType, wallet.ClientWalletData[]>;
    ...
    class Transfers {
         ...
         * @param options
         */
        createRefund: TwoArgsMethodOverload<string, refund.CreateTransferRefund, refund.RefundData>;
    ...
    class BankingAliases {
         ...
         * @param options
         */
        create: MethodOverload<bankingAlias.CreateIBANBankingAlias, bankingAlias.IBANBankingAliasData>;
    ...
    class Disputes {
         ...
         * @param options
         */
        contestDispute: TwoArgsMethodOverload<string, MoneyData, dispute.DisputeData>;
         ...
         * @param options
         */
        getSettlementTransfer: MethodOverload<string, settlementTransfer.SettlementTransferData>;
         ...
         * @param options
         */
        getDocumentsForDispute: MethodOverload<string, disputeDocument.DisputeDocumentData[]>;
    ...
    class Mandates {
         ...
         * @param options
         */
        getMandatesForBankAccount: TwoArgsMethodOverload<string, string, mandate.MandateData[]>;
