 ...
 */
declare function nspell(dictionary: IDictionary): NSpell

/**
 * @param dictionaries - List of dictionary objects. The first must have an aff key, other aff keys are ignored
 */
declare function nspell(dictionaries: IDictionary[]): NSpell
