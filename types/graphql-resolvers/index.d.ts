...
export function resolveDependee(dependeeName: string): IFieldResolver<any, any, TArgs>;

export function resolveDependees(dependeeNames: string[]): IFieldResolver<any, any, TArgs>;
