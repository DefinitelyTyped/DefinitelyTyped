...
var box = new photonui.BoxLayout({
    ...
    children: [new photonui.Button(), new photonui.Button(), new photonui.Button()],
});
...
var select = new photonui.FontSelect({
    value: 'item1',
    fonts: ['Arial', 'Arial Black', 'Cantarell', 'Courier New', 'Impact', 'Time New Roman', 'Titillium Web', 'Verdana'],
    callbacks: {
        'value-changed': function (widget: any, value: any) {
