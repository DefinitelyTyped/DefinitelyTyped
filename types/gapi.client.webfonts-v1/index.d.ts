...
declare namespace gapi.client.webfonts {
...
declare namespace gapi.client {
    ...
    export function load (name: "webfonts", version: "v1") : PromiseLike<void>;    
    export function load (name: "webfonts", version: "v1", callback: () => any) : void;    
    
    const webfonts: gapi.client.webfonts.WebfontsResource; 
