...
declare namespace gapi.client.gamesConfiguration {
...
declare namespace gapi.client {
    ...
    export function load (name: "gamesConfiguration", version: "v1configuration") : PromiseLike<void>;    
    export function load (name: "gamesConfiguration", version: "v1configuration", callback: () => any) : void;    
    
    const achievementConfigurations: gapi.client.gamesConfiguration.AchievementConfigurationsResource; 
    
    const imageConfigurations: gapi.client.gamesConfiguration.ImageConfigurationsResource; 
    
    const leaderboardConfigurations: gapi.client.gamesConfiguration.LeaderboardConfigurationsResource; 
