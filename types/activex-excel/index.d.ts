...
declare namespace Excel {
    ...
    type PivotTableWizardAutoPage<TSourceType> = TSourceType extends XlPivotTableSourceType.xlConsolidation
        ? boolean
        : undefined;
    ...
    class Application {
        ...
        ): string | number | boolean | Range | Error | SafeArray<string> | SafeArray<number> | SafeArray<boolean>;
        Interactive: boolean;
    ...
    class FormatCondition {
        ...
        Modify(
            ...
            Operator: XlFormatConditionOperator.xlBetween | XlFormatConditionOperator.xlNotBetween,
            Formula1: string,
            Formula2: string
        ): void;
        Modify(
    ...
    interface PivotCaches {
        ...
        readonly Count: number;
        Create(
            SourceType: XlPivotTableSourceType.xlDatabase | XlPivotTableSourceType.xlConsolidation,
            SourceData: string,
    ...
    interface Range {
        ...
        SpecialCells(
            Type: XlCellType.xlCellTypeConstants | XlCellType.xlCellTypeFormulas,
...
interface ActiveXObject {
    ...
    on(
        ...
        argNames: ['Wb', 'Ch'],
        handler: (this: Excel.Application, parameter: { readonly Wb: Excel.Workbook; readonly Ch: Excel.Chart }) => void
    ): void;
    on(
        obj: Excel.Application,
