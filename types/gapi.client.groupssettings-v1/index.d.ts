...
declare namespace gapi.client.groupssettings {
...
declare namespace gapi.client {
    ...
    export function load (name: "groupssettings", version: "v1") : PromiseLike<void>;    
    export function load (name: "groupssettings", version: "v1", callback: () => any) : void;    
    
    const groups: gapi.client.groupssettings.GroupsResource; 
