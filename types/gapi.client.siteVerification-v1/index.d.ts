...
declare namespace gapi.client.siteVerification {
...
declare namespace gapi.client {
    ...
    export function load (name: "siteVerification", version: "v1") : PromiseLike<void>;    
    export function load (name: "siteVerification", version: "v1", callback: () => any) : void;    
    
    const webResource: gapi.client.siteVerification.WebResourceResource; 
