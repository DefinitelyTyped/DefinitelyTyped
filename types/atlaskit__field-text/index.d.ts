// Type definitions for @atlaskit/field-text 7.0.13
...
export interface IFieldTextProp {
...
type InnerRefCallback = (node?: HTMLInputElement) => void
export interface IFieldTextStatelessProp extends IFieldTextProp {
    innerRef?: InnerRefCallback
}

export class FieldTextStateless extends Component<IFieldTextProp> {}
export default class extends Component<IFieldTextProp, IFieldState> {}
