// Type definitions for Google Google Cloud Natural Language API v1beta2 1.0
...
declare namespace gapi.client {
    // Load Google Cloud Natural Language API v1beta2
    function load(name: "language", version: "v1beta2"): PromiseLike<void>;    
    function load(name: "language", version: "v1beta2", callback: () => any): void;    
    
    const documents: gapi.client.language.DocumentsResource; 
