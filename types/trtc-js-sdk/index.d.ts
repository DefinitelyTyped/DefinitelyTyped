...
type Callback<T = any> = (info: T) => void;
...
declare namespace TRTC {
    ...
    interface Client {
        ...
        /** 获取当前已发布本地流的音频统计数据 */
        getLocalAudioStats(): Promise<MediaStatsMap<LocalAudioStats>>;

        /** 获取当前已发布本地流的视频统计数据 */
        getLocalVideoStats(): Promise<MediaStatsMap<LocalVideoStats>>;

        /** 获取当前所有远端流的音频统计数据 */
        getRemoteAudioStats(): Promise<MediaStatsMap<RemoteAudioStats>>;

        /** 获取当前所有远端流的视频统计数据 */
        getRemoteVideoStats(): Promise<MediaStatsMap<RemoteVideoStats>>;
    }
    ...
    /** 本地流视频统计数据 */
    interface LocalVideoStats extends SentMediaStats, VideoStats {
        /** 已编码帧数 */
    ...
    /** 远端流视频统计数据 */
    interface RemoteVideoStats extends ReceivedMediaStats, VideoStats {
        /** 已解码帧数 */
        framesDecoded: number;
    }

    type MediaStats = LocalAudioStats | LocalVideoStats | RemoteAudioStats | RemoteVideoStats;

    interface MediaStatsMap<T = MediaStats> {
        [userId: string]: T;
    }
