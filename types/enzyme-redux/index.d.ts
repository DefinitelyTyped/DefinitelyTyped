...
export function shallowWithStore<P>(Component: ReactElement<P>, store: any): ShallowWrapper<P>;
export function mountWithStore<P>(Component: ReactElement<P>, store: any): ReactWrapper<P>;
