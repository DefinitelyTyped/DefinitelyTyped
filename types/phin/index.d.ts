...
interface PhinFactory {
    ...
    unpromisified(
        optsOrUrl: (Options & { parse?: 'none'; stream?: false }) | string,
        cb: (err: unknown, resp: BufferResponse) => unknown
    ): void;
    unpromisified(
        optsOrUrl: Options & { parse: 'json'; stream?: false },
        cb: (err: unknown, resp: JsonResponse) => unknown
    ): void;
    ...
    defaults(
        defaultOpts: DefaultOpts & { parse: 'json'; stream?: false }
    ): {
        (optsOrUrl: Options & { stream: true }): Promise<StreamResponse>;
    ...
    defaults(
        defaultOpts: DefaultOpts & { parse?: 'none'; stream?: false }
    ): {
        (optsOrUrl: Options & { stream: true }): Promise<StreamResponse>;
        (optsOrUrl: Options & { parse: 'json'; stream?: false }): Promise<JsonResponse>;
        (optsOrUrl: (Options & { parse?: 'none'; stream?: false }) | string): Promise<BufferResponse>;
    ...
    defaults(
        defaultOpts: DefaultOpts & { parse: 'json'; stream: true }
    ): {
        (optsOrUrl: Options & { parse: 'none'; stream: false }): Promise<BufferResponse>;
        (optsOrUrl: Options & { parse?: 'json'; stream: false }): Promise<JsonResponse>;
    ...
    defaults(
        defaultOpts: DefaultOpts & { parse?: 'none'; stream: true }
    ): {
