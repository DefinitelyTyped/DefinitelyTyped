// Type definitions for Google Google Cloud Dataproc API v1beta2 1.0
...
// Generated from: https://dataproc.googleapis.com/$discovery/rest?version=v1beta2

/// <reference types="gapi.client" />

declare namespace gapi.client.dataproc {
...
declare namespace gapi.client {
    // Load Google Cloud Dataproc API v1beta2
    function load(name: "dataproc", version: "v1beta2"): PromiseLike<void>;    
    function load(name: "dataproc", version: "v1beta2", callback: () => any): void;    
    
    const projects: gapi.client.dataproc.ProjectsResource; 
