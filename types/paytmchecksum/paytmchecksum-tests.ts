...
PaytmChecksum.verifySignature(JSON.stringify({
  mid: "YOUR_MID_HERE",
  orderId: "YOUR_ORDER_ID_HERE"
}), "YOUR_MERCHANT_KEY", "checksum from generateSignature")
PaytmChecksum.verifySignature({
  mid: "YOUR_MID_HERE",
  orderId: "YOUR_ORDER_ID_HERE"
}, "YOUR_MERCHANT_KEY", "checksum from generateSignature")
PaytmChecksum.generateSignatureByString(JSON.stringify({
  mid: "YOUR_MID_HERE",
  orderId: "YOUR_ORDER_ID_HERE"
}), "YOUR_MERCHANT_KEY")
PaytmChecksum.verifySignatureByString(JSON.stringify({
  mid: "YOUR_MID_HERE",
  orderId: "YOUR_ORDER_ID_HERE"
}), "YOUR_MERCHANT_KEY", "checksum from generateSignature")
...
PaytmChecksum.calculateHash(JSON.stringify({
  mid: "YOUR_MID_HERE",
  orderId: "YOUR_ORDER_ID_HERE"
}), "RANDOM STRING AS SALT")
PaytmChecksum.calculateChecksum(JSON.stringify({
  mid: "YOUR_MID_HERE",
  orderId: "YOUR_ORDER_ID_HERE"
}), "YOUR_MERCHANT_KEY", "RANDOM STRING AS SALT")