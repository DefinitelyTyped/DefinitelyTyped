...
declare namespace xcode {
     ...
     */
    type PbxprojSection = Record<string, Record<string, unknown> | string>;

    /** Known section names within `hash.project.objects`. */
    interface PbxprojObjects {
    ...
    function project(projectPath: string): XcodeProject;
}
