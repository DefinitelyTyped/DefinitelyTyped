...
interface Animations {
     ...
     */
    runAnimation<T extends OptsType>(els: ElsType, opts: T): Promise<T> | void;
     ...
     */
    runAnimation<T extends ElsType, U>(
        els: T,
        opts: OptsType,
     ...
     */
    getAnimationCSS(name: string, positions: AnimationType): string;
