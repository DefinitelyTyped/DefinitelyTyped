...
export class Parser <OutputJsonInterface>{
    ...
    public attribsKey: string
    public dataKey: string
    public documentNodeName: string
    public piNodeList: string[]
    public dtdNodeList: string[]
    public errors: any[]
 ...
 * @param xml
 */
export function parse<OutputJsonInterface>(xml: string, options?: PixlParseOptions): OutputJsonInterface
