...
declare namespace gapi.client {
    ...
    namespace sheets {
        ...
        interface PivotValue {
             ...
             * PERCENT_OF_GRAND_TOTAL, all the pivot values are displayed as the percentage of the grand total. In the Sheets UI, this is referred to as "Show As" in the value section of a pivot
             * table.
             */
