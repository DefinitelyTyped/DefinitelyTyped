...
declare namespace gapi.client {
    ...
    namespace sheets {
        ...
        interface CellData {
            /**
             * Output only. Information about a data source formula on the cell. The field is set if user_entered_value is a formula referencing some [SheetType.DATA_SOURCE] sheet, e.g
        ...
        interface DataSource {
            ...
            dataSourceId?: string;
            /**
             * The ID of the Sheet connected with the data source. The field cannot be changed once set. When creating a data source, an associated SheetType.DATA_SOURCE sheet is also created, if
             * the field is not specified, the ID of the created sheet will be randomly generated.
             */
            sheetId?: number;
            /** The DataSourceSpec. */
            spec?: DataSourceSpec;
        ...
        interface SheetProperties {
             ...
             * error to set any grid properties on non-grid sheets.
             */
