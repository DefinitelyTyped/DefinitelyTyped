...
export namespace ShapeUtils {
    export function area(contour: Vector2[]): number;   
    export function triangulateShape(contour: Vector2[], holes: any[]): number[];
    export function isClockWise(pts: Vector2[]): boolean;
}
