...
export class ExtrudeGeometry extends Geometry {
    ...
    static WorldUVGenerator: {
        generateTopUV(geometry: Geometry, vertex:Vector3, indexA: number, indexB: number, indexC: number): Vector2[];
        generateSideWallUV(geometry: Geometry, vertex:Vector3, indexA: number, indexB: number, indexC: number, indexD: number): Vector2[];
    };
