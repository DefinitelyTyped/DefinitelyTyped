...
interface IotaApi extends IriApi {
    ...
    getLatestInclusion(hashes: string[], callback?: (error: Error, states: boolean[]) => void): void;

    broadcastAndStore(trytes: string[], callback?: (error: Error, response: {}) => void): void;
    ...
    broadcastBundle(transactionHash: string, callback?: (error: Error, response: {}) => void): void;

    getBundle(transactionHash: string, callback?: (error: Error, bundle: TransactionObject[]) => void): void;
    ...
    isReattachable(address: string | string[], callback?: (error: Error, response: boolean | boolean[]) => void): void;
}
