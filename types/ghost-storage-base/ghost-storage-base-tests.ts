...
storage.serve(); // $ExpectType (req: Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>, res: Response<any, number, Record<string, any>>, next: NextFunction) => void
