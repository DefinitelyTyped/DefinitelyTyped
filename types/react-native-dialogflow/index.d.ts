// Type definitions for react-native-dialogflow 3.2.0
// Project: https://github.com/innFactory/react-native-dialogflow
...
declare module 'react-native-dialogflow' {
    export namespace Dialogflow {
        ...
        function setEntities(entities: Array<any>): void;
        ...
        function setContexts(contexts: Array<any>): void;
        function resetContexts(resultCallback: (result: object) => void, errorCallback: (error: Error) => void): void;
        function setPermanentContexts(contexts: Array<any>): void;
