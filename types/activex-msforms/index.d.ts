...
interface ActiveXObject {
    ...
    on(
        ...
        event: 'BeforeDragOver',
        argNames: MSForms.EventHelperTypes.Control_BeforeDragOver_ArgNames,
        handler: (this: MSForms.ScrollBar, parameter: MSForms.EventHelperTypes.Control_BeforeDragOver_Parameter) => void
    ): void;
    on(
        obj: MSForms.ScrollBar,
        event: 'BeforeDropOrPaste',
    ...
    on(
        ...
        handler: (this: MSForms.TabStrip, parameter: MSForms.EventHelperTypes.TabStrip_BeforeDragOver_Parameter) => void
    ): void;
    on(
        obj: MSForms.TabStrip,
        event: 'BeforeDropOrPaste',
