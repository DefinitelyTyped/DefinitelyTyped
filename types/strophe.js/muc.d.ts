    ...
    namespace Strophe {
        ...
        namespace MUC {
            interface Plugin {
                 ...
                 */
                leave(room: string, nick: string, handler_cb?: (stanza: Element) => boolean, exit_msg?: string): string;
            ...
            interface XmppRoom {
                 ...
                 */
                addHandler(handler_type: 'presence' | 'message' | 'roster', handler: (stanza: Element) => any): number;
            ...
            interface Occupant extends OccupantInfo {
                ...
                op(reason?: string, handler_cb?: (stanza: Element) => any, error_cb?: (stanza: Element) => any): string;
