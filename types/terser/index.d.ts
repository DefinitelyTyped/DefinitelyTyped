...
declare module "terser" {
    ...
    /**
     * Terser provides a TreeWalker object and every node has a walk method that given a walker will apply your visitor to each node in the tree.
    ...
    type visitor = (node: AST_Node, descend: Function) => boolean | void;
