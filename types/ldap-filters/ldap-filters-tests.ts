...
const output = Filter.AND([Filter.attribute('givenName').equalTo('jenny'), Filter.attribute('sn').equalTo('jensen')]);
...
const filter = Filter.parse('(&(givenName=jenny)(sn=jensen)(|(c=us)(st=ontario)))');
