...
gapi.load('client', () => {
    ...
    async function run() {
         ...
         */
        await gapi.client.spectrum.paws.getSpectrum({
        });
        /** The Google Spectrum Database does not support batch requests, so this method always yields an UNIMPLEMENTED error. */
        await gapi.client.spectrum.paws.getSpectrumBatch({
        });
        /** Initializes the connection between a white space device and the database. */
        await gapi.client.spectrum.paws.init({
        });
        /**
         ...
         */
        await gapi.client.spectrum.paws.notifySpectrumUse({
        });
        ...
        await gapi.client.spectrum.paws.register({
        });
        /**
         ...
         */
        await gapi.client.spectrum.paws.verifyDevice({
        });
    }
});
