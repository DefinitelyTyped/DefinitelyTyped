...
declare namespace gapi.client.gamesManagement {
...
declare namespace gapi.client {
    ...
    export function load (name: "gamesManagement", version: "v1management") : PromiseLike<void>;    
    export function load (name: "gamesManagement", version: "v1management", callback: () => any) : void;    
    
    const achievements: gapi.client.gamesManagement.AchievementsResource; 
    
    const applications: gapi.client.gamesManagement.ApplicationsResource; 
    
    const events: gapi.client.gamesManagement.EventsResource; 
    
    const players: gapi.client.gamesManagement.PlayersResource; 
    
    const quests: gapi.client.gamesManagement.QuestsResource; 
    
    const rooms: gapi.client.gamesManagement.RoomsResource; 
    
    const scores: gapi.client.gamesManagement.ScoresResource; 
    
    const turnBasedMatches: gapi.client.gamesManagement.TurnBasedMatchesResource; 
