...
export namespace utils {
    ...
    function generateKeyPair<K extends KeyType>(keyType: K, opts: KeySettings[K] & KeyPairOptions, cb?: (err: Error | null, keyPair: KeyPairReturn) => void): void;
    function generateKeyPair<K extends OptionalKeyType>(keyType: K, opts?: KeySettings[K] & KeyPairOptions, cb?: (err: Error | null, keyPair: KeyPairReturn) => void): void;
    ...
    function generateKeyPairSync<K extends OptionalKeyType>(keyType: K, opts?: KeySettings[K] & KeyPairOptions): KeyPairReturn;
    namespace sftp {
        enum OPEN_MODE {
            READ = 0x00000001,
            WRITE = 0x00000002,
