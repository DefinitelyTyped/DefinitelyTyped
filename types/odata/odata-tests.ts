...
o('http://services.odata.org/V4/OData/OData.svc/Products').get<Product>(
    function(data) {
...
Q.all<any>([
    ...
    o('http://services.odata.org/V4/OData/OData.svc/Categories')
        .take(2)
        .get<Category[]>(),
...
const oEequest = o('http://services.odata.org/V4/OData/OData.svc/Products').find(2);
