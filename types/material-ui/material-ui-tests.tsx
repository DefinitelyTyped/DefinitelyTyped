...
class DeepDownTheTree extends Component<{} & { muiTheme: MuiTheme }> {
    ...
    render() {
        return <span style={{ color: this.props.muiTheme.palette.textColor }}>Hello World!</span>;
    }
}
...
const AppBarExampleIcon = () => <AppBar title="Title" iconClassNameRight="muidocs-icon-navigation-expand-more" />;
...
const dataSource3 = [{ text: 'Some Text', value: 'someFirstValue' }, { text: 'Some Text', value: 'someSecondValue' }];
...
const AvatarExampleSimple = () => (
    <List className="foo">
        ...
        <ListItem
            disabled={true}
            leftAvatar={
                <Avatar icon={<FileFolder />} color={orange200} backgroundColor={pink400} size={30} style={style} />
            }
        >
...
const RaisedButtonExampleComplex = () => (
    <div>
        <RaisedButton label="Choose an Image" labelPosition="before" style={styles.button}>
            <input type="file" style={styles.exampleImageInput} />
        </RaisedButton>
        <RaisedButton
...
class ChipExampleComplex extends Component {
    ...
    render() {
        return (
            <div>
                <Chip onClick={this.handleClick} onRequestDelete={this.handleRequestDelete}>
                    Click Me
                </Chip>
            </div>
        );
...
class DialogExampleDialogDatePicker extends Component<{}, { open?: boolean }> {
    ...
    render() {
        const actions = [<FlatButton label="Ok" primary={true} keyboardFocused={true} onClick={this.handleClose} />];
...
class DialogExampleScrollable extends Component<{}, { open?: boolean }> {
    ...
    render() {
        ...
        for (let i = 0; i < 30; i++) {
            radios.push(
                <RadioButton key={i} value={`value${i + 1}`} label={`Option ${i + 1}`} style={styles.radioButton} />
            );
        }
...
const FontIconExampleIcons = () => (
    <div>
        ...
        <FontIcon className="material-icons" style={iconStyles} color={red500}>
            flight_takeoff
        </FontIcon>
        <FontIcon className="material-icons" style={iconStyles} color={yellow500}>
            cloud_download
        </FontIcon>
        ...
        <Paper>
            <List>
                ...
                <ListItem
                    ...
                    secondaryText={
                        <p>
                            <span style={{ color: darkBlack }}>Brendan Lim</span> -- I&apos;ll be in your neighborhood
                            doing errands this weekend. Do you want to grab brunch?
                        </p>
                    }
                ...
                <ListItem
                    ...
                    primaryText={
                        <p>
                            Summer BBQ&nbsp;&nbsp;<span style={{ color: lightBlack }}>4</span>
                        </p>
                    }
                    secondaryText={
                        <p>
                            <span style={{ color: darkBlack }}>to me, Scott, Jennifer</span> -- Wish I could come, but
                ...
                <ListItem
                    ...
                    secondaryText={
                        <p>
                            <span style={{ color: darkBlack }}>Grace Ng</span> -- Do you have Paris recommendations?
                            Have you ever been?
                        </p>
                    }
                    secondaryTextLines={2}
                ...
                <ListItem
                    ...
                    secondaryText={
                        <p>
                            <span style={{ color: darkBlack }}>Kerem Suer</span> -- Do you have any ideas what we can
                            get Heidi for her birthday? How about a pony?
                        </p>
                    }
                    secondaryTextLines={2}
                />
                ...
                <ListItem
                    ...
                    secondaryText={
                        <p>
                            <span style={{ color: darkBlack }}>Raquel Parrado</span> -- We should eat this: grated
                            squash. Corn and tomatillo tacos.
                        </p>
                    }
                    secondaryTextLines={2}
                />
    ...
    <Paper>
        <SelectableList defaultValue={3}>
            ...
            <ListItem
                ...
                leftAvatar={<Avatar src="images/ok-128.jpg" />}
                nestedItems={[
                    <ListItem value={2} primaryText="Grace Ng" leftAvatar={<Avatar src="images/uxceo-128.jpg" />} />,
                ]}
            />
            <ListItem value={3} primaryText="Kerem Suer" leftAvatar={<Avatar src="images/kerem-128.jpg" />} />
        ...
        <Paper style={styles.paper}>
            <Menu>
                ...
                <MenuItem
                    ...
                    rightIcon={
                        <FontIcon className="material-icons" style={{ color: '#559' }}>
                            settings
                        </FontIcon>
                    }
                />
...
class PopoverExampleSimple extends Component<{}, { open?: boolean; anchorEl?: ReactInstance }> {
    ...
    render() {
        return (
            <div>
                <RaisedButton onClick={this.handleClick} label="Click me" />
                <Popover
                    open={this.state.open}
...
const LinearProgressExampleSimple = () => <LinearProgress mode="indeterminate" />;
...
const RefreshIndicatorExampleSimple = () => (
    <div style={styles.container}>
        <RefreshIndicator percentage={30} size={40} left={10} top={0} status="ready" style={styles.refresh} />
        <RefreshIndicator percentage={60} size={50} left={65} top={0} status="ready" style={styles.refresh} />
        <RefreshIndicator
            percentage={80}
            size={60}
            left={120}
...
const RefreshIndicatorExampleLoading = () => (
    <div style={styles.container}>
        <RefreshIndicator size={40} left={10} top={0} status="loading" style={styles.refresh} />
        <RefreshIndicator
            size={50}
            left={70}
            top={0}
...
class SelectFieldExampleMultiSelect extends Component<{}, { values?: string[] }> {
    ...
    render() {
        ...
        return (
            <SelectField multiple={true} hintText="Select a name" value={values} onChange={this.handleChange}>
...
const SliderExampleStep = () => <Slider step={0.1} value={0.5} />;
...
const CheckboxExampleSimple = () => (
    <div style={styles.block}>
        ...
        <Checkbox label="Checked by default" defaultChecked={true} style={styles.checkbox} />
        <Checkbox
...
const ToggleExampleSimple = () => (
    <div style={styles.block}>
        ...
        <Toggle label={<span>Element</span>} style={styles.toggle} />
...
class SnackbarExampleSimple extends Component<{}, { open?: boolean }> {
    ...
    render() {
        return (
            <div>
                <RaisedButton onClick={this.handleClick} label="Add to my calendar" />
                <Snackbar
                    open={this.state.open}
...
class SnackbarExampleTwice extends Component<{}, { open?: boolean; message?: string }> {
    ...
    render() {
        return (
            <div>
                <RaisedButton onClick={this.handleClick} label="Add to my calendar two times" />
                <Snackbar
                    open={this.state.open}
                    message={this.state.message}
                    action="undo"
        ...
        return (
            <div style={{ width: '100%', maxWidth: 700, margin: 'auto' }}>
                <Stepper linear={false} activeStep={stepIndex}>
                    ...
                    <Step>
                        <StepButton onClick={() => this.setState({ stepIndex: 1 })}>Create an ad group</StepButton>
                    </Step>
                    <Step>
        ...
        return (
            <div style={{ width: '100%', maxWidth: 700, margin: 'auto' }}>
                <Stepper linear={false}>
                    ...
                    <Step completed={false}>
                        <StepLabel icon={<AlertWarning color={red500} />} style={{ color: red500 }}>
                            Create an ad group
                        </StepLabel>
                    </Step>
                    <Step completed={false}>
...
const TabsExampleSimple = () => (
    <Tabs tabTemplateStyle={{ backgroundColor: 'red' }}>
        ...
        <Tab label="onActive" value="/home" onActive={handleActive}>
            <div>
            ...
            <Tabs value={this.state.value} onChange={this.handleChange}>
                <Tab label="Tab A" value="a">
                    <div>
                        ...
                        <p>
                            Tabs are also controllable if you want to programmatically pass them their values. This
                            allows for more functionality in Tabs such as not having any Tab selected or assigning them
                            different values.
                        </p>
                    </div>
                </Tab>
                <Tab label="Tab B" value="b">
                    <div>
                        ...
                        <p>
                            This is another example of a controllable tab. Remember, if you use controllable Tabs, you
                            need to give all of your tabs values or else you wont be able to select them.
                        </p>
                    </div>
                </Tab>
            </Tabs>
...
const TextFieldExampleSimple = () => (
    <div>
        ...
        <br />
        <TextField type="number" min={5} max={50} step={5} />
        <br />
        <TextField hintText="Hint Text" errorText="This field is required" required />
    </div>
);
...
const TimePickerInternational = () => (
    <div>
        <TimePicker hintText="Custom Labels" okLabel="确定" cancelLabel="取消" />
    </div>
);
...
ReactDOM.render(<MaterialUiTests />, document.getElementById('app'));
