...
const MuiThemeableFunction = muiThemeable()<StatelessComponent<Props>, Props>(
  props => {
    return (
...
@muiThemeable()
class MuiThemeableClass extends Component<
  { label: string } & { muiTheme?: MuiTheme }
> {
  render() {
    return (
      <span style={{ color: this.props.muiTheme.palette.textColor }}>
        Applied the Theme to class component decorated:{" "}
        {this.props.label}.
      </span>
    );
  }
...
const AvatarExampleSimple = () => (
  <List className="foo">
    ...
    <ListItem
      disabled={true}
      leftAvatar={
        <Avatar src="images/uxceo-128.jpg" size={30} style={style} />
      }
    >
...
class DatePickerExampleToggle extends Component<
  {},
  DatePickerExampleToggleState
> {
  static initState() {
...
class DatePickerExampleControlled extends Component<
  {},
  { controlledDate?: Date }
> {
  state = {
      ...
      <List>
        ...
        <ListItem
          ...
          secondaryText={
            <p>
              ...
              this weekend. Do you want to grab brunch?
            </p>
          }
        ...
        <ListItem
          ...
          primaryText={
            <p>
              Summer BBQ&nbsp;&nbsp;
              <span style={{ color: lightBlack }}>4</span>
            </p>
          }
          secondaryText={
            <p>
        ...
        <ListItem
          ...
          secondaryText={
            <p>
              ...
              -- Do you have any ideas what we can get Heidi for
              her birthday? How about a pony?
            </p>
          }
          secondaryTextLines={2}
        />
...
function wrapState(
  ComposedComponent: ComponentClass<__MaterialUI.List.SelectableProps>
) {
  return class SelectableList extends Component<
    { defaultValue: number; children: React.ReactNode },
  ...
  <div>
    ...
    <Paper style={style}>
      <Menu desktop={true} width={256}>
        ...
        <MenuItem
          primaryText="Paste in place"
          secondaryText="Shift + V"
        />
        <MenuItem
          primaryText="Research"
          secondaryText="Opt + Shift + Cmd + I"
        />
      </Menu>
    </Paper>
    <Paper style={style}>
          ...
          menuItems={[
            <MenuItem
              ...
              menuItems={[
                ...
                <MenuItem
                  primaryText="Grid lines"
                  checked={true}
                />,
                <MenuItem
                  primaryText="Page breaks"
                  insetChildren={true}
                />,
...
class IconMenuExampleControlled extends Component<
  {},
  IconMenuExampleControlledState
> {
  state = {
    valueSingle: "3",
    valueMultiple: ["3", "5"],
...
class DropDownMenuOpenImmediateExample extends Component<
  {},
  { value?: number }
> {
  state = { value: 2 };
...
class PopoverExampleSimple extends Component<
  {},
  { open?: boolean; anchorEl?: ReactInstance }
> {
  state = {
    open: false,
    anchorEl: null
...
class PopoverExampleConfigurable extends Component<
  {},
  PopoverExampleConfigurableState
> {
  ...
  render() {
    return (
      <div>
        ...
        <p>
          Use the settings below to toggle the positioning of the
          popovers above
        </p>
        ...
        <div style={styles.block}>
          <div style={styles.block2}>
            ...
            <RadioButton
              ...
              label="Center"
              checked={
                this.state.anchorOrigin.vertical === "center"
              }
            />
            <RadioButton
              onClick={this.setAnchor.bind(
          ...
          <div style={styles.block2}>
            ...
            <RadioButton
              ...
              label="Left"
              checked={
                this.state.anchorOrigin.horizontal === "left"
              }
            />
            <RadioButton
              onClick={this.setAnchor.bind(
              ...
              label="Middle"
              checked={
                this.state.anchorOrigin.horizontal === "middle"
              }
            />
            <RadioButton
              onClick={this.setAnchor.bind(
              ...
              label="Right"
              checked={
                this.state.anchorOrigin.horizontal === "right"
              }
            />
          </div>
        </div>
        ...
        <div style={styles.block}>
          <div style={styles.block2}>
            ...
            <RadioButton
              ...
              label="Center"
              checked={
                this.state.targetOrigin.vertical === "center"
              }
            />
            <RadioButton
              onClick={this.setTarget.bind(
              ...
              label="Bottom"
              checked={
                this.state.targetOrigin.vertical === "bottom"
              }
            />
          </div>
          <div style={styles.block2}>
            ...
            <RadioButton
              ...
              label="Left"
              checked={
                this.state.targetOrigin.horizontal === "left"
              }
            />
            <RadioButton
              onClick={this.setTarget.bind(
              ...
              label="Middle"
              checked={
                this.state.targetOrigin.horizontal === "middle"
              }
            />
            <RadioButton
              onClick={this.setTarget.bind(
              ...
              label="Right"
              checked={
                this.state.targetOrigin.horizontal === "right"
              }
            />
          </div>
        </div>
...
class CircularProgressExampleDeterminate extends Component<
  {},
  { completed?: number }
> {
    ...
    return (
      <div>
        ...
        <SelectField
          ...
          onChange={this.handleChange}
          errorText={
            night && "Should not be Night (Custom error style)"
          }
...
class SliderExampleControlled extends Component<
  {},
  { firstSlider?: number; secondSlider?: number }
> {
  state = {
    firstSlider: 0.5,
    secondSlider: 50
...
class SnackbarExampleAction extends Component<
  {},
  { open?: boolean; autoHideDuration?: number; message?: string }
> {
  state = {
    autoHideDuration: 4000,
    message: "Event added to your calendar",
...
class SnackbarExampleTwice extends Component<
  {},
...
class HorizontalLinearStepper extends Component<
  {},
  { stepIndex?: number; finished?: boolean }
> {
  state = {
    finished: false,
    stepIndex: 0
...
class GranularControlStepper extends Component<
  {},
  { stepIndex?: number; visited?: number[] }
> {
  state = {
    stepIndex: null,
    visited: []
    ...
    return (
      <div>
        ...
        <div style={styles.propContainer}>
          ...
          />
          <h3 style={styles.propToggleHeader}>
  ...
  <Tabs tabTemplateStyle={{ backgroundColor: "red" }}>
    <Tab label="Item One">
      <div>
        ...
        <p>
          You can put any sort of HTML or react component in here. It
          even keeps the component state!
        </p>
      ...
      <Tabs value={this.state.value} onChange={this.handleChange}>
        <Tab label="Tab A" value="a">
          <div>
            ...
            <p>
              Tabs are also controllable if you want to
              programmatically pass them their values. This allows
              for more functionality in Tabs such as not having
              any Tab selected or assigning them different values.
            </p>
          </div>
        </Tab>
        <Tab label="Tab B" value="b">
          <div>
            ...
            <p>
              This is another example of a controllable tab.
              Remember, if you use controllable Tabs, you need to
              give all of your tabs values or else you wont be
              able to select them.
            </p>
          </div>
        </Tab>
