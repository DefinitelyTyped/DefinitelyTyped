...
declare module "countryjs" {
     ...
     *
     */
    export function info(name: string, mode?: "ISO2" | "ISO3" | "name"): ICountry | undefined
    ...
    *
    */
    export function translations(name: string, mode?: "ISO2" | "ISO3" | "name"): { de: string, es: string, fr: string, ja: string, it: string } | undefined
