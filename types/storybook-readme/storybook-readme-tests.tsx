...
storiesOf('withReadme Example', module)
    ...
    .add('StoryName Here', withReadme(DocExample1, () => <div>your react component</div>))
    .add('StoryName Here', withReadme([DocExample1, DocExample2], () => <div>your react component</div>));
...
storiesOf('withDocs Example', module)
    ...
    .add('StoryName Here', withDocs(DocExample1, () => <div>your react component</div>))
    .add('StoryName Here', withDocs([DocExample1, DocExample2], () => <div>your react component</div>));
