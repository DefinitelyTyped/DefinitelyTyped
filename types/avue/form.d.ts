...
import type { FormItemRule, UploadRawFile, UploadFile, UploadUserFile } from 'element-plus';

declare module '@smallwei/avue' {
    export interface AvueFormColumn<T = any> {
        /** 表单项类型 */
        type?: string;
        /** 字段位置排序，数字越大位置越靠前 */
        order?: number;
        ...
        /** 点击事件 */
        click?: (args: { column: AvueFormColumn<T>[]; row: T; index: number; label: any; value: any }) => void;
        /** 值改变事件 */
        change?: (args: { column: AvueFormColumn<T>[]; row: T; index: number; label: any; value: any }) => void;
        /** 聚焦事件 */
        focus?: (args: { column: AvueFormColumn<T>[]; row: T; index: number; label: any; value: any }) => void;
        /** 失焦事件 */
        blur?: (args: { column: AvueFormColumn<T>[]; row: T; index: number; label: any; value: any }) => void;
        [x: string]: any;
    }
