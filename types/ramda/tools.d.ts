...
declare namespace Curry {
    type GapOf<T1 extends any[], T2 extends any[], TN extends any[], I extends any[]> = T1[Tools.Pos<
        I
    >] extends R.Placeholder
    ...
    type PartialGaps<T extends any[]> = { [K in keyof T]?: T[K] | R.Placeholder };
    ...
    type Curry<F extends (...args: any) => any> = <T extends any[]>(
        ...args: Tools.Cast<Tools.Cast<T, Gaps<Parameters<F>>>, any[]>
