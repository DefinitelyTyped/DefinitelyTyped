...
// compose<V extends unknown[], T1>(fn0: (...args: V) => T1): (...args: V) => ReturnType<typeof fn0>;
// compose<V extends unknown[], T1, T2>(fn1: (x: ReturnType<typeof fn0>) => T2, fn0: (...args: V) => T1): (...args: V) => ReturnType<typeof fn1>;
