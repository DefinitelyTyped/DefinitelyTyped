...
export function both<T, TF1 extends T>(
    pred1: PredTypeguard<T, TF1>,
): <TF2 extends T>(pred2: PredTypeguard<T, TF2>) => (a: T) => a is TF1 & TF2;
...
export function cond<T, TF1 extends T, TF2 extends Exclude<T, TF1>, R>(
    pairs: [CondPairTypeguard<T, TF1, R>, CondPairTypeguard<Exclude<T, TF1>, TF2, R>],
): (value: T) => R;
export function cond<T, TF1 extends T, TF2 extends Exclude<T, TF1>, TF3 extends Exclude<T, TF1 | TF2>, R>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        CondPairTypeguard<Exclude<T, TF1>, TF2, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2>, TF3, R>,
    ],
): (value: T) => R;
export function cond<
    T,
    TF1 extends T,
    TF2 extends Exclude<T, TF1>,
    TF3 extends Exclude<T, TF1 | TF2>,
    TF4 extends Exclude<T, TF1 | TF2 | TF3>,
    R,
>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        CondPairTypeguard<Exclude<T, TF1>, TF2, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2>, TF3, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3>, TF4, R>,
    ],
): (value: T) => R;
export function cond<
    T,
    ...
    TF3 extends Exclude<T, TF1 | TF2>,
    TF4 extends Exclude<T, TF1 | TF2 | TF3>,
    TF5 extends Exclude<T, TF1 | TF2 | TF3 | TF4>,
    R,
>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        ...
        CondPairTypeguard<Exclude<T, TF1 | TF2>, TF3, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3>, TF4, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4>, TF5, R>,
    ],
): (value: T) => R;
export function cond<
    T,
    ...
    TF4 extends Exclude<T, TF1 | TF2 | TF3>,
    TF5 extends Exclude<T, TF1 | TF2 | TF3 | TF4>,
    TF6 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5>,
    R,
>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        ...
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3>, TF4, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4>, TF5, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5>, TF6, R>,
    ],
): (value: T) => R;
export function cond<
    T,
    ...
    TF5 extends Exclude<T, TF1 | TF2 | TF3 | TF4>,
    TF6 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5>,
    TF7 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6>,
    R,
>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        ...
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4>, TF5, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5>, TF6, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6>, TF7, R>,
    ],
): (value: T) => R;
export function cond<
    T,
    ...
    TF6 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5>,
    TF7 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6>,
    TF8 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7>,
    R,
>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        ...
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5>, TF6, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6>, TF7, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7>, TF8, R>,
    ],
): (value: T) => R;
export function cond<
    T,
    ...
    TF7 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6>,
    TF8 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7>,
    TF9 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7 | TF8>,
    R,
>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        ...
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6>, TF7, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7>, TF8, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7 | TF8>, TF9, R>,
    ],
): (value: T) => R;
export function cond<
    T,
    ...
    TF8 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7>,
    TF9 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7 | TF8>,
    TF10 extends Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7 | TF8 | TF9>,
    R,
>(
    pairs: [
        CondPairTypeguard<T, TF1, R>,
        ...
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7>, TF8, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7 | TF8>, TF9, R>,
        CondPairTypeguard<Exclude<T, TF1 | TF2 | TF3 | TF4 | TF5 | TF6 | TF7 | TF8 | TF9>, TF10, R>,
    ],
): (value: T) => R;
