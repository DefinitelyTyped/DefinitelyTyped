...
() => {
  ...
  function add11(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) {
  ...
  = R.useWith(add11, [square, square, square, square, square, square, square, square, square, square, square]);
};
