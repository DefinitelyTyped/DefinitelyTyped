...
// Definitions by: Craig Boland <https://github.com/cnboland>
...
interface BootstrapDialogStatic {
    ...
    (options: BootstrapDialogOptions): BootstrapDialogContext;
    alert(message: string, closeCallback?: () => void): void;
    confirm(message: string, closeCallback?: (result: boolean) => void): void;
    show(options: BootstrapDialogOptions): BootstrapDialogInstance;
}
...
interface BootstrapDialogOptions {
    ...
    message?: string | JQuery | ((dialog?: BootstrapDialogContext) => string | JQuery);
    /**
     ...
     */
    onhide?(dialog?: BootstrapDialogContext): any;
    /** If provided, it will be invoked when the dialog is popped down. */
    onhidden?(dialog?: BootstrapDialogContext): void;
...
interface BootstrapDialogInstance {
    $modal: JQuery;
    $modalBody: JQuery;
    $modalContent: JQuery;
    $modalDialog: JQuery;
...
interface BootstrapDialogButton {
     ...
     */
    action?: (dialog: BootstrapDialogContext) => void;
}

interface BootstrapDialogButtonInstance {
...
interface BootstrapDialogContext {
