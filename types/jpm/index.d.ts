...
declare module 'sdk/page-mod' {
     ...
     */
    export function PageMod(options: {
...
declare module 'sdk/passwords' {
    ...
    export function store(
        options: Credential & { onComplete?: () => any; onError?: (error: FFAddonSDK.NSIException) => any },
    ): void;
...
declare module 'sdk/request' {
    ...
    export function Request<ResponseType>(options: {
        url?: string | FFAddonSDK.SDKURL;
...
declare namespace FFAddonSDK {
    ...
    interface ActionButton extends ActionButtonState {
        ...
        state: (
            ...
            state?: { disabled?: boolean; label?: string; icon?: Icon },
        ) => ActionButtonState;
        click: () => void;
        destroy: () => void;
