...
export function usePortalManager(): UsePortalManagerHook["add"] &
...
export function useToastManager(): UseToastManagerHook["notify"] &
  UseToastManagerHook;
...
export interface CalendarProps
  extends Omit<TonicProps, "children" | "onChange" | "onError"> {
  date?: Date;
  defaultDate?: Date;
  /**
...
export interface TabProps<T extends string | number | undefined>
  extends Omit<TonicProps, "children"> {
  children:
    | ReactNode
    | ((args: {
...
export interface TabPanelProps<T extends number | string | undefined>
  extends Omit<TonicProps, "children"> {
  children:
    | ReactNode
    | ((args: {
...
export interface TabsProps<T extends number | string | undefined>
  extends Omit<TonicProps, "children" | "onChange"> {
  children: ReactNode | ((context: unknown) => ReactNode);
  defaultIndex?: T;
  disabled?: boolean;
  index?: T;
...
type _ExtendedCSSProperties = Omit<
  CSSProperties,
...
type _CSSPropsWithHTML<Attributes> = RefAttributes<any> &
  Attributes &
