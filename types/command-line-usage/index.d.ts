 ...
 */
declare function commandLineUsage(sections: Section | Section[]): string;
...
export interface Content {
     ...
     *  3. An array of objects (recordset-style data). In this case, the data will be rendered in table format. The property names of each object are not important, so long as they are consistent
