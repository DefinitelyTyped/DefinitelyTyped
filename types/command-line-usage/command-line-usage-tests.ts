...
usage = getUsage([
    ...
    {
        header: 'Options',
        optionList: [{ name: 'files', typeLabel: '\\{something\\}', description: 'This is not \\{red red\\}.' }],
    },
]);
...
usage = getUsage([
    ...
    {
        header: 'Options',
        optionList: [{ name: 'files', typeLabel: '{magenta {underline files}}', description: 'This is {red red}.' }],
    },
    {
...
sections = [
    {
        ...
        content: {
            options: {
                columns: [{ name: 'one', maxWidth: 40 }, { name: 'two', width: 40, noWrap: true }],
            },
            data: [
                {
...
sections = [
    ...
    {
        content: ['{italic This app was tested by dragons in Wales.}', '', null],
        raw: true,
    },
];
getUsage(sections);
...
sections = [
    {
        header: 'Example app',
        content: ['Generates something {italic very} important. This description is:'],
    },
    {
        content: {
            options: {
            ...
            data: [{ col: '  • rather long' }, { col: '  • inconsequential' }, { col: '  • demonstrative' }],
        },
    },
    {
        content: [
