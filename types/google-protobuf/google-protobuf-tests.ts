...
class MySimple extends jspb.Message {
    ...
    static serializeBinaryToWriter(message: MySimple, writer: jspb.BinaryWriter) {
        ...
        if (f4 != null) {
            writer.writeMessage(4, f4, google_protobuf_compiler_plugin_pb.CodeGeneratorRequest.serializeBinaryToWriter);
        }
        const f5 = message.getSomeAny();
        if (f5 != null) {
            writer.writeMessage(5, f5, google_protobuf_any_pb.Any.serializeBinaryToWriter);
        }
        const f6 = message.getSomeMethod();
        if (f6 != null) {
            writer.writeMessage(6, f6, google_protobuf_api_pb.Method.serializeBinaryToWriter);
        }
        const f7 = message.getSomeGeneratedCodeInfo();
        if (f7 != null) {
            writer.writeMessage(7, f7, google_protobuf_descriptor_pb.GeneratedCodeInfo.serializeBinaryToWriter);
        }
        const f8 = message.getSomeDuration();
        if (f8 != null) {
            writer.writeMessage(8, f8, google_protobuf_duration_pb.Duration.serializeBinaryToWriter);
        }
        const f9 = message.getSomeEmpty();
        if (f9 != null) {
            writer.writeMessage(9, f9, google_protobuf_empty_pb.Empty.serializeBinaryToWriter);
        }
        const f10 = message.getSomeFieldMask();
        if (f10 != null) {
            writer.writeMessage(10, f10, google_protobuf_field_mask_pb.FieldMask.serializeBinaryToWriter);
        }
        const f11 = message.getSomeSourceContext();
        if (f11 != null) {
            writer.writeMessage(11, f11, google_protobuf_source_context_pb.SourceContext.serializeBinaryToWriter);
        }
        const f12 = message.getSomeStruct();
        if (f12 != null) {
            writer.writeMessage(12, f12, google_protobuf_struct_pb.Struct.serializeBinaryToWriter);
        }
        const f13 = message.getSomeTimestamp();
        if (f13 != null) {
            writer.writeMessage(13, f13, google_protobuf_timestamp_pb.Timestamp.serializeBinaryToWriter);
        }
        const f14 = message.getSomeType();
        if (f14 != null) {
            writer.writeMessage(14, f14, google_protobuf_type_pb.Type.serializeBinaryToWriter);
        }
        const f15 = message.getSomeDoubleValue();
        if (f15 != null) {
            writer.writeMessage(15, f15, google_protobuf_wrappers_pb.DoubleValue.serializeBinaryToWriter);
        }
    }
