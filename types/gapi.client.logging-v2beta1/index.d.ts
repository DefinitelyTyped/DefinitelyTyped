...
declare namespace gapi.client {
    // Load Stackdriver Logging API v2beta1
    export function load (name: "logging", version: "v2beta1") : PromiseLike<void>;    
    export function load (name: "logging", version: "v2beta1", callback: () => any) : void;    
