...
const v_host: string = snmp.defaultOptions.host;
const v_community: string = snmp.defaultOptions.community;
const v_family: 'udp4' | 'udp6' = snmp.defaultOptions.family;
const v_port: number = snmp.defaultOptions.port;
const v_bindPort: number = snmp.defaultOptions.bindPort;
const v_timeouts: number[] = snmp.defaultOptions.timeouts;
...
function callback ( err: Error | null, varbinds: VarBind[] ): void {
    ...
    const v_valueHex: string = vb.valueHex;
