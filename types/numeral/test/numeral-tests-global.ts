...
const value3: numeral.Numeral = numeral(1000);
const added: numeral.Numeral = value3.add(10);
// 1010
...
const value7: numeral.Numeral = numeral(0);
numeral.zeroFormat('N/A');
const zeroString: string = value7.format('0.0');
// 'N/A'

const a: numeral.Numeral = numeral(1000);
