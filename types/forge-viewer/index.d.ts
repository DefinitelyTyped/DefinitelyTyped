...
declare namespace Autodesk {
  namespace Viewing {
    ...
    namespace Private {
      ...
      class InstanceTree {
        constructor(nodeAccess: any, objectCount: number, maxDepth: number);
        root: InstanceTreeNode;
        enumNodeFragments(node: any, callback: (dbid: any) => void, recursive?: boolean): void;
      }
      ...
      namespace VertexEnumerator {
        ...
        function enumMeshVertices(geometry: any, callback: any, matrix?: any): any;
