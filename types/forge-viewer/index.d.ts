...
declare namespace Autodesk {
    namespace Viewing {
        ...
        class Viewer3D {
            ...
            ): { model: Model; point: THREE.Vector3 };
            createViewCube(): void;
            ...
            registerContextMenuCallback(
                id: string,
                callback: (menu: ContextMenuItem[], status: ContextMenuCallbackStatus) => void
            ): void;
            resize(): void;
            ...
            addEventListener(type: string, listener?: ViewerEvent, options?: boolean | AddEventListenerOptions): void;
            dispatchEvent(evt: Event): boolean;
            removeEventListener(type: string, listener?: ViewerEvent, options?: boolean | EventListenerOptions): void;
        }
