...
declare namespace Autodesk {
    namespace Viewing {
        ...
        class Model {
            ...
            getExternalIdMapping(
                onSuccessCallback: (idMapping: { [key: string]: number }) => void,
                onErrorCallback: () => void,
            ): any;
            getFastLoadList(): any;
            getFragmentMap(): any;
            ...
            getLayerToNodeIdMapping(
                onSuccessCallback: (mapping: { [key: string]: number[] }) => void,
                onErrorCallback: () => void,
            ): void;
            ...
            search(
                text: string,
                onSuccessCallback: (dbIds: number[]) => void,
                onErrorCallback: (err?: any) => void,
                attributeNames?: string[],
                options?: { searchHidden: boolean },
            ): void;
        ...
        class Viewer3D {
            ...
            loadModel(
                url: string,
                options: object,
                onSuccessCallback?: (model: Model) => void,
            ...
            getObjectTree(
                onSuccessCallback?: (objTree: InstanceTree) => void,
                onErrorCallback?: (
                    errorCode: number,
                    errorMessage: string,
                    statusCode: number,
            ...
            getAggregateSelection(
                callback?: (model: Model, dbId: number) => void,
            ): ReadonlyArray<{ model: Model; selection: number[] }>;
        ...
        class ModelBuilder {
            ...
            constructor(
                model: Model,
                options?: { conserveMemory?: boolean | undefined; createWireframe?: boolean | undefined },
            );
            addFragment(
                geometry: number | THREE.BufferGeometry,
                material: string | THREE.Material,
                transform?: THREE.Matrix4 | number[],
                bbox?: THREE.Box3 | number[],
            ): number;
            ...
            findGeometryFragments(
                geometry: number | number[] | THREE.BufferGeometry | THREE.BufferGeometry[],
            ): number[];
        ...
        namespace Private {
            ...
            function formatValueWithUnits(
                value: number,
                units: string,
                type: number,
                precision: number,
                options?: {
                    noMixedArea?: boolean | undefined;
                    noMixedVolume?: boolean | undefined;
                    preferLetters?: boolean | undefined;
                },
            ): string;
            ...
            namespace VertexEnumerator {
                function enumMeshEdges(
                    geometry: THREE.Geometry,
                    callback: (p: THREE.Vector3, q: THREE.Vector3, a: number, b: number) => void,
                ): void;
                function enumMeshIndices(
                    geometry: THREE.Geometry,
                    callback: (a: number, b: number, c: number) => void,
                ): void;
                function enumMeshLines(
                    geometry: THREE.Geometry,
                    callback: (start: THREE.Vector3, end: THREE.Vector3, a: number, b: number, idx: number) => void,
                ): void;
                function enumMeshTriangles(
                    geometry: THREE.Geometry,
                    callback: (
                        vA: THREE.Vector3,
                        vB: THREE.Vector3,
                ...
                function enumMeshVertices(geometry: THREE.Geometry, callback: any, matrix?: THREE.Matrix4): void;
            ...
            class Viewer3DImpl {
                ...
                createOverlayScene(
                    name: string,
                    materialPre?: THREE.Material,
                    materialPost?: THREE.Material,
                    camera?: any,
    ...
    namespace AEC {
        ...
        class LevelsExtension extends Viewing.Extension {
            ...
            constructor(
                viewer: Viewing.GuiViewer3D,
                options?: { autoDetectAecModelData?: boolean | undefined; ifcLevelsEnabled?: boolean | undefined },
            );
        ...
        namespace Core {
            ...
            class ModelStructureInfo {
                ...
                generateSurfaceShadingData(
                    devices: RoomDevice[],
                    levels?: LevelRoomsMap,
                    nodeName?: string,
                ): Promise<SurfaceShadingData>;
    ...
    namespace Edit2D {
        ...
        namespace Math2D {
            ...
            function getFitToBoxTransform(
                fromBox: THREE.Box2,
                toBox: THREE.Box2,
                options?: { flipY: boolean; preserveAspect: boolean },
        ...
        class PolyBase extends Shape {
            ...
            enumEdges(
                cb: (a: THREE.Vector2, b: THREE.Vector2, ai: number, bi: number) => boolean,
                loopIndex?: number,
            ): void;
    ...
    namespace Extensions {
        namespace CompGeom {
            ...
            function getCubeBezierPoint(
                ...
                px4: number,
                py4: number,
                optionalTarget?: THREE.Vector2,
            ): any;
            function getEllipseArcPoint(
                t: number,
                cx: number,
                cy: number,
                rx: number,
        ...
        namespace PixelCompare {
            class PixelCompare extends Viewing.Extension {
                ...
                compareTwoModels(
                    mainModel: Viewing.Model | number,
                    secondaryModel: Viewing.Model | number,
                    mainModelInfo?: any,
                    secondaryModelInfo?: any,
                ): void;
        ...
        class DataVisualization extends Viewing.Extension {
            ...
            setupSurfaceShading(
                model: Viewing.Model,
                shadingData: DataVisualization.Core.SurfaceShadingData,
                options?: {
                    type: "PlanarHeatmap";
