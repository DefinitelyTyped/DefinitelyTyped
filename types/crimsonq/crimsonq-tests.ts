...
(async () => {
    ...
    CQ.redisCommander; // $ExpectType { default: RedisStatic; Cluster: ClusterStatic; Command: typeof Command; };
    CQ.redisSubscriber; // $ExpectType { default: RedisStatic; Cluster: ClusterStatic; Command: typeof Command; };
