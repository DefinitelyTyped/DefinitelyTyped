...
export class OAuth {
    ...
    getOAuthAccessToken(oauth_token: string, oauth_token_secret: string, callback: oauth1tokenCallback): void;
    ...
    delete(url: string, oauth_token: string, oauth_token_secret: string, callback: dataCallback): ClientRequest;

    get(url: string, oauth_token: string, oauth_token_secret: string, callback: dataCallback): ClientRequest;
    ...
    signUrl(url: string, oauth_token: string, oauth_token_secret: string, method?: string): string;

    authHeader(url: string, oauth_token: string, oauth_token_secret: string, method?: string): string;
    ...
    protected _getSignature(method: string, url: string, parameters: string, tokenSecret: string): string;
    ...
    protected _makeArrayOfArgumentsHash(argumentHash: { [key: string]: string | string[] }): string[][];

    protected _sortRequestParams(argument_pairs: string[][]): string[][];

    protected _normaliseRequestParams(args: string[][]): string;

    protected _createSignatureBase(method: string, url: string, parameters: string): string;
...
export class OAuth2 {
    ...
    getOAuthAccessToken(code: string, params: any, callback: oauth2tokenCallback): void;
    getOAuthAccessToken(code: string, callback: oauth2tokenCallback): void;

    getProtectedResource(url: string, access_token: string, callback: dataCallback): void;
    ...
    protected _executeRequest(http_library: string, options: RequestOptions, callback: dataCallback): void;
}
