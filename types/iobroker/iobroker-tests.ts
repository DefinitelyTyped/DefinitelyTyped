...
adapter
    .setObjectAsync('obj.id', { type: 'state', common: { name: 'foo' }, native: {} })
    .then(({ id }) => id.toLowerCase());
adapter
    .setForeignObjectAsync('obj.id', { type: 'state', common: { name: 'foo' }, native: {} })
    .then(({ id }) => id.toLowerCase());
...
adapter
    .setObjectNotExistsAsync('obj.id', { type: 'state', common: { name: 'foo' }, native: {} })
    .then(({ id }) => id.toLowerCase());
adapter
    .setForeignObjectNotExistsAsync('obj.id', { type: 'state', common: { name: 'foo' }, native: {} })
    .then(({ id }) => id.toLowerCase());
