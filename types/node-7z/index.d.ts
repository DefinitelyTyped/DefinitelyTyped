// Type definitions for node-7z v2.1.1
...
declare module 'node-7z' {
    ...
    class ZipStream extends StreamNS.Stream implements NodeJS.ReadableStream {
        /**
     ...
     */
    function add(archive: string, source: string | string[], options?: SevenZipOptions): ZipStream;
    /**
     ...
     * @param options Seven Zip Options
     */
    function _delete(archive: string, target: string | string[], options?: SevenZipOptions): ZipStream;
    /**
     ...
     * @param options Seven Zip Options
     */
    function extract(archive: string, output: string, options?: SevenZipOptions): ZipStream;
    /**
     ...
     * @param options Seven Zip Options
     */
    function extractFull(archive: string, output: string, options?: SevenZipOptions): ZipStream;
    /**
     * Calculate hash values for files
     * @param target Target files to calculate the hash of
     * @param options Seven Zip Options
     */
    function hash(target: string | string[], options?: SevenZipOptions): ZipStream;
    /**
     * Lists contents of archive
     * @param archive Archive to list the contents from
     * @param options Seven Zip Options
     */
    function list(archive: string, options?: SevenZipOptions): ZipStream;
    /**
     ...
     * @param options Seven Zip Options
     */
    function rename(archive: string, target: Array<string[]>, options?: SevenZipOptions): ZipStream;
    /**
     * Tests archive files
     * @param archive Archive to test
     * @param options Seven Zip Options
     */
    function test(archive: string, options: SevenZipOptions): ZipStream;
    /**
     ...
     * @param options Seven Zip Options
     */
    function update(archive: string, files: string | string[], options?: SevenZipOptions): ZipStream;
    /**
     ...
     */
    function listen(stream: ZipStream): ZipStream;
