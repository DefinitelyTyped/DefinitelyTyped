...
function getSuggestLabel(suggest: google.maps.places.AutocompletePrediction) {
    return "label";
}
function renderSuggestItem(suggest: google.maps.places.AutocompletePrediction) {
