...
export type BrowserEvents = 'disconnected' | 'targetchanged' | 'targetcreated' | 'targetdestroyed';
...
export interface FrameBase {
     ...
     */
    $eval(selector: string, pageFunction: (element: Element, ...args: any[]) => any, ...args: any[]): Promise<any>;
