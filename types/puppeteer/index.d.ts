...
export type PDFFormat = 'Letter' | 'Legal' | 'Tabloid' | 'Ledger' | 'A0' | 'A1' | 'A2' | 'A3' | 'A4' | 'A5';
...
export interface Worker {
     ...
     */
    evaluateHandle<T>(pageFunction: (...args: any[]) => T | Promise<T>, ...args: SerializableOrJSHandle[]): Promise<T>;
...
export interface ExecutionContext {
    evaluate<F extends EvaluateFn>(fn: F, ...args: SerializableOrJSHandle[]): Promise<EvaluateFnReturnType<F>>;
    evaluateHandle(fn: EvaluateFn, ...args: SerializableOrJSHandle[]): Promise<JSHandle>;
