...
declare module BootstrapFileInput {
    ...
    interface PreviewConfig {
        ...
        */
        extra: {} | Function;
        /**
         * an identifier for storing the data-fileid attribute for each file thumbnail. If not set this will be autogenerated.
         */
        fileId: string | {};
        /**
         * one of the file template types as configured within the keys in previewSettings. This will override the initialPreviewFileType setting. This is useful to identify the template to be used to display the particular file's content.
         */
        type: string;
        /**
         * file mime type to identify the content. Useful for certain file templates like audio or video (e.g. video/mp4).
         */
        filetype: string;
        /**
         * float, the size of the file in BYTES which will be displayed using the size layout template. If not set or if it cannot be parsed as a float number, then a blank string will be displayed.
         */
        size: number;
        /**
         *  object, exif properties for the image (applicable for JPEG image files only) that will be used for auto orientation of images as configured within autoOrientImageInitial.
         */
        exif: {};
        /**
         * whether to parse this preview content as a data input instead of a raw markup source. This will override the initialPreviewAsData setting
         */
        previewAsData: boolean;
    }
