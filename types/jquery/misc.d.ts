...
```
     ...
     */
    // NOTE: JQuery's implementation of promises are *not* Promise/A+ compliant as they *do not* adopt the state of the value 
    //       they are resolved with if that value is promise-like. This means they are not (and should not be) assignable to 
    //       ES2015 native Promises or other Promise/A+ compatible types. However they should still be considered "Promise-like"
    //       and therefore assignable to `PromiseLike<T>`
    interface PromiseBase<TR, TJ, TN,
        UR, UJ, UN,
        VR, VJ, VN,
        SR, SJ, SN> extends PromiseLike<TR> {
          /**
