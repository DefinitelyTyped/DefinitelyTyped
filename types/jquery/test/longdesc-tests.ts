...
function longdesc() {
    ...
    function delegate_0(elements: HTMLElement[], selector: string, events: any, data: any, handler: jQuery.EventHandler) {
        // jQuery 1.4.3+
    ...
    function jquery_when_0() {
        $.when($.ajax('test.aspx')).then(function(data: any, textStatus: string, jqXHR: jQuery.jqXHR) {
    ...
    function jquery_when_3() {
        ...
        $.when(d1, d2).done(function(v1: any, v2: any) {
            console.log(v1); // "Fish"
    ...
    function jquery_when_4() {
        ...
        $.when(d1, d2, d3).done(function(v1: any, v2: any, v3: any) {
    ...
    function on_3() {
        function greet(event: jQuery.Event<{ name: string; }>) {
