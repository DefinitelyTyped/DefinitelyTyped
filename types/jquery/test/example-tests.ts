...
function examples() {
    ...
    function bind_0() {
        ...
        $('p').bind('dblclick', function(this: HTMLElement) {
            $('span').text('Double-click happened in ' + this.nodeName);
        });
        $('p').bind('mouseenter mouseleave', function(this: HTMLElement, event) {
            $(this).toggleClass('over');
        });
    }

    function bind_1() {
        $('p').bind('click', function(this: HTMLElement) {
            alert($(this).text());
        });
    }

    function bind_2() {
        function handler(event: jQuery.Event<any>) {
    ...
    function bind_6() {
        $('p').bind('myCustomEvent', function(this: HTMLElement, e, myName, myValue) {
    ...
    function css_6() {
        $('div').on('click', function() {
            $(this).css({
                width: function(index: number, value: string) {
                    return parseFloat(value) * 1.2;
                },
                height: function(index: number, value: string) {
                    return parseFloat(value) * 1.2;
                },
            });
        });
    ...
    function deferred_pipe_0() {
        var defer = $.Deferred(),
            filtered = defer.pipe(function(value: number) {
                return value * 2;
            });

        defer.resolve(5);
        filtered.done(function(value: number) {
    ...
    function deferred_pipe_1() {
        var defer = $.Deferred(),
            filtered = defer.pipe(null, function(value: number) {
                return value * 3;
            });

        defer.reject(6);
        filtered.fail(function(value: number) {
    ...
    function deferred_pipe_2(url: string, url2: string) {
        var request = $.ajax(url, { dataType: 'json' }),
            chained = request.pipe(function(data: any) {
                return $.ajax(url2, { data: { user: data.userId } });
            });

        chained.done(function(data: any) {
    ...
    function deferred_promise_1() {
        ...
        _obj.done(function(name: string) {
    ...
    function deferred_then_1() {
        var filterResolve = function() {
            var defer = $.Deferred(),
                filtered = defer.then(function(value: number) {
                    return value * 2;
                });
    ...
    function deferred_then_2() {
        var defer = $.Deferred(),
            filtered = defer.then(null, function(value: number) {
                return value * 3;
            });
    ...
    function jQuery_ajax_2(handleResponse: jQuery.PromiseCallback<any>) {
    ...
    function jQuery_get_json_1() {
        $.getJSON('test.js', function(json: any) {
    ...
    function jQuery_proxy_0() {
        ...
        // this === "zombie"; handler unbound after first click
            .on('click', $.proxy(me.test, me) as jQuery.EventHandler)

            // this === "person"
            .on('click', youClick as jQuery.EventHandler)

            // this === "zombie"
            .on('click', $.proxy(you.test, me) as jQuery.EventHandler)
    ...
    function jQuery_proxy_1() {
        ...
        $('#test').on('click', jQuery.proxy(obj, 'test') as jQuery.EventHandler);
    }
    ...
    function jQuery_proxy_2() {
        ...
        var proxy = $.proxy(me.test, me, you, they) as jQuery.EventHandler;
    ...
    function jQuery_when_0() {
        $.when($.ajax('/page1.php'), $.ajax('/page2.php')).done(function(a1: any, a2: any) {
    ...
    function jQuery_when_1(myFunc: jQuery.PromiseCallback<any>, myFailure: jQuery.PromiseCallback<any>) {
    ...
    function map_1() {
        var mappedItems = $('li').map(function(index) {
            var replacement: HTMLElement | null = $('<li>').text($(this).text()).get(0);
            if (index === 0) {
    ...
    function on_1() {
        function myHandler(event: jQuery.Event<{ foo: string; }>) {
            alert(event.data.foo);
        }
