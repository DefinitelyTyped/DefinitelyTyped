...
```
     */
    change(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'change'> | false): this;
    /**
...
```
     */
    click(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'click'> | false): this;
    /**
...
```
     */
    contextmenu(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'contextmenu'> | false): this;
    /**
...
```
     */
    dblclick(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'dblclick'> | false): this;
    /**
...
```
    ...
    delegate<TType extends string>(
        selector: JQuery.Selector,
        eventType: TType,
        handler: JQuery.TypeEventHandler<TElement, undefined, any, any, TType> | false
    ): this;
    /**
     * Attach a handler to one or more events for all elements that match the selector, now or in the future, based on a specific set of root elements.
     * @param selector A selector to filter the elements that trigger the event.
...
```
     */
    focusin(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'focusin'> | false): this;
    /**
...
```
     */
    focusout(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'focusout'> | false): this;
    /**
...
```
     */
    hover(
        handlerIn: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseenter'> | false,
        handlerOut: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseleave'> | false
    ): this;
    /**
...
```
     */
    hover(
        handlerInOut: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseenter' | 'mouseleave'> | false
    ): this;
    /**
...
```
     */
    keydown(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'keydown'> | false): this;
    /**
...
```
     */
    keypress(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'keypress'> | false): this;
    /**
...
```
     */
    keyup(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'keyup'> | false): this;
    /**
...
```
     */
    mousedown(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mousedown'> | false): this;
    /**
...
```
     */
    mouseenter(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseenter'> | false): this;
    /**
...
```
     */
    mouseleave(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseleave'> | false): this;
    /**
...
```
     */
    mousemove(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mousemove'> | false): this;
    /**
...
```
     */
    mouseout(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseout'> | false): this;
    /**
...
```
     */
    mouseover(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseover'> | false): this;
    /**
...
```
     */
    mouseup(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'mouseup'> | false): this;
    /**
...
```
    ...
    off<TType extends string>(
        events: TType,
        selector: JQuery.Selector,
        handler: JQuery.TypeEventHandler<TElement, any, any, any, TType> | false
    ): this;
    /**
     * Remove an event handler.
     * @param events One or more space-separated event types and optional namespaces, or just namespaces, such as
...
```
    ...
    off<TType extends string>(
        events: TType,
        selector_handler?: JQuery.Selector | JQuery.TypeEventHandler<TElement, any, any, any, TType> | false
    ): this;
    /**
     * Remove an event handler.
...
```
     */
    removeClass(
        className_function?: JQuery.TypeOrArray<string> | ((this: TElement, index: number, className: string) => string)
    ): this;
    /**
    ...
    replaceWith(
        newContent_function:
            ...
            | ((
              ...
              ) => JQuery.htmlString | JQuery<JQuery.Node> | JQuery.TypeOrArray<Element> | JQuery.Node)
    ): this;
    /**
...
```
     */
    select(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'select'> | false): this;
    /**
...
```
     */
    submit(handler?: JQuery.TypeEventHandler<TElement, null, TElement, TElement, 'submit'> | false): this;
    /**
...
```
    ...
    unbind<TType extends string>(
        event: TType,
        handler: JQuery.TypeEventHandler<TElement, any, TElement, TElement, TType> | false
    ): this;
    /**
     * Remove a previously-attached event handler from the elements.
     * @param event A string containing one or more DOM event types, such as "click" or "submit," or custom event names.
...
```
    ...
    undelegate(
        selector: JQuery.Selector,
        eventType_events: string | JQuery.TypeEventHandlers<TElement, any, any, any>
    ): this;
    /**
     * Remove a handler from the event for all elements which match the current selector, based upon a specific set of root elements.
