...
interface JQuery {
    ...
    MonthPicker(methodName: 'GetSelectedDate'): Date; // tslint:disable-line:unified-signatures
    MonthPicker(methodName: 'GetSelectedMonth'): number; // tslint:disable-line:unified-signatures
