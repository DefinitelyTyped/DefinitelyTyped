...
interface FullTextSource {
  ...
  declare namespace ydn.db {
    ...
    export class DbOperator {
      ...
      keys(store_name: string, index_name: string, key_range?: KeyRange, limit?: number, offset?: number, reverse?: boolean): Request;
      ...
      values(store_name: string, index_name: string, key_range?: KeyRange, limit?: number, offset?: number, reverse?: boolean): Request;
