...
declare module 'angular' {
    ...
    interface IHttpBackendService {
         ...
         * @param keys Array of keys to assign to regex matches in the request url.
         */
        expectJSONP(url: string | RegExp | ((url: string) => boolean), keys?: string[]): mock.IRequestHandler;
         ...
         * @param keys Array of keys to assign to regex matches in the request url.
         */
        whenJSONP(url: string | RegExp | ((url: string) => boolean), keys?: string[]): mock.IRequestHandler;
    ...
    namespace mock {
        ...
        interface IRequestHandler {
             ...
             * @param responseText Response text to add to the response.
             */
            respond(data: string | object, headers?: IHttpHeaders, responseText?: string): IRequestHandler;
