...
requestHandler = httpBackendService.expect('GET', 'http://test.local', function (data: string): boolean {
    return true;
});
...
requestHandler = httpBackendService.expect('GET', /test.local/, 'response data', function (headers: object): boolean {
    return true;
});
requestHandler = httpBackendService.expect(
    'GET',
...
requestHandler = httpBackendService.expect('GET', /test.local/, { key: 'value' }, function (headers: object): boolean {
    return true;
});
requestHandler = httpBackendService.expect(
    'GET',
...
requestHandler = httpBackendService.expectPATCH('http://test.local', function (data: string): boolean {
    return true;
});
...
requestHandler = httpBackendService.expectPOST('http://test.local', function (data: string): boolean {
    return true;
});
...
requestHandler = httpBackendService.when('GET', 'http://test.local', function (data: string): boolean {
    return true;
});
...
requestHandler = httpBackendService.when('GET', /test.local/, 'response data', function (headers: object): boolean {
    return true;
});
requestHandler = httpBackendService.when(
    'GET',
...
requestHandler = httpBackendService.when('GET', /test.local/, { key: 'value' }, function (headers: object): boolean {
    return true;
});
requestHandler = httpBackendService.when(
    'GET',
