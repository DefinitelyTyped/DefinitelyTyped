...
export class Integrity {
	...
	concat(integrity: string | IntegrityLike | HashLike, opts?: { strict?: boolean }): IntegrityMap;
...
export function parse(sri: string | IntegrityLike | HashLike, opts?: { single: true; strict?: boolean }): Hash;
export function parse(
	sri: string | IntegrityLike | HashLike,
	opts?: { single?: boolean; strict?: boolean },
): IntegrityMap | Hash;

export function stringify(obj: string | IntegrityLike | HashLike, opts?: { strict?: boolean; sep?: string }): string;
