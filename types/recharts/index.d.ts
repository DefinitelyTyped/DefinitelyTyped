...
export interface BarProps extends EventAttributes, Partial<PresentationAttributes>, Animatable {
    ...
    maxBarSize?: number;
    hide?: boolean;
    shape?: React.ReactElement<any,any> | ContentRenderer<RectangleProps>;
    data?: BarData[];
    background?: boolean | React.ReactElement<any,any> | ContentRenderer<any> | object;
...
export interface CartesianGridProps extends Partial<PresentationAttributes> {
    ...
    width?: number;
    height?: number;
    horizontal?: object | React.ReactElement<any,any> | ContentRenderer<LineProps & CartesianGridProps> | boolean;
    vertical?: object | React.ReactElement<any,any> | ContentRenderer<LineProps & CartesianGridProps> | boolean;
...
export interface LegendProps {
    content?: React.ReactElement<any,any> | ContentRenderer<LegendProps>;
    wrapperStyle?: object;
    chartWidth?: number;
    chartHeight?: number;
    width?: number;
...
export interface LineProps extends EventAttributes, Partial<PresentationAttributes>, Animatable {
    ...
    connectNulls?: boolean;
    hide?: boolean;
    activeDot?: object | React.ReactElement<any,any> | ContentRenderer<any> | boolean;
    dot?: object | React.ReactElement<any,any> | ContentRenderer<DotProps> | boolean;
    top?: number;
    left?: number;
    width?: number;
    height?: number;
    data?: object[];
    dataKey: DataKey; // As the source code states, dataKey will replace valueKey in 1.1.0 and it'll be required (it's already required in current implementation).
    label?: boolean | object | React.ReactElement<any,any> | ContentRenderer<any>;
    points?: Point[];
}
...
export interface PieProps extends EventAttributes, Partial<PresentationAttributes>, Animatable {
    ...
    sectors?: object[];
    hide?: boolean;
    labelLine?: object | ContentRenderer<LineProps & any> | React.ReactElement<any,any> | boolean;
    label?: {
        offsetRadius: number;
...
export interface PolarRadiusAxisProps extends EventAttributes, Partial<PresentationAttributes> {
    ...
    axisLine?: boolean | object;
    tick?: boolean | object | React.ReactElement<any,any> | ContentRenderer<any>;
    stroke?: string;
    tickFormatter?: TickFormatterFunction;
...
export interface RadarProps extends EventAttributes, Partial<PresentationAttributes>, Animatable {
    ...
    dataKey: DataKey; // As the source code states, dataKey will replace valueKey in 1.1.0 and it'll be required (it's already required in current implementation).
    points?: RadarPoint[];
    shape?: React.ReactElement<any,any> | ContentRenderer<RadarProps>;
    activeDot?: object | React.ReactElement<any,any> | ContentRenderer<any> | boolean;
    dot?: object | React.ReactElement<any,any> | ContentRenderer<DotProps> | boolean;
    label?: object | React.ReactElement<any,any> | ContentRenderer<any> | boolean;
    legendType?: LegendType;
    hide?: boolean;
}
...
export interface RadialBarProps extends EventAttributes, Partial<PresentationAttributes>, Animatable {
    ...
    data?: RadialBarData[];
    legendType?: LegendType;
    label?: boolean | React.ReactElement<any,any> | ContentRenderer<any> | object;
    background?: boolean | React.ReactElement<any,any> | ContentRenderer<any> | object;
    hide?: boolean;
}
...
export interface TooltipProps extends Animatable {
    content?: React.ReactElement<any,any> | React.StatelessComponent<any> | ContentRenderer<TooltipProps>;
    viewBox?: ViewBox;
    active?: boolean;
    separator?: string;
    formatter?: TooltipFormatter;
    ...
    labelStyle?: object;
    wrapperStyle?: object;
    cursor?: boolean | object | React.ReactElement<any,any> | React.StatelessComponent<any>;
...
export interface TreemapProps extends EventAttributes, Animatable {
    ...
    style?: object;
    aspectRatio?: number;
    content?: React.ReactElement<any,any> | ContentRenderer<any>;
    fill?: string;
    stroke?: string;
    className?: string;
...
export interface LabelListProps {
    ...
    className?: string;
    clockWise?: boolean;
    content?: React.ReactElement<any,any> | ContentRenderer<LabelProps>;
    data?: number;
