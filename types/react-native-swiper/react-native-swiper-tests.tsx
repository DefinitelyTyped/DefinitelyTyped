...
import { StyleSheet, Text, View, ViewStyle, NativeSyntheticEvent, NativeScrollEvent } from 'react-native';
...
class SwiperTest extends React.Component {
    ...
    callback = (event: NativeSyntheticEvent<NativeScrollEvent>, state: SwiperState, context: Swiper) => {
