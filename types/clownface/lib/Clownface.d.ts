...
declare class Clownface<D extends DatasetCore = DatasetCore, T extends Term = Term> implements ClownfaceContract<D, T> {
    constructor(
        options: ClownfaceInit & Partial<WithSingleTerm<T> | WithTerms<T>> & Partial<WithSingleValue | WithValues>,
    );
    ...
    node(
        value: SingleOrOneElementArray<string | number | boolean>,
        options?: NodeOptions,
    ...
    node(
        values: SingleOrArray<
            string | number | boolean | NamedNode | BlankNode | Literal | Variable | DefaultGraph | null
        >,
        options?: NodeOptions,
    ): SafeClownface<D>;
    ...
    literal(
        value: SingleOrOneElementArray<
            string | number | boolean | NamedNode | BlankNode | Literal | Variable | DefaultGraph | null
        >,
        languageOrDatatype?: string | NamedNode,
    ): SingleContextClownface<D, Literal>;
    literal(
        values: Array<string | number | boolean | NamedNode | BlankNode | Literal | Variable | DefaultGraph | null>,
        languageOrDatatype?: string | NamedNode,
