 ...
 * Web Auth
 */
export type AuthorizeParams<P extends { [key: string]: string | number | undefined }> = P & {
...
export class WebAuth {
    authorize<P extends { [key: string]: string | number | undefined; } = {}>(parameters: AuthorizeParams<P>, options?: AuthorizeOptions): Promise<Credentials>;
