// Type definitions for streamsaver 2.0.0
 ...
 */
export function createWriteStream<I = any, O = any>(
    filename: string, options?: CreateWriteStreamOptions<I, O>): WritableStream;
