// Type definitions for nearest-color 0.4
// Project: https://github.com/dtao/nearest-color
 ...
 * ```
 */
declare const nearestColor: NearestColor<ColorMatch | string>;
 ...
 * ```
 */
declare const from: NearestColorFrom;

interface NearestColorFrom {
    (availableColors: readonly string[]): NearestColor<string>;
    (availableColors: { [colorName: string]: string }): NearestColor<ColorMatch>;
}

/**
 * A map from the names of standard CSS colors to their hex values.
 */
declare const STANDARD_COLORS: { [colorName: string]: string };
 ...
 */
declare const DEFAULT_COLORS: readonly ColorSpec[];

declare const nearestColorNamespace: {
    nearestColor: typeof nearestColor;
    from: typeof from;
    STANDARD_COLORS: typeof STANDARD_COLORS;
    DEFAULT_COLORS: typeof DEFAULT_COLORS;
};

export = nearestColorNamespace;

export as namespace nearestColorNamespace;
