...
declare module 'esri/dijit/Search' {
    ...
    class Search {
        ...
        set(
            name: string,
            value: any | boolean | Layer | Graphic | InfoTemplate | number | TextSymbol | Map | any[] | string
        ): void;
...
declare module 'esri/layers/FeatureLayer' {
    ...
    class FeatureLayer extends GraphicsLayer {
        ...
        on(
            ...
            listener: (event: { adds: Graphic[]; deletes: Graphic[]; updates: Graphic[]; target: FeatureLayer }) => void
        ): esri.Handle;
...
declare module 'esri/layers/LabelLayer' {
    ...
    class LabelLayer extends GraphicsLayer {
        ...
        addFeatureLayer(
            featureLayer: FeatureLayer,
            renderer?: SimpleRenderer | UniqueValueRenderer | ClassBreaksRenderer,
            textExpression?: any
        ): void;
        /**
...
declare module 'esri/map' {
    ...
    class Map {
        ...
        on(
            type: 'zoom-end',
            listener: (event: { anchor: Point; extent: Extent; level: number; zoomFactor: number; target: Map }) => void
        ): esri.Handle;
...
declare module 'esri/opsdashboard/ExtensionBase' {
    ...
    class ExtensionBase {
        ...
        on(
            type: 'data-source-added',
            listener: (event: { dataSourceProxy: any; target: ExtensionBase }) => void
        ): esri.Handle;
        /** Event indicating that a data source has been removed from the host operation view. */
        on(
            type: 'data-source-removed',
            listener: (event: { dataSourceId: string; target: ExtensionBase }) => void
        ): esri.Handle;
        ...
        on(
            ...
            listener: (event: { error: Error; target: ExtensionBase }) => void
        ): esri.Handle;
        /** Event indicating that a new map widget has been added into the host operation view. */
        on(
            type: 'map-widget-added',
            listener: (event: { mapWidgetProxy: MapWidgetProxy; target: ExtensionBase }) => void
        ): esri.Handle;
        /** Event indicating that a map widget has been removed from the host operation view. */
        on(
            type: 'map-widget-removed',
            listener: (event: { mapWidgetId: string; target: ExtensionBase }) => void
        ): esri.Handle;
        on(type: string, listener: (event: any) => void): esri.Handle;
    }
...
declare module 'esri/opsdashboard/MapToolProxy' {
    ...
    class MapToolProxy {
        ...
        on(
            type: 'available-display-size-changed',
            listener: (event: { size: any; target: MapToolProxy }) => void
        ): esri.Handle;
...
declare module 'esri/opsdashboard/MapWidgetProxy' {
    ...
    class MapWidgetProxy {
        ...
        on(
            ...
            listener: (event: { extent: Extent; target: MapWidgetProxy }) => void
        ): esri.Handle;
        on(type: string, listener: (event: any) => void): esri.Handle;
    }
...
declare module 'esri/opsdashboard/WidgetConfigurationProxy' {
    ...
    class WidgetConfigurationProxy extends ExtensionConfigurationBase {
        ...
        on(
            type: 'data-source-selection-changed',
            listener: (event: {
        ...
        on(
            type: 'map-widget-selection-changed',
            listener: (event: { mapWidgetProxy: MapWidgetProxy; target: WidgetConfigurationProxy }) => void
        ): esri.Handle;
        on(type: string, listener: (event: any) => void): esri.Handle;
    }
...
declare module 'esri/opsdashboard/WidgetProxy' {
    ...
    class WidgetProxy extends ExtensionBase {
        ...
        on(
            type: 'data-source-expired',
            listener: (event: { dataSourceConfig: any; dataSourceProxy: DataSourceProxy; target: WidgetProxy }) => void
        ): esri.Handle;
        ...
        on(
            type: 'toolbar-draw-complete',
            listener: (event: { geometry: Geometry; target: WidgetProxy }) => void
        ): esri.Handle;
        on(type: string, listener: (event: any) => void): esri.Handle;
    }
    export = WidgetProxy;
...
declare module 'esri/renderers/UniqueValueRenderer' {
    ...
    class UniqueValueRenderer extends Renderer {
        ...
        constructor(
            defaultSymbol: Symbol,
            attributeField: string | Function,
            attributeField2?: string,
            attributeField3?: string,
