...
declare namespace webpack {
    ...
    namespace Options {
        ...
        interface DevServerOptions {
            ...
            /** his option lets you reduce the compilations in lazy mode. By default in lazy mode, every request results in a new compilation. With filename, it's possible to only compile when a certain file is requested. */
            filename?: string;
