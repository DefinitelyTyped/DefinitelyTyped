...
// declare module as `reveal.js` so that it matched with the packeage name
    ...
    namespace Reveal {
        ...
        interface Options {
            ...
            slideNumber?:
                ...
                | 'c'
                | 'c/t'
                | ((...args: any) => [string] | [string, string, string]);
...
declare module 'reveal.js/plugin/markdown/markdown' {
    ...
    const RevealMarkdown: Reveal.PluginFunction;
...
declare module 'reveal.js/plugin/highlight/highlight' {
    import Reveal = require('reveal.js');
    const RevealHighlight: Reveal.PluginFunction;
 ...
 */
declare module 'reveal.js/plugin/search/search' {
    import Reveal = require('reveal.js');
    const RevealSearch: Reveal.PluginFunction;
    export = RevealSearch;
}
...
declare module 'reveal.js/plugin/notes/notes' {
    import Reveal = require('reveal.js');
    const RevealNotes: Reveal.PluginFunction;
    export = RevealNotes;
}
 ...
 */
declare module 'reveal.js/plugin/math/math' {
    import Reveal = require('reveal.js');
    const RevealMath: Reveal.PluginFunction;
    export = RevealMath;
}
...
declare module 'reveal.js/plugin/zoom/zoom' {
    import Reveal = require('reveal.js');
    const RevealZoom: Reveal.PluginFunction;
    export = RevealZoom;
}
