...
async function TestScriptManager() {
    ...
    try {
        ...
        await scriptManager.callFunctionInRealm('realmId', 'functionDeclaration', 'awaitPromise', 'argumentValueList', 'thisParameter', 'resultOwnership');
        console.log('callFunctionInRealm method passed');

        // Test callFunctionInBrowsingContext method
        await scriptManager.callFunctionInBrowsingContext('browsingContextId', 'functionDeclaration', 'awaitPromise', 'argumentValueList', 'thisParameter', 'resultOwnership', 'sandbox');
        ...
        await scriptManager.evaluateFunctionInBrowsingContext('browsingContextId', 'expression', 'awaitPromise', 'resultOwnership', 'sandbox');
        ...
        scriptManager.getCallFunctionParams('targetType', 'id', 'sandbox', 'functionDeclaration', 'awaitPromise', 'argumentValueList', 'thisParameter', 'resultOwnership');
