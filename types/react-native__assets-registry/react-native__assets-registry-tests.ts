import { PackagerAsset, AssetDestPathResolver, registerAsset, getAssetByID } from "@react-native/assets-registry/registry";
import { getAndroidResourceFolderName, getAndroidResourceIdentifier, getBasePath } from "@react-native/assets-registry/path-support";
