...
export type PromiseCreator<TPayload = {}> = (payload: TPayload, dispatch: Dispatch) => PromiseLike<any>;

export function promisifyRoutine(routine: Routine): PromiseCreator;

export type BoundPromiseCreator<TPayload = {}> = (payload: TPayload) => PromiseLike<any>;
