        ...
        conversation_parts?: [
            {
                ...
                id: string,
                notified_at?: Date,
                readonly part_type: 'comment'| 'note' |
                 'note_and_reopen' | 'assignment' | 'open' |
                  'close' | 'away_mode_assignment' | 'participant_added' |
                   'participant_removed' | 'conversation_rating_changed' |
                    'conversation_rating_remark_added' | 'snoozed' | 'unsnoozed' |
                     'assign_and_unsnooze' | 'timer_unsnooze',
