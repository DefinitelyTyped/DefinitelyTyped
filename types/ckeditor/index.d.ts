// Type definitions for CKEditor 4.9.2
...
declare namespace CKEDITOR {
    ...
    namespace dom {
        ...
        class document extends domObject {
            ...
            createElement(name: string, attribsAndStyles?: { attributes: { [key: string]: any }; styles: { [key: string]: any }; }): element;
        ...
        class domObject extends event {
            ...
            fire(eventName: string, data?: any, editor?: editor): any;
    ...
    class style {
        ...
        removeFromRange(range: Range, editor: editor): void;
