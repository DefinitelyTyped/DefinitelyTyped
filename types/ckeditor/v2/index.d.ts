...
declare namespace CKEDITOR {
    ...
    namespace dom {
        ...
        class elementPath {
            ...
            contains(
                query: string | string[] | Object | element | ((element: element) => boolean),
                excludeRoot?: boolean,
                fromTop?: boolean,
            ): element;
    ...
    class menu {
        ...
        add(item: any): void;
        addListener(
            listenerFn: (startElement: dom.element, selection: dom.selection, path: dom.elementPath) => any,
        ): void;
    ...
    namespace htmlParser {
        ...
        class filter {
            ...
            addRules(
                ...
                options?: number | { priority?: number; applyToAll?: boolean },
            ): void;
        ...
        class fragment {
            ...
            forEach(callback: (node: node, type?: number) => void | boolean, type?: number, skipRoot?: boolean): void;
            writeHtml(writer: basicWriter, filter?: filter): void;
