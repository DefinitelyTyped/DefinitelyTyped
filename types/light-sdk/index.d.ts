...
interface INative {
     ...
     * 通过js接口控制是否隐藏状态栏
     * @param {object} params - 接口入参
     * @param {booleanean} params.hidden    -是否隐藏
     * @param {callback} cb 功能处理后的回调函数
     */
     ...
     * @param {object} params - 接口入参
     */
    getStatusBarHeight(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js登录用户
     * @param {object} params - 接口入参
     * @param {string} params.uid			-用户hsid
     * @param {string} params.mobile			-用户手机号码
     * @param {string} params.token			-用户令牌
     * @param {string} params.nickname			-用户昵称
     * @param {string} params.photoURL			-用户头像地址
     * @param {string} params.logoutWhenExit			-app退出后是否注销当前用户
     * @param {callback} cb 功能处理后的回调函数
     */
     ...
     * @param cb
     */
    userGetInfo(cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js设置登录用户信息
     * @param {object} params - 接口入参
     * @param {string} params.uid			-用户hsid
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    userSetInfo(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过JS退出用户登录
     * @param cb
     */
    userlogout(cb: (res: ICallbackResult) => void): void;
    /**
     * 用于向系统日历增加事件
     * @param {object} params - 接口入参
     * @param {string} params.startDate - 开始时间，格式：yyyy-MM-dd hh:mm:ss ，示例："2019-6-12 15:05:00"
     * @param {string} params.endDate - 结束时间，格式同开始时间，默认值为开始时间，不填或所填时间小于开始时间，则为默认值
     * @param {string} params.title - 标题
     * @param {string} params.location - 位置信息
     * @param {string} params.notes - 备注信息
     * @param {number} params.alarmOffset - 提前提醒时间，单位：分 ，默认值为0，即事件开始时间提醒.注意事项：类型必须为整数，入参小于0时为默认值
     * @param {callback} cb 功能处理后的回调函数
     */
    createCalendar(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 用于向系统日历更新相应事件信息
     * @param {object} params - 接口入参
     ...
     * @param {string} params.location - 位置信息
     * @param {string} params.notes - 备注信息
     * @param {string} params.alarmOffset - 提前提醒时间，单位：分 ，默认值为0，即事件开始时间提醒.注意事项：类型必须为整数，入参小于0时为默认值
     * @param {callback} cb 功能处理后的回调函数
     */
    updateCalendar(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 用于向系统日历删除事件
     * @param {object} params - 接口入参
     * @param {string} params.startDate - 开始时间，格式：yyyy-MM-dd hh:mm:ss ，示例："2019-6-12 15:05:00"
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    deleteCalendar(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 用于向系统日历查询事件
     * @param {object} params - 接口入参
     * @param {string} params.startDate - 开始时间，格式：yyyy-MM-dd hh:mm:ss ，示例："2019-6-12 15:05:00"
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    queryCalendar(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js接口在网页中查询存储在native的属性
     * @param {object} params - 接口入参
     * @param {string} params.key - native存储数据的key
     * @param {boolean} params.keepType - 传true：value可以支持string、object、array、boolean、number等类型的数据。默认false，即只支持string或object类型的数据
     * @param {array} params.multi_param - 一次性读取多个值如[{key:key1},{key:key2}]
     * @param {string} params.scope - native存储域
     * @param {callback} cb 功能处理后的回调函数
     */
    readData(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    writeData(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    deleteData(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js接口获取客户端系统剪贴板内容
     * @param {object} params - 接口入参
     * @param {callback} cb 功能处理后的回调函数
     */
    getClipBoardContent(params: null, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    getContactInfo(params: null, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js接口返回指定字符串内容的二维码图片的base64编码字符串
     *
     * @param {object} params - 接口入参
     * @param {string} params.desc - 需要被编码成二维码的内容
     * @param {number} params.size - 二维码尺寸,默认为300x300，
     * @param {callback} cb 功能处理后的回调函数
     */
    genCode(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js接口打开本地二维码扫描页面，扫码成功后在网页中返回扫码结果信息
     *
     * @param {object} params - 接口入参
     * @param {float} params.sideLength - 扫描区域边长相对于屏幕较短边长的百分比，取值范围(0,1]
     * @param {float} params.offsetX - 扫描区域相对于屏幕左侧的偏移百分比，取值范围[0,1]
     * @param {float} params.offsetY - 扫描区域相对于屏幕顶部的偏移百分比，取值范围[0,1]
     * @param {string} params.type - 扫一扫识别类型。参数值有2种可选，qrcode：二维码， barcode：条形码，不传或参数错误时默认为二维码效果
     * @param {callback} cb 功能处理后的回调函数
     */
    scanCode(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js调用获取经纬度
     * @param {object} params - 接口入参
     * @param {number} params.scanSpan - 定位刷新间隔（单位毫秒）
     * @param {callback} cb 功能处理后的回调函数
     */
    getLocation(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js调用关闭定位服务
     * @deprecated
     * @param {object} params - 接口入参
     * @param cb
     */
    stopLocation(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 获取当前是否可获取定位状态
     * @param {object} params - 接口入参
     * @param {callback} cb 功能处理后的回调函数
     */
    getLocationStatus(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param cb
     */
    pushGetRegistrationID(params: null, cb: (res: ICallbackResult) => void): void;
    /**
     * 当前用户添加标签
     * @deprecated
     * @param {object} params - 接口入参
     ...
     * @param cb
     */
    pushAddTags(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 当前用户删除标签
     * @deprecated
     * @param {object} params - 接口入参
     ...
     * @param cb
     */
    pushDeleteTags(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 获取当前用户的所有标签
     * @deprecated
     * @param params
     * @param cb
     */
    pushGetTags(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过JS向客户端传递推送alias，用于推送服务器定点推送
     * @param {object} params - 接口入参
     * @param {string} params.alias    -推送alias，为空字符串时为清除已有alias
     * @param {callback} cb 功能处理后的回调函数
     */
    pushSetAlias(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 通过JS获取推送消息
     * @param {object} params - 接口入参
     * @param {callback} cb 功能处理后的回调函数
     */
    pushAddEventListener(params: null, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     */
    imagePicker(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js接口在网页中返回指定文件ID对应的base64编码字符串
     * @param {object} params - 接口入参
     * @param {string} params.path - 文件ID,协议为LightResource://xxx.类型
     */
    getBase64(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {boolean} params.cropPhoto - 是否剪裁
     * @param {string} params.maxWidth - 最大宽度
     * @param {string} params.aspectXY - 宽高比
     * @param {string} params.maxCount - 宽高比
     * @param {boolean} params.allowTakePicture - 多选图片(即type为CAMERA_MUTIL-ALBUM或MUTIL-ALBUM)情况下可选的最大照片数，默认为9。
     * @param {boolean} params.reverselyOrdered - 多选图片(即type为CAMERA_MUTIL-ALBUM或MUTIL-ALBUM)情况下相册选择器是否倒序显示，默认正序显示，仅支持iOS
     * @param {callback} cb 功能处理后的回调函数
     */
    chooseImage(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    saveImage(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 图片预览功能，支持预览多张图片。
     * @param {object} params - 接口入参
     * @param {array} params.images -图片地址
     * @param {number} params.selectedIndex -预览时的图片数组下标(从0开始)，表示展示当前选中的图片。默认情况为0
     * @param {callback} cb 功能处理后的回调函数
     */
    imagePreview(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 通过js接口录制音频
     * @param {object} params - 接口入参
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    startRecord(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 通过js接口结束录制音频
     * @param cb
     */
    stopRecord(cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    filePreview(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {boolean} params.overwrite -是否覆盖（默认不覆盖）
     * @param {callback} cb 功能处理后的回调函数
     */
    fileSave(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js获取是否含有手势或指纹验证信息
     * @param {object} params - 接口入参
     * @param {string} params.verifyType    -验证方式（FP:指纹 GL:手势）
     * @param {callback} cb 功能处理后的回调函数
     */
    preVerifyOpeation(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js调用手势或指纹验证
     * @param {object} params - 接口入参
     * @param {string} params.verifyType    -验证方式（FP:指纹 GL:手势）
     * @param {string} params.GLOpeationType    -只有verifyType为GL才可用，字段说明(verify:手势验证 set:手势设置 update:手势更新 close:清除手势)
     * @param {string} params.otherTitle    -其他方式点击按钮title
     * @param {string} params.additionalTitle    -附加方式点击按钮title
     * @param {callback} cb 功能处理后的回调函数
     */
    verifyOpeation(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js展现安全键盘
     * @deprecated
     * @param {object} params - 接口入参
     * @param {string} params.textshow -Plain:明文显示，不加密（当textShow设置为Plain时，encryptMode无论设置成什么都不加密）。DelayAsterisk:字符0.5秒后变为星号。InstantAsterisk:字符输入后直接变为星号。默认为InstantAsterisk配置（大小写不明感，后面类型为string的配置项一样）
     ...
     * @param {string} params.disorder -none:不乱序。number:只有数字乱序。numberAndAlpha:数字字母都乱序。若无配置或配置字符串不符合这三个，则默认为none。
     * @param {string} params.pressEffect -default:按钮点击后有点击效果，none:没有点击效果。默认为default。
     ...
     * @param {number} params.maxLength -设置最大输入长度，默认为16
     ...
     * @param cb
     */
    safekeyboardShow(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js关闭安全键盘
     * @deprecated
     * @param {object} params - 接口入参
     * @param cb
     */
    safekeyboardHide(params: null, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js展现交易键盘
     * @deprecated
     * @param {object} params - 接口入参
     ...
     * @param {array} params.funcKey -键盘工具栏按钮 注意:本字段只有search类型才支持，volume和price类型不支持
     * @param {string} params.describe -键盘工具类描述
     * @param cb
     */
    tradekeyboardShow(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * t通过js关闭交易键盘
     * @deprecated
     * @param {object} params - 接口入参
     ...
     * @param cb
     */
    tradekeyboardHide(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 通过js分享内容到各平台
     * @param {object} params - 接口入参
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    socialShare(params: any, cb: (res: ICallbackResultNoData) => void): void;
    /**
     * 三方登录接口
     * @param {object} params - 接口入参
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    socialLogin(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    socialAppInstalled(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 苹果内购接口
     * @param {object} params - 接口入参
     ...
     * @param {callback} cb 功能处理后的回调函数
     */
    iapPurchase(params: any, cb: (res: ICallbackResult) => void): void;
    /**
     * 通过js传入经服务器加签后的订单信息(orderInfo)并调用相应支付渠道SDK的支付接口
     * @param {object} params - 接口入参
     * @param {string} params.channel_id -021:支付宝钱包022:微信钱包
     * @param {object} params.orderInfo			- 具体内容见下方的”其他(当支付渠道为微信钱包时/当支付渠道为微信钱包时)”项
     * @param {boolean} params.isSandBox			-是否进入沙箱环境（只对支付宝有效）
     * @param {callback} cb 功能处理后的回调函数
     */
    tradePay(params: any, cb: (res: ICallbackResult) => void): void;
}
