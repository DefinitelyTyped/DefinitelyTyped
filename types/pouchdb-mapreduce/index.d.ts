...
declare namespace PouchDB {
    ...
    interface Database<Content extends {} = {}> {
         ...
         */
        query<Result extends {}, Model extends {} = Content>(fun: string | Map<Model, Result> | Filter<Model, Result>, opts: Query.Options<Model, Result>, callback: Core.Callback<Query.Response<Result>>): void;
        /**
         * Invoke a map/reduce function, which allows you to perform more complex queries
         * on PouchDB than what you get with allDocs().
         */
