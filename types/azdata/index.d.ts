...
declare module 'azdata' {
    ...
    export namespace queryeditor {
        export type QueryEventType = 'queryStart' | 'queryUpdate' | 'queryStop' | 'executionPlan' | 'visualize';
    ...
    export namespace nb {
        ...
        export type OutputTypeName = 'execute_result' | 'display_data' | 'stream' | 'error' | 'update_display_data';
