...
test('array', () => {
    ...
    expect(tester).toHaveBeenCalledWith(testCases[0], expect.any(Function));
    expect(tester).toHaveBeenCalledWith(testCases[1], expect.any(Function));
    expect(tester).toHaveBeenCalledWith(testCases[2], expect.any(Function));
});
