// Type definitions for Google AdSense Management API v1.4
...
declare namespace gapi.client.adsense {
...
declare namespace gapi.client {
    ...
    export function load (name: "adsense", version: "v1.4") : PromiseLike<void>;    
    export function load (name: "adsense", version: "v1.4", callback: () => any) : void;    
    
    const accounts: gapi.client.adsense.AccountsResource; 
    
    const adclients: gapi.client.adsense.AdclientsResource; 
    
    const adunits: gapi.client.adsense.AdunitsResource; 
    
    const alerts: gapi.client.adsense.AlertsResource; 
    
    const customchannels: gapi.client.adsense.CustomchannelsResource; 
    
    const metadata: gapi.client.adsense.MetadataResource; 
    
    const payments: gapi.client.adsense.PaymentsResource; 
    
    const reports: gapi.client.adsense.ReportsResource; 
    
    const savedadstyles: gapi.client.adsense.SavedadstylesResource; 
    
    const urlchannels: gapi.client.adsense.UrlchannelsResource; 
