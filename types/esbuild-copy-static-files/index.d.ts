...
declare namespace EsbuildCopyStaticFiles {
    interface CopyStaticFilesOptions {
         ...
         * @default true
         */
        dereference?: fs.CopyOptions["dereference"];
         ...
         * @default true
         */
        preserveTimestamps?: fs.CopyOptions["preserveTimestamps"];
         ...
         * @default true
         */
        recursive?: fs.CopyOptions["recursive"];
    }
