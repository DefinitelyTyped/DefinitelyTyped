 ...
 */
declare interface TVInputDeviceManager {
    /**
     ...
     * @since 2.3
     */
    getKey(keyName: Tizen.InputDeviceKeyName): InputDeviceKey | null;
     ...
     * @since 2.3
     */
    registerKey(keyName: Tizen.InputDeviceKeyName): void;
     ...
     * @since 2.3
     */
    unregisterKey(keyName: Tizen.InputDeviceKeyName): void;
