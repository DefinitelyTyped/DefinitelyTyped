...
declare const enum CaptionInfoKey {
 ...
 * @since 2.4
 */
declare const enum CaptionMode {
 ...
 * @since 2.4
 */
declare const enum CaptionFontSize {
 ...
 * @since 2.4
 */
declare const enum CaptionFontStyle {
 ...
 * @since 2.4
 */
declare const enum CaptionColor {
 ...
 * @since 2.4
 */
declare const enum CaptionOpacity {
 ...
 * @since 2.4
 */
declare const enum CaptionEdge {
...
interface CaptionValueChangeCallback {
    (key: CaptionInfoKey, value: Tizen.CaptionValue): void;
}
...
declare interface TVInfoManager {
     ...
     * @since 2.4
     */
    getCaptionValue(key: CaptionInfoKeyUnion): Tizen.CaptionValue;
