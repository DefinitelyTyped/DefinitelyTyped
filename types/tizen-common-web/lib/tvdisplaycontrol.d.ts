 ...
 */
declare interface TVDisplayControlManager {
    /**
     ...
     */
    get3DEffectMode(): Display3DEffectModeUnion;
     ...
     * @warning 5.0 http://tizen.org/privilege/tv.display (public level) has been deprecated since 5.0.
     */
    is3DModeEnabled(): Display3DModeStateUnion;
 ...
 */
declare const enum Display3DEffectMode {
    OFF = 'OFF',
