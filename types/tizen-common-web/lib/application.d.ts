...
declare interface ApplicationManager {
     ...
     *
     */
    getAppInfo: (id?: Tizen.ApplicationId) => ApplicationInformation;
     ...
     *
     */
    getAppCerts: (id?: Tizen.ApplicationId) => ApplicationCertificate[];
     ...
     *
     */
    getAppSharedURI: (id?: Tizen.ApplicationId) => string;
     ...
     *
     */
    getAppMetaData: (id?: Tizen.ApplicationId) => ApplicationMetaData[];
...
interface Application {
     ...
     */
    readonly contextId: Tizen.ApplicationContextId;
     ...
     *
     */
    broadcastEvent: (event: Tizen.EventInfo, data: Tizen.UserEventData) => void;
...
interface ApplicationInformation {
     ...
     */
    readonly id: Tizen.ApplicationId;
    /**
     ...
     * @since 2.1
     */
    readonly packageId: Tizen.PackageId;
}
...
interface ApplicationContext {
     ...
     * An attribute to store the ID of a running application.
     */
    readonly id: Tizen.ApplicationContextId;
    /**
     * An attribute to store the ID of an installed application.
     */
    readonly appId: Tizen.ApplicationId;
}
...
declare interface ApplicationControlDataConstructor {
 ...
 *
 */
declare class ApplicationControlData {
...
declare interface ApplicationControlConstructor {
    new (
        operation: string,
        uri?: string,
        mime?: string,
...
interface RequestedApplicationControl {
     ...
     * @since 2.1
     */
    readonly callerAppId: Tizen.ApplicationId;
    /**
...
interface EventCallback {
     ...
     * @since 2.3
     */
    (event: Tizen.EventInfo, data: Tizen.EventData): void;
}
...
interface StatusEventCallback {
     ...
     */
    (appId: Tizen.ApplicationId, isActive: boolean): void;
}
...
interface ApplicationInformationEventCallback {
     ...
     */
    onuninstalled?(id: Tizen.PackageId): void;
}
