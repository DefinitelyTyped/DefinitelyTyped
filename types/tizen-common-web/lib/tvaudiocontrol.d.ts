 ...
 *
 */
declare const enum AudioOutputMode {
    PCM = 'PCM',
    DOLBY = 'DOLBY',
    DTS = 'DTS',
    AAC = 'AAC',
 ...
 *
 */
declare const enum AudioBeepType {
    UP = 'UP',
    DOWN = 'DOWN',
    LEFT = 'LEFT',
    RIGHT = 'RIGHT',
 ...
 */
declare interface TVAudioControlManager {
    /**
     ...
     *
     */
    getOutputMode: () => AudioOutputModeUnion;
     ...
     *
     */
    playSound: (type: AudioBeepTypeUnion) => void;
}
