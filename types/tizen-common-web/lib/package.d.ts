...
declare interface PackageManager {
     ...
     */
    getPackageInfo(id?: Tizen.PackageId): PackageInformation;
    /**
...
interface PackageInformation {
     ...
     */
    readonly appIds: Tizen.ApplicationId[];
}
/**
...
interface PackageProgressCallback {
     ...
     */
    onprogress(id: Tizen.PackageId, progress: number): void;
    /**
     ...
     * @param id The package ID.
     */
    oncomplete(id: Tizen.PackageId): void;
}
/**
