...
declare interface FilesystemManager {
     ...
     */
    isFile: (path: Tizen.Path) => boolean;
     ...
     * @throw WebAPIException InvalidValuesError, IOError, NotFoundError, SecurityError
     */
    isDirectory: (path: Tizen.Path) => boolean;
     ...
     */
    pathExists: (path: Tizen.Path) => boolean;
     ...
     * @returns Path to directory for given path.
     */
    getDirName: (path: Tizen.Path) => string;
...
interface ListDirectorySuccessCallback {
     ...
     */
    (names: string[], path: Tizen.Path): void;
}
/**
