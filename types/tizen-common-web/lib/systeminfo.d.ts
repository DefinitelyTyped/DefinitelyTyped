 ...
 */
declare interface SystemInfoManager {
    /**
     ...
     *
     */
    getCount(property: SystemInfoPropertyIdUnion): number;
...
interface SystemInfoDeviceCapability {
     ...
     * @since 2.2
     */
    readonly profile: SystemInfoProfileUnion;
}
/**
 ...
 */
declare const enum SystemInfoPropertyId {
    BATTERY = 'BATTERY',
    CPU = 'CPU',
    STORAGE = 'STORAGE',
    DISPLAY = 'DISPLAY',
 ...
 */
declare const enum SystemInfoNetworkType {
    NONE = 'NONE',
    '2G' = '2G',
    '2.5G' = '2.5G',
    '3G' = '3G',
 ...
 * @since 2.4
 */
declare const enum SystemInfoWifiSecurityMode {
    NONE = 'NONE',
    WEP = 'WEP',
    WPA_PSK = 'WPA_PSK',
    WPA2_PSK = 'WPA2_PSK',
 ...
 * @since 2.4
 */
declare const enum SystemInfoWifiEncryptionType {
    NONE = 'NONE',
    WEP = 'WEP',
    TKIP = 'TKIP',
    AES = 'AES',
 ...
 * @since 2.4
 */
declare const enum SystemInfoNetworkIpMode {
    NONE = 'NONE',
    STATIC = 'STATIC',
    DYNAMIC = 'DYNAMIC',
    AUTO = 'AUTO',
 ...
 */
declare const enum SystemInfoDeviceOrientationStatus {
 ...
 */
declare const enum SystemInfoVideoSourceType {
    TV = 'TV',
    AV = 'AV',
    SVIDEO = 'SVIDEO',
    COMP = 'COMP',
...
interface SystemInfoVideoSourceInfo {
     ...
     */
    readonly type: SystemInfoVideoSourceTypeUnion;
    /**
 ...
 * @since 2.3
 */
interface SystemInfoVideoSource extends SystemInfoProperty {
    /**
...
type SystemInfoPropertyType = SystemInfoBattery &
    SystemInfoCpu &
    SystemInfoStorage &
 ...
 */
interface SystemInfoBattery extends SystemInfoProperty {
    /**
 ...
 */
interface SystemInfoCpu extends SystemInfoProperty {
    /**
 ...
 */
interface SystemInfoStorage extends SystemInfoProperty {
    /**
 ...
 */
interface SystemInfoStorageUnit extends SystemInfoProperty {
    /**
 ...
 */
interface SystemInfoDisplay extends SystemInfoProperty {
    /**
 ...
 * @since 5.5
 */
interface SystemInfoPanel extends SystemInfoProperty {
    /**
 ...
 * @since 2.0
 */
interface SystemInfoDeviceOrientation extends SystemInfoProperty {
    /**
     * Represents the status of the current device orientation.
     */
    readonly status: SystemInfoDeviceOrientationStatusUnion;
    /**
 ...
 * @since 2.0
 */
interface SystemInfoBuild extends SystemInfoProperty {
    /**
 ...
 * @since 2.1
 */
interface SystemInfoLocale extends SystemInfoProperty {
    /**
 ...
 * @since 2.0
 */
interface SystemInfoNetwork extends SystemInfoProperty {
    /**
     * Represents the network type of the current data network.
     */
    readonly networkType: SystemInfoNetworkTypeUnion;
}
/**
 ...
 */
interface SystemInfoWifiNetwork extends SystemInfoProperty {
    /**
     ...
     * @since 2.4
     */
    readonly securityMode: SystemInfoWifiSecurityModeUnion;
    /**
     * Represents this connection's encryption type.
     *
     * @since 2.4
     */
    readonly encryptionType: SystemInfoWifiEncryptionTypeUnion;
    /**
     * Represents this connection's IP configuration type.
     *
     * @since 2.4
     */
    readonly ipMode: SystemInfoNetworkIpModeUnion;
    /**
 ...
 * @since 2.4
 */
interface SystemInfoEthernetNetwork extends SystemInfoProperty {
    /**
 ...
 * by listener would be outdated.
 */
interface SystemInfoCellularNetwork extends SystemInfoProperty {
    /**
 ...
 * @since 3.0
 */
interface SystemInfoNetProxyNetwork extends SystemInfoProperty {
    /**
 ...
 * @since 2.1
 */
interface SystemInfoPeripheral extends SystemInfoProperty {
    /**
 ...
 * @since 2.3
 */
interface SystemInfoMemory extends SystemInfoProperty {
    /**
     * Represents the low memory state.
     */
    readonly status: SystemInfoLowMemoryStatusUnion;
}
