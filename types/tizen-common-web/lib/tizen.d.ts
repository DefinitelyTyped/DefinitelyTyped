 ...
 *
 */
declare const enum FilterMatchFlag {
    EXACTLY = 'EXACTLY',
...
declare const enum BundleValueType {
    STRING = 'STRING',
...
declare class Bundle {
     ...
     *
     */
    typeOf: (key: string) => BundleValueTypeUnion;
    /**
 ...
 */
declare class AttributeRangeFilter extends AbstractFilter {
 ...
 */
declare class CompositeFilter extends AbstractFilter {
    constructor(type: CompositeFilterTypeUnion, filters?: AbstractFilter[]);
    /**
...
interface SortModeConstructor {
    new (attributeName: string, order?: SortModeOrderUnion): SortMode;
}
/**
 ...
 */
declare class SortMode {
    constructor(attributeName: string, order?: SortModeOrderUnion);
    /**
     ...
     */
    order: SortModeOrderUnion;
}

interface SimpleCoordinatesConstructor {
 ...
 */
declare class SimpleCoordinates {
