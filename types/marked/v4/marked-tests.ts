...
(async () => {
    ...
    // $ExpectType void
    marked(md, (_: any, res: string) => {
        res;
    });
    // $ExpectType void
    marked(md, { async: true }, (_: any, res: string) => {
        res;
    });
    // $ExpectType void
    marked(md, { async: false }, (_: any, res: string) => {
        res;
    });
    ...
    // $ExpectType void
    marked.parse(md, (_: any, res: string) => {
        res;
    });
    // $ExpectType void
    marked(md, { async: true }, (_: any, res: string) => {
...
import { Lexer, Parser, Renderer, Slugger, TextRenderer, Tokenizer } from "marked";
