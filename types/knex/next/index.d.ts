...
declare namespace Knex {
    ...
    interface WhereIn {
        (
            columnName: string,
            values: Value[] | QueryBuilder | QueryCallback
        ): QueryBuilder;
        (
            columnNames: string[],
            values: Value[][] | QueryBuilder | QueryCallback
    ...
    interface MigratorConfig {
        ...
        // FS migration source related
        directory?: string
        extension?: string
        sortDirsSeparately?: boolean

        /** Ignored when directory, extension or sortDirsSeparately is specified */
