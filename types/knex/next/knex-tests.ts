...
// Migrations
//
var config: Knex.MigratorConfig = {
...
class CustomMigrationSource implements Knex.MigrationSource {
    getMigrations() {
    ...
    getMigration(_migration: string): { up: Function; down: Function; } {
        return { up: (_knex: any) => {}, down: (_knex: any) => {} };
    }
}

var anotherConfig: Knex.MigratorConfig = {
    migrationSource: new CustomMigrationSource()
};
knex.migrate.status(anotherConfig);
