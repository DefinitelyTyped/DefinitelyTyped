...
async function testProjectOperations() {
    ...
    const projectLogsWithOptions: Client.ApiResponse = await client.getProjectLogs('test-project', projectLogsQuery, requestOptions);

    // createProject
    const createdProject: Client.ApiResponse = await client.createProject('test-project', projectData);
    const createdProjectWithOptions: Client.ApiResponse = await client.createProject('test-project', projectData, requestOptions);
...
async function testLogStoreOperations() {
    ...
    const logStoresWithOptions: Client.ApiResponse = await client.listLogStore('test-project', listLogStoreQuery, requestOptions);

    // createLogStore
    const createdLogStore: Client.ApiResponse = await client.createLogStore('test-project', 'test-logstore');
    const createdLogStoreWithData: Client.ApiResponse = await client.createLogStore('test-project', 'test-logstore', logStoreData);
    const createdLogStoreWithOptions: Client.ApiResponse = await client.createLogStore('test-project', 'test-logstore', logStoreData, requestOptions);

    // deleteLogStore
    const deletedLogStore: Client.ApiResponse = await client.deleteLogStore('test-project', 'test-logstore');
    const deletedLogStoreWithOptions: Client.ApiResponse = await client.deleteLogStore('test-project', 'test-logstore', requestOptions);

    // updateLogStore
    const updatedLogStore: Client.ApiResponse = await client.updateLogStore('test-project', 'test-logstore');
    const updatedLogStoreWithData: Client.ApiResponse = await client.updateLogStore('test-project', 'test-logstore', logStoreData);
    const updatedLogStoreWithOptions: Client.ApiResponse = await client.updateLogStore('test-project', 'test-logstore', logStoreData, requestOptions);

    // getLogStore
    const logStore: Client.ApiResponse = await client.getLogStore('test-project', 'test-logstore');
    const logStoreWithOptions: Client.ApiResponse = await client.getLogStore('test-project', 'test-logstore', requestOptions);
}
...
async function testIndexOperations() {
    ...
    const indexConfigWithOptions: Client.ApiResponse = await client.getIndexConfig('test-project', 'test-logstore', requestOptions);

    // createIndex
    const createdIndex: Client.ApiResponse = await client.createIndex('test-project', 'test-logstore', indexConfig);
    const createdIndexWithOptions: Client.ApiResponse = await client.createIndex('test-project', 'test-logstore', indexConfig, requestOptions);

    // updateIndex
    const updatedIndex: Client.ApiResponse = await client.updateIndex('test-project', 'test-logstore', indexConfig);
    const updatedIndexWithOptions: Client.ApiResponse = await client.updateIndex('test-project', 'test-logstore', indexConfig, requestOptions);

    // deleteIndex
    const deletedIndex: Client.ApiResponse = await client.deleteIndex('test-project', 'test-logstore');
    const deletedIndexWithOptions: Client.ApiResponse = await client.deleteIndex('test-project', 'test-logstore', requestOptions);
}
...
async function testLogOperations() {
    ...
    const logsWithQuery: Client.ApiResponse = await client.getLogs('test-project', 'test-logstore', fromDate, toDate, getLogsQuery);
    const logsWithOptions: Client.ApiResponse = await client.getLogs('test-project', 'test-logstore', fromDate, toDate, getLogsQuery, requestOptions);

    // getHistograms
    const histograms: Client.ApiResponse = await client.getHistograms('test-project', 'test-logstore', fromDate, toDate);
    const histogramsWithQuery: Client.ApiResponse = await client.getHistograms('test-project', 'test-logstore', fromDate, toDate, getHistogramsQuery);
    const histogramsWithOptions: Client.ApiResponse = await client.getHistograms('test-project', 'test-logstore', fromDate, toDate, getHistogramsQuery, requestOptions);

    // postLogStoreLogs
    const postedLogs: Client.ApiResponse = await client.postLogStoreLogs('test-project', 'test-logstore', postLogStoreLogsData);
    const postedLogsWithOptions: Client.ApiResponse = await client.postLogStoreLogs('test-project', 'test-logstore', postLogStoreLogsData, requestOptions);
}
