...
import { InnerRef, MenuPlacement, MenuPosition, CommonProps } from '../types';
...
export type MenuListComponentProps<OptionType> = CommonProps<OptionType> & MenuListProps & MenuListState;
