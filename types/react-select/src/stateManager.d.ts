...
> extends Component<
    StateProps<SelectProps<OptionType>> & Props<OptionType> & SelectProps<OptionType>,
    State<OptionType>
> {
...
export function manageState<T extends SelectBase<any>>(SelectComponent: T): StateManager<GetOptionType<T>, T>;
