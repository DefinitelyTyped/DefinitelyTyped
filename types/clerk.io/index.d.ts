 ...
 */
export function Clerk<T extends ClerkEndpoints>(method: 'call', endpoint: T, config: ConfigTypes[T], callback?: (response: ResponseTypes[T]) => void, error?: (error: ClerkErrorResponse) => void): void;
/**
 ...
 */
export function Clerk(method: 'chat', action: 'on', event: 'message' | 'open' | 'enable' | 'support', callback: () => void): void;
/**
...
export function Clerk(method: 'on', event: 'live_search_update' | 'rendered' | 'render' | 'response' | 'update' | 'model', callback: (content: ClerkContent, data?: any) => void): void;
export function Clerk(method: 'on', event: 'live_search_update' | 'rendered' | 'render' | 'response' | 'update' | 'model', css_selector: string, callback: (content: ClerkContent, data: any) => void): void;
/**
 ...
 * @see https://docs.clerk.io/docs/clerkjs-content
 */
export function Clerk(method: 'content', selector: string, config?: unknown, content?: (content: ClerkContent) => void): void;
/**
 ...
 */
export function Clerk(method: 'cart', action: 'add' | 'set' | 'remove', id: string | number | string[] | number[]): void;
/**
