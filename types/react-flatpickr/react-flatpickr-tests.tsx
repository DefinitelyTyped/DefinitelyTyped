...
const hook = (selectedDates: Date[], dateStr: string, instance: flatpickr.Instance, elem: HTMLElement) => null;
...
const valueStringArrayElement = <DatePicker value={['2018-11-29T18:35:50.115Z', '2018-11-29T19:35:50.115Z']} />;
const valueDateArrayElement = <DatePicker value={[new Date(), new Date(1543516477474)]} />;
const valueNumberArrayElement = <DatePicker value={[1543516477474, 1544549477474]} />;
const customRender = (
