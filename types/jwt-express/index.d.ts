...
export let options: Express.JWTExpressOptions;
 ...
 * @return JWT
 */
export function create(secret: string | ((payload: any) => string), payload: any): Express.JWT;
 ...
 * @return Express middleware
 */
export function init(secret: string | ((req: express.Request) => string), options?: Express.JWTExpressOptions): express.RequestHandler;
