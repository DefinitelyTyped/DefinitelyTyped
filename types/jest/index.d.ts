...
declare namespace jest {
    ...
    type PromiseOf<T> = T extends Promise<infer S> ? S : T;
    ...
    type SafeParameters<T> = T extends (...args: any) => any ? Parameters<T> : any[];
    type SafeReturn<T> = T extends (...args: any) => any ? ReturnType<T> : any[];
    type ArrayElementOf<T> =  T extends Array<infer E> ? E : any;
    type ElementOf<T> = T extends string ? string : ArrayElementOf<T>;
    ...
    interface Matchers<R, T = {}> {
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        lastCalledWith<E extends SafeParameters<T>>(...args: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        lastReturnedWith<E extends SafeReturn<T>>(value: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        nthCalledWith<E extends SafeParameters<T>>(nthCall: number, ...args: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        nthReturnedWith<E extends SafeReturn<T>>(n: number, value: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toBe<E extends T | JasmineMatcher>(expected: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toBeCalledWith<E extends SafeParameters<T>>(...args: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toContain<E extends ElementOf<T>>(expected: E): R;
        /**
         * Used when you want to check that an item is in a list.
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toContainEqual<E extends ArrayElementOf<T>>(expected: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toEqual<E extends T>(expected: E): R;
        /**
         * Ensures that a mock function is called.
         */
        toHaveBeenCalled(): R;
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toHaveBeenCalledWith<E extends SafeParameters<T>>(...args: E): R;
        /**
         * Ensure that a mock function is called with specific arguments on an Nth call.
         *
         * Optionally, you can provide a type for the expected arguments via a generic.
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toHaveBeenNthCalledWith<E extends SafeParameters<T>>(nthCall: number, ...args: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toHaveBeenLastCalledWith<E extends SafeParameters<T>>(...args: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toHaveLastReturnedWith<E extends SafeReturn<T>>(expected: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toHaveNthReturnedWith<E extends SafeReturn<T>>(nthCall: number, expected: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toHaveReturnedWith<E extends SafeReturn<T>>(expected: E): R;
        /**
         ...
         */
        // tslint:disable-next-line: no-unnecessary-generics
        toReturnWith<E extends SafeReturn<T>>(expected: E): R;
        /**
    ...
    type JestExtendedMatchers<TMatchers extends ExpectExtendMap, TActual> = JestMatchersShape<
        ...
        ExtendedMatchers<TMatchers, Promise<void>, PromiseOf<TActual>>,
