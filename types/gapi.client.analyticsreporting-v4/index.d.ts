...
declare namespace gapi.client {
    ...
    export function load (name: "analyticsreporting", version: "v4") : PromiseLike<void>;    
    export function load (name: "analyticsreporting", version: "v4", callback: () => any) : void;    
    
    const reports: gapi.client.analyticsreporting.ReportsResource; 
