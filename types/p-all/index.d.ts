...
declare function pAll<TAll>(tasks: Iterable<PromiseFactory<TAll>>, options?: pAll.Options): Promise<TAll[]>;
...
declare function pAll(tasks: Iterable<PromiseFactory<any>>, options?: pAll.Options): Promise<any[]>;
