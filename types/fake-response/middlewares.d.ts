...
declare class DefaultMiddlewares extends Validators {
...
export declare class Middlewares extends DefaultMiddlewares {
    constructor(db?: UserDB, config?: Config, globals?: Globals, injectors?: Injectors[]);
    protected initialMiddlewareWrapper: (data: any, dataType: string, specificMiddleware: Middleware, commonMiddleware: Config["middleware"], delay: number) => (req: express.Request, res: express.Response, next: express.NextFunction) => Promise<void>;
    protected specificMiddlewareWrapper: (globals: Globals) => (req: express.Request, res: express.Response, next: express.NextFunction) => void;
