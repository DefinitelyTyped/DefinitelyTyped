...
declare namespace gapi.client.reseller {
...
declare namespace gapi.client {
    ...
    const customers: gapi.client.reseller.CustomersResource; 
    
    const resellernotify: gapi.client.reseller.ResellernotifyResource; 
    
    const subscriptions: gapi.client.reseller.SubscriptionsResource; 
