...
declare namespace When {
    ...
    function attempt<A1, T>(f: _.Fn1<A1, T>, arg1: A1 | Promise<A1>): Promise<T>;

    function attempt<A1, A2, T>(f: _.Fn2<A1, A2, T>, arg1: A1 | Promise<A1>, arg2: A2 | Promise<A2>): Promise<T>;
...
declare module 'when/node' {
    ...
    function call<A1, T>(fn: _.NodeFn1<A1, T>, arg1: A1 | when.Promise<A1>): when.Promise<T>;
