...
declare global {
	/**
	 * @see https://developer.knuddels.de/docs/classes/Json.html
	 */
	interface Json {
		/**
		 * @see https://developer.knuddels.de/docs/classes/Json.html#property_[x: string]
		 */
		[x: string]: JsonData;
	}

	/**
	 * @see https://developer.knuddels.de/docs/classes/KnuddelsJson.html
	 */
	interface KnuddelsJson {
		/**
		 * @see https://developer.knuddels.de/docs/classes/KnuddelsJson.html#property_[x: string]
		 */
		[x: string]: KnuddelsJsonData;
	}

	/**
	 * @see https://developer.knuddels.de/docs/classes/JsonArray.html
	 */
	interface JsonArray extends Array<JsonData> {
	}

	/**
	 * @see https://developer.knuddels.de/docs/classes/KnuddelsJsonArray.html
	 */
	interface KnuddelsJsonArray extends Array<KnuddelsJsonData> {
	}

	/**
	 * @see https://developer.knuddels.de/docs/classes/KnuddelsEventArray.html
	 */
