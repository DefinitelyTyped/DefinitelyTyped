...
export class WebiconTests {
    ...
    Test() {
         ...
         * Using a string
         */
        setOptions.url = setOptions.uri = iconOptions.url = iconOptions.uri = '';

        /**
         * Using an object
         */
        setOptions.url = setOptions.uri = iconOptions.url = iconOptions.uri = this.getUrlObject();

        /**
         * Using a function
         * Returning a string
         */
        setOptions.url = setOptions.uri = iconOptions.url = iconOptions.uri = this.getStringUrlCallback();

        /**
         * Returning an object
         */
        setOptions.url = setOptions.uri = iconOptions.url = iconOptions.uri = this.getObjectUrlCallback();

        /**
         * Declaring class-resolvers
         * Using a string
         */
        cssIconSetOptions.className = cssIconSetOptions.cssClass = cssIconSetOptions.class = '';

        /**
         * Using a function
         */
        cssIconSetOptions.className = cssIconSetOptions.cssClass = cssIconSetOptions.class = ClassResolver;
         ...
         * Simple
         */
        config.svgSets = config.svgSet = config.iconSets = config.iconSet = {
            clock: '',
        };
         ...
         * Array
         */
        config.svgSets = config.svgSet = config.iconSets = config.iconSet = [idSetOptions];

        /**
         * Setting css-class icons
         * Simple
         */
        config.fonts = config.font = config.sprites = config.sprite = {
            clock: '',
        };
         ...
         * Array
         */
        config.fonts = config.font = config.sprites = config.sprite = [idCssIconOptions];
         ...
         * Simple
         */
        config.defaultIconSetUrl = config.defaultSvgSetUrl = config.defaultSvgIconSetUrl = '';

        /**
         * Complex
         */
        config.defaultIconSetUrl = config.defaultSvgSetUrl = config.defaultSvgIconSetUrl = setOptions;
