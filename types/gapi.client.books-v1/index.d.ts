...
declare namespace gapi.client.books {
...
declare namespace gapi.client {
    // Load Books API v1
    export function load (name: "books", version: "v1") : PromiseLike<void>;    
    export function load (name: "books", version: "v1", callback: () => any) : void;    
    
    const bookshelves: gapi.client.books.BookshelvesResource; 
    
    const cloudloading: gapi.client.books.CloudloadingResource; 
    
    const dictionary: gapi.client.books.DictionaryResource; 
    
    const layers: gapi.client.books.LayersResource; 
    
    const myconfig: gapi.client.books.MyconfigResource; 
    
    const mylibrary: gapi.client.books.MylibraryResource; 
    
    const notification: gapi.client.books.NotificationResource; 
    
    const onboarding: gapi.client.books.OnboardingResource; 
    
    const personalizedstream: gapi.client.books.PersonalizedstreamResource; 
    
    const promooffer: gapi.client.books.PromoofferResource; 
    
    const series: gapi.client.books.SeriesResource; 
    
    const volumes: gapi.client.books.VolumesResource; 
