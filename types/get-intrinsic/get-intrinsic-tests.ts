...
{
    GetIntrinsic('%AggregateError%'); // $ExpectType AggregateErrorConstructor
    GetIntrinsic('%AggregateError.prototype%'); // $ExpectType AggregateError
...
// allowMissing = false
{
    GetIntrinsic('%AggregateError%', false); // $ExpectType AggregateErrorConstructor
    GetIntrinsic('%AggregateError.prototype%', false); // $ExpectType AggregateError
    ...
    GetIntrinsic('%BigInt%', false); // $ExpectType BigIntConstructor
    GetIntrinsic('%BigInt.prototype%', false); // $ExpectType BigInt
...
// allowMissing = true
{
    GetIntrinsic('%AggregateError%', true); // $ExpectType AggregateErrorConstructor | undefined
    GetIntrinsic('%AggregateError.prototype%', true); // $ExpectType AggregateError | undefined
    ...
    GetIntrinsic('%BigInt%', true); // $ExpectType BigIntConstructor | undefined
    GetIntrinsic('%BigInt.prototype%', true); // $ExpectType BigInt | undefined
...
{
    GetIntrinsic('%AggregateError%', boolean); // $ExpectType AggregateErrorConstructor | undefined
    GetIntrinsic('%AggregateError.prototype%', boolean); // $ExpectType AggregateError | undefined
    ...
    GetIntrinsic('%BigInt%', boolean); // $ExpectType BigIntConstructor | undefined
    GetIntrinsic('%BigInt.prototype%', boolean); // $ExpectType BigInt | undefined
