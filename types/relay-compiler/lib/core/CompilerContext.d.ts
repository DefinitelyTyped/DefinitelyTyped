...
export class CompilerContext {
    ...
    applyTransforms(transforms: ReadonlyArray<IRTransform>, reporter?: Reporter): CompilerContext;
    ...
    withMutations(fn: (context: CompilerContext) => CompilerContext): CompilerContext;
    getSchema(): Schema;
}
