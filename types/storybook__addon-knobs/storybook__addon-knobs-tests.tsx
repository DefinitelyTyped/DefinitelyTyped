...
stories.add('with all knobs', () => {
    ...
    const genericSelectV2Enum: SomeEnum = select<SomeEnum>(
        'Some generic select v2',
    ...
    return (
        <div style={style}>
            I'm {name} and I was born on "{dob}"<p>My favorite number is {favoriteNumber}.</p>
