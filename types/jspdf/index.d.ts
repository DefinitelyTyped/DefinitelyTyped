...
declare module 'jspdf' {
    class jsPDF {
        constructor(orientation?: any, unit?: string, format?: string | Array<Number>, compressPdf?: number);
        ...
        table(
            ...
            y: number,
            data: any,
            headers: { name: string; prompt?: string; width?: number; align?: string; padding?: number }[],
            config: any,
        ): jsPDF;
