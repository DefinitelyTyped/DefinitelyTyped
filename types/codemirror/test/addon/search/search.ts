...
const searchCursor: CodeMirror.SearchCursor = editor.getSearchCursor(
    "test",
...
const searchCursor2: CodeMirror.SearchCursor = doc.getSearchCursor(
    "test",
    { from: position, to: position },
    true
);
const searchCursor3: CodeMirror.SearchCursor = doc.getSearchCursor(
    /test/,
    { from: position, to: position },
    searchOpt
);
