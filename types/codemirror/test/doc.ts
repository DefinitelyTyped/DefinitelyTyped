...
doc.on(
    "change",
    (doc: CodeMirror.Doc, changeObj: CodeMirror.EditorChangeCancellable) => {}
);
doc.on(
    "beforeChange",
    (doc: CodeMirror.Doc, changeObj: CodeMirror.EditorChangeCancellable) => {}
...
doc.on(
    ...
    (doc: CodeMirror.Doc, selection: CodeMirror.Selection) => {}
);
...
const line3: CodeMirror.LineHandle = doc.addLineClass(
    lineHandle,
    "background",
    "test"
);
const line4: CodeMirror.LineHandle = doc.removeLineClass(0, "gutter", "test");
const line5: CodeMirror.LineHandle = doc.addLineClass(
    lineHandle,
    "wrap",
    "test"
);
