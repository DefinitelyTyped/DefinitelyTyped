...
import { genericHashLink, HashLink, HashLinkProps, NavHashLink, NavHashLinkProps } from "react-router-hash-link";
...
React.forwardRef<HTMLAnchorElement>((_, ref) => <HashLink ref={ref} to="/" />);

React.forwardRef<HTMLAnchorElement>((_, ref) => <NavHashLink ref={ref} to="/" />);
