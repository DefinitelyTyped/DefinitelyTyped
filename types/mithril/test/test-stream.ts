...

{
    ...
    const child = stream.scanMerge([[parent1, (out, p1) => out + p1], [parent2, (out, p2) => out + p2]], -10);
}

{
    ...
    const child = stream.scanMerge([[parent1, (out, p1) => out + p1], [parent2, (out, p2) => out + p2 + p2]], 'a');
