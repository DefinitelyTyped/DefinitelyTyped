...
interface ChocolateChipStatic {
     ...
     * @return void
     */
    UIPopover(options?: { id?: string; callback?: Function; title?: string }): void;
     ...
     * @return void
     */
    UISheet(options: { id: string; listClass?: string; background?: string; handle?: boolean }): void;
    ...
    UISlideout: {
         ...
         * @return void
         */
        (options?: { dynamic?: boolean; callback?: (args?: any) => any }): any;
     ...
     * @return void
     */
    UITabbar(options?: { id?: string; tabs: number; labels: string[]; icons?: string[]; selected?: number }): void;
     ...
     * @return void
     */
    UISearch(options?: { articleId?: any; id?: string; placeholder?: string; results?: number }): void;
...
interface ChocolateChipElementArray {
     ...
     * @return void
     */
    UIBusy(options?: { size?: string; color?: string; position?: string | boolean; duration?: string }): void;
     ...
     * @return void
     */
    UISegmented(options?: { selected?: number; callback?: Function }): void;
     ...
     * @return void
     */
    UISelectList(options?: { name?: string; selected?: number; callback?: Function }): void;
     ...
     * @return void
     */
    UIStepper(options: { start: number; end: number; defaultValue: number }): void;
...
interface JQueryStatic {
     ...
     * @return JQuery
     */
    UICreateSegmented(options: { id?: string; className?: string; labels?: string[]; selected?: number }): JQuery;
     ...
     * @return void
     */
    UISetupCarousel(options: { target: any; panels: JQuery; loop?: boolean; pagination?: boolean }): void;
