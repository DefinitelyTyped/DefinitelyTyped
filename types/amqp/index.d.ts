...
// Project: https://github.com/postwait/node-amqp#readme
...
declare namespace amqp {
  ...
  interface AMQPClient extends net.Socket {
  ...
  interface AMQPQueue extends events.EventEmitter {
  ...
  interface AMQPExchange extends events.EventEmitter {
    ...
    // publish(routingKey: string, message: Buffer | {}, callback?: Callback<void>): void
  ...
  function createConnection(options: ConnectionOptions): AMQPClient
  ...
  interface Ack extends DeliveryInfo {
