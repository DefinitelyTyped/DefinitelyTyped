...
declare namespace BabylonWalk {
    type coreTypes = babelTypes.ArrayExpression | babelTypes.AssignmentExpression | babelTypes.BinaryExpression |
    ...
    type es2015Types = babelTypes.AssignmentPattern | babelTypes.ArrayPattern | babelTypes.ArrowFunctionExpression |
    ...
    type flowTypes = babelTypes.AnyTypeAnnotation | babelTypes.ArrayTypeAnnotation | babelTypes.BooleanTypeAnnotation |
    ...
    type jsxTypes = babelTypes.JSXAttribute | babelTypes.JSXClosingElement | babelTypes.JSXElement |
    ...
    type miscTypes = babelTypes.Noop | babelTypes.ParenthesizedExpression;

    type NodeTypes = coreTypes | es2015Types | flowTypes | jsxTypes | miscTypes;

    interface coreVisitors<V> {
    ...
    interface miscVisitors<V> {
        Noop?: V; ParenthesizedExpression?: V;
    }

    interface visitors<V> extends coreVisitors<V>, es2015Visitors<V>, flowVisitors<V>, jsxVisitors<V>, miscVisitors<V> {
    }

    type Visitor = (commentBlock: NodeTypes, state: any) => void;

    type SimpleVisitor = (node: NodeTypes, state: any) => void;

    type AncestorVisitor = (node: NodeTypes, state: any, ancestors: babelTypes.Node[]) => void;

    type AncestorStatelessVisitor = (node: NodeTypes, state: any, ancestors: babelTypes.Node[]) => void;

    type RecursiveVisitor = (node: NodeTypes, state: any, next: (node: babelTypes.Node) => void) => void;

    function simple(node: NodeTypes, visitors: visitors<SimpleVisitor>, state: any): void;
    function ancestor(node: NodeTypes, visitors: visitors<AncestorVisitor>, state: any): void;
    function recursive(node: NodeTypes, visitors: visitors<RecursiveVisitor>, state: any): void;
}
