declare namespace adone.system.process {
    function errname(code: number): string;

    function errnameFallback(uv: object, code: number): string;
    ...
    namespace I {
        ...
        interface ExecOptions extends ExecCommonOptions {
            /**
             * Write some input to the `stdin` of your binary.
             */
            input?: string | Buffer | nodestd.stream.Stream;
        }

        interface ExecSyncOptions extends ExecCommonOptions {
            /**
             * Write some input to the `stdin` of your binary.
