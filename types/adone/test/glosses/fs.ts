namespace fsTests {
    ...
    namespace DirectoryTests {
        ...
        d.files().then(
            (
                x: Array<
                    adone.fs.File | adone.fs.Directory | adone.fs.SymbolicLinkFile | adone.fs.SymbolicLinkDirectory
                >,
            ) => {},
        );
        {
    ...
    namespace globTests {
        ...
        fs.glob(['hello'], {
            stat: true,
            patternIndex: true,
        }).forEach((x: { path: string; patternIndex: number; stat: adone.fs.I.Stats }) => {});
