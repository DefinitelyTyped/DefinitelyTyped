namespace compressorsTests {
    ...
    namespace gzTests {
        ...
        gz.compress(Buffer.from('hello'), {
            info: true,
        }).then((x: { buffer: Buffer; engine: nodestd.zlib.Gzip }) => {});
        ...
        gz.decompress(Buffer.from('hello'), {
            info: true,
        }).then((x: { buffer: Buffer; engine: nodestd.zlib.Gunzip }) => {});
