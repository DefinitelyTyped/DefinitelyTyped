namespace streamsTests {
    ...
    namespace CoreStreamTests {
        ...
        {
            const a: adone.stream.core.Stream<any, number> = new Stream().throughSync(function () {
                this.push(1);
            });
        }
        {
            const a: adone.stream.core.Stream<any, number> = new Stream().throughSync(
                function () {
                    this.push(1);
                },
                function () {
        ...
        {
            const a: adone.stream.core.Stream<any, number> = new Stream().throughAsync(function () {
                this.push(1);
            });
        }
        {
            const a: adone.stream.core.Stream<any, number> = new Stream().throughAsync(
                function () {
                    this.push(1);
                },
                function () {
        ...
        {
            const a: adone.stream.core.Stream<any, number> = new Stream().through(
                function () {
                    this.push(1);
                },
                function () {
        ...
        {
            const a: adone.stream.core.Stream<number, string> = new Stream<number, number>([1, 2, 3]).map(
                (x) => `${x}`,
            );
        }
        {
            const a: adone.stream.core.Stream<any, number | string> = new Stream<string, string>().mapIf(
                (x) => x === '1',
                () => 1,
            );
        }
        {
            const a: adone.stream.core.Stream<any, number | string> = new Stream<number, string>().mapIf(
                async (x) => x === '1',
                () => 1,
            );
        }
        ...
        {
            const a: adone.stream.core.Stream<number, number> = new Stream<number, number>().forEach(
                async (x) => x === 1,
            );
        }
        {
        ...
        {
            const a: Promise<number> = new Stream().then(
                () => 1,
                () => 2,
            );
        }
    ...
    namespace coreTests {
        ...
        {
            const a: adone.stream.core.Stream<any, number> = stream.core.create<string, number>(undefined, {
                transform(x) {
                    this.push(Number(x));
                },
            });
        ...
        {
            const a: adone.stream.core.Stream<any, number> = stream.core.create(undefined, {
                flush() {
                    this.push(1);
                },
            });
