...
declare namespace l {
    ...
    interface LoopBackApplication extends core.Application {
        ...
        middlewareFromConfig(
            factory: () => void,
            config: { phase: string; enabled?: boolean; params?: any[] | any; paths?: any[] | string | RegExp },
        ): any;
    ...
    class PersistedModel extends Model {
         ...
         */
        static findById<T = any>(id: any, callback: CallbackWithResult<T>): void;
         ...
         */
        static findOrCreate<T = any>(data: any, callback: CallbackWithMultipleResults<T, boolean>): void;
         ...
         */
        static replaceById<T = any>(id: any, data: any, callback: CallbackWithResult<T>): void;
         ...
         */
        static replaceOrCreate<T = any>(data: any, callback: CallbackWithResult<T>): void;
         ...
         *
         */
        static updateAll(callback: CallbackWithMultipleResults<any, number>): void;
         ...
         *
         */
        static updateAll(whereOrData: any, callback: CallbackWithMultipleResults<any, number>): void;
         ...
         *
         */
        static updateAll(where: any, data: any, callback: CallbackWithMultipleResults<any, number>): void;
         ...
         */
        static upsert<T = any>(data: any, callback: CallbackWithResult<T>): void;
         ...
         * @param {any} model Updated model instance
         */
        static upsertWithWhere<T = any>(data: any, callback: CallbackWithResult<T>): void;
         ...
         * @param {any} instance Replaced instance
         */
        replaceAttributes<T = any>(data: any, callback: CallbackWithResult<T>): void;
         ...
         * If false, report the error via callback.  Default is false.
         */
        save<T = any>(options?: { validate: boolean; throws: boolean }): Promise<T>;
         ...
         */
        updateAttribute<T = any>(name: string, value: any, callback: CallbackWithResult<T>): void;
         ...
         * @param {any} instance Updated instance
         */
        updateAttributes<T = any>(data: any, callback: CallbackWithResult<T>): void;
