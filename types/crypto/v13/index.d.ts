...
export class Verify extends stream.Writable {
    ...
    verify(object: object | KeyLike, signature: ArrayBufferView): boolean;
 ...
 */
export function sign(algorithm: string | null | undefined, data: ArrayBufferView, key: KeyLike | SignPrivateKeyInput): Buffer;

export interface VerifyKeyWithOptions extends KeyObject, SigningOptions {
}
 ...
 */
export function verify(algorithm: string | null | undefined, data: ArrayBufferView, key: KeyLike | VerifyKeyWithOptions, signature: ArrayBufferView): boolean;
