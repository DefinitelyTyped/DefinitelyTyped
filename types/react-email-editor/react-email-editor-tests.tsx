...
import EmailEditor, { Design, FileInfo, FileUploadDoneCallback, HtmlExport } from 'react-email-editor';
...
class App extends React.Component {
    ...
    private readonly handleLoad = () => {
        if (this.editorRef.current) {
            ...
            this.editorRef.current.setMergeTags([{ name: '{{newTestTag}}', value: 'New Test Tag Value' }]);
        }
    };
