...
interface FairPlay {
  ...
  licenseRequestHeaders?: Array<DRMHeader>,
...
declare interface JWPlayerConfig {
  file: string,
  image?: string,
  title?: string,
  description?: string,
...
declare interface JWPlayerInstance {
  on(event: Event, callback: (args: any) => void): void,
  once(event: Event, callback: (args: any) => void): void,
  off(event: Event, callback: (args: any) => void): void,
  trigger(event: Event, callback: (args: any) => void): void,
  getViewable(): number,
  next(): void,
  getPlaylist(): Array<PlaylistItem>,
  getPlaylistItem(index: number): PlaylistItem,
  getPlaylistIndex(): number,
  load(playlist: Array<PlaylistItem>): void,
  ...
  getQualityLevels(): Array<QualityLevels>,
