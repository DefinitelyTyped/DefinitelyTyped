...
export interface Daum {
     ...
     * ```
     */
    readonly Postcode: typeof DaumPostcode;
}

export class DaumPostcode {
...
export type DaumPostcodeEmbedHandler = (element: HTMLElement, options?: DaumPostcodeEmbedOptions) => void;
export type DaumPostcodeOpenHandler = (options?: DaumPostcodeOpenOptions) => void;
