...
export interface WhenMock<T = any, Y extends any[] = any> extends jest.Mock<T, Y> {
  ...
  mockResolvedValue<V = T>(value: V | PromiseLike<V>): WhenMock<Promise<V>, Y>;
  mockResolvedValueOnce<V = T>(value: V | PromiseLike<V>): WhenMock<Promise<V>, Y>;
  mockRejectedValue<V = T>(value: V | PromiseLike<V>): WhenMock<Promise<V>, Y>;
  mockRejectedValueOnce<V = T>(value: V | PromiseLike<V>): WhenMock<Promise<V>, Y>;
}
