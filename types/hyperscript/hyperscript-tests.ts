...
h(
    "div#page",
    h("div#header", h("h1.classy", "h", { style: { "background-color": "#22f" } })),
    h("div#menu", { style: { "background-color": "#2f2" } }, h("ul", h("li", "one"), h("li", "two"), h("li", "three"))),
...
h<HTMLDivElement>(
    "div#page",
    h<HTMLDivElement>("div#header", h<HTMLHeadingElement>("h1.classy", "h", { style: { "background-color": "#22f" } })),
);
