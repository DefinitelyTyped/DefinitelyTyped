...
//                 Mufaddal Hamid <https://github.com/mufaddalhamidofficial>
// Definitions: https://github.com/DefinitelyTyped/DefinitelyTyped

export = RNCryptoJS;

type WordArray = RNCryptoJS.lib.WordArray;
type CipherParams = RNCryptoJS.lib.CipherParams;
type X64Word = RNCryptoJS.x64.Word;
...
interface HasherStatic {
     ...
     * @example
     *
     *     var hasher = RNCryptoJS.algo.SHA256.create();
     */
...
interface CipherStatic {
     ...
     * @example
     *
     *     var cipher = RNCryptoJS.algo.AES.createEncryptor(keyWordArray, { iv: ivWordArray });
     */
     ...
     * @example
     *
     *     var cipher = RNCryptoJS.algo.AES.createDecryptor(keyWordArray, { iv: ivWordArray });
     */
     ...
     * @example
     *
     *     var cipher = RNCryptoJS.algo.AES.create(RNCryptoJS.algo.AES._ENC_XFORM_MODE, keyWordArray, { iv: ivWordArray });
     */
...
interface ModeStatic {
     ...
     * @example
     *
     *     var mode = RNCryptoJS.mode.CBC.Encryptor.create(cipher, iv.words);
     */
...
interface BlockCipherMode {
     ...
     * @example
     *
     *     var mode = RNCryptoJS.mode.CBC.createEncryptor(cipher, iv.words);
     */
     ...
     * @example
     *
     *     var mode = RNCryptoJS.mode.CBC.createDecryptor(cipher, iv.words);
     */
...
interface Padding {
     ...
     * @example
     *
     *     RNCryptoJS.pad.Pkcs7.pad(wordArray, 4);
     */
     ...
     * @example
     *
     *     RNCryptoJS.pad.Pkcs7.unpad(wordArray);
     */
...
interface X64WordArray {
    /**
     * The array of RNCryptoJS.x64.Word objects.
     */
    words: number[];
    /**
    ...
    namespace RNCryptoJS {
        ...
        export namespace lib {
            ...
            interface WordArray {
                 ...
                 *
                 * @param encoder (Optional) The encoding strategy to use. Default: RNCryptoJS.enc.Hex
                 *
                 ...
                 *     var string = wordArray.toString(RNCryptoJS.enc.Utf8);
                 */
            ...
            interface CipherParams {
                 ...
                 *     var string = cipherParams.toString(RNCryptoJS.format.OpenSSL);
                 */
