...
interface PlusDownloader {
    ...
    createDownload(
        ...
        completedCB?: (result0: PlusDownloaderDownload, result1: number) => void,
...
interface PlusDownloaderDownload {
    ...
    addEventListener(
        type?: string,
        listener?: (result0: PlusDownloaderDownload, result1: number) => void,
        capture?: boolean,
    ): void;
    /**
     * 获取下载请求HTTP响应头部信息
...
interface PlusFingerprint {
    ...
    authenticate(
        successCB?: () => void,
        errorCB?: (result: PlusFingerprintFingerprintError) => void,
...
interface PlusGallery {
    ...
    save(
        path?: string,
        succesCB?: (result: PlusGalleryGallerySaveEvent) => void,
        errorCB?: (result: any) => void,
    ): void;
}
...
interface PlusGeolocation {
     ...
     */
    getCurrentPosition(
        successCB?: (result: PlusGeolocationPosition) => void,
        errorCB?: (result: PlusGeolocationGeolocationError) => void,
...
interface PlusNativeUI {
    ...
    actionSheet(
        ...
        actionsheetCallback?: (result: any) => void,
    ): PlusNativeUINativeUIObj;
    /**
     * 弹出系统提示对话框
...
interface PlusUploader {
    ...
    createUpload(
        ...
        completedCB?: (result0: PlusUploaderUpload, result1: number) => void,
    ): PlusUploaderUpload;
    /**
     * 枚举上传任务
...
interface PlusUploaderUpload {
    ...
    addEventListener(
        type?: string,
        listener?: (result0: PlusUploaderUpload, result1: number) => void,
        capture?: boolean,
    ): void;
    /**
     * 获取上传请求HTTP响应头部信息
...
interface PlusWebviewWebviewObject {
    ...
    drag(
        ...
        callback?: (result: PlusWebviewWebviewDragEvent) => void,
    ): void;
    /**
     * 截屏绘制
...
interface PlusBarcode {
    ...
    scan(
        path?: string,
        successCB?: (result0: number, result1: string, result2: string) => void,
        errorCB?: (result: any) => void,
        filters?: any[],
    ): void;
    /**
...
interface PlusShareShareService {
     ...
     */
    authorize(
        successCallback?: (result: PlusShareShareService) => void,
        errorCallback?: (result: any) => void,
