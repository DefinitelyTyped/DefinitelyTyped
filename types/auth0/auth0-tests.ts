...
management.getPermissionsInRole({ id: 'role_id', include_totals: true, },).then(permissions =>
...
// Custom Domains
management.createCustomDomain({ domain: 'auth0.com', type: 'auth0_managed_certs', },).then(domain =>
    console.log(domain,)
);
