...
export interface Workspace {
    ...
    addModalPanel<T>(options: { item: T; visible?: boolean; priority?: number; autoFocus?: boolean }): Panel<T>;
...
export class TextBuffer {
    ...
    /** Batch multiple operations as a single undo/redo step. */
    transact<T>(optionsOrInterval: number | { groupingInterval?: number } & HistoryTransactionOptions, fn: () => T): T;
    /** Batch multiple operations as a single undo/redo step. */
    transact<T>(fn: () => T): T;
