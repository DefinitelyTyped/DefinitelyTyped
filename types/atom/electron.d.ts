...
declare namespace AtomElectron {
	class EventEmitter {
	...
	interface CommonInterface {
		clipboard: AtomElectron.Clipboard;
		crashReporter: AtomElectron.CrashReporter;
		nativeImage: typeof AtomElectron.NativeImage;
		screen: AtomElectron.Screen;
		shell: AtomElectron.Shell;
	}

	interface MainInterface extends CommonInterface {
		app: AtomElectron.App;
		autoUpdater: AtomElectron.AutoUpdater;
		BrowserView: typeof AtomElectron.BrowserView;
		BrowserWindow: typeof AtomElectron.BrowserWindow;
		ClientRequest: typeof AtomElectron.ClientRequest;
		contentTracing: AtomElectron.ContentTracing;
		Cookies: typeof AtomElectron.Cookies;
		Debugger: typeof AtomElectron.Debugger;
		dialog: AtomElectron.Dialog;
		DownloadItem: typeof AtomElectron.DownloadItem;
		globalShortcut: AtomElectron.GlobalShortcut;
		IncomingMessage: typeof AtomElectron.IncomingMessage;
		ipcMain: AtomElectron.IpcMain;
		Menu: typeof AtomElectron.Menu;
		MenuItem: typeof AtomElectron.MenuItem;
		net: AtomElectron.Net;
		powerMonitor: AtomElectron.PowerMonitor;
		powerSaveBlocker: AtomElectron.PowerSaveBlocker;
		protocol: AtomElectron.Protocol;
		session: typeof AtomElectron.Session;
		systemPreferences: AtomElectron.SystemPreferences;
		TouchBar: typeof AtomElectron.TouchBar;
		Tray: typeof AtomElectron.Tray;
		webContents: typeof AtomElectron.WebContents;
		WebRequest: typeof AtomElectron.WebRequest;
	}

	interface RendererInterface extends CommonInterface {
		BrowserWindowProxy: typeof AtomElectron.BrowserWindowProxy;
		desktopCapturer: AtomElectron.DesktopCapturer;
		ipcRenderer: AtomElectron.IpcRenderer;
		remote: AtomElectron.Remote;
		webFrame: AtomElectron.WebFrame;
		webviewTag: AtomElectron.WebviewTag;
	}
	...
	interface MessageBoxOptions {
		/**
		 * Can be , , , or . On Windows, displays the same icon as , unless you set an icon
		 * using the option. On macOS, both and display the same warning icon.
		 */
		type?: string;
		/**
