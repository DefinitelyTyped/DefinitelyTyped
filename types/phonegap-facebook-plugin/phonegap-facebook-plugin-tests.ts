...
facebookConnectPlugin.getLoginStatus(
    (status: PhonegapFacebookPlugin.LoginResult) => {
...
facebookConnectPlugin.login(
    ['a', 'b'],
    (result: PhonegapFacebookPlugin.LoginResult) => {
...
facebookConnectPlugin.showDialog(
    feedDialogOptions,
    (status: PhonegapFacebookPlugin.FeedDialogResult) => {
...
facebookConnectPlugin.showDialog(
    sendDialogOptions,
    (status: PhonegapFacebookPlugin.SendDialogResult) => {},
    (error: string) => {},
);
...
facebookConnectPlugin.showDialog(
    shareDialogOptions,
    (status: PhonegapFacebookPlugin.ShareDialogResult) => {
        var post_id: string = status.post_id;
    },
    (error: string) => {},
);
