...
import RevealHighlight = require("reveal.js/plugin/highlight/highlight.esm");
import RevealMarkdown = require("reveal.js/plugin/markdown/markdown.esm");
import RevealMath = require("reveal.js/plugin/math/math.esm");
import RevealNotes = require("reveal.js/plugin/notes/notes.esm");
import RevealSearch = require("reveal.js/plugin/search/search.esm");
import RevealZoom = require("reveal.js/plugin/zoom/zoom.esm");
