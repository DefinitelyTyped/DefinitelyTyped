...
declare namespace internal {
    ...
    class Readable extends Stream implements ReadableStream {
        ...
        readable: boolean;
        readonly readableEncoding: buffer.BufferEncoding | null;
        ...
        unshift(chunk: any, encoding?: buffer.BufferEncoding): void;
...
declare global {
    namespace NodeJS {
        interface ReadableStream extends EventEmitter_ {
            ...
            unshift(chunk: string | Uint8Array, encoding?: buffer.BufferEncoding): void;
