...
declare global {
    namespace NodeJS {
        interface ReadableStream extends EventEmitter_ {
            ...
            unshift(chunk: string | buffer.Buffer | Uint8Array): void;
        ...
        interface WritableStream extends EventEmitter_ {
            writable: boolean;
            write(buffer: buffer.Buffer | Uint8Array | string, cb?: (err?: Error | null) => void): boolean;
            write(str: string, encoding?: string, cb?: (err?: Error | null) => void): boolean;
            end(cb?: () => void): void;
            end(data: string | Uint8Array | buffer.Buffer, cb?: () => void): void;
