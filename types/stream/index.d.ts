...
declare namespace internal {
    ...
    class Readable extends Stream implements ReadableStream {
        ...
        setEncoding(encoding: buffer.BufferEncoding): this;
        pause(): this;
        resume(): this;
        isPaused(): boolean;
        ...
        push(chunk: any, encoding?: buffer.BufferEncoding): boolean;
    ...
    interface WritableOptions {
        ...
        defaultEncoding?: buffer.BufferEncoding;
        objectMode?: boolean;
        emitClose?: boolean;
        write?(this: Writable, chunk: any, encoding: buffer.BufferEncoding, callback: (error?: Error | null) => void): void;
        writev?(this: Writable, chunks: Array<{ chunk: any, encoding: buffer.BufferEncoding }>, callback: (error?: Error | null) => void): void;
    ...
    class Writable extends Stream implements WritableStream {
        ...
        _write(chunk: any, encoding: buffer.BufferEncoding, callback: (error?: Error | null) => void): void;
        _writev?(chunks: Array<{ chunk: any, encoding: buffer.BufferEncoding }>, callback: (error?: Error | null) => void): void;
        _destroy(error: Error | null, callback: (error?: Error | null) => void): void;
        _final(callback: (error?: Error | null) => void): void;
        write(chunk: any, cb?: (error: Error | null | undefined) => void): boolean;
        write(chunk: any, encoding: buffer.BufferEncoding, cb?: (error: Error | null | undefined) => void): boolean;
        setDefaultEncoding(encoding: buffer.BufferEncoding): this;
        end(cb?: () => void): void;
        end(chunk: any, cb?: () => void): void;
        end(chunk: any, encoding: buffer.BufferEncoding, cb?: () => void): void;
        cork(): void;
        uncork(): void;
        destroy(error?: Error): void;
    ...
    interface DuplexOptions extends ReadableOptions, WritableOptions {
        ...
        write?(this: Duplex, chunk: any, encoding: buffer.BufferEncoding, callback: (error?: Error | null) => void): void;
        writev?(this: Duplex, chunks: Array<{ chunk: any, encoding: buffer.BufferEncoding }>, callback: (error?: Error | null) => void): void;
    ...
    interface TransformOptions extends DuplexOptions {
        ...
        write?(this: Transform, chunk: any, encoding: buffer.BufferEncoding, callback: (error?: Error | null) => void): void;
        writev?(this: Transform, chunks: Array<{ chunk: any, encoding: buffer.BufferEncoding }>, callback: (error?: Error | null) => void): void;
        final?(this: Transform, callback: (error?: Error | null) => void): void;
        destroy?(this: Transform, error: Error | null, callback: (error: Error | null) => void): void;
        transform?(this: Transform, chunk: any, encoding: buffer.BufferEncoding, callback: TransformCallback): void;
        flush?(this: Transform, callback: TransformCallback): void;
    }

    class Transform extends Duplex {
        constructor(opts?: TransformOptions);
        _transform(chunk: any, encoding: buffer.BufferEncoding, callback: TransformCallback): void;
...
declare global {
    namespace NodeJS {
        ...
        interface WritableStream extends EventEmitter_ {
            ...
            write(str: string, encoding?: buffer.BufferEncoding, cb?: (err?: Error | null) => void): boolean;
            end(cb?: () => void): void;
            end(data: string | Uint8Array, cb?: () => void): void;
            end(str: string, encoding?: buffer.BufferEncoding, cb?: () => void): void;
        }
