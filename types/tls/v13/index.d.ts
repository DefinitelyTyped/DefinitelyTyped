...
export interface TlsOptions extends SecureContextOptions, CommonConnectionOptions {
    ...
    pskCallback?(socket: TLSSocket, identity: string): ArrayBufferView | null;
    /**
...
export interface PSKCallbackNegotation {
    psk: ArrayBufferView;
    identitty: string;
}
 ...
 * @deprecated
 */
export function createSecurePair(credentials?: SecureContext, isServer?: boolean, requestCert?: boolean, rejectUnauthorized?: boolean): SecurePair;
 ...
 * information.
 */
export let DEFAULT_ECDH_CURVE: string;
/**
 ...
 * is used.
 */
export let DEFAULT_MAX_VERSION: SecureVersion;
/**
 ...
 */
export let DEFAULT_MIN_VERSION: SecureVersion;
 ...
 */
export const rootCertificates: ReadonlyArray<string>;
