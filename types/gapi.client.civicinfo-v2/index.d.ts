// Type definitions for 'Google Google Civic Information API' v2
...
declare namespace gapi.client.civicinfo {
...
declare namespace gapi.client {
    ...
    export function load (name: "civicinfo", version: "v2") : PromiseLike<void>;    
    export function load (name: "civicinfo", version: "v2", callback: () => any) : void;    
    
    const divisions: gapi.client.civicinfo.DivisionsResource; 
    
    const elections: gapi.client.civicinfo.ElectionsResource; 
    
    const representatives: gapi.client.civicinfo.RepresentativesResource; 
