...

{
    ...
    const input: stream.ReadableStream = new stream.Readable();
    const output: stream.WritableStream = new stream.Writable();
...
{
    const strm: stream.WritableStream = new stream.Writable();
    const x = 1;
    const y = 1;
...
{
    const strm: stream.ReadableStream = new stream.Readable();
