...
h = () => { return false }
// @ts-expect-error
h = (s: string) => { return false }
h = (req: LdapSearchRequest) => { return false }
// @ts-expect-error
h = (req: LdapSearchRequest, s: string) => { return false }
h = (req: LdapSearchRequest, res: LdapSearchResponse) => { return false }
