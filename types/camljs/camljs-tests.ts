...
var caml = new CamlBuilder()
    .Where()
    .Any(
        CamlBuilder.Expression()
            .TextField('Email')
            .EqualTo('support@google.com'),
        CamlBuilder.Expression()
            .TextField('Email')
            .EqualTo('plus@google.com'),
        CamlBuilder.Expression()
            .TextField('Title')
            .BeginsWith('[Google]'),
        CamlBuilder.Expression()
...
caml = new CamlBuilder()
    ...
    .All(
        ...
        CamlBuilder.Expression().Any(
            CamlBuilder.Expression()
                .TextField('NotificationScope')
                .EqualTo('77'),
            CamlBuilder.Expression()
                .TextField('NotificationScope')
                .EqualTo('88')
                .And()
                .TextField('ScopeWebRelativeUrl')
                .EqualTo('99')
        )
    )
    .ToString();
...
var caml = new CamlBuilder()
    ...
    .GreaterThan(CamlBuilder.CamlValues.Now)
...
caml = CamlBuilder.Expression()
    .All(
        CamlBuilder.Expression()
            .DateField('BroadcastExpires')
            .GreaterThanOrEqualTo(CamlBuilder.CamlValues.Today),
        CamlBuilder.Expression().Any(
            CamlBuilder.Expression()
                .UserField('BroadcastTo')
                .IsInCurrentUserGroups(),
            CamlBuilder.Expression()
                .UserField('BroadcastTo')
                .EqualToCurrentUser()
        ),
...
caml = new CamlBuilder()
    ...
    .GreaterThan(new Date(Date.UTC(2013, 0, 1)))
    .ToString();
...
var query = new CamlBuilder()
    ...
    .LeftJoin('Country', 'Country')
    .Select('y4r6', 'Population')
    .Query()
    .Where()
