function test() {
    ...
    var seed: MakerJs.IPathBezierSeed = {
    ...
    function testModel() {
        ...
        makerjs.model.findChains(model, function (
            chains: MakerJs.IChain[],
            loose: MakerJs.IWalkPath[],
            layer: string,
        ) {});
        ...
        makerjs.model.walkPaths(
            model,
            (modelContext: MakerJs.IModel, pathId: string, pathContext: MakerJs.IPath) => {},
        );
    ...
    function testModels(): MakerJs.IModel[] {
        ...
        return [
            ...
            new makerjs.models.ConnectTheDots(true, [
                [0, 0],
                [1, 1],
            ]),
            ...
            new makerjs.models.SCurve(5, 0.9),
