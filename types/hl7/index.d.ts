// Type definitions for hl7 2.5.1
...
import { MSH, PID, PV1, ORC, OBR, OBX, AIS, AIL } from './segments';
/**
...
declare namespace hl7 {
    ...
    /**
     * A segment is a logical grouping of data fields. Segments of a message may be required or optional. They may occur only once in a message or they may be allowed to repeat. Each segment is given a name.
