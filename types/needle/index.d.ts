...
declare namespace needle {
     ...
     */
    export function request(method: string, url: string, data: BodyData, callback?: NeedleCallback): ReadableStream;
    /**
     * Generic request.
     * This not only allows for flexibility, but also lets you perform a GET request with data,
     * in which case will be appended to the request as a query string,
     ...
     * @param method Designates an HTTP verb for the request.
     */
    export function request(method: string, url: string, data: BodyData, options?: NeedleOptions, callback?: NeedleCallback): ReadableStream;
}
