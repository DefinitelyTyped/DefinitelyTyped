...
declare namespace Domain {
    ...
    interface DefineAggregateResult {
         ...
         */
        defineIgnoreSnapshot(version: AggregateVersion, cb?: ((data: any) => boolean) | boolean): DefineAggregateResult;
    ...
    type defineEventStreamsToLoadHandler = (
        cmd: any,
    ) => Array<{
        context: string;
        aggregate: string;
    ...
    interface CqrsDomain {
         ...
         * @returns to be able to chain...
         */
        onEvent(cb: ((evt: any) => void) | ((evt: any, callback: () => void) => void)): CqrsDomain;
         ...
         * @returns to be able to chain...
         */
        idGenerator(cb: (() => string) | ((callback: generateIdCallback) => string)): CqrsDomain;
         ...
         * @returns to be able to chain...
         */
        aggregateIdGenerator(cb: (() => string) | ((callback: generateIdCallback) => string)): CqrsDomain;
