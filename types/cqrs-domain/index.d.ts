// Type definitions for cqrs-domain 2.10.0
...
declare module "cqrs-domain" {
	...
	module Domain {
		...
		export interface AggregateModel {
			...
			apply(event: string, data: any): void;
			apply(event: string, data: any, version: number): void;
			 ...
			 */
			reset(data: AggregateModel|any): void;
		...
		export interface DefineContextOptions {
			/**
		...
		export function defineContext(options: DefineAggregateOptions): void;
		...
		export interface DefineAggregateOptions {
			/**
		...
		interface DefineAggregateResult {
			 ...
			 */
			defineIgnoreSnapshot(version: AggregateVersion, cb: (data: any) => boolean): DefineAggregateResult;
			
			/**
			 * optionally, define if snapshot should be ignored
			 * if true, the whole event stream will be loaded
			 */
			defineIgnoreSnapshot(version: AggregateVersion, ignore: boolean): DefineAggregateResult;
			
			/**
			 * optionally, define if snapshot should be ignored
			 * if true, the whole event stream will be loaded
			 */
			defineIgnoreSnapshot(version: AggregateVersion): DefineAggregateResult;
			 ...
			 */
			defineAggregateIdGenerator(cb: () => string): DefineAggregateResult;
			
			/**
			 * optionally, define idGenerator function for new aggregate ids
			 */
			defineAggregateIdGenerator(cb: (callback: generateIdCallback) => string): DefineAggregateResult;
			 ...
			 */
			defineCommandAwareAggregateIdGenerator(cb: (cmd: Command) => string): DefineAggregateResult;
		...
		export function defineAggregate(options: DefineAggregateOptions, initializationData?: any): DefineAggregateResult;
		...
		export interface DefinePreLoadConditionOptions {
			/**
			 * the command name
		...
		export function definePreLoadCondition(options: DefinePreLoadConditionOptions, handler: preLoadConditionHandler): void;
		...
		export interface DefinePreConditionOptions {
			/**
			 * the command name
			 * optional, default is file name without extension,
			 * if name is '' it will handle all commands that matches the appropriate aggregate
		...
		export function definePreCondition(options: DefinePreConditionOptions, handler: preConditionHandler): void;
		...
		type defineEventStreamsToLoadHandler = (cmd: any) => {
			context: string,
			aggregate: string,
			aggregateId: string
		}[];
		...
		export function defineCommand(options: DefineCommandOptions, handler: commandHandler): DefineCommandResult;
		...
		export function defineEvent(options: DefineEventOptions, handler: eventHandler): void;
		
		//endregion
		
		//region defineBusinessRule
		
		export interface DefineBusinessRuleOptions {
			/**
			 * optional, default is file name without extension
			 */
			name?: string,
		...
		export function defineBusinessRule(options: DefineBusinessRuleOptions, handler: businessRuleHandler): void;
		...
		export interface DefineCommandHandlerOptions {
			/**
			 * optional, default is file name without extension
			 */
			name?: string,
		...
		export function defineCommandHandler(options: DefineCommandHandlerOptions, handler: commandHandlerHandler): void;
		...
		export interface IDomain {
			 ...
			 */
			defineCommand(definition: CommandDefinition): IDomain;
			 ...
			 * @returns {Domain}            to be able to chain...
			 */
			defineEvent(definition: EventDefinition): IDomain;
			 ...
			 *                            `function(err, evts, aggregateData, meta){}` evts is of type Array, aggregateData and meta are an object
			 */
			handle(cmd: any, cb: (err: Error) => void): void;
			 ...
			 *                            `function(err, evts, aggregateData, meta){}` evts is of type Array, aggregateData and meta are an object
			 */
			handle(cmd: any, cb: (err: Error, events: any[], aggregateData: any, metaInfos: HandleMetaInfos) => void): void;
			 ...
			 * @returns {Domain}      to be able to chain...
			 */
			onEvent(cb: (evt: any) => void): IDomain;
			 ...
			 * @returns {Domain}      to be able to chain...
			 */
			onEvent(cb: (evt: any, callback: () => void) => void): IDomain;
			 ...
			 * @returns {Domain}       to be able to chain...
			 */
			idGenerator(cb: (callback: generateIdCallback) => string): IDomain;
			 ...
			 * @returns {Domain}       to be able to chain...
			 */
			aggregateIdGenerator(cb: () => string): IDomain;
			 ...
			 * @returns {Domain}       to be able to chain...
			 */
			aggregateIdGenerator(cb: (callback: generateIdCallback) => string): IDomain;
	...
	function Domain(options: CreateDomainOptions): IDomain;
