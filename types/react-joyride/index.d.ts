...
// Project: https://github.com/gilbarbara/react-joyride, https://gilbarbara.github.com/react-joyride
...
export type Status = 'idle' | 'ready' | 'waiting' | 'running' | 'paused' | 'skipped' | 'finished' | 'error';
