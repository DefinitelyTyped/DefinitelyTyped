...
declare function Split(elements: Array<string | HTMLElement>, options?: Split.Options): Split.Instance;
...
declare namespace Split {
    ...
    interface Options {
        ...
        gutterStyle?(dimension: 'width' | 'height', gutterSize: number): CSSStyleDeclarationPartial;
    }
