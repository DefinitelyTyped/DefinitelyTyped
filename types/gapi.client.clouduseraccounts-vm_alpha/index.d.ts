...
declare namespace gapi.client {
    ...
    export function load (name: "clouduseraccounts", version: "vm_alpha") : PromiseLike<void>;    
    export function load (name: "clouduseraccounts", version: "vm_alpha", callback: () => any) : void;    
