...
class MockVoiceProcessor implements VoiceProcessor {
    start(engines: Bumblebee.VoiceEngine[], volume: number, downsamplerScript: string, errorCallback: (e: Error) => {}, audioProcessCallback: (data: any) => void, audioContextCallback: (analyzer: AnalyserNode, gainNode: GainNode) => void): void {
