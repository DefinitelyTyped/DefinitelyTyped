...
declare namespace ext {
    ...
    interface DagreLayoutOptions extends cytoscape.ShapedLayoutOptions {
        ...
        // Type of algorithm to assign a rank to each node in the input graph. Possible values: 'network-simplex', 'tight-tree' or 'longest-path', default: 'network-simplex'
        ...
        // higher weight edges are generally made shorter and straighter than lower weight edges, default: 1 for all edges
...
//     // declare module as Cytoscape extension
...
//         export interface DagreLayoutOptions extends cytoscape.ShapedLayoutOptions {
//             name: 'dagre';
