...
declare namespace gapi.client {
    ...
    export function load (name: "analytics", version: "v3") : PromiseLike<void>;    
    export function load (name: "analytics", version: "v3", callback: () => any) : void;    
    
    const data: gapi.client.analytics.DataResource; 
    
    const management: gapi.client.analytics.ManagementResource; 
    
    const metadata: gapi.client.analytics.MetadataResource; 
    
    const provisioning: gapi.client.analytics.ProvisioningResource; 
