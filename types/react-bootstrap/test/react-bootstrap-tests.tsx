    ...
    render() {
        ...
        return (
            <div style={style}>
                ...
                <div style={style}>
                    <PanelGroup accordion id="accordion-controlled-example" activeKey={0} onSelect={this.callback}>
                        <Panel eventKey="1">
                            <Panel.Heading>
                ...
                <div style={style}>
                    <div className="static-modal">
                        ...
                        >
                            ...
                            <Modal.Body bsClass="custom-class">One fine body...</Modal.Body>
                ...
                <div style={style}>
                    <ListGroup>
                        ...
                        <ListGroupItem onClick={this.callback}>Trigger an alert</ListGroupItem>
                    </ListGroup>
                </div>
                <div style={style}>
                    <ListGroup>
                ...
                <div style={style}>
                    <div>
                        <ResponsiveEmbed a16by9>Embedded Content</ResponsiveEmbed>
                        <ResponsiveEmbed a4by3>Embedded Content</ResponsiveEmbed>
                        <ResponsiveEmbed bsClass="embed-responsive">Embedded Content</ResponsiveEmbed>
                    </div>
                </div>
                <div style={style}>
                    <PageHeader>
                ...
                <div>
                    <ButtonToolbar>
                        <ToggleButtonGroup type="checkbox" defaultValue={[1, 3]} bsSize="small">
