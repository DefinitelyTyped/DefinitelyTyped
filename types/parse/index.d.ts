...
declare namespace Parse {
    ...
    class Query<T extends Object = Object> {
        ...
        containedBy<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, values: Array<T['attributes'][K]>): this;
        containedIn<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, values: Array<T['attributes'][K]>): this;
        ...
        equalTo<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, value: T['attributes'][K]): this;
        ...
        greaterThan<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, value: T['attributes'][K]): this;
        greaterThanOrEqualTo<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, value: T['attributes'][K]): this;
        include<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K | K[]): this;
        includeAll(): Query<T>;
        lessThan<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, value: T['attributes'][K]): this;
        lessThanOrEqualTo<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, value: T['attributes'][K]): this;
        ...
        notContainedIn<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, values: Array<T['attributes'][K]>): this;
        notEqualTo<K extends (Extract<keyof T['attributes'], string> | keyof BaseAttributes)>(key: K, value: T['attributes'][K]): this;
