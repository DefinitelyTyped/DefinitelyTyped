...
declare namespace Parse {
    ...
    class Query<T extends Object = Object> {
        ...
        containedBy<K extends (keyof T['attributes'] | keyof BaseAttributes)>(key: K, values: Array<T['attributes'][K]>): this;
        containedIn<K extends (keyof T['attributes'] | keyof BaseAttributes)>(key: K, values: Array<T['attributes'][K]>): this;
        ...
        doesNotMatchKeyInQuery<U extends Object, K extends keyof T['attributes'], X extends keyof U['attributes']>(key: K, queryKey: X, query: Query<U>): this;
        ...
        equalTo<K extends (keyof T['attributes'] | keyof BaseAttributes)>(key: K, value: T['attributes'][K]): this;
        ...
        matchesKeyInQuery<U extends Object, K extends keyof T['attributes'], X extends keyof U['attributes']>(key: K, queryKey: X, query: Query<U>): this;
