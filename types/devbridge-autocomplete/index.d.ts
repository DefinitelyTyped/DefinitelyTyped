...
interface JQuery {
     ...
     * DevdrigeAutocomplete will not override a existing autocomplete. If one
     * extists you can use the alias method devbridgeAutocomplete;
     */
...
declare namespace Devbridge {
    ...
    interface AutocompleteOptions {
        ...
        /**
         * function (suggestion, currentValue) {} custom function to format suggestion entry inside suggestions container, optional.
         */
        ...
        /**
         * Boolean value indicating if it shoud prevent future ajax requests for queries with the same root if no results were returned. E.g. if Jam returns no suggestions, it will not fire for any future query that starts with Jam. Default true.
         */
        preventBadQueries?: boolean,
        /**
         * function (container) {} called before displaying the suggestions. You may manipulate suggestions DOM before it is displayed.
         */
        ...
        /**
         * Default No results. Text or htmlString or Element or jQuery object for no matching results label.
         */
        noSuggestionNotice?: string | Element | JQuery,
        /**
         * Default: false. Suggestions are automatically positioned when their container is appended to body (look at appendTo option), in other cases suggestions are rendered but no positioning is applied. Set this option to force auto positioning in other cases.
         */
        forceFixPosition?: boolean,
        /**
         * Default bottom. Vertical orientation of the displayed suggestions, available values are auto, top, bottom. If set to auto, the suggestions will be orientated it the way that place them closer to middle of the view port.
         */
