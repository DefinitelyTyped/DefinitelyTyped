namespace angularStrapTests {
    ...
    namespace modalTests {
        ...
        angular.module('demoApp').config($modalConfig).controller('demoCtrl', demoCtrl);

        function demoCtrl($scope: IDemoCtrlScope, $modal: ngStrap.modal.IModalService): void {
    ...
    namespace asideTests {
        angular.module('demoApp').config($asideConfig).controller('demoCtrl', demoCtrl);

        function demoCtrl($scope: ngStrap.aside.IAsideScope, $aside: ngStrap.aside.IAsideService): void {
    ...
    namespace alertTests {
        angular.module('demoApp').config($alertConfig).controller('demoCtrl', demoCtrl);

        function demoCtrl($scope: ngStrap.alert.IAlertScope, $alert: ngStrap.alert.IAlertService): void {
    ...
    namespace tooltipTests {
        angular.module('demoApp').config($tooltipConfig).controller('demoDrct', demoDrct);
    ...
    namespace popoverTests {
        angular.module('demoApp').config($popoverConfig).controller('demoDrct', demoDrct);
