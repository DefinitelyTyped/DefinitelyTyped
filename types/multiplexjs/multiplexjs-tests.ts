...
namespace MxTests {
    ...
    namespace RuntimeTests {
        ...
        QUnit.test("hash", function(assert) {
            ...
            assert.ok(
                mx.hash(new SimpleClassWithComparer(10)) === mx.hash(new SimpleClassWithComparer(10)),
                "hash class instance overriding __hash__ method!",
            );
            assert.ok(
                mx.hash(10, 10.5, "string", new Date(2015, 0, 1)) === mx.hash(10, 10.5, "string", new Date(2015, 0, 1)),
                "combine hash codes!",
            );
        });
        ...
        QUnit.test("equals", function(assert) {
            ...
            assert.ok(
                mx.equals(new SimpleClass(), new SimpleClass(), EqualityComparer.create((obj) => 0, (a, b) => true)),
                "equals class instance using comparer!",
            );
            assert.ok(
                mx.equals(new SimpleClassWithComparer(10), new SimpleClassWithComparer(10)),
        ...
        QUnit.test("compare", function(assert) {
            assert.ok(
                mx.compare(1, null) === 1 && mx.compare(null, 1) === -1 && mx.compare(null, null) === 0,
                "compare null!",
            );
            assert.ok(mx.compare(1, 0) === 1 && mx.compare(0, 1) === -1 && mx.compare(1, 1) === 0, "compare numbers!");
            assert.ok(
                mx.compare("B", "A") === 1 && mx.compare("A", "B") === -1 && mx.compare("A", "A") === 0,
                "compare string!",
            );
            assert.ok(
                mx.compare(true, false) === 1 && mx.compare(false, true) === -1 && mx.compare(true, true) === 0,
                "compare bolean!",
            );
            assert.ok(
                mx.compare(new Date(2015, 0, 2), new Date(2015, 0, 1)) === 1
                    && mx.compare(new Date(2015, 0, 1), new Date(2015, 0, 2)) === -1
                    && mx.compare(new Date(2015, 0, 1), new Date(2015, 0, 1)) === 0,
                "compare date!",
            );
    ...
    namespace LinqTests {
        ...
        QUnit.test("contains", function(assert) {
            ...
            assert.ok(
                mx(_arr2).contains(new SimpleClass(), { hash: () => 0, equals: () => true }) === true,
            ...
            assert.ok(
                mx(_arr4).contains({ name: "n5", inner: { index: 5, val: {} } }) === true,
                "Object literal without equality-comparer!",
            );
            assert.ok(
                mx(_arr4).contains({ name: "n5", inner: null }, {
        ...
        QUnit.test("defaultIfEmpty", function(assert) {
            ...
            assert.ok(
                mx(_arr).where(t => t > 100).defaultIfEmpty(10).count() === 1,
        ...
        QUnit.test("except", function(assert) {
            ...
            assert.ok(
                mx(_arr3).except([{ name: "n5", inner: null }]).count() === 10,
                "Array of 10 distinct complex object literal without equality-comparer!",
            );
            assert.ok(
                mx(_arr3).except([{ name: "n5", inner: null }], {
                    hash: o => mx.hash(o.name),
                    equals: (a, b) => a.name === b.name,
                }).count() === 9,
                "Array of 10 distinct complex object literal with equality-comparer!",
        ...
        QUnit.test("intersect", function(assert) {
            ...
            assert.ok(
                mx(_arr3).intersect([{ name: "n5", inner: null }]).count() === 0,
                "Array of 10 distinct complex object literal without equality-comparer!",
            );
            assert.ok(
                mx(_arr3).intersect([{ name: "n5", inner: null }], {
                    hash: o => mx.hash(o.name),
                    equals: (a, b) => a.name === b.name,
                }).count() === 1,
                "Array of 10 distinct complex object literal with equality-comparer!",
        ...
        QUnit.test("join", function(assert) {
            ...
            assert.ok(
                _result.first().item1.name === "A" && _result.first().item2.code === "A",
                "join 2 complex-object array, getting item",
            );
            assert.ok(
                mx(_arr3).join(mx(CreateObjectLiteralArray()), t => t, u => u, (t, u) => t).count() === 100,
                "join 2 empty object-literal array",
            );
            assert.ok(
                mx(mx.empty()).join(mx(_arr3), t => t, u => u, (t, u) => t).count() === 0,
        ...
        QUnit.test("orderBy", function(assert) {
            ...
            assert.deepEqual(
                mx(_arr1).orderBy(t => t).take(5).toArray(),
                [0, 1, 2, 3, 4],
                "Order array of numbers ascending!",
            );
            assert.ok(
                mx(_arr2).orderBy(t => t.name).thenByDescending(t => t.inner.index).first().name === "n0",
        ...
        QUnit.test("orderByDescending", function(assert) {
            ...
            assert.deepEqual(
                mx(_arr1).orderByDescending(t => t).take(5).toArray(),
                [9, 8, 7, 6, 5],
                "Order array of numbers descending!",
            );
            assert.ok(
                mx(_arr2).orderByDescending(t => t.name).thenByDescending(t => t.inner.index).first().name === "n9",
                "Order array of complex object by 'name' descending then by 'inner.index' descending !",
            );
            assert.deepEqual(
                mx(_arr3).orderByDescending(t => t.val).thenBy(t => t.name).toArray(),
                _result,
                "Order descending and thenBy!",
            );
            assert.ok(
                mx(_arr2).orderByDescending(t => t.name, {
                    hash: o => mx.hash(o),
                    equals: (a, b) => a === b,
                }).first().name === "n9",
        ...
        QUnit.test("selectMany", function(assert) {
            ...
            assert.deepEqual(mx(_arr).selectMany(t => t.values, (t, u) => ({ name: t.name, value: u })).first(), {
                name: "A",
                value: 1,
        ...
        QUnit.test("skip", function(assert) {
            ...
            assert.deepEqual(
                mx(_arr).where(t => t % 2 === 0).skip(3).toArray(),
                [6, 8],
        ...
        QUnit.test("take", function(assert) {
            ...
            assert.deepEqual(
                mx(_arr).where(t => t % 2 === 0).take(3).toArray(),
                [0, 2, 4],
        ...
        QUnit.test("toDictionary", function(assert) {
            ...
            assert.ok(
                mx(_arr).toDictionary(t => t.name, t => t.inner.index).first().value === 0,
                "toDictionary key-selector & element-selector!",
            );
            assert.ok(
                mx(_arr).toDictionary(t => t, {
                    hash: o => mx.hash(o.name),
                    equals: (a, b) => a.name === b.name,
                }).first().key.name === "n0",
            ...
            assert.ok(
                mx(_arr).toDictionary(t => t, t => t.inner.index, {
                    hash: o => mx.hash(o.name),
                    equals: (a, b) => a.name === b.name,
                }).first().value === 0,
        ...
        QUnit.test("toLookup", function(assert) {
            ...
            assert.ok(
                mx(_arr2).toLookup(t => t, t => t.name, {
                    hash: (o) => mx.hash(o.name),
                    equals: (a, b) => a.name === b.name,
                }).first().first() === "n0",
    ...
    namespace CollectionTests {
        ...
        QUnit.test("collection enumerable", function(assert) {
            var _col = CreateCollection();
            assert.deepEqual(
                _col.select(t => t * 2).where(t => t > 5).toArray(),
                [6, 8, 10],
    ...
    namespace ListTests {
        ...
        QUnit.test("binarySearch", function(assert) {
            ...
            assert.ok(
                _list2.binarySearch({ index: 50 }, { compare: (a, b) => a.index - b.index }) === 50,
                "binary-search find an item with comparer!",
            );
            assert.ok(
                _list2.binarySearch({ index: 80 }, 50, 40, { compare: (a, b) => a.index - b.index }) === 80,
        ...
        QUnit.test("list enumerable", function(assert) {
            ...
            assert.deepEqual(
                _list.select(t => t * 2).where(t => t > 5).toArray(),
                [6, 8, 10],
    ...
    namespace SortedListTests {
        ...
        QUnit.test("comparer", function(assert) {
            ...
            assert.ok(
                _comparer.compare(5, 1) > 0 && _comparer.compare(1, 5) < 0 && _comparer.compare(1, 1) === 0,
        ...
        QUnit.test("remove", function(assert) {
            ...
            assert.ok(
                _list.remove(1) === true && _list.count() === 4 && _list.indexOfKey(1) < 0,
        ...
        QUnit.test("sorted-list enumerable", function(assert) {
            ...
            assert.deepEqual(
                _list.select(t => t.key * 2).where(t => t > 5).toArray(),
                [6, 8, 10],
                "select-where-toArray over a sorted-list!",
            );
            assert.deepEqual(
                _list.where(t => t.key > 2).select(t => t.value).toArray(),
                ["C", "D", "E"],
        ...
        QUnit.test("evaluate sorting", function(assert) {
            ...
            assert.deepEqual(
                _list2.keys().select(t => t.id).toArray(),
                [1, 2, 3, 4, 5],
    ...
    namespace HashSetTests {
        ...
        QUnit.test("constructor", function(assert) {
            ...
            assert.ok(
                new HashSet<number>(mx.EqualityComparer.defaultComparer).count() === 0,
        ...
        QUnit.test("comparer", function(assert) {
            ...
            assert.ok(
                _hash2.comparer().equals({ name: "A", value: 1 }, { name: "A", value: 2 }),
        ...
        QUnit.test("exceptWith", function(assert) {
            ...
            assert.ok(
                _hash2.count() === 1 && _hash2.contains({ name: "A", value: 0 }) === false,
        ...
        QUnit.test("intersectWith", function(assert) {
            ...
            assert.ok(
                _hash2.count() === 1 && _hash2.contains({ name: "A", value: 0 }) === true,
        ...
        QUnit.test("symmetricExceptWith", function(assert) {
            ...
            assert.ok(
                _hash2.contains({ name: "A", value: 0 }) === false && _hash2.contains({ name: "B", value: 0 }) === true,
        ...
        QUnit.test("unionWith", function(assert) {
            ...
            _hash2.unionWith([{ name: "A", value: 5 }, { name: "B", value: 6 }, { name: "C", value: 7 }, {
                name: "D",
                value: 8,
            }]);
            ...
            assert.ok(
                _hash2.contains({ name: "A", value: 0 }) === true && _hash2.contains({ name: "D", value: 0 }) === true,
        ...
        QUnit.test("set enumerable", function(assert) {
            ...
            assert.deepEqual(
                _hash1.select(t => t * 2).where(t => t > 5).toArray(),
                [6, 8, 10],
                "select-where-toArray over a HashSet of numbers!",
            );
            assert.deepEqual(
                _hash2.select(t => t.value * 2).where(t => t > 5).toArray(),
                [6],
        ...
        function CreateObjectHashSet(): HashSet<SimpleObject> {
            var _items: SimpleObject[] = [{ name: "A", value: 1 }, { name: "A", value: 2 }, { name: "B", value: 3 }, {
                    name: "B",
                    value: 4,
                }],
    ...
    namespace QueueTests {
        ...
        QUnit.test("queue enumerable", function(assert) {
            ...
            assert.deepEqual(
                _queue.select(t => t * 2).where(t => t > 5).toArray(),
                [6, 8, 10],
    ...
    namespace StackTests {
        ...
        QUnit.test("stack enumerable", function(assert) {
            ...
            assert.deepEqual(
                _stack.select(t => t * 2).where(t => t > 5).toArray(),
                [6, 8, 10],
