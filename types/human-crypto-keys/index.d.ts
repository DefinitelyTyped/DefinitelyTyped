// Type definitions for human-crypto-keys v0.1.4
...
interface Options {
   ...
   *
   * For more information please read the [Encryption Algorithms](https://github.com/ipfs-shipyard/js-crypto-key-composer/tree/initial-impl#encryption-algorithms) Section of [crypto-key-composer](https://github.com/ipfs-shipyard/js-crypto-key-composer) package
   */
