...
declare namespace sequelize {
    ...
    interface HooksDefineOptions<TInstance> {
        ...
        afterFind?: (instancesOrInstance: TInstance[] | TInstance, options: Object, fn?: Function) => any;
    }
    ...
    interface Instance<TAttributes> {
         ...
         */
        set<K extends keyof TAttributes>(key: K, value: TAttributes[K], options?: InstanceSetOptions): this;
        set(keys: Object, options?: InstanceSetOptions): this;
        setAttributes<K extends keyof TAttributes>(key: K, value: TAttributes[K], options?: InstanceSetOptions): this;
    ...
    type FindOptionsOrderArray = Array<
        string | number | Model<any, any> | { model: Model<any, any>; as?: string } | fn
    >;
    ...
    interface QueryInterface {
        ...
        describeTable(
            tableName: string | { schema?: string; tableName?: string },
            options?: string | { schema?: string; schemaDelimeter?: string; logging?: boolean | Function },
        ): Promise<Object>;
