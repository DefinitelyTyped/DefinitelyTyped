...
declare namespace gapi.client.tasks {
...
declare namespace gapi.client {
    // Load Tasks API v1
    export function load (name: "tasks", version: "v1") : PromiseLike<void>;    
    export function load (name: "tasks", version: "v1", callback: () => any) : void;    
    
    const tasklists: gapi.client.tasks.TasklistsResource; 
    
    const tasks: gapi.client.tasks.TasksResource; 
