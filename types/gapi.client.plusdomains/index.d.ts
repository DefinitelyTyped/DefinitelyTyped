// Type definitions for Google Google+ Domains API v1 1.0
...
declare namespace gapi.client.plusdomains {
...
declare namespace gapi.client {
    ...
    const activities: gapi.client.plusdomains.ActivitiesResource; 
    
    const audiences: gapi.client.plusdomains.AudiencesResource; 
    
    const circles: gapi.client.plusdomains.CirclesResource; 
    
    const comments: gapi.client.plusdomains.CommentsResource; 
    
    const media: gapi.client.plusdomains.MediaResource; 
    
    const people: gapi.client.plusdomains.PeopleResource; 
