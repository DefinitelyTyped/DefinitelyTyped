...
export namespace Radio {
    type RadioProps = Omit<ReactDOM.InputHTMLAttributes<HTMLInputElement>, 'value' | 'name' | 'role' | 'type' | 'aria-checked'> & {
        value: any;
    };
}
...
export namespace RadioGroup {
    type RadioGroupProps = Omit<ReactDOM.HTMLProps<any>, 'onChange'> & {
        selectedValue?: any;
        onChange?: (value: any) => void;
        Component?: React.ReactType<Omit<ReactDOM.HTMLProps<any>, 'onChange' | 'role'>>;
    };
}
