...
declare module 'boom' {
    class Boom<Data = any> extends Error {
         ...
         */
        static boomify(error: Error, options?: { statusCode?: number, message?: string, override?: boolean }): Boom<null>;

        /**
         * Identifies whether an error is a Boom object. Same as calling instanceof Boom.
         * @param error the error object to identify.
         */
        static isBoom(error: Error): boolean
         ...
         */
        static badRequest<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static unauthorized(message?: string, scheme?: string, attributes?: {[index: string]: string}): Boom<null>;
        static unauthorized(message?: string, scheme?: string[]): Boom<null>;
        static unauthorized(message?: null, scheme?: string, attributes?: {[index: string]: string} | string): Boom<null>;
        static unauthorized(message?: null, scheme?: string[]): Boom<null>;
         ...
         */
        static paymentRequired<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static forbidden<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static notFound<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static methodNotAllowed<Data = null>(message?: string, data?: Data, allow?: string | string[]): Boom<Data>;
         ...
         */
        static notAcceptable<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static proxyAuthRequired<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static clientTimeout<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static conflict<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static resourceGone<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static lengthRequired<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static preconditionFailed<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static entityTooLarge<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static uriTooLong<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static unsupportedMediaType<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static rangeNotSatisfiable<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static expectationFailed<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static teapot<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static badData<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static locked<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static preconditionRequired<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static tooManyRequests<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static illegal<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static badImplementation<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         * @see {@link https://github.com/hapijs/boom#boombadimplementationmessage-data---alias-internal}
         */
        static internal<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static notImplemented<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static badGateway<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static serverUnavailable<Data = null>(message?: string, data?: Data): Boom<Data>;
         ...
         */
        static gatewayTimeout<Data = null>(message?: string, data?: Data): Boom<Data>;
    }
