...
declare namespace gapi.client {
    ...
    const variants: gapi.client.genomics.VariantsResource; 
    
    const annotationsets: gapi.client.genomics.AnnotationsetsResource; 
    
    const references: gapi.client.genomics.ReferencesResource; 
    
    const datasets: gapi.client.genomics.DatasetsResource; 
    
    const variantsets: gapi.client.genomics.VariantsetsResource; 
    
    const annotations: gapi.client.genomics.AnnotationsResource; 
    
    const operations: gapi.client.genomics.OperationsResource; 
    
    const referencesets: gapi.client.genomics.ReferencesetsResource; 
    
    const callsets: gapi.client.genomics.CallsetsResource; 
    
    const reads: gapi.client.genomics.ReadsResource; 
    
    const readgroupsets: gapi.client.genomics.ReadgroupsetsResource; 
