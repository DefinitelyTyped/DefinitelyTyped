...
onetime((t1: boolean, t2: string, t3: number, t4: undefined, t5: string, t6: number) => 5)(
    true,
    '',
    5,
    undefined,
...
onetime((t1: boolean, t2: string, t3: number, t4: undefined, t5: string, t6: number, t7: boolean) => 5)(
    true,
    '',
    5,
    undefined,
...
const t9 = onetime(
    (t1: boolean, t2: string, t3: number, t4: undefined, t5: string, t6: number, t7: boolean, t8: string, t9: number) =>
        5
);
