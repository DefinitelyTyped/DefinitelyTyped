...
export interface SubscriptionPricingInstance
    extends SubscriptionPricingMethods, PricingInstance<SubscriptionPricingPromise>
{
    attach: (element: string | HTMLElement) => void;
}

export interface SubscriptionPricingPromise
    extends SubscriptionPricingInstance, PricingPromise<SubscriptionPricingState, SubscriptionPricingMethods>
{}
