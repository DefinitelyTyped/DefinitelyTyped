...
export interface SWStats {
    ...
    onResponseFinish: null | Function;
    authentication: boolean;
    onAuthenticate: null | Function;
...
export function getFastifyPlugin(fastify: FastifyInstance, opts: Partial<SWStats>, done: () => void): void;
...
export type HTTPMethod = HTTPMethodSubset | 'HEAD' | 'OPTIONS' | 'TRACE' | 'PATCH';
