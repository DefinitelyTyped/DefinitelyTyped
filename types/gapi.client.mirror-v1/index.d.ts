...
declare namespace gapi.client.mirror {
...
declare namespace gapi.client {
    ...
    export function load (name: "mirror", version: "v1") : PromiseLike<void>;    
    export function load (name: "mirror", version: "v1", callback: () => any) : void;    
    
    const accounts: gapi.client.mirror.AccountsResource; 
    
    const contacts: gapi.client.mirror.ContactsResource; 
    
    const locations: gapi.client.mirror.LocationsResource; 
    
    const settings: gapi.client.mirror.SettingsResource; 
    
    const subscriptions: gapi.client.mirror.SubscriptionsResource; 
    
    const timeline: gapi.client.mirror.TimelineResource; 
