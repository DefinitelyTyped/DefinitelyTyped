...
declare class TextBuffer {
    ...
    setAttrRegion(attr: ScreenBuffer.Attributes | number, region?: Rect.Region): void;
    ...
    iterate(
        ...
        callback: (cellData: { offset: number; x: number; y: number; text: string; attr: number; misc: any }) => void,
    ): void;
