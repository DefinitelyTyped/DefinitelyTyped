...
declare class ScreenBuffer extends NextGenEvents {
    ...
    fill(options?: { attr: ScreenBuffer.Attributes | number; char?: string }): void;

    clear(): void;

    put(options: ScreenBuffer.PutOptions, format: string, ...formatArgumets: any[]): void;

    get(options?: { x: number; y: number }): { char: string; attr: ScreenBuffer.Attributes };
