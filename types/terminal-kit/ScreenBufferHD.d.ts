...
declare class ScreenBufferHD extends ScreenBuffer {
    constructor(options: { blending: ScreenBufferHD.IsBlending } | ScreenBuffer.Options);

    readonly blending: ScreenBufferHD.IsBlending;

    static loadImage(url: string, calback: (error?: any, image?: ScreenBufferHD) => void): void;
    ...
    draw(options?: ScreenBuffer.DrawOptions | { blending: ScreenBufferHD.IsBlending }): void;
