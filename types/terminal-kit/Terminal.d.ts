...
declare namespace Terminal {
    interface Impl {
        ...
        eraseLine: Terminal;
        eraseArea: (x: number, y: number, width?: number, height?: number) => Terminal;
        ...
        getColor(register: number, callback?: Callback<{ r: number; g: number; b: number }>): void;
        setColor(register: number, r: number, g: number, b: number, names?: ReadonlyArray<string>): void;
        setColor(register: number, rgb: { r: number; g: number; b: number }, names?: ReadonlyArray<string>): void;
        getPalette(register: number, callback?: Callback<Palette>): void;
        setPalette(palette: string | Palette): void;

        wrapColumn(options?: { width: null | number; x: number; continue?: boolean; offset?: number }): void;
        ...
        singleLineMenu(menuItems: ReadonlyArray<string>, callback: Callback<SingleLineMenuResponse>): void;
        ...
        singleRowMenu(menuItems: ReadonlyArray<string>, callback: Callback<SingleLineMenuResponse>): void;
        ...
        singleColumnMenu(menuItems: ReadonlyArray<string>, callback: Callback<SingleColumnMenuResponse>): void;
        ...
        gridMenu(menuItems: ReadonlyArray<string>, callback: Callback<GridMenuResponse>): void;
        ...
        bar(value: number, options?: { innerSize?: number; barStyle?: CTerminal }): void;
    ...
    type Autocompletion =
        | ((inputString: string, callback: Callback<string | AutocompletionArray<string>>) => void)
    ...
    interface InputFieldOptions {
        ...
        tokenResetHook?: (term: Terminal, config?: HookConfig) => string | CTerminal;
        tokenRegExp?: RegExp;
    }
    ...
    interface ProgressBarController {
        update: (updateObject: number | { progress: number | null; items?: number; title?: string }) => void;
