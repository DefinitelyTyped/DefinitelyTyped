...
declare namespace fabric {
	...
	export function createCanvasForNode(width: number, height: number): fabric.Canvas;
	 ...
	 */
	export function createSVGRefElementsMarkup(canvas: fabric.StaticCanvas): string;
	/**
