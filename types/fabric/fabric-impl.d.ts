...
////////////////////////////////////////////////////////////
type IControlActionHandlerFunction = (eventData: Event, transform: Object, x: number, y: number) => Boolean;
type IControlReturnPropertyFunction = (eventData: Event, control: Control, fabricObject: Object) => String;
...
interface IControlOptions extends IObjectOptions {
    ...
    /**
     */
    positionHandler?: (dim: Object, finalMatrix: Number[], fabricObject: Object, currentControl: Control) => Point;
