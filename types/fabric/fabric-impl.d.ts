...
interface IControlsActions {
    scaleCursorStyleHandler: (eventData: Event, control: Control, fabricObject: Object) => String;
    skewCursorStyleHandler: (eventData: Event, control: Control, fabricObject: Object) => String;
    scaleSkewCursorStyleHandler: (eventData: Event, control: Control, fabricObject: Object) => String;
    rotationWithSnapping: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    scalingEqually: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    scalingX: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    scalingY: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    scalingYOrSkewingX: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    scalingXOrSkewingY: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    changeWidth: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    skewHandlerX: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    skewHandlerY: (eventData: Event, transform: Object, x: number, y: number) => Boolean;
    scaleOrSkewActionName: (eventData: Event, control: Control, fabricObject: Object) => String;
    rotationStyleHandler: (eventData: Event, control: Control, fabricObject: Object) => String;
    fireEvent: (eventName: String, options: Object) => void;
    wrapWithFixedAnchor: (actionHandler: Function) => Function;
    getLocalPoint: (transform: Object, originX: String, originY: String, x: number, y: number)=> Point;
}
