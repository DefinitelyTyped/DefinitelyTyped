...
//                 Jeffry Angtoni <https://github.com/jeffryang24>
...
declare namespace P {
    ...
    interface PrettyOptions {
        /**
         * If set to true, it will only convert the unix timestamp to ISO 8601 date format, and reserialize the JSON (equivalent to pino -t).
         */
         ...
         * @param log - JSON object log data.
         * @param options - Utility function options object.
         */
        formatter?(log: LogDescriptor, options: UtilityFunctionOption): string;
        /**
    ...
    interface UtilityFunctionOption {
        prefix: string;
        chalk: Chalk;
        withSpaces: (value: string, eol: string) => string;
        filter: (
            value: LogDescriptor,
            messageKey: string,
            eol: string,
            errorLikeObjectKeys: string[],
            excludeStandardKeys?: boolean
        ) => string;
        formatTime: (value: LogDescriptor, after?: string) => string;
        asColoredText: (value: LogDescriptor, text: string) => string;
        asColoredLevel: (value: LogDescriptor) => string;
    }
