...
export class Polygon {
     ...
     * @param returnNew If passed a truthy value, a new Polygon will be returned to you. Otherwise the operation will be applied to this and this will be returned.
     */
