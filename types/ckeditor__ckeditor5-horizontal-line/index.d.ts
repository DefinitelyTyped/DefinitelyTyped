// Type definitions for @ckeditor/ckeditor5-horizontal-line 27.1
...
declare const _default: {
    ...
    HorizontalLineEditing: typeof HorizontalLineEditing;
    HorizontalLineUI: typeof HorizontalLineUI;
};
