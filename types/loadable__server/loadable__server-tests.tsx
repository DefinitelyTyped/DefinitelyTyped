...
// getInlineStyleElements
{
    ...
    const elementsWithAttrs: Promise<Array<React.ReactElement<{}>>> = getInlineStyleElements(attributes);
    const elementsWithAttrFn: Promise<Array<React.ReactElement<{}>>> = getInlineStyleElements(attrFn);
}
