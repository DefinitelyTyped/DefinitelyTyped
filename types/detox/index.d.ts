// Type definitions for detox 14.5.0
...
declare module 'detox' {
  ...
  export const expect: Expect<Expect<any>>
  export const by: Matchers
  ...
  interface Actions<R> {
     ...
     */
    pinchWithAngle(direction: Direction, speed: Speed, angle: number)
  }
