...
export namespace Query {
     ...
     */
    export const MAX_RESULTS_COUNT: number;
    export const VALUE_QUERY_LIMIT: number;
    export const USE_PARENT_RELATION: boolean;
    export const USE_RELATION_DIRECTION: boolean;
    export const RETURN_LABELS: boolean;
    export const COLLECT_RELATIONS_WITH_VALUES: boolean;
    export const prefilter: string;
    export const prefilterParameters: { [key: string]: any };
    export const applyPrefilters: (queryStructure: QueryStructure) => typeof queryStructure;

    /**
     * Immutable constant object to identify Neo4j internal ID
     */
    export type NEO4J_INTERNAL_ID = Readonly<{queryInternalName: "NEO4JID"}>;
     ...
     * @returns {boolean}
     */
    export const filterRelation: (d: any) => boolean;
     ...
     */
    export const generateTaxonomyCountQuery:  (label: string) => string;

    export const generateNegativeQueryElements: () => Pick<QueryStructure, 'whereElements' | 'parameters'>;
     ...
     */
    export const generateQueryElements: (rootNode: Node, selectedNode: Node, links: Link[], isConstraintNeeded: boolean, useCustomConstraints: boolean) => QueryStructure;
     ...
     */
    export const generateNodeValueConstraints: (node: Node, useCustomConstraints: boolean) => Pick<QueryStructure, 'whereElements' | 'parameters'>;
     ...
     */
    export const getRelevantLinks: (rootNode: Node, targetNode: Node, initialLinks: Link[]) => Link[];
     ...
     * @param links
     */
    export const getLinksToRoot: (node: Node, links: Link[]) => Link[];
     ...
     */
    export const generateResultQuery: (isGraph: boolean) => QueryStructure;
     ...
     */
    export const generateNodeCountQuery: (countedNode: Node) => string;
     ...
     */
    export const generateNodeValueQuery: (targetNode: Node) => string;
     ...
     * @returns {string}
     */
    export const generateNodeRelationQuery: (targetNode: Node) => string;
}
