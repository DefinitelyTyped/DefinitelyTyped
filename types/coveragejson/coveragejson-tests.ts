...
const verticalProfileCoverage: CoverageJSON.Coverage = {
  ...
  domain: {
    ...
    axes: {
      ...
      z: {
        values: [
          5.4562, 8.9282, 14.8802, 20.832, 26.7836, 32.735, 38.6863, 44.6374,
          50.5883, 56.5391, 62.4897, 68.4401, 74.3903, 80.3404, 86.2902, 92.24,
          98.1895, 104.1389, 110.0881, 116.0371, 121.9859,
        ],
      },
  ...
  ranges: {
    PSAL: {
      ...
      axisNames: ["z"],
      values: [
        43.9599, 43.9599, 43.964, 43.964, 43.9679, 43.9879, 44.004, 44.012,
        44.012, 44.0159, 44.032, 44.032, 44.048, 44.0559, 44.0559, 44.0579,
        44.068, 44.074, 44.0779, 44.088, 44.094,
      ],
    },
    POTM: {
      type: "NdArray",
      ...
      axisNames: ["z"],
      values: [
        23.8, 23.7, 23.5, 23.4, 23.2, 22.4, 21.8, 21.7, 21.5, 21.3, 21.0, 20.6,
        20.1, 19.7, 19.4, 19.1, 18.9, 18.8, 18.7, 18.6, 18.5,
      ],
    },
  },
};
