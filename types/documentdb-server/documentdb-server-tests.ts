...
function bulkImport(docs: Array<Object>) {
    ...
    function tryCreate(
        doc: Object,
        callback: (err: IRequestCallbackError, doc: Object, options: IRequestCallbackOptions) => void,
    ): void {
...
function simple(prefix: string) {
    ...
    var isAccepted: boolean = collection.queryDocuments(collection.getSelfLink(), 'SELECT * FROM root r', function (
        err: IFeedCallbackError,
        feed: Array<any>,
        options: IFeedCallbackOptions,
    ) {
...
function bulkDeleteSproc(query: string) {
    ...
    function tryQueryAndDelete(continuation?: string) {
        ...
        var isAccepted: boolean = collection.queryDocuments(collectionLink, query, requestOptions, function (
            err: IFeedCallbackError,
    ...
    function tryDelete(documents: Array<IDocumentMeta>) {
        if (documents.length > 0) {
            ...
            var isAccepted: boolean = collection.deleteDocument(documents[0]._self, {}, function (
                err,
                responseOptions,
            ) {
                if (err) throw err;
...
function updateSproc(id: string, update: Object) {
    ...
    function tryUpdate(document: IDocumentMeta) {
        ...
        // Update the document.
        var isAccepted: boolean = collection.replaceDocument(document._self, document, requestOptions, function (
            err,
            updatedDocument,
            responseOptions,
        ) {
    ...
    function getAndUpdateMetadata() {
        ...
        var isAccepted: boolean = collection.queryDocuments(
            ...
            function (err: IFeedCallbackError, feed: Array<any>, options: IFeedCallbackOptions) {
                ...
                var isAccepted: boolean = collection.replaceDocument(metaDoc._self, metaDoc, function (
