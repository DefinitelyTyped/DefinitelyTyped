...
map.on('load', function() {
    ...
    var layers: [number, string][] = [[150, '#f28cb1'], [20, '#f1f075'], [0, '#51bbd6']];
...
var mapStyle = {
    ...
    sources: {
        ...
        overlay: {
            ...
            coordinates: [[-50, 40], [0, 40], [0, 0], [-50, 0]],
        },
    },
 ...
 * Marker
 */
let marker = new mapboxgl.Marker(undefined, { offset: [10, 0] }).setLngLat([-50, 50]).addTo(map);
