...
declare namespace google.maps {
   ...
   */
  export function importLibrary<K extends keyof ImportLibraryMap>(libraryName: K): Promise<ImportLibraryMap[K]>;
...
declare namespace google.maps.places {
  ...
  /**
   * Business status for the place. See the <a href="https://developers.google.com/maps/documentation/javascript/reference/places-service#BusinessStatus">web service documentation</a> for more information.
   *
  ...
  export enum BusinessStatus {
    /**
     * The establishment is permanently closed. See the <a href="https://developers.google.com/maps/documentation/javascript/reference/places-service#BusinessStatus">web service documentation</a> for more information.
     */
    CLOSED_PERMANENTLY = 'CLOSED_PERMANENTLY',
    /**
     * The establishment is temporarily closed. See the <a href="https://developers.google.com/maps/documentation/javascript/reference/places-service#BusinessStatus">web service documentation</a> for more information.
     */
    CLOSED_TEMPORARILY = 'CLOSED_TEMPORARILY',
    /**
     * The establishment will open in the future. See the <a href="https://developers.google.com/maps/documentation/javascript/reference/places-service#BusinessStatus">web service documentation</a> for more information.
     */
    FUTURE_OPENING = 'FUTURE_OPENING',
    /**
     * The establishment is operational, not necessarily open now. See the <a href="https://developers.google.com/maps/documentation/javascript/reference/places-service#BusinessStatus">web service documentation</a> for more information.
     */
  ...
  /**
   * Defines the spatial relationship between the target location and the area. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#containment">web service documentation</a> for more information.
   *
  ...
  export enum Containment {
    /**
     * The target location is outside the area region, but close by. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#containment">web service documentation</a> for more information.
     */
    NEAR = 'NEAR',
    /**
     * The target location is within the area region, close to the edge. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#containment">web service documentation</a> for more information.
     */
    OUTSKIRTS = 'OUTSKIRTS',
    /**
     * The target location is within the area region, close to the center. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#containment">web service documentation</a> for more information.
     */
    WITHIN = 'WITHIN',
  }
  ...
  /**
   * See <a href="http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=6872107">http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=6872107</a> for additional information/context on EV charging connector types. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
   *
  ...
  export enum EVConnectorType {
    /**
     * Combined Charging System (AC and DC). See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    ...
    /**
     * CHAdeMO type connector. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    CHADEMO = 'CHADEMO',
    /**
     * J1772 type 1 connector. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    J1772 = 'J1772',
    /**
     * The North American Charging System (NACS), standardized as SAE J3400. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    NACS = 'NACS',
    /**
     * Other connector types. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    OTHER = 'OTHER',
    /**
     * The generic TESLA connector. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    TESLA = 'TESLA',
    /**
     * IEC 62196 type 2 connector. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    TYPE_2 = 'TYPE_2',
    /**
     * GB/T type corresponds to the GB/T standard in China. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
    UNSPECIFIED_GB_T = 'UNSPECIFIED_GB_T',
    /**
     * Unspecified wall outlet. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#evconnectortype">web service documentation</a> for more information.
     */
  ...
  /**
   * Types of fuel. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
   *
  ...
  export enum FuelType {
    /**
     * Bio-diesel. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    BIO_DIESEL = 'BIO_DIESEL',
    /**
     * Diesel fuel. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    DIESEL = 'DIESEL',
    /**
     * Diesel plus fuel. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    DIESEL_PLUS = 'DIESEL_PLUS',
    /**
     * E 100. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    E100 = 'E100',
    /**
     * E 80. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    E80 = 'E80',
    /**
     * E 85. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    E85 = 'E85',
    /**
     * Liquefied Petroleum Gas. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    LPG = 'LPG',
    /**
     * Methane. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    METHANE = 'METHANE',
    /**
     * Midgrade. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    MIDGRADE = 'MIDGRADE',
    /**
     * Premium. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    PREMIUM = 'PREMIUM',
    /**
     * Regular unleaded. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    REGULAR_UNLEADED = 'REGULAR_UNLEADED',
    /**
     * SP 100. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP100 = 'SP100',
    /**
     * SP 91. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP91 = 'SP91',
    /**
     * SP 91 E10. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP91_E10 = 'SP91_E10',
    /**
     * SP 92. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP92 = 'SP92',
    /**
     * SP 95. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP95 = 'SP95',
    /**
     * SP95 E10. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP95_E10 = 'SP95_E10',
    /**
     * SP 98. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP98 = 'SP98',
    /**
     * SP 99. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
    SP99 = 'SP99',
    /**
     * Truck diesel. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#fueltype">web service documentation</a> for more information.
     */
  ...
  /**
   * Price level of the place. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#pricelevel">web service documentation</a> for more information.
   *
  ...
  export enum PriceLevel {
    /**
     * Place provides expensive services. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#pricelevel">web service documentation</a> for more information.
     */
    EXPENSIVE = 'EXPENSIVE',
    /**
     * Place provides free services. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#pricelevel">web service documentation</a> for more information.
     */
    FREE = 'FREE',
    /**
     * Place provides inexpensive services. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#pricelevel">web service documentation</a> for more information.
     */
    INEXPENSIVE = 'INEXPENSIVE',
    /**
     * Place provides moderately priced services. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#pricelevel">web service documentation</a> for more information.
     */
    MODERATE = 'MODERATE',
    /**
     * Place provides very expensive services. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#pricelevel">web service documentation</a> for more information.
     */
  ...
  /**
   * How results will be ranked in the response. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#rankpreference_1">web service documentation</a> for more information.
   *
  ...
  export enum SearchByTextRankPreference {
    /**
     * Ranks results by distance. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#rankpreference_1">web service documentation</a> for more information.
     */
    DISTANCE = 'DISTANCE',
    /**
     * Ranks results by relevance. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#rankpreference_1">web service documentation</a> for more information.
     */
    RELEVANCE = 'RELEVANCE',
  }
  ...
  /**
   * How results will be ranked in the response. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#rankpreference">web service documentation</a> for more information.
   *
  ...
  export enum SearchNearbyRankPreference {
    /**
     * Ranks results by distance. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#rankpreference">web service documentation</a> for more information.
     */
    DISTANCE = 'DISTANCE',
    /**
     * Ranks results by popularity. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#rankpreference">web service documentation</a> for more information.
     */
  ...
  /**
   * Defines the spatial relationship between the target location and the landmark. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
   *
  ...
  export enum SpatialRelationship {
    /**
     * The target is directly opposite the landmark on the other side of the road. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
     */
    ACROSS_THE_ROAD = 'ACROSS_THE_ROAD',
    /**
     * Not on the same route as the landmark but a single turn away. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
     */
    AROUND_THE_CORNER = 'AROUND_THE_CORNER',
    /**
     * Close to the landmark&#39;s structure but further away from its street entrances. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
     */
    BEHIND = 'BEHIND',
    /**
     * The target is directly adjacent to the landmark. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
     */
    BESIDE = 'BESIDE',
    /**
     * On the same route as the landmark but not besides or across. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
     */
    DOWN_THE_ROAD = 'DOWN_THE_ROAD',
    /**
     * This is the default relationship when nothing more specific below applies. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
     */
    NEAR = 'NEAR',
    /**
     * The landmark has a spatial geometry and the target is within its bounds. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#spatialrelationship">web service documentation</a> for more information.
     */
    WITHIN = 'WITHIN',
  }
  ...
  /**
   * The type of vehicle for a transit line. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
   *
  ...
  export enum TransitVehicleType {
    /**
     * Airplane. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    AIRPLANE = 'AIRPLANE',
    /**
     * Bus. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    BUS = 'BUS',
    /**
     * Cable car. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    CABLE_CAR = 'CABLE_CAR',
    /**
     * Coach. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    COACH = 'COACH',
    /**
     * Commuter train. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    COMMUTER_TRAIN = 'COMMUTER_TRAIN',
    /**
     * Ferry. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    FERRY = 'FERRY',
    /**
     * Funicular. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    FUNICULAR = 'FUNICULAR',
    /**
     * Gondola lift. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    GONDOLA_LIFT = 'GONDOLA_LIFT',
    /**
     * Heavy rail. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    HEAVY_RAIL = 'HEAVY_RAIL',
    /**
     * High speed train. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    HIGH_SPEED_TRAIN = 'HIGH_SPEED_TRAIN',
    /**
     * Horse carriage. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    HORSE_CARRIAGE = 'HORSE_CARRIAGE',
    /**
     * Intercity bus. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    INTERCITY_BUS = 'INTERCITY_BUS',
    /**
     * Long distance train. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    LONG_DISTANCE_TRAIN = 'LONG_DISTANCE_TRAIN',
    /**
     * Metro rail. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    METRO_RAIL = 'METRO_RAIL',
    /**
     * Monorail. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    MONORAIL = 'MONORAIL',
    /**
     * Rail. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    RAIL = 'RAIL',
    /**
     * Share taxi. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    SHARE_TAXI = 'SHARE_TAXI',
    /**
     * Special. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    SPECIAL = 'SPECIAL',
    /**
     * Subway. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    SUBWAY = 'SUBWAY',
    /**
     * Tram. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    TRAM = 'TRAM',
    /**
     * Trolleybus. See the <a href="https://developers.google.com/maps/documentation/places/web-service/reference/rpc/google.maps.places.v1#vehicletype">web service documentation</a> for more information.
     */
    TROLLEYBUS = 'TROLLEYBUS',
  }
...
declare namespace google.maps {
  export interface HTMLElementOptionsTagNameMap {
    ...
    "gmp-marker-3d": google.maps.maps3d.Marker3DElementOptions;
    "gmp-marker-3d-interactive": google.maps.maps3d.Marker3DInteractiveElementOptions;
    "gmp-marker-interactive": google.maps.maps3d.MarkerInteractiveElementOptions;
    "gmp-model-3d": google.maps.maps3d.Model3DElementOptions;
    "gmp-model-3d-interactive": google.maps.maps3d.Model3DInteractiveElementOptions;
    "gmp-place-accessible-entrance-icon": google.maps.places.PlaceAccessibleEntranceIconElementOptions;
    "gmp-place-address": google.maps.places.PlaceAddressElementOptions;
    ...
    "gmp-place-details": google.maps.places.PlaceDetailsElementOptions;
    "gmp-place-details-compact": google.maps.places.PlaceDetailsCompactElementOptions;
    ...
    "gmp-place-phone-number": google.maps.places.PlacePhoneNumberElementOptions;
    "gmp-place-plus-code": google.maps.places.PlacePlusCodeElementOptions;
    "gmp-place-price": google.maps.places.PlacePriceElementOptions;
    "gmp-place-rating": google.maps.places.PlaceRatingElementOptions;
    "gmp-place-review-summary": google.maps.places.PlaceReviewSummaryElementOptions;
    "gmp-place-reviews": google.maps.places.PlaceReviewsElementOptions;
    "gmp-place-search": google.maps.places.PlaceSearchElementOptions;
    "gmp-place-standard-content": google.maps.places.PlaceStandardContentElementOptions;
    "gmp-place-summary": google.maps.places.PlaceSummaryElementOptions;
    "gmp-place-text-search-request": google.maps.places.PlaceTextSearchRequestElementOptions;
    "gmp-place-type": google.maps.places.PlaceTypeElementOptions;
    "gmp-place-type-specific-highlights": google.maps.places.PlaceTypeSpecificHighlightsElementOptions;
    "gmp-place-website": google.maps.places.PlaceWebsiteElementOptions;
    "gmp-polygon-3d": google.maps.maps3d.Polygon3DElementOptions;
    "gmp-polygon-3d-interactive": google.maps.maps3d.Polygon3DInteractiveElementOptions;
    "gmp-polyline-3d": google.maps.maps3d.Polyline3DElementOptions;
    "gmp-polyline-3d-interactive": google.maps.maps3d.Polyline3DInteractiveElementOptions;
    "gmp-popover": google.maps.maps3d.PopoverElementOptions;
    "gmp-route-3d": google.maps.routes.Route3DElementOptions;
  }
}
declare namespace google.maps {
