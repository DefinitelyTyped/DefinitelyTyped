...
declare class Nightmare {
    ...
    evaluate<T1, T2, T3, R>(fn: (arg1: T1, arg2: T2, arg3: T3, done?: (err: Error | undefined, value: R) => void) => R, arg1: T1, arg2: T2, arg3: T3): Nightmare;
    evaluate<T1, T2, R>(fn: (arg1: T1, arg2: T2, done?: (err: Error | undefined, value: R) => void) => R, arg1: T1, arg2: T2): Nightmare;
    evaluate<T, R>(fn: (arg: T, done?: (err: Error | undefined, value: R) => void) => R, arg: T): Nightmare;
    evaluate<R>(fn: (done?: (err: Error | undefined, value: R) => void) => R): Nightmare;

    wait(ms: number): Nightmare;
    wait(selector: string): Nightmare;
    wait<T1, T2, T3, R>(fn: (arg1: T1, arg2: T2, arg3: T3, done?: (err: Error | undefined, value: R) => void) => R, arg1: T1, arg2: T2, arg3: T3): Nightmare;
    wait<T1, T2, R>(fn: (arg1: T1, arg2: T2, done?: (err: Error | undefined, value: R) => void) => R, arg1: T1, arg2: T2): Nightmare;
    wait<T, R>(fn: (arg: T, done?: (err: Error | undefined, value: R) => void) => R, arg: T): Nightmare;
    wait<R>(fn: (done?: (err: Error | undefined, value: R) => void) => R): Nightmare;
