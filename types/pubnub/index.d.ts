...
declare class Pubnub {
    ...
    grant(params: Pubnub.GrantParameters, callback: (status: Pubnub.GrantStatus, response: {}) => void): void;
...
declare namespace Pubnub {
    ...
    interface ChannelGroups {
        addChannels(params: AddChannelParameters, callback: (status: ChannelGroupStatus) => void): void;

        addChannels(params: AddChannelParameters): Promise<{}>;

        removeChannels(params: RemoveChannelParameters, callback: (status: ChannelGroupStatus) => void): void;
        ...
        listGroups(callback: (status: ChannelGroupStatus, response: ListAllGroupsResponse) => void): void;

        listGroups(): Promise<ListAllGroupsResponse>;

        deleteGroup(params: DeleteGroupParameters, callback: (status: ChannelGroupStatus) => void): void;
