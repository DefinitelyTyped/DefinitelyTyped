...
export interface WebTwainAcquire extends WebTwainEdit {
   ...
   */
  getCapabilities(
    succssCallback: (capabilityDetails: ICapabilityDetails[]) => void,
    failureCallback: (
      errorCode: number,
      errorString: string
    ) => void
  ...
  setCapabilities(
    ...
    succssCallback: (capabilities: ICapabilities) => void,
 ...
 */
export interface ICapabilityDetails {
  /**
   * The Capability.
   */
...
export interface ICapabilitySetup {
  /**
