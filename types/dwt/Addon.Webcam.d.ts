...
export interface IVideoControlProperty {
  /**
...
export interface IVideoControlPropertyExtra {
  /**
...
export interface ICameraControlProperty {
  /**
   * Return the value of the property.
   */
  GetValue(): number;
...
export interface ICameraControlPropertyExtra {
  /**
   * Return the minimum value of the property.
   */
  GetMinValue(): number;
