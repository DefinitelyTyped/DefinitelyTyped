...
declare var Desmos: {
    ...
    */
    ...
    /**
    The AxisArrowMode specifies whether arrows should be drawn at one or both ends of the x or y axes. It is specified separately for the x and y axes through the xAxisArrowMode and yAxisArrowMode graph settings.
...
export interface Calculator {
    ...
    */
    asyncScreenshot(
        opts: Parameters<GraphingCalculator["screenshot"]>[0] & {
            /**
        ...
        */
            format?: "png" | "svg";
            /**
         Determines the strategy for computing the viewport visible in the screenshot. See the table below for available modes and their descriptions.
         @default "contain"
         */
    ...
    */
    resize(): void;
    /**
    Returns an image of the current graphpaper in the form of a PNG data URI. You can use the returned data URI directly in the src attribute of an image. To save the data as a traditional image file, you can parse the data and base64 decode it.
    */
    screenshot(opts?: {
        /**
    ...
    */
    ...
    /**
    Updates any of the properties allowed in the constructor. Only properties that are present will be changed--other settings will retain their previous value.
