// Type definitions for Google Google Cloud Deployment Manager Alpha API alpha
...
declare namespace gapi.client {
    ...
    export function load (name: "deploymentmanager", version: "alpha") : PromiseLike<void>;    
    export function load (name: "deploymentmanager", version: "alpha", callback: () => any) : void;    
