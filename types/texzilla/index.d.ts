...
declare namespace TeXZilla {
     ...
     */
    function setDOMParser(parser: DOMParser): void;
     ...
     */
    function setXMLSerializer(serializer: XMLSerializer): void;
     ...
     */
    function setItexIdentifierMode(enabled: boolean): void;
     ...
     */
    function getTeXSource(el: string | Element): string | null;
     ...
     */
    function toMathMLString(str: string, displayMode?: boolean, rightToLeft?: boolean, throwOnError?: boolean): string;
     ...
     * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
     */
    function toMathML(str: string, displayMode?: boolean, rightToLeft?: boolean, throwOnError?: boolean): Element;
     ...
     */
    function toImage(str: string, rightToLeft?: boolean, roundToPowerOfTwo?: boolean, size?: number, document?: Document): HTMLImageElement;
     ...
     * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
     */
    function filterString(str: string, throwOnError?: boolean): string;
     ...
     * @param throwOnError - indicates whether TeXZilla should throw an exception when parsing fails
     */
    function filterElement(el: Element, throwOnError?: boolean): void;
}
