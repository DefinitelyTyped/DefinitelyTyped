...
export function swapon(path: string, swapFlags: SwapFlags): void;
export function swapoff(path: string): void;
export function initgroups(user: string, group: number | string): void;
