...
export class SectionListTestNullListHeaderFooterStyle extends React.Component<SectionListProps<string>, {}> {
    myList: React.RefObject<SectionList<string>>;
...
export class SectionListTestUndefinedListHeaderFooterStyle extends React.Component<SectionListProps<string>, {}> {
    myList: React.RefObject<SectionList<string>>;
