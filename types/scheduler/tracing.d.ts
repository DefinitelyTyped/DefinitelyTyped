...
type TypeByBuildFlag<Flag extends boolean | undefined, WhenTrue, WhenFalse> = Flag extends undefined
    ? WhenTrue | WhenFalse
    : Flag extends true
    ? WhenTrue
    : WhenFalse;
...
export function unstable_trace<T>(name: string, timestamp: number, callback: () => T, threadID?: number): T;
