    ...
    render() {
        ...
        return (
            <div>
                ...
                <a data-tip="custom show and hide" data-event="click" data-event-off="dblclick">
                    ( •̀д•́)
                </a>
                <ReactTooltip />
                ...
                <a data-for="overTime" data-tip="3/14/1592">
                    =( •̀д•́)
                </a>
                <ReactTooltip
                    id="overTime"
                    wrapper="span"
                    getContent={[(dateString) => new Date(dateString).toISOString(), 1000]}
                />
                ...
                <a data-tip={this.msgString} data-for="SanitizeHTMLOptions">
                    {' '}
