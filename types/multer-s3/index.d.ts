...
// Definitions by: KIM Jaesuck a.k.a. gim tcaesvk <https://github.com/tcaesvk>, Gal Talmor <http://github.com/galtalmor>
...
interface Options {
    ...
    metadata?(req: Express.Request, file: Express.Multer.File, callback: (error: any, metadata?: object) => void): void;
