...
const circles: Selection<SVGCircleElement, CircleDatum, SVGSVGElement, any> = select<SVGSVGElement, any>(
    'svg',
...
let filterFn: (
    ...
    datum: CircleDatum,
    index: number,
    group: SVGCircleElement[] | NodeListOf<SVGCircleElement>,
) => boolean;
