...
declare namespace AMap {
    ...
    class Map extends EventBindable {
        ...
        getCity(
            callback: (result: { provice: string; city: string; citycode: string; district: string }) => void,
        ): void;
    ...
    class Icon {
        constructor(options?: { size?: Size; imageOffset?: Pixel; image?: string; imageSize?: Size });
    ...
    class MapType implements MapControl {
        constructor(options?: { defaultType?: number; showTraffic?: boolean; showRoad?: boolean });
    ...
    class OverView extends EventBindable implements MapControl {
        constructor(options?: { tileLayer?: TileLayer[]; isOpen?: boolean; visible?: boolean });
    ...
    class Geocoder {
        constructor(opts?: { city?: string; radius?: number; batch?: boolean; extensions?: string });
    ...
    class Autocomplete {
        constructor(opts: { type?: string; city?: string; datatype?: string; citylimit?: boolean; input?: string });
