...
interface FileUploaderButtonInheritedProps extends Omit<ReactLabelAttr, 'onChange'>, SharedProps {
...
interface FileUploaderInheritedProps extends Omit<ReactLabelAttr, 'onChange'>, EmbeddedIconProps, SharedProps {
    onChange?(event: React.ChangeEvent<HTMLInputElement>): void;
}
