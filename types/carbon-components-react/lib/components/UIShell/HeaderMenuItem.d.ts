...
export type HeaderMenuItemProps<E extends object = ReactAnchorAttr> = Omit<LinkProps<E>, ExcludedAttributes> &
    HeaderMenuItemPropsBase;

declare function HeaderMenuItem<E extends object = ReactAnchorAttr>(
    props: React.PropsWithChildren<HeaderMenuItemProps<E>>,
