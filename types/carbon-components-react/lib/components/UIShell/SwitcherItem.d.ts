...
export type SwitcherItemProps<E extends object = ReactAnchorAttr> = Omit<LinkProps<E>, 'tabIndex'> &
    SwitcherItemPropsBase;

declare function SwitcherItem<E extends object = ReactAnchorAttr>(
    props: React.PropsWithChildren<SwitcherItemProps<E>>,
