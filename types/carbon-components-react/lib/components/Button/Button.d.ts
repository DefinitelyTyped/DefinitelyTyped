...
export type ButtonIntrinsicProps<K extends keyof React.JSX.IntrinsicElements> = ButtonBaseProps &
...
declare function Button<T extends keyof React.JSX.IntrinsicElements, R extends HTMLElement = HTMLElement>(props: ForwardRefProps<R, ButtonIntrinsicProps<T> & ButtonKindProps>): FCReturn;
