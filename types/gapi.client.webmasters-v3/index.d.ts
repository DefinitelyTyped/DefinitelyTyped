...
declare namespace gapi.client.webmasters {
...
declare namespace gapi.client {
    ...
    export function load (name: "webmasters", version: "v3") : PromiseLike<void>;    
    export function load (name: "webmasters", version: "v3", callback: () => any) : void;    
    
    const searchanalytics: gapi.client.webmasters.SearchanalyticsResource; 
    
    const sitemaps: gapi.client.webmasters.SitemapsResource; 
    
    const sites: gapi.client.webmasters.SitesResource; 
    
    const urlcrawlerrorscounts: gapi.client.webmasters.UrlcrawlerrorscountsResource; 
    
    const urlcrawlerrorssamples: gapi.client.webmasters.UrlcrawlerrorssamplesResource; 
