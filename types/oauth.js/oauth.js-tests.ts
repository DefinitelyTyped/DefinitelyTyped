...
var formEncoded1: string = OAuth.formEncode([
    ['name1', 'value1'],
    ['name2', 'value2'],
]);
...
var authorizationHeader1: string = OAuth.getAuthorizationHeader('realm', [
    ['name1', 'value1'],
...
var normalizedParameters1: string = OAuth.SignatureMethod.normalizeParameters([
    ['name1', 'value1'],
    ['name2', 'value2'],
]);
