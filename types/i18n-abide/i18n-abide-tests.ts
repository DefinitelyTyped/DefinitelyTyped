...
i18n.abide(); // $ExpectType RequestHandler<ParamsDictionary, any, any, ParsedQs, number, Record<string, any>>
i18n.abide(emptyAbideOptions); // $ExpectType RequestHandler<ParamsDictionary, any, any, ParsedQs, number, Record<string, any>>
i18n.abide(fullAbideOptions); // $ExpectType RequestHandler<ParamsDictionary, any, any, ParsedQs, number, Record<string, any>>
