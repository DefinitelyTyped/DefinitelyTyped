...
i18n.abide(); // $ExpectType RequestHandler<ParamsDictionary, any, any, Query>
i18n.abide(emptyAbideOptions); // $ExpectType RequestHandler<ParamsDictionary, any, any, Query>
i18n.abide(fullAbideOptions); // $ExpectType RequestHandler<ParamsDictionary, any, any, Query>
