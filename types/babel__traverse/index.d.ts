...
type PathParentConditionalNull<T extends Node | null> = Extract<T, NullParentNode | null> extends never ? never : null;

type AsPathParentType<T extends Node | null> = Exclude<T, NullParentNode | null> extends never
    ? never
    : NodePath<Exclude<T, NullParentNode | null>>;
