...
ChartMogul.DataSource.all(config).then(data => {
    ...
    data.data_sources[0].invoice_handling_setting!.manual!.prevent_subscription_for_invoice_refunded; // $ExpectType boolean
    data.data_sources[0].invoice_handling_setting!.manual!.prevent_subscription_for_invoice_written_off; // $ExpectType boolean
    data.data_sources[0].invoice_handling_setting!.automatic!.create_subscription_when_invoice_is; // $ExpectType InvoiceHandlingTrigger
    data.data_sources[0].invoice_handling_setting!.automatic!.update_subscription_when_invoice_is; // $ExpectType InvoiceHandlingTrigger
    data.data_sources[0].invoice_handling_setting!.automatic!.prevent_subscription_for_invoice_voided; // $ExpectType boolean
    data.data_sources[0].invoice_handling_setting!.automatic!.prevent_subscription_for_invoice_refunded; // $ExpectType boolean
    data.data_sources[0].invoice_handling_setting!.automatic!.prevent_subscription_for_invoice_written_off; // $ExpectType boolean
});
