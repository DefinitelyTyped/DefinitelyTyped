...
export type ModelWithFields<
    ...
    Additional = {},
    VirtualFields = {}
> = Model<Fields, Additional, VirtualFields> &
    Fields &
    VirtualFields &
    Additional &
    ORMId;
...
export class Model<Fields, Additional = {}, VirtualFields = {}> {
    ...
    static upsert<Fields>(
        props: Partial<Fields>
    ): ModelWithFields<Fields, any, any>;
    ...
    static exists(lookupObj: object): boolean;
...
export class QuerySet<Fields, Additional = {}, VirtualFields = {}> {
    ...
    at(
        index: string
    ): ModelWithFields<Fields, Additional, VirtualFields> | undefined;
    ...
    orderBy(
        iteratees: any,
        orders: any
    ): QuerySet<Fields, Additional, VirtualFields>; // TODO
    ...
    ): QuerySet<Fields, Additional, VirtualFields>;
}
...
export type ORMSelector<State extends ORMCommonState, Result = any> = (
    session: SessionWithModels<State>,
    ...args: any[]
) => Result;

export function createSelector<State extends ORMCommonState = ORMCommonState>(
    orm: ORM<State>,
