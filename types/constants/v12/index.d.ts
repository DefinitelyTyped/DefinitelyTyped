...
export const SIGUNUSED: number;
export const defaultCoreCipherList: string;
export const defaultCipherList: string;
export const ENGINE_METHOD_RSA: number;
export const ALPN_ENABLED: number;
