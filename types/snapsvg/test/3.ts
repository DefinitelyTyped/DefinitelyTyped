...
window.onload = () => {
...

    {
        ...
        var r = s
            .rect(200, 100, 100, 100, 20, 20)
            .attr({ stroke: '#123456', strokeWidth: 20, fill: 'red', opacity: 0.3 });
...

    {
        ...
        var myFrames = [
            {
                animation: { transform: 'r360,150,150' },
                dur: 1000,
            },
        ...
        function nextFrame(el: Snap.Element, frameArray: any[], whichFrame: number) {
            ...
            el.animate(frameArray[whichFrame].animation, frameArray[whichFrame].dur, <any>(
    ...
    }
    {
        ...
        for (var index = 0; index < len; index++) {
            (function() {
                var svgTextElement = s
                    .text(350, 100, textArray[index])
                    .attr({ fontSize: '120px', opacity: 0, 'text-anchor': 'middle' });
