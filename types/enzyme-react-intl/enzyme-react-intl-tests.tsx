...
function mountWithIntlTests() {
    ...
    const propsComponentWrapper = intl.mountWithIntl<Props>(<PropsComponent id={4} />);

    propsComponentWrapper.props().id; // $ExpectType number

    const stateComponentWrapper = intl.mountWithIntl<{}, State>(<StateComponent />);
...
function renderWithIntlTests() {
    ...
    const wrapper = intl.renderWithIntl<Props, State>(<StatePropsComponent id={1} />);
...
function shallowWithIntlTests() {
    ...
    const propsComponentWrapper = intl.shallowWithIntl<Props>(<PropsComponent id={4} />);

    propsComponentWrapper.props().id; // $ExpectType number

    const stateComponentWrapper = intl.shallowWithIntl<{}, State>(<StateComponent />);
