...
export interface InitOptions {
     ...
     * Note 1: The country part is optional, and if a country is either not recognized or supported, it will fallback to using the generic language. If the language isn't supported, it will fallback
     * to en-US.
    ...
    /**
     * Array of integration IDs. When set, only integrations from this list will be displayed. If an empty array is used, no integrations will be displayed. Note: Listing an integration in the array
     * doesn't guarantee that it will be displayed in the Web Messenger.
     */
...
export interface PrechatCapture {
    /**
...
export interface PrechatCaptureField {
...
export interface PrechatCaptureFieldOptions {
    name: string;
    label: string;
}
