...
// Project: https://github.com/olifolkerd/tabulator
...
declare namespace Tabulator {
    ...
    type OptionsPersistentConfiguration = {
    ...
    This option takes an array of value arrays, each item in the first array should be a list of acceptable field values for groups at that level	 */
        ...
        groupHeader?: ((value: any, count: number, data: any, group: GroupComponent) => string) | ((value: any, count: number, data: any) => string)[];
    ...
    type FilterFunction = (field: string, type: Tabulator.FilterType, value: any) => void;
    ...
    type OptionsFiltering = {
        ...
        initialHeaderFilter?: Pick<Filter, "field" | "value">[];
...
You can pass an optional additional property with sorter, sorterParams that should contain an object with additional information for configuring the sorter*/
    ...
    You can set accessors on a per column basis using the accessor option in the column definition object.*/
        ...
        /**sets the on hover tooltip for the column header
     * 
     ...
     */
        ...
        /**change the orientation of the column header to vertical
     * 
    ...
    type ColumnCalc = "avg" | "max" | "min" | "sum" | "concat" | "count" | ((values: Array<any>, data: Array<any>, calcParams: {}) => number);
    ...
    type SelectLabelValue = { label: string; value: string | number | boolean };
...
declare class Tabulator {
  ...
  It takes the same arguments as the setData function, and behaves in the same way when loading data (ie, it can make ajax requests, parse JSON etc) */
    replaceData: (data?: {}[] | string, params?: any, config?: any) => Promise<void>;
    ...
    addData: (data?: {}[], addToTop?: boolean, positionTarget?: Tabulator.RowLookup) => Promise<Tabulator.RowComponent>;
    ...
    updateOrAddData: (data: {}[]) => Promise<Tabulator.RowComponent[]>;
  ...
  */
    ...
    /**You can use the setGroupHeader function to change the header generation function for each group. This function has one argument and takes the same values as passed to the groupHeader setup option. */
    setGroupHeader: (values: ((value: any, count: number, data: any, group: Tabulator.GroupComponent) => string) | ((value: any, count: number, data: any) => string)[]) => void;
