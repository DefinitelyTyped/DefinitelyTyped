...
import { GensyncFunction, GensyncGenerator } from '.';
 ...
 */
declare function gensync<A extends unknown[], R>(opts: {
    /**
 ...
 * @param opts Options for an existing sync/async function.
 */
declare function gensync<A extends unknown[], R, E = unknown>(opts: {
    /**
     * A string name to apply to the returned function. If no value is provided,
     * the name of `errback`/`async`/`sync` functions will be used, with any
     * `Sync` or `Async` suffix stripped off. If the callback is simply named
...
declare namespace gensync {
    ...
    export type GensyncGenerator<R = unknown> = Generator<GensyncGenerator<never>, R> & { __gensyncBrand: never };

    export interface GensyncFunction<A extends unknown[], R, E = unknown> {
    ...
    export type GensyncReturn<T> = T extends GensyncGenerator<infer U> ? U : never;
     ...
     */
    export function all<T extends readonly GensyncGenerator[] | []>(
        args: T,
     ...
     * @returns A new gensync generator
     */
    export function all<T>(args: Iterable<GensyncGenerator<T>>): GensyncGenerator<T[]>;
     ...
     * @returns A new gensync generator
     */
    export function race<T extends readonly GensyncGenerator[] | []>(
        args: T,
    ): GensyncGenerator<GensyncReturn<T[number]>>;
     ...
     * @returns A new gensync generator
     */
    export function race<T>(args: Iterable<GensyncGenerator<T>>): GensyncGenerator<T>;
}
