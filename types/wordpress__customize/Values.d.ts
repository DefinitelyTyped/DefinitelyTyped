...
export class Values<T> extends Class {
	...
	instance(...args: Array<string|((...values: Array<T>) => void)>): JQuery.Promise<any, any, any>;
	value(id: string): T;
	...
	when(...args: Array<string|((...values: Array<T>) => void)>): JQuery.Promise<any, any, any>;
	_change(): void;
}

export interface Values<T> extends Events<string> {
	(arg: string): T;
	(...args: Array<string|((...values: Array<T>) => void)>): JQuery.Promise<any, any, any>;
}
