// Type definitions for Google Google Cloud Machine Learning Engine v1beta1 1.0
...
// Generated from: https://ml.googleapis.com/$discovery/rest?version=v1beta1

/// <reference types="gapi.client" />

declare namespace gapi.client.ml {
    
    interface GoogleCloudMlV1beta1__HyperparameterSpec {
        ...
        params?: GoogleCloudMlV1beta1__ParameterSpec[];
    ...
    interface GoogleCloudMlV1beta1__ListVersionsResponse {
        // The list of versions.
        versions?: GoogleCloudMlV1beta1__Version[];
        // Optional. Pass this token as the `page_token` field of the request for a
        // subsequent call.
        nextPageToken?: string;
    }
    ...
    interface GoogleCloudMlV1beta1__TrainingOutput {
        ...
        // Only set for hyperparameter tuning jobs.
        trials?: GoogleCloudMlV1beta1__HyperparameterOutput[];
    }
    ...
    interface VersionsResource {
        ...
        list(request: {        
            ...
            parent: string;
        }): gapi.client.Request<GoogleCloudMlV1beta1__ListVersionsResponse>;        
...
declare namespace gapi.client {
    // Load Google Cloud Machine Learning Engine v1beta1
    function load(name: "ml", version: "v1beta1"): PromiseLike<void>;    
    function load(name: "ml", version: "v1beta1", callback: () => any): void;    
