// Type definitions for Google Google Cloud Machine Learning Engine v1beta1
...
declare namespace gapi.client {
    ...
    export function load (name: "ml", version: "v1beta1") : PromiseLike<void>;    
    export function load (name: "ml", version: "v1beta1", callback: () => any) : void;    
