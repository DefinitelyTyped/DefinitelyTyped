...
/**
 * libnpmpublish is a Node.js library for programmatically publishing and unpublishing npm packages.
 * Give it a manifest as an object and a tarball as a Buffer, and it'll put them on the registry for you.
 */
export namespace libnpmpublish {
    /**
     ...
     */
    function publish(manifest: object, tarballData: Buffer, options?: fetch.Options): Promise<Response>;
