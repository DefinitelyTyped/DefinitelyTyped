...
namespace XDate_Test {
    ...
    class adding extends test_base {
        ...
        private addHours_addMinutes_addSeconds_addMilliseconds(): boolean {
            ...
            return d.getHours() == 7 && d.getMinutes() == 45 && d.getSeconds() == 30 && d.getMilliseconds() == 550;
        }
    ...
    class constructors extends test_base {
        ...
        public from_XDate_XDate(): boolean {
            ...
            return xdate1.getTime() == xdate2.getTime() && !xdate1.getUTCMode() && !xdate2.getUTCMode();
        }
        ...
        public from_milliseconds_time_utcMode_false(): boolean {
            ...
            return !xdate1.getUTCMode() && !xdate2.getUTCMode() && xdate1.getTime() == MS && xdate2.getTime() == MS;
        }
        ...
        public toString_utcMode_undefined_true(): boolean {
            ...
            return (
                xdate1.toString('yyyy-MM-dd HH-mm-ss') == '2012-09-21 00-00-00' &&
	...
	*/
    ...
    class diffing extends test_base {
        public diffWeeks(): boolean {
            return (
                Math.floor(new XDate(2011, 4, 18).diffWeeks(new XDate(2011, 4, 26))) == 1 &&
    ...
    class formatting extends test_base {
        public numbers_am(): boolean {
            return new XDate(1986, 5, 8, 4, 3, 2).toString('MM/dd/yyyy hh:mm:ss tt') == '06/08/1986 04:03:02 am';
        }
        ...
        public numbers_am_mini(): boolean {
            return new XDate(1986, 5, 8, 4, 3, 2).toString('M/d/yy h:m:s t') == '6/8/86 4:3:2 a';
        }

        public numbers_pm(): boolean {
            return new XDate(1986, 5, 8, 14, 3, 2).toString('MM/dd/yyyy hh:mm:ss tt') == '06/08/1986 02:03:02 pm';
        }
        ...
        public numbers_pm_mini(): boolean {
            return new XDate(1986, 5, 8, 14, 3, 2).toString('M/d/yy h:m:s t') == '6/8/86 2:3:2 p';
        }

        public no_am_pm_confusion(): boolean {
            return new XDate(2012, 5, 8).toString('tt') == 'am' && new XDate(2012, 5, 8, 12).toString('tt') == 'pm';
        }

        public numbers_24_hour_clock(): boolean {
            return new XDate(1986, 5, 8, 14, 3, 2).toString('dd/MM/yyyy HH:mm:ss') == '08/06/1986 14:03:02';
        }

        public short_names(): boolean {
            return new XDate(2011, 10, 5).toString('ddd, MMM dd, yyyy') == 'Sat, Nov 05, 2011';
        }

        public long_namesu(): boolean {
            return new XDate(2011, 10, 5).toString('dddd, MMMM dd, yyyy') == 'Saturday, November 05, 2011';
        }
        ...
        public non_zero_parenthesis_crazy_quotes(): boolean {
            return new XDate(2010, 5, 8, 14, 30).toString("M/d/yyyy h(:mm')')tt") == '6/8/2010 2:30)pm';
        }
        ...
        public toString_toUTCString_settings_param(): boolean {
            ...
            return (
                new XDate(2011, 3, 29).toString('dddd yyyy', settings) == 'Primeday 2011' &&
        ...
        public toString_toUTCString_different_locale(): boolean {
            ...
            return (
                new XDate(2011, 3, 29).toString('dddd yyyy', 'starwars') == 'Primeday 2011' &&
        ...
        public custom_formatter_function(): boolean {
            ...
            return d.toString('vvv') == 'cool/false/5' && d.toUTCString('vvv') == 'cool/true/5';
        }
    ...
    class getters extends test_base {
        public getTime_valueOf(): boolean {
            ...
            return xdate1.getTime() == MS && xdate1.valueOf() == MS && xdate2.getTime() == MS && xdate2.valueOf() == MS;
        }
	...
	*/
    ...
    class parsing extends test_base {
        ...
        public ISO_timezone_colon(): boolean {
            ...
            var d = new XDate(s);
            return d.getUTCHours() == 16 && d.getUTCMinutes() == 30 && d.getUTCSeconds() == 28 && !d.getUTCMode();
        }
        ...
        public ISO_timezone_hour_only(): boolean {
            ...
            var d = new XDate(s);
            return d.getUTCHours() == 16 && d.getUTCMinutes() == 45 && d.getUTCSeconds() == 34 && !d.getUTCMode();
        }

        public ISO_timezone_positive(): boolean {
            var s = '2010-06-08T14:00:28+02:30';
            var d = new XDate(s);
            return d.getUTCHours() == 11 && d.getUTCMinutes() == 30 && d.getUTCSeconds() == 28 && !d.getUTCMode();
        }
    ...
    class setters extends test_base {
        ...
        public setFullYear_allow_overflow(): boolean {
            ...
            return xdate1.getMonth() == 2 && xdate1.getDate() == 1 && xdate2.getMonth() == 2 && xdate2.getDate() == 1;
        }
        ...
        public setMonth_allow_overflow(): boolean {
            ...
            return xdate1.getMonth() == 2 && xdate1.getDate() == 3 && xdate2.getMonth() == 2 && xdate2.getDate() == 3;
        }
        ...
        public setWeek_overflow(): boolean {
            ...
            xdate.setWeek(54);
            return xdate.getFullYear() == 2013 && xdate.getWeek() == 2 && xdate.getMonth() == 0 && xdate.getDate() == 7;
        }
    ...
    class utc_mode extends test_base {
        ...
        public getTimezoneOffset(): boolean {
            ...
            return xdate1.getTimezoneOffset() == date.getTimezoneOffset() && !xdate2.getTimezoneOffset();
        }
    }
