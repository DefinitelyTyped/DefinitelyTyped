    ...
    namespace accounts {
        ...
        interface IAccount extends IResourceObject, IAccountShared {
            ...
            requirements?: {
                 ...
                 * enabled for the account. These fields might block payouts sooner if the
                 * next threshold is reached before these fields are collected.
                 */
                current_deadline: number;

                /**
                 * The fields that need to be collected to keep the account enabled. If not
                 * collected by the current_deadline, these fields appear in past_due as well,
                 * and the account is disabled.
                 */
                currently_due: string[];

                /**
                 * If the account is disabled, this string describes why the account can’t
                 * create charges or receive payouts. Can be requirements.past_due,
                 ...
                 * reached. As they become required, these fields appear in currently_due as
                 * well, and the current_deadline is set.
                 */
                eventually_due: string[];

                /**
                 * The fields that weren’t collected by the current_deadline. These fields
                 * need to be collected to re-enable the account.
                 */
                past_due: string[];

                /**
                 * Fields that may become required depending on the results of verification
                 * or review. An empty array unless an asynchronous verification is pending.
                 * If verification fails, the fields in this array become required and move
                 * to currently_due or past_due.
                 */
