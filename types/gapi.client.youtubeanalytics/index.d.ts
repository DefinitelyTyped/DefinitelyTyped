...
declare namespace gapi.client {
    ...
    const groupItems: gapi.client.youtubeanalytics.GroupItemsResource; 
    
    const groups: gapi.client.youtubeanalytics.GroupsResource; 
    
    const reports: gapi.client.youtubeanalytics.ReportsResource; 
