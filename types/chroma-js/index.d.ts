...
export const average: chroma.ChromaStatic["average"];
export const bezier: chroma.ChromaStatic["bezier"];
export const blend: chroma.ChromaStatic["blend"];
export const brewer: chroma.ChromaStatic["brewer"];
export const contrast: chroma.ChromaStatic["contrast"];
export const contrastAPCA: chroma.ChromaStatic["contrastAPCA"];
export const cubehelix: chroma.ChromaStatic["cubehelix"];
export const deltaE: chroma.ChromaStatic["deltaE"];
export const distance: chroma.ChromaStatic["distance"];
export const limits: chroma.ChromaStatic["limits"];
export const mix: chroma.ChromaStatic["mix"];
export const interpolate: chroma.ChromaStatic["mix"];
export const random: chroma.ChromaStatic["random"];
export const scale: chroma.ChromaStatic["scale"];
export const valid: chroma.ChromaStatic["valid"];
