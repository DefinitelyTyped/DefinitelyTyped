...
declare function parseColumns(input: string, options?: parseColumns.BaseOptions): Array<{ [key: string]: string }>;
declare function parseColumns<T>(input: string, options: parseColumns.Options<T>): Array<{ [key: string]: T }>;
