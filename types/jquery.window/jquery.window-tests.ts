...
function example_3() {
    ...
    $.window({
        ...
        content:
            '<div style="padding: 10px; font - weight:bold; ">I only can be dragged within body element.' +
    ...
    $('#my_boundary_panel').window({
        ...
        content:
            '<div style="border: 15px solid green; padding: 10px; font - weight:bold; ">I only can be dragged within my boss...@@</div>',
        checkBoundary: true,
        width: 200,
        height: 160,
        maxWidth: 400,
...
function example_4() {
    $.window({
        ...
        content:
            '<div style="padding: 10px; font - weight:bold; ">I can\'t be dragged...<br>' +
