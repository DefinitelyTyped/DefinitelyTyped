...
const SomeFunctionalComponentWithIntl: React.ComponentClass<SomeComponentProps> = injectIntl<
        ...
        return (
            <div className={this.props.className}>
                ...
                <FormattedNumber value={123}>
                    {formattedNum => <span className="number">{formattedNum}</span>}
                </FormattedNumber>
                ...
                <FormattedPlural
                    ...
                    many="haiku"
                >
                    {formattedPlural => <span className="number">{formattedPlural}</span>}
                </FormattedPlural>
