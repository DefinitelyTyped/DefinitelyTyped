...
export function createAction<Payload>(type?: string): ActionFunction1<any, ThunkAction<Payload>>;

export function createAction<Payload, Arg>(type?: string): ActionFunction1<Arg, ThunkAction<Payload>>;
