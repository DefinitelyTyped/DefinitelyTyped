...
declare namespace gapi.client {
    // Load Gmail API v1
    export function load (name: "gmail", version: "v1") : PromiseLike<void>;    
    export function load (name: "gmail", version: "v1", callback: () => any) : void;    
    
    const users: gapi.client.gmail.UsersResource; 
