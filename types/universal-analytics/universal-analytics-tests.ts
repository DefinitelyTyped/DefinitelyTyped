...
visitor.transaction('trans-12345', 500).item(300, 1, 'item-54321').item(200, 2, 'item-41325').send();
...
visitor.t('trans-12345', 500).i(300, 1, 'item-54321').i(200, 2, 'item-41325').send();
...
visitor.event({ ec: 'Mail Server', ea: 'New Team Member Notification sent' }).event({ ea: 'Invitation sent' }).send();
