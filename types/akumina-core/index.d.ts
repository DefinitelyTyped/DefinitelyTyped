...
declare namespace Akumina.AppParts {
    class Banner {
...
declare namespace Akumina.Digispace {
...
declare namespace Akumina.Digispace.WidgetManager {
    class Menu {
        constructor(p: any);
        Open(parent: any): any;
    }
}
declare namespace Akumina.Digispace.Utilities { /* Added */
...
declare namespace Akumina.AddIn {
    class Utilities {
...
declare namespace Akumina.Digispace.AppPart {
    class Eventing {
        constructor();
