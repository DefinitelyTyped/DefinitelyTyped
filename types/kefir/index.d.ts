...
export class Observable<T, S> {
    ...
    observe(onValue?: (value: T) => void, onError?: (error: S) => void, onEnd?: () => void): Subscription;
...
export type Event<V, E> = { type: 'value'; value: V } | { type: 'error'; value: E } | { type: 'end'; value: void };
