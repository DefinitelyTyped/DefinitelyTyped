...
declare namespace gapi.client {
    ...
    export function load (name: "acceleratedmobilepageurl", version: "v1") : PromiseLike<void>;    
    export function load (name: "acceleratedmobilepageurl", version: "v1", callback: () => any) : void;    
