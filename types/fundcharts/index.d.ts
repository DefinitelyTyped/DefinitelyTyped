...
declare namespace FundCharts{
    ...
    interface BarOptions{
        ...
        duration?:number;
        fontFamily?:string;
        handleTextX?:(ctx?:OffscreenCanvasRenderingContext2D,xaxis?:string[]|number[])=>void
        handleTextY?:(ctx?:OffscreenCanvasRenderingContext2D,yaxis?:{min?:number,max?:number,unit?:number})=>void
        chartLeft?:number;
        chartRight?:number;
        chartTop?:number;
        colors?:string[]
    ...
    interface LineOptions{
        ...
        duration?:number;
        fontFamily?:string;
        handleTextX?:(ctx?:OffscreenCanvasRenderingContext2D,xaxis?:LineOptions["xaxis"])=>void
        handleTextY?:(ctx?:OffscreenCanvasRenderingContext2D,yaxis?:{min?:number,max?:number,unit?:number})=>void
        yaxisfunc?:(data:number)=>number|string
        colors?:string[]
        noGradient?:boolean;
