...
declare namespace Layui {
    ...
    interface Carousel {
        ...
        // 设置全局项
        set(options: CarouselOption): void;
    }
    ...
    interface ColorPicker {
        ...
        set(option: ColorPickerOption): void;
        // 绑定切换事件
    ...
    interface FlowOption {
        ...
        // 是否开启图片懒加载。默认false。如果设为true，则只会对在可视区域的图片进行按需加载。但与此同时，在拼接列表字符的时候， <br/>&nbsp;
    ...
    interface Lay {
         ...
         * @param fn
         */
        each(obj: object, fn: (k: string, v: any) => void): void;
    ...
    interface LayerOptions {
        ...
        // 图标。信息框和加载层的私有参数  默认：-1（信息框）/0（加载层）
        icon?: number;
    ...
    interface PageOptions {
        ...
        // 连续出现的页码个数 默认：5
        groups?: number;
        // 自定义“上一页”的内容，支持传入普通文本和HTML 默认：上一页
        prev?: string;
        // 自定义“下一页”的内容，同上 默认：下一页
        next?: string;
        // 自定义“首页”的内容，同上  默认：1
        first?: string;
        // 自定义“尾页”的内容，同上 默认：总页的具体数值
        last?: string;
        // 自定义排版。可选值有：	<br/>&nbsp;
    ...
    interface TableColumnOption {
        ...
        templet?: string | ((d: { LAY_INDEX: number; [index: string]: any }) => string);
    ...
    */
    ...
    interface TableOption {
        ...
        elem?: string | HTMLElement | JQuery;
        // https://www.layui.com/doc/modules/table.html#cols	<br/>&nbsp;
        // 设置表头。值是一个二维数组。方法渲染方式必填 ,1维是表头集合，二维是列集合
    ...
    interface Table {
        ...
        /**
         * 导出table中数据到文件
         * @param data  table选项中的id，指定id后则下载的文件名为table中title
         * @param type  默认csv
         */
    ...
    interface Transfer {
         ...
         * @param option 各项基础参数
         */
        render(option: TransferOption): void;
