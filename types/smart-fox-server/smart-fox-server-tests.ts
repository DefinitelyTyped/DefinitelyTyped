...
function test_MatchExpression() {
    var exp = new SFS2X.Entities.Match.MatchExpression('rank', SFS2X.Entities.Match.NumberMatch.GREATER_THAN, 5).and(
        'country',
    ...
    var exp = new SFS2X.Entities.Match.MatchExpression(
        'avatarData.shield.inUse',
        SFS2X.Entities.Match.BoolMatch.EQUALS,
        true,
    );

    var exp = new SFS2X.Entities.Match.MatchExpression(
        'avatarData.weapons.3.name',
        SFS2X.Entities.Match.StringMatch.EQUALS,
        'Narsil',
    );
}
