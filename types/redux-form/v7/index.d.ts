...
export type FormErrors<FormData = {}, T = string> = { [P in keyof FormData]?: ReactElement | T } & ErrorOther<T>;

export interface WarningOther<T = void> {
    _warning?: T;
}

export type FormWarnings<FormData = {}, T = void> = { [P in keyof FormData]?: ReactElement | string | WarningOther<T> };
