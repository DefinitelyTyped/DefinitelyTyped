...
// Definitions based on work by: Daniel Lytkin <https://github.com/aikoven>
...
export interface ReduxFormConfig {
     ...
     * mounted under the store-form reducer
     */
    form: string;
     ...
     * need to mount your store-form reducer at somewhere other than form in
...
export function getValues(fromState: any): { [key: string]: any };
