...
describe('Stripe object', () => {
    it('should exercise alternative ways to create Stripe object', () => {
        const stripeWithBetaOption: stripe.Stripe = Stripe('pk_test_TYooMQauvdEDq54NiTphI7jx', {
            betas: ['beta-feature'],
        }); // This looks deprecated
        const stripeWithLocale: stripe.Stripe = Stripe('pk_test_TYooMQauvdEDq54NiTphI7jx', { locale: 'zh' });
        const stripeWithAccount: stripe.Stripe = Stripe('pk_test_TYooMQauvdEDq54NiTphI7jx', {
...
describe('Stripe elements', () => {
    ...
    it('should use payment intents', () => {
        stripe.retrievePaymentIntent('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2').then((result) => {
            if (result.error) {
        ...
        const card = elements.create('card');
        stripe
            .handleCardPayment('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2', card, {
                payment_method_data: {
                    billing_details: {
                        name: 'Jenny Rosen',
                    },
        ...
        stripe.confirmCardPayment('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2').then((_result) => {
            // Handle result.error or result.paymentIntent
        });
        // stripe.confirmCardPayment(clientSecret,data?)
        stripe
            .confirmCardPayment('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2', {
                payment_method: {
                    card,
                    billing_details: {
                        name: 'Jenny Rosen',
        ...
        stripe.confirmPaymentIntent('{PAYMENT_INTENT_CLIENT_SECRET}').then((_result) => {
            // Handle result.error or result.paymentIntent
        });

        // stripe.confirmPaymentIntent(clientSecret,element)
        stripe.confirmPaymentIntent('{PAYMENT_INTENT_CLIENT_SECRET}', card).then((_result) => {
            // Handle result.error or result.paymentIntent
        });
        ...
        const ibanElement = elements.create('iban');
        stripe
            .confirmSepaDebitPayment('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2', {
                payment_method: {
    ...
    it('should handle card setup', () => {
        ...
        stripe
            .handleCardSetup('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2', card, {
                payment_method_data: {
                    billing_details: {
                        name: 'Jenny Rosen',
                    },
    ...
    it('should confirm card setup', () => {
        ...
        stripe
            .confirmCardSetup('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2', {
                payment_method: {
                    card,
                    billing_details: {
                        name: 'Jenny Rosen',
    ...
    it('should confirm SEPA debit setup', () => {
        ...
        stripe
            .confirmSepaDebitSetup('pi_18eYalAHEMiOZZp1l9ZTjSU0_secret_NibvRz4PMmJqjfb0sqmT7aq2', {
                payment_method: {
                    sepa_debit: ibanElement,
                    billing_details: {
                        name: 'Jenny Rosen',
