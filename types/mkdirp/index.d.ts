...
declare namespace mkdirp {
     ...
     */
    function sync(dir: string, opts?: Mode | Options): string|null;
     ...
     * implementation is overridden.
     */
    function manualSync(dir: string, opts?: Mode | Options): string|null;
     ...
     * overridden.
     */
    function nativeSync(dir: string, opts?: Mode | Options): string|null;
}
export = mkdirp;
