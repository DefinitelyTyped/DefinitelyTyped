...
export interface CloudTasksConfig extends gax.GoogleAuthOptions {
  key?: string;
  autoRetry?: boolean;
  maxRetries?: number;
  libName?: string;
...
export interface CallOptionsWithPagination extends gax.CallOptions {
  autoPaginate: false;
}

export interface MethodOverload<T, R> {
  (data: T, options?: gax.CallOptions): PromiseLike<[R]>;
  (data: T, options: gax.CallOptions, callback: APICallback<R>): void;
