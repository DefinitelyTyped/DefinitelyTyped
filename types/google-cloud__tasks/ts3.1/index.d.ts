...
export type EnhancedPick<T, Req extends keyof T, Opt extends keyof T> = Required<Pick<T, Req>> & Partial<Pick<T, Req>>;

export type ProjectIdCallback = (err?: Error | null, projectId?: string | null) => void;
...
export interface PaginatedMethodOverload<T, R, U, V = T> {
    ...
    (data: T, options?: CallOptions): PromiseLike<[R]>;
    (data: T, options: CallOptions, callback: APICallback<R>): void;
    (data: T, options: CallOptionsWithPagination, callback: APIPaginatedCallback<R, V, U>): void;
    (data: T, callback: APICallback<R>): void;
}
...
export type CreateNamedRequest<N extends string, T> = ParentRequest & { [P in N]: T };
export type UpdateNamedRequest<N extends string, T> = ParentRequest & { [P in N]: T };
...
export default class CloudTasksClient {
     ...
     *   });
     */
    listQueues: PaginatedMethodOverload<ListRequestObject, Queue[], ListQueuesResponse>;
     ...
     *   });
     */
    listQueuesStream(request: ListRequestObject, options?: CallOptions): Transform;
     ...
     *   });
     */
    createQueue: MethodOverload<CreateNamedRequest<'queue', Partial<Queue>>, Queue>;
     ...
     *   });
     */
    testIamPermissions: MethodOverload<ResourceRequest & TestIamPermissionsRequest, TestIamPermissionsResponse>;
     ...
     *   });
     */
    listTasks: PaginatedMethodOverload<ListRequestObject & RunTaskRequest, Task[], ListTasksResponse>;
     ...
     *   });
     */
    listTasksStream(request: ListRequestObject & RunTaskRequest, options?: CallOptions): Transform;
