...
export class Fragment {
  nodesBetween(from: number, to: number, f: (node: Node, start: number, parent: Node, index: number) => boolean | null | undefined): void;
  descendants(f: (node: Node, pos: number, parent: Node) => boolean | null | undefined): void;
...
export interface ParseRule {
  ...
  getAttrs(p: Node | string): boolean | AnyObject | null | undefined;
  contentElement?: string | null;
  getContent(p: Node): Fragment;
  preserveWhitespace?: boolean | "full" | null;
}

export interface DOMParserParseOptions {
  preserveWhitespace?: boolean | "full" | null;
...
export class DOMParser {
  ...
  schema: Schema;
  rules: ParseRule[];
  parse(dom: Node, options?: DOMParserParseOptions): Node;
  parseSlice(dom: Node, options?: AnyObject): Slice;
...
export class Node {
  ...
  maybeChild(index: number): Node | null | undefined;
  forEach(f: (node: Node, offset: number, index: number) => void): void;
  nodesBetween(from: number, to: number, f: (node: Node, pos: number, parent: Node, index: number) => boolean | null | undefined): void;
  descendants(f: (node: Node, pos: number, parent: Node) => boolean | null | undefined): void;
  textContent: string;
...
export { Node as ProsemirrorNode }; // Backwards compatibility.
