...
{
    var subscription = RxNode.fromStream<string>(process.stdin, 'end').subscribe(function (x) {
        console.log(x);
    });
}
{
    var subscription = RxNode.fromReadableStream(process.stdin).subscribe(function (x) {
        console.log(x);
    });
}
{
...
{
    var subscription = RxNode.fromWritableStream(process.stdout).subscribe(function (x) {
        console.log(x);
    });
}
{
