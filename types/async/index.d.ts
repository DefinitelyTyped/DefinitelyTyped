...
export function some<T, E = Error>(arr: IterableCollection<T>, iterator: AsyncBooleanIterator<T, E>): Promise<T>;
...
export function series<T, R, E = Error>(tasks: Array<AsyncFunction<T, E>>): Promise<R>;
export function series<T, R, E = Error>(tasks: Dictionary<AsyncFunction<T, E>>): Promise<R>;
...
export function parallel<T, R, E = Error>(tasks: Array<AsyncFunction<T, E>>): Promise<R>;
export function parallel<T, R, E = Error>(tasks: Dictionary<AsyncFunction<T, E>>): Promise<R>;
...
export function parallelLimit<T, R, E = Error>(tasks: Array<AsyncFunction<T, E>>, limit: number): Promise<R>;
export function parallelLimit<T, R, E = Error>(tasks: Dictionary<AsyncFunction<T, E>>, limit: number): Promise<R>;
...
export function auto<R extends Dictionary<any>, E = Error>(tasks: AsyncAutoTasks<R, E>): Promise<R>;
export function autoInject<E = Error>(tasks: any, callback: AsyncResultCallback<any, E>): void;
export function autoInject<R>(tasks: any): Promise<R>;
