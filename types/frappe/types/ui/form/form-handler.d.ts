...
type FormEventHandlersChildTable<DT extends DocTypeChildTable, F extends string> =
    & Partial<
...
type InferFormHandler<DT extends DocType> = DT extends DocTypeChildTable ? FormEventHandlersChildTable<DT, string>
