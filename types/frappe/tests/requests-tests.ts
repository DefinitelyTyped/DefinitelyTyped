...
const call2Opt2: Promise<FrappeResponse<{ arg1: string; arg2: number }>> = frappe.call('methodName', { arg1: 'foo', arg2: 42 });
const call2Opt3: Promise<FrappeResponse<string>> = frappe.call('methodName', { arg1: 'foo', arg2: 42 }, (data: FrappeResponse<string>, responseText) => {
  const s: string = data.message;
  const r: string | undefined = responseText;
});
const call2Opt4: Promise<FrappeResponse<boolean>> = frappe.call('methodName', { arg1: 'foo', arg2: 42 }, (data: FrappeResponse<boolean>) => {
...
const xcall2: Promise<FrappeResponse<{ arg1: string; arg2: number }>> = frappe.xcall('methodName', { arg1: 'foo', arg2: 42 });
