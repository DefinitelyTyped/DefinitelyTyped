...
gapi.client.request({ path: '/plus/v1/people', params: { query: 'John' } }).then(
    function (response) {
        // Handle response
    },
    function (reason) {
...
var personFetcher = {
    ...
    fetch: function (this: any, name: string) {
        gapi.client.request({ path: '/plus/v1/people', params: { query: name } }).then(
            function (this: any, response) {
