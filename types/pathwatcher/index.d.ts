...
declare namespace PathWatcher {
	...
	namespace Statics {
		...
		interface File {
			...
			new (filePath: string, symlink?: boolean): PathWatcher.File;
		}

		/** The static side to the Directory class. */
		interface Directory {
			/** Configures a new Directory instance, no files are accessed. */
			new (directoryPath: string, symlink?: boolean): PathWatcher.Directory;
		}
...
declare module "pathwatcher" {
	let File: PathWatcher.Statics.File;
	let Directory: PathWatcher.Statics.Directory;
