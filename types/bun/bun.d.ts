...
declare module "bun" {
    ...
    function write(
        ...
        input: Blob | NodeJS.TypedArray | ArrayBufferLike | string | BunJS.BlobPart[],
        options?: {
    ...
    interface ServerWebSocket<T = undefined> {
         ...
         */
        send(data: string | BunJS.BufferSource, compress?: boolean): ServerWebSocketSendStatus;
         ...
         */
        sendBinary(data: BunJS.BufferSource, compress?: boolean): ServerWebSocketSendStatus;
         ...
         */
        publish(topic: string, data: string | BunJS.BufferSource, compress?: boolean): ServerWebSocketSendStatus;
         ...
         */
        publishBinary(topic: string, data: BunJS.BufferSource, compress?: boolean): ServerWebSocketSendStatus;
    ...
    abstract class CryptoHashInterface<T> {
         ...
         * @param hashInto `TypedArray` to write the hash into. Faster than creating a new one each time
         */
        static hash(input: StringOrBuffer, hashInto?: NodeJS.TypedArray): NodeJS.TypedArray;
    ...
    interface Socket<Data = undefined> {
         ...
         */
        write(data: string | BunJS.BufferSource, byteOffset?: number, byteLength?: number): number;
         ...
         */
        end(data?: string | BunJS.BufferSource, byteOffset?: number, byteLength?: number): number;
    ...
    namespace SpawnOptions {
        ...
        type OptionsToSubprocess<Opts extends OptionsObject> = Opts extends OptionsObject<
            infer In,
            infer Out,
            infer Err
        > ? Subprocess<
