...
declare module "util" {
     ...
     */
    export function deprecate<T extends AnyFunction>(fn: T, msg: string, code?: string): T;
    /**
    ...
    export interface CustomPromisifyLegacy<TCustom extends AnyFunction> extends AnyFunction {
        __promisify__: TCustom;
    }
    export interface CustomPromisifySymbol<TCustom extends AnyFunction> extends AnyFunction {
        [promisify.custom]: TCustom;
    }
    export type CustomPromisify<TCustom extends AnyFunction> =
     ...
     * ```
     */
    export function promisify<TCustom extends AnyFunction>(fn: CustomPromisify<TCustom>): TCustom;
