...
type MessagePort = import("worker_threads").MessagePort;
declare var MessageChannel: typeof import("worker_threads").MessageChannel;
type MessageChannel = import("worker_threads").MessageChannel;
declare var BroadcastChannel: typeof import("worker_threads").BroadcastChannel;
type BroadcastChannel = import("worker_threads").BroadcastChannel;
 ...
 */
declare function setImmediate(handler: TimerHandler, ...arguments: any[]): Timer;
/**
 * Run a function every `interval` milliseconds
 * @param handler function to call
 * @param interval milliseconds to wait between calls
 */
declare function setInterval(handler: TimerHandler, interval?: number, ...arguments: any[]): Timer;
/**
 * Run a function after `timeout` (milliseconds)
 * @param handler function to call
 * @param timeout milliseconds to wait between calls
 */
declare function setTimeout(handler: TimerHandler, timeout?: number, ...arguments: any[]): Timer;
...
interface WebSocket extends EventTarget {
     ...
     */
    onmessage: ((this: WebSocket, event: MessageEvent<string | Buffer>) => unknown) | null;
