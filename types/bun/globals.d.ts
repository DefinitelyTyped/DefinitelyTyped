// this is set to let us override definitions in @types/node
...
declare namespace BunJS {
    ...
    interface TextEncoder extends NodeTextEncoder {
         ...
         */
        encodeInto(src?: string, dest?: BunJS.BufferSource): import("util").EncodeIntoResult;
    }
 ...
 */
declare function structuredClone<T>(value: T, options?: BunJS.StructuredSerializeOptions): T;
 ...
 */
declare function setImmediate(handler: BunJS.TimerHandler, ...arguments: any[]): Timer;
/**
 * Run a function every `interval` milliseconds
 * @param handler function to call
 * @param interval milliseconds to wait between calls
 */
declare function setInterval(handler: BunJS.TimerHandler, interval?: number, ...arguments: any[]): Timer;
/**
 * Run a function after `timeout` (milliseconds)
 * @param handler function to call
 * @param timeout milliseconds to wait between calls
 */
declare function setTimeout(handler: BunJS.TimerHandler, timeout?: number, ...arguments: any[]): Timer;
...
interface ReadableStreamDirectController {
    ...
    write(data: BunJS.BufferSource | ArrayBuffer | string): number | Promise<number>;
...
interface ReadableStreamDefaultReader<R = any> extends ReadableStreamGenericReader {
    ...
    readMany(): Promise<BunJS.ReadableStreamDefaultReadManyResult<R>>;
    releaseLock(): void;
}
...
declare namespace BunJS {
    namespace WebAssembly {
        ...
        type _Instance = typeof globalThis extends { onerror: any; WebAssembly: { Instance: infer T } } ? T : Instance;
        ...
        type _Memory = typeof globalThis extends { onerror: any; WebAssembly: { Memory: infer T } } ? T : Memory;

        /** [MDN Reference](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Module) */
        interface Module {}
        type _Module = typeof globalThis extends { onerror: any; WebAssembly: { Module: infer T } } ? T : Module;
        ...
        type _Table = typeof globalThis extends { onerror: any; WebAssembly: { Table: infer T } } ? T : Table;
...
declare namespace WebAssembly {
    ...
    interface WebAssemblyInstantiatedSource extends BunJS.WebAssembly.WebAssemblyInstantiatedSource {}
    ...
    interface Global<T extends keyof ValueTypeMap = keyof ValueTypeMap> extends BunJS.WebAssembly._Global<T> {}
 ...
 */
declare function postMessage(message: any, transfer?: BunJS.Transferable[]): void;
