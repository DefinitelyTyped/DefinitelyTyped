...
declare module "bun:test" {
     ...
     */
    export function beforeAll(fn: (() => unknown | Promise<unknown>) | ((done: (err?: unknown) => void) => void)): void;
    /**
     ...
     * @param fn the function to run
     */
    export function afterAll(fn: (() => unknown | Promise<unknown>) | ((done: (err?: unknown) => void) => void)): void;
    /**
     ...
     * @param fn the function to run
     */
    export function afterEach(fn: (() => unknown | Promise<unknown>) | ((done: (err?: unknown) => void) => void)): void;
