...
expectType<string>(fsPromises.readFile("./index.d.ts", { encoding: "utf-8" }).toString());
...
Bun.sleep(1); // sleep for 1 ms (recommended)
...
// new Loader();
new ByteLengthQueuingStrategy({} as any);
new ReadableStreamDefaultController();
new ReadableStreamDefaultReader({} as any);
new WritableStreamDefaultController();
new WritableStreamDefaultWriter({} as any);
new TransformStream();
new TransformStreamDefaultController();
new CountQueuingStrategy({} as any);
new DOMException();
new SubtleCrypto();
new CryptoKey();
new BuildError();
new ResolveError();
new EventSource("asdf");
new AbortController();
new AbortSignal();
new Request("asdf");
new Response();
