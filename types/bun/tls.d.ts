...
declare module "tls" {
    ...
    class Server extends net.Server {
        ...
        addListener(
            event: "OCSPRequest",
            listener: (certificate: Buffer, issuer: Buffer, callback: (err: Error | null, resp: Buffer) => void) => void
        ): this;
        addListener(
            event: "resumeSession",
    ...
    interface SecureContextOptions {
         ...
         */
        ca?: string | Buffer | TypedArray | BunFile | Array<string | Buffer | BunFile> | undefined;
        /**
         ...
         */
        cert?: string | Buffer | TypedArray | BunFile | Array<string | Buffer | TypedArray | BunFile> | undefined;
        /**
