 ...
 */
declare module "ws" {
    import { IncomingMessage, OutgoingHttpHeaders, Server as HTTPServer } from "http";
    ...
    > extends EventEmitter {
        ...
        on(event: "close" | "listening", cb: (this: WebSocketServer<T>) => void): this;
        on(event: string | symbol, listener: (this: WebSocketServer<T>, ...args: any[]) => void): this;
    ...
    let Server: typeof WebSocketServer;
}
