...
declare module "diagnostics_channel" {
    ...
    class Channel {
        ...
        bindStore<T>(store: AsyncLocalStorage<T>, transform?: TransformCallback<T>): void;
        unbindStore(store: AsyncLocalStorage<unknown>): void;
        runStores(context: unknown, fn: (...args: unknown[]) => unknown, receiver?: unknown, ...args: unknown[]): any;
    }
    ...
    class TracingChannel implements TracingChannels {
        ...
        traceSync<T>(fn: (...values: any[]) => T, context?: any, thisArg?: any, ...args: any[]): any;
        tracePromise<T>(
    ...
    function tracingChannel(nameOrChannels: string | TracingChannels): TracingChannel;
}
