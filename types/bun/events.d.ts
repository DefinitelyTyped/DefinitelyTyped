...
declare module "events" {
    ...
    interface EventEmitter<Events extends Record<string | symbol, any[]> = Record<string | symbol, any[]>> {
        /**
         ...
         * ```
         */
        listeners(eventName: keyof Events): FunctionLike[];
        /**
         * Returns a copy of the array of listeners for the event named `eventName`,
         ...
         * ```
         */
        rawListeners(eventName: keyof Events): FunctionLike[];
        /**
    ...
    class EventEmitter {
         ...
         * ```
         */
        static getEventListeners(emitter: DOMEventTarget | EventEmitter, name: string | symbol): FunctionLike[];
        /**
         * ```js
         * const {
         *   setMaxListeners,
