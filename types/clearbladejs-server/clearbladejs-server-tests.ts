...
ClearBlade.addSortToQuery(query1, CbServer.QuerySortDirections.QUERY_SORT_ASCENDING, 'column1');
ClearBlade.addFilterToQuery(query1, CbServer.QueryConditions.QUERY_GREATERTHAN, 'key', 'value');
