...
export function linear(data: ReadonlyArray<DataPoint>, options?: Options): Result;
export function exponential(data: ReadonlyArray<DataPoint>, options?: Options): Result;
export function logarithmic(data: ReadonlyArray<DataPoint>, options?: Options): Result;
export function power(data: ReadonlyArray<DataPoint>, options?: Options): Result;
export function polynomial(data: ReadonlyArray<DataPoint>, options?: Options): Result;
