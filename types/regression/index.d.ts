...
declare namespace Regression {
    ...
    function _round(number: number, precision: number): number;
    function linear(data: ReadonlyArray<DataPoint>, options?: Options): Result;
    ...
    function power(data: ReadonlyArray<DataPoint>, options?: Options): Result;
    function polynomial(
        data: ReadonlyArray<DataPoint>,
        options?: Options
    ): Result;
