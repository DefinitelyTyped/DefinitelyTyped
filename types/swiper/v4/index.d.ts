...
export declare interface EventsOptions {
    init: () => {};
    beforeDestroy: () => {};
    slideChange: () => {};
    slideChangeTransitionStart: () => {};
...
export declare interface OptionsWithElement {
    el: SelectableElement;
}

export declare interface PaginationOptions extends OptionsWithElement {
    type?: string;
...
export declare interface ScrollbarOptions extends OptionsWithElement {
    hide: boolean;
    draggable: boolean;
...
export declare interface AutoplayOptions extends OptionsWithElement {
...
export declare interface EffectFadeOptions {
    crossfade: boolean;
}

export declare interface EffectCoverflowOptions {
...
export declare interface EffectFlipOptions {
    slideShadows: boolean;
    limitRotation: boolean;
}

export declare interface EffectCubeOptions {
    slideShadows: boolean;
    shadow: boolean;
    shadowOffset: number;
    shadowScale: number;
...
export declare interface HashNavigationOptions {
    watchState: boolean;
    replaceState: boolean;
}

export declare interface HistoryNavigationOptions {
    replaceState: boolean;
    key: string;
}

export declare interface ControllerOptions {
    control: Swiper;
    inverse: boolean;
    by: string;
}
