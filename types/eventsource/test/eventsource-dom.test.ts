...
eventSource.addEventListener = (type: string, listener: (evt: MessageEvent) => any) => {};
eventSource.dispatchEvent = (event: Event) => true;
eventSource.removeEventListener = (type: string, listener: (evt: MessageEvent) => any) => {};
eventSource.close();
...
eventSourcePolyfill.addEventListener = (type: string, listener: (evt: MessageEvent) => any) => {};
eventSourcePolyfill.dispatchEvent = (event: Event) => true;
eventSourcePolyfill.removeEventListener = (type: string, listener: (evt: MessageEvent) => any) => {};
