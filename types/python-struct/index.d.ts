...
export function unpack(format: string, data: Buffer, checkBounds?: boolean): DataType[];
export function unpackFrom(format: string, data: Buffer, checkBounds: boolean | undefined, position: number): DataType;
