...
export type MultiPropertySchema<T extends object> = { [P in keyof T]: SinglePropertySchema<T[P]> | T[P] };
...
export interface AFrame {
    ...
    registerGeometry<T extends object>(name: string, geometry: GeometryDefinition<T>): GeometryConstructor<T>;
    ...
    registerSystem<T extends object>(name: string, definition: SystemDefinition<T>): SystemConstructor<T>;
}
