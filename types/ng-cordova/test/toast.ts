...
namespace demo.toast {
    ...
    export class ToastController {
        ...
        center() {
            this.$cordovaToast.show(this.toastMessage, 'long', 'center').then(
                (success) => {
        ...
        top() {
            this.$cordovaToast.showShortTop(this.toastMessage).then(
                (success) => {
        ...
        bottom() {
            this.$cordovaToast.showLongBottom(this.toastMessage).then(
                (success) => {
