namespace ngCordova {
    ...
    angular
        ...
        .controller('MyCtrl', function (
            $scope: ng.IScope & { downloadProgress: number },
            $timeout: ng.ITimeoutService,
            $cordovaFileTransfer: ngCordova.IFileTransferService,
        ) {
            ...
            document.addEventListener(
                ...
                function () {
                    ...
                    $cordovaFileTransfer.upload(url, filePath, options, trustHosts).then(
                        function (result) {
                            // Success!
