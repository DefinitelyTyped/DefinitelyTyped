// Type definitions for Google DCM/DFA Reporting And Trafficking API v2.7
...
declare namespace gapi.client {
    // Load DCM/DFA Reporting And Trafficking API v2.7
    export function load (name: "dfareporting", version: "v2.7") : PromiseLike<void>;    
    export function load (name: "dfareporting", version: "v2.7", callback: () => any) : void;    
