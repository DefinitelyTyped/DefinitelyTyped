...
export function parseSimulcastStreamList(streams : string) : {
    scid : number | string,
    paused : boolean,
}[];
 ...
 */
interface SessionAttributes extends SharedAttributes {
    icelite? : string,
 ...
 */
interface MediaAttributes extends SharedAttributes {
    rtp? : {
        payload : number,
        codec : string,
        rate? : number,
 ...
 * See the SDP grammar for more details: https://tools.ietf.org/html/rfc4566#section-9
 */
interface SharedDescriptionFields {
    // i=
    description? : string,
