...
declare namespace Lowdb {
    ...
    interface BaseAdapter<SchemaT = any> extends AdapterOptions<SchemaT> {
        ...
        new <SchemaT = any>(source: string, options?: AdapterOptions<SchemaT>): BaseAdapter<SchemaT>;
        source: string;
    }

    interface AdapterSync<SchemaT = any> extends BaseAdapter<SchemaT> {
        new <SchemaT = any>(source: string, options?: AdapterOptions<SchemaT>): AdapterSync<SchemaT>;
        write(state: object): void;
    }

    interface AdapterAsync<SchemaT = any> extends BaseAdapter<SchemaT> {
        new <SchemaT = any>(source: string, options?: AdapterOptions<SchemaT>): AdapterAsync<SchemaT>;
    ...
    interface LowdbFpSync<SchemaT> extends LowdbBase<SchemaT> {
         ...
         * ```
         */
        <TKey extends keyof SchemaT>(path: TKey | [TKey], defaultValue?: SchemaT[TKey]): FpReturnSync<SchemaT[TKey]>;
    ...
    interface LowdbFpAsync<SchemaT> extends LowdbBase<SchemaT> {
         ...
         * ```
         */
        <TKey extends keyof SchemaT>(path: TKey | [TKey], defaultValue?: SchemaT[TKey]): FpReturnAsync<SchemaT[TKey]>;
        <TKey extends keyof SchemaT, TSubKey extends keyof SchemaT[TKey]>(
            path: [TKey, TSubKey],
            defaultValue?: SchemaT[TKey][TSubKey],
    ...
    interface FpReturnBase<PathT> {
        ...
        <R1, R2, R3, R4, R5, R6>(
            f1: [(a1: PathT) => R1, (a: R1) => R2, (a: R2) => R3, (a: R3) => R4, (a: R4) => R5, (a: R5) => R6],
        ): R6;
