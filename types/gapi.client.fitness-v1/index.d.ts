...
declare namespace gapi.client.fitness {
...
declare namespace gapi.client {
    // Load Fitness v1
    export function load (name: "fitness", version: "v1") : PromiseLike<void>;    
    export function load (name: "fitness", version: "v1", callback: () => any) : void;    
    
    const users: gapi.client.fitness.UsersResource; 
