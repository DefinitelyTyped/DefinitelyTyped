...
let contact: connect.Contact;
let connection: connect.Connection;
let sendDigitOptions: connect.SendDigitOptions;

connect.Endpoint.byPhoneNumber(""); // $ExpectType: connect.Endpoint

connect.agent(agentCallback); // $ExpectType: void
connect.contact(contactCallback); // $ExpectType: void
