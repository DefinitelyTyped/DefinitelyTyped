...
declare function remoteOriginUrl(options?: string | remoteOriginUrl.Options): Promise<string | undefined>;
declare function remoteOriginUrl(callback: remoteOriginUrl.Callback): void;
declare function remoteOriginUrl(options: string | remoteOriginUrl.Options, callback: remoteOriginUrl.Callback): void;
