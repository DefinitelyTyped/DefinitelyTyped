...
export module tile {
    ...
    export class requestorBing extends requestor {
        constructor(options?: { dataFormat?: string; timeoutMs?: number; maxAvailableZoomLevel?: number });
    ...
    export class requestorLocal extends requestor {
        constructor(options?: { dataFormat?: string; timeoutMs?: number; maxAvailableZoomLevel?: number; data: {}[] });
    ...
    export class descriptorLocal {
        constructor(options: { valueFieldNames: string[]; geometryFieldName: string; bleedRatio?: number });
    }
}
