...
export enum PayloadOutputEnum {
    Data = 'data',
    Stream = 'stream',
    File = 'file'
}

export enum PayloadMultipartOutputEnum {
    // TODO not ready. The v16 definition have similar doubts: "// TODO type this?"
    // https://github.com/hapijs/hapi/blob/master/API.md#route.options.payload.multipart
    Data = 'data',
    Stream = 'stream',
    File = 'file',
    Annotated = 'annotated',
...
export interface RouteOptionsPayload {
     ...
     */
    multipart?: false | PayloadOutputEnum | PayloadMultipartOutputEnum ;
