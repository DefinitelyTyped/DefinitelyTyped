...
declare module 'svelte-range-slider-pips' {
    ...
    export type OnStop = OnStart & {
        startValue: number;
    };

    export type OnChange = OnStop & {
        previousValue: number;
    };

    export type Formater = (v: number, i?: number, p?: number) => string;

    export type SpringValues = { stiffness: number; damping: number };
