...
const parameterizedBlockWithModsClass: string = parameterizedB_("block", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
const parameterizedElemClass: string = parameterizedB_("block", "elem");
const parameterizedElemWithModsClass: string = parameterizedB_("block", "elem", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
...
const parameterizedWithBlockWithModsClass: string = parameterizedWithBlock({
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
const parameterizedWithBlockElemClass: string = parameterizedWithBlock("elem");
const parameterizedWithBlockElemWithModsClass: string = parameterizedWithBlock("elem", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
...
const parameterizedLockBlockWithModsClass: string = parameterizedLockBlock({
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
const parameterizedLockBlockElemClass: string = parameterizedLockBlock("elem");
const parameterizedLockBlockElemWithModsClass: string = parameterizedLockBlock("elem", {
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
...
const parameterizedWithElemWithModsClass: string = parameterizedWithElem({
    stringMod: "string",
    boolMod: true,
    numberMod: 5,
});
