...
export interface ojThematicMap<K1, K2, K3, D1, D2, D3>
    extends dvtBaseComponent<ojThematicMapSettableProperties<K1, K2, K3, D1, D2, D3>>
{
    ...
    onAnimationDurationChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["animationDuration"]>) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["animationOnDisplay"]>) => any)
        | null;
    onAreaDataChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["areaData"]>) => any)
        | null;
    onAsChanged: ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["as"]>) => any) | null;
    onFocusRendererChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["focusRenderer"]>) => any)
        | null;
    onHiddenCategoriesChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["hiddenCategories"]>) => any)
        | null;
    onHighlightMatchChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["highlightMatch"]>) => any)
        | null;
    onHighlightedCategoriesChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["highlightedCategories"]>) => any)
        | null;
    onHoverBehaviorChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["hoverBehavior"]>) => any)
        | null;
    onHoverRendererChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["hoverRenderer"]>) => any)
        | null;
    onInitialZoomingChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["initialZooming"]>) => any)
        | null;
    onIsolatedItemChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["isolatedItem"]>) => any)
        | null;
    onLabelDisplayChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["labelDisplay"]>) => any)
        | null;
    onLabelTypeChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["labelType"]>) => any)
        | null;
    onLinkDataChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["linkData"]>) => any)
        | null;
    onMapProviderChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["mapProvider"]>) => any)
        | null;
    onMarkerDataChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["markerData"]>) => any)
        | null;
    onMarkerZoomBehaviorChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["markerZoomBehavior"]>) => any)
        | null;
    ...
    onRendererChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["renderer"]>) => any)
        | null;
    onSelectionChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["selection"]>) => any)
        | null;
    onSelectionModeChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["selectionMode"]>) => any)
        | null;
    onSelectionRendererChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["selectionRenderer"]>) => any)
        | null;
    onStyleDefaultsChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["styleDefaults"]>) => any)
        | null;
    onTooltipChanged: ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["tooltip"]>) => any) | null;
    onTooltipDisplayChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["tooltipDisplay"]>) => any)
        | null;
    onTouchResponseChanged:
        | ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["touchResponse"]>) => any)
        | null;
    onZoomingChanged: ((event: JetElementCustomEvent<ojThematicMap<K1, K2, K3, D1, D2, D3>["zooming"]>) => any) | null;
    addEventListener<T extends keyof ojThematicMapEventMap<K1, K2, K3, D1, D2, D3>>(
        type: T,
        listener: (this: HTMLElement, ev: ojThematicMapEventMap<K1, K2, K3, D1, D2, D3>[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojThematicMapSettableProperties<K1, K2, K3, D1, D2, D3>>(
        property: T,
    ): ojThematicMap<K1, K2, K3, D1, D2, D3>[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojThematicMapSettableProperties<K1, K2, K3, D1, D2, D3>>(
        property: T,
        value: ojThematicMapSettableProperties<K1, K2, K3, D1, D2, D3>[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojThematicMapSettableProperties<K1, K2, K3, D1, D2, D3>>,
    ): void;
...
export interface ojThematicMapEventMap<K1, K2, K3, D1, D2, D3>
    extends dvtBaseComponentEventMap<ojThematicMapSettableProperties<K1, K2, K3, D1, D2, D3>>
{
...
export interface ojThematicMapMarker extends JetElement<ojThematicMapMarkerSettableProperties> {
    ...
    onSourceHoverSelectedChanged:
        | ((event: JetElementCustomEvent<ojThematicMapMarker["sourceHoverSelected"]>) => any)
        | null;
    ...
    addEventListener<T extends keyof ojThematicMapMarkerEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojThematicMapMarkerEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
