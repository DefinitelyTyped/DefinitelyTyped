...
export interface ojChart<K, D> extends dvtBaseComponent<ojChartSettableProperties<K, D>> {
    ...
    legend: {
        ...
        sections: Array<{
            items: Array<{
                ...
                lineWidth: number;
                markerColor: string;
                markerShape?: 'circle' | 'diamond' | 'human' | 'plus' | 'rectangle' | 'square' | 'star' | 'triangleDown' | 'triangleUp' | string | undefined;
    ...
    styleDefaults: {
        ...
        markerShape?: 'auto' | 'circle' | 'diamond' | 'human' | 'plus' | 'square' | 'star' | 'triangleDown' | 'triangleUp' | string | undefined;
        markerSize: number;
...
export interface ojChartItem extends JetElement<ojChartItemSettableProperties> {
    ...
    labelPosition?: 'center' | 'outsideSlice' | 'aboveMarker' | 'belowMarker' | 'beforeMarker' | 'afterMarker' | 'insideBarEdge' | 'outsideBarEdge' | 'none' | 'auto' | undefined;
    labelStyle?: object | object[] | undefined;
    low?: number | undefined;
    markerDisplayed?: 'on' | 'off' | 'auto' | undefined;
    markerShape?: 'circle' | 'diamond' | 'human' | 'plus' | 'square' | 'star' | 'triangleDown' | 'triangleUp' | 'auto' | string | undefined;
    markerSize?: number | undefined;
    open?: number | undefined;
    pattern?: 'smallChecker' | 'smallCrosshatch' | 'smallDiagonalLeft' | 'smallDiagonalRight' | 'smallDiamond' | 'smallTriangle' | 'largeChecker' | 'largeCrosshatch' | 'largeDiagonalLeft' |
       'largeDiagonalRight' | 'largeDiamond' | 'largeTriangle' | 'auto' | undefined;
    q1?: number | undefined;
    q2?: number | undefined;
    q3?: number | undefined;
...
export interface ojChartSeries extends JetElement<ojChartSeriesSettableProperties> {
    ...
    lineType?: 'straight' | 'curved' | 'stepped' | 'centeredStepped' | 'segmented' | 'centeredSegmented' | 'none' | 'auto' | undefined;
