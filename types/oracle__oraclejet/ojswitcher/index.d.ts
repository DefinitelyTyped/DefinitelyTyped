...
export interface ojSwitcher extends JetElement<ojSwitcherSettableProperties> {
    ...
    addEventListener<T extends keyof ojSwitcherEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojSwitcherEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojSwitcherSettableProperties>(property: T): ojSwitcher[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojSwitcherSettableProperties>(
        property: T,
        value: ojSwitcherSettableProperties[T],
    ): void;
