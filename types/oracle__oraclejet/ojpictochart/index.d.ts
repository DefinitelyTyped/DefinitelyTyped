...
export interface ojPictoChart<K, D> extends dvtBaseComponent<ojPictoChartSettableProperties<K, D>> {
    ...
    onAnimationOnDataChangeChanged:
        | ((event: JetElementCustomEvent<ojPictoChart<K, D>["animationOnDataChange"]>) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((event: JetElementCustomEvent<ojPictoChart<K, D>["animationOnDisplay"]>) => any)
        | null;
    ...
    onHighlightedCategoriesChanged:
        | ((event: JetElementCustomEvent<ojPictoChart<K, D>["highlightedCategories"]>) => any)
        | null;
    onHoverBehaviorChanged: ((event: JetElementCustomEvent<ojPictoChart<K, D>["hoverBehavior"]>) => any) | null;
    onHoverBehaviorDelayChanged:
        | ((event: JetElementCustomEvent<ojPictoChart<K, D>["hoverBehaviorDelay"]>) => any)
        | null;
...
export interface ojPictoChartItem extends JetElement<ojPictoChartItemSettableProperties> {
    ...
    onSourceHoverSelectedChanged:
        | ((event: JetElementCustomEvent<ojPictoChartItem["sourceHoverSelected"]>) => any)
        | null;
