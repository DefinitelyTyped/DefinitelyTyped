...
export interface ojDialog extends baseComponent<ojDialogSettableProperties> {
    ...
    addEventListener<T extends keyof ojDialogEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojDialogEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
...
export namespace ojDialog {
    ...
    interface ojResizeStart
        extends CustomEvent<{
            event: Event;
            [propName: string]: any;
        }> {}
    interface ojResizeStop
        extends CustomEvent<{
            event: Event;
            [propName: string]: any;
        }> {}
