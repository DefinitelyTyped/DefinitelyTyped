...
export interface ojFilePicker extends JetElement<ojFilePickerSettableProperties> {
    ...
    addEventListener<T extends keyof ojFilePickerEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojFilePickerEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojFilePickerSettableProperties>(property: T): ojFilePicker[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojFilePickerSettableProperties>(
        property: T,
        value: ojFilePickerSettableProperties[T],
    ): void;
