...
export interface inputBase<V, SP extends inputBaseSettableProperties<V, SV>, SV = V, RV = V>
    extends editableValue<V, SP, SV, RV>
{
    ...
    onAsyncValidatorsChanged:
        | ((event: JetElementCustomEvent<inputBase<V, SP, SV, RV>["asyncValidators"]>) => any)
        | null;
    ...
    addEventListener<T extends keyof inputBaseEventMap<V, SP, SV, RV>>(
        type: T,
        listener: (this: HTMLElement, ev: inputBaseEventMap<V, SP, SV, RV>[T]) => any,
        useCapture?: boolean,
    ): void;
    ...
    setProperty<T extends keyof inputBaseSettableProperties<V, SV, RV>>(
        property: T,
        value: inputBaseSettableProperties<V, SV, RV>[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, inputBaseSettableProperties<V, SV, RV>>,
    ): void;
...
export interface inputBaseEventMap<V, SP extends inputBaseSettableProperties<V, SV>, SV = V, RV = V>
...
export interface ojInputPassword extends inputBase<string | null, ojInputPasswordSettableProperties> {
    ...
    addEventListener<T extends keyof ojInputPasswordEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojInputPasswordEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojInputPasswordSettableProperties>(property: T): ojInputPassword[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojInputPasswordSettableProperties>(
        property: T,
        value: ojInputPasswordSettableProperties[T],
    ): void;
...
export interface ojInputText extends inputBase<any, ojInputTextSettableProperties> {
    ...
    addEventListener<T extends keyof ojInputTextEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojInputTextEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojInputTextSettableProperties>(property: T): ojInputText[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojInputTextSettableProperties>(
        property: T,
        value: ojInputTextSettableProperties[T],
    ): void;
...
export interface ojTextArea extends inputBase<any, ojTextAreaSettableProperties> {
    ...
    addEventListener<T extends keyof ojTextAreaEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojTextAreaEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojTextAreaSettableProperties>(property: T): ojTextArea[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojTextAreaSettableProperties>(
        property: T,
        value: ojTextAreaSettableProperties[T],
    ): void;
