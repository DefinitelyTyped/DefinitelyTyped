...
export interface editableValue<V, SP extends editableValueSettableProperties<V, SV, RV>, SV = V, RV = V>
    extends baseComponent<SP>
{
    ...
    onDisplayOptionsChanged:
        | ((event: JetElementCustomEvent<editableValue<V, SP, SV, RV>["displayOptions"]>) => any)
        | null;
    ...
    onMessagesCustomChanged:
        | ((event: JetElementCustomEvent<editableValue<V, SP, SV, RV>["messagesCustom"]>) => any)
        | null;
    ...
    addEventListener<T extends keyof editableValueEventMap<V, SP, SV, RV>>(
        type: T,
        listener: (this: HTMLElement, ev: editableValueEventMap<V, SP, SV, RV>[T]) => any,
        useCapture?: boolean,
    ): void;
...
export interface editableValueEventMap<V, SP extends editableValueSettableProperties<V, SV, RV>, SV = V, RV = V>
