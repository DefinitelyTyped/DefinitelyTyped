...
export interface DvtDiagramLayoutContextLink {
    ...
    setLabelPosition(pos: { x: number; y: number }): void;
    setLabelRotationAngle(angle: number): void;
    setLabelRotationPoint(point: { x: number; y: number }): void;
...
export interface ojDiagram<K1, K2, D1, D2> extends dvtBaseComponent<ojDiagramSettableProperties<K1, K2, D1, D2>> {
    ...
    focusRenderer:
        | ((
              context: ojDiagram.RendererContext<K1, D1>,
          ) => {
              insert: SVGElement;
          } | void)
        | null;
    ...
    tooltip: {
        renderer: (
            context: ojDiagram.TooltipContext<K1, K2, D1, D2>,
        ) =>
            | {
    ...
    onAnimationOnDataChangeChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['animationOnDataChange']>) => any)
        | null;
    onAnimationOnDisplayChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['animationOnDisplay']>) => any)
        | null;
    ...
    onHiddenCategoriesChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['hiddenCategories']>) => any)
        | null;
    onHighlightMatchChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['highlightMatch']>) => any)
        | null;
    onHighlightedCategoriesChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['highlightedCategories']>) => any)
        | null;
    ...
    onLinkHighlightModeChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['linkHighlightMode']>) => any)
        | null;
    ...
    onNodeHighlightModeChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['nodeHighlightMode']>) => any)
        | null;
    ...
    onPromotedLinkBehaviorChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['promotedLinkBehavior']>) => any)
        | null;
    ...
    onSelectionRendererChanged:
        | ((event: JetElementCustomEvent<ojDiagram<K1, K2, D1, D2>['selectionRenderer']>) => any)
        | null;
    ...
    addEventListener<T extends keyof ojDiagramEventMap<K1, K2, D1, D2>>(
        type: T,
        listener: (this: HTMLElement, ev: ojDiagramEventMap<K1, K2, D1, D2>[T]) => any,
        useCapture?: boolean,
    ): void;
    ...
    setProperty<T extends keyof ojDiagramSettableProperties<K1, K2, D1, D2>>(
        property: T,
        value: ojDiagramSettableProperties<K1, K2, D1, D2>[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojDiagramSettableProperties<K1, K2, D1, D2>>,
    ): void;
...
export namespace ojDiagram {
    interface ojBeforeCollapse
        extends CustomEvent<{
            nodeId: any;
            [propName: string]: any;
        }> {}
    interface ojBeforeExpand
        extends CustomEvent<{
            nodeId: any;
            [propName: string]: any;
        }> {}
    interface ojCollapse
        extends CustomEvent<{
            nodeId: any;
            [propName: string]: any;
        }> {}
...
export interface ojDiagramEventMap<K1, K2, D1, D2>
    extends dvtBaseComponentEventMap<ojDiagramSettableProperties<K1, K2, D1, D2>> {
...
export interface ojDiagramSettablePropertiesLenient<K1, K2, D1, D2>
    extends Partial<ojDiagramSettableProperties<K1, K2, D1, D2>> {
    [key: string]: any;
}
export interface ojDiagramLink extends JetElement<ojDiagramLinkSettableProperties> {
    ...
    addEventListener<T extends keyof ojDiagramLinkEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojDiagramLinkEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojDiagramLinkSettableProperties>(property: T): ojDiagramLink[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojDiagramLinkSettableProperties>(
        property: T,
        value: ojDiagramLinkSettableProperties[T],
    ): void;
...
export interface ojDiagramNode extends JetElement<ojDiagramNodeSettableProperties> {
    ...
    onDescendantsConnectivityChanged:
        | ((event: JetElementCustomEvent<ojDiagramNode['descendantsConnectivity']>) => any)
        | null;
    ...
    addEventListener<T extends keyof ojDiagramNodeEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojDiagramNodeEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojDiagramNodeSettableProperties>(property: T): ojDiagramNode[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojDiagramNodeSettableProperties>(
        property: T,
        value: ojDiagramNodeSettableProperties[T],
    ): void;
