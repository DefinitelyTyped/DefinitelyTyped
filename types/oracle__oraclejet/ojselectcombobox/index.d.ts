...
export interface ojCombobox<V, SP extends ojComboboxSettableProperties<V, SV, RV>, SV = V, RV = V>
    extends editableValue<V, SP, SV, RV>
{
    onOjAnimateEnd: ((event: ojCombobox.ojAnimateEnd) => any) | null;
    onOjAnimateStart: ((event: ojCombobox.ojAnimateStart) => any) | null;
    addEventListener<T extends keyof ojComboboxEventMap<V, SP, SV, RV>>(
        type: T,
        listener: (this: HTMLElement, ev: ojComboboxEventMap<V, SP, SV, RV>[T]) => any,
        useCapture?: boolean,
    ): void;
    ...
    setProperty<T extends keyof ojComboboxSettableProperties<V, SV, RV>>(
        property: T,
        value: ojComboboxSettableProperties<V, SV, RV>[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojComboboxSettableProperties<V, SV, RV>>,
    ): void;
...
export interface ojComboboxEventMap<V, SP extends ojComboboxSettableProperties<V, SV, RV>, SV = V, RV = V>
    extends editableValueEventMap<V, SP, SV, RV>
{
...
export interface ojComboboxSettablePropertiesLenient<V, SV, RV>
    extends Partial<ojComboboxSettableProperties<V, SV, RV>>
{
    [key: string]: any;
}
export interface ojComboboxMany<K, D>
    extends ojCombobox<any[] | null, ojComboboxManySettableProperties<K, D>, any[] | null, string>
{
    ...
    addEventListener<T extends keyof ojComboboxManyEventMap<K, D>>(
        type: T,
        listener: (this: HTMLElement, ev: ojComboboxManyEventMap<K, D>[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojComboboxManySettableProperties<K, D>>(property: T): ojComboboxMany<K, D>[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojComboboxManySettableProperties<K, D>>(
        property: T,
        value: ojComboboxManySettableProperties<K, D>[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojComboboxManySettableProperties<K, D>>,
    ): void;
...
export interface ojComboboxManyEventMap<K, D>
    extends ojComboboxEventMap<any[] | null, ojComboboxManySettableProperties<K, D>, any[] | null, string>
{
...
export interface ojComboboxManySettableProperties<K, D>
    extends ojComboboxSettableProperties<any[] | null, any[] | null, string>
{
    asyncValidators: Array<AsyncValidator<any[]>>;
    converter: Converter<any> | Validation.RegisteredConverter | null;
    minLength: number;
...
export interface ojComboboxOne<K, D> extends ojCombobox<any, ojComboboxOneSettableProperties<K, D>, any, string> {
    ...
    addEventListener<T extends keyof ojComboboxOneEventMap<K, D>>(
        type: T,
        listener: (this: HTMLElement, ev: ojComboboxOneEventMap<K, D>[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojComboboxOneSettableProperties<K, D>>(property: T): ojComboboxOne<K, D>[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojComboboxOneSettableProperties<K, D>>(
        property: T,
        value: ojComboboxOneSettableProperties<K, D>[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojComboboxOneSettableProperties<K, D>>,
    ): void;
...
export namespace ojComboboxOne {
    ...
    interface ojValueUpdated extends
        CustomEvent<{
            value: any;
            previousValue: any;
            [propName: string]: any;
...
export interface ojComboboxOneEventMap<K, D>
    extends ojComboboxEventMap<any, ojComboboxOneSettableProperties<K, D>, any, string>
{
...
export interface ojSelect<V, SP extends ojSelectSettableProperties<V, SV>, SV = V> extends editableValue<V, SP, SV> {
    ...
    addEventListener<T extends keyof ojSelectEventMap<V, SP, SV>>(
        type: T,
        listener: (this: HTMLElement, ev: ojSelectEventMap<V, SP, SV>[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojSelectSettableProperties<V, SV>>(property: T): ojSelect<V, SP, SV>[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojSelectSettableProperties<V, SV>>(
        property: T,
        value: ojSelectSettableProperties<V, SV>[T],
    ): void;
...
export interface ojSelectEventMap<V, SP extends ojSelectSettableProperties<V, SV>, SV = V>
    extends editableValueEventMap<V, SP, SV>
{
...
export interface ojSelectMany<K, D> extends ojSelect<any[] | null, ojSelectManySettableProperties<K, D>> {
    ...
    onMinimumResultsForSearchChanged:
        | ((event: JetElementCustomEvent<ojSelectMany<K, D>["minimumResultsForSearch"]>) => any)
        | null;
    ...
    addEventListener<T extends keyof ojSelectManyEventMap<K, D>>(
        type: T,
        listener: (this: HTMLElement, ev: ojSelectManyEventMap<K, D>[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojSelectManySettableProperties<K, D>>(property: T): ojSelectMany<K, D>[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojSelectManySettableProperties<K, D>>(
        property: T,
        value: ojSelectManySettableProperties<K, D>[T],
    ): void;
    setProperty<T extends string>(
        property: T,
        value: JetSetPropertyType<T, ojSelectManySettableProperties<K, D>>,
    ): void;
...
export interface ojSelectManyEventMap<K, D>
    extends ojSelectEventMap<any[] | null, ojSelectManySettableProperties<K, D>>
{
...
export interface ojSelectOne<K, D> extends ojSelect<any, ojSelectOneSettableProperties<K, D>> {
    ...
    onMinimumResultsForSearchChanged:
        | ((event: JetElementCustomEvent<ojSelectOne<K, D>["minimumResultsForSearch"]>) => any)
        | null;
    ...
    addEventListener<T extends keyof ojSelectOneEventMap<K, D>>(
        type: T,
        listener: (this: HTMLElement, ev: ojSelectOneEventMap<K, D>[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojSelectOneSettableProperties<K, D>>(property: T): ojSelectOne<K, D>[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojSelectOneSettableProperties<K, D>>(
        property: T,
        value: ojSelectOneSettableProperties<K, D>[T],
    ): void;
