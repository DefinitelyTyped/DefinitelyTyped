...
export interface ojValidationGroup extends JetElement<ojValidationGroupSettableProperties> {
    ...
    addEventListener<T extends keyof ojValidationGroupEventMap>(
        type: T,
        listener: (this: HTMLElement, ev: ojValidationGroupEventMap[T]) => any,
        useCapture?: boolean,
    ): void;
    addEventListener(type: string, listener: EventListenerOrEventListenerObject, useCapture?: boolean): void;
    getProperty<T extends keyof ojValidationGroupSettableProperties>(property: T): ojValidationGroup[T];
    getProperty(property: string): any;
    setProperty<T extends keyof ojValidationGroupSettableProperties>(
        property: T,
        value: ojValidationGroupSettableProperties[T],
    ): void;
