...
interface NodesRef {
     ...
     */
    boundingClientRect(callback: (result: NodeRect) => void): void;
    /**
     * 添加节点的滚动位置查询请求，以像素为单位
     */
    scrollOffset(callback: (result: NodeRect) => void): SelectorQuery;
    /**
     * 获取节点的相关信息，需要获取的字段在fields中指定
     */
    fields(fields: NodeField, callback: (result: NodeRect) => void): SelectorQuery;
}
