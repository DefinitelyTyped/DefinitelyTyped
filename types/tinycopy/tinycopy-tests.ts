...
new TinyCopy(trigger_1, target_1).on('success', function (data) {}).on('error', function (err) {});

var trigger_2 = document.getElementById('trigger_2');
var target_2 = 'test';
new TinyCopy(trigger_2, target_2).on('success', function (data) {}).on('error', function (err) {});
