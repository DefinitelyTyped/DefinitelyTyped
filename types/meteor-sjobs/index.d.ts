// Type definitions for Steve Jobs task scheduler for Meteor.js
...
declare module 'meteor/msavin:sjobs' {
    ...
    export type JobState = 'pending' | 'success' | 'failure';
    ...
    export interface CfgTimeObject {
        keyword: 'in' | 'on';
        year?: number;
        month?: number;
        day?: number;
    ...
    export interface JobRunConfigObject {
