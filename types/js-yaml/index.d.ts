...
// Definitions by: Bart van der Schoor <https://github.com/Bartvds>, Sebastian Clausen <https://github.com/sclausen>, Daniel Schmidt <https://github.com/DanielMSchmidt>
// Definitions: https://github.com/DefinitelyTyped/DefinitelyTyped
// TypeScript Version: 3.0

export as namespace jsyaml;

export type YamlValue = Record<string | number, unknown>;

export function safeLoad(str: string, opts?: LoadOptions): YamlValue;
export function load(str: string, opts?: LoadOptions): YamlValue;
...
export function safeLoadAll(str: string, iterator?: undefined, opts?: LoadOptions): YamlValue[];
export function safeLoadAll(str: string, iterator: (doc: any) => void, opts?: LoadOptions): void;

export function loadAll(str: string, iterator?: undefined, opts?: LoadOptions): YamlValue[];
