// Type definitions for 'Google Cloud User Accounts API' alpha
...
declare namespace gapi.client {
    ...
    export function load (name: "clouduseraccounts", version: "alpha") : PromiseLike<void>;    
    export function load (name: "clouduseraccounts", version: "alpha", callback: () => any) : void;    
