...
declare class Element {
    ...
    getChildrenByFilter(filter: (child: Element.Node) => boolean, recursive?: boolean): Element[];
    ...
    cnode<T extends Element.Node>(child: T): T;

    append(...nodes: Element.Node[]): void;

    prepend(...nodes: Element.Node[]): void;
