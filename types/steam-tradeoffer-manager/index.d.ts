...
declare class TradeOfferManager extends EventEmitter {
     ...
     */
    getOffers(filter: EOfferFilter, callback: (err: EResultError | null, sent: TradeOffer[], received: TradeOffer[]) => void): void;
     ...
     */
    getOffers(filter: EOfferFilter, historicalCutoff: Date | null, callback: (err: EResultError | null, sent: TradeOffer[], received: TradeOffer[]) => void): void;
