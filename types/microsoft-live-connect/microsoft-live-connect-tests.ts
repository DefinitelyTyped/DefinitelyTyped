    ...
    WL.login(login_props).then(
        function(response) {
            ...
            WL.api<Microsoft.Live.IFolder>(api_properties).then(
                function(response) {
                    document.getElementById("infoArea").innerText = "Created folder. Name: " + response.name + ", ID: "
                        + response.id;
                },
                function(responseFailed: Microsoft.Live.IError) {
                    document.getElementById("infoArea").innerText = "Error calling API: "
                        + responseFailed.error.message;
                },
            );
        },
        function(responseFailed: Microsoft.Live.IJSError) {
            document.getElementById("infoArea").innerText = "Error signing in: " + responseFailed.error_description;
        },
    );
}
                ...
                WL.login({
                    ...
                    function(response) {
                        WL.backgroundDownload({
                            ...
                            function(responseFailed: Microsoft.Live.IError) {
                                document.getElementById("infoLabel").innerText = "Error calling API: "
                                    + responseFailed.error.message;
                            },
                        );
                    },
                    function(responseFailed: Microsoft.Live.IError) {
                        document.getElementById("infoLabel").innerText = "Error signing in: "
                            + responseFailed.error.message;
                    },
                );
            } else {
    ...
    WL.login({
        ...
        function(response) {
            WL.download({
                ...
                function(responseFailed: Microsoft.Live.IError) {
                    document.getElementById("info").innerText = "Error downloading file: "
                        + responseFailed.error.message;
                },
            );
        },
        function(responseFailed: Microsoft.Live.IError) {
            document.getElementById("info").innerText = "Error signing in: " + responseFailed.error.message;
        },
    );
}
    ...
    WL.fileDialog({
        ...
        function(response) {
            WL.upload({
                ...
                function(responseFailed: Microsoft.Live.IError) {
                    document.getElementById("info").innerText = "Error uploading file: " + responseFailed.error.message;
                },
            );
        },
        function(responseFailed: Microsoft.Live.IError) {
            document.getElementById("info").innerText = "Error getting folder info: " + responseFailed.error.message;
        },
    );
}
...
function onSessionChange() {
    ...
    if (session) {
        document.getElementById("infoLabel").innerText = "Something about the session changed.";
    } else {
        document.getElementById("infoLabel").innerText = "Signed out or session error.";
    }
}
        ...
        function(response) {
            WL.api<Microsoft.Live.IUser>({
                ...
                function(response) {
                    ...
                    document.getElementById("birthday").innerText = response.birth_month + " " + response.birth_day
                        + " " + response.birth_year;
                },
                function(responseFailed: Microsoft.Live.IError) {
                    document.getElementById("infoArea").innerText = "Error calling API: "
...
function onUploadFileError(response: Microsoft.Live.IError) {
    document.getElementById("info").innerText = "Error getting folder info: " + response.error.message;
}
skyDriveProps = {
    name: "skydrivepicker",
...
function onDownloadFileError(responseFailed: Microsoft.Live.IError) {
    document.getElementById("info").innerText = "Error getting folder/file info: " + responseFailed.error.message;
}
