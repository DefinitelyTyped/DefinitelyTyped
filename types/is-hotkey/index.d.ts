...
export function isHotkey(hotkey: string | ReadonlyArray<string>, event: KeyboardEvent): boolean;

export function isHotkey(hotkey: string | ReadonlyArray<string>, options: HotKeyOptions, event: KeyboardEvent): boolean;
