...
declare module 'hapi' {
    ...
    interface FileHandlerObject extends FileHandlerOptions {
    ...
    interface RouteHandlerPlugins {
         ...
         */
        file?: string | RequestHandler<string> | FileHandlerObject;
        /**
         ...
         */
        directory?: DirectoryHandlerObject;
    }
    ...
    interface Base_Reply {
         ...
         */
        file: (path: string, options?: FileHandlerOptions) => Response;
    }
...
declare var inertPlugin: hapi.PluginFunction<OptionalRegistrationOptions>;
