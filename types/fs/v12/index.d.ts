 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function stat(path: PathLike, options: BigIntOptions, callback: (err: ErrnoException | null, stats: BigIntStats) => void): void;
export function stat(path: PathLike, options: StatOptions, callback: (err: ErrnoException | null, stats: Stats | BigIntStats) => void): void;
 ...
 */
export function mkdir(path: PathLike, options: number | string | MakeDirectoryOptions | undefined | null, callback: NoParamCallback): void;
 ...
 * @param fd A file descriptor.
 */
export function write<TBuffer extends ArrayBufferView>(fd: number, buffer: TBuffer, callback: (err: ErrnoException | null, written: number, buffer: TBuffer) => void): void;
 ...
 */
export function writeFile(path: PathLike | number, data: any, options: WriteFileOptions, callback: NoParamCallback): void;
 ...
 */
export function appendFile(file: PathLike | number, data: any, options: WriteFileOptions, callback: NoParamCallback): void;
...
export namespace writev {
    function __promisify__(fd: number, buffers: ReadonlyArray<ArrayBufferView>, position?: number): Promise<WriteVResult>;
}

/**
 * See `writev`.
 */
export function writevSync(fd: number, buffers: ReadonlyArray<ArrayBufferView>, position?: number): number;
...
export function opendir(path: string, cb: (err: ErrnoException | null, dir: Dir) => void): void;
export function opendir(path: string, options: OpenDirOptions, cb: (err: ErrnoException | null, dir: Dir) => void): void;
...
export namespace promises {
    interface FileHandle {
         ...
         */
        writev(buffers: ReadonlyArray<ArrayBufferView>, position?: number): Promise<WriteVResult>;
