...
export interface FileHandle {
     ...
     */
    readv(buffers: ReadonlyArray<ArrayBufferView>, position?: number): Promise<ReadVResult>;
 ...
 */
export function open(path: PathLike, flags: string | number, mode?: Mode): Promise<FileHandle>;
 ...
 */
export function read<TBuffer extends Uint8Array>(
    handle: FileHandle,
    buffer: TBuffer,
    offset?: number | null,
    length?: number | null,
 ...
 * @param position The offset from the beginning of the file where this data should be written. If not supplied, defaults to the current position.
 */
export function write<TBuffer extends Uint8Array>(
    handle: FileHandle,
    buffer: TBuffer,
    offset?: number | null,
 ...
 * @param encoding The expected string encoding.
 */
export function write(handle: FileHandle, string: string, position?: number | null, encoding?: BufferEncoding | null): Promise<{ bytesWritten: number, buffer: string }>;
 ...
 */
export function mkdir(path: PathLike, options: MakeDirectoryOptions & { recursive: true; }): Promise<string>;
 ...
 * should be created. If a string is passed, it is parsed as an octal integer. If not specified, defaults to `0o777`.
 */
export function mkdir(path: PathLike, options?: Mode | (MakeDirectoryOptions & { recursive?: false; }) | null): Promise<void>;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function readlink(path: PathLike, options?: BaseEncodingOptions | BufferEncoding | null): Promise<string>;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function readlink(path: PathLike, options?: BaseEncodingOptions | string | null): Promise<string | Buffer>;
 ...
 * @param handle A `FileHandle`.
 */
export function fstat(handle: FileHandle): Promise<Stats>;
 ...
 * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
 */
export function fchmod(handle: FileHandle, mode: Mode): Promise<void>;
 ...
 * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
 */
export function lchmod(path: PathLike, mode: Mode): Promise<void>;
 ...
 * @param mtime The last modified time. If a string is provided, it will be coerced to number.
 */
export function lutimes(path: PathLike, atime: string | number | Date, mtime: string | number | Date): Promise<void>;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function realpath(path: PathLike, options?: BaseEncodingOptions | BufferEncoding | null): Promise<string>;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function realpath(path: PathLike, options?: BaseEncodingOptions | BufferEncoding | null): Promise<string | Buffer>;
 ...
 * If `flag` is not supplied, the default of `'w'` is used.
 */
export function writeFile(path: PathLike | FileHandle, data: string | Uint8Array, options?: BaseEncodingOptions & { mode?: Mode, flag?: OpenMode } | BufferEncoding | null): Promise<void>;
 ...
 * If `flag` is not supplied, the default of `'a'` is used.
 */
export function appendFile(path: PathLike | FileHandle, data: string | Uint8Array, options?: BaseEncodingOptions & { mode?: Mode, flag?: OpenMode } | BufferEncoding | null): Promise<void>;
 ...
 * If a flag is not provided, it defaults to `'r'`.
 */
export function readFile(path: PathLike | FileHandle, options?: { encoding?: null, flag?: OpenMode } | null): Promise<Buffer>;
 ...
 * If a flag is not provided, it defaults to `'r'`.
 */
export function readFile(path: PathLike | FileHandle, options: { encoding: BufferEncoding, flag?: OpenMode } | BufferEncoding): Promise<string>;
 ...
 * If a flag is not provided, it defaults to `'r'`.
 */
export function readFile(path: PathLike | FileHandle, options?: BaseEncodingOptions & { flag?: OpenMode } | BufferEncoding | null): Promise<string | Buffer>;

export function opendir(path: string, options?: OpenDirOptions): Promise<Dir>;
