...
export type BinaryData = Buffer | ArrayBufferView;
export class Stats {
    isFile(): boolean;
    isDirectory(): boolean;
 ...
 * URL support is _experimental_.
 */
export function rename(oldPath: PathLike, newPath: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 */
export function truncate(path: PathLike, len: number | undefined | null, callback: (err: ErrnoException | null) => void): void;
 ...
 * URL support is _experimental_.
 */
export function truncate(path: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param len If not specified, defaults to `0`.
 */
export function ftruncate(fd: number, len: number | undefined | null, callback: (err: ErrnoException | null) => void): void;

/**
 * Asynchronous ftruncate(2) - Truncate a file to a specified length.
 * @param fd A file descriptor.
 */
export function ftruncate(fd: number, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function chown(path: PathLike, uid: number, gid: number, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param fd A file descriptor.
 */
export function fchown(fd: number, uid: number, gid: number, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function lchown(path: PathLike, uid: number, gid: number, callback: (err: ErrnoException | null) => void): void;
 ...
 */
export function chmod(path: PathLike, mode: string | number, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
 */
export function fchmod(fd: number, mode: string | number, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param mode A file mode. If a string is passed, it is parsed as an octal integer.
 */
export function lchmod(path: PathLike, mode: string | number, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function stat(path: PathLike, callback: (err: ErrnoException | null, stats: Stats) => void): void;
 ...
 * @param fd A file descriptor.
 */
export function fstat(fd: number, callback: (err: ErrnoException | null, stats: Stats) => void): void;
 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function lstat(path: PathLike, callback: (err: ErrnoException | null, stats: Stats) => void): void;
 ...
 * @param newPath A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function link(existingPath: PathLike, newPath: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 */
export function symlink(target: PathLike, path: PathLike, type: symlink.Type | undefined | null, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param path A path to the new symlink. If a URL is provided, it must use the `file:` protocol.
 */
export function symlink(target: PathLike, path: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function readlink(path: PathLike, options: { encoding: "buffer" } | "buffer", callback: (err: ErrnoException | null, linkString: Buffer) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function readlink(path: PathLike, options: { encoding?: string | null } | string | undefined | null, callback: (err: ErrnoException | null, linkString: string | Buffer) => void): void;

/**
 * Asynchronous readlink(2) - read value of a symbolic link.
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function readlink(path: PathLike, callback: (err: ErrnoException | null, linkString: string) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function realpath(path: PathLike, options: { encoding: "buffer" } | "buffer", callback: (err: ErrnoException | null, resolvedPath: Buffer) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function realpath(path: PathLike, options: { encoding?: string | null } | string | undefined | null, callback: (err: ErrnoException | null, resolvedPath: string | Buffer) => void): void;

/**
 * Asynchronous realpath(3) - return the canonicalized absolute pathname.
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function realpath(path: PathLike, callback: (err: ErrnoException | null, resolvedPath: string) => void): void;
...
export namespace realpath {
    ...
    function native(path: PathLike, options: { encoding: "buffer" } | "buffer", callback: (err: ErrnoException | null, resolvedPath: Buffer) => void): void;
    function native(path: PathLike, options: { encoding?: string | null } | string | undefined | null, callback: (err: ErrnoException | null, resolvedPath: string | Buffer) => void): void;
    function native(path: PathLike, callback: (err: ErrnoException | null, resolvedPath: string) => void): void;
}
 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function unlink(path: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function rmdir(path: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 */
export function mkdir(path: PathLike, options: number | string | MakeDirectoryOptions | undefined | null, callback: (err: ErrnoException | null) => void): void;

/**
 * Asynchronous mkdir(2) - create a directory with a mode of `0o777`.
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function mkdir(path: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 * should be created. If a string is passed, it is parsed as an octal integer. If not specified, defaults to `0o777`.
 */
export function mkdirSync(path: PathLike, options?: number | string | MakeDirectoryOptions | null): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function mkdtemp(prefix: string, options: { encoding?: BufferEncoding | null } | BufferEncoding | undefined | null, callback: (err: ErrnoException | null, folder: string) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function mkdtemp(prefix: string, options: "buffer" | { encoding: "buffer" }, callback: (err: ErrnoException | null, folder: Buffer) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function mkdtemp(prefix: string, options: { encoding?: string | null } | string | undefined | null, callback: (err: ErrnoException | null, folder: string | Buffer) => void): void;

/**
 * Asynchronously creates a unique temporary directory.
 * Generates six random characters to be appended behind a required prefix to create a unique temporary directory.
 */
export function mkdtemp(prefix: string, callback: (err: ErrnoException | null, folder: string) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function readdir(path: PathLike, options: { encoding: "buffer"; withFileTypes?: false } | "buffer", callback: (err: ErrnoException | null, files: Buffer[]) => void): void;
 ...
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function readdir(path: PathLike, callback: (err: ErrnoException | null, files: string[]) => void): void;
 ...
 */
export function readdir(path: PathLike, options: { encoding?: string | null; withFileTypes: true }, callback: (err: ErrnoException | null, files: Dirent[]) => void): void;
 ...
 * @param fd A file descriptor.
 */
export function close(fd: number, callback: (err: ErrnoException | null) => void): void;
 ...
 */
export function open(path: PathLike, flags: string | number, mode: string | number | undefined | null, callback: (err: ErrnoException | null, fd: number) => void): void;

/**
 * Asynchronous open(2) - open and possibly create a file. If the file is created, its mode will be `0o666`.
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function open(path: PathLike, flags: string | number, callback: (err: ErrnoException | null, fd: number) => void): void;
 ...
 */
export function utimes(path: PathLike, atime: string | number | Date, mtime: string | number | Date, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param mtime The last modified time. If a string is provided, it will be coerced to number.
 */
export function futimes(fd: number, atime: string | number | Date, mtime: string | number | Date, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param fd A file descriptor.
 */
export function fsync(fd: number, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param fd A file descriptor.
 */
export function write<TBuffer extends BinaryData>(fd: number, buffer: TBuffer, callback: (err: ErrnoException | null, written: number, buffer: TBuffer) => void): void;
 ...
 * @param position The offset from the beginning of the file where this data should be written. If not supplied, defaults to the current position.
 */
export function write(fd: number, string: any, position: number | undefined | null, callback: (err: ErrnoException | null, written: number, str: string) => void): void;
 ...
 * @param string A string to write. If something other than a string is supplied it will be coerced to a string.
 */
export function write(fd: number, string: any, callback: (err: ErrnoException | null, written: number, str: string) => void): void;
 ...
 */
export function read<TBuffer extends BinaryData>(
    fd: number,
    buffer: TBuffer,
    offset: number,
    length: number,
 ...
 */
export function readFile(path: PathLike | number, options: { encoding?: null; flag?: string; } | undefined | null, callback: (err: ErrnoException | null, data: Buffer) => void): void;
 ...
 * If a flag is not provided, it defaults to `'r'`.
 */
export function readFile(path: PathLike | number, options: { encoding: string; flag?: string; } | string, callback: (err: ErrnoException | null, data: string) => void): void;
 ...
 * If a file descriptor is provided, the underlying file will _not_ be closed automatically.
 */
export function readFile(path: PathLike | number, callback: (err: ErrnoException | null, data: Buffer) => void): void;
 ...
 */
export function writeFile(path: PathLike | number, data: any, options: WriteFileOptions, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param data The data to write. If something other than a Buffer or Uint8Array is provided, the value is coerced to a string.
 */
export function writeFile(path: PathLike | number, data: any, callback: (err: ErrnoException | null) => void): void;
 ...
 */
export function appendFile(file: PathLike | number, data: any, options: WriteFileOptions, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param data The data to write. If something other than a Buffer or Uint8Array is provided, the value is coerced to a string.
 */
export function appendFile(file: PathLike | number, data: any, callback: (err: ErrnoException | null) => void): void;
 ...
 * URL support is _experimental_.
 */
export function access(path: PathLike, mode: number | undefined, callback: (err: ErrnoException | null) => void): void;
 ...
 * URL support is _experimental_.
 */
export function access(path: PathLike, callback: (err: ErrnoException | null) => void): void;
 ...
 * @param fd A file descriptor.
 */
export function fdatasync(fd: number, callback: (err: ErrnoException | null) => void): void;
 ...
 */
export function copyFile(src: PathLike, dest: PathLike, callback: (err: ErrnoException | null) => void): void;
/**
 * Asynchronously copies src to dest. By default, dest is overwritten if it already exists.
 * No arguments other than a possible exception are given to the callback function.
 * Node.js makes no guarantees about the atomicity of the copy operation.
 ...
 */
export function copyFile(src: PathLike, dest: PathLike, flags: number, callback: (err: ErrnoException | null) => void): void;
