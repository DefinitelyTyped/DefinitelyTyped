 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function readlink(path: PathLike, options: BufferEncodingOption, callback: (err: ErrnoException | null, linkString: Buffer) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function readlink(path: PathLike, options: BaseEncodingOptions | string | undefined | null, callback: (err: ErrnoException | null, linkString: string | Buffer) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function realpath(path: PathLike, options: BufferEncodingOption, callback: (err: ErrnoException | null, resolvedPath: Buffer) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function realpath(path: PathLike, options: BaseEncodingOptions | string | undefined | null, callback: (err: ErrnoException | null, resolvedPath: string | Buffer) => void): void;
...
export namespace realpath {
    ...
    function native(path: PathLike, options: BufferEncodingOption, callback: (err: ErrnoException | null, resolvedPath: Buffer) => void): void;
    function native(path: PathLike, options: BaseEncodingOptions | string | undefined | null, callback: (err: ErrnoException | null, resolvedPath: string | Buffer) => void): void;
 ...
 */
export function mkdir(path: PathLike, options: MakeDirectoryOptions & { recursive: true }, callback: (err: ErrnoException | null, path: string) => void): void;
 ...
 * should be created. If a string is passed, it is parsed as an octal integer. If not specified, defaults to `0o777`.
 */
export function mkdir(path: PathLike, options: Mode | MakeDirectoryOptions | null | undefined, callback: (err: ErrnoException | null, path: string | undefined) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function mkdtemp(prefix: string, options: BaseEncodingOptions | BufferEncoding | undefined | null, callback: (err: ErrnoException | null, folder: string) => void): void;
 ...
 * @param options The encoding (or an object specifying the encoding), used as the encoding of the result. If not provided, `'utf8'` is used.
 */
export function mkdtemp(prefix: string, options: BaseEncodingOptions | string | undefined | null, callback: (err: ErrnoException | null, folder: string | Buffer) => void): void;
 ...
 */
export function readdir(path: PathLike, options: BaseEncodingOptions & { withFileTypes: true }, callback: (err: ErrnoException | null, files: Dirent[]) => void): void;
 ...
 */
export function open(path: PathLike, flags: OpenMode, mode: Mode | undefined | null, callback: (err: ErrnoException | null, fd: number) => void): void;

/**
 * Asynchronous open(2) - open and possibly create a file. If the file is created, its mode will be `0o666`.
 * @param path A path to a file. If a URL is provided, it must use the `file:` protocol.
 */
export function open(path: PathLike, flags: OpenMode, callback: (err: ErrnoException | null, fd: number) => void): void;
 ...
 * @param position The offset from the beginning of the file where this data should be written. If not supplied, defaults to the current position.
 */
export function write(fd: number, string: string, position: number | undefined | null, callback: (err: ErrnoException | null, written: number, str: string) => void): void;
 ...
 * @param string A string to write.
 */
export function write(fd: number, string: string, callback: (err: ErrnoException | null, written: number, str: string) => void): void;
 ...
 */
export function readSync(fd: number, buffer: ArrayBufferView, opts?: ReadSyncOptions): number;
 ...
 * If a flag is not provided, it defaults to `'r'`.
 */
export function readFile(path: PathLike | number, options: { encoding: BufferEncoding; flag?: string; } | string, callback: (err: ErrnoException | null, data: string) => void): void;
 ...
 */
export function writeFile(path: PathLike | number, data: string | ArrayBufferView, options: WriteFileOptions, callback: NoParamCallback): void;
 ...
 * @param data The data to write. If something other than a Buffer or Uint8Array is provided, the value is coerced to a string.
 */
export function writeFile(path: PathLike | number, data: string | ArrayBufferView, callback: NoParamCallback): void;
...
export namespace writeFile {
     ...
     * If `flag` is not supplied, the default of `'w'` is used.
     */
    function __promisify__(path: PathLike | number, data: string | ArrayBufferView, options?: WriteFileOptions): Promise<void>;
}
 ...
 * If `flag` is not supplied, the default of `'w'` is used.
 */
export function writeFileSync(path: PathLike | number, data: string | ArrayBufferView, options?: WriteFileOptions): void;
...
export namespace readv {
    function __promisify__(fd: number, buffers: ReadonlyArray<ArrayBufferView>, position?: number): Promise<ReadVResult>;
}

/**
 * See `readv`.
 */
export function readvSync(fd: number, buffers: ReadonlyArray<ArrayBufferView>, position?: number): number;
