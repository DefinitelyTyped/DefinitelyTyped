...
chart2.on('draw', (data: any) => {
    ...
    if (data.type === 'point') {
        ...
        var triangle = new Chartist.Svg(
            'path',
            {
                d: ['M', data.x, data.y - 15, 'L', data.x - 15, data.y + 8, 'L', data.x + 15, data.y + 8, 'z'].join(
                    ' '
                ),
...
var biPolarChart = new Chartist.Bar(
    '.ct-chart',
    {
...
new Chartist.Candle(
    ...
    {
        labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
        series: [[5, 4, 3, 7], [3, 2, 9, 5], [5, 4, 3, 7], [3, 2, 9, 5], [5, 4, 3, 7], [3, 2, 9, 5], [3, 2, 9, 5]],
    },
    {
        axisX: {
            labelOffset: {
...
new Chartist.Bar(
    '.ct-chart',
    {
        ...
        series: [
            ...
            [{ value: 7 }, { value: 6 }, { value: 5 }, { value: 4 }, { value: 3 }, { value: 2 }, { value: 1 }],
        ],
    },
    {}
);
