...
export interface ConnectorDescription<TProvided, TExposed> {
     ...
     */
    cleanUp?(this: React.Component<TExposed> & ConnectedWidget, props: TExposed, searchState: SearchState): SearchState;
}
...
export interface RefinementListProvided {
     ...
     */
    items: Array<
        { count: number; isRefined: boolean; label: string; value: string[] } & Partial<
            Pick<Hit<{ value: string }>, '_highlightResult'>
        >
    >;
