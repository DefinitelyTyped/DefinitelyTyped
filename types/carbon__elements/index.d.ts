...
export function rgba(hexcode: any, opacity: any): string;
export const teal: {
    '10': '#d9fbfb';
    '20': '#9ef0f0';
    '30': '#3ddbd9';
...
export function fluid(selector: any): any;
...
export function fontFamily(name: any): {
    fontFamily: any;
};
export function fontWeight(weight: any): {
    fontWeight: any;
};
...
export function print(block: any): string;
export const reset: {
    html: {
        fontSize: '16px';
    };
...
export function breakpoint(): any;
export function breakpointDown(name: any): string;
export function breakpointUp(name: any): string;
...
export const borderSubtle01: '#e0e0e0';
export const borderSubtle02: '#e0e0e0';
export const borderSubtle03: '#e0e0e0';
...
export const g100: {
    ...
    borderSubtle01: '#393939';
    borderSubtleSelected01: '#525252';
    borderSubtle02: '#525252';
    borderSubtleSelected02: '#6f6f6f';
