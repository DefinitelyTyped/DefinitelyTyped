...
declare module "splunk-sdk" {
    ...
    type TaskCallbackFn<T> = DoneCallbackFn<(err: Error | null, ...taskResults: T[]) => void>;
    ...
    type Namespace = Partial<{ user: string; owner: string; app: string; sharing: string; }>
    ...
    module Async {
         ...
         *
         */
        function whilst(condition: () => boolean, body: (done: (res?: any) => void) => void, callback: (err: Error | null) => void): void;
         ...
         *
         */
        function parallelMap<P, N>(vals: ReadonlyArray<N>, fn: (done: (prev: P, next: N) => void) => void, callback: (err: Error | null, vals: ReadonlyArray<P>) => void): void;
         ...
         *
         */
        function seriesMap<P, N>(vals: ReadonlyArray<N>, fn: (done: (prev: P, next: N) => void) => void, callback: (err: Error | null, vals: ReadonlyArray<P>) => void): void;
         ...
         *
         */
        function parallelEach<N>(vals: N[], fn: (val: N, idx: number, done: VoidProvider) => void, callback: (err: Error | null) => void): void;
         ...
         *
         */
        function seriesEach<N>(vals: N[], fn: (val: N, idx: number, don: VoidProvider) => void, callback: (err: Error | null) => void): void;
         ...
         *
         */
        function chain(tasks: ((...params: any[]) => void)[], callback: (err: Error | null, ...results: any[]) => void): void;
    ...
    export class Context {
         ...
         */
        _requestWrapper(task: (...params: any[]) => any, callback: (...params: any[]) => any): void;
         ...
         *
         */
        get(path: string, params: Params, callback: (err: Error | null, ...params: any[]) => void): void;
         ...
         *
         */
        del(path: string, params: Params, callback: (err: Error | null, response: any) => void): void;
         ...
         *
         */
        post(path: string, params: Params, callback: (err: Error | null, response: any) => void): void;
         ...
         *
         */
        request(path: string, method: "GET" | "POST" | "DELETE", query: any, post: any, body: any, headers: any, callback: (err: Error | null, response: any) => void): void;
    ...
    export class Http {
         ...
         *
         */
        get(url: string, headers: any, params: Params, timeout: number, callback: (err: Error | null, response: any) => void): void;
         ...
         *
         */
        post(url: string, headers: any, params: Params, timeout: number, callback: (err: Error | null, response: any) => void): void;
         ...
         *
         */
        del(url: string, headers: any, params: Params, timeout: number, callback: (err: Error | null, response: any) => void): void;
         ...
         * @see makeRequest
         */
        request(url: string, message: any, callback: (err: Error | null, response: any) => void): void;
         ...
         *
         */
        makeRequest(url: string, message: any, callback: (err: Error | null, response: any) => void): void;
    ...
    export namespace ModularInputs {
        ...
        export class ModularInput {
             ...
             *
             */
            static runScript(exports: any, args: any[], eventWriter: any, inputStream: any, callback: (err: Error | null, status: any) => void): void;
            /**
             ...
             *
             */
            start(name: string, definition: InputDefinition, done: (err: Error | null) => void): void;
            /**
             ...
             *
             */
            end(name: string, definition: InputDefinition, done: (err: Error | null) => void): void;
    ...
    module Utils {
         ...
         *
         */
        function bind(me: any, fn: (...params: any[]) => any): (...params: any[]) => any;
         ...
         *
         */
        function forEach(obj: any | any[], iterator: (...params: any[]) => any, context?: any): void;
    ...
    type SearchParams = Partial<{ search: string; } & {
        auto_cancel: number;
    ...
    type OneshotSearchParams = Partial<OutputMode & Pick<SearchParams, "rf" | "earliest_time" | "latest_time">>;
    ...
    export class Service extends Context {
         ...
         * 
         */
        search(query: string, params: SearchParams, namespace: Namespace, callback: (err: Error | null, job: Service.Job) => void): void;
        ...
        * 
        */
        search(query: string, params: SearchParams, callback: (err: Error | null, createdJob: Service.Job) => void): void;
         ...
         * 
         */
        getJob(sid: string, namespace: Namespace, callback: (err: Error | null, job: Service.Job) => void): void;
         ...
         * 
         */
        getJob(sid: string, callback: (err: Error | null, job: Service.Job) => void): void;
         ...
         * 
         */
        oneshotSearch(query: string, params: OneshotSearchParams, callback: (err: Error | null, results: { [key: string]: any }) => void): void;
         ...
         * 
         */
        currentUser(callback: (err: Error | null, user: Service.User) => void): void;
         ...
         * 
         */
        serverInfo(callback: (err: Error | null, info: Service.ServerInfo) => void): void;
         ...
         * 
         */
        parse(query: string, params: Partial<OutputMode & { enable_lookups: boolean; parse_only: boolean; reload_macros: boolean; }>, callback: (err: Error | null, parse: any) => void): void;
         ...
         * 
         */
        typeahead(prefix: string, count: number, callback: (err: Error | null, options: any) => void): void;
         ...
         * 
         */
        log(event: string | any, params: Partial<{
            index: string;
            host: string;
            host_regex: string;
            source: string;
    ...
    export namespace Service {
        type ServerLicense = "Enterprise" | "Forwarder" | "Free" | "Invalid" | "Trial";
        ...
        export class Endpoint extends Class {
             ...
             * 
             */
            constructor(service: Service, qualifiedPath: string, namespace?: Namespace);
             ...
             * 
             */
            get(relpath: string, params: Params, callback: (err: Error | null, response: any) => void): void;
             ...
             * 
             */
            post(relpath: string, params: Params, callback: (err: Error | null, response: any) => void): void;
             ...
             * 
             */
            del(relpath: string, params: Params, callback: (err: Error | null, response: any) => void): void;
        }
        ...
        export class Resource<K> extends Endpoint {
             ...
             * @protected
             */
            protected fetch(options: any, callback: (err: Error | null, resource: K) => void): void;
        ...
        export class Entity<K> extends Resource<K> {
             ...
             * 
             */
            constructor(service: Service, path: string, namespace?: Namespace, options?: any);
             ...
             * 
             */
            fetch(options: any, callback: (err: Error | null, entity: K) => void): void;
        ...
        export class Collection<K, L> extends Resource<Collection<K, L>> {
             ...
             * 
             */
            fetch(options: Partial<{ count: number; offset: number; search: string; sort_dir: string; sort_key: string; sort_mode: string; }>, callback: (err: Error | null, resource: Collection<K, L>) => void): void;
             ...
             * 
             */
            fetch(callback: (err: Error | null, resource: Collection<K, L>) => void): void;
        ...
        export class SavedSearch extends Entity<SavedSearch> {
             ...
             * 
             */
            acknowledge(callback: (err: Error | null, savedSearch: SavedSearch) => void): void;
            /**
             ...
             * 
             */
            dispatch(options: Partial<{ dispatch: { now: string;[key: string]: string; }; trigger_actions: boolean; force_dispatch: boolean; }>, callback: (err: Error | null, job: Job, savedSearch: SavedSearch) => void): void;
             ...
             * 
             */
            history(callback: (err: Error | null, job: Job, savedSearch: SavedSearch) => void): void;
             ...
             * 
             */
            suppressInfo(callback: (err: Error | null, suppressionState: any, search: SavedSearch) => void): void;
             ...
             * 
             */
            update(props: any, callback: (err: Error | null, entity: SavedSearch) => void): void;
        }
         ...
         * @extends Collection
         */
        export class SavedSearches extends Collection<SavedSearch, SavedSearchParams> {
            /**
             * Retrieves the REST endpoint path for this resource (with no namespace).
             *
             * 
         ...
         * @extends Collection
         */
        export class StoragePasswords extends Collection<StoragePassword, StoragePasswordParams> {
            /**
             * Retrieves the REST endpoint path for this resource (with no namespace).
             */
            path(): string;
        ...
        export class FiredAlertGroup extends Entity<FiredAlertGroup> {
             ...
             * 
             */
            list(callback: (err: Error | null, firedAlerts: ReadonlyArray<FiredAlert>, alertGroup: FiredAlertGroup) => void): void;
         ...
         */
        export class FiredAlertGroupCollection extends Collection<FiredAlertGroup, FiredAlertGroupParams> {
            /**
             * Retrieves the REST endpoint path for this resource (with no namespace).
             */
            path(): string;
        ...
        export class Application extends Entity<Application> {
             ...
             * 
             */
            setupInfo(callback: (err: Error | null, info: any, app: Application) => any): void;
             ...
             * 
             */
            updateInfo(callback: (err: Error | null, info: any, app: Application) => any): void;
        }
         ...
         * @extends Collection
         */
        export class Applications extends Collection<Application, ApplicationParams> {
            /**
        ...
        export class Users extends Collection<User, UserParams> {
             ...
             * 
             */
            create(params: UserParams, callback: (err: Error | null, createdUser: User) => void): void;
        }
        ...
        export class Index extends Entity<Index> {
             ...
             * 
             */
            submitEvent(event: string, params: Params, callback: (err: Error | null, result: any, index: Index) => void): void;
        }
        ...
        export class Indexes extends Collection<Index, IndexParams> {
             ...
             * 
             */
            create(params: IndexParams, callback: (err: Error | null, index: Index) => void): void;
            create(name: string, params: IndexParams, callback: (err: Error | null, index: Index) => void): void;
        }
        ...
        export class ConfigurationStanza extends Entity<ConfigurationStanza> {
             ...
             * 
             */
            constructor(service: Service, file: string, name: string, namespace?: Namespace);
         ...
         */
        export class ConfigurationFile extends Collection<ConfigurationStanza, ConfigurationStanzaParams> {
            /**
             * Retrieves the REST endpoint path for this resource (with no namespace).
             *
             * 
             ...
             * 
             */
            create(values: ConfigurationStanzaParams, callback: (err: Error | null, created: ConfigurationStanza) => void): void;
            create(stanzaName: string, values: ConfigurationStanzaParams, callback: (err: Error | null, created: ConfigurationStanza) => void): void;
        }
         ...
         * @extends Collection
         */
        export class Configurations extends Collection<ConfigurationFile, ConfigurationFileParams> {
            /**
             ...
             * 
             */
            create(callback: (err: Error | null, created: ConfigurationFile) => void): void;
            create(filename: string, callback: (err: Error | null, created: ConfigurationFile) => void): void;
        }
        ...
        export class Job extends Entity<Job> {
             ...
             * 
             */
            results(params: Params, callback: (err: Error | null, results: { [key: string]: any }, job: Job) => void): void;
            ...
            track(
                ...
                callbacks:
                    Partial<{
                        ...
                        failed: (job: Job) => void;
                        error: (err: Error | null, done: (...args: any[]) => void) => void;
                    }> | ((job: Job) => void)
            ): void;
        ...
        export class Jobs extends Collection<Job, JobParams> {
             ...
             * 
             */
            search(query: string, params: SearchParams, callback: (err: Error | null, job: Job) => void): void;
             ...
             * 
             */
            oneshotSearch(query: string, params: OneshotSearchParams, callback: (err: Error | null, results: Results) => void): void;
            ...
            /**
              ...
              * 
              */
            create(params: JobParams, callback: (err: Error | null, job: Job) => void): void;
            create(query: string, params: JobParams, callback: (err: Error | null, job: Job) => void): void;
            ...
            /**
                  ...
                  * 
                  */
            create(query: string, callback: (err: Error | null, job: Job) => void): void;
        }
        ...
        export class PivotSpecification {
             ...
             * 
             */
            addFilter(fieldName: string, comparisonType: string, comparisonOp: string, compareTo: string): PivotSpecification;
            /**
             ...
             * 
             */
            addLimitFilter(fieldName: string, sortAttribute: string, sortDirection: string, limit: string, statsFunction: string): PivotSpecification;
            /**
             ...
             * 
             */
            addRangeRowSplit(fieldName: string, label: string, options: any): PivotSpecification;
            /**
             ...
             * 
             */
            addBooleanRowSplit(fieldName: string, label: string, trueDisplayValue: string, falseDisplayValue: string): PivotSpecification;
            /**
             ...
             * 
             */
            addTimestampRowSplit(fieldName: string, label: string, binning: string): PivotSpecification;
            /**
            ...
            addRangeColumnSplit(
                fieldName: string,
                options: Partial<{ start: number; end: number; step: number; limit: number; }>
            ): PivotSpecification;
             ...
             * 
             */
            addBooleanColumnSplit(fieldName: string, trueDisplayValue: string, falseDisplayValue: string): PivotSpecification;
            /**
             ...
             * 
             */
            addTimestampColumnSplit(fieldName: string, binning: string): PivotSpecification;
            /**
             ...
             * 
             */
            addCellValue(fieldName: string, label: string, statsFunction: string): PivotSpecification;
            /**
    ...
    */
        ...
        export class DataModelObject {
             ...
             * 
             */
            createLocalAccelerationJob(earliestTime: string, callback: (...params: any[]) => any): void;
            /**
             ...
             * 
             */
            startSearch(params: Params, querySuffix: string, callback: (...params: any[]) => any): void;
            /**
        ...
        export class DataModel extends Entity<DataModel> {
           ...
           * 
           */
            constructor(service: Service, name: string, namespace: Namespace, props?: any);
             ...
             * 
             */
            update(props: any, callback: (err: Error | null, dataModel: DataModel) => void): void;
        }
        ...
        export class DataModels extends Collection<DataModel, DataModelParams> {
             ...
             * 
             */
            create(name: string, params: DataModelParams, callback: (err: Error | null, dataModel: DataModel) => void): void;
             ...
             *
             */
            create(params: DataModelParams, callback: (err: Error | null, created: DataModel) => void): void;
