...
// Project: https://github.com/splunk/splunk-sdk-javascript
    ...
    export namespace Service {
        ...
        export class SavedSearch extends Entity<SavedSearch> {
            ...
            dispatch(
                ...
                callback: (err: Error | null, job: Job, savedSearch: SavedSearch) => void,
            ): void;
        ...
        export class Job extends Entity<Job> {
            ...
            results(
                params: Params,
                callback: (err: Error | null, results: { [key: string]: any }, job: Job) => void,
            ): void;
        ...
        export class DataModels extends Collection<DataModel, DataModelParams> {
            ...
            /**
             * @deprecated
             * This method is not included within the SDK but necessary for correct OOP.
             *
             * @param {Object} params A dictionary of properties.
             * @param {Function} callback A function to call with the new `DataModel` object: `(err, createdDataModel)`.
             */
            create(params: DataModelParams, callback: (err: Error | null, created: DataModel) => void): never;
