...
declare class OSRM {
     ...
     */
    route(options: RouteOptions, callback: (err: Error, results: RouteResults) => void): void;
    /**
     * returns the nearest street segment for a given coordinate
     */
    nearest(options: NearestOptions, callback: (err: Error, results: NearestResults) => void): void;

    /**
     * computes distance tables for given coordinates
     */
    table(options: TableOptions, callback: (err: Error, results: TableResults) => void): void;
    /**
     * matches given coordinates to the road network
     */
    match(options: MatchOptions, callback: (err: Error, results: MatchResults) => void): void;
    /**
     * Compute the shortest trip between given coordinates
     */
    trip(options: TripOptions, callback: (err: Error, results: TripResults) => void): void;
    /**
     * Return vector tiles containing debugging info
     */
    tile(options: TileOptions | Tile, callback: (err: Error, results: Buffer) => void): void;
}
