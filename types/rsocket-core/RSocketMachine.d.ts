...
import {ISubject, ISubscription, ISubscriber } from 'rsocket-types';
...
export declare type Role = 'CLIENT' | 'SERVER';

declare class ResponderWrapper<D, M> implements Responder<D, M> {
...
export declare interface RSocketMachine<D, M> extends ReactiveSocket<D, M> {
  setRequestHandler(requestHandler?: PartialResponder<D, M>): void,
}

export declare function createServerMachine<D, M>(
...
export declare function createClientMachine<D, M>(
  connection: DuplexConnection,
  connectionPublisher: (partialSubscriber: Partial<ISubscriber<Frame>>) => void,
  serializers?: PayloadSerializers<D, M>,
  requestHandler?: PartialResponder<D, M>,
...
declare class RSocketMachineImpl<D, M> implements RSocketMachine<D, M> {
...
export declare function deserializePayload<D, M>(
  serializers: PayloadSerializers<D, M>,
  frame: FrameWithData,
): Payload<D, M>
