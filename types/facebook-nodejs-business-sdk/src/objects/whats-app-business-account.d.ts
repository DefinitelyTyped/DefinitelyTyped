...
export default class WhatsAppBusinessAccount extends AbstractCrudObject {
    ...
    createAssignedUser(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<WhatsAppBusinessAccount>;
    ...
    createFlow(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    ...
    createMessageTemplate(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<WhatsAppBusinessAccount>;
    createMigrateMessageTemplate(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<WhatsAppBusinessAccount>;
    getPhoneNumbers(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createPhoneNumber(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    ...
    createProductCatalog(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    getSchedules(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createSetOboMobilityIntent(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    ...
    createSubscribedApp(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<WhatsAppBusinessAccount>;
    ...
    createUpsertMessageTemplate(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<WhatsAppBusinessAccount>;
