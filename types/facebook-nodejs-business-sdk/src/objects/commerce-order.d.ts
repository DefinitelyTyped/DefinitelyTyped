...
export default class CommerceOrder extends AbstractCrudObject {
    ...
    createAcknowledgeOrder(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
    getCancellations(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createCanCellATIOn(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
    createItemUpdate(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
    ...
    createRefund(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
    getReturns(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createReturn(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
    getShipments(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createShipment(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
    createUpdateShipment(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
    createUpdate(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceOrder>;
