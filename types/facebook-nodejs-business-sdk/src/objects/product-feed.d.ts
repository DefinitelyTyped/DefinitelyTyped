...
export default class ProductFeed extends AbstractCrudObject {
    ...
    getRules(fields: string[], params?: Record<any, any>, fetchFirstPage?: boolean): Cursor | Promise<any>;
    ...
    getUploadSchedules(fields: string[], params?: Record<any, any>, fetchFirstPage?: boolean): Cursor | Promise<any>;
    createUploadSchedule(fields: string[], params?: Record<any, any>, pathOverride?: string | null): Promise<ProductFeed>;
    getUploads(fields: string[], params?: Record<any, any>, fetchFirstPage?: boolean): Cursor | Promise<any>;
    ...
    get(fields: string[], params?: Record<any, any>): ProductFeed;
