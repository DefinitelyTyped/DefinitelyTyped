...
export default class EventRequest {
     ...
     */
    constructor(access_token: string, pixel_id: string, page_id: string, events?: Array<SignalEvent>, partner_agent?: string | null, test_event_code?: string | null, namespace_id?: string | null, upload_id?: string | null, upload_tag?: string | null, upload_source?: string | null, debug_mode_flag?: boolean, http_service?: HttpServiceInterface | null);
    /**
