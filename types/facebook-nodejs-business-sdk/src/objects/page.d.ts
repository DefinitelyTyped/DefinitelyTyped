...
export default class Page extends AbstractCrudObject {
    ...
    createAbTest(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<PagePostExperiment>;
    createAcknowledgeOrder(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createAgency(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createAssignedUser(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createBlocked(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    createBusinessDatum(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    ...
    createCall(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    getCanvasElements(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createCanvasElement(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CanvasBodyElement>;
    getCanvases(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createCanvase(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Canvas>;
    getChatPlugin(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createChatPlugin(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createCopyrightManualClaim(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<VideoCopyrightMatch>;
    ...
    createCustomLabel(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<PageUserMessageThreadLabel>;
    ...
    createCustomUserSetting(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    getDataSet(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createDataSet(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AdsPixel>;
    getEvents(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createExtendThreadControl(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createFeed(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createImageCopyright(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ImageCopyright>;
    ...
    createLeadGenForm(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<LeadgenForm>;
    ...
    createLiveVideo(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<LiveVideo>;
    ...
    createLocation(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    getMediaFingerprints(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createMediaFingerprint(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<MediaFingerprint>;
    createMessageAttachMEnt(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    createMessage(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createMessengerCallSetting(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    getMessengerLeadForMs(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createMessengerLeadForM(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createMessengerProfile(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    createNlpConfig(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    getNotificationMessageTokens(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createNotificationMessagesDevSupport(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    getPageBackedInstagramAccounts(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createPageBackedInstagramAccount(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<InstagramUser>;
    createPageWhatsAppNumberVerification(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    createPassThreadControl(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    createPassThreadMetadatum(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    getPersonas(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createPersona(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Persona>;
    createPhotoStory(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createPicture(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProfilePictureSource>;
    ...
    createReleaseThreadControl(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    createRequestThreadControl(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createSetting(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createSubscribedApp(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createTakeThreadControl(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    createThreadAction(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    ...
    createUnlinkAccount(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Page>;
    getVideoCopyrightRules(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createVideoCopyrightRule(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<VideoCopyrightRule>;
    createVideoCopyright(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<VideoCopyright>;
    ...
    createVideoReel(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AdVideo>;
    createVideoStory(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    getVideos(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createVideo(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AdVideo>;
    ...
    createWelcomeMessageFlow(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
