...
export default class ProductCatalog extends AbstractCrudObject {
    ...
    createAgency(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    ...
    createAssignedUser(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    getAutomotiveModels(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createBatch(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    createCatalogStore(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<StoreCatalogSettings>;
    getCategories(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createCategory(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalogCategory>;
    ...
    createCpasLsbImageBank(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CPASLsbImageBank>;
    ...
    createExternalEventSource(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    ...
    createHomeListing(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<HomeListing>;
    getHotelRoomsBatch(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createHotelRoomsBatch(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    getHotels(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createHotel(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Hotel>;
    createItemsBatch(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    createLocalizedItemsBatch(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    getPricingVariablesBatch(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createPricingVariablesBatch(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    getProductFeeds(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createProductFeed(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductFeed>;
    getProductGroups(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createProductGroup(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductGroup>;
    getProductSets(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createProductSet(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductSet>;
    ...
    createProduct(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductItem>;
    ...
    createVehicle(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Vehicle>;
    createVersionItemsBatch(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
