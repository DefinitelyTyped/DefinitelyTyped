...
export default class CommerceMerchantSettings extends AbstractCrudObject {
    ...
    createAcknowledgeOrder(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceMerchantSettings>;
    ...
    createOrderMAnAgeMEntApp(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CommerceMerchantSettings>;
    ...
    createShippingProfile(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
