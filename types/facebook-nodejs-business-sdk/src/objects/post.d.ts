...
export default class Post extends AbstractCrudObject {
    ...
    createLike(fields: Array<string>, params?: Record<any, any>, pathOverride?: string | null): Promise<Post>;
    ...
    get(fields: Array<string>, params?: Record<any, any>): Post;
    update(fields: Array<string>, params?: Record<any, any>): Post;
}
