...
export default class User extends AbstractCrudObject {
    ...
    createAccessToken(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<User>;
    ...
    createApplication(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<User>;
    ...
    createBusiness(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createFeed(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Post>;
    ...
    createFundraiser(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<FundraiserPersonToCharity>;
    ...
    createMessengerDesktopPerformanceTrace(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<User>;
    getMusic(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createNotification(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<User>;
    ...
    createStagingResource(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<User>;
