...
export default class BusinessAssetGroup extends AbstractCrudObject {
    ...
    createAssignedUser(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
    ...
    createContainedAdAccount(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
    ...
    createContainedApplication(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
    ...
    createContainedCustomConversion(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
    ...
    createContainedInstagramAccount(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
    ...
    createContainedPage(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
    ...
    createContainedPixel(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
    ...
    createContainedProductCatalog(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessAssetGroup>;
