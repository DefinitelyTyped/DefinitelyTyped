...
export default class IGUserExportForCAM extends AbstractCrudObject {
    ...
    static get CreatorCountries(): Readonly<{
        ac: "AC";
        ad: "AD";
        ae: "AE";
        af: "AF";
    ...
    static get CreatorGender(): Readonly<{
        custom: "custom";
        female: "female";
        male: "male";
        unknown: "unknown";
    }>;
    static get MajorAudienceCountries(): Readonly<{
        ac: "AC";
        ad: "AD";
        ae: "AE";
        af: "AF";
    ...
    static get MajorAudienceGender(): Readonly<{
        custom: "custom";
        female: "female";
        male: "male";
        unknown: "unknown";
    }>;
    getBrandedContentMedia(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
