...
export default class Business extends AbstractCrudObject {
    ...
    static get BusinessVertical(): Readonly<{
    ...
    createBmReviewRequest(fields: string[], params?: Record<string, any>, pathOverride?: string | null): Promise<AbstractObject>;
    ...
    createSelfCertifyWhatsAppBusiness(fields: string[], params?: Record<string, any>, pathOverride?: string | null): Promise<Business>;
