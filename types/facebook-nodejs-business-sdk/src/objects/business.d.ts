...
export default class Business extends AbstractCrudObject {
    ...
    createAccessToken(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createAdStudy(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AdStudy>;
    createAdAccount(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AdAccount>;
    createAddPhoneNumber(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    createAdNetworkApplication(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Application>;
    getAdNetworkAnalytics(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createAdNetworkAnalytic(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createAdsPixel(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AdsPixel>;
    ...
    createBlockListDraft(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createBusinessUser(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessUser>;
    getBusinessProjects(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createClaimCustomConversion(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CustomConversion>;
    ...
    createClientApp(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createClientPage(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createCollaborativeAdsCollaborationRequest(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CPASCollaborationRequest>;
    ...
    createCpasBusinessSetupConfig(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CPASBusinessSetupConfig>;
    getCpasMerchantConfig(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createCreativeFolder(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessCreativeFolder>;
    getCreditCards(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createCustomConversion(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<CustomConversion>;
    createDraftNegativeKeywordList(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    getEventSourceGroups(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createEventSourceGroup(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<EventSourceGroup>;
    ...
    createImage(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<BusinessImage>;
    ...
    createMAnAgeDBusiness(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    createMAnAgeDPartnerBusinessSetup(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    deleteMAnAgeDPartnerBusinesses(params?: Record<string, any>): Promise<any>;
    createMAnAgeDPartnerBusiness(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    ...
    createOpenBridgeConfiguration(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<OpenBridgeConfiguration>;
    getOwnedAdAccounts(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createOwnedAdAccount(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    getOwnedApps(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createOwnedApp(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createOwnedBusiness(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createOwnedPage(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    ...
    createOwnedProductCatalog(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<ProductCatalog>;
    ...
    createPartnerPremiumOption(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    ...
    createPixelTo(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<AbstractObject>;
    ...
    createSetupMAnAgeDPartnerAdAccount(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    deleteSharePreVerifiedNumbers(params?: Record<string, any>): Promise<any>;
    createSharePreVerifiedNumber(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    createSystemUserAccessToken(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<Business>;
    getSystemUsers(fields: string[], params?: Record<string, any>, fetchFirstPage?: boolean): Cursor | Promise<Cursor>;
    createSystemUser(fields: string[], params?: Record<string, any>, pathOverride?: string | null | undefined): Promise<SystemUser>;
