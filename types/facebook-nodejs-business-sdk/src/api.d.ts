...
export default class FacebookAdsApi {
     ...
     * @return {Promise}
     */
    call(method: string, path: string | Array<string> | string, params?: Record<any, any>, files?: Record<any, any>, useMultipartFormData?: boolean, urlOverride?: string): Promise<any>;
