...
class FacebookAdsApiBatch {
   ...
   */
  constructor(api: FacebookAdsApi, successCallback?: (...args: Array<any>) => any, failureCallback?: (...args: Array<any>) => any): void {
    this._api = api;
    this._files = [];
    this._batch = [];
    this._requests = [];
  ...
  execute(): void | Promise<unknown> {
    ...
    return this._api.call(method, path, params).then(responses => {
