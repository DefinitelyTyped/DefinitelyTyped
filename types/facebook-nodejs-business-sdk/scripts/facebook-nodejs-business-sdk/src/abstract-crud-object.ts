...
export class AbstractCrudObject extends AbstractObject {
   ...
   * @return {Cursor}
   */
  getEdge(targetClass: Record<string, any>, fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true, endpoint: string | null | undefined): Cursor | Promise<any> {
   ...
   * @return  {Promise}
   */
  createEdge(endpoint: string, fields: Array<string>, params: Record<string, any> = {}, targetClassConstructor: (...args: Array<any>) => any = null, pathOverride?: string | null | undefined = null): Promise<any> {
    if (fields && fields.length > 0) {
      params['fields'] = fields.join(',');
    }
