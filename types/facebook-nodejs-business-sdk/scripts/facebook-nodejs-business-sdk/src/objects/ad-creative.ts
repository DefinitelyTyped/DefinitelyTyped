...
export default class AdCreative extends AbstractCrudObject {
  ...
  createAdLabel(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AdCreative> {
    return this.createEdge('/adlabels', fields, params, AdCreative, pathOverride);
  }

  getCreativeInsights(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
