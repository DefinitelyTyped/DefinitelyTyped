...
export default class CustomData {
  ...
  constructor(value: number, currency: string, content_name: string, content_category: string, content_ids: Array<string>, contents: Array<SignalContent>, content_type: string, order_id: string, predicted_ltv: number, num_items: number, search_string: string, status: string, item_number: string, delivery_category: string, custom_properties: Record<string, any>, shipping_contact: SignalUserData, billing_contact: SignalUserData, external_order_id: string, original_order_id: string, message: string) {
    ...
    this._business_data_custom_data = new BusinessDataCustomData(value, currency, business_data_contents, order_id, status, business_data_shipping_contact, business_data_billing_contact, external_order_id, original_order_id, message);
    this._server_custom_data = new ServerCustomData(value, currency, content_name, content_category, content_ids, server_contents, content_type, order_id, predicted_ltv, num_items, search_string, status, item_number, delivery_category, custom_properties);
  }
