...
export default class Content {
  ...
  constructor(id: string, quantity: number, price: number, item_price: number, title: string, description: string, brand: string, category: string, delivery_category: string, tax: number, external_content_id: string) {
    this._business_data_content = new BusinessDataContent(id, quantity, price, title, tax, external_content_id);
    this._server_content = new ServerContent(id, quantity, item_price, title, description, brand, category, delivery_category);
  }
