...
export default class Page extends AbstractCrudObject {
  ...
  getAbTests(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(PagePostExperiment, fields, params, fetchFirstPage, '/ab_tests');
  }

  createAbTest(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<PagePostExperiment> {
    return this.createEdge('/ab_tests', fields, params, PagePostExperiment, pathOverride);
  }

  createAcknowledgeOrder(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/acknowledge_orders', fields, params, Page, pathOverride);
  }

  getAdsPosts(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  createAgency(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  getArExperience(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  createAssignedUser(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  getBlocked(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Profile, fields, params, fetchFirstPage, '/blocked');
  }

  createBlocked(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
    return this.createEdge('/blocked', fields, params, null, pathOverride);
  }

  createBusinessDatum(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
  ...
  getCallToActions(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(PageCallToAction, fields, params, fetchFirstPage, '/call_to_actions');
  }

  createCall(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
    return this.createEdge('/calls', fields, params, null, pathOverride);
  }

  getCanvasElements(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(CanvasBodyElement, fields, params, fetchFirstPage, '/canvas_elements');
  }

  createCanvasElement(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CanvasBodyElement> {
    return this.createEdge('/canvas_elements', fields, params, CanvasBodyElement, pathOverride);
  }

  getCanvases(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Canvas, fields, params, fetchFirstPage, '/canvases');
  }

  createCanvase(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Canvas> {
    return this.createEdge('/canvases', fields, params, Canvas, pathOverride);
  }

  getChatPlugin(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(ChatPlugin, fields, params, fetchFirstPage, '/chat_plugin');
  }

  createChatPlugin(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  createCopyrightManualClaim(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<VideoCopyrightMatch> {
    return this.createEdge('/copyright_manual_claims', fields, params, VideoCopyrightMatch, pathOverride);
  }

  getCrosspostWhitelistedPages(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  createCustomLabel(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<PageUserMessageThreadLabel> {
  ...
  getCustomUserSettings(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(CustomUserSettings, fields, params, fetchFirstPage, '/custom_user_settings');
  }

  createCustomUserSetting(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  createExtendThreadControl(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/extend_thread_control', fields, params, Page, pathOverride);
  }

  getFantasyGames(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  createFeed(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/feed', fields, params, Page, pathOverride);
  }

  getGlobalBrandChildren(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  getImageCopyrights(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(ImageCopyright, fields, params, fetchFirstPage, '/image_copyrights');
  }

  createImageCopyright(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<ImageCopyright> {
    return this.createEdge('/image_copyrights', fields, params, ImageCopyright, pathOverride);
  }

  getIndexedVideos(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  getLeadGenForms(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(LeadgenForm, fields, params, fetchFirstPage, '/leadgen_forms');
  }

  createLeadGenForm(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<LeadgenForm> {
  ...
  getLocations(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Page, fields, params, fetchFirstPage, '/locations');
  }

  createLocation(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/locations', fields, params, Page, pathOverride);
  }

  getMediaFingerprints(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(MediaFingerprint, fields, params, fetchFirstPage, '/media_fingerprints');
  }

  createMediaFingerprint(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<MediaFingerprint> {
    return this.createEdge('/media_fingerprints', fields, params, MediaFingerprint, pathOverride);
  }

  createMessageAttachMEnt(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
    return this.createEdge('/message_attachments', fields, params, null, pathOverride);
  }

  createMessage(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/messages', fields, params, Page, pathOverride);
  }

  getMessagingFeatureReview(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(MessagingFeatureReview, fields, params, fetchFirstPage, '/messaging_feature_review');
  }

  getMessengerCallSettings(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(MessengerCallSettings, fields, params, fetchFirstPage, '/messenger_call_settings');
  }

  createMessengerCallSetting(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/messenger_call_settings', fields, params, Page, pathOverride);
  }

  getMessengerLeadForMs(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(MessengerAdsPartialAutomatedStepList, fields, params, fetchFirstPage, '/messenger_lead_forms');
  }

  createMessengerLeadForM(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  getMessengerProfile(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(MessengerProfile, fields, params, fetchFirstPage, '/messenger_profile');
  }

  createMessengerProfile(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/messenger_profile', fields, params, Page, pathOverride);
  }

  createNlpConfig(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  createNotificationMessagesDevSupport(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/notification_messages_dev_support', fields, params, Page, pathOverride);
  }

  getPageBackedInstagramAccounts(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(InstagramUser, fields, params, fetchFirstPage, '/page_backed_instagram_accounts');
  }

  createPageBackedInstagramAccount(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<InstagramUser> {
    return this.createEdge('/page_backed_instagram_accounts', fields, params, InstagramUser, pathOverride);
  }

  createPageWhatsAppNumberVerification(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/page_whatsapp_number_verification', fields, params, Page, pathOverride);
  }

  createPassThreadControl(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/pass_thread_control', fields, params, Page, pathOverride);
  }

  createPassThreadMetadatum(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  createPersona(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Persona> {
    return this.createEdge('/personas', fields, params, Persona, pathOverride);
  }

  createPhotoStory(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  createPicture(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<ProfilePictureSource> {
  ...
  getPublishedPosts(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(PagePost, fields, params, fetchFirstPage, '/published_posts');
  }

  getRatings(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Recommendation, fields, params, fetchFirstPage, '/ratings');
  }

  createReleaseThreadControl(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/release_thread_control', fields, params, Page, pathOverride);
  }

  createRequestThreadControl(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
  ...
  getRtbDynamicPosts(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(RTBDynamicPost, fields, params, fetchFirstPage, '/rtb_dynamic_posts');
  }

  getScheduleDPosts(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(PagePost, fields, params, fetchFirstPage, '/scheduled_posts');
  }

  getSecondaryReceivers(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Application, fields, params, fetchFirstPage, '/secondary_receivers');
  }

  getSettings(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(PageSettings, fields, params, fetchFirstPage, '/settings');
  }

  createSetting(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/settings', fields, params, Page, pathOverride);
  }

  getShopSetupStatus(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  createSubscribedApp(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/subscribed_apps', fields, params, Page, pathOverride);
  }

  getTabs(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Tab, fields, params, fetchFirstPage, '/tabs');
  }

  getTagged(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(PagePost, fields, params, fetchFirstPage, '/tagged');
  }

  createTakeThreadControl(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/take_thread_control', fields, params, Page, pathOverride);
  }

  createThreadAction(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/thread_action', fields, params, Page, pathOverride);
  }

  getThreadOwner(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(PageThreadOwner, fields, params, fetchFirstPage, '/thread_owner');
  }

  getThreads(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(UnifiedThread, fields, params, fetchFirstPage, '/threads');
  }

  createUnlinkAccount(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Page> {
    return this.createEdge('/unlink_accounts', fields, params, Page, pathOverride);
  }

  getVideoCopyrightRules(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(VideoCopyrightRule, fields, params, fetchFirstPage, '/video_copyright_rules');
  }

  createVideoCopyrightRule(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<VideoCopyrightRule> {
    return this.createEdge('/video_copyright_rules', fields, params, VideoCopyrightRule, pathOverride);
  }

  createVideoCopyright(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<VideoCopyright> {
    return this.createEdge('/video_copyrights', fields, params, VideoCopyright, pathOverride);
  }

  getVideoLists(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(VideoList, fields, params, fetchFirstPage, '/video_lists');
  }

  getVideoReels(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(AdVideo, fields, params, fetchFirstPage, '/video_reels');
  }

  createVideoReel(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AdVideo> {
    return this.createEdge('/video_reels', fields, params, AdVideo, pathOverride);
  }

  createVideoStory(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
  ...
  getVisitorPosts(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
  ...
  deleteWelcomeMessageFlows(params: Record<string, any> = {}): Promise<any> {
    return super.deleteEdge('/welcome_message_flows', params);
  }

  getWelcomeMessageFlows(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(CTXPartnerAppWelcomeMessageFlow, fields, params, fetchFirstPage, '/welcome_message_flows');
  }

  createWelcomeMessageFlow(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
