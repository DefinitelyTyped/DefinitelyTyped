...
export default class LeadgenForm extends AbstractCrudObject {
  ...
  getLeads(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Lead, fields, params, fetchFirstPage, '/leads');
  }

  getTestLeads(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Lead, fields, params, fetchFirstPage, '/test_leads');
  }

  createTestLead(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<Lead> {
