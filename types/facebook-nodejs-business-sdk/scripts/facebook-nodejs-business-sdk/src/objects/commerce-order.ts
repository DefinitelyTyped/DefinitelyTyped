...
export default class CommerceOrder extends AbstractCrudObject {
  ...
  createAcknowledgeOrder(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
    return this.createEdge('/acknowledge_order', fields, params, CommerceOrder, pathOverride);
  }

  getCancellations(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(AbstractObject, fields, params, fetchFirstPage, '/cancellations');
  }

  createCanCellATIOn(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
    return this.createEdge('/cancellations', fields, params, CommerceOrder, pathOverride);
  }

  createItemUpdate(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
  ...
  getPayments(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(AbstractObject, fields, params, fetchFirstPage, '/payments');
  }

  getPromotionDetails(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(AbstractObject, fields, params, fetchFirstPage, '/promotion_details');
  }

  getPromoTIOns(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(AbstractObject, fields, params, fetchFirstPage, '/promotions');
  }

  getRefunds(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(AbstractObject, fields, params, fetchFirstPage, '/refunds');
  }

  createRefund(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
  ...
  createReturn(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
    return this.createEdge('/returns', fields, params, CommerceOrder, pathOverride);
  }

  getShipments(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(AbstractObject, fields, params, fetchFirstPage, '/shipments');
  }

  createShipment(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
    return this.createEdge('/shipments', fields, params, CommerceOrder, pathOverride);
  }

  createUpdateShipment(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
    return this.createEdge('/update_shipment', fields, params, CommerceOrder, pathOverride);
  }

  createUpdate(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<CommerceOrder> {
    return this.createEdge('/updates', fields, params, CommerceOrder, pathOverride);
  }
