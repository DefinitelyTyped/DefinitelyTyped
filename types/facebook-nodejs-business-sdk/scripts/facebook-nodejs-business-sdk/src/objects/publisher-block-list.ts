...
export default class PublisherBlockList extends AbstractCrudObject {
  ...
  createAppendPublisherUrl(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
    return this.createEdge('/append_publisher_urls', fields, params, null, pathOverride);
  }

  getPagedWebPublishers(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(WebPublisher, fields, params, fetchFirstPage, '/paged_web_publishers');
  }
