...
export default class WhatsAppBusinessPreVerifiedPhoneNumber extends AbstractCrudObject {
  ...
  getPartners(fields: Array<string>, params: Record<string, any> = {}, fetchFirstPage: boolean = true): Cursor | Promise<any> {
    return this.getEdge(Business, fields, params, fetchFirstPage, '/partners');
  }

  createRequestCode(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
    return this.createEdge('/request_code', fields, params, null, pathOverride);
  }

  createVerifyCode(fields: Array<string>, params: Record<string, any> = {}, pathOverride?: string | null | undefined = null): Promise<AbstractObject> {
