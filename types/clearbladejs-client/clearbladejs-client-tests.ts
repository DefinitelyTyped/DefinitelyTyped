...
///////////////////////////////////////
query1.addSortToQuery(query1, CbClient.QuerySortDirections.QUERY_SORT_ASCENDING, 'column1');
query1.addFilterToQuery(query1, CbClient.QueryConditions.QUERY_GREATERTHAN, 'key', 'value');
