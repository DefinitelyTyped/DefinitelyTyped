...
export interface WebApp {
  ...
  */
  checkHomeScreenStatus: (
    callback?: (status: HomeScreenStatus) => CallbackReturnValue
  ) => void;
  /**
  ...
  */
  onEvent: <T extends keyof EventMap>(
    eventType: T,
    eventHandler: (...args: EventMap[T]) => CallbackReturnValue
  ) => void;
  /**
  ...
  */
  openInvoice: (
    url: string,
    callback: (status: InvoiceStatus) => CallbackReturnValue
  ) => void;
  /**
  ...
  */
  showPopup: (
    params: PopupParams,
    callback?: (id: string) => CallbackReturnValue
  ) => void;
  /**
  ...
  */
  showScanQrPopup: (
    ...
    callback?: (text: string) => boolean | Promise<boolean>
  ) => void;
  /**
  ...
  */
  readTextFromClipboard: (
    callback?: (text: string) => CallbackReturnValue
  ) => void;
  /**
...
export interface CloudStorage {
  ...
  */
  setItem: (
    key: string,
    value: string,
    callback?: SuccessCloudStorageCallback
  ) => CloudStorage;
  /**
  ...
  */
  getItems: <TKeys extends string[]>(
    ...
    callback: (
      error: CloudStorageCallbackError,
      values: { [key in TKeys[number]]: string }
    ) => void | Promise<void>
  ) => CloudStorage;
  /**
...
export interface LocationManager {
  ...
  */
  getLocation: (
    callback: (locationData: LocationData | null) => CallbackReturnValue
  ) => LocationManager;
  /**
...
export interface EventMap {
  ...
  */
  ...
  /**
    ...
    - cancelled – user declined this request.
  */
  contactRequested: [data: RequestContactData];
  /**
  ...
  */
  biometricAuthRequested: [
    { isAuthenticated: boolean; biometricToken?: string }
  ];
  /**
