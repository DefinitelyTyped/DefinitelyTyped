...
export class CellSelection<S extends Schema = any> {
    ...
    static fromJSON<S extends Schema = any>(doc: ProsemirrorNode<S>, json: CellSelectionJSON): CellSelection<S>;
}
...
export function selectionCell<S extends Schema = any>(state: EditorState<S>): ResolvedPos<S> | null | undefined;

export function moveCellForward<S extends Schema = any>(pos: ResolvedPos<S>): ResolvedPos<S>;

export function inSameTable<S extends Schema = any>($a: ResolvedPos<S>, $b: ResolvedPos<S>): boolean;
...
export function nextCell<S extends Schema = any>(pos: ResolvedPos<S>, axis: string, dir: number): null | ResolvedPos<S>;
