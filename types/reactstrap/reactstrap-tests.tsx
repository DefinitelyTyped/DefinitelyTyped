    ...
    render() {
        return (
            <div>
                ...
                <ButtonToggle color="success">success</ButtonToggle> <ButtonToggle color="info">info</ButtonToggle>{' '}
                <ButtonToggle color="warning">warning</ButtonToggle> <ButtonToggle color="danger">danger</ButtonToggle>{' '}
            </div>
        );
    }
}
...
const Example41 = (props: any) => <DropdownItem header>Header</DropdownItem>;
        ...
        return (
            <Form>
                ...
                <FormGroup tag="fieldset">
                    ...
                    <FormGroup check inline>
                        <Label check>
                            <Input type="checkbox" /> Check me out as well
                        </Label>
                    </FormGroup>
                </FormGroup>
...
const ExampleListGroupHorizontal = (props: any) => {
    return (
        <div>
            <p>
                The <code>horizontal</code> prop can be a Boolean or a string specifying one of Bootstrap's breakpoints
            </p>
            ...
            <p className="mt-3">
                Note that horizontal list groups cannot be combined with flush list groups. If <code>flush</code> is{' '}
                <code>true</code> then <code>horizontal</code> has no effect.
            </p>
        </div>
    );
};
            ...
            <div>
                ...
                <Modal returnFocusAfterClose={this.state.focusAfterClose} isOpen={this.state.open}>
                    <ModalBody>
                        ...
                        and will not be focused if "returnFocusAfterClose" is false.
                    </ModalBody>
                    <ModalFooter>
                        <Button color="primary" onClick={this.toggle}>
                            Close
...
function Example104() {
    ...
    return (
        <FormGroup className="some-class" aria-labelledby="label">
            <Label sm={3} id="label">
                Label
            </Label>
...
function Example105() {
    return (
        <Dropdown className="main-nav-avatar" isOpen={true} aria-labelledby="menu">
            <a href="javascript:void(0)" id="menu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Toggle
            </a>

            <DropdownMenu right className="asdf">
                <div className="d-block">Item</div>
            </DropdownMenu>
        </Dropdown>
    );
}
...
function Example106() {
    return (
        <Nav vertical>
            <NavLink className="toggle-drawer" href="#">
                Details
            </NavLink>
        </Nav>
    );
...
const CSSModuleExample = (props: any) => {
    ...
    return (
        <Button color="secondary" cssModule={cssModule}>
            Button
        </Button>
    );
};
...
class Example130 extends React.Component {
    render() {
        return (
            <>
                <Carousel activeIndex={1} next={() => {}} previous={() => {}} enableTouch={false}>
                ...
                <Carousel activeIndex={1} next={() => {}} previous={() => {}} enableTouch={true}>
                    <CarouselIndicators items={[]} activeIndex={1} onClickHandler={() => {}} />
                    <CarouselControl direction="prev" directionText="Previous" onClickHandler={() => {}} />
                    <CarouselControl direction="next" directionText="Next" onClickHandler={() => {}} />
                </Carousel>
                ...
                <UncontrolledCarousel activeIndex={1} next={() => {}} previous={() => {}} enableTouch={true} items={[]}>
                    <CarouselIndicators items={[]} activeIndex={1} onClickHandler={() => {}} />
                    <CarouselControl direction="prev" directionText="Previous" onClickHandler={() => {}} />
                    <CarouselControl direction="next" directionText="Next" onClickHandler={() => {}} />
                </UncontrolledCarousel>
...
const PopoverTestInnerRef = () => {
    ...
    return (
        <Popover target={target} container={container}>
            Yo!
        </Popover>
    );
};
...
const UncontrolledTooltipTestInnerRef = () => {
    ...
    const container = React.createRef<HTMLDivElement>();
    return (
        <UncontrolledTooltip target={target} container={container}>
            Yo!
        </UncontrolledTooltip>
    );
};
