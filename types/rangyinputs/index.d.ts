...
interface JQuery {
     ...
     */
    insertText(text: string, pos: number, selectionBehaviour?: 'select' | 'collapseToStart' | 'collapseToEnd'): JQuery;
     ...
     */
    replaceSelectedText(text: string, selectionBehaviour?: 'select' | 'collapseToStart' | 'collapseToEnd'): JQuery;
