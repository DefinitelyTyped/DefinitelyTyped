...
const definitions: pdfMake.TDocumentDefinitions[] = [
            ...
            '\nWe also support auto columns. They set their widths based on the content:\n\n',
            {
                columns: [
                    ...
                    },
                    {
                        width: '*',
                        text:
                            'This is a star-sized column. It should get the remaining' +
                    ...
                    },
                    {
                        width: '*',
                        text:
                            'This is a star-sized column. It should get the remaining space ' +
            ...
            " We'll split it into three columns and make sure they inherit the style:\n\n",
            {
                ...
                columns: [
                    ...
                    'automatically and make sure it inherits the styles',
                    {
                        fontSize: 20,
                        text:
                            "In this column, we've overriden fontSize to 20. It means the content should have italics=true" +
                            ' (inherited from the style) and be a little bit bigger',
                    },
                    {
                        style: 'header',
                        text:
                            'Last column does not override any styling properties, but applies a new style (header) to itself.' +
    ...
    },
    {
        content: [
            ...
            {
                text: [
                    'It is also possible to set keepWithHeaderRows to make sure there will be no page-break' +
                        ...
                        "since there's not enough space for the first row to be rendered here",
                ],
                color: 'gray',
                italics: true,
            },
    ...
    },
    {
        content: [
            ...
            {
                ul: ['item 1', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.', 'item 3'],
            },
            ...
            {
                ol: ['item 1', 'Lorem ipsum dolor sit amet, consectetur adipisicing elit.', 'item 3'],
            },
            ...
            { text: '\n\nUnordered lists inside columns', style: 'header' },
            {
                columns: [
                    {
                        ul: ['item 1', 'Lorem ipsum dolor sit amet'],
                    },
                    {
                        ul: ['item 1', 'Lorem ipsum dolor sit amet'],
                    },
            ...
            { text: '\n\nOrdered lists inside columns', style: 'header' },
            {
                columns: [
                    {
                        ol: ['item 1', 'Lorem ipsum dolor sit amet'],
                    },
                    {
                        ol: ['item 1', 'Lorem ipsum dolor sit amet'],
                    },
            ...
            {
                ol: ['item 1', { text: 'item 2', listType: 'none' }, { text: 'item 3', listType: 'upper-roman' }],
            },
