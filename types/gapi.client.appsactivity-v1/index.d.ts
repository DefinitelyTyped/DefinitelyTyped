...
declare namespace gapi.client.appsactivity {
...
declare namespace gapi.client {
    ...
    export function load (name: "appsactivity", version: "v1") : PromiseLike<void>;    
    export function load (name: "appsactivity", version: "v1", callback: () => any) : void;    
    
    const activities: gapi.client.appsactivity.ActivitiesResource; 
