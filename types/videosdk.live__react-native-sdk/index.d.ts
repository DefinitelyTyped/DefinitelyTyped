 ...
 *      - **VIEWER** : Audio and video streams will not be produced or consumed in this mode.
 * ---
 * @returns This will return Meeting properties and method. You can refer this [API Reference](https://docs.videosdk.live/react-native/api/sdk-reference/use-meeting/introduction)
 *
 */
...
export function switchAudioDevice(device: 'SPEAKER_PHONE' | 'EARPIECE' | 'WIRED_HEADSET' | 'BLUETOOTH'): Promise<void>;
