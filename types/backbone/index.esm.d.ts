...
export type _Omit<T, K> = Pick<T, Exclude<keyof T, K>>;
...
export interface PersistenceOptions extends Partial<_Omit<JQueryAjaxSettings, "success" | "error">> {
...
export interface ModelSaveOptions extends Silenceable, Waitable, Validable, Parseable, PersistenceOptions {
    patch?: boolean | undefined;
}

export interface ModelDestroyOptions extends Waitable, PersistenceOptions {}

export interface CollectionFetchOptions extends PersistenceOptions, Parseable, CollectionSetOptions {
...
export class Router extends EventsMixin implements Events {
    /**
     * Do not use, prefer TypeScript's extend functionality.
     */
    static extend(properties: any, classProperties?: any): any;
...
export type ViewEventListener = (event: JQuery.Event) => void;

export class View<TModel extends (Model | undefined) = Model, TElement extends Element = HTMLElement>
    extends EventsMixin
    implements Events
{
    /**
...
export let emulateHTTP: boolean;
