...
declare namespace ymaps {
    ...
    interface IBaseLineStringGeometry extends IBaseGeometry, ILineStringGeometryAccess {
        //tslint:disable-line no-empty-interface no-empty-interfaces
    }
    ...
    interface IGeocodeProvider {
        geocode(
            request: string,
            options?: { boundedBy?: number[][]; results?: number; skip?: number; strictBounds?: boolean },
        ): Promise<object>;

        suggest(
            request: string,
            options?: { boundedBy?: number[][]; results?: number; strictBounds?: boolean },
        ): Promise<object>;
    }
