    ...
    render() {
        return (
            <div>
                ...
                <ReactFlagsSelect countries={this.countries} customLabels={this.customLabels} />
                <ReactFlagsSelect
                ...
                <ReactFlagsSelect
                    ...
                    optionsSize={14}
                />
                <ReactFlagsSelect defaultCountry="US" showSelectedLabel={false} disabled={true} />
                <ReactFlagsSelect defaultCountry="GB" onSelect={this.onSelectFlag} />
