...
export type CommonOrganisationDetailV2 = CommonOrganisation & {
    /**
...
export type CommonPersonDetailV2 = CommonPerson & {
    /**
...
export type CommonPhysicalAddressWithPurpose = CommonPhysicalAddress & {
    /**
     * Enumeration of values indicating the purpose of the physical address.
     */
    purpose: "MAIL" | "OTHER" | "PHYSICAL" | "REGISTERED" | "WORK";
