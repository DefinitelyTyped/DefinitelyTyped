...
export type Endpoint = 'events' | 'teams' | 'matches' | 'rankings' | 'season_rankings' | 'awards' | 'skills';

/**
 * Parameter Objects
 */
export type StringRequest = string | string[] | RegExp | StringRequestValidatorFunction;
export type StringRequestValidatorFunction = (itemValue: string, item: ResponseObject) => Promise<boolean> | boolean;

export type NumberRequest = number | number[] | NumberRequestValidatorFunction;
export type NumberRequestValidatorFunction = (itemValue: number, item: ResponseObject) => Promise<boolean> | boolean;
 ...
 * GET
 */
export function get(endpoint: 'teams', params: TeamsRequestObject): Promise<TeamsResponseObject[]>;

export function get(endpoint: 'events', params: EventsRequestObject): Promise<EventsResponseObject[]>;

export function get(endpoint: 'matches', params: MatchesRequestObject): Promise<MatchesResponseObject[]>;

export function get(endpoint: 'rankings', params: RankingsRequestObject): Promise<RankingsResponseObject[]>;
...
export function get(endpoint: 'awards', params: AwardsRequestObject): Promise<AwardsResponseObject[]>;

export function get(endpoint: 'skills', params: SkillsRequestObject): Promise<SkillsResponseObject[]>;

/**
 * SIZE
 */
export function size(endpoint: 'teams', params: TeamsRequestObject): Promise<number>;

export function size(endpoint: 'events', params: EventsRequestObject): Promise<number>;

export function size(endpoint: 'matches', params: MatchesRequestObject): Promise<number>;

export function size(endpoint: 'rankings', params: RankingsRequestObject): Promise<number>;

export function size(endpoint: 'season_rankings', params: SeasonRankingsRequestObject): Promise<number>;

export function size(endpoint: 'awards', params: AwardsRequestObject): Promise<number>;

export function size(endpoint: 'skills', params: SkillsRequestObject): Promise<number>;
