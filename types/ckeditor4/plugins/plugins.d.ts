declare namespace CKEDITOR {
    ...
    namespace plugins {
        ...
        namespace clipboard {
            ...
            function canClipboardApiBeTrusted(
            ...
            function getRangeAtDropPosition(
                domEvent: Event,
                editor: editor
            ): dom.range

            function initDragDataTransfer(
                evt?: dom.event,
                editor?: editor
            ): void

            function initPasteDataTransfer(
                evt?: dom.event,
                sourceEditor?: editor
            ): void
        ...
        namespace image2 {
            ...
            function getLinkAttributesParser(): (
                editor: editor,
                element: dom.element
            ) => { [key: string]: string }
        ...
        namespace link {
            ...
            function showDisplayTextForElement(
                element: dom.element,
                editor: editor
            ): boolean

            function tryRestoreFakeAnchor(
                editor: editor,
                element: dom.element
            ): dom.element
        }
