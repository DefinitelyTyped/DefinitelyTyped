...
export function closest(color: RGBColor, palette: ReadonlyArray<RGBColor>, backgroundColor?: RGBColor): RGBColor;

export function furthest(color: RGBColor, palette: ReadonlyArray<RGBColor>, backgroundColor?: RGBColor): RGBColor;
...
export function closest_lab(color: LabColor, palette: ReadonlyArray<LabColor>): LabColor;

export function furthest_lab(color: LabColor, palette: ReadonlyArray<LabColor>): LabColor;

export function map_palette_lab(p1: ReadonlyArray<LabColor>, p2: ReadonlyArray<LabColor>): { [key: string]: LabColor };
