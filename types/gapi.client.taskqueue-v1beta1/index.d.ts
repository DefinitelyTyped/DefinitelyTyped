// Type definitions for Google TaskQueue API v1beta1 1.0
...
// Generated from: https://www.googleapis.com/discovery/v1/apis/taskqueue/v1beta1/rest

/// <reference types="gapi.client" />

declare namespace gapi.client.taskqueue {
...
declare namespace gapi.client {
    // Load TaskQueue API v1beta1
    function load(name: "taskqueue", version: "v1beta1"): PromiseLike<void>;    
    function load(name: "taskqueue", version: "v1beta1", callback: () => any): void;    
    
    const taskqueues: gapi.client.taskqueue.TaskqueuesResource; 
    
    const tasks: gapi.client.taskqueue.TasksResource; 
