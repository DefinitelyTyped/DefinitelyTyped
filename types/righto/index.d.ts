declare module 'righto' {
    ...
    /** WARNING: This constructor does not perform any type checking on the argument list and is intended to be used only when real parameters are mixed with righto.after statements */
    //export default function righto<AT extends any[], RT extends any[], ET = any>(fn: CPSFunction<AT, RT, ET>, ...args: any[]): Righto<RT, ET>;
