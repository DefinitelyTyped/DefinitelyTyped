...
export class I18nextProvider extends React.Component<I18nextProviderProps> { render(): React.ReactNode }
...
export class Interpolate extends React.Component<InterpolateProps> { render(): React.ReactNode }
