// Type definitions for 'Google Ad Exchange Seller API' v2.0
...
declare namespace gapi.client {
    ...
    export function load (name: "adexchangeseller", version: "v2.0") : PromiseLike<void>;    
    export function load (name: "adexchangeseller", version: "v2.0", callback: () => any) : void;    
    
    const accounts: gapi.client.adexchangeseller.AccountsResource; 
