...
table1.push(['First value', 'Second value'], ['First value', 'Second value']);
...
table4.push(['foo', 'bar', 'baz'], ['frob', 'bar', 'quuz']);
const table5 = new Table({
    chars: { mid: '', 'left-mid': '', 'mid-mid': '', 'right-mid': '' },
}) as Table.HorizontalTable;
table5.push(['foo', 'bar', 'baz'], ['frobnicate', 'bar', 'quuz']);
...
table6.push(['foo', 'bar', 'baz'], ['frobnicate', 'bar', 'quuz']);
...
}) as Table.VerticalTable;
table9.push({ 'v0.1': 'Testing something cool' }, { 'v0.1': 'Testing something cool' });
...
table10.push({ 'Header 3': ['v0.1', 'Testing something cool'] }, { 'Header 4': ['v0.1', 'Testing something cool'] });
...
table11.push(['foo', 'bar', 'baz'], ['frob', 'bar', 'quuz']);
...
table13.push(['Hello how are you?', 'I am fine thanks!']);
...
table14.push([{ colSpan: 2, content: 'greetings' }], [{ colSpan: 2, content: 'greetings' }], ['hello', 'howdy']);

// use colSpan to span columns - (colSpan below normal cell)
const table15 = new Table({ style: { head: [], border: [] } }) as Table.HorizontalTable;
table15.push(['hello', 'howdy'], [{ colSpan: 2, content: 'greetings' }], [{ colSpan: 2, content: 'greetings' }]);
...
table21.push([{ content: 'a', rowSpan: 2 }, 'b'], [{ content: 'c', rowSpan: 2 }], ['d']);
...
table22.push([{ content: 'a', rowSpan: 3, colSpan: 2 }, 'b'], [], [{ content: 'c', rowSpan: 2, colSpan: 2 }], []);
...
table24.push([{ colSpan: 2, content: 'hello there' }], ['hi', 'hi']);
...
table25.push([{ colSpan: 2, content: 'hello there' }], ['hi', { hAlign: 'center', content: 'hi' }]);
...
table26.push([{ colSpan: 2, content: 'hello there' }], [{ hAlign: 'right', content: 'hi' }, 'hi']);
...
table28.push(['Value Row 1 Col 1', 'Value Row 1 Col 2'], ['Value Row 2 Col 1', 'Value Row 2 Col 2']);

// Header as Cells
const table29 = new Table({
    head: [{ content: 'Top Header 1' }, { content: 'Top Header 2' }],
}) as Table.HorizontalTable;
table29.push(['Value Row 1 Col 1', 'Value Row 1 Col 2'], ['Value Row 2 Col 1', 'Value Row 2 Col 2']);

// ColSpan in header
const table30 = new Table({
    head: [{ content: 'Top Header 1', colSpan: 2 }, { content: 'Top Header 3' }],
}) as Table.HorizontalTable;
table30.push(
