...
var User = Object.create({
    someUserFunction: () => {
        console.log("someUserFunction called!");
    },
});
...
emitter.once("some-single-shot-event", (event_data: any) => {
    console.log("handle some-single-shot-event");
});
...
recurlyEmitter.once("field:submit", (event_data: any) => {
    console.log("handle some-single-shot-event");
});
// @ts-expect-error
recurlyEmitter.once("some-single-shot-event", (event_data: any) => {
    console.log("handle some-single-shot-event");
});
