...
export interface ChildClass {
    /**
     * - The module name that'll be looked for in the DOM when initialising the component
     */
    moduleName: string;
}

export type ChildClassConstructor = typeof GOVUKFrontendComponent & ChildClass;
