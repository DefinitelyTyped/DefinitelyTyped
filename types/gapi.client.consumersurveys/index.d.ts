...
declare namespace gapi.client.consumersurveys {
...
declare namespace gapi.client {
    ...
    const mobileapppanels: gapi.client.consumersurveys.MobileapppanelsResource; 
    
    const results: gapi.client.consumersurveys.ResultsResource; 
    
    const surveys: gapi.client.consumersurveys.SurveysResource; 
