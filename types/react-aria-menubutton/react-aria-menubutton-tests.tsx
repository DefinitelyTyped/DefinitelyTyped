...
import { Button, Menu, MenuItem, Wrapper, closeMenu, openMenu } from 'react-aria-menubutton';
...
class MyMenuButton extends React.Component {
    render() {
        ...
        return (
            <Wrapper className="MyMenuButton" onSelection={(value, event) => console.log(value, event)}>
