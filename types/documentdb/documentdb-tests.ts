...
const connectionPolicy: ddb.ConnectionPolicy = { MediaReadMode:'Buffered', MediaRequestTimeout:1000, RequestTimeout:1000, EnableEndpointDiscovery:true, PreferredLocations:['foo'], RetryOptions:retry1, DisableSSLVerification:false };
...
const document1:ddb.NewDocument<any> = { id:'1' };
const document2:ddb.NewDocument<any> = { id:'1', ttl:60 };
const sproc1:ddb.Procedure = { id:'1', body:function() {} };
const sproc2:ddb.Procedure = { id:'1', body:'function() {}' };
const trigger1:ddb.Trigger = { id:'1', triggerOperation:'All', serverScript:function() {} };
...
const udf1:ddb.UserDefinedFunction = { id:'1', serverScript:function() {} };
...
client1.createDocument('foo', document1, docOptions1, (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
client1.createDocument('foo', document1, (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
...
const it9:ddb.QueryIterator<ddb.RetrievedDocument<any>> = client1.queryDocuments('foo', query1, feedOptions1);
const it10:ddb.QueryIterator<ddb.RetrievedDocument<any>> = client1.queryDocuments('foo', query1);
...
client1.readDocument('foo', requestOptions1, (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
client1.readDocument('foo', (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
...
const it31:ddb.QueryIterator<ddb.RetrievedDocument<any>> = client1.readDocuments('foo', feedOptions1);
const it32:ddb.QueryIterator<ddb.RetrievedDocument<any>> = client1.readDocuments('foo');
...
client1.replaceDocument('foo', document1, requestOptions1, (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
client1.replaceDocument('foo', document1, (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
...
client1.upsertDocument('foo', document1, docOptions1, (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
client1.upsertDocument('foo', document1, (err:ddb.QueryError, resource:ddb.RetrievedDocument<any>, responseHeaders:any) => void 0);
...
type Row = {foo:string};
const qi1 = new ddb.QueryIterator(client1, query1, feedOptions1, (err:ddb.QueryError, resource:Row, responseHeaders:any) => void 0, 'foo');
const qi2 = new ddb.QueryIterator(client1, query1, feedOptions1, [(err:ddb.QueryError, resource:Row, responseHeaders:any) => void 0]);
