export let AMAZON_SERVICE_ACCOUNTS: number;
...
export let AZURE_SERVICE_ACCOUNTS: number;
...
export let ENCODING_ALGORITHMS: number;
...
export let FILE_CATEGORIES: number;
...
export let GOOGLE_SERVICE_ACCOUNTS: number;
...
export let OBJECT_STORAGE_SERVICES: number;
