...
declare namespace gapi.client {
    ...
    export function load (name: "androidpublisher", version: "v2") : PromiseLike<void>;    
    export function load (name: "androidpublisher", version: "v2", callback: () => any) : void;    
    
    const edits: gapi.client.androidpublisher.EditsResource; 
    
    const entitlements: gapi.client.androidpublisher.EntitlementsResource; 
    
    const inappproducts: gapi.client.androidpublisher.InappproductsResource; 
    
    const purchases: gapi.client.androidpublisher.PurchasesResource; 
    
    const reviews: gapi.client.androidpublisher.ReviewsResource; 
