...
declare class Vec2 {
     ...
     */
    public ignore(fn?: (vec: Vec2, prev: Vec2) => any): Vec2;
    ...
    public add(vec2: number[] | Vec2, returnNew?: boolean): Vec2;

    public subtract(x: number, y: number, returnNew?: boolean): Vec2;
    public subtract(vec2: Vec2 | number[], returnNew?: boolean): Vec2;
    ...
    public multiply(scalarArrayVec2: number | number[] | Vec2, returnNew?: boolean): Vec2;
    ...
    public divide(scalarArrayVec2: number | number[] | Vec2, returnNew?: boolean): Vec2;
     ...
     */
    public rotate(radians: number, inverse?: number, returnNew?: boolean): Vec2;
     ...
     */
    public nearest(array: Vec2[]): Vec2;
    ...
    public equal(arrayVec2: number[] | Vec2): boolean;
     ...
     */
    public min(vec: Vec2, returnNew?: boolean): Vec2;
     ...
     */
    public max(vec: Vec2, returnNew?: boolean): Vec2;
     ...
     */
    public isPointOnLine(start: Vec2, end: Vec2): boolean;
     ...
     */
    public fromArray(array: number[]): Vec2;
