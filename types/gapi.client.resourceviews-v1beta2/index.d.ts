...
declare namespace gapi.client {
    ...
    export function load (name: "resourceviews", version: "v1beta2") : PromiseLike<void>;    
    export function load (name: "resourceviews", version: "v1beta2", callback: () => any) : void;    
    
    const zoneOperations: gapi.client.resourceviews.ZoneOperationsResource; 
