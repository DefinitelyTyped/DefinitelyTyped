// Type definitions for react-resize-detector 2.3
...
interface ReactResizeDetectorProps extends React.Props<ReactResizeDetector> {
    ...
    /** Possible values: throttle and debounce See lodash docs for more information. Default: undefined - means that callback will be fired as often as ResizeObserver allows */
