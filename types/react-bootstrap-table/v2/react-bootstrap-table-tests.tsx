    ...
    render() {
        ...
        return (
            <BootstrapTable
                ...
                options={{
                    onCellEdit: (row: any, fieldName: string, value: any) => {
                        console.info(row);
                    },
                }}
            >
    ...
    render() {
        ...
        return (
            <BootstrapTable data={products} insertRow deleteRow exportCSV>
                <TableHeaderColumn row={0} rowSpan={2} dataField="id" isKey={true}>
                    ID
                </TableHeaderColumn>
                <TableHeaderColumn row={0} colSpan={3} dataSort csvHeader="Product" headerAlign="right">
                    Product
                </TableHeaderColumn>
                <TableHeaderColumn row={1} dataField="name" width="175" dataAlign="center">
                    name
                </TableHeaderColumn>
                ...
                <TableHeaderColumn row={1} csvHeader="name" dataField="customer">
                    name
                </TableHeaderColumn>
                <TableHeaderColumn row={1} csvHeader="order" dataField="order" dataSort>
                    order
                </TableHeaderColumn>
            </BootstrapTable>
        );
