...
class SelectFilterWithDefaultValue extends React.Component<any> {
  render() {
    return (
...
class TextFilterWithCondition extends React.Component<any> {
  render() {
    return (
      <BootstrapTable data={ products }>
        <TableHeaderColumn dataField='id' isKey>Product ID</TableHeaderColumn>
...
class CustomFilter extends React.Component<any> {
  render() {
    return (
      <BootstrapTable data={ products }>
        <TableHeaderColumn dataField='id' isKey>Product ID</TableHeaderColumn>
...
export default class ColumnHeaderSpanComplex extends React.Component<any> {
  render() {
    const selectRow = {
      mode: 'checkbox',
