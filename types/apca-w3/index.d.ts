...
declare module 'apca-w3' {
     ...
     */
    export function sRGBtoY(rgba: RGBAArray): number;
     ...
     * The linear Y (luminance) of the given rgba color
     */
    export function displayP3toY(rgba: RGBAArray): number;
     ...
     */
    export function colorParsley(colorIn: number | string | [number] | RGBAComponents): RGBAArray;
}
