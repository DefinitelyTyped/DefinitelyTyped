...
export namespace HelloSign {
    ...
    interface SignatureRequestRequestOptions<Metadata = GenericObject> {
        // was number in 1.6.0, changed to string
    ...
    type Template<Metadata = GenericObject> = Partial<{
        template_id: string;
        title: string;
        message: string;
        metadata: GenericObject<Metadata>;
