...
declare namespace Rx {
    ...
    interface Observable<T> extends IObservable<T> {
         ...
         */
        toPromise<TPromise extends IPromise<T>>(promiseCtor: {
            new (
                resolver: (resolvePromise: (value: T) => void, rejectPromise: (reason: any) => void) => void,
            ): TPromise;
        }): TPromise;
...
declare namespace Rx {
    ...
    interface ObservableStatic {
        fromCallback: {
            ...
            <T1, TResult>(func: (arg1: T1, callback: (result: TResult) => any) => any, context?: any): (
                arg1: T1,
            ) => Observable<TResult>;
            <T1, T2, TResult>(func: (arg1: T1, arg2: T2, callback: (result: TResult) => any) => any, context?: any): (
                arg1: T1,
                arg2: T2,
            ) => Observable<TResult>;
            <T1, T2, T3, TResult>(
            ...
            <T1, T2, TResult>(func: (arg1: T1, arg2: T2, callback: Function) => any, context?: any): (
                arg1: T1,
                arg2: T2,
            ) => Observable<TResult>;
            <T1, T2, T3, TResult>(func: (arg1: T1, arg2: T2, arg3: T3, callback: Function) => any, context?: any): (
                arg1: T1,
                arg2: T2,
                arg3: T3,
            ) => Observable<TResult>;
            // with any function with selector
            <TCallbackResult, TResult>(func: Function, context: any, selector: (args: TCallbackResult[]) => TResult): (
                ...args: any[]
            ) => Observable<TResult>;
        ...
        fromNodeCallback: {
            ...
            <T1, T>(func: (arg1: T1, callback: (err: any, result: T) => any) => any, context?: any): (
                arg1: T1,
            ) => Observable<T>;
            <T1, T2, T>(func: (arg1: T1, arg2: T2, callback: (err: any, result: T) => any) => any, context?: any): (
                arg1: T1,
                arg2: T2,
            ) => Observable<T>;
            <T1, T2, T3, T>(
            ...
            <T1, TC, TR>(func: (arg1: T1, callback: Function) => any, context: any, selector: (results: TC[]) => TR): (
                arg1: T1,
            ) => Observable<TR>;
            <T1, T2, TC, TR>(
                func: (arg1: T1, arg2: T2, callback: Function) => any,
            ...
            <T1, T2, TR>(func: (arg1: T1, arg2: T2, callback: Function) => any, context?: any): (
                arg1: T1,
                arg2: T2,
            ) => Observable<TR>;
            <T1, T2, T3, TR>(func: (arg1: T1, arg2: T2, arg3: T3, callback: Function) => any, context?: any): (
                arg1: T1,
                arg2: T2,
                arg3: T3,
            ) => Observable<TR>;
