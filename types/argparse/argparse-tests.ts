...
bar = subparsers.addParser('c2', { aliases: ['co'], addHelp: true, help: 'c2 help' });
...
constExample.addArgument(['-f', '--foo'], {
    help: 'foo bar',
    nargs: Const.ONE_OR_MORE,
});
constExample.addArgument(['-b', '--bar'], {
    help: 'bar foo',
    nargs: Const.ZERO_OR_MORE,
});
constExample.addArgument('--baz', {
    help: 'baz',
    nargs: Const.OPTIONAL,
});
constExample.addArgument('--qux', {
    help: Const.SUPPRESS,
});
constExample.addArgument('quux', {
    help: 'quux',
