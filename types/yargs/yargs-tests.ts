...
function Argv$inferRequiredOptionTypes() {
    ...
    // $ExpectType { [x: string]: unknown; x: string; y: number; _: string[]; $0: string; }
    yargs
        .demandOption(['x', 'y'], true)
        .string('x')
        .number('y').argv;

    // $ExpectType { [x: string]: unknown; x: string | undefined; y: number | undefined; _: string[]; $0: string; }
    yargs
        .demandOption(['x', 'y'], false)
        .string('x')
        .number('y').argv;
...
function Argv$inferRepeatedOptionTypes() {
    ...
    yargs
        .string('a')
        .option('a', { number: true })
        .boolean('a').argv.a;

    // $ExpectType boolean | undefined
    yargs
        .number('a')
        .option('a', { string: true })
        .boolean('a').argv.a;
    ...
    yargs
        .boolean('a')
        .option('a', { number: true })
        .option('a', { string: true }).argv.a;

    // $ExpectType number | undefined
    yargs
        .boolean('a')
        .option('a', { string: true })
        .option('a', { number: true }).argv.a;
}
