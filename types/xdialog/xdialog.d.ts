declare module "xdialog" {
    ...
    interface Options {
         ...
         */
        beforecreate?: ((param: XDialog.CallbackParam) => boolean | void) | null;
         ...
         */
        beforeshow?: ((param: XDialog.CallbackParam) => boolean | void) | null;
         ...
         */
        beforehide?: ((param: XDialog.CallbackParam) => boolean | void) | null;
         ...
         */
        onok?: ((param: XDialog.CallbackParam) => boolean | void) | null;
         ...
         * Return false to avoid to be closed.
         */
        oncancel?: ((param: XDialog.CallbackParam) => boolean | void) | null;
         ...
         * Return false to avoid to be closed.
         */
        ondelete?: ((param: XDialog.CallbackParam) => boolean | void) | null;
         ...
         */
        ondestroy?: ((param: XDialog.CallbackParam) => boolean | void) | null;
         ...
         */
        ondrag?: ((element: Element, destElement: Element, srcElement: Element) => boolean | void) | null;
    }
}
...
declare const xdialog: {
     ...
     */
    info(text: string, options: XDialog.Options);

    /**
     * Display a warning dialog.
     */
    warn(text: string, options: XDialog.Options);

    /**
     * Display an error dialog.
     */
    error(text: string, options: XDialog.Options);

    /**
     * Display a fatal error dialog.
     */
    fatal(text: string, options: XDialog.Options);
