...
export interface Transducer<TInput, TOutput> {
    ...
    <TResult, TCompleteResult>(xf: CompletingTransformer<TResult, TCompleteResult, TOutput>): CompletingTransformer<
        TResult,
        TCompleteResult,
        TInput
    >;
...
export function into<TInput>(empty: string, xf: Transducer<TInput, string>, coll: Iterable<TInput>): string;
export function into<TInput, TOutput>(
