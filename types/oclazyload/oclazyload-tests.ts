...
angular.module('app', ['oc.lazyLoad']).config([
    '$ocLazyLoadProvider',
    function ($ocLazyLoadProvider: oc.ILazyLoadProvider) {
...
angular.module('app').controller('FooCtrl', [
    ...
    function ($ocLazyLoad: oc.ILazyLoad) {
        ...
        $ocLazyLoad.load(['partials/template1.html', 'partials/template2.html'], {
            cache: false,
            reconfig: true,
            rerun: true,
            serie: true,
        ...
        var isLoaded: boolean = $ocLazyLoad.isLoaded(['testModule1.js', 'testModule2.js']);
