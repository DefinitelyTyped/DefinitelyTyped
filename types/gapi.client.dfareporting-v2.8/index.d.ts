// Type definitions for Google DCM/DFA Reporting And Trafficking API v2.8
...
declare namespace gapi.client.dfareporting {
...
declare namespace gapi.client {
    ...
    export function load (name: "dfareporting", version: "v2.8") : PromiseLike<void>;    
    export function load (name: "dfareporting", version: "v2.8", callback: () => any) : void;    
    
    const accountActiveAdSummaries: gapi.client.dfareporting.AccountActiveAdSummariesResource; 
    
    const accountPermissionGroups: gapi.client.dfareporting.AccountPermissionGroupsResource; 
    
    const accountPermissions: gapi.client.dfareporting.AccountPermissionsResource; 
    
    const accountUserProfiles: gapi.client.dfareporting.AccountUserProfilesResource; 
    
    const accounts: gapi.client.dfareporting.AccountsResource; 
    
    const ads: gapi.client.dfareporting.AdsResource; 
    
    const advertiserGroups: gapi.client.dfareporting.AdvertiserGroupsResource; 
    
    const advertisers: gapi.client.dfareporting.AdvertisersResource; 
    
    const browsers: gapi.client.dfareporting.BrowsersResource; 
    
    const campaignCreativeAssociations: gapi.client.dfareporting.CampaignCreativeAssociationsResource; 
    
    const campaigns: gapi.client.dfareporting.CampaignsResource; 
    
    const changeLogs: gapi.client.dfareporting.ChangeLogsResource; 
    
    const cities: gapi.client.dfareporting.CitiesResource; 
    
    const connectionTypes: gapi.client.dfareporting.ConnectionTypesResource; 
    
    const contentCategories: gapi.client.dfareporting.ContentCategoriesResource; 
    
    const conversions: gapi.client.dfareporting.ConversionsResource; 
    
    const countries: gapi.client.dfareporting.CountriesResource; 
    
    const creativeAssets: gapi.client.dfareporting.CreativeAssetsResource; 
    
    const creativeFieldValues: gapi.client.dfareporting.CreativeFieldValuesResource; 
    
    const creativeFields: gapi.client.dfareporting.CreativeFieldsResource; 
    
    const creativeGroups: gapi.client.dfareporting.CreativeGroupsResource; 
    
    const creatives: gapi.client.dfareporting.CreativesResource; 
    
    const dimensionValues: gapi.client.dfareporting.DimensionValuesResource; 
    
    const directorySiteContacts: gapi.client.dfareporting.DirectorySiteContactsResource; 
    
    const directorySites: gapi.client.dfareporting.DirectorySitesResource; 
    
    const dynamicTargetingKeys: gapi.client.dfareporting.DynamicTargetingKeysResource; 
    
    const eventTags: gapi.client.dfareporting.EventTagsResource; 
    
    const files: gapi.client.dfareporting.FilesResource; 
    
    const floodlightActivities: gapi.client.dfareporting.FloodlightActivitiesResource; 
    
    const floodlightActivityGroups: gapi.client.dfareporting.FloodlightActivityGroupsResource; 
    
    const floodlightConfigurations: gapi.client.dfareporting.FloodlightConfigurationsResource; 
    
    const inventoryItems: gapi.client.dfareporting.InventoryItemsResource; 
    
    const landingPages: gapi.client.dfareporting.LandingPagesResource; 
    
    const languages: gapi.client.dfareporting.LanguagesResource; 
    
    const metros: gapi.client.dfareporting.MetrosResource; 
    
    const mobileCarriers: gapi.client.dfareporting.MobileCarriersResource; 
    
    const operatingSystemVersions: gapi.client.dfareporting.OperatingSystemVersionsResource; 
    
    const operatingSystems: gapi.client.dfareporting.OperatingSystemsResource; 
    
    const orderDocuments: gapi.client.dfareporting.OrderDocumentsResource; 
    
    const orders: gapi.client.dfareporting.OrdersResource; 
    
    const placementGroups: gapi.client.dfareporting.PlacementGroupsResource; 
    
    const placementStrategies: gapi.client.dfareporting.PlacementStrategiesResource; 
    
    const placements: gapi.client.dfareporting.PlacementsResource; 
    
    const platformTypes: gapi.client.dfareporting.PlatformTypesResource; 
    
    const postalCodes: gapi.client.dfareporting.PostalCodesResource; 
    
    const projects: gapi.client.dfareporting.ProjectsResource; 
    
    const regions: gapi.client.dfareporting.RegionsResource; 
    
    const remarketingListShares: gapi.client.dfareporting.RemarketingListSharesResource; 
    
    const remarketingLists: gapi.client.dfareporting.RemarketingListsResource; 
    
    const reports: gapi.client.dfareporting.ReportsResource; 
    
    const sites: gapi.client.dfareporting.SitesResource; 
    
    const sizes: gapi.client.dfareporting.SizesResource; 
    
    const subaccounts: gapi.client.dfareporting.SubaccountsResource; 
    
    const targetableRemarketingLists: gapi.client.dfareporting.TargetableRemarketingListsResource; 
    
    const targetingTemplates: gapi.client.dfareporting.TargetingTemplatesResource; 
    
    const userProfiles: gapi.client.dfareporting.UserProfilesResource; 
    
    const userRolePermissionGroups: gapi.client.dfareporting.UserRolePermissionGroupsResource; 
    
    const userRolePermissions: gapi.client.dfareporting.UserRolePermissionsResource; 
    
    const userRoles: gapi.client.dfareporting.UserRolesResource; 
    
    const videoFormats: gapi.client.dfareporting.VideoFormatsResource; 
