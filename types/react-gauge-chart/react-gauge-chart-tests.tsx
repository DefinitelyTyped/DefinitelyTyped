...
const GagueWithLevels: React.ReactElement = <GaugeChart id="gauge-chart2"
  nrOfLevels={20}
  percent={0.86}
/>;
...
const GagueWithCustomColorsAndLargeArcWidth: React.ReactElement = <GaugeChart id="gauge-chart3"
  nrOfLevels={30}
