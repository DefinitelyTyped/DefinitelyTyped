 ...
 */
export type TagifyMode = "select" | "mix";
 ...
 */
export type DropDownPosition = "manual" | "text" | "input" | "all";
 ...
 */
export interface AutoCompleteSettings extends Partial<AutoCompleteRuntimeSettings> {}

/**
 * Settings for the dropdown feature at runtime.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownRuntimeSettings<T extends BaseTagData = TagData> {
    /**
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownSettings<T extends BaseTagData = TagData> extends Partial<DropDownRuntimeSettings<T>> {}

/**
 * Options for the mix mode feature at runtime.
 */
export interface MixModeRuntimeSettings {
    /**
 ...
 */
export interface MixModeSettings extends Partial<MixModeRuntimeSettings> {}

/**
 * Options related to accessibility at runtime.
 */
export interface A11yRuntimeSettings {
    /**
 ...
 */
export interface A11ySettings extends Partial<A11yRuntimeSettings> {}

/**
 * Options for the edit tags feature at runtime.
 */
export interface EditTagsRuntimeSettings {
    /**
 ...
 */
export interface EditTagsSettings extends Partial<EditTagsRuntimeSettings> {}

/**
 * Messages for reasons if tag validation fails.
 */
export interface InvalidTagsMessages {
    /**
 ...
 */
export interface ClassNameRuntimeSettings {
    /**
     * @default 'tagify'
     */
    namespace: string;
 ...
 */
export interface ClassNameSettings extends Partial<ClassNameRuntimeSettings> {}

/**
 * Render functions for the template feature at runtime.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface TemplatesRuntime<T extends BaseTagData = TagData> {
    /**
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface Templates<T extends BaseTagData = TagData> extends Partial<TemplatesRuntime<T>> {}

/**
 * Data passed with suggestionClick hook {@link Hooks.suggestionClick}.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface SuggestionClickData<T extends BaseTagData = TagData> {
    /**
     * Tagify instance.
     */
    tagify: Tagify<T>;
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface BeforePasteData<T extends BaseTagData = TagData> {
    /**
     * Tagify instance.
     */
    tagify: Tagify<T>;
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface BeforeKeyDownData<T extends BaseTagData = TagData> {
    /**
     * Tagify instance.
     */
    tagify: Tagify<T>;
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface HooksRuntime<T extends BaseTagData = TagData> {
    /**
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface Hooks<T extends BaseTagData = TagData> extends Partial<HooksRuntime<T>> {}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface TagifyCoreSettings<T extends BaseTagData = TagData> {
    /**
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface TagifyRuntimeSettings<T extends BaseTagData = TagData> extends TagifyCoreSettings<T> {
    /**
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface TagifyConstructorSettings<T extends BaseTagData = TagData> extends TagifySettings<T> {}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface EventData<T extends BaseTagData = TagData> {
    /**
 ...
 */
export interface SingleEventData<T extends BaseTagData = TagData, S = unknown> extends EventData<T> {
    value: S;
}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface TagEventData<T extends BaseTagData = TagData> extends EventData<T> {
    data?: T | undefined;
 ...
 */
export interface DomEventData<T extends BaseTagData = TagData, E extends Event = Event> extends EventData<T> {
    event: E;
}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface KeyboardEventData<T extends BaseTagData = TagData> extends DomEventData<T, KeyboardEvent> {}

/**
 * Event data for when the element receives or loses focus.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface FocusChangeEventData<T extends BaseTagData = TagData> extends EventData<T> {
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownEventData<T extends BaseTagData = TagData> extends HTMLDivElement, EventData<T> {}

/**
 * A tag has been added.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface AddEventData<T extends BaseTagData = TagData> extends TagEventData<T> {}

/**
 * The component lost focus.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface BlurEventData<T extends BaseTagData = TagData> extends FocusChangeEventData<T> {}

/**
 * Any change to the value has occurred.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface ChangeEventData<T extends BaseTagData = TagData> extends SingleEventData<T, string> {}

/**
 * Clicking a tag.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface ClickEventData<T extends BaseTagData = TagData> extends DomEventData<T, MouseEvent>, TagEventData<T> {
    data: T;
    index: number;
}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DoubleClickEventData<T extends BaseTagData = TagData> extends TagEventData<T> {}

/**
 * Suggestions dropdown has been removed from the DOM.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownHideEventData<T extends BaseTagData = TagData> extends DropDownEventData<T> {}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownShowEventData<T extends BaseTagData = TagData> extends DropDownEventData<T> {}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownUpdatedEventData<T extends BaseTagData = TagData> extends DropDownEventData<T> {}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownNoMatchEventData<T extends BaseTagData = TagData> extends SingleEventData<T, string> {}

/**
 * Suggestions dropdown item selected (by mouse / keyboard/ touch).
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownSelectEventData<T extends BaseTagData = TagData> extends EventData<T> {
    data: T;
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface DropDownScrollEventData<T extends BaseTagData = TagData> extends EventData<T> {
    percentage: number;
}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface EditBeforeUpdateEventData<T extends BaseTagData = TagData> extends TagEventData<T> {}

/**
 * Typing inside an edited tag.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface EditInputEventData<T extends BaseTagData = TagData> extends TagEventData<T> {
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface EditKeydownEventData<T extends BaseTagData = TagData> extends KeyboardEventData<T> {}

/**
 * A tag is now in "edit mode".
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface EditStartEventData<T extends BaseTagData = TagData> extends TagEventData<T> {
    data: T;
    index: number;
    isValid: boolean;
}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface EditUpdatedEventData<T extends BaseTagData = TagData> extends TagEventData<T> {}

/**
 * The component has received focus.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface FocusEventData<T extends BaseTagData = TagData> extends FocusChangeEventData<T> {}

/**
 * A tag has been added but did not pass validation.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface InvalidTagEventData<T extends BaseTagData = TagData> extends TagEventData<T> {
    data: T;
    /**
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface InputEventDataNormal<T extends BaseTagData = TagData> extends EventData<T> {
    /**
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface InputEventDataMix<T extends BaseTagData = TagData> extends EventData<T> {
    textContent: string;
}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export type InputEventData<T extends BaseTagData = TagData> = InputEventDataNormal<T> | InputEventDataMix<T>;

/**
 * When tagify input has focus and a key was pressed.
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface KeydownEventData<T extends BaseTagData = TagData> extends KeyboardEventData<T> {}

/**
 * A tag has been removed (use `removeTag` instead with jQuery).
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface RemoveEventData<T extends BaseTagData = TagData> extends TagEventData<T> {}
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface PasteEventData<T extends BaseTagData = TagData> extends EventData<T> {
    /**
     * Clipboard event
     */
 ...
 * @template T Type of the tag data. See the Tagify class for more details.
 */
export interface EventDataMap<T extends BaseTagData = TagData> {
    /**
     * A tag has been added.
     */
    add: AddEventData<T>;
 ...
 * the type parameter.
 */
export class Tagify<T extends BaseTagData = TagData> {
    /**
     ...
     * editor.
     */
    constructor(inputElement: HTMLInputElement | HTMLTextAreaElement, settings?: TagifySettings<T>);
     ...
     */
    removeAllTags(opts?: RemoveAllTagsOptions): void;
     ...
     */
    parseTemplate<K extends keyof TemplatesRuntime>(
        template: K,
        data: Parameters<Exclude<TemplatesRuntime<T>[K], null>>,
    ): HTMLElement;
    ...
    off<K extends keyof EventDataMap>(
        event: K,
        callback: (event: CustomEvent<EventDataMap<T>[K]>) => void,
    ): this;
