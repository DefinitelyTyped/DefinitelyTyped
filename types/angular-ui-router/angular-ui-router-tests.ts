...
myApp.config(
    (
        ...
        $urlMatcherFactory.type('myType2', {
            ...
            decode: function (item: any) {
                return item;
            },
            is: function (item: any) {
                return true;
            },
        });
        ...
        $urlRouterProvider
            ...
            .when(/\/test\d/, [
                '$injector',
                '$location',
                ($injector: ng.auto.IInjectorService, $location: ng.ILocationService) => '/list',
            ])
            .when(matcher, '/list')
...
class UrlLocatorTestService implements IUrlLocatorTestService {
    ...
    constructor(
        ...
        $rootScope.$on(
            '$stateNotFound',
            (event: ng.IAngularEvent, unfoundState: ng.ui.IUnfoundState, fromState: ng.ui.IState, fromParams: {}) =>
...
namespace UiViewScrollProviderTests {
    ...
    app.config([
        ...
        function ($uiViewScrollProvider: ng.ui.IUiViewScrollProvider) {
...
namespace UrlRouterProviderTests {
    ...
    app.config(($urlRouterProvider: ng.ui.IUrlRouterProvider) => {
        ...
        (
            ...
            UserService: ITestUserService,
            $urlMatcher: ng.ui.IUrlMatcher,
        ) => {
