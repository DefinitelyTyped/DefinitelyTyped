// Type definitions for orientjs 3.0.6
 ...
 */
    ...
    class OServer extends events.EventEmitter {
        acquireConnection(): Promise<OConnection>;
        connect(): Promise<OServer>;
        close(): Promise<void>;
    ...
    interface OClusterConfig {
        selectionStrategy: (cluster: OCluster) => OServer
    }
    class OCluster extends events.EventEmitter {

        servers: OServer[];
        constructor(config?: OClusterConfig)
        acquireFrom(selection: (cluster: OCluster) => OServer): Promise<OServer>;
        connect(): Promise<OServer>;
    ...
    class SessionManager {
        ...
        acquireSession(op, data): Promise<ODatabaseSession>;

        acquireSubscribeSession(op, data): Promise<ODatabaseSession>;
        sendOnSubscribe(db, op, data, onAcquire): Promise<ODatabaseSession>;
        close(): Promise<void>;
    }
    ...
    class ODatabaseTransaction {
         ...
         */
        command(command, options): OResult;

        /**
         * Commit the transaction.
         * @return {Promise} The results of the transaction.
         */
        commit(changes): Promise<any>;
    ...
    class ODatabaseSession {
         ...
         */
        liveQuery(query: string, options?: any);
