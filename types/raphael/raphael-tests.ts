...
R.circle(320, 240, 200).attr({ fill: '#000', 'fill-opacity': 0.5, 'stroke-width': 5 });
var img2 = R.image(src, 160, 120, 320, 240);
var butt1 = R.set(),
    butt2 = R.set();
butt1.push(
    R.circle(24.833, 26.917, 26.667).attr({ stroke: '#ccc', fill: '#fff', 'fill-opacity': 0.4, 'stroke-width': 2 }),
    R.path(
