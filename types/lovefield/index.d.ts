...
declare namespace lf {
    ...
    namespace schema {
        ...
        interface TableBuilder {
            ...
            addIndex(name: string, columns: string[] | IndexedColumn[], unique?: boolean, order?: Order): TableBuilder;
            addNullable(columns: string[]): TableBuilder;
            addPrimaryKey(columns: string[] | IndexedColumn[], autoInc?: boolean): TableBuilder;
