...
declare namespace FhirKitClient {
    ...
    class Client {
         ...
         * @return {Promise<Object>} FHIR resource
         */
        vread(params: { resourceType: string, id: string, version: string, headers?: Headers, options?: Options }): Promise<fhir.ResourceBase & Response>;
         ...
         * @return {Promise<Object>} FHIR resource
         */
        create(params: { resourceType: string, body: Body, headers?: Headers, options?: Options }): Promise<fhir.ResourceBase & Response>;
         ...
         * @return {Promise<Object>} FHIR resource
         */
        update(params: { resourceType: string, id: string, body: Body, headers?: Headers, options?: Options }): Promise<fhir.ResourceBase & Response>;
         ...
         * @return {Promise<Object>} FHIR resource
         */
        patch(params: { resourceType: string, id: string, JSONPatch: OpPatch[], headers?: Headers, options?: Options }): Promise<fhir.ResourceBase & Response>;
         ...
         * @return {Promise<Object>} FHIR resources in a FHIR fhir.Bundle structure.
         */
        nextPage(params: { bundle: fhir.Bundle, options?: Options }, headers?: Headers): Promise<fhir.Bundle>;
         ...
         * @return {Promise<Object>} FHIR resources in a FHIR fhir.Bundle structure.
         */
        prevPage(params: { bundle: fhir.Bundle, options?: Options }, headers?: Headers): Promise<fhir.Bundle>;
