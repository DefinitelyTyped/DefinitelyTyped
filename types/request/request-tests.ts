...
const requestMultipart = request.post('http://service.com/upload', function optionalCallback(
    err,
    httpResponse,
    body,
) {});
...
request({ method: 'GET', uri: 'http://www.google.com', gzip: true }, (error, response, body) => {
