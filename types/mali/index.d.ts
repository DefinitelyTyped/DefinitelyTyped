...
declare class Mali extends EventEmitter {
  ...
  name: string;
  env: string;
  ports: ReadonlyArray<string | number>; // ? not sure which it is
  silent: boolean;

  addService(path: any, name: string | ReadonlyArray<string>, options?: any): void;
  use(service?: any, name?: any, fns?: any): void;
  start(port?: any, creds?: any, options?: any): any; // gnarly type asserting for these functions so Im just gonna let them handle it.
  toJSON(): any;
  close(): void;
  inspect(): any;
}
