...
declare namespace swan {
    ...
    interface NodesRef {
         ...
         * 节点信息会在callback中返回。
         */
        boundingClientRect(callback?: (rect: NodesRefRect | NodesRefRect[]) => void): SelectorQuery;
        /**
    ...
    type ExtendedComponent<Instance extends Component<Data, Props>, Data, Methods, Props> = CombinedInstance<
        Instance,
        Data,
        Methods,
        Props
    ...
    type CombinedInstance<Instance extends Component<Data, Props>, Data, Methods, Props> = Methods & Instance;
    ...
    type ThisTypedComponentOptionsWithRecordProps<V extends Component<Data, Props>, Data, Methods, Props> = object &
    ...
    interface Component<D, P> {
         ...
         */
        setData(
            key: string | { [key in keyof D]?: string | number | boolean | symbol | object | null | any[] },
            value?: any,
            callback?: () => void
        ): void;
 ...
 */
declare function App<T extends swan.AppOptions>(app: T & ThisType<T & swan.App>): void;
/**
 * 获取小程序实例
 */
...
declare function Component<D, M, P>(
    options?: swan.ThisTypedComponentOptionsWithRecordProps<swan.Component<D, P>, D, M, P>
 ...
 */
declare function Page<T extends swan.PageOptions & object>(page: T & ThisType<T & swan.Page>): void;
/**
