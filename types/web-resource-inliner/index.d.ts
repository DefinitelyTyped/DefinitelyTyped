...
declare namespace WebResourceInliner {
    ...
    interface Options {
         ...
         */
        requestTransform?: (request: object) => object;
        /**
         ...
         */
        scriptTransform?: (content: string, callback: Callback) => any;
        /**
         * Allows to make changes to links before they are inlined, such as CSS pre-and-post-processors.
         *
         * Callback is standard node error first, second argument is transformed value.
         */
        linkTransform?: (content: string, callback: Callback) => any;
    }

    function html(options: Options, callback: Callback): string;
    function css(options: Options, callback: Callback): string;
}

declare function WebResourceInliner(): void;

export = WebResourceInliner;
