// Type definitions for Google Android Management API v1
...
declare namespace gapi.client.androidmanagement {
...
declare namespace gapi.client {
    ...
    export function load (name: "androidmanagement", version: "v1") : PromiseLike<void>;    
    export function load (name: "androidmanagement", version: "v1", callback: () => any) : void;    
    
    const signupUrls: gapi.client.androidmanagement.SignupUrlsResource; 
    
    const enterprises: gapi.client.androidmanagement.EnterprisesResource; 
