import { Installation, Message, MobileMessaging, MobileMessagingError, PersonalizeContext, UserData } from "mobile-messaging-react-native";
...
const subscription = MobileMessaging.subscribe('messageReceived',
    (data: Message) => {
...
MobileMessaging.subscribe("notificationTapped", tappedHandler);
