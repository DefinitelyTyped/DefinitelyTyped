...
declare namespace __Combinatorics {
    ...
    function cartesianProduct<T1, T2, T3, T4>(
        a1: T1[],
        a2: T2[],
        a3: T3[],
        a4: T4[],
    ): ICartesianProductGenerator<[T1, T2, T3, T4]>;
    function cartesianProduct<T1, T2, T3, T4, T5>(
        a1: T1[],
        a2: T2[],
        a3: T3[],
        a4: T4[],
    ...
    function cartesianProduct<T1, T2, T3, T4, T5, T6>(
        a1: T1[],
        a2: T2[],
        a3: T3[],
        a4: T4[],
    ...
    function cartesianProduct<T1, T2, T3, T4, T5, T6, T7>(
        a1: T1[],
        a2: T2[],
        a3: T3[],
        a4: T4[],
    ...
    function cartesianProduct<T1, T2, T3, T4, T5, T6, T7, T8>(
        a1: T1[],
        a2: T2[],
        a3: T3[],
        a4: T4[],
    ...
    function cartesianProduct<T1, T2, T3, T4, T5, T6, T7, T8, T9>(
        a1: T1[],
        a2: T2[],
        a3: T3[],
        a4: T4[],
    ...
    function cartesianProduct<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(
        a1: T1[],
        a2: T2[],
        a3: T3[],
        a4: T4[],
