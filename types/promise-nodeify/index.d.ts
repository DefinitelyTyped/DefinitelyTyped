...
declare const promiseNodeify: {
    <T>(promise: Promise<T>, callback: (error: Error | undefined, value: T | undefined) => any): Promise<T> | undefined;
    ...
    nodeifyThis<T>(callback: (error: Error | undefined, value: T | undefined) => any): Promise<T> | undefined;
};
