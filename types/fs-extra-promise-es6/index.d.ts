...
export function symlink(srcpath: string, dstpath: string, type?: "file" | "dir" | "junction", callback?: (err: Error) => void): void;
export function symlinkSync(srcpath: string, dstpath: string, type?: "file" | "dir" | "junction"): void;
