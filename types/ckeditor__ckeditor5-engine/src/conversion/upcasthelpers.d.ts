import Matcher, { MatcherPattern } from "../view/matcher";
import ConversionHelpers from "./conversionhelpers";
import { Priority } from "@ckeditor/ckeditor5-utils/src/priorities";
...
export default class UpcastHelpers extends ConversionHelpers {
    ...
    elementToElement(config: {
        view?: MatcherPattern;
        model: Element | ((element: ViewElement, api: UpcastConversionApi) => Element);
        converterPriority: Priority;
    }): UpcastHelpers;
    ...
    elementToAttribute(config: {
        ...
        model:
            ...
            | {
                  key: string;
                  value: (viewElement: ViewElement, api: UpcastConversionApi) => string | null;
              };
        converterPriority: Priority;
    }): UpcastHelpers;
    ...
    attributeToAttribute(config: {
        view:
            ...
            | {
                  key: string;
                  value?: string | RegExp | ((element: ViewElement) => boolean);
              }
        ...
        model:
            ...
            | {
                  key: string;
                  value: string | ((element: ViewElement, api: UpcastConversionApi) => string);
              };
        converterPriority?: Priority;
    }): UpcastHelpers;
    ...
    elementToMarker(config: {
        view: MatcherPattern;
        model: string | ((el: ViewElement) => string);
        converterPriority?: Priority;
    }): UpcastHelpers;
 ...
 */
export function convertToModelFragment(): (...args: unknown[]) => unknown;

/**
 * Function factory, creates a converter that converts {@link module:engine/view/text~Text} to {@link module:engine/model/text~Text}.
 */
export function convertText(): (...args: unknown[]) => unknown;
 ...
 */
export function convertSelectionChange(model: Model, mapper: Mapper): (...args: unknown[]) => unknown;
