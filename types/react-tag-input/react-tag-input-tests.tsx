...
ReactDOM.render(
    <ReactTags
        ...
        handleDrag={(tag: Tag, currPos: number, newPos: number) => console.log('Drag: ' + tag.text)}
        handleInputChange={(value: string) => console.log('Changed to: ', value)}
        handleFilterSuggestions={(textInputValue: string, possibleSuggestionsArray: Tag[]) => suggestions}
