...
export interface BrowserInteraction {
     ...
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/actiontext
     */
     ...
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/createtracer
     */
     ...
     *
     * @returns This method returns the same API object created by interaction().
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/end
     */
    end(): this;
     ...
     * @returns This method returns the same API object created by interaction().
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/getcontext
     */
     ...
     *
     * @returns This method returns the same API object created by interaction().
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/ignore
     */
    ignore(): this;
     ...
     *
     * @returns This method returns the same API object created by interaction().
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/onend
     */
    // eslint-disable-next-line @definitelytyped/no-unnecessary-generics
     ...
     *
     * @returns This method returns the same API object created by interaction().
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/save
     */
    save(): this;
     ...
     * @returns This method returns the same API object created by interaction().
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/setattribute
     */
     ...
     * @returns This method returns the same API object created by interaction().
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/setname
     */
...
export interface NewRelicAPI {
     ...
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/setcustomattribute
     */
     ...
     * @see https://docs.newrelic.com/docs/browser/new-relic-browser/browser-apis/interaction/
     */
