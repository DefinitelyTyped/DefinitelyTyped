...
declare namespace NewRelic {
    interface Browser {
         ...
         *
         * @param {string} releaseName A short description of the component; for example, the name of a project,
         *  application, file, or library.
         * @param {string} releaseId The ID or version of this release; for example, a version number, build number
         ...
         * @param {{[key: string]: string}} attributes JSON object with one or more key/value pairs.
         ...
         *
         * @param {EventObject} eventObject If you are sending the same event object to New Relic Insights as a
         ...
         *
         * @param {number} timestamp Defaults to the current time of the call. If used, this marks the time that
         ...
         *
         * @param {string} name Name of the attribute. Appears as column in the PageView event.
         *   It will also appear as a column in the PageAction event if you are using it.
         * @param {string} value Value of the attribute. Appears as the value in the named attribute column in the
         ...
         *
         * @param {(err: any) => boolean} filterCallback The callback will be called with each error, so it is not
         ...
         *
         * @returns {BrowserIntegration} This method returns an API object that is bound to a specific BrowserInteraction
         ...
         * grouping.
         *
         * @param {string} name Current route name for the page. Route names passed to setCurrentRouteName() can
    ...
    interface BrowserInteraction {
         ...
         *
         * @param {string} name This will be used as the name of the tracer. If you do not include a name,
         *   New Relic Browser does not add a node to the interaction tree. The callback time will be
         *   attributed to the parent node.
         * @param {() => void} [callback]
         * @returns {() => void} This method ends the async time. It calls (and times) the callback that was passed into createTracer().
         ...
         *
         * @returns {BrowserInteraction} This method returns the same API object created by interaction().
         ...
         *
         * @param {(contextObject: any) => void} [callback] A function that accepts the interaction context object
         ...
         *
         * @param {(contextObject: any) => void} callback
         * @returns {BrowserInteraction} This method returns the same API object created by interaction().
         ...
         *
         * @param {string} name If null, the name will be set using the targetGroupedUrl attribute.
