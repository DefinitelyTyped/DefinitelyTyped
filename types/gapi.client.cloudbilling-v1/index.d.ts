...
declare namespace gapi.client.cloudbilling {
...
declare namespace gapi.client {
    ...
    export function load (name: "cloudbilling", version: "v1") : PromiseLike<void>;    
    export function load (name: "cloudbilling", version: "v1", callback: () => any) : void;    
    
    const projects: gapi.client.cloudbilling.ProjectsResource; 
    
    const billingAccounts: gapi.client.cloudbilling.BillingAccountsResource; 
    
    const services: gapi.client.cloudbilling.ServicesResource; 
