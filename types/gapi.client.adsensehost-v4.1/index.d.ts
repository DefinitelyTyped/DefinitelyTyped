...
declare namespace gapi.client.adsensehost {
...
declare namespace gapi.client {
    ...
    export function load (name: "adsensehost", version: "v4.1") : PromiseLike<void>;    
    export function load (name: "adsensehost", version: "v4.1", callback: () => any) : void;    
    
    const accounts: gapi.client.adsensehost.AccountsResource; 
    
    const adclients: gapi.client.adsensehost.AdclientsResource; 
    
    const associationsessions: gapi.client.adsensehost.AssociationsessionsResource; 
    
    const customchannels: gapi.client.adsensehost.CustomchannelsResource; 
    
    const reports: gapi.client.adsensehost.ReportsResource; 
    
    const urlchannels: gapi.client.adsensehost.UrlchannelsResource; 
