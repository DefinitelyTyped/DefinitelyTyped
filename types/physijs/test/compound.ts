...
spawnChair = (function () {
    ...
    buildBack = function () {
        ...
        back = new Physijs.BoxMesh(new THREE.BoxGeometry(5, 1, 0.5), chair_material);
        back.position.y = 5;
        back.position.z = -2.5;
        ...
        _object = new Physijs.BoxMesh(new THREE.BoxGeometry(1, 5, 0.5), chair_material);
    ...
    buildLegs = function () {
        ...
        // back left
        leg = new Physijs.BoxMesh(new THREE.BoxGeometry(0.5, 4, 0.5), chair_material);
        leg.position.x = 2.25;
        leg.position.z = -2.25;
        leg.position.y = -2.5;
        leg.castShadow = true;
        ...
        _leg = new Physijs.BoxMesh(new THREE.BoxGeometry(0.5, 4, 0.5), chair_material);
        _leg.position.x = -4.5;
