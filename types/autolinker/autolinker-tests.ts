...
() => {
    ...
    let linkedText5 = Autolinker.link('http://www.yahoo.com/some/long/path/to/a/file', {
        truncate: 25,
        newWindow: false,
    });
...
() => {
    ...
    let linkedText5 = AutolinkerCJS.link('http://www.yahoo.com/some/long/path/to/a/file', {
        truncate: 25,
        newWindow: false,
    });
    let myTextEl = document.getElementById('text');
