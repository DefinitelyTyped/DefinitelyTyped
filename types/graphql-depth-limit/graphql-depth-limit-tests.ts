...
import { GraphQLSchema, DocumentNode, buildSchema, Source, parse, validate, specifiedRules } from 'graphql';
...
validate(schema, document, [
    graphqlDepthLimit(10, { ignore: [/_trusted$/, 'idontcare'] }, (depths: any) => {
        // do something....
    }),
]);
