// Type definitions for Google Prediction API v1.5 1.5
...
// Generated from: https://www.googleapis.com/discovery/v1/apis/prediction/v1.5/rest
...
declare namespace gapi.client {
    // Load Prediction API v1.5
    function load(name: "prediction", version: "v1.5"): PromiseLike<void>;    
    function load(name: "prediction", version: "v1.5", callback: () => any): void;    
