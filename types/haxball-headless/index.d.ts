// Type definitions for haxball-headless
...
declare interface RoomConfigObject {
    roomName?: string
    playerName?: string
    password?: string
    maxPlayers?: number
...
declare type CollisionFlagsObject = "ball" | "red" | "blue" | "redKO" | "blueKO" | "wall" | "all" | "kick" | "score" | "c0" | "c1" | "c2" | "c3" | "c4"
