...
let data: jsonQuery.Context = {
    people: [{ name: 'Matt', country: 'NZ' }, { name: 'Pete', country: 'AU' }, { name: 'Mikey', country: 'NZ' }],
};
...
data = {
    grouped_people: {
        ...
        enemies: [{ name: 'Evil Steve', country: 'AU' }, { name: 'Betty', country: 'NZ' }],
    },
};
...
data = {
    ...
    comments_lookup: {
        page_1: [{ id: 'comment_1', parent_id: 'page_1', content: 'I am a comment' }],
    },
};
