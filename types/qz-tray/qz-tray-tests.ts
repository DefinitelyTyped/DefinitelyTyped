...
const claimDeviceFn = async () => qz.hid.claimDevice({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1"})
const closeStream = async () => qz.hid.closeStream({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1"})
const getFeatureReportFn = async () => qz.hid.getFeatureReport({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1", responseSize: "20"})
const isClaimedFn = async () => qz.hid.isClaimed({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1"})
const listDevicesFn = async () => qz.hid.listDevices()
const openStreamFn = async () => qz.hid.openStream({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1"})
const readData = async () => qz.hid.readData({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1", responseSize: "20"})
const releaseDeviceFn = async () => qz.hid.releaseDevice({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1"})
const sendDataFn = async () => qz.hid.sendData({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1", data: "some data"})
const sendFeatureReport = async () => qz.hid.sendFeatureReport({vendorId: "01x10", productId: "1x", usagePage: "09x6546565", serial: "1", data: "some data"})
...
const claimDeviceUsbFn = async () => qz.usb.claimDevice({vendorId: "01x8066", productId: "07x656565", interface: "0x1110"})
const closeStreamUsbFn = async () => qz.usb.closeStream({vendorId: "01x8066", productId: "07x656565", endpoint: "0x1110"})
...
const listEndpointsUsbFn = async () => qz.usb.listEndpoints({vendorId: "01x8066", productId: "07x656565", iface: "0x1110"})
const listInterfacesUsbFn = async () => qz.usb.listInterfaces({vendorId: "01x8066", productId: "07x656565"})
const openStreamUsbFn = async () => qz.usb.openStream({vendorId: "01x8066", productId: "07x656565", endpoint: "0x1110", responseSize: "500"})
const readDataUsbFn = async () => qz.usb.readData({vendorId: "01x8066", productId: "07x656565", endpoint: "0x1110", responseSize: "500"})
const releaseDeviceUsbFn = async () => qz.usb.releaseDevice({vendorId: "01x8066", productId: "07x656565"})
const sendDataUsbFn = async () => qz.usb.sendData({vendorId: "01x8066", productId: "07x656565", endpoint: "0x1110", data: "500", type: "BASE64"})
