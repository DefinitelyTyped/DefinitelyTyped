...
export type UsbCloseStreamDeviceInfoInput = Pick<
    DeviceInfo,
    'vendorId' | 'productId'
> & {
    endpoint: string
...
export type ListEndpointsDeviceInfoInput = Pick<
    DeviceInfo,
    'vendorId' | 'productId'
> & {
    iface: string
...
export type ListInterfacesDeviceInfoInput = Pick<
    ...
    'vendorId' | 'productId'
>
export type UsbOpenStreamDeviceInfoInput = Pick<
    DeviceInfo,
    'vendorId' | 'productId'
> & {
    endpoint: string
...
export type UsbReleaseDeviceDeviceInfoInput = Pick<
    ...
    'vendorId' | 'productId'
>
export type UsbSendDataDeviceInfoInput = Pick<
    DeviceInfo,
    'vendorId' | 'productId'
> & {
    endpoint: string
