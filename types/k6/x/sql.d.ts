/**
 * k6 extension using the xk6 system. Allows connection to RDBMSs: mysql, postgres, sqlite3, sqlserver
...
declare namespace sql {
     ...
     */
    function open(type: 'mysql' | 'postgres' | 'sqlite3' | 'sqlserver', connectionString: string): DatabaseConnection;
