// Type definitions for @dagrejs/graphlib 2.1
...
export interface Graph {
    /**
     * Sets the default node label or the default node label factory function.
     * This label will be assigned as default label in case if no label was specified while setting a node.
     * This function will be invoked each time when setting a node with no label specified and returned value will be used as a label for node
     * Complexity: O(1).
     *
     * @argument label - default node label or default node label factory function.
     * @returns the graph, allowing this to be chained with other functions.
     */
    setDefaultNodeLabel(label: string | Label | ((v: string) => string | Label)): Graph;
    ...
    /**
     * Sets the default edge label or the default edge label factory function.
     * This label will be assigned as default label in case if no label was specified while setting an edge.
     * This function will be invoked each time when setting an edge with no label specified and returned value will be used as a label for edge.
     * Complexity: O(1).
     *
     * @argument label - default edge label or default edge label factory function.
     * @returns the graph, allowing this to be chained with other functions.
     */
    setDefaultEdgeLabel(label: string | Label | ((v: string, w: string, name?: string) => string | Label)): Graph;
     ...
     */
    edge(v: string, w: string, name?: string): GraphEdge;
     ...
     */
    predecessors(v: string): void | Node[];
...
export const Graph: {
    new(options?: GraphOptions): Graph;
};
...
export namespace alg {
     ...
     */
    function preorder(graph: Graph, vs: string | string[]): string[];
     ...
     * @returns the nodes in the order they were visited as a list of their names.
     */
    function postorder(graph: Graph, vs: string | string[]): string[];
}
