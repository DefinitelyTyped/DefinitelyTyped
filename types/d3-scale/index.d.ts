 ...
 * @parm range An optional array of range values to initialize the scale with.
 */
export function scaleOrdinal<Domain extends { toString(): string } | null | undefined, Range>(range?: ReadonlyArray<Range>): ScaleOrdinal<Domain, Range>;
 ...
 * The generic corresponds to the data type of domain elements.
 */
export function scaleBand<Domain extends { toString(): string } | null | undefined>(): ScaleBand<Domain>;
 ...
 * The generic corresponds to the data type of domain elements.
 */
export function scalePoint<Domain extends { toString(): string } | null | undefined>(): ScalePoint<Domain>;
