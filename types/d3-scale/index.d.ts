 ...
 * @param range Array of range values.
 */
export function scaleLinear<Range, Output>(range: ReadonlyArray<Range>): ScaleLinear<Range, Output>;
/**
 ...
 * @param range Array of range values.
 */
export function scalePow<Range, Output>(range: ReadonlyArray<Range>): ScalePower<Range, Output>;
/**
 ...
 * @param range Array of range values.
 */
export function scaleSqrt<Range, Output>(range: ReadonlyArray<Range>): ScalePower<Range, Output>;
/**
 ...
 * @param range Array of range values.
 */
export function scaleLog<Range, Output>(range: ReadonlyArray<Range>): ScaleLogarithmic<Range, Output>;
/**
 ...
 * @param range Array of range values.
 */
export function scaleSymlog<Range, Output>(range: ReadonlyArray<Range>): ScaleSymLog<Range, Output>;
/**
 ...
 * @param range Array of range values.
 */
export function scaleTime<Range, Output>(range: ReadonlyArray<Range>): ScaleTime<Range, Output>;
/**
 ...
 * @param range Array of range values.
 */
export function scaleUtc<Range, Output>(range: ReadonlyArray<Range>): ScaleTime<Range, Output>;
/**
 ...
 * The generic corresponds to the data type of the output of the interpolator underlying the scale.
 */
export function scaleSequential<Output>(): ScaleSequential<Output>;
/**
 ...
 * The generic corresponds to the data type of the interpolator return type.
 */
export function scaleDiverging<Output>(): ScaleDiverging<Output>;
/**
 ...
 * The domain defaults to the empty array.
 * The range defaults to the empty array; an ordinal scale always returns undefined until a non-empty range is defined.
 *
 ...
 * The generic corresponds to the data type of range elements.
 */
export function scaleOrdinal<Domain extends { toString(): string }, Range>(): ScaleOrdinal<Domain, Range>;
/**
 * Constructs a new ordinal scale.
 * The domain defaults to the empty array.
 * The range defaults to the empty array; an ordinal scale always returns undefined until a non-empty range is defined.
 ...
 * The generic corresponds to the data type of range elements.
 */
export function scaleOrdinal<Range>(): ScaleOrdinal<string, Range>;
/**
 ...
 * @param range A two-element array of numeric values.
 */
export function scalePoint(range: [number | { valueOf(): number }, number | { valueOf(): number }]): ScalePoint<string>;
/**
 * Constructs a new point scale with the specified range, no padding, no rounding and center alignment.
 * The domain defaults to the empty domain.
 *
