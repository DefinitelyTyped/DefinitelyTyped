 ...
 * The second generic corresponds to the data type of range values.
 */
export function scaleThreshold<Domain extends number | string | Date, Range>(): ScaleThreshold<
  Domain,
  Range
>;
 ...
 * The second generic corresponds to the data type of range values.
 */
export interface ScaleOrdinal<Domain extends { toString(): string } | null | undefined, Range> {
  /**
   * Given a value in the input domain, returns the corresponding value in the output range.
 ...
 * @parm range An optional array of range values to initialize the scale with.
 */
export function scaleOrdinal<Domain extends { toString(): string } | null | undefined, Range>(
 ...
 */
export interface ScaleBand<Domain extends { toString(): string } | null | undefined> {
  /**
 ...
 * The generic corresponds to the data type of domain elements.
 */
export function scaleBand<Domain extends { toString(): string } | null | undefined>(): ScaleBand<
  Domain
>;
 ...
 * The generic corresponds to the data type of domain elements.
 */
export interface ScalePoint<Domain extends { toString(): string } | null | undefined> {
  /**
 ...
 * The generic corresponds to the data type of domain elements.
 */
export function scalePoint<Domain extends { toString(): string } | null | undefined>(): ScalePoint<
  Domain
>;
