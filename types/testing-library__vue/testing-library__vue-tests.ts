...
// Has bound queries
component.getByLabelText(/some text/, {
    exact: true,
    trim: false,
...
component.getByPlaceholderText(/some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
component.getAllByText(/some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
component.queryByText(/some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
component.queryAllByText(/some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
component.findByText(/some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
    selector: '*',
}); // $ExpectType Promise<HTMLElement>
component.findAllByText('foo'); // $ExpectType Promise<HTMLElement[]>
component.findAllByText(/some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
lib.getByLabelText(elem, /some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
lib.getByPlaceholderText(elem, /some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
lib.getAllByText(elem, /some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
lib.queryByText(elem, /some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
lib.queryAllByText(elem, /some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
lib.findAllByText(elem, /some text/, {
    exact: true,
    trim: false,
    collapseWhitespace: true,
    normalizer: (x) => x,
...
lib.waitForElementToBeRemoved(() => option, {
    container: select,
    timeout: 3000,
    mutationObserverOptions: { subtree: false },
}); // $ExpectType Promise<HTMLOptionElement>

// Reexports utilities from dom-testing-library
lib.buildQueries(
    (el: HTMLElement) => [el],
    (_: HTMLElement) => 'something',
    (_: HTMLElement) => 'error',
);
lib.within(elem);
