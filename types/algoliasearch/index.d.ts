...
declare namespace algoliasearch {
    ...
    interface Client {
         ...
         * Add global API Keys
         */
        addApiKey(scopes: string[], cb: (err: Error, res: AddApiKeyTask) => void): void;
        /**
         * Add global API Key
         */
        addApiKey(scopes: string[], options: ApiKeyOptions, cb: (err: Error, res: AddApiKeyTask) => void): void;
        /**
         * Add global API Keys
         */
         ...
         */
        updateApiKey(key: string, scopes: string[], cb: (err: Error, res: UpdateApiKeyTask) => void): void;
        /**
         * Update global API key
         */
        updateApiKey(
         ...
         */
        deleteApiKey(key: string, cb: (err: Error, res: DeleteApiKeyTask) => void): void;
        /**
         * Deletes a global key
         */
