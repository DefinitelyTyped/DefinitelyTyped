...
declare namespace algoliasearch {
    ...
    interface Client {
         ...
         */
        copyIndex(from: string, to: string, cb: (err: Error, res: UpdateIndexTask) => void): void;
        /**
         ...
         */
        moveIndex(from: string, to: string, cb: (err: Error, res: UpdateIndexTask) => void): void;
        /**
         * Move index to a new one (and will overwrite the original one)
         * https://github.com/algolia/algoliasearch-client-js#move-index---moveindex
         */
         ...
         * https://github.com/algolia/algoliasearch-client-js#add-user-key---addapikey
         */
        addApiKey(scopes: string[], options: ApiKeyOptions, cb: (err: Error, res: Task) => void): void;
        /**
         * Add global API Keys
         * https://github.com/algolia/algoliasearch-client-js#add-user-key---addapikey
         */
         ...
         */
        updateApiKey(key: string, scopes: string[], cb: (err: Error, res: Task) => void): void;
        /**
         * Update global API key
         * https://github.com/algolia/algoliasearch-client-js#update-user-key---updateapikey
         */
        updateApiKey(key: string, scopes: string[], options: ApiKeyOptions, cb: (err: Error, res: Task) => void): void;
        /**
         * Update global API key
         * https://github.com/algolia/algoliasearch-client-js#update-user-key---updateapikey
         */
        updateApiKey(key: string, scopes: string[], options?: ApiKeyOptions): Promise<Task>;
        /**
         ...
         */
        getLogs(options: LogsOptions, cb: (err: Error, res: { logs: Log[] }) => void): void;
        /**
         * Get 1000 last events
         * https://github.com/algolia/algoliasearch-client-js#get-logs---getlogs
         */
    ...
    interface Index {
         ...
         * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
         */
        addObject(object: {}, objectID: string, cb: (err: Error, res: Task) => void): void;
        /**
         * Add list of objects
         * https://github.com/algolia/algoliasearch-client-js#add-objects---addobjects
         */
         ...
         * https://github.com/algolia/algoliasearch-client-js#delete-objects---deleteobjects
         */
        deleteObjects(objectIDs: string[], cb: (err: Error, res: Task) => void): void;
        /**
         ...
         */
        setSettings(settings: IndexSettings, cb: (err: Error, res: Task) => void): void;
        /**
         * Set an index settings
         * https://github.com/algolia/algoliasearch-client-js#set-settings---setsettings
         */
         ...
         */
        saveSynonym(synonym: Synonym, options: SynonymOption, cb: (err: Error, res: Task) => void): void;
        /**
         * Save a synonym object
         */
        batchSynonyms(synonyms: Synonym[], options: SynonymOption, cb: (err: Error, res: Task) => void): void;
        /**
         * Delete a specific synonym
         * https://github.com/algolia/algoliasearch-client-js#batch-synonyms---batchsynonyms
         */
        deleteSynonym(identifier: string, options: SynonymOption, cb: (err: Error, res: Task) => void): void;
        /**
         * Clear all synonyms of an index
         * https://github.com/algolia/algoliasearch-client-js#clear-all-synonyms---clearsynonyms
         */
        clearSynonyms(options: SynonymOption, cb: (err: Error, res: Task) => void): void;
        /**
         ...
         */
        saveRule(rule: Rule, options: RuleOption, cb: (err: Error, res: Task) => void): void;
        /**
         * Save a rule object
         */
        batchRules(rules: Rule[], options: RuleOption, cb: (err: Error, res: Task) => void): void;
        /**
         * Delete a specific rule
         * https://github.com/algolia/algoliasearch-client-js#batch-rules---batchrules
         */
        deleteRule(identifier: string, options: RuleOption, cb: (err: Error, res: Task) => void): void;
        /**
         ...
         */
        searchRules(options: SearchRuleOptions, cb: (err: Error, res: any) => void): void;
        /**
    ...
    namespace Places {
        ...
        interface PlaceInterface {
            ...
            search(
                e: QueryInterface & LanguageInterface,
                cb: (err: Error, response: ResultSearchInterface<LocalizedHitInterface>) => void
            ): void;
            ...
            reverse(
                ...
                cb: (err: Error, response: ResultSearchInterface<HitInterface>) => void
            ): void;
            reverse(
                e: QueryReverseInterface & LanguageInterface,
                cb: (err: Error, response: ResultSearchInterface<LocalizedHitInterface>) => void
            ): void;
            ...
            reverse(
                e: QueryReverseInterface & LanguageInterface
            ): Promise<ResultSearchInterface<LocalizedHitInterface>>;
        }
...
interface AlgoliasearchInstance {
    (applicationId: string, apiKey: string, options?: algoliasearch.ClientOptions): algoliasearch.Client;
}
