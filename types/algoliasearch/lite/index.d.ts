...
declare namespace algoliasearch {
    ...
    interface Index {
         ...
         * https://algolia.com/doc/api-reference/api-methods/get-objects/#retrieve-only-one-object
         */
        getObject(objectID: string, attributes: string[], cb: (err: Error, res: {}) => void): void;
        /**
         * Gets specific attributes from an object
         * https://algolia.com/doc/api-reference/api-methods/get-objects/#retrieve-only-one-object
         */
         ...
         */
        search<T = any>(params: QueryParameters, cb: (err: Error, res: Response<T>) => void): void;
        /**
         * Search in an index
         * https://github.com/algolia/algoliasearch-client-js#search-in-an-index---search
         */
         ...
         */
        searchForFacetValues(options: SearchForFacetValues.Parameters): Promise<SearchForFacetValues.Response>;
        /**
         * Search in an index
         * https://www.algolia.com/doc/api-reference/api-methods/search-for-facet-values/
         */
...
declare function algoliasearch(applicationId: string, apiKey: string, options?: ClientOptions): algoliasearch.Client;
