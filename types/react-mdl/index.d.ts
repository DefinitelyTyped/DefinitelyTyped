...
declare namespace __ReactMDL {
    ...
    class __MDLComponent<P> extends React.Component<P> { render(): React.ReactNode }
    ...
    class MDLComponent extends React.Component<{ recursive?: boolean }> { render(): React.ReactNode }
}
