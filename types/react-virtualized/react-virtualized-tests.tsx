...
export class InfiniteLoaderExample extends PureComponent<any, any> {
    ...
    _rowRenderer({ index, key, style }: ListRowProps) {
        ...
        if (loadedRowsMap[index] === STATUS_LOADED) {
            ...
            content = <div className={'styles.placeholder'} style={{ width: row.size }} />;
        }
                        ...
                        <div className={'styles.GridRow'}>
                            <div
                                ...
                                style={{
                                    ...
                                    top: 0,
                                    color: leftColor,
                                    backgroundColor: `rgb(${topBackgroundColor.r},${topBackgroundColor.g},${
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    top: rowHeight,
                                    color: leftColor,
                                    backgroundColor: `rgb(${leftBackgroundColor.r},${leftBackgroundColor.g},${
