...
declare namespace gapi.client {
    ...
    const activities: gapi.client.admin.ActivitiesResource; 
    
    const channels: gapi.client.admin.ChannelsResource; 
    
    const customerUsageReports: gapi.client.admin.CustomerUsageReportsResource; 
    
    const userUsageReport: gapi.client.admin.UserUsageReportResource; 
