...
declare class WebpackAssetsManifest extends Plugin {
    ...
    hooks: {
        ...
        customize: SyncWaterfallHook<
            ...
            WebpackAssetsManifest.AnyObject,
...
declare namespace WebpackAssetsManifest {
    interface Options {
        ...
        replacer?:
            ...
            | ((key: string, value: string) => number | string | boolean | null | object | undefined);
        ...
        customize?:
            | ((entry: Entry, original: AnyObject, manifest: WebpackAssetsManifest, asset: AnyObject) => Entry | false)
            | null;
