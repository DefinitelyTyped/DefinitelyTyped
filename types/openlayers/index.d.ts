...
export class Map extends Object {
     ...
     * @api stable
     */
    getFeaturesAtPixel(pixel: ol.Pixel, opt_options?: olx.AtPixelOptions): Array<ol.Feature | ol.render.Feature> | null;
     ...
     * @api
     */
    hasFeatureAtPixel(pixel: ol.Pixel, opt_options?: olx.AtPixelOptions): boolean;
...
export namespace proj {
     ...
     */
    function getPointResolution(projection: Projection, resolution: number, point: ol.Coordinate): number;
}
