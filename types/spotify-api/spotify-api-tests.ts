...
const playlist: SpotifyApi.SinglePlaylistResponse = {
    ...
    tracks: {
        href:
            'https://api.spotify.com/v1/users/physicaltunes/playlists/0r6srTg2RFfBWba9WZ6Dlq/tracks?offset=0&limit=100',
        items: [
            {
...
const playlistTracks: SpotifyApi.PlaylistTrackResponse = {
    href:
        'https://api.spotify.com/v1/users/spotify_espa%C3%B1a/playlists/21THa8j9TaSGuXYNBU5tsC/tracks?offset=0&limit=3',
    items: [
        {
    ...
    limit: 3,
    next:
        'https://api.spotify.com/v1/users/spotify_espa%C3%B1a/playlists/21THa8j9TaSGuXYNBU5tsC/tracks?offset=3&limit=3',
    offset: 0,
    previous: null,
    total: 69,
};
