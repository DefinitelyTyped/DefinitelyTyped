// Type definitions for StripeJS v3.0
...
declare module 'stripejs' {
    import {ElementCreatorOptions, ElementFactory} from 'stripejs/element';
    import {StripePaymentOptions, StripePaymentRequest} from 'stripejs/payment';
    import {BankTokenData, PiiTokenData, TokenData, IBANTokenData, TokenResult} from 'stripejs/token';
