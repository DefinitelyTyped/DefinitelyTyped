declare module 'stripejs/element' {
    ...
    interface ElementCreatorOptions {
        /**
     ...
     * @see ElementCreator
     */
    type ElementType = 'card' | 'cardNumber' | 'cardExpiry' | 'cardCvc' | 'postalCode';
    ...
    // --- CARD ELEMENT --- //
    interface CardElementOptions extends BaseOptions {
        /**
         * A pre-filled value
    ...
    // --- IBAN ELEMENT --- //
    interface IBANElementOptions extends BaseOptions {
        /**
    ...
    // --- IDEAL ELEMENT --- //
    interface IdealBankOptions extends BaseOptions {
        /**
    ...
    interface PaymentRequestButtonStyle {
        /**
    ...
    interface MSClearAttributes extends StyleAttributes {
        display?: string;
    }
}