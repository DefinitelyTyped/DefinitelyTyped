declare module 'stripejs/payment' {
    import {StripePaymentResponse} from "stripejs/payment";
    import {ShippingAddress, ShippingOption} from "stripejs/shipping";
    ...
    interface StripePaymentRequest {
         ...
         * NOTE: can only be called when the browser payment interface is not showing
         *
    ...
    interface UpdateOptions {
         ...
         * NOTE: This object is shown to the customer in the browser‘s payment interface
         */
        total: PaymentItem;
     ...
     */
    interface StripePaymentOptions extends UpdateOptions {
        /**
