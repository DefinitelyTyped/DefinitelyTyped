...
declare module 'angular' {
    export namespace permission {
        ...
        export interface PermissionStore {
             ...
             */
            definePermission(permissionName: string, validationFunction: PermissionValidationFunction): void;
             ...
             * @param validationFunction {Function} Function used to validate if permission is valid
             */
            defineManyPermissions(permissionNames: string[], validationFunction: PermissionValidationFunction): void;
        ...
        export interface RoleStore {
             ...
             */
            defineRole(roleName: string, permissions: string[], validationFunction: RoleValidationFunction): void;
