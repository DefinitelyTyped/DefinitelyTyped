...
import { ngPermission, permission, uiPermission } from "angular-permission";
    ...
    .run(
        function(
            ...
            PermissionStore
                ...
                .definePermission(
                    "admin",
                    function(permission: string, stateParams: angular.permission.TransitionProperties) {
            ...
            PermissionStore.defineManyPermissions(
                ...
                function(permissionName: string, stateParams: angular.permission.TransitionProperties) {
