...
angular
    .module('barModule', [permission, 'user'])
    .run(function (
        PermissionStore: permissionNamespace.PermissionStore,
        ...
        PermissionStore
            ...
            .definePermission('admin', function (
                permission: string,
                stateParams: angular.permission.TransitionProperties,
            ) {
        ...
        PermissionStore.defineManyPermissions(arrayOfPermissionNames, function (
...
angular.module('fooModule', [permission, 'user']).run(function (RoleStore: permissionNamespace.RoleStore, User: any) {
    RoleStore
