...
declare module "node:console" {
    ...
    interface ConsoleDirOptions {
        ...
        /**
         * Tells [`util.inspect()`](https://nodejs.org/docs/latest-v20.x/api/util.html#utilinspectobject-options)
         * how many times to recurse while formatting the object. This is useful for inspecting large complicated
         * objects. To make it recurse indefinitely, pass `null`.
         * @default 2
         */
        depth?: number | null | undefined;
        /**
         * If true, then the output will be styled with ANSI color codes. Colors are customizable;
         * see [customizing `util.inspect()`](https://nodejs.org/docs/latest-v20.x/api/util.html#customizing-utilinspect-colors) colors.
         * @default false
         */
    ...
    global {
        ...
        interface Console {
             ...
             * @since v0.1.101
             */
            dir(obj: any, options?: ConsoleDirOptions): void;
            /**
