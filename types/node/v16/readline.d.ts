...
declare module "readline" {
    ...
    type AsyncCompleter = (line: string, /** @deferred */ callback: (err?: null | Error, result?: CompleterResult) => void) => void;
     ...
     */
    function clearLine(stream: NodeJS.WritableStream, dir: Direction, /** @deferred */ callback?: () => void): boolean;
    /**
     ...
     * @return `false` if `stream` wishes for the calling code to wait for the `'drain'` event to be emitted before continuing to write additional data; otherwise `true`.
     */
    function clearScreenDown(stream: NodeJS.WritableStream, /** @deferred */ callback?: () => void): boolean;
    /**
     ...
     * @return `false` if `stream` wishes for the calling code to wait for the `'drain'` event to be emitted before continuing to write additional data; otherwise `true`.
     */
    function cursorTo(stream: NodeJS.WritableStream, x: number, y?: number, /** @deferred */ callback?: () => void): boolean;
    /**
     ...
     * @return `false` if `stream` wishes for the calling code to wait for the `'drain'` event to be emitted before continuing to write additional data; otherwise `true`.
     */
    function moveCursor(stream: NodeJS.WritableStream, dx: number, dy: number, /** @deferred */ callback?: () => void): boolean;
}
