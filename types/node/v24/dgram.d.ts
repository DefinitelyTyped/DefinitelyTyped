...
declare module "dgram" {
    ...
    class Socket extends EventEmitter {
         ...
         * used when using `dgram.Socket` objects with the [`cluster`](https://nodejs.org/docs/latest-v24.x/api/cluster.html) module. When
         ...
         * does not participate in [`cluster`](https://nodejs.org/docs/latest-v24.x/api/cluster.html) handle sharing.
         * @since v24.19.0
