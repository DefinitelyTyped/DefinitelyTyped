 ...
 * * `node.async_hooks`: Enables capture of detailed [`async_hooks`](https://nodejs.org/docs/latest-v18.x/api/async_hooks.html) trace data.
 * The [`async_hooks`](https://nodejs.org/docs/latest-v18.x/api/async_hooks.html) events have a unique `asyncId` and a special `triggerId` `triggerAsyncId` property.
 ...
 * * `node.perf`: Enables capture of [Performance API](https://nodejs.org/docs/latest-v18.x/api/perf_hooks.html) measurements.
 ...
 * * `v8`: The [V8](https://nodejs.org/docs/latest-v18.x/api/v8.html) events are GC, compiling, and execution related.
 ...
 *
 * The features from this module are not available in [`Worker`](https://nodejs.org/docs/latest-v18.x/api/worker_threads.html#class-worker) threads.
 * @experimental
 * @see [source](https://github.com/nodejs/node/blob/v18.20.2/lib/trace_events.js)
 */
