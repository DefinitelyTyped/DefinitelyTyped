...
declare module "net" {
    ...
    class Socket extends stream.Duplex {
         ...
         * @return The socket itself.
         */
        end(callback?: (err?: Error | null) => void): this;
        end(buffer: Uint8Array | string, callback?: (err?: Error | null) => void): this;
        end(str: Uint8Array | string, encoding?: BufferEncoding, callback?: (err?: Error | null) => void): this;
        /**
         * events.EventEmitter
         *   1. close
         *   2. connect
