declare module 'util' {
    ...
    namespace types {
        ...
        function isBoxedPrimitive(
            object: any
        ): object is Number | Boolean | String | Symbol /* | Object(BigInt) | Object(Symbol) */;
    ...
    class TextDecoder {
        ...
        decode(input?: NodeJS.TypedArray | DataView | ArrayBuffer | null, options?: { stream?: boolean }): string;
    }
