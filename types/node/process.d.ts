declare module "process" {
    ...
    interface ProcessEventMap extends SignalsEventMap {
        ...
        "message": [
            ...
            sendHandle: dgram.Socket | net.Server | net.Socket | undefined,
        ];
        "multipleResolves": Parameters<NodeJS.MultipleResolveListener>;
        ...
        "workerMessage": [value: unknown, source: number];
    }
    global {
