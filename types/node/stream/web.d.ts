declare module "node:stream/web" {
    ...
    var ReadableStream: {
        ...
        new(underlyingSource: UnderlyingByteSource, strategy?: { highWaterMark?: number }): ReadableStream<NodeJS.NonSharedUint8Array>;
    ...
    interface ReadableStreamBYOBReader extends ReadableStreamGenericReader {
        read<T extends NodeJS.NonSharedArrayBufferView>(view: T, options?: ReadableStreamBYOBReaderReadOptions): Promise<ReadableStreamReadResult<T>>;
        releaseLock(): void;
    }
