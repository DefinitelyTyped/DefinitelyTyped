...
declare module "cluster" {
    ...
    interface WorkerEventMap {
        ...
        "message": [message: any, handle: net.Socket | net.Server];
        "online": [];
    }
    /**
     ...
     * @since v0.7.0
     */
    export class Worker implements EventEmitter {
        /**
    ...
    export interface Worker extends InternalEventEmitter<WorkerEventMap> {}
    interface ClusterEventMap {
        ...
        "message": [worker: Worker, message: any, handle: net.Socket | net.Server];
        "online": [worker: Worker];
        "setup": [settings: ClusterSettings];
    }
    export interface Cluster extends InternalEventEmitter<ClusterEventMap> {
