...
declare module "fs" {
    ...
    export interface FSWatcher extends InternalEventEmitter<FSWatcherEventMap> {
        /**
     ...
     * @experimental
     */
    export class Utf8Stream implements EventEmitter {
    ...
    export interface Utf8Stream extends InternalEventEmitter<Utf8StreamEventMap> {}
