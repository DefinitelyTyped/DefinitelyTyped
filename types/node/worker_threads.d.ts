...
declare module "worker_threads" {
    ...
    class MessagePort extends EventEmitter {
        ...
        addListener(event: "message", /** @deferred */ listener: (value: any) => void): this;
        addListener(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        ...
        on(event: "message", /** @deferred */ listener: (value: any) => void): this;
        on(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        on(event: string | symbol, /** @deferred */ listener: (...args: any[]) => void): this;
        once(event: "close", /** @deferred */ listener: () => void): this;
        once(event: "message", /** @deferred */ listener: (value: any) => void): this;
        once(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        once(event: string | symbol, /** @deferred */ listener: (...args: any[]) => void): this;
        prependListener(event: "close", /** @deferred */ listener: () => void): this;
        prependListener(event: "message", /** @deferred */ listener: (value: any) => void): this;
        prependListener(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        ...
        prependOnceListener(event: "message", /** @deferred */ listener: (value: any) => void): this;
        prependOnceListener(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        ...
        removeListener(event: "message", /** @deferred */ listener: (value: any) => void): this;
        removeListener(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        removeListener(event: string | symbol, /** @deferred */ listener: (...args: any[]) => void): this;
        off(event: "close", /** @deferred */ listener: () => void): this;
        off(event: "message", /** @deferred */ listener: (value: any) => void): this;
        off(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        off(event: string | symbol, /** @deferred */ listener: (...args: any[]) => void): this;
    ...
    class Worker extends EventEmitter {
        ...
        addListener(event: "exit", /** @deferred */ listener: (exitCode: number) => void): this;
        addListener(event: "message", /** @deferred */ listener: (value: any) => void): this;
        addListener(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        ...
        prependOnceListener(event: "exit", /** @deferred */ listener: (exitCode: number) => void): this;
        prependOnceListener(event: "message", /** @deferred */ listener: (value: any) => void): this;
        prependOnceListener(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        ...
        removeListener(event: "exit", /** @deferred */ listener: (exitCode: number) => void): this;
        removeListener(event: "message", /** @deferred */ listener: (value: any) => void): this;
        removeListener(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        removeListener(event: "online", /** @deferred */ listener: () => void): this;
        removeListener(event: string | symbol, /** @deferred */ listener: (...args: any[]) => void): this;
        off(event: "error", /** @deferred */ listener: (err: Error) => void): this;
        off(event: "exit", /** @deferred */ listener: (exitCode: number) => void): this;
        off(event: "message", /** @deferred */ listener: (value: any) => void): this;
        off(event: "messageerror", /** @deferred */ listener: (error: Error) => void): this;
        off(event: "online", /** @deferred */ listener: () => void): this;
        off(event: string | symbol, /** @deferred */ listener: (...args: any[]) => void): this;
    }
