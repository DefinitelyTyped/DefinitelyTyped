declare module 'https' {
    ...
    interface Server<Request extends http.IncomingMessage = http.IncomingMessage, Response extends http.ServerResponse = http.ServerResponse> extends http.Server<Request, Response> {}
