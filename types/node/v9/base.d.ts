...
declare module 'dns' {
    ...
    export function resolve4(
        ...
        callback: (err: NodeJS.ErrnoException, addresses: string[] | RecordWithTtl[]) => void,
    ): void;
...
declare module 'fs' {
    ...
    export function realpath(
        path: PathLike,
        options: { encoding?: string | null } | string | undefined | null,
        callback: (err: NodeJS.ErrnoException, resolvedPath: string | Buffer) => void,
    ): void;
...
declare module 'tls' {
    ...
    export class Server extends net.Server {
        ...
        addListener(
            event: 'newSession',
            listener: (sessionId: any, sessionData: any, callback: (err: Error, resp: Buffer) => void) => void,
        ): this;
        addListener(
            event: 'OCSPRequest',
...
declare module 'http2' {
    ...
    export interface ClientHttp2Session extends Http2Session {
        ...
        addListener(
            event: 'stream',
            listener: (stream: ClientHttp2Stream, headers: IncomingHttpHeaders, flags: number) => void,
        ): this;
