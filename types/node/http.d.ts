...
declare module "http" {
    ...
    > extends net.ServerEventMap {
        ...
        "connect": [request: InstanceType<Request>, socket: stream.Duplex, head: Buffer];
        ...
        "upgrade": [req: InstanceType<Request>, socket: stream.Duplex, head: Buffer];
    }
    /**
     * @since v0.1.17
     */
    ...
    interface ClientRequestEventMap extends stream.WritableEventMap {
        ...
        "abort": [];
        "connect": [response: IncomingMessage, socket: net.Socket, head: Buffer];
        "continue": [];
        "information": [info: InformationEvent];
        "response": [response: IncomingMessage];
        "socket": [socket: net.Socket];
        "timeout": [];
        "upgrade": [response: IncomingMessage, socket: net.Socket, head: Buffer];
    }
    /**
