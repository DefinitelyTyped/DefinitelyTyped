...
declare module "node:console" {
    ...
    global {
        interface ConsoleDirOptions {
            ...
            /**
             * Tells [`util.inspect()`](https://nodejs.org/docs/latest-v18.x/api/util.html#utilinspectobject-options)
             ...
             * see [customizing `util.inspect()`](https://nodejs.org/docs/latest-v18.x/api/util.html#customizing-utilinspect-colors) colors.
             * @default false
             */
