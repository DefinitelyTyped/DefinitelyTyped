...
declare module "http2" {
    ...
    export interface Http2StreamEventMap extends stream.DuplexEventMap {
        "aborted": [];
    ...
    export interface ClientHttp2StreamEventMap extends Http2StreamEventMap {
        "continue": [];
    ...
    export interface Http2SessionEventMap {
        ...
        "error": [err: Error];
        "frameError": [type: number, code: number, id: number];
        "goaway": [errorCode: number, lastStreamID: number, opaqueData?: Buffer];
    ...
    export interface Http2Session extends InternalEventEmitter<Http2SessionEventMap> {
        /**
    ...
    export interface ServerHttp2SessionEventMap<
    ...
    export interface Http2SecureServerEventMap<
        Http1Request extends typeof IncomingMessage = typeof IncomingMessage,
        Http1Response extends typeof ServerResponse<InstanceType<Http1Request>> = typeof ServerResponse,
        Http2Request extends typeof Http2ServerRequest = typeof Http2ServerRequest,
        Http2Response extends typeof Http2ServerResponse<InstanceType<Http2Request>> = typeof Http2ServerResponse,
    ...
    export interface Http2ServerRequestEventMap extends stream.ReadableEventMap {
