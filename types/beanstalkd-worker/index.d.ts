...
export default class BeanstalkdWorker {
                    ...
                    */
                   handle(tube: string, handler: TubeHandler, options?: BeanstalkdHandleOptions): void;
                    ...
                    */
                   job(tube: string, jobId: string): Job;
                    ...
                    */
                   done(tube: string, jobId: string, onPoll?: JobPollHandler): Promise<void>;
...
export type TubeHandler = (this: WatcherJob, payload?: any) => any;
export type JobPollHandler = (state: BeanstalkdJobState) => any;

export type JobStatus = BeanstalkdJobState | "success";
...
export interface WatcherJob extends Job {
...
export interface BeanstalkdSpawnOptions {
...
export interface BeanstalkdHandleOptions {
...
export interface BeanstalkdHandleBackoff {
