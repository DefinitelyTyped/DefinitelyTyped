// Type definitions for lax.js x.x
...
declare module 'lax.js' {
    ...
    export interface LaxTransform {
        [styleBinding: CssProperty]: [LaxValueMap, LaxValueMap, LaxTransformOptions?];
    }
