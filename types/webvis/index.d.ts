declare namespace webvis {
    ...
    type JoinSessionRequestContent = {
        scenarioUri?: string;
        name?: string;
    ...
    type RemoveStreamRequestContent = {
        streamID: number;
    };
    ...
    type GetSimpleL3DInfoRequestContent = {
        nodeIDs?: number[];
        pathes?: number[][];
        shapeIDs?: number[];
    };
    ...
    /**
     * @experimental XREdgeCompareProperties is experimental and may be changed in the future without notice!
     ...
     *
     * @property properties An object with the changed properties.
     * @property viewer Reference to the related Viewer.
     */
    ...
    /**
     * @experimental XREdgeCompareMode is experimental and may be changed in the future without notice!
    ...
    type UserGeoResourceData = {
        resourceType: any;
        data: number[];
    };
    type UserGeometryData = {
        identifier?: string;
        matrix?: Array<number>;
        volume?: Array<number>;
        appearance?: {
     ...
     *
     * @remarks This API visualizes a set of {@link CloudPoint}s in the 3D space. At the moment,
     ...
     *
     * @property pointCloudId - The ID of the point cloud that was removed.
     * @property viewerId - The ID of the viewer that the point cloud was removed from.
     */
     ...
     *
     * @property pointCloudId - The ID of the point cloud data that was created.
     * @property properties - The properties of the point cloud that was created.
     * @property viewerId - The ID of the viewer that the point cloud was created in.
     */
     ...
     *
     * @property pointCloudId - The ID of the point cloud that was changed.
     * @property properties - The properties of the point cloud that was changed.
     * @property viewerId - The ID of the viewer that the point cloud was changed in.
     */
    ...
    type ViewerMagnifierProperties = {
        /**
    ...
    type ViewerHighlightParameters = {
     ...
     *
     * @property heatmapId - The ID of the heatmap that was removed.
     * @property viewerId - The ID of the viewer that the heatmap was removed from.
     */
     ...
     *
     * @property heatmapId - The ID of the heatmap data that was created.
     * @property properties - The properties of the heatmap that was created.
     * @property viewerId - The ID of the viewer that the heatmap was created in.
     */
     ...
     *
     * @property configuration - The new configuration of the heatmap.
     * @property viewerId - The ID of the viewer that the heatmap configuration was changed in.
     */
     ...
     *
     * @property heatmapId - The ID of the heatmap that was changed.
     * @property properties - The properties of the heatmap that was changed.
     * @property viewerId - The ID of the viewer that the heatmap was changed in.
     */
    ...
    type ViewerDrawingProcessOptions = {
        /**
            ...
            ViewerPointCloudAPI
    {
         ...
         *
         * @typeParam T The type of the setting to change.
         ...
         *
         * @typeParam T The type of the setting to read.
    ...
    /**
     * Events that signals that the viewport size has changed.
     * It contains the new width and height of the viewport.
     *
     * @event
     * @see {@link EventType.VIEWPORT_CHANGED}
     *
     * @property width The new width of the viewport
     * @property height The new height of the viewport
     */
     ...
     *
     * @property viewerSetting The name of the setting that has changed
     * @property value The new value of the setting
     * @property viewer The viewer in which the setting was changed
     */
     ...
     *
     * @property viewerId The id of the viewer that was removed
     */
     ...
     *
     * @property viewerId The id of the viewer in which the navigation was started
     */
     ...
     * @see {@link NavigationMode}
     *
     * @property viewerId The id of the viewer in which the navigation ended
     */
     ...
     *
     * @property viewerId The id of the viewer that was created
     */
     ...
     * @see {@link ViewerAPI.setViewMatrix}
     *
     * @property viewer The viewer in which the view matrix was changed
     * @property matrix The new view matrix
     */
     ...
     *
     * @property progressState The current progress state of the viewer
     */
    ...
    /**
     * Event that is fired when every resource is downloaded and drawing is finished.
     *
     * @event
     ...
     */
    type TopologyShapeDescriptor = {
        /**
         * The volume of the Shape.
         */
        volume: number;
    };
    type TopologyPropertyTypeMap = {
     ...
     */
    type TopologyPlanarFaceDescriptor = {
        /**
     ...
     */
    type TopologyLineSegmentDescriptor = {
        /**
     ...
     */
    type TopologyEllipseDescriptor = {
        /**
     ...
     */
    type TopologyEdgeDescriptor = {
        /**
         * The length of the Edge.
         */
        length: number;
    };
    type TopologyDescriptorMap = {
     ...
     */
    type TopologyCylinderDescriptor = {
        /**
     ...
     */
    type TopologyCircularArcDescriptor = {
        /**
    ...
    interface TopologyAPI {
         ...
         * @typeParam {keyof TopologyPropertyTypeMap} T - The type of the property which should be set.
    ...
    enum ViewerSettingStrings {
         ...
         *
         * @valueType {@link DrawingArrowhead}
         ...
         *
         * @valueType [number, number, number, number, number, number, number, number, number, number, number, number, number, number, number, number] | Float32Array | undefined
         * @default undefined
         *
         ...
         *
         * @valueType {@link ViewerLightingEnvironment}
         ...
         *
         * @valueType {@link CameraProjectionType}
         ...
         *
         * @valueType {@link ViewPerspective}
     ...
     *
     * @property targetNodeID - The ID of the node whose selection has changed. For further information see {@link ChangeSelectionResult.targetNodeID}.
     * @property oldSelectionCount - The number of previous selected Nodes.
     * @property newSelectionCount - The number of currently selected Nodes.
     * @property selectedNodes - The IDs of the currently selected Nodes.
     */
     ...
     */
    type XRImageSourceConfigDevice = {
     ...
     */
    type XRImageSourceConfigPlayback = {
        /**
     ...
     */
    type ThicknessMeasurementResult = {
        /**
     ...
     */
    type MeasurementTypeToTargetMap = {
        /**
     ...
     * @see {@link MeasurementType}
     */
    type MeasurementTypeToResultMap = {
        /**
     ...
     */
    type MeasurementTargetClassMap = {
        /**
     ...
     * @see {@link MeasurementTargetClass}
     *
     * @typeParam K - The {@link MeasurementTargetClass}. Defaults to all available classes.
     */
     ...
     * @see {@link MeasurementType}
     *
     * @typeParam K - The {@link MeasurementType}. Defaults to all available types.
     */
    ...
    interface MeasurementAPI {
         ...
         *
         * @typeParam T - The {@link MeasurementType}.
     ...
     *
     * @property measurementID - The ID of the measurement.
     */
     ...
     *
     * @property measurementID - The ID of the measurement.
     * @property properties - The properties of the measurement.
     */
     ...
     *
     * @property measurementID - The ID of the measurement.
     * @property properties - The properties of the measurement that have been changed.
     */
     ...
     *
     * @property materialId The ID of the material.
     */
     ...
     *
     * @property materialId The ID of the material.
     * @property properties The properties of the material.
     */
     ...
     *
     * @property materialId The ID of the material.
     * @property properties The properties of the material that have been changed.
     */
     ...
     */
    type SetLayerFilterEnabledResult = {
    ...
    class LayerFilterRegisteredEvent extends WebVisEvent {
         ...
         * @param {boolean} enabled The enabled state of the new LayerFilter.
         */
    ...
    interface InstanceGraphAPI {
         ...
         */
        resetProperty<T extends Property | string>(nodeID: number, property: T, recursive?: boolean): Promise<void>;
        /**
     ...
     *
     * @property targetNodeID  The ID of the target node.
     * @property parentNodeID  The ID of the parent node.
     *
     * @event
     ...
     *
     * @property targetNodeID  The ID of the target node.
     * @property properties    The properties which has been reset.
     * @property recursive     If set to true, the properties are reset recursively.
     *
     * @event
     ...
     *
     * @property targetNodeId  The ID of the target node.
     * @property state         The State of the target node.
     *
     * @event
     ...
     *
     * @property targetNodeID  The ID of the target node.
     * @property sourceNodeID  The ID of the source node.
     * @property property      The property which has been changed.
     ...
     * @property targetNodeID     The ID of the target node.
     * @property parentNodeID     The ID of the parent node.
     * @property nodeType         The type of the target node.
     * @property dataUri          The data URI of the target node.
     * @property targetNodeDepth  The depth of the target node.
     * @property label            The label of the target node.
     * @property properties       A map of all properties on the node.
     * @property usage            The usage of the target node.
     * @property subType          The sub type of the target node.
     * @property contentType      The content type of the target node.
     *
     * @event
     ...
     *
     * @event
     * @property nodePath The path of the node which should be moved.
     * @property parentPath The path of the new parent node.
     */
     ...
     *
     * @property targetNodeIDs    The IDs of the target Nodes.
     * @property targetNodePaths  The paths of the target Nodes.
     */
     ...
     *
     * @property targetNodeIDs The IDs of the changed Nodes.
     * @property targetNodePaths The paths of the changed Nodes.
     * @property propertyName  The name of the changed Property.
     * @property propertyValue The new value of the Property.
     */
    ...
    enum Property {
         ...
         *
         * @valueType \{ name: string } & {@link AnimationOptions}
         * @default null
         *
         ...
         *
         * @valueType {@link EnabledState} | boolean
         * @default false
         */
         ...
         *
         * @valueType {@link ComparisonGroup}
         * @default ComparisonGroup.NONE
         *
         * @see {@link ViewerAPI.enterColorCompareMode}
         * @see {@link InteractionMode.COLOR_COMPARISON}
        ...
        /**
         * @hidden The hidden property is hidden, heh heh. It is currently not used but might make its return in the future.
         *
         * @valueType boolean
         * @default false
         */
         ...
         *
         * @readonly
         * @valueType {@link NodeRepresentation}
         ...
         *
         * @valueType {@link Serializable} | undefined
         * @default undefined
         */
        USER_DATA = "userData",
    }
     ...
     * @property state The new status of the service.
     */
     ...
     *
     * @property service The name of the service.
     * @property state The new state of the service.
     */
     ...
     *
     * @property service The name of the service.
     * @property status The status code of the connection.
     */
     ...
     *
     * @typeParam T - The type of event that the listener listens to. This can also be
    ...
    interface EventAPI {
         ...
         *
         * @typeParam T - The type of event that the listener listens to. This can also be a union of multiple
         * event types.
     ...
     * @property transactionCode - The transaction code associated with the event.
     * @property transactionID - The transaction ID associated with the event.
     */
    class WebVisEvent {
    ...
    interface AttachmentAPI {
         ...
         *
         * @typeParam T The data type fitting the {@link AttachmentType} of the attachment data.
         * @param attachmentID Specifies the attachment object.
         ...
         *
         * @typeParam The data type fitting the {@link AttachmentType} of the attachment data.
         * @param attachmentID Specifies the attachment object.
     ...
     *
     * @property attachmentID - The ID of the attachment.
     * @property data - The new attachment data.
     */
     ...
     *
     * @property attachmentID - The ID of the attachment.
     * @property dataType - The type of the attachment data.
     */
     ...
     *
     * @property annotationID - The ID of the annotation.
     */
     ...
     *
     * @property annotationID - The ID of the annotation.
     * @property properties - An object with the properties to be used when creating the annotation.
     */
     ...
     *
     * @property annotationID - The ID of the annotation.
     * @property properties - An object with the properties to be changed.
     */
     ...
     *
     * @event
     * @property animationName - The name of the started animation.
     * @property targetNodeID - The node ID which runs the animation.
     * @property targetType - The type of the animation target.
     * @property options - The options of the animation.
     */
     ...
     *
     * @event
     * @property animationName - The name of the running animation.
     * @property targetNodeID - The node id which runs the animation.
     * @property targetType - The type of the animation target.
     * @property iteration - The current iteration.
     */
     ...
     *
     * @event
     * @property name - The name of the removed animation frames.
     */
     ...
     *
     * @event
     * @property name - The name of the generated animation frames.
     * @property frames - The list of created animation frames.
     */
    ...
    /**
     * Event that is fired when a animation has ended.
     ...
     *
     * @property animationName - The name of the ended animation.
     * @property targetNodeID - The node ID which runs the animation.
     * @property targetType - The type of the animation target.
     * @property options - The options of the ended animation.
     */
     ...
     */
    type ContextCreatedListenerOptions = {
        /**
     ...
     * An object that specifies characteristics about the event listener
     */
    type ContextRemovedListenerOptions = {
        /**
         * If true, the listener would be automatically removed when invoked.
         * @default false
         */
