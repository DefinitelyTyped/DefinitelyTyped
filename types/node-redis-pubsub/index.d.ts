...
declare namespace NRP {
    ...
    class NodeRedisPubSub {
        ...
        on(channel: string, handler: (data: string, channel: string) => void, callback?: () => void): () => void;
        subscribe(channel: string, handler: (data: string, channel: string) => void, callback?: () => void): () => void;
