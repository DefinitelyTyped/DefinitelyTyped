...
// Disabled rule above because the constraint between the output type C and T is needed
// in many cases in this file, such as.
...
export function set(str: string): Set<string>;
export function set<T>(coll: Collection<T> | T[]): Set<T>;
...
export function last<T>(coll: Collection<T> | T[]): T;
...
export function seq<T, C extends Collection<T>>(coll: C): Seq<T>;
export function seq<T>(arr: T[]): Seq<T>;
export function seq(str: string): Seq<string>;

export function cons<T, C extends Collection<T>>(val: T, coll: C): C;
...
export function reduceKV<K, T, R>(acc: (curr: R, key: K, val: T) => R, init: R, map: Associative<K, T>): R;

export function take<T, S extends Seq<T>>(n: number, seq: S): S;

export function takeWhile<T, C extends Collection<T>>(pred: (val: T) => boolean, coll: C): C;
export function takeWhile<T>(pred: (val: T) => boolean, arr: T[]): Seq<T>;
export function takeWhile(pred: (val: string) => boolean, str: string): Seq<string>;

export function drop<T, C extends Collection<T>>(n: number, coll: C): C;
export function drop<T>(n: number, arr: T[]): Seq<T>;
export function drop(n: number, str: string): Seq<string>;

export function dropWhile<T, C extends Collection<T>>(pred: (val: T) => boolean, coll: C): C;
export function dropWhile<T>(pred: (val: T) => boolean, arr: T[]): Seq<T>;
export function dropWhile(pred: (val: string) => boolean, str: string): Seq<string>;

export function some<T, C extends Collection<T>>(pred: (val: T) => T, coll: C): T;
export function some<T>(pred: (val: T) => T, arr: T[]): Seq<T>;
export function some(pred: (val: string) => string | null | undefined | boolean, str: string): Seq<string>;

export function every<T, C extends Collection<T>>(pred: (val: T) => boolean, seq: C): boolean;
export function every<T>(pred: (val: T) => boolean, arr: T[]): boolean;
export function every(pred: (val: string) => boolean, str: string): boolean;

export function sort<T, C extends Collection<T>>(coll: C): C;
export function sort<T>(arr: T[]): Seq<T>;
export function sort(str: string): Seq<string>;
...
export function interpose<T, C extends Collection<T>>(val: T, coll: C): C;
export function interpose<T>(val: T, arr: T[]): Seq<T>;
export function interpose(val: string, str: string): Seq<string>;
export function interpose(val: any, str: any): Seq<any>;
...
export function iterate<T, C extends Collection<T>>(fn: (val: T) => T, init: T): C;

export function repeat<T, C extends Collection<T>>(n: number, val: T): C;
export function repeat<T>(val: T): Seq<T>;

export function repeatedly<T, C extends Collection<T>>(fn: () => T): C;
export function repeatedly<T, C extends Collection<T>>(n: number, fn: () => T): C;

export function partition<T>(n: number, coll: Collection<T> | T[]): Seq<Seq<T>>;
export function partition(n: number, str: string): Seq<Seq<string>>;
export function partition<T>(n: number, step: number, coll: Collection<T> | T[]): Seq<Seq<T>>;
export function partition(n: number, step: number, str: string): Seq<Seq<string>>;
export function partition<T>(
    n: number, step: number, pad: T, coll: Collection<T> | T[]): Seq<Seq<T>>;
// tslint:disable-next-line:unified-signatures
export function partition(n: number, step: number, pad: string, str: string): Seq<Seq<string>>;

export function partitionBy<T>(fn: (val: T) => any, coll: Collection<T> | T[]): Seq<Seq<T>>;
export function partitionBy(fn: (val: string) => any, str: string): Seq<Seq<string>>;

export function groupBy<T, K>(
    fn: (val: T) => K, coll: Collection<T> | T[]): HashMap<K, T>;
export function groupBy<K>(fn: (val: string) => K, str: string): HashMap<K, string>;

// Helpers
export function primSeq<T>(coll: Collection<T> | T[], index?: number): Seq<T>;
export function primSeq(str: string, index?: number): Seq<string>;
...
export function pipeline(x: any, ...fns: Array<(val: any) => any>): any;

export function partial<T, U>(f: (val: T) => U, arg: T):
    () => U;
export function partial<T, A, U>(f: (val: T, arg: A) => U, arg: T):
    (arg: A) => U;
export function partial<T, A1, A2, U>(f: (val: T, arg1: A1, arg2: A2) => U, arg: T):
    (arg1: A1, arg2: A2) => U;
export function partial<T, A1, A2, A3, U>(f: (val: T, arg1: A1, arg2: A2, arg3: A3) => U, arg: T):
    (arg1: A1, arg2: A2, arg3: A3) => U;
export function partial<T, U>(f: (val: T, ...moreArgs: any[]) => U, arg: T):
    (args: any[]) => U;

export function curry<T, U>(f: (val: T) => U, arg: T): () => U;
export function curry<T, A, U>(f: (arg: A, val: T) => U, arg: T): (arg: A) => U;
export function curry<T, A1, A2, U>(
    f: (arg1: A1, arg2: A2, val: T) => U, arg: T): (arg1: A1, arg2: A2) => U;
export function curry<T, A1, A2, A3, U>(
    f: (arg1: A1, arg2: A2, arg3: A3, val: T) => U, arg: T): (arg1: A1, arg2: A2, arg3: A3) => U;
export function curry<U>(f: (...args: any[]) => U, val: any): (...args: any[]) => U;

export function fnil<T>(f: () => T): (val: T) => T;
