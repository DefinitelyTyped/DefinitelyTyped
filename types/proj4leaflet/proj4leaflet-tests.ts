...
const crs2 = new L.Proj.CRS("EPSG:3006", "+proj=utm +zone=33 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", {
    origin: [218128.7031, 6126002.9379],
    resolutions: [8192, 4096, 2048], // 3 example zoom level resolutions
});

const crs3 = new L.Proj.CRS("EPSG:3006", "+proj=utm +zone=33 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs", {
    origin: [218128.7031, 6126002.9379],
...
// imageOverlay
const imageBounds: LatLngBoundsExpression = [[145323.20011251318, 475418.56045463786], [
    175428.80013969325,
    499072.9604685671,
]];

L.Proj.imageOverlay(
    "http://geo.flevoland.nl/arcgis/rest/services/Groen_Natuur/Agrarische_Natuur/MapServer/export?"
