// Type definitions for @ckeditor/ckeditor5-html-support 33.0
...
export { default as DataSchema } from './src/dataschema';
export { default as HtmlComment } from './src/htmlcomment';
