...
export interface ExpandableCalendarProps extends CalendarList {
    /** the initial position of the calendar ('open' or 'closed') */
    initialPosition: 'open' | 'open';
...
export interface ExpandableCalendar extends React.Component<ExpandableCalendarProps> {}
