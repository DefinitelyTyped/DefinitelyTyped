...
declare class NextGenEvents {
    ...
    addListener(eventName: string, fn?: any, options?: NextGenEvents.AddListenerOptions): this;
    on(eventName: string, fn?: any, options?: NextGenEvents.AddListenerOptions): this;
    once(eventName: string, fn?: any, options?: NextGenEvents.AddListenerOptions): this;
    ...
    addListenerContext(contextName: string, options: NextGenEvents.ContextOptions): this;
    ...
    static emitToOneListener(event: NextGenEvents.Event, listener: any, removedListeners: any): void;
    ...
    static getContextScope(context: NextGenEvents.Context, scopeName: string): NextGenEvents.Scope;
