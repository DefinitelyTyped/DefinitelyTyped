...
declare namespace CassanKnex {
    ...
    type SelectAsClause<T> = { [P in keyof T]: string };
    ...
    type InsertQueryBuilder = QueryBuilder & InsertableQueryBuilder & TtlableQueryBuilder;
    type SelectQueryBuilder<T> = QueryBuilder & WhereableQueryBuilder<T> & LimitableQueryBuilder & FromableQueryBuilder;
    type UpdateQueryBuilder<T> = QueryBuilder &
        WhereableQueryBuilder<T> &
        UpdateableQueryBuilder<T> &
        IfableQueryBuilder<T> &
        TtlableQueryBuilder;
    type DeleteQueryBuilder<T> = QueryBuilder & WhereableQueryBuilder<T> & FromableQueryBuilder;
    type CreateColumnFamilyQueryBuilder<T> = QueryBuilder &
        FieldValueQueryBuilder<T> &
        CreateableColumnFamilyBuilder<T>;
    type KeyspaceQueryBuilder = QueryBuilder & KeyspaceableQueryBuilder;
    type CreateTypeQueryBuilder<T> = QueryBuilder & FieldValueQueryBuilder<T>;
    type AlterColumnFamilyQueryBuilder<T> = QueryBuilder & AlterableQueryBuilder<T> & FieldValueQueryBuilder<T>;
}
