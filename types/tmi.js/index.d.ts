// Type definitions for tmi.js v1.3.1
// Project: https://docs.tmijs.org/v1.3.0/index.html
...
declare module 'tmi.js' {
    ...
    interface ClientBase {
        ...
        removeAllListeners<P extends keyof Events>(event?: P): Client,
        setMaxListeners(n: number): Client,
        emits(events: (keyof Events)[], values: any[][]): void, //wish this could work better but either I'm just not smart enough or it's not possible
        emit: (event: any) => boolean,
        once(event: any, listener: any): Client,
        listenerCount<P extends keyof Events>(event: P): number,
    }
    ...
    interface UserNoticeState extends CommonUserstate {
        login?: string,
        message?: string,
        "system-msg"?: string,
    }

    interface CommonSubUserstate extends UserNoticeState {
        "msg-param-sub-plan"?: ResubMethod,
        "msg-param-sub-plan-name"?: string
    }

    interface ChatUserstate extends CommonUserstate {
        'message-type'?: "chat" | "action" | "whisper",
        username?: string,
        bits?: string,
    }

    interface SubUserstate extends CommonSubUserstate {
    ...
    interface SubGiftUserstate extends CommonSubUserstate {
    ...
    interface RaidUserstate extends UserNoticeState {
        "message-type"?: "raid"
    ...
    type Userstate = ChatUserstate | SubGiftUserstate | SubUserstate | RaidUserstate | RitualUserstate
    ...
    type ResubMethod = "Prime" | "1000" | "2000" | "3000"
    ...
    type Client = StrictEventEmitter<ClientBase, Events> & Actions
