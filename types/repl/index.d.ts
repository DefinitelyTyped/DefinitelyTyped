...
export type REPLEval = (this: REPLServer, evalCmd: string, context: Context, file: string, cb: (err: Error | null, result: any) => void) => void;
export type REPLWriter = (this: REPLServer, obj: any) => string;

/**
 * This is the default "writer" value, if none is passed in the REPL options,
 * and it can be overridden by custom print functions.
 */
export const writer: REPLWriter & { options: InspectOptions };

export type REPLCommandAction = (this: REPLServer, text: string) => void;
...
export class REPLServer extends Interface {
     ...
     */
    readonly inputStream: ReadableStream;
    /**
     ...
     */
    readonly commands: { readonly [key: string]: REPLCommand | undefined };
    /**
