...
import { CodeGeneratorResponse as pb_CodeGeneratorResponse } from 'google-protobuf/google/protobuf/compiler/plugin_pb';
import FileObject = pb_CodeGeneratorResponse.File.AsObject;

const { CodeGeneratorRequest, CodeGeneratorResponse, CodeGeneratorResponseError } = protocPlugin;
