...
declare module 'opentok' {
  ...
  class OpenTok {
    ...
    public startArchive(sessionId: string, options: OpenTok.ArchiveOptions, callback: (error: Error, archive: OpenTok.Archive) => void): void;
    public stopArchive(archiveId: string, callback: (error: Error, archive: OpenTok.Archive) => void): void;
    ...
    public startBroadcast(sessionId: string, options: OpenTok.BroadcastOptions, callback: (error: Error, broadcast: OpenTok.Broadcast) => void): void;
    public stopBroadcast(broadcastId: string, callback: (error: Error, broadcast: OpenTok.BroadcastStopResponse) => void): void;
