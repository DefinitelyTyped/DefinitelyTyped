...
interface Creep extends RoomObject {
    ...
    /**
     * Accept another Creep's request to pull
     * @param target Creep to accept pull request from
     * @see Creep.move
     */
    move(target: Creep): CreepMoveReturnCode;
    /**
     ...
     * @param target Creep to be pulled
     */
