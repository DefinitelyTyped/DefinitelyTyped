...
export namespace NanoStream {
    ...
    interface NanoPlayerAdaption {
        rule?: 'deviationOfMean' | 'deviationOfMean2' | 'none';
        downStep?: number;
    }

    interface NanoPlayerSource {
    ...
    interface NanoPlayerStreamInfo {
