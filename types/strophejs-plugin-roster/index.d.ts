...
type IqCallback = (stanza: Element) => any
type IqID = string
type RosterSubscriptionState = 'none' | 'to' | 'from' | 'both' | 'remove'
type PresenceSubscriptionType = 'subscribe' | 'unsubscribe' | 'subscribed' | 'unsubscribed'
...
type RosterUpdateCallback =
(items: RosterItem[], item: RosterItem, previousItem: RosterItem) => any
type PresenceRequestCallback = (from: string) => any
