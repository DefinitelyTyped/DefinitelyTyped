...
export default class Device extends EventEmitter {
     ...
     */
    play(resource: string | MediaResource, options: PlaybackOptions, callback?: (error?: Error) => void): void;
    play(resource: string | MediaResource, callback?: (error?: Error) => void): void;

    /**
     * Gets the current status of the cast device including data about current media playback.
     */
    getStatus(callback?: (error?: Error, status?: DeviceStatus) => void): void;

    /**
     * Gets the current status of the cast device including data about current media playback.
     */
    getReceiverStatus(callback?: (error?: Error, status?: DeviceStatus) => void): void;
     ...
     */
    getVolume(callback?: (error?: Error, volume?: DeviceVolume) => void): void;
