...
minio.getObject('testBucket', 'hello.jpg', (error: Error | null, objectStream: Stream) => {
    console.log(error, objectStream);
});
minio.getObject('testBucket', 'hello.jpg');

minio.getPartialObject('testBucket', 'hello.jpg', 10, (error: Error | null, objectStream: Stream) => {
    console.log(error, objectStream);
});
minio.getPartialObject('testBucket', 'hello.jpg', 10, 20, (error: Error | null, objectStream: Stream) => {
    console.log(error, objectStream);
});
...
minio.putObject('testBucket', 'hello.jpg', new Stream(), (error: Error | null, etag: string) => {
    console.log(error, etag);
});
minio.putObject('testBucket', 'hello.jpg', new Buffer('string'), 100, (error: Error | null, etag: string) => {
    console.log(error, etag);
});
minio.putObject('testBucket', 'hello.txt', 'hello.txt content', 100, metaData, (error: Error | null, etag: string) => {
    console.log(error, etag);
});
...
minio.fPutObject('testBucket', 'hello.jpg', 'file/path', metaData, (error: Error | null, etag: string) => {
    console.log(error, etag);
});
