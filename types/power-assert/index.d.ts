...
declare namespace assert {
    ...
    export function strictEqual<T extends U, U = T>(actual: U, expected: T, message?: string): asserts actual is T;
    export function notStrictEqual<T>(actual: T, expected: T, message?: string): void;
    export function deepStrictEqual<T extends U, U = T>(actual: U, expected: T, message?: string): asserts actual is T;
