...
declare module _ {
    ...
    interface UnderscoreStatic {
        ...
        map<T>(list: _.List<T>, iterator: _.IterateePropertyShorthand, context?: any): any[];

        map<T>(list: _.List<T>, iterator: _.IterateeMatcherShorthand<any>, context?: any): boolean[];
         ...
         **/
        find<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>, context?: any): T | undefined;

        /**
         * @see _.find
         **/
        find<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>, context?: any): T | undefined;

        /**
         * @see _.find
         **/
        find<T, U extends {}>(object: _.List<T> | _.Dictionary<T>, iterator: U): T | undefined;

        /**
         * @see _.find
         **/
        find<T>(object: _.List<T> | _.Dictionary<T>, iterator: string): T | undefined;

        /**
         * @see _.find
         **/
        detect<T>(list: _.List<T>, iterator: _.ListIterator<T, boolean>, context?: any): T | undefined;

        /**
         * @see _.find
         **/
        detect<T>(object: _.Dictionary<T>, iterator: _.ObjectIterator<T, boolean>, context?: any): T | undefined;

        /**
         * @see _.find
         **/
        detect<T, U extends {}>(object: _.List<T> | _.Dictionary<T>, iterator: U): T | undefined;

        /**
         * @see _.find
         **/
        detect<T>(object: _.List<T> | _.Dictionary<T>, iterator: string): T | undefined;
         ...
         **/
        findWhere<T, U extends {}>(list: _.List<T>, properties: U): T | undefined;
         ...
         **/
        invoke<T extends {}>(list: _.List<T>, methodName: string, ...args: any[]): any;
         ...
         **/
        pluck<T extends {}, K extends keyof T>(list: _.List<T>, propertyName: K): T[K][];

        pluck(list: _.List<any>, propertyName: string): any[];
         ...
         **/
        sortedIndex<T, TSort>(list: _.List<T>, value: T, iterator?: ((x: T) => TSort) | string, context?: any): number;
        ...
        partial<T1, T2, T3>(fn: { (p1: T1, p2: T2): T3 }, stub1: UnderscoreStatic, p2: T2): { (p1: T1): T3 };

        partial<T1, T2, T3, T4>(fn: { (p1: T1, p2: T2, p3: T3): T4 }, p1: T1): { (p2: T2, p3: T3): T4 };
    ...
    interface _Chain<T, V = T> {
        ...
        pick<K extends keyof V>(keys: K[]): _Chain<TypeOfDictionary<Pick<V, K>>, Pick<V, K>>;
        pick<K extends keyof V>(
            predicate: ObjectIterator<V[K], boolean>,
        ): _Chain<TypeOfDictionary<Pick<V, K>>, Pick<V, K>>;
