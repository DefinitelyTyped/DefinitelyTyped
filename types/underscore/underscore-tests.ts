...
// toPath
{
    _.toPath(["a", 0, "b"] as const); // $ExpectType ["a", 0, "b"]
    _.toPath(["a", 0, "b"]); // $ExpectType (string | number)[]

    _(["a", 0, "b"] as const).toPath(); // $ExpectType ["a", 0, "b"]
    _(["a", 0, "b"]).toPath(); // $ExpectType (string | number)[]

    extractChainTypes(_.chain(["a", 0, "b"] as const).toPath()); // $ExpectType ChainType<["a", 0, "b"], 0 | "a" | "b">
