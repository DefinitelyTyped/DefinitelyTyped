...
// map, collect
{
    ...
    // property name iterator with a non-nullable single type - lists
    ...
    // property name iterator with a non-nullable single type - dictionaries
    ...
    // property name iterator with other types - lists
