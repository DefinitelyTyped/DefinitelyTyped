 ...
 *
 * Expects exactly one child, providing the rate in Hz.
 *
 * @param {core.Node} rate
 * child computing the rate in Hz
 * @returns {core.Node}
 * a node the output of the phasor
 */
export declare function phasor(
    rate: core.Node): core.Node;
 ...
 * child computing the rate in Hz
 * @returns {core.Node}
 * a node that computes the output of the pulse train
 */
 ...
 *
 * Expects exactly one child specifying the frequency in Hz.
 *
 * @param {core.Node} frequency
 * child computing the frequency in Hz
 * @returns {core.Node}
 * a node that computes the output of the sine wave
 */
export declare function cycle(
    frequency: core.Node): core.Node;
 ...
 * child computing the frequency in Hz
 * @returns {core.Node}
 * a node that computes the output of the saw wave
 */
 ...
 * child computing the frequency in Hz
 * @returns {core.Node}
 * a node that computes the output of the square wave
 */
 ...
 * child computing the frequency in Hz
 * @returns {core.Node}
 * a node that computes the output of the triangle wave
 */
 ...
 * child computing the frequency in Hz
 * @returns {core.Node}
 * a node that computes the output of the blepsaw
 */
 ...
 * child computing the frequency in Hz
 * @returns {core.Node}
 * a node that computes the output of the blepsquare
 */
 ...
 * child computing the frequency in Hz
 * @returns {core.Node}
 * a node that computes the output of the bleptriangle
 */
