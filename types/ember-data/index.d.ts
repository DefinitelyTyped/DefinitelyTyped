...
export namespace DS {
     ...
     */
    interface PromiseArray<T> extends Ember.ArrayProxy<T>, PromiseProxyMixin<Ember.ArrayProxy<T>> {}
     ...
     */
    interface PromiseObject<T extends object> extends ObjectProxy<T>, PromiseProxyMixin<T & ObjectProxy> {}
