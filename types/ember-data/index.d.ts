...
declare namespace DS {
  ...
  class BuildURLMixin {
     ...
     */
    buildURL(modelName: string, id: string|any[]|{}, snapshot: Snapshot|any[], requestType: string, query: {}): string;
    /**
     ...
     * property is true.
     */
    urlForFindMany(ids: any[], modelName: string, snapshots: any[]): string;
    /**
  ...
  class Snapshot {
     ...
     */
    belongsTo(keyName: string, options: {}): Snapshot|string|null|undefined;
    /**
  ...
  class RESTAdapter extends Adapter implements BuildURLMixin {
     ...
     * type and ID.
     */
    findRecord(store: Store, type: Model, id: string, snapshot: Snapshot): Promise<any>;
    /**
     * Called by the store in order to fetch a JSON array for all
     * of the records for a given type.
     */
    findAll(store: Store, type: Model, sinceToken: string, snapshotRecordArray: SnapshotRecordArray): Promise<any>;
    /**
     ...
     */
    findMany(store: Store, type: Model, ids: any[], snapshots: any[]): Promise<any>;
    /**
     * Called by the store in order to fetch a JSON array for
     * the unloaded records in a has-many relationship that were originally
     * specified as a URL (inside of `links`).
     */
    findHasMany(store: Store, snapshot: Snapshot, url: string, relationship: {}): Promise<any>;
    /**
     * Called by the store in order to fetch the JSON for the unloaded record in a
     * belongs-to relationship that was originally specified as a URL (inside of
     * `links`).
     */
    findBelongsTo(store: Store, snapshot: Snapshot, url: string): Promise<any>;
    /**
     * Called by the store when a newly created record is
     * saved via the `save` method on a model record instance.
     */
    createRecord(store: Store, type: Model, snapshot: Snapshot): Promise<any>;
    /**
     * Called by the store when an existing record is saved
     * via the `save` method on a model record instance.
     */
    updateRecord(store: Store, type: Model, snapshot: Snapshot): Promise<any>;
    /**
     * Called by the store when a record is deleted.
     */
    deleteRecord(store: Store, type: Model, snapshot: Snapshot): Promise<any>;
    /**
  ...
  class EmbeddedRecordsMixin {
     ...
     */
    serializeBelongsTo(snapshot: Snapshot, json: {}, relationship: {}): any;
    /**
     * Serializes `hasMany` relationships when it is configured as embedded objects.
     */
    serializeHasMany(snapshot: Snapshot, json: {}, relationship: {}): any;
    /**
     * When serializing an embedded record, modify the property (in the json payload)
     * that refers to the parent record (foreign key for relationship).
     */
    removeEmbeddedForeignKey(snapshot: Snapshot, embeddedSnapshot: Snapshot, relationship: {}, json: {}): any;
  }
  /**
  ...
  class JSONSerializer extends Serializer {
     ...
     */
    normalizeResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeFindRecordResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeQueryRecordResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeFindAllResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeFindBelongsToResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeFindHasManyResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeFindManyResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeQueryResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeCreateRecordResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeDeleteRecordResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeUpdateRecordResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeSaveResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeSingleResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    normalizeArrayResponse(store: Store, primaryModelClass: Model, payload: {}, id: string|number, requestType: string): {};
    /**
     ...
     */
    shouldSerializeHasMany(snapshot: Snapshot, key: string, relationshipType: string): boolean;
    /**
     ...
     */
    serializeIntoHash(hash: {}, typeClass: Model, snapshot: Snapshot, options: {}): any;
    /**
     * `serializeAttribute` can be used to customize how `DS.attr`
     * properties are serialized
     */
    serializeAttribute(snapshot: Snapshot, json: {}, key: string, attribute: {}): any;
    /**
     ...
     */
    serializePolymorphicType(snapshot: Snapshot, json: {}, relationship: {}): any;
    /**
  ...
  class Adapter extends Ember.Object {
     ...
     */
    generateIdForRecord(store: Store, type: Model, inputProperties: {}): string|number;
    /**
