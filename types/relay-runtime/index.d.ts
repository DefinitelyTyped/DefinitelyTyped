...
type OperationSelector = COperationSelector<any, any>;
type Selector = CSelector<any>;
type PayloadData = any;
type Snapshot = CSnapshot<any>;
...
// ~~~~~~~~~~~~~~~~~~~~~
declare function HandlerProvider(name: string): HandlerInterface | null;
...
// ~~~~~~~~~~~~~~~~~~~~~
interface RelayInMemoryRecordSource {
    [key: string]: any;
}
interface RecordMap {
...
declare class RelayRecordSourceInspector {
    constructor(source: RecordSource);
...
type commitLocalUpdate = (environment: Environment, updater: StoreUpdater) => void;
...
declare function commitRelayModernMutation(environment: Environment, config: MutationConfig<any>): Disposable;
...
/**
   ...
   * shape.
   */
declare function fetchRelayModernQuery(
