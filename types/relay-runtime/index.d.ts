...
declare namespace __Relay.Common {
    ...
    */
    ...
    export interface RecordProxy {
      ...
      getLinkedRecords(name: string, args?: Variables | void): (RecordProxy | void)[] | void,
    ...
    export interface RecordSourceProxy {
      create(dataID: DataID, typeName: string): RecordProxy,
      delete(dataID: DataID): void,
      get(dataID: DataID): (RecordProxy | void)[] | void,
      getRoot(): RecordProxy,
    }
     ...
     */
    export type RecordMap = {[dataID: string]: Record | void};
     ...
     * `Props`.
     */
    export type FragmentSpecResults = {[key: string]: any};
    ...
    > {
      ...
      getDataIDsFromObject: (
        fragments: CFragmentMap<TFragment>,
        props: Props,
      ) => {[key: string]: Maybe<(DataID | Array<DataID>)>},
    ...
    */
    ...
    export type NetworkLayer = {
      ...
      sendQueries(requests: Array<RelayQueryRequest>): Promise<any> | void,
    ...
    */
    ...
    export type RelayQuerySet = {[queryName: string]: any};
...
declare namespace __Relay.Runtime {
    // ~~~~~~~~~~~~~~~~~~~~~
    // Maybe Fix
    // ~~~~~~~~~~~~~~~~~~~~~
    ...
    class Environment {
      ...
      applyUpdate(optimisticUpdate: OptimisticUpdate): Common.Disposable;
      ...
      commitUpdate(updater: Common.StoreUpdater): void;
    ...
    class RecordSource {
      ...
      clear(): void;
      delete(dataID: Common.DataID): void;
      get(dataID: Common.DataID): Record | void;
      getRecordIDs(): Common.DataID[];
      getStatus(dataID: Common.DataID): 'EXISTENT' | 'NONEXISTENT' | 'UNKNOWN';
    ...
    */
    ...
    class RelayRecordSourceInspector {
       ...
       */
      get(dataID: Common.DataID): RecordInspector | void;
      /**
    ...
    class RelayObservable<T> implements Subscribable<T> {
       ...
       */
      static fromLegacy<V>(
        callback: (legacyObserver: Common.LegacyObserver<V>) => Common.Disposable | RelayObservable<V>,
      ): RelayObservable<V>;
       ...
       */
      subscribeLegacy(legacyObserver: Common.LegacyObserver<T>): Common.Disposable;
    ...
    type MutationConfig<T> = {
      configs?: Array<Common.RelayMutationConfig>,
