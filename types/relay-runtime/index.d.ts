...
export {
  ConnectionMetadata,
} from './lib/handlers/connection/RelayConnectionHandler';

import RelayConcreteNode from './lib/util/RelayConcreteNode';
import * as ConnectionHandler from './lib/handlers/connection/RelayConnectionHandler';

export { ConnectionHandler, RelayConcreteNode };
...
interface Environment
  ...
  ): CSnapshot<ReaderSelectableNode, OperationDescriptor>;
...
export const RelayDefaultMissingFieldHandlers: ReadonlyArray<
  MissingFieldHandler
>;
...
export type NormalizationSelector = CNormalizationSelector<
  NormalizationSelectableNode
>;

export type SelectorStoreUpdater<TData = unknown> = (
...
export interface COperationDescriptor<
  TReaderNode,
  TNormalizationNode,
  TRequest
> {
...
export interface CSnapshot<TReaderNode, TOwner>
  extends CReaderSelector<TReaderNode> {
...
export function getSelectorsFromObject(
  ...
  [key: string]:
    | OwnedReaderSelector
    | ReadonlyArray<OwnedReaderSelector>
    | null
    | undefined;
};
...
export function getFragmentOwner(
  ...
  fragmentRef:
    | FragmentPointer
    | ReadonlyArray<FragmentPointer | null | undefined>
    | null
    | undefined,
...
export function isRelayModernEnvironment(
  environment: any,
): environment is RelayModernEnvironment;
