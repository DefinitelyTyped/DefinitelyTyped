...
export function CalendarContainer(props: { className?: string, children?: React.ReactNode, showPopperArrow?: boolean, arrowProps?: { [propName: string]: any } }): React.ReactElement;
