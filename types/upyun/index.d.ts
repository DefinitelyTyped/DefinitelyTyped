...
declare class Client {
     ...
     */
    putFile(remotePath: string, localFile: string | Stream | Buffer | File, options?: putFileOptions): Promise<putFilePictureResponse | boolean>
     ...
     */
    multipartUpload(remotePath: string, fileOrPath: string | Buffer | File, multiUuid: string, partId: number): Promise<boolean>
