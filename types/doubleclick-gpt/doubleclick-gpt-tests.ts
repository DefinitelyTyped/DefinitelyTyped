...
let slot1 = googletag.pubads().display('/1234567/sports', [728, 90], 'div-1');
...
let slot = googletag.defineSlot('/1234567/sports', [728, 90], 'div-1').addService(googletag.content());
...
googletag.pubads().definePassback('/1234567/sports', [468, 60]).setTagForUnderAgeOfConsent(1).display();
...
googletag
    .pubads()
    .definePassback('/1234567/sports', [160, 600])
    .updateTargetingFromMap({ color: 'red', interests: ['sports', 'music', 'movies'] })
    .display();
