...
declare namespace H {
    ...
    namespace datalens {
        ...
        class Service implements service.IConfigurable {
             ...
             */
            constructor(options?: datalens.Service.Options);
             ...
             * @param x {datalens.QueryTileProvider.X} - Tile columns
             * @param y {datalens.QueryTileProvider.Y} - Tile row
             * @param z {datalens.QueryTileProvider.Zoom} - zoom level
             * @param params {any=} - URL parameters (eg bounding box)
             * @param onResult {function(any)=} - Callback called on a successful request with response data
             * @param onError {function(Error)=} - Callback called on an unsuccessful request with the Error object
             * @returns {Promise<Uint8Array>} - Typed array with tile data
             */
            fetchLayerTile(layerName: string, x: datalens.QueryTileProvider.X, y: datalens.QueryTileProvider.Y, z: datalens.QueryTileProvider.Zoom,
             ...
             * @returns {datalens.Service}
             */
            configure(appId: string, appCode: string, useHTTPS: boolean, useCIT: boolean, baseUrl?: service.Url): datalens.Service;
        }

        namespace Service {
            /**
             * Overrides the datalens.Service configuration
             * Normally the datalens.Service instance is configured with the service.Platform instance.
         ...
         */
        class QueryProvider extends datalens.Provider {
            /**
             * Constructor
             * @param service {datalens.Service} - Data Lens REST API service
             * @param options {datalens.QueryProvider.Options=} - Configures source query and data accessibility parameters
             */
            constructor(data: datalens.Service.Data, options?: datalens.QueryProvider.Options);
        ...
        namespace QueryProvider {
            /**
             * Configures source query and data accessibility parameters for datalens.QueryProvider
             * Specifies the query credentials and dynamic parameters required for fetching query data with the Data Lens REST API. Other options from datalens.Provider.Options are available.
        ...
        class QueryTileProvider extends map.provider.RemoteTileProvider {
             ...
             * Constructor
             * @param service {datalens.Service} - Data Lens REST API service
             * @param options {datalens.QueryTileProvider.Options} - Configures source query and data accessibility parameters
             */
             ...
             * Note that new data will be fetched only after the reload method is called.
             * @param tileParamNames {datalens.QueryTileProvider.TileParamNames} - Names of the URI parameters that control the x/y/z of a tiled query
             */
            setTileParamNames(tileParamNames: datalens.QueryTileProvider.TileParamNames): void;
        }
        ...
        namespace QueryTileProvider {
            ...
            /**
             * Configures source query and data accessibility parameters for datalens.QueryTileProvider
             ...
             * Other options from datalens.Provider.Options are available.
             * @property tileParamNames {datalens.QueryTileProvider.TileParamNames=} - Names of the URI parameters that control the x/y/z of a tiled query
             * @property queryId {string} - The ID for the Data Lens REST API query
             * @property queryParams {any=} - The query's dynamic parameters. The dynamic parameters can be used to filter data provided by the query.
             */
            interface Options {
                tileParamNames: datalens.QueryTileProvider.TileParamNames;
                queryId: string;
                queryParams?: string;
            }
        ...
        class RasterLayer extends map.layer.TileLayer {
             ...
             * @param points {Array<datalens.RasterLayer.TilePoint>} - Input data points within a tile
             * @param canvas {HTMLCanvasElement} - The target canvas
             */
            static defaultRenderTile(points: datalens.RasterLayer.TilePoint[], canvas: HTMLCanvasElement): void;
        }
        ...
        namespace RasterLayer {
             ...
             * By default this step is processed with datalens.RasterLayer.defaultDataToRows.
             * This behavior can be changed by defining the dataToRows callback.
             * To collect the rows for a tile including buffer, the rows must be translated to datalens.RasterLayer.TilePoint.
             ...
             * @property dataToRows {function(datalens.Service.Data, datalens.QueryTileProvider.X, datalens.QueryTileProvider.Y, datalens.QueryTileProvider.Zoom)=} -
             ...
             * @property rowToTilePoint {function(datalens.RasterLayer.Row, datalens.RasterLayer.X, datalens.RasterLayer.Y)=} -
             * Defines how the row is translated to the datalens.RasterLayer.TilePoint. This callback is called for each row that is returned from dataToRows.
             * @property buffer {function(datalens.QueryTileProvider.Zoom)=} - Defines the buffer as a function of the zoom level.
             ...
             * @property renderTile {function(Array<datalens.RasterLayer.TilePoint>, HTMLCanvasElement, datalens.QueryTileProvider.Zoom)=} -
             ...
             */
            interface Options {
                dataToRows?(data: datalens.Service.Data, x: datalens.QueryTileProvider.X, y: datalens.QueryTileProvider.Y, zoom: datalens.QueryTileProvider.Zoom):
                    datalens.RasterLayer.Row[];
                rowToTilePoint?(row: datalens.RasterLayer.Row, x: datalens.RasterLayer.X, y: datalens.RasterLayer.Y): datalens.RasterLayer.TilePoint;
                buffer?(zoom: datalens.QueryTileProvider.Zoom): number;
                renderTile?(points: datalens.RasterLayer.TilePoint[], canvas: HTMLCanvasElement, zoom: datalens.QueryTileProvider.Zoom): void;
            }
             ...
             * @property data {datalens.RasterLayer.Row=} - Reference to source data row
             */
            interface TilePoint {
                x: number;
                y: number;
                data?: datalens.RasterLayer.Row;
            }
         ...
         */
        class HeatmapLayer extends datalens.RasterLayer {
            /**
             * Constructor
             * @param provider {datalens.QueryTileProvider} - Source of tiled data
             * @param options {datalens.HeatmapLayer.Options} - Configuration for data processing and rendering
             */
            constructor(provider: datalens.QueryTileProvider, options: datalens.HeatmapLayer.Options);
             ...
             * @param data {datalens.Service.Data}
             * @param x {datalens.QueryTileProvider.X}
             * @param y {datalens.QueryTileProvider.Y}
             * @param zoom {datalens.QueryTileProvider.Zoom}
             * @returns {Array<datalens.HeatmapLayer.Row>}
             */
            static defaultDataToRows: (data: datalens.Service.Data, x: datalens.QueryTileProvider.X, y: datalens.QueryTileProvider.Y, zoom: datalens.QueryTileProvider.Zoom) =>
                datalens.HeatmapLayer.Row[];

            /**
             * Set of possible values for the inputScale option
             * @type {datalens.HeatmapLayer.InputScale}
             */
            static inputScale: datalens.HeatmapLayer.InputScale;

            /**
             * Set of possible values for the aggregation option
             * @type {datalens.HeatmapLayer.Aggregation}
             */
            static aggregation: datalens.HeatmapLayer.Aggregation;

            /**
             * @param zoom {number} - zoom level
             * @return {datalens.HeatmapLayer.Options}
             */
            getOptionsPerZoom(zoom: number): datalens.HeatmapLayer.Options;
        ...
        namespace HeatmapLayer {
             ...
             * By default this step is processed with datalens.HeatmapLayer.defaultDataToRows. This behavior can be changed by defining the dataToRows callback.
             * To collect the rows for a tile including buffer, the rows must be translated to datalens.HeatmapLayer.TilePoint. This translation must be specified with the rowToTilePoint callback.
             * Other options define the blending options for the heat map.
             * @property dataToRows {function(datalens.Service.Data, datalens.QueryTileProvider.X, datalens.QueryTileProvider.Y, datalens.QueryTileProvider.Zoom)=} -
             * Defines how the input tile data is split by rows. You can specify this callback to define client-side aggregation and filtering. This callback is called for each tile.
             * @property rowToTilePoint {function(datalens.HeatmapLayer.Row, datalens.HeatmapLayer.X, datalens.HeatmapLayer.Y)=} -
             * Defines how the row is translated to the datalens.HeatmapLayer.TilePoint. This callback is called for each row that is returned from dataToRows.
             * @property bandwidth {datalens.HeatmapLayer~Bandwidth | datalens.HeatmapLayer~BandwidthStop | Array.<datalens.HeatmapLayer~BandwidthStop> |
             * datalens.HeatmapLayer~BandwidthCallback=} - Describes the bandwidth behavior in relation to current zoom level A numeric value sets it static across all levels
             ...
             * @property valueRange {function(datalens.QueryTileProvider.Zoom)} - Defines the range for the color scale as a function of the zoom level.
             * The returned value must be an array of 2 numbers.
             * @property countRange {function(datalens.QueryTileProvider.Zoom)} - Defines the range for the density alpha mask as a function of the zoom level.
             ...
             * @property aggregation {datalens.HeatmapLayer.Aggregation} - Specifies which type of aggregation was applied (eg. type of aggregation function for bucket in the Data Lens query).
             * Possible values are SUM or AVERAGE. If the aggregation type is AVERAGE , then an averaged heat map is rendered.
             * @property inputScale {datalens.HeatmapLayer.InputScale} - Defines the scale (eg logarithmic scale) of the TilePoint value.
            ...
            interface Options {
                dataToRows?(data: datalens.Service.Data, x: datalens.QueryTileProvider.X, y: datalens.QueryTileProvider.Y, zoom: datalens.QueryTileProvider.Zoom):
                    datalens.HeatmapLayer.Row[];
                rowToTilePoint(row: datalens.HeatmapLayer.Row, x: datalens.HeatmapLayer.X, y: datalens.HeatmapLayer.Y): datalens.HeatmapLayer.TilePoint;
                bandwidth?: datalens.HeatmapLayer.Bandwidth | datalens.HeatmapLayer.BandwidthStop | datalens.HeatmapLayer.BandwidthStop[] | datalens.HeatmapLayer.BandwidthCallback;
                valueRange?(zoom: datalens.QueryTileProvider.Zoom): number[];
                countRange?(zoom: datalens.QueryTileProvider.Zoom): number[];
                colorScale?(scale: number): string;
                alphaScale?(scale: number): number;
                aggregation?: datalens.HeatmapLayer.Aggregation;
                inputScale?: datalens.HeatmapLayer.InputScale;
            }
             ...
             * @property data {datalens.HeatmapLayer.Row} - Reference to source data row
             */
            interface TilePoint {
                x: number;
                y: number;
                value: number;
                count: number;
                data?: datalens.HeatmapLayer.Row;
            }
        ...
        class ObjectLayer extends map.layer.ObjectLayer {
            /**
             * Constructor
             * @param provider {map.provider.RemoteTileProvider | datalens.Provider | datalens.QueryProvider | datalens.QueryTileProvider} - Data source (tiled or not)
             * @param options {datalens.ObjectLayer.Options} - Defines data processing, clustering and data-driven styling
             */
            constructor(provider: map.provider.RemoteTileProvider | datalens.Provider | datalens.QueryProvider | datalens.QueryTileProvider, options: datalens.ObjectLayer.Options);

            /**
             * Default value for dataToRows callback option. It represents each row as an object where property names correspond to data column names.
             * @property data {datalens.Service.Data}
             * @returns {Array<datalens.ObjectLayer.Row>}
             */
            static defaultDataToRows(data: datalens.Service.Data): datalens.ObjectLayer.Row[];
             ...
             * @param state {datalens.ObjectLayer.StyleState} - New state
             */
            updateObjectStyle(any: map.Object, state: datalens.ObjectLayer.StyleState): void;
        }
        ...
        namespace ObjectLayer {
             ...
             * The initial step of rendering is to split the tile data by rows, where each row represents a bucket.
             * By default this step is processed with datalens.ObjectLayer.defaultDataToRows. This behavior can be changed by defining the dataToRows callback.
             ...
             * @property dataToRows {function(datalens.Service.Data)=} - Defines how the input data is split by rows. You can specify this callback to define client-side aggregation and filtering.
             * @property rowToMapObject {function(datalens.ObjectLayer.Row, datalens.QueryTileProvider.Zoom)} - Defines how each row is presented on the map (eg marker, polygon)
             * @property rowToStyle {function(datalens.ObjectLayer.Row, datalens.QueryTileProvider.Zoom, datalens.ObjectLayer.StyleState)=} -
             ...
             * @property dataDomains {datalens.ObjectLayer.DataDomains=} - Defines quantization of data for improving data-driven styling performance
             * @property clustering {datalens.ObjectLayer.Clustering=} - When present, client-side clustering is applied
             */
            interface Options {
                dataToRows?(data: datalens.Service.Data): datalens.ObjectLayer.Row[];
                rowToMapObject(row: datalens.ObjectLayer.Row, z: datalens.QueryTileProvider.Zoom): map.Object;
                rowToStyle?(row: datalens.ObjectLayer.Row, z: datalens.QueryTileProvider.Zoom, styleState: datalens.ObjectLayer.StyleState): datalens.ObjectLayer.ObjectStyleOptions;
                dataDomains?: datalens.ObjectLayer.DataDomains;
                clustering?: datalens.ObjectLayer.Clustering;
            }
             ...
             * @property rowToDataPoint {datalens.ObjectLayer.Row} - Defines data points from rows
             * @property options {function(datalens.QueryTileProvider.Zoom)} - Defines clustering options as a function of the zoom level
             */
            interface Clustering {
                rowToDataPoint(row: datalens.ObjectLayer.Row): clustering.DataPoint;
                options(zoom: datalens.QueryTileProvider.Zoom): clustering.Provider.ClusteringOptions;
            }
             ...
             * The option must have properties corresponding to the properties of datalens.ObjectLayer.Row. Values must be represented as an Array of Numbers that defines the quantization domain.
        ...
        class RawDataProvider extends map.provider.RemoteTileProvider {
            /**
             * Constructor
             * @param options {datalens.RawDataProvider.Options} - Configures options
             */
            constructor(options: datalens.RawDataProvider.Options);
        ...
        namespace RawDataProvider {
             ...
             * @property featuresToRows {function(Array<datalens.RawDataProvider.Feature>, datalens.QueryTileProvider.X, datalens.QueryTileProvider.Y, datalens.QueryTileProvider.Zoom,
             * datalens.RawDataProvider.TileSize, datalens.RawDataProvider.Helpers)=} -
            ...
            interface Options {
                dataUrl?: string;
                dataToFeatures?(obj: any): datalens.RawDataProvider.Feature[];
                featuresToRows?(features: datalens.RawDataProvider.Feature[], x: datalens.QueryTileProvider.X, y: datalens.QueryTileProvider.Y, z: datalens.QueryTileProvider.Zoom,
                                tileSize: datalens.RawDataProvider.TileSize, helpers: datalens.RawDataProvider.Helpers): datalens.ObjectLayer.Row[];
            }
             ...
             * @property latLngToPixel {function(datalens.RawDataProvider.Latitude, datalens.RawDataProvider.Longitude, datalens.QueryTileProvider.Zoom, datalens.RawDataProvider.TileSize)=} -
             * Translates geographical coordinates (latitude, longitude) to world pixel coordinates.
             * @property pixelToLatLng {function(datalens.RawDataProvider.PX, datalens.RawDataProvider.PY, datalens.QueryTileProvider.Zoom, datalens.RawDataProvider.TileSize)=} -
             ...
             */
            interface Helpers {
                latLngToPixel?(latitude: datalens.RawDataProvider.Latitude, longitude: datalens.RawDataProvider.Longitude, z: datalens.QueryTileProvider.Zoom,
                               tileSize: datalens.RawDataProvider.TileSize): datalens.RawDataProvider.PixelCoordinates;
                pixelToLatLng?(x: datalens.RawDataProvider.PX, y: datalens.RawDataProvider.PY, z: datalens.QueryTileProvider.Zoom, tileSize: datalens.RawDataProvider.TileSize):
                    datalens.RawDataProvider.GeoCoordinates;
        ...
        class SpatialLayer extends map.layer.TileLayer {
            /**
             * Constructor
             * @param dataProvider {datalens.Provider} - Source of tiled data (pass in null if data come from feature properties)
             * @param spatialProvider {datalens.SpatialTileProvider} - Source of geometry data
             * @param options {datalens.SpatialLayer.Options} - Configuration for data processing and rendering
             */
            constructor(dataProvider: datalens.Provider, spatialProvider: datalens.SpatialTileProvider, options: datalens.SpatialLayer.Options);
             ...
             * @param {datalens.SpatialLayer.StyleState} state
             */
            updateSpatialStyle(spatial: map.Object, state: datalens.SpatialLayer.StyleState): void;
        }
        ...
        namespace SpatialLayer {
             ...
             * The initial step of rendering is to split the tile data by rows, where each row represents a bucket.
             * By default this step is processed with datalens.SpatialLayer.defaultDataToRows. This behavior can be changed by defining the dataToRows callback.
             * @property dataToRows {function(datalens.Service.Data, datalens.QueryTileProvider.X, datalens.QueryTileProvider.Y, datalens.QueryTileProvider.Zoom)=} -
             * Defines how the input tile data is split by rows. You can specify this callback to define client-side aggregation and filtering. This callback is called for each tile.
             * @property rowToSpatialId {function(datalens.SpatialLayer.Row)} -
             * Defines how to get the spatial ID from a data row. This callback is called for each row that is returned from dataToRows.
             * @property featureToSpatialId {function(datalens.SpatialLayer.Feature)} -
             ...
             * @property defaultStyle {function(datalens.QueryTileProvider.Zoom, datalens.SpatialLayer.StyleState)} - Defines the default map object style.
             * @property transformFeature {datalens.SpatialLayer.transformFeature} - Defines how to transform the features.
             */
            interface Options {
                dataToRows?(data: datalens.Service.Data, x: datalens.QueryTileProvider.X, y: datalens.QueryTileProvider.Y, z: datalens.QueryTileProvider.Zoom):
                    datalens.SpatialLayer.Row[];
                rowToSpatialId(row: datalens.SpatialLayer.Row): string;
                featureToSpatialId(feature: datalens.SpatialLayer.Feature): string;
                rowToStyle(row: datalens.SpatialLayer.Row, z: datalens.QueryTileProvider.Zoom, styleState: datalens.SpatialLayer.StyleState): any;
                defaultStyle(z: datalens.QueryTileProvider.Zoom, styleState: datalens.SpatialLayer.StyleState): any;
                transformFeature: datalens.SpatialLayer.transformFeature;
            }
        ...
        class SpatialTileProvider extends map.provider.RemoteTileProvider {
             ...
             * Constructor
             * @param service {datalens.Service} - Data Lens REST API service
             * @param options {datalens.SpatialTileProvider.Options} - Configures layer name
             */
            constructor(service: datalens.Service, options: datalens.SpatialTileProvider.Options);
        ...
        namespace SpatialTileProvider {
            /**
             * Defines layer name and data accessibility parameters for datalens.SpatialTileProvider
             * This defines the layer name and dynamic parameters required for fetching tiled geometry data with the Data Lens REST API. Other options from datalens.Provider.Options are available.
