...
declare global {
	...
	namespace FirstMate {
		...
		namespace Statics {
			...
			interface Grammar {
				new (registry: FirstMate.GrammarRegistry, options?: FirstMate.Options.Grammar):
					FirstMate.Grammar;
			}
			...
			interface ScopeSelector {
				 ...
				 */
				new (source: string): FirstMate.ScopeSelector;
			}
...
export const GrammarRegistry: FirstMate.Statics.GrammarRegistry;

export const ScopeSelector: FirstMate.Statics.ScopeSelector;

/** Grammar that tokenizes lines of text. */
export const Grammar: FirstMate.Statics.Grammar;
