...
declare module bootbot {
    ...
    type Event = 'message' | 'quick_reply' | 'attachment' | 'postback' | 'delivery' | 'read' | 'authentication' | 'refferal'
    ...
    interface AirlineUpdateTemplate {
    ...
    type Template = ButtonTemplate | GenericTemplate | ListTemplate | MediaTemplate | OpenGraphTemplate | ReceiptTemplate | AirlineBoardingPassTemplate | AirlineCheckInTemplate | AirlineItineraryTemplate | AirlineUpdateTemplate
    
}

export = bootbot.BootBot
