...
declare module 'leaflet' {
    ...
    namespace Draw {
        ...
        class Marker extends Feature {
            constructor(map: Map, options?: DrawOptions.MarkerOptions);
        }
        ...
        class Circle extends SimpleShape {
            constructor(map: Map, options?: DrawOptions.CircleOptions);
        }

        class Polyline extends Feature {
            constructor(map: Map, options?: DrawOptions.PolylineOptions);
        ...
        class Rectangle extends SimpleShape {
            constructor(map: Map, options?: DrawOptions.RectangleOptions);
        }
