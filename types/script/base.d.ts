...
declare var Browser: Script.Base.Browser;
declare var Logger: Script.Base.Logger;
// conflicts with MimeType in lib.d.ts
// declare var MimeType: Script.Base.MimeType;
declare var Session: Script.Base.Session;
