// Type definitions for @createjs/easeljs 2.0.0-beta3
// Project: https://github.com/CreateJS/EaselJS (Does not have to be to GitHub, but prefer linking to a source code repository rather than to a project website.)
...
export class Graphics {
    ...
    static LineTo: LineTo;
    static MoveTo: MoveTo;
    static ArcTo: ArcTo;
    static Arc: Arc;
    static QuadraticCurveTo: QuadraticCurveTo;
    static BezierCurveTo: BezierCurveTo;
    static Rect: Rect;
    static ClosePath: ClosePath;
    static BeginPath: BeginPath;
    static Fill: Fill;
    static Stroke: Stroke;
    static StrokeStyle: StrokeStyle;
    static StrokeDash: Stroke;
    static RoundRect: RoundRect;
    static Circle: Circle;
    static Ellipse: Arc;
    static PolyStar: PolyStar
