// Type definitions for Google Ad Exchange Seller API v1.1 1.1
...
// Generated from: https://www.googleapis.com/discovery/v1/apis/adexchangeseller/v1.1/rest
...
declare namespace gapi.client {
    // Load Ad Exchange Seller API v1.1
    function load(name: "adexchangeseller", version: "v1.1"): PromiseLike<void>;    
    function load(name: "adexchangeseller", version: "v1.1", callback: () => any): void;    
    ...
    const alerts: gapi.client.adexchangeseller.AlertsResource; 
    
    const customchannels: gapi.client.adexchangeseller.CustomchannelsResource; 
    
    const metadata: gapi.client.adexchangeseller.MetadataResource; 
    
    const preferreddeals: gapi.client.adexchangeseller.PreferreddealsResource; 
