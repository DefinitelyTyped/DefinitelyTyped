...
declare namespace GoogleAppsScript {
  export module Spreadsheet {
     ...
     */
    export enum DataExecutionErrorCode { DATA_EXECUTION_ERROR_CODE_UNSUPPORTED, NONE, TIME_OUT, TOO_MANY_ROWS, TOO_MANY_CELLS, ENGINE, PARAMETER_INVALID, UNSUPPORTED_DATA_TYPE, DUPLICATE_COLUMN_NAMES, INTERRUPTED, OTHER, TOO_MANY_CHARS_PER_CELL, DATA_NOT_FOUND, PERMISSION_DENIED }
     ...
     */
    export interface DataSourceChart {
     ...
     */
    export interface DataSourcePivotTable {
     ...
     */
    export interface DataSourceRefreshScheduleFrequency {
     ...
     */
    export enum DataSourceRefreshScope { DATA_SOURCE_REFRESH_SCOPE_UNSUPPORTED, ALL_DATA_SOURCES }
    ...
    export interface DataSourceSheet {
      ...
      getSheetValues(columnName: string): Object[];
      getSheetValues(columnName: string, startRow: Integer, numRows: Integer): Object[];
     ...
     */
    export interface DataSourceSheetFilter {
     ...
     */
    export interface DataSourceTableFilter {
      getDataSourceColumn(): DataSourceColumn;
     ...
     */
    export interface DateTimeGroupingRule {
     ...
     */
    export enum DateTimeGroupingRuleType { UNSUPPORTED, SECOND, MINUTE, HOUR, HOUR_MINUTE, HOUR_MINUTE_AMPM, DAY_OF_WEEK, DAY_OF_YEAR, DAY_OF_MONTH, DAY_MONTH, MONTH, QUARTER, YEAR, YEAR_MONTH, YEAR_QUARTER, YEAR_MONTH_DAY }
     ...
     */
    export enum FrequencyType { FREQUENCY_TYPE_UNSUPPORTED, DAILY, WEEKLY, MONTHLY }
     ...
     */
    export enum SheetType { GRID, OBJECT, DATASOURCE }
     ...
     */
    export enum ThemeColorType { UNSUPPORTED, TEXT, BACKGROUND, ACCENT1, ACCENT2, ACCENT3, ACCENT4, ACCENT5, ACCENT6, HYPERLINK }
