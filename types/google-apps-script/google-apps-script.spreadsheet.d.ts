...
declare namespace GoogleAppsScript {
    export module Spreadsheet {
         ...
         */
        export enum DataSourceParameterType {
         ...
         */
        export enum DeveloperMetadataLocationType {
            SPREADSHEET,
            SHEET,
            ROW,
            COLUMN,
         ...
         */
        export enum GroupControlTogglePosition {
            BEFORE,
            AFTER,
        }
         ...
         */
        export enum PivotTableSummarizeFunction {
            CUSTOM,
            SUM,
            COUNTA,
            COUNT,
         ...
         */
        export enum PivotValueDisplayType {
            DEFAULT,
         ...
         * columns.
         */
        export enum TextToColumnsDelimiter {
            COMMA,
            SEMICOLON,
            PERIOD,
            SPACE,
