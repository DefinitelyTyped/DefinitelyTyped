        ...
        namespace Collection {
            interface AccountsCollection {
                ...
                link(
                    ...
                    merchantId: string,
                    accountId: string,
                ): Content.Schema.AccountsLinkResponse;
            ...
            interface InventoryCollection {
                ...
                set(
                    ...
                    storeCode: string,
                    productId: string,
                ): Content.Schema.InventorySetResponse;
                // Updates price and availability of a product in your Merchant Center account.
                set(
                    resource: Schema.InventorySetRequest,
                    merchantId: string,
            ...
            interface LiasettingsCollection {
                ...
                requestgmbaccess(
                    ...
                    accountId: string,
                    gmbEmail: string,
                ): Content.Schema.LiasettingsRequestGmbAccessResponse;
                // Requests inventory validation for the specified country.
                requestinventoryverification(
                    merchantId: string,
                    accountId: string,
                    country: string,
                ): Content.Schema.LiasettingsRequestInventoryVerificationResponse;
                ...
                setinventoryverificationcontact(
                    ...
                    country: string,
                    language: string,
                ): Content.Schema.LiasettingsSetInventoryVerificationContactResponse;
            ...
            interface OrderinvoicesCollection {
                ...
                createchargeinvoice(
                    resource: Schema.OrderinvoicesCreateChargeInvoiceRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrderinvoicesCreateChargeInvoiceResponse;
                ...
                createrefundinvoice(
                    resource: Schema.OrderinvoicesCreateRefundInvoiceRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrderinvoicesCreateRefundInvoiceResponse;
            }
            interface OrderpaymentsCollection {
                // Notify about successfully authorizing user's payment method for a given amount.
                notifyauthapproved(
                    resource: Schema.OrderpaymentsNotifyAuthApprovedRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrderpaymentsNotifyAuthApprovedResponse;
                // Notify about failure to authorize user's payment method.
                notifyauthdeclined(
                    resource: Schema.OrderpaymentsNotifyAuthDeclinedRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrderpaymentsNotifyAuthDeclinedResponse;
                // Notify about charge on user's selected payments method.
                notifycharge(
                    resource: Schema.OrderpaymentsNotifyChargeRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrderpaymentsNotifyChargeResponse;
                // Notify about refund on user's selected payments method.
                notifyrefund(
                    resource: Schema.OrderpaymentsNotifyRefundRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrderpaymentsNotifyRefundResponse;
            }
            interface OrderreportsCollection {
                ...
                ): Content.Schema.OrderreportsListDisbursementsResponse;
                // Retrieves a report for disbursements from your Merchant Center account.
                listdisbursements(
                    merchantId: string,
                    disbursementStartDate: string,
            ...
            interface OrdersCollection {
                ...
                cancel(
                    ...
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrdersCancelResponse;
                // Cancels a line item, making a full refund.
                cancellineitem(
                    resource: Schema.OrdersCancelLineItemRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrdersCancelLineItemResponse;
                // Sandbox only. Cancels a test order for customer-initiated cancellation.
                canceltestorderbycustomer(
                    resource: Schema.OrdersCancelTestOrderByCustomerRequest,
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrdersCancelTestOrderByCustomerResponse;
                // Sandbox only. Creates a test order.
                createtestorder(
                    resource: Schema.OrdersCreateTestOrderRequest,
                    merchantId: string,
                ): Content.Schema.OrdersCreateTestOrderResponse;
                // Sandbox only. Creates a test return.
                createtestreturn(
                    resource: Schema.OrdersCreateTestReturnRequest,
                    merchantId: string,
                    orderId: string,
                ...
                ): Content.Schema.OrdersGetByMerchantOrderIdResponse;
                // Sandbox only. Retrieves an order template that can be used to quickly create a new order in sandbox.
                gettestordertemplate(
                    merchantId: string,
                    templateName: string,
                ): Content.Schema.OrdersGetTestOrderTemplateResponse;
                // Sandbox only. Retrieves an order template that can be used to quickly create a new order in sandbox.
                gettestordertemplate(
                    merchantId: string,
                    templateName: string,
                ...
                instorerefundlineitem(
                    ...
                    merchantId: string,
                    orderId: string,
                ): Content.Schema.OrdersInStoreRefundLineItemResponse;
            ...
            interface PosCollection {
                ...
                sale(
                    ...
                    merchantId: string,
                    targetMerchantId: string,
                ): Content.Schema.PosSaleResponse;
                // Submit a sale event for the given merchant.
                sale(
                    resource: Schema.PosSaleRequest,
                    merchantId: string,
        ...
        namespace Schema {
            ...
            interface OrderinvoicesCreateRefundInvoiceRequest {
                ...
                refundOnlyOption?:
                    ...
                    | undefined;
                returnOption?:
                    | Content.Schema.OrderinvoicesCustomBatchRequestEntryCreateRefundInvoiceReturnOption
                    | undefined;
