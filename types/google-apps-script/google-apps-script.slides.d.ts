...
declare namespace GoogleAppsScript {
    export module Slides {
         ...
         */
        export enum SheetsChartEmbedType {
            UNSUPPORTED,
            IMAGE,
        }
         ...
         */
        export enum TextBaselineOffset {
            UNSUPPORTED,
            NONE,
            SUPERSCRIPT,
            SUBSCRIPT,
