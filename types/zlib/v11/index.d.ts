...
export interface ZlibOptions {
    ...
    dictionary?: Buffer | ArrayBufferView | ArrayBuffer; // deflate/inflate only, empty dictionary by default
    info?: boolean;
}
...
export type InputType = string | Buffer | ArrayBuffer | ArrayBufferView;
