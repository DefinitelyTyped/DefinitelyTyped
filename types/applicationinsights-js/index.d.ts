...
declare module Microsoft.ApplicationInsights {
    ...
    interface IAppInsights {
         ...
         * but don't want to calculate the duration yourself. This method doesn't send any telemetry. Call [`stopTrackPage`](https://github.com/Microsoft/ApplicationInsights-JS/blob/master/API-reference.md#stoptrackpage) to log the end of the page view
         * and send the event.
         * @param   name  A string that idenfities this item, unique within this HTML document. Defaults to the document title.
         */
        startTrackPage(name?: string): any;
        /**
         * Stops the timer that was started by calling [`startTrackPage`](https://github.com/Microsoft/ApplicationInsights-JS/blob/master/API-reference.md#starttrackpage) and sends the pageview load time telemetry with the specified properties and measurements.
