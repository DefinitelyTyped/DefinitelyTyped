...
declare namespace HashRing {
    ...
    type Servers = string | ReadonlyArray<string> | Record<string, Partial<ServerConfig>>;
}

declare class HashRing {
    constructor(servers: HashRing.Servers, algorithm?: string, options?: Partial<HashRing.HashRingOptions>);
