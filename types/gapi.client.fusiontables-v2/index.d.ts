// Type definitions for Google Fusion Tables API v2
...
declare namespace gapi.client {
    ...
    export function load (name: "fusiontables", version: "v2") : PromiseLike<void>;    
    export function load (name: "fusiontables", version: "v2", callback: () => any) : void;    
