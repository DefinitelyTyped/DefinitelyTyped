...
interface GetRequest
  extends AbstractRequestInterfaceWithData<GetResponseData, DataOfGetRequest> {}
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-empty-interface
interface CreateRequestArgument
  extends AbstractRequestInterfaceWithData<
...
interface UpdateRequest
  extends AbstractRequestInterfaceWithData< OperationResponseJSON,RecordDataItems> {}

// eslint-disable-next-line @typescript-eslint/no-empty-interface
interface DeleteRequestArgument
  extends AbstractRequestInterface<OperationResponseJSON> {}
...
interface UpdateSiteRequest
  extends AbstractRequestInterfaceWithData<OperationResponseJSON,SiteData> {}
...
interface UsersGetRequest
  extends AbstractRequestInterface<GetResponseUserData> {}
...
interface UsersUpdateRequest
  extends AbstractRequestInterfaceWithData<OperationResponseJSON,UserResponseData> {}
...
interface GetGroupsRequest
  extends AbstractRequestInterfaceWithData<GroupsResponse, ViewItems> {}
...
interface UpdateGroupsRequest
  extends AbstractRequestInterfaceWithData<GroupsData> {}

/**
 * @abstract apiGroupsCreate関数で使用する関数引数定義
 */
// eslint-disable-next-line @typescript-eslint/no-empty-interface
interface CreateGroupsArgument
  extends AbstractRequestInterfaceWithData<OperationResponseJSON, GroupsData> {}
