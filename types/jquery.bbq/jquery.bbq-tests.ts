...
$(function () {
    ...
    function run_many_tests(...args: any[]) {
        ...
        function set_result(i, test) {
            result = $.isArray(test) ? func_each.apply(this, test) : $.isFunction(test) ? test(result) : '';
        }
    ...
    QUnit.test('jQuery.param.sorted', function () {
        ...
        $.each(tests, function (i, test: any) {
            ...
            QUnit.assert.equal(
                decodeURIComponent(sorted),
                (old_jquery && test.expected_old) || test.expected,
                'params should be sorted',
            );
            QUnit.assert.deepEqual(
                $.deparam(unsorted, true),
                $.deparam(sorted, true),
                'sorted params should deparam the same as unsorted params',
            );
        });
        ...
        QUnit.assert.equal(
            $.param.fragment('foo#c=3&a=4', '#b=2&a=1', 1),
            'foo#a=4&b=2&c=3',
            'params should be sorted',
        );
        QUnit.assert.equal(
            $.param.fragment('foo#c=3&a=4', '#b=2&a=1', 2),
            'foo#b=2&a=1',
            'params should NOT be sorted',
        );
    });
    ...
    QUnit.test('jQuery.param.querystring', function () {
        ...
        QUnit.assert.equal(
            $.param.querystring('http://example.com/?foo#bar?baz'),
            'foo',
            'properly identifying params',
        );
        ...
        QUnit.assert.equal(
            $.param.querystring('http://a:b@example.com:1234/foo.html?' + params_str),
            params_str,
            'params string from url',
        );
        QUnit.assert.equal(
            $.param.querystring('http://a:b@example.com:1234/foo.html?' + params_str + '#bippity-boppity-boo'),
            params_str,
            'params string from url',
        );
    });
    ...
    QUnit.test('jQuery.param.querystring - build URL', function () {
        ...
        function fake_encode(params_str) {
            return (
                '?' +
                $.map(params_str.split('&'), encodeURIComponent).join('&').replace(/%3D/g, '=').replace(/%2B/g, '+')
            );
        }
        ...
        run_many_tests(
            ...
            function (result) {
                QUnit.assert.equal(
                    current_url,
                    pre + '?a=2&b=2&c=true&d=false&e=undefined&f=' + post,
                    '$.param.querystring( url, Object )',
                );
            },
            ...
            function (result) {
                ...
                QUnit.assert.equal(
                    current_url,
                    pre + fake_encode(params) + post,
                    '$.param.querystring( url, Object, 2 )',
                );
            },
            ...
            function (result) {
                ...
                QUnit.assert.equal(
                    current_url,
                    pre + fake_encode(params) + post,
                    '$.param.querystring( url, Object, 1 )',
                );
            },
            ...
            function (result) {
                ...
                QUnit.assert.equal(
                    current_url,
                    pre + fake_encode(params) + post,
                    '$.param.querystring( url, String, 1 )',
                );
            },
            ...
            function (result) {
                QUnit.assert.equal(
                    current_url,
                    pre + '?/path/to/file.php' + post,
                    '$.param.querystring( url, String, 2 )',
                );
            },
            ...
            function (result) {
                QUnit.assert.equal(
                    current_url,
                    pre + '?i_am_out_of_witty_strings' + post,
                    '$.param.querystring( url, String, 2 )',
                );
            },
        );
    ...
    QUnit.test('jQuery.param.fragment', function () {
        ...
        QUnit.assert.equal(
            $.param.fragment('http://example.com/?foo#bar?baz'),
            'bar?baz',
            'properly identifying params',
        );
        ...
        QUnit.assert.equal(
            $.param.fragment('http://a:b@example.com:1234/foo.html#' + params_str),
            params_str,
            'params string from url',
        );
        QUnit.assert.equal(
            $.param.fragment('http://a:b@example.com:1234/foo.html?bippity-boppity-boo#' + params_str),
            params_str,
            'params string from url',
        );
    ...
    QUnit.test('jQuery.param.fragment - build URL', function () {
        ...
        run_many_tests(
            ...
            function (result) {
                QUnit.assert.equal(
                    current_url,
                    pre + '#a=2&b=2&c=true&d=false&e=undefined&f=',
                    '$.param.fragment( url, Object )',
                );
            },
            ...
            function (result) {
                QUnit.assert.equal(
                    current_url,
                    pre + '#i_am_out_of_witty_strings',
                    '$.param.fragment( url, String, 2 )',
                );
            },
        );
        ...
        QUnit.assert.equal($.param.fragment('foo#', { b: 2, a: 1 }), 'foo#!a=1&b=2', '$.param.fragment( url, Object )');
        QUnit.assert.equal(
            $.param.fragment('foo#!', { b: 2, a: 1 }),
            'foo#!a=1&b=2',
            '$.param.fragment( url, Object )',
        );
        QUnit.assert.equal(
            $.param.fragment('foo#c=3&a=4', { b: 2, a: 1 }),
            'foo#!a=1&b=2&c=3',
            '$.param.fragment( url, Object )',
        );
        QUnit.assert.equal(
    ...
    QUnit.test('jQuery.param.fragment.noEscape', function () {
        ...
        QUnit.assert.equal(
            $.param.fragment('#', { foo: '/a,b@c$d+e&f=g h!' }),
            '#foo=/a,b%40c%24d%2Be%26f%3Dg+h!',
            '/, should be unescaped, everything else but space (+) should be urlencoded',
        );
        ...
        QUnit.assert.equal(
            $.param.fragment('#', { foo: '/a,b@c$d+e&f=g h!' }),
            '#!foo=/a,b%40c%24d%2Be%26f%3Dg+h!',
            '/, should be unescaped, everything else but ! and space (+) should be urlencoded',
        );
    ...
    QUnit.test('jQuery.deparam.querystring', function () {
        ...
        QUnit.assert.deepEqual(
            ...
            params_obj_coerce,
            'params obj from window.location, coerced',
        );
        QUnit.assert.deepEqual($.deparam.querystring(params_str), params_obj, 'params obj from string');
        QUnit.assert.deepEqual(
            $.deparam.querystring(params_str, true),
            params_obj_coerce,
            'params obj from string, coerced',
        );
        QUnit.assert.deepEqual($.deparam.querystring('?' + params_str), params_obj, 'params obj from string');
        QUnit.assert.deepEqual(
            $.deparam.querystring('?' + params_str, true),
        ...
        QUnit.assert.deepEqual(
            $.deparam.querystring('foo.html?' + params_str, true),
            params_obj_coerce,
            'params obj from string, coerced',
        );
        QUnit.assert.deepEqual(
            $.deparam.querystring('http://a:b@example.com:1234/foo.html?' + params_str),
            params_obj,
            'params obj from string',
        );
        QUnit.assert.deepEqual(
            $.deparam.querystring('http://a:b@example.com:1234/foo.html?' + params_str, true),
            params_obj_coerce,
            'params obj from string, coerced',
        );
        QUnit.assert.deepEqual(
            $.deparam.querystring('http://a:b@example.com:1234/foo.html?' + params_str + '#bippity-boppity-boo'),
            params_obj,
            'params obj from string',
        );
        QUnit.assert.deepEqual(
            $.deparam.querystring('http://a:b@example.com:1234/foo.html?' + params_str + '#bippity-boppity-boo', true),
            params_obj_coerce,
            'params obj from string, coerced',
        );
    });
    ...
    QUnit.test('jQuery.deparam.fragment', function () {
        ...
        QUnit.assert.deepEqual(
            $.deparam.fragment('foo.html#' + params_str, true),
            params_obj_coerce,
            'params obj from string, coerced',
        );
        QUnit.assert.deepEqual(
            $.deparam.fragment('http://a:b@example.com:1234/foo.html#' + params_str),
            params_obj,
            'params obj from string',
        );
        QUnit.assert.deepEqual(
            $.deparam.fragment('http://a:b@example.com:1234/foo.html#' + params_str, true),
            params_obj_coerce,
            'params obj from string, coerced',
        );
        QUnit.assert.deepEqual(
            $.deparam.fragment('http://a:b@example.com:1234/foo.html?bippity-boppity-boo#' + params_str),
            params_obj,
            'params obj from string',
        );
        QUnit.assert.deepEqual(
            $.deparam.fragment('http://a:b@example.com:1234/foo.html?bippity-boppity-boo#' + params_str, true),
            params_obj_coerce,
            'params obj from string, coerced',
        );
        ...
        QUnit.assert.deepEqual(
            $.deparam.fragment('#!' + params_str, true),
            params_obj_bang_coerce,
            'params obj from string, coerced',
        );
        QUnit.assert.deepEqual(
            $.deparam.fragment('foo.html#!' + params_str),
            params_obj_bang,
            'params obj from string',
        );
        QUnit.assert.deepEqual(
    ...
    QUnit.test('jQuery.fn.querystring', function () {
        ...
        run_many_tests(
            ...
            function () {
                ...
                QUnit.assert.equal(
                    elems.querystring.apply(elems, ['arbitrary_attr'].concat(aps.call(arguments))),
                    elems,
                    'pass query string',
                );
                ...
                QUnit.assert.equal(
                    elems.querystring.apply(elems, ['href'].concat(aps.call(arguments))),
                    elems,
                    'pass query string',
                );
    ...
    QUnit.test('jQuery.fn.fragment', function () {
        ...
        QUnit.assert.equal(test_fn_fragment('foo#!', { b: 2, a: 1 }), 'foo#!a=1&b=2', '$.fn.fragment( url, Object )');
        QUnit.assert.equal(
            test_fn_fragment('foo#c=3&a=4', { b: 2, a: 1 }),
            'foo#!a=1&b=2&c=3',
            '$.fn.fragment( url, Object )',
        );
        QUnit.assert.equal(
    ...
    QUnit.test(
        'jQuery.bbq.pushState(), jQuery.bbq.getState(), jQuery.bbq.removeState(), window.onhashchange',
        function () {
            QUnit.assert.expect(old_jquery ? 95 : 167);

            var a: { str: string; coerce: boolean },
                b: { str: string; coerce: boolean },
                c,
                d,
                e,
                f,
                ...
                hash,
                hash_actual,
                obj: { str: string; coerce: boolean },
                event: JQueryBbq.EventObject,
                msg = 'Testing window.onhashchange and history';
            ...
            QUnit.assert.deepEqual(
                obj.str,
                { a: '1', b: '1' } as any,
                'hashchange triggered manually: $.bbq.getState()',
            );
            QUnit.assert.deepEqual(
                obj.coerce,
                { a: 1, b: 1 } as any,
                'hashchange triggered manually: $.bbq.getState( true )',
            );
            ...
            if (!old_jquery) {
                QUnit.assert.deepEqual(
                    event.getState(),
                    { a: '1', b: '1' },
                    'hashchange triggered manually: event.getState()',
                );
                QUnit.assert.deepEqual(
                    event.getState('a'),
                    { a: 1, b: 1 },
                    'hashchange triggered manually: event.getState( true )',
                );
                QUnit.assert.equal(event.getState('a'), '1', 'hashchange triggered manually: event.getState( "a" )');
                QUnit.assert.equal(
                    event.getState('a', true),
                    1,
                    'hashchange triggered manually: event.getState( "a", true )',
                );
            }
            ...
            run_many_tests(
                ...
                function (result) {
                    ...
                    QUnit.assert.deepEqual(
                        obj.str,
                        { a: '2', b: '2', c: 'true', d: 'false', e: 'undefined', f: '' } as any,
                        '$.bbq.getState()',
                    );
                    QUnit.assert.deepEqual(
                        obj.coerce,
                ...
                function (result) {
                    ...
                    QUnit.assert.deepEqual(
                        obj.str,
                        { a: '2', b: '2', d: 'false', e: 'undefined', f: '' } as any,
                        '$.bbq.getState()',
                    );
                    QUnit.assert.deepEqual(
                        obj.coerce,
                ...
                function (result) {
                    var b_str = old_jquery
                        ...
                        b_coerce = old_jquery ? '[object Object]' : ({ x: [7], y: 8 } as any); //z:[9,0,true,false,undefined,'']};
                ...
                function (result) {
                    ...
                    QUnit.assert.deepEqual(
                        obj.str,
                        { a: ['4', '5', '6'], b: b_str, c: '2' } as any,
                        '$.bbq.getState()',
                    );
                    QUnit.assert.deepEqual(
                        obj.coerce,
                        { a: [4, 5, 6], b: b_coerce, c: 2 } as any,
                        '$.bbq.getState( true )',
                    );
                    if (!old_jquery) {
                        QUnit.assert.deepEqual(
                ...
                function (result) {
                    if (is_chrome) {
                        ...
                        QUnit.assert.ok(
                            true,
                            'history is sporadically broken in chrome, this is a known bug, so this test is skipped in chrome',
                        );
                    } else {
                        QUnit.assert.deepEqual(
                            x,
                            ['almost_done?not_search', 'omg_ponies', '', '/path/to/file.php'],
                            'back button and window.bbq.go(-1) should work',
                        );
                    }
