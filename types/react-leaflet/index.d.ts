...
export class MapLayer<
    ...
    E extends Leaflet.Layer = Leaflet.Layer
...
export class SVGOverlay<
    P extends SVGOverlayProps = SVGOverlayProps,
    E extends Leaflet.SVGOverlay = Leaflet.SVGOverlay
> extends MapComponent<P, E> {
    createLeafletElement(props: P): E;
    updateLeafletElement(fromProps: P, toProps: P): void;
}
...
export class Popup<P extends PopupProps = PopupProps, E extends Leaflet.Popup = Leaflet.Popup> extends DivOverlay<
    P,
    E
> {
    getOptions(props: P): P;
...
export function withLeaflet<T extends ContextProps>(
