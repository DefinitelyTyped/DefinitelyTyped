...
export type UseSortByOptions<D extends object> = Partial<{
    ...
    orderByFn: (rows: Array<Row<D>>, sortFns: Array<SortByFnPartial<D>>, directions: boolean[]) => Array<Row<D>>;
...
export type SortByFnPartial<D extends object> = (rowA: Row<D>, rowB: Row<D>) => number;
