...
type Driver = import("mg-api-js").Objects.Driver;
async function regularCall() {
    ...
    // @ts-expect-error
    const implicitCast: Driver = await password.call("Add", { entity: {}, typeName: "Driver" });
    // $ExpectType Driver
    const explicitCast = (await password.call("Add", { entity: {}, typeName: "Driver" })) as Driver;
