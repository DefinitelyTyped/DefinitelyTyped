...
declare namespace chrome.i18n {
     ...
     */
    export function getMessage(messageName: string, substitutions?: string | string[] | undefined): string;
    /**
...
declare namespace chrome.pageCapture {
     ...
     */
    export function saveAsMHTML(details: SaveDetails, callback: (mhtmlData?: ArrayBuffer | undefined) => void): void;
}
...
declare namespace chrome.wallpaper {
     ...
     */
    export function setWallpaper(details: WallpaperDetails, callback: (thumbnail?: ArrayBuffer | undefined) => void): void;
}
