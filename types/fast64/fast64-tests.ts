...
fast64.decode("", { uint8Array: true }); // $ExpectType Uint8Array || Uint8Array<ArrayBuffer>
fast64.urlencode(""); // $ExpectType string
fast64.urldecode(""); // $ExpectType string
fast64.urldecode("", { uint8Array: true }); // $ExpectType Uint8Array || Uint8Array<ArrayBuffer>
