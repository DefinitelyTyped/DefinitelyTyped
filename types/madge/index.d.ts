...
export interface MadgeModuleDependencyGraph {
    [id: string]: string[];
}

export interface MadgeWarnings {
    skipped: string[];
}
...
/**
 * Creates a Madge instance for a given path.
 *
 ...
 */
export default function (path: string | string[] | object, config?: Partial<MadgeConfig>): Promise<Madge>;
