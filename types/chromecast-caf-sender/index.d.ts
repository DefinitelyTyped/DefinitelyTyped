...
declare namespace cast.framework {
    ...
    class CastSession {
        ...
        addEventListener(type: SessionEventType.MEDIA_SESSION, handler: (event: MediaSessionEventData) => void): void;
        addEventListener(type: SessionEventType.VOLUME_CHANGED, handler: (event: VolumeEventData) => void): void;
        removeEventListener(
            type: SessionEventType.ACTIVE_INPUT_STATE_CHANGED,
            handler: (event: ActiveInputStateEventData) => void,
        ): void;
        ...
        removeEventListener(type: SessionEventType.VOLUME_CHANGED, handler: (event: VolumeEventData) => void): void;
    }
    ...
    class SessionStateEventData extends EventData {
        constructor(session: CastSession, sessionState: SessionState, opt_errorCode: chrome.cast.ErrorCode);
