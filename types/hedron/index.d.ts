...
export class Provider extends React.Component<ProviderProps & React.HTMLProps<HTMLElement>> {}

export class Bounds extends React.Component<BoundsProps & React.HTMLProps<HTMLElement>> {}
export class Box extends React.Component<BoxProps & React.HTMLProps<HTMLElement>> {}
