...
const MyText: React.SFC<TabProps<MyTextProps>> = (props) => <Text style={props.style}>{props.children}</Text>;
...
const TabView1 = () => (
    <ScrollableTabView style={{ marginTop: 20 }} initialPage={0} renderTabBar={() => <ScrollableTabBar />}>
