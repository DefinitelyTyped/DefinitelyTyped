...
interface WebApp {
    ...
    onEvent(eventType: "writeAccessRequested", eventHandler: (eventData: { status: "allowed" | "cancelled" }) => void): void;
    ...
    offEvent(eventType: "writeAccessRequested", eventHandler: (eventData: { status: "allowed" | "cancelled" }) => void): void;
