...
// do not edit! 2020-05-29T21:50:58.007Z
...
declare namespace GetIntrinsic {
    ...
    interface Intrinsics {
        ...
        '%AsyncGenerator.prototype%': AsyncGenerator<any, any, any>;
        '%AsyncGenerator.prototype.next%': AsyncGenerator<any, any, any>['next'];
        '%AsyncGenerator.prototype.return%': AsyncGenerator<any, any, any>['return'];
        '%AsyncGenerator.prototype.throw%': AsyncGenerator<any, any, any>['throw'];
        '%AsyncGeneratorFunction.prototype%': AsyncGeneratorFunction;
        '%AsyncGeneratorFunction.prototype.prototype%': AsyncGenerator<any, any, any>;
        '%AsyncGeneratorFunction.prototype.prototype.next%': AsyncGenerator<any, any, any>['next'];
        '%AsyncGeneratorFunction.prototype.prototype.return%': AsyncGenerator<any, any, any>['return'];
        '%AsyncGeneratorFunction.prototype.prototype.throw%': AsyncGenerator<any, any, any>['throw'];
        '%AsyncGeneratorPrototype.next%': AsyncGenerator<any, any, any>['next'];
        '%AsyncGeneratorPrototype.return%': AsyncGenerator<any, any, any>['return'];
        '%AsyncGeneratorPrototype.throw%': AsyncGenerator<any, any, any>['throw'];
        ...
        '%Generator.prototype%': Generator<any, any, any>;
        '%Generator.prototype.next%': Generator<any, any, any>['next'];
        '%Generator.prototype.return%': Generator<any, any, any>['return'];
        '%Generator.prototype.throw%': Generator<any, any, any>['throw'];
        '%GeneratorFunction.prototype%': GeneratorFunction;
        '%GeneratorFunction.prototype.prototype%': Generator<any, any, any>;
        '%GeneratorFunction.prototype.prototype.next%': Generator<any, any, any>['next'];
        '%GeneratorFunction.prototype.prototype.return%': Generator<any, any, any>['return'];
        '%GeneratorFunction.prototype.prototype.throw%': Generator<any, any, any>['throw'];
        '%GeneratorPrototype.next%': Generator<any, any, any>['next'];
        '%GeneratorPrototype.return%': Generator<any, any, any>['return'];
        '%GeneratorPrototype.throw%': Generator<any, any, any>['throw'];
