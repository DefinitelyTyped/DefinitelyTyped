...
declare namespace Sinon {
    ...
    interface SinonAssert {
        ...
        calledOn(spy: SinonSpy | SinonSpyCall, obj: any): void;
        alwaysCalledOn(spy: SinonSpy, obj: any): void;
        calledWith(spy: SinonSpy | SinonSpyCall, ...args: any[]): void;
        alwaysCalledWith(spy: SinonSpy, ...args: any[]): void;
        neverCalledWith(spy: SinonSpy, ...args: any[]): void;
        calledWithExactly(spy: SinonSpy | SinonSpyCall, ...args: any[]): void;
        alwaysCalledWithExactly(spy: SinonSpy, ...args: any[]): void;
        calledWithMatch(spy: SinonSpy | SinonSpyCall, ...args: any[]): void;
        alwaysCalledWithMatch(spy: SinonSpy, ...args: any[]): void;
        neverCalledWithMatch(spy: SinonSpy, ...args: any[]): void;
        threw(spy: SinonSpy | SinonSpyCall): void;
        threw(spy: SinonSpy | SinonSpyCall, exception: string): void;
        threw(spy: SinonSpy | SinonSpyCall, exception: any): void;
