// Type definitions for acorn 8.8
...
type LVal = Identifier | MemberExpression | RestElement | AssignmentPattern | ArrayPattern | ObjectPattern;
...
declare namespace acorn {
    ...
    class Parser {
        ...
        finishNodeAt<T extends AcornNodeTypeString>(
            node: Node,
            type: T,
            pos: number,
            loc: Position,
        ...
        static extend(
            this: typeof Parser,
            ...plugins: Array<(BaseParser: typeof Parser) => typeof Parser>
        ): typeof Parser;
    }
