...
function RuleTests() {
    ...
    var test_addRule = ko.observable(stringValue).validate().addRule(dummyRule).end();
    ...
    var test_currencyMajor = ko.observable(numberValue).validate().currencyMajor().end();

    var test_currencyMinor = ko.observable(numberValue).validate().currencyMajorMinor().end();
    ...
    var test_earliest = ko.observable(dateValue).validate().earliest(dateValue).end();

    var test_email = ko.observable(stringValue).validate().email().end();

    var test_entryformat = ko.observable(stringValue).validate().entryFormat(stringValue).end();

    var test_expression = ko.observable(stringValue).validate().expression(regexpValue).expression(stringValue).end();
    ...
    var test_latest = ko.observable(dateValue).validate().latest(dateValue).latest(dateFN).end();
    ...
    var test_matches = ko.observable(stringValue).validate().matches(numberValue).matches(numberFN).end();

    var test_maximum = ko.observable(0).validate().maximum(numberValue).maximum(numberFN).end();
    ...
    var test_minimum = ko.observable(numberValue).validate().minimum(numberValue).minimum(numberFN).end();

    var test_minimumLength = ko.observable('').validate().minimumLength(numberValue).minimumLength(numberFN).end();
    ...
    var test_name = ko.observable(stringValue).validate().name(stringValue).end();

    var test_noneOf = ko.observable<any>(numberValue).validate().noneOf(arrayValue).noneOf(arrayFN).end();

    var test_not = ko.observable(numberValue).validate().not(anyValue).not(anyFN).end();
    ...
    var test_oneOf = ko.observable(numberValue).validate().oneOf(arrayValue).oneOf(arrayFN).end();
    ...
    var test_ruleMessage = ko.observable(anyValue).validate().ruleMessage(stringValue).end();

    var test_string = ko.observable(stringValue).validate().string().end();

    var test_validateChildProperties = ko.observable(anyValue).validate().validateChildProperties().end();

    var test_valueFormat = ko.observable(anyValue).validate().valueFormat(stringValue).end();
