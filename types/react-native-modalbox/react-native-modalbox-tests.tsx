...
import { Text, StyleSheet, ScrollView, View, Dimensions, Button } from 'react-native';
    ...
    render() {
        ...
        return (
            <View style={styles.wrapper}>
                ...
                <Button title="Position centered + backdrop + disable" onPress={() => this.modal3.open()} />
                <Button title="Position bottom + backdrop + slider" onPress={() => this.modal4.open()} />
                <Button title=" Backdrop + backdropContent" onPress={() => this.setState({ isOpen: true })} />
                <Button title=" Position bottom + ScrollView" onPress={() => this.modal6.open()} />
