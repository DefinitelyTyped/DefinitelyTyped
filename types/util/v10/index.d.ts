...
export function callbackify<TResult>(fn: () => Promise<TResult>): (callback: (err: ErrnoException_ | null, result: TResult) => void) => void;
export function callbackify<T1>(fn: (arg1: T1) => Promise<void>): (arg1: T1, callback: (err: ErrnoException_) => void) => void;
export function callbackify<T1, TResult>(fn: (arg1: T1) => Promise<TResult>): (arg1: T1, callback: (err: ErrnoException_ | null, result: TResult) => void) => void;
