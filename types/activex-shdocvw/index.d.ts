...
interface ActiveXObject {
    ...
    on(
        ...
        argNames: ['pDisp', 'URL'],
        handler: (this: SHDocVw.InternetExplorer, parameter: { readonly pDisp: any; readonly URL: any }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorer,
        event: 'FileDownload',
    ...
    on(
        ...
        argNames: ['pDisp'],
        handler: (this: SHDocVw.InternetExplorer, parameter: { readonly pDisp: any }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorer,
    ...
    on(
        ...
        handler: (this: SHDocVw.InternetExplorer, parameter: { readonly PhishingFilterStatus: number }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorer,
    ...
    on(
        ...
        handler: (this: SHDocVw.InternetExplorer, parameter: { readonly URL: any; readonly dwCount: number }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorer,
    ...
    on(
        ...
        event: 'BeforeScriptExecute',
        argNames: ['pDispWindow'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly pDispWindow: any }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'ClientToHostWindow',
    ...
    on(
        ...
        event: 'DocumentComplete' | 'NavigateComplete2',
        argNames: ['pDisp', 'URL'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly pDisp: any; readonly URL: any }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'FileDownload',
    ...
    on(
        ...
        event: 'NewWindow2',
        argNames: ['ppDisp', 'Cancel'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { ppDisp: any; Cancel: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'NewWindow3',
    ...
    on(
        ...
        event: 'OnTheaterMode',
        argNames: ['TheaterMode'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly TheaterMode: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'OnToolBar',
    ...
    on(
        ...
        event: 'PrivacyImpactedStateChange',
        argNames: ['bImpacted'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly bImpacted: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'ProgressChange',
    ...
    on(
        ...
        event: 'SetPhishingFilterStatus',
        argNames: ['PhishingFilterStatus'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly PhishingFilterStatus: number }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'SetSecureLockIcon',
        argNames: ['SecureLockIcon'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly SecureLockIcon: number }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'StatusTextChange' | 'TitleChange',
        argNames: ['Text'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly Text: string }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'ThirdPartyUrlBlocked',
    ...
    on(
        ...
        event: 'WebWorkerFinsihed',
        argNames: ['dwUniqueID'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly dwUniqueID: number }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'WebWorkerStarted',
    ...
    on(
        ...
        event: 'WindowSetResizable',
        argNames: ['Resizable'],
        handler: (this: SHDocVw.InternetExplorerMedium, parameter: { readonly Resizable: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.InternetExplorerMedium,
        event: 'WindowSetTop',
    ...
    on(
        ...
        event: 'DocumentComplete' | 'NavigateComplete2',
        argNames: ['pDisp', 'URL'],
        handler: (this: SHDocVw.ShellBrowserWindow, parameter: { readonly pDisp: any; readonly URL: any }) => void,
    ): void;
    on(
        obj: SHDocVw.ShellBrowserWindow,
        event: 'FileDownload',
    ...
    on(
        ...
        event: 'PrintTemplateInstantiation' | 'PrintTemplateTeardown',
        argNames: ['pDisp'],
        handler: (this: SHDocVw.ShellBrowserWindow, parameter: { readonly pDisp: any }) => void,
    ): void;
    on(
        obj: SHDocVw.ShellBrowserWindow,
        event: 'PrivacyImpactedStateChange',
        argNames: ['bImpacted'],
        handler: (this: SHDocVw.ShellBrowserWindow, parameter: { readonly bImpacted: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.ShellBrowserWindow,
        event: 'ProgressChange',
    ...
    on(
        ...
        event: 'SetPhishingFilterStatus',
        argNames: ['PhishingFilterStatus'],
        handler: (this: SHDocVw.ShellBrowserWindow, parameter: { readonly PhishingFilterStatus: number }) => void,
    ): void;
    on(
        obj: SHDocVw.ShellBrowserWindow,
        event: 'SetSecureLockIcon',
        argNames: ['SecureLockIcon'],
        handler: (this: SHDocVw.ShellBrowserWindow, parameter: { readonly SecureLockIcon: number }) => void,
    ): void;
    on(
        obj: SHDocVw.ShellBrowserWindow,
        event: 'StatusTextChange' | 'TitleChange',
    ...
    on(
        ...
        event: 'ThirdPartyUrlBlocked',
        argNames: ['URL', 'dwCount'],
        handler: (this: SHDocVw.ShellBrowserWindow, parameter: { readonly URL: any; readonly dwCount: number }) => void,
    ): void;
    on(
        obj: SHDocVw.ShellBrowserWindow,
        event: 'UpdatePageStatus',
    ...
    on(
        ...
        event: 'CommandStateChange',
        argNames: ['Command', 'Enable'],
        handler: (this: SHDocVw.WebBrowser, parameter: { readonly Command: number; readonly Enable: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.WebBrowser,
        event: 'DocumentComplete' | 'NavigateComplete2',
        argNames: ['pDisp', 'URL'],
        handler: (this: SHDocVw.WebBrowser, parameter: { readonly pDisp: any; readonly URL: any }) => void,
    ): void;
    on(
        obj: SHDocVw.WebBrowser,
        event: 'FileDownload',
        argNames: ['ActiveDocument', 'Cancel'],
        handler: (this: SHDocVw.WebBrowser, parameter: { readonly ActiveDocument: boolean; Cancel: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.WebBrowser,
        event: 'NavigateError',
    ...
    on(
        ...
        event: 'PrintTemplateInstantiation' | 'PrintTemplateTeardown',
        argNames: ['pDisp'],
        handler: (this: SHDocVw.WebBrowser, parameter: { readonly pDisp: any }) => void,
    ): void;
    on(
        obj: SHDocVw.WebBrowser,
        event: 'PrivacyImpactedStateChange',
    ...
    on(
        ...
        event: 'SetPhishingFilterStatus',
        argNames: ['PhishingFilterStatus'],
        handler: (this: SHDocVw.WebBrowser, parameter: { readonly PhishingFilterStatus: number }) => void,
    ): void;
    on(
        obj: SHDocVw.WebBrowser,
        event: 'SetSecureLockIcon',
    ...
    on(
        ...
        event: 'ThirdPartyUrlBlocked',
        argNames: ['URL', 'dwCount'],
        handler: (this: SHDocVw.WebBrowser, parameter: { readonly URL: any; readonly dwCount: number }) => void,
    ): void;
    on(
        obj: SHDocVw.WebBrowser,
        event: 'UpdatePageStatus',
    ...
    on(
        ...
        event: 'WindowClosing',
        argNames: ['IsChildWindow', 'Cancel'],
        handler: (this: SHDocVw.WebBrowser, parameter: { readonly IsChildWindow: boolean; Cancel: boolean }) => void,
    ): void;
    on(
        obj: SHDocVw.WebBrowser,
        event: 'WindowSetHeight',
