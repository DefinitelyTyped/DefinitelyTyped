...
declare namespace google {
    export function load(moduleName: string, moduleVersion: string, optionalSettings?: any): void;
}
...
declare namespace google.earth {
    ...
    export class GEView {
         ...
         */
        project(lat: number, lng: number, alt: number, altitudeMode: KmlAltitudeModeEnum): KmlVec2;
    ...
    export class KmlLatLonBox extends KmlObject {
         ...
         */
        setBox(north: number, south: number, east: number, west: number, rotation: number): void;
    ...
    export class KmlLod extends KmlObject {
         ...
         */
        set(minLodPixels: number, maxLodPixels: number, minFadeExtent: number, maxFadeExtent: number): void;
