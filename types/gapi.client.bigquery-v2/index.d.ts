...
declare namespace gapi.client.bigquery {
...
declare namespace gapi.client {
    ...
    export function load (name: "bigquery", version: "v2") : PromiseLike<void>;    
    export function load (name: "bigquery", version: "v2", callback: () => any) : void;    
    
    const datasets: gapi.client.bigquery.DatasetsResource; 
    
    const jobs: gapi.client.bigquery.JobsResource; 
    
    const projects: gapi.client.bigquery.ProjectsResource; 
    
    const tabledata: gapi.client.bigquery.TabledataResource; 
    
    const tables: gapi.client.bigquery.TablesResource; 
