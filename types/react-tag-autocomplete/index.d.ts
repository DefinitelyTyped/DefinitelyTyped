...
export default class ReactTags extends Component<IReactTagsProps> {}
...
export interface IReactTagsProps {
    /**
     ...
     */
    tagComponent?: React.SFC<ITagProps>;
    /**
