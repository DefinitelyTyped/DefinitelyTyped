...
export interface PlatformConfig<ProjectParams, DependencyParams, ProjectConfig, DependencyConfig> {
    projectConfig: (projectRoot: string, projectParams: ProjectParams) => ProjectConfig;
    dependencyConfig: (dependency: string, params: DependencyParams) => DependencyConfig;
    linkConfig: () => {
        isInstalled: (projectConfig: ProjectConfig, name: string, dependencyConfig: DependencyConfig) => boolean;
        register: (
            name: string,
...
export function init(projectDir: string, argsOrName: string | string[]): Promise<void>;
