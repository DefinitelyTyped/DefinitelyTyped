// Type definitions for @ckeditor/ckeditor5-language 27.1
...
declare const _default: {
    TextPartLanguage: typeof TextPartLanguage;
    TextPartLanguageEditing: typeof TextPartLanguageEditing;
    TextPartLanguageUI: typeof TextPartLanguageUI;
};
