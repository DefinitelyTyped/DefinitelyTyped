...
export interface SourceValueElement<T extends CellValue> {
    id: T;
    name: CellValue;
}
...
interface MethodsOptions {
    ...
    // tslint:disable-next-line ban-types
    setHeight?: Function;
    /** Merge cells @param string columnName - Column name, such as A1. @param integer colspan - Number of columns @param integer rowspan - Number of rows myTable.setMerge([string], [int], [int]); */
    // tslint:disable-next-line ban-types
    setMerge?: Function;
    ...
    // tslint:disable-next-line ban-types
    undo?: Function;
    /** select cells @param object startCell - cell object @param object endCell - cell object @param boolean ignoreEvents - ignore onselection event	myTable.updateSelection([cell], [cell], true); */
    // tslint:disable-next-line ban-types
 ...
 */
export type Options = MethodsOptions & EventsOptions & InitializationOptions & TranslationsOptions & UnDocumentOptions;
...
export interface JExcelElement {
    ads: HTMLDivElement;
