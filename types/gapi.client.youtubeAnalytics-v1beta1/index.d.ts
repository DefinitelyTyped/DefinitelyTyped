...
declare namespace gapi.client {
    ...
    export function load (name: "youtubeAnalytics", version: "v1beta1") : PromiseLike<void>;    
    export function load (name: "youtubeAnalytics", version: "v1beta1", callback: () => any) : void;    
