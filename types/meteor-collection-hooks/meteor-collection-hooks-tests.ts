...
Collection.before.find((userId: string, selector: Mongo.Selector, options: { multi?: boolean | undefined; upsert?: boolean | undefined; }) => {});
Collection.before.findOne((userId: string, selector: Mongo.Selector, options: { multi?: boolean | undefined; upsert?: boolean | undefined; }) => {});
Collection.before.insert((userId: string, doc: Model) => {});
Collection.before.remove((userId: string, doc: Model) => {});
Collection.before.update((userId: string, doc: Model, fieldNames: string[], modifier: Mongo.Modifier, options: { multi?: boolean | undefined; upsert?: boolean | undefined; }) => {});
Collection.before.upsert((userId: string, doc: Model, selector: Mongo.Selector, modifier: Mongo.Modifier, options: { multi?: boolean | undefined; upsert?: boolean | undefined; }) => {});

Collection.after.find((userId: string, selector: Mongo.Selector, options: { multi?: boolean | undefined; upsert?: boolean | undefined; }, cursor: Mongo.Cursor<Model>) => {});
...
let { numberAffected, insertedId }: { numberAffected?: number | undefined; insertedId?: string | undefined; } = Collection.direct.upsert(doc._id, { $inc: { votes: 2 } }, { multi: true }, () => {});
