declare module 'meteor/mongo' {
    namespace Mongo {
        interface Collection<T> {
            before: {
                find(
                    hook: (userId: string, selector: Mongo.Selector, options: CollectionHooks.ModifierOptions) => void,
                ): void;
                findOne(
                    hook: (userId: string, selector: Mongo.Selector, options: CollectionHooks.ModifierOptions) => void,
                ): void;
            ...
            direct: {
                ...
                remove(selector: Mongo.Selector | Mongo.ObjectID | string, callback?: () => void): number;
                update(
                    selector: Mongo.Selector | Mongo.ObjectID | string,
                    modifier: Mongo.Modifier,
                    options?: {
