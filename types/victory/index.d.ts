...
declare module 'victory' {
    ...
    export interface VictoryAxisProps extends VictoryCommonProps {
        ...
        style?: {
            ...
            axis?: React.CSSProperties;
            axisLabel?: React.CSSProperties;
            grid?: { [K in keyof React.CSSProperties]: string | number | ((tick?: any) => string | number) };
            ticks?: { [K in keyof React.CSSProperties]: string | number | ((tick?: any) => string | number) };
            tickLabels?: { [K in keyof React.CSSProperties]: string | number | ((tick?: any) => string | number) };
        };
        /**
