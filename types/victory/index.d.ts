...
declare module "victory" {
  ...
  export interface VictoryStyleInterface {
      parent?: { [K in keyof React.CSSProperties]: StringOrNumberOrCallback };
      data?: { [K in keyof React.CSSProperties]: StringOrNumberOrCallback };
      labels?: { [K in keyof React.CSSProperties]: StringOrNumberOrCallback };
  }
  ...
  export class VictoryBar extends React.Component<VictoryBarProps, any> {}
     ...
     */
    export class VictoryBoxPlot extends React.Component<
        VictoryBoxPlotProps,
        any
    > {}
