...
SwaggerExpressMiddleware(
    'PetStore.yaml',
    app,
    (err: any, middleware: SwaggerExpressMiddleware.SwaggerMiddleware, api: SwaggerExpressMiddleware.SwaggerObject) => {
        ...
        app.get(`${api.basePath}/pets`, (req, res, next) => {
            res.json([{ id: 'pet_1', name: 'Itchy' }, { id: 'pet_2', name: 'Scratchy' }]);
        });
