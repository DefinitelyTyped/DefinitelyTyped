// Type definitions for falafel 2.2.4
...
declare function falafel(src: string | Buffer, fn: WalkerFunction): Result;
declare function falafel(src: string | Buffer, opts: OptionsObject, fn: WalkerFunction): Result;
declare function falafel(opts: FullOptionsObject, fn: WalkerFunction): Result;
