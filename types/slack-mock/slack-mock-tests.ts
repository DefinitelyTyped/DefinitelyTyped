...
slackMock.interactiveButtons.send('http://localhost:9000/button', interactiveButtonPayload).then(() => {
...
slackMock.outgoingWebhooks.send('http://localhost:9000/outgoing', outgoingWebhookPayload).then(() => {
...
slackMock.slashCommands.send('http://localhost:9000/slash', slashCommandPayload).then(() => {
