...
const functionComponentElementNullProps: React.FunctionComponentElement<{}> = React.createElement(FunctionComponent4, null);
const legacyStatelessComponentElement: React.SFCElement<SCProps> = React.createElement(FunctionComponent, scProps);
const legacyStatelessComponentElementNullProps: React.SFCElement<{}> = React.createElement(FunctionComponent4, null);
...
// custom elements need to be declared through type augmentation
declare global {
    namespace JSX {
        interface IntrinsicElements {
            [customDomElement]: typeof customProps;
        }
    }
}
...
function foo3(child: React.ReactType<{ name: string }>) {
