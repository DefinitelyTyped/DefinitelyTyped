...
declare namespace React {
    ...
    type SetStateAction<S> = (S extends (...args: any[]) => any ? never : S) | ((prevState: S) => S);
     ...
     */
    function useState<S>(initialState: (S extends (...args: any[]) => any ? never : S) | (() => S)): [S, Dispatch<SetStateAction<S>>];
