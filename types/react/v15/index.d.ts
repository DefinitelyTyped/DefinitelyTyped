...
declare namespace React {
    ...
    // All the WAI-ARIA 1.1 attributes
    ...
    interface HTMLAttributes<T> extends DOMAttributes<T> {
        ...
        * between DOM
        * elements where the DOM hierarchy cannot be used to represent the relationship.
        * @see aria-controls. */
       'aria-owns'?: string;
       /** Defines a short hint (a word or short phrase) intended to aid the user with data entry when the control has no value.
        * A hint could be a sample value or a brief description of the expected format. */
       'aria-placeholder'?: string;
       /** Defines an element's number or position in the current set of listitems or treeitems. Not required if all elements in
        * the set are present in the DOM.
        * @see aria-setsize. */
       'aria-posinset'?: number;
       /** Indicates the current "pressed" state of toggle buttons.
        * @see aria-checked @see aria-selected. */
       'aria-pressed'?: boolean | 'undefined' | 'false' | 'mixed' | 'true';
       ...
       'aria-selected'?: boolean | 'undefined' | 'false' | 'true';
