...
/**
 * The function returned from an effect passed to {@link useEffect},
...
export type JSXElementConstructor<P> =
    ...
    // constructor signature must match Component
...
/**
 * @deprecated Use `ReactElement<P, FunctionComponent<P>>`
 */
...
/**
 * @deprecated Use `ReactElement<P, ComponentClass<P>>`
 */
...
export function createElement<P extends {}, T extends Component<P, ComponentState>, C extends ComponentClass<P>>(
 ...
 * ```
 */
export const StrictMode: ExoticComponent<{ children?: ReactNode | undefined }>;
 ...
 * ```
 */
export type ComponentProps<T extends keyof JSX.IntrinsicElements | JSXElementConstructor<any>> = T extends
 ...
 * ```
 */
export type ComponentPropsWithRef<T extends ElementType> = T extends JSXElementConstructor<infer Props>
 ...
 * ```
 */
export type CustomComponentPropsWithRef<T extends ComponentType> = T extends JSXElementConstructor<infer Props>
    // If it's a class i.e. newable we're dealing with a class component
    ? T extends abstract new(args: any) => any ? PropsWithoutRef<Props> & RefAttributes<InstanceType<T>>
    : Props
    : never;
 ...
 * ```
 */
export type ComponentRef<T extends ElementType> = ComponentPropsWithRef<T> extends RefAttributes<infer Method> ? Method
    : never;

// will show `Memo(${Component.displayName || Component.name})` in devtools by default,
// but can be given its own specific name
export type MemoExoticComponent<T extends ComponentType<any>> =
...
export namespace JSX {
    ...
    // TODO: Check impact of making ElementType<P = any> = JSXElementConstructor<P>
    ...
    type LibraryManagedAttributes<C, P> = C extends MemoExoticComponent<infer T> | LazyExoticComponent<infer T>
        ? T extends MemoExoticComponent<infer U> | LazyExoticComponent<infer U> ? ReactManagedAttributes<U, P>
