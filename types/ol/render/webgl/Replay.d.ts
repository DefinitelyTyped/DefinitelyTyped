...
export default class WebGLReplay extends VectorContext {
    ...
    protected drawHitDetectionReplay<T>(gl: WebGLRenderingContext, context: WebGLContext, skippedFeaturesHash: { [key: string]: boolean }, featureCallback: ((p0: (Feature | RenderFeature)) => T), oneByOne: boolean, opt_hitExtent?: Extent): T;
    ...
    protected drawHitDetectionReplayOneByOne<T>(gl: WebGLRenderingContext, context: WebGLContext, skippedFeaturesHash: { [key: string]: boolean }, featureCallback: ((p0: (Feature | RenderFeature)) => T), opt_hitExtent?: Extent): T;
    ...
    replay<T>(context: WebGLContext, center: Coordinate, resolution: number, rotation: number, size: Size, pixelRatio: number, opacity: number, skippedFeaturesHash: { [key: string]: boolean }, featureCallback: ((p0: (Feature | RenderFeature)) => T), oneByOne: boolean, opt_hitExtent?: Extent): T;
}
