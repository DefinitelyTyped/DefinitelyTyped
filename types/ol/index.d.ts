...
declare module 'ol/collection/event' {
    export default ol.Collection.Event;
}
...
declare module 'ol/object/event' {
    // export default ol.Object.Event;
}
...
declare module 'ol/interaction/draganddrop/event' {
    export default ol.interaction.DragAndDrop.Event;
}
declare module 'ol/interaction/dragbox' {
    export default ol.interaction.DragBox;
}
declare module 'ol/interaction/dragbox/event' {
    export default ol.interaction.DragBox.Event;
}
...
declare module 'ol/interaction/draw/event' {
    export default ol.interaction.Draw.Event;
}
declare module 'ol/interaction/extent' {
    // export default ol.interaction.Extent;
}
declare module 'ol/interaction/extent/event' {
    // export default ol.interaction.Extent.Event;
}
...
declare module 'ol/interaction/modify/event' {
    export default ol.interaction.Modify.Event;
}
...
declare module 'ol/interaction/select/event' {
    export default ol.interaction.Select.Event;
}
...
declare module 'ol/interaction/translate/event' {
    export default ol.interaction.Translate.Event;
}
...
declare module 'ol/render/webgl' {
    // export default ol.render.webgl;
}
declare module 'ol/render/webgl/immediate' {
    // export default ol.render.webgl.Immediate;
}
declare module 'ol/renderer' {
    // export default ol.renderer;
}
...
declare module 'ol/source/image/event' {
    // export default ol.source.Image.Event;
}
...
declare module 'ol/source/raster/event' {
    // export default ol.source.Raster.Event;
}
...
declare module 'ol/source/tile/event' {
    // export default ol.source.Tile.Event;
}
...
declare module 'ol/source/vector/event' {
    // export default ol.source.Vector.Event;
}
...
declare module 'ol/webgl/context' {
    // export default ol.webgl.Context;
}
