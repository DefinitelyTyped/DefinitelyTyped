...
export function makeArrayExtender<T>(valueReader: (this: T, p0: Node, p1: any[]) => any[] | undefined, opt_this?: T): Parser;
...
export function makeSimpleNodeFactory(opt_nodeName?: string, opt_namespaceURI?: string): (p0: any, p1: any[], p2?: string) => Node | undefined;
