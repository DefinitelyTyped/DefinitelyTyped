...
export default class TileGrid {
    ...
    forEachTileCoordParentTileRange<T>(tileCoord: TileCoord, callback: ((this: T, p1: number, p2: TileRange) => boolean), opt_this?: T, opt_tileRange?: TileRange, opt_extent?: Extent): boolean;
    getExtent(): Extent;
