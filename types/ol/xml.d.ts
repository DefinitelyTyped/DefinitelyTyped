...
export function makeArrayExtender<T>(
    valueReader: (this: T, param1: Node, param2: any[]) => any[],
    opt_this?: T
): Parser;
export function makeArrayPusher<T>(
    valueReader: (this: T, param1: Element, param2: any[]) => void,
    opt_this?: T
): Parser;
export function makeArraySerializer<T, V>(
    nodeWriter: (this: T, param1: Element, param2: V, param3: any[]) => void,
    opt_this?: T
): Serializer;
export function makeChildAppender<T, V>(
    nodeWriter: (this: T, param1: Node, param2: V, param3: any[]) => void,
    opt_this?: T
): Serializer;
...
): (param0: any, param1: any[], param2: string) => Node;
...
export function pushSerializeAndPop<O, T>(
    ...
    nodeFactory: (this: T, param1: any, param2: any[], param3: string) => Node,
    values: any[],
    objectStack: any[],
    opt_keys?: string[],
    opt_this?: T
