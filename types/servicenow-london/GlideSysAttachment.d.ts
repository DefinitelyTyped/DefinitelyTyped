declare class GlideSysAttachment {
    ...
    writeBase64(record: ScopedGlideRecord, fileName: string, contentType: string, base64Content: string): string;
    writeContentStream(record: ScopedGlideRecord, fileName: string, contentType: string, inputStream: object): string;
}
