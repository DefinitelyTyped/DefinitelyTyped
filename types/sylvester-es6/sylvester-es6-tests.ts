...
linkedList1.forEach((node, i) => node.data + i, this);
linkedList1.each((node, i) => node.data + i, this);
...
circularLinkedList1.forEach((node, i) => node.data + i, this);
circularLinkedList1.each((node, i) => node.data + i, this);
