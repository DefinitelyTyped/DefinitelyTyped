...
declare namespace gapi.client.doubleclickbidmanager {
...
declare namespace gapi.client {
    ...
    export function load (name: "doubleclickbidmanager", version: "v1") : PromiseLike<void>;    
    export function load (name: "doubleclickbidmanager", version: "v1", callback: () => any) : void;    
    
    const lineitems: gapi.client.doubleclickbidmanager.LineitemsResource; 
    
    const queries: gapi.client.doubleclickbidmanager.QueriesResource; 
    
    const reports: gapi.client.doubleclickbidmanager.ReportsResource; 
    
    const sdf: gapi.client.doubleclickbidmanager.SdfResource; 
