...
declare module "expired-storage" {
  ...
  class ExpiredStorage {
     ...
     */
    keys(includeExpired: boolean): Array<string> | null;
    /**
     ...
     */
    clearExpired(): Array<string> | null;
    /**
    ...
    * @param key Item key to get (string).
    * @return {ExpiredStorage.PeekInterface} PeekInterface with: {value, timeLeft, isExpired}
    */
  ...
  namespace ExpiredStorage {
    export interface PeekInterface {
      /**
       * The value of a [key]
       */
      value: string | null,
