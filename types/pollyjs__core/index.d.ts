...
export type InterceptHandler = (req: Request, res: Response, intercept: Intercept) => EventListenerResponse;
export class RouteHandler {
    ...
    intercept(fn: (req: Request, res: Response, intercept: Intercept) => EventListenerResponse): RouteHandler;
