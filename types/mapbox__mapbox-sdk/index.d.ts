...
declare module '@mapbox/mapbox-sdk/services/directions' {
  ...
  import MapiClient, { SdkConfig } from '@mapbox/mapbox-sdk/lib/classes/mapi-client';
  import { MapiRequest, MapboxProfile, DirectionsApproach, Coordinates } from '@mapbox/mapbox-sdk/lib/classes/mapi-request';
...
declare module '@mapbox/mapbox-sdk/services/styles' {
  ...
  *********************************************************************************************************************/
  ...
  interface StylesService {
     ...
     * @param ownerId
     */
    getStyle(config: { styleId: string; ownerId?: string, metadata?: boolean, draft?: boolean, fresh?: boolean }): MapiRequest;
    /**
     * Create a style.
     * @param style
     * @param ownerId
...
declare module '@mapbox/mapbox-sdk/services/tilesets' {
  ...
  interface TilesetsService {
    ...
    createTileset(config: { tilesetId: string; recipe: any; name: string; private?: boolean; description?: string }): MapiRequest;
