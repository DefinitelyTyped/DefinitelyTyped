...
export function cvjs_displayInformationModal(floorplan_div: string, textString: any, modalHeight: number, 
modal_left: number, modal_top: number): void;
...
export function cvjs_saveScreenAsImage_makeTumbnails(serverPath: string, image_fileName: string, sizeThumb1: number, thumb1_fileName: string, sizeThumb2: number, 
thumb2_fileName: string): void;
export function cvjs_saveScreenAsImage_stickyNoteInfo_makeTumbnails(serverPath: string, image_fileName: string, sizeThumb1: number, thumb1_fileName: string, sizeThumb2: number, 
thumb2_fileName: string): void;
...
export function cvjs_batchConvertDrawingsToPDF_CustomReport(floorPlan: any, drawingFilesArray: any, pageOrientationArray: any, pageSizeArray: any, pageResolutionArray: any, batchFilesToPDF_Controller: any, 
...
export function cvjs_InitCADViewer_highLight_popUp_dual_Id(floorplan_div: string, cvjsRoomPolygonBaseAttributes: object, cvjsRoomPolygonHighlightAttributes: object, 
cvjsRoomPolygonSelectAttributes: object, cvjsPopUpBody: object, cvjsPopUpBody2: object): void;
export function cvjs_InitCADViewer_highLight_popUp_app(floorplan_div: string, app_folder: any, cvjsRoomPolygonBaseAttributes: object, cvjsRoomPolygonHighlightAttributes: object, 
cvjsRoomPolygonSelectAttributes: object, cvjsPopUpBody: object): void;
export function cvjs_InitCADViewer_highLight_popUp(floorplan_div: string, cvjsRoomPolygonBaseAttributes: object, cvjsRoomPolygonHighlightAttributes: object, 
cvjsRoomPolygonSelectAttributes: object, cvjsPopUpBody: object): void;
export function cvjs_InitCADViewer_highLight(floorplan_div: string, cvjsRoomPolygonBaseAttributes: object, cvjsRoomPolygonHighlightAttributes: object, 
cvjsRoomPolygonSelectAttributes: object): void;
export function cvjs_InitCADViewer_app(floorplan_div: string, app_folder: string, imagePathDirect: string): void;
export function cvjs_InitCADViewer_app_highLight(floorplan_div: string, app_folder: string, cvjsRoomPolygonBaseAttributes: object, cvjsRoomPolygonHighlightAttributes: object, 
cvjsRoomPolygonSelectAttributes: object): void;
export function cvjs_InitCADViewer_app_highLight_popUp(floorplan_div: string, app_folder: string, cvjsRoomPolygonBaseAttributes: object, cvjsRoomPolygonHighlightAttributes: object, 
cvjsRoomPolygonSelectAttributes: object, cvjsPopUpBody: object): void;
...
export function cvjs_LoadDrawing_Conversion(floorplan_div: string, originatingContent: string, originatingFileNameNoExtension: any, originatingUsername: string, 
originatingPassword: string): void;
export function cvjs_LoadDrawing_Conversion_original(floorplan_div: any, originatingContent: any, originatingFileNameNoExtension: any, originatingUsername: any, 
originatingPassword: any): void;
...
export function cvjs_insertSingleIconImage(floorplan_div: string, placeholder: string, icon_image_code: string, cvjs_command_name: string, cvjs_command_parameter: string, 
cvjs_icon_image: string, cvjs_language_popup: boolean, cvjs_icon_image_npmpackage: string, firsticonflag: boolean): void;
...
export function cvjs_superimposeBackgroundDrawing_PrintOutputAtDualTextbox(floorplan_div: string, backgroundDrawing: string, adjustmentTop: number, adjustmentBottom: number, 
adjustmentLeft: number, adjustmentRight: number): void;
export function cvjs_superimposeBackgroundDrawing_PrintOutputAtZoom(floorplan_div: string, backgroundDrawing: string, adjustmentTop: number, adjustmentBottom: number, 
adjustmentLeft: number, adjustmentRight: number): void;
...
export function cvjs_ApplyRelativeLinearGradient(graphicalObject: any, xStart: any, yStart: any, xEnd: any, yEnd: any, startColor: any, middleColor: any, endColor: any, 
fillOpacity: any): void;
...
export function cvjs_ApplyRelativeLinearGradientStandard3ColorsOnSpaceObjectId(layer: string, Id: string, startColor: string, middleColor: string, endColor: string, 
fillOpacity: number): void;
export function cvjs_ApplyRelativeLinearGradientStandard3ColorsOnSpaceObjectNode(layer: string, nodeId: string, startColor: string, middleColor: string, endColor: string, 
fillOpacity: number): void;
export function cvjs_ApplyRelativeLinearGradientOnObject_layerSort(layer: string, nodeId: string, xStart: number, yStart: number, xEnd: number, yEnd: number, startColor: string, 
middleColor: string, endColor: string, fillOpacity: number, layer2: string): 1 | -1;
...
export function cvjs_ApplyRelativeRadialGradientStandard3ColorsOnSpaceObjectId(layer: string, Id: string, startColor: string, middleColor: string, endColor: string, 
fillOpacity: number): void;
export function cvjs_ApplyRelativeRadialGradientStandard3ColorsOnSpaceObjectNode(layer: string, nodeId: string, startColor: string, middleColor: string, endColor: string, 
fillOpacity: number): void;
export function cvjs_ApplyRelativeRadialGradientOnObject_layerSort(layer: string, nodeId: string, xC: number, yC: number, radius: number, startColor: string, 
middleColor: string, endColor: string, fillOpacity: number, layer2: string): 1 | -1;
export function cvjs_AddTextOnObject(txtLayer: string, nodeId: string, leftScale: number, textString1: string, textStyle1: object, scaleText1: string, hexColorText1: string, 
textString2: string, textStyle2: object, scaleText2: string, hexColorText2: string, textString3: string, textStyle3: object, scaleText3: string, hexColorText3: string): void;
export function cvjs_AddTextAndTBorderOnSpaceObject3Lines(txtLayer: string, nodeId: string, tborderId: string, leftScale: number, textId1: string, 
textString1: string, textStyle1: object, scaleText1: string, hexColorText1: string, textId2: string, textString2: string, textStyle2: object, scaleText2: string, 
  hexColorText2: string, textId3: string, textString3: string, textStyle3: object, scaleText3: string, hexColorText3: string): number;
export function cvjs_AddTextAndTBorderOnSpaceObjectId_GlobalHeight(txtLayer: string, Id: string, leftScale: number, textStringArr: any, textStyleArr: any, 
scaleTextArr: any, hexColorTextArr: any, clipping: boolean): void;
export function cvjs_AddTextAndTBorderOnSpaceObjectId(txtLayer: string, Id: string, leftScale: number, textStringArr: any, textStyleArr: any, scaleTextArr: any, 
hexColorTextArr: any, clipping: boolean, centering: boolean): void;
export function cvjs_AddTextAndTBorderOnSpaceObjectNode(txtLayer: string, nodeId: string, leftScale: number, textStringArr: any, textStyleArr: any, scaleTextArr: any, 
hexColorTextArr: any, clipping: boolean, centering: boolean): void;
export function cvjs_AddTextAndTBorderOnSpaceObject(txtLayer: any, nodeId: any, tborderId: any, leftScale: any, textIdArr: any, textStringArr: any, textStyleArr: any, 
scaleTextArr: any, hexColorTextArr: any, clipping: any, centering: any, globalheightFlag: any): number;
export function cvjs_AddTextOnObjectScaleText(graphicalObject: any, leftScale: any, textString1: any, textStyle1: any, scaleText1: any, textString2: any, textStyle2: any, 
scaleText2: any, textString3: any, textStyle3: any, scaleText3: any): void;
...
export function cvjs_setCurrentNodeValues(currentNode_underbar: string, currentNode_name: string, currentNode_id: string, currentNode_layer: string, currentNode_group: string, 
currentNode_attributes: string, currentNode_attributeStatus: string, currentNode_type: string, currentNode_tags: string, currentNode_occupancy: string, 
  currentNode_linked: boolean, currentNode_translate_x: string, currentNode_translate_y: string, currentNode_scale_x: string, currentNode_scale_y: string, 
    currentNode_rotate: string, currentNode_transform: string, currentNode_area: string, currentNode_defaultcolor: object, currentNode_highlightcolor: object, 
      currentNode_selectcolor: object, currentNode_pageNumber: object, currentNode_pageName: object): void;
export function cvjs_setCurrentSpaceObjectNodeValues(currentNode_underbar: string, currentNode_name: string, currentNode_id: string, currentNode_layer: string, 
currentNode_group: string, currentNode_attributes: string, currentNode_attributeStatus: string, currentNode_type: string, currentNode_tags: string, 
  currentNode_occupancy: string, currentNode_linked: boolean, currentNode_translate_x: string, currentNode_translate_y: string, currentNode_scale_x: string, 
    currentNode_scale_y: string, currentNode_rotate: string, currentNode_transform: string, currentNode_area: string, currentNode_defaultcolor: object, 
      currentNode_highlightcolor: object, currentNode_selectcolor: object, currentNode_pageNumber: object, currentNode_pageName: object): void;
export function cvjs_setCurrentStickyNoteValues(currentStickyNote_underbar: string, currentStickyNote_name: string, currentStickyNote_id: string, 
currentStickyNote_layer: string, currentStickyNote_group: string, currentStickyNote_text: string, currentStickyNote_userid: string, currentStickyNote_date: string, 
  currentStickyNote_linked: boolean): void;
export function cvjs_setCurrentStickyNoteValues_All(currentStickyNote_underbar: string, currentStickyNote_name: string, currentStickyNote_id: string, 
currentStickyNote_layer: string, currentStickyNote_group: string, currentStickyNote_text: string, currentStickyNote_userid: string, currentStickyNote_date: string, 
  currentStickyNote_linked: boolean, currentStickyNote_transform: boolean, currentStickyNote_currentPage: string, currentStickyNote_drawingRotation: number): void;
...
export function cvjs_setCurrentRedlineValues(currentRedline_underbar: string, currentRedline_name: string, currentRedline_id: string, currentRedline_layer: string, 
currentRedline_group: string, currentRedline_color: string, currentRedline_strokeWidth: any, currentRedline_drawingRotation: number): void;
export function cvjs_setCurrentRedlineValues_All(currentRedline_underbar: string, currentRedline_name: string, currentRedline_id: string, currentRedline_layer: string, 
currentRedline_group: string, currentRedline_color: string, currentRedline_strokeWidth: any, currentRedline_fill: string, currentRedline_fill_opacity: number, 
  currentRedline_transform: string, currentRedline_username: string, currentRedline_userid: string, currentRedline_currentPage: number, currentRedline_polypath_arrow: string, currentRedline_triangle_design: string, currentRedline_redline_text: string, currentRedline_drawingRotation: string, currentRedline_font_size: string): void;
...
export function cvjs_overwriteNodeValues(overwriteNode_underbar: any, overwriteNode_id: any, overwriteNode_name: any, overwriteNode_layer: any, overwriteNode_group: any, 
overwriteNode_attributes: any, overwriteNode_attributeStatus: any, overwriteNode_type: any, overwriteNode_tags: any, overwriteNode_occupancy: any, overwriteNode_linked: any, overwriteNode_area: any): void;
...
export function cvjs_addRectangleCustomSpaceObject(floorplan_div: string, svgImagePath: string, spaceObjectId: string, spaceObjectName: string, spaceObjectType: string, 
spaceObjectLayer: any): void;
...
export function cvjs_makeLegendUpperRightDiv(upperRightDeltaX: number, upperRightDeltaY: any, roomLayer: any, headerScale: any, headerString: any, headerStyle: any, 
headerHexColor: any, scaleTextArr: number[], textStringArr: any, textStylesArr: any, hexColorTextArr: any, legendColorArr: any, floorplan_div: string, 
  highlight_handles_style_object: any): void;
export function cvjs_makeLegendUpperRight(upperRightDeltaX: number, upperRightDeltaY: any, roomLayer: any, headerScale: any, headerString: any, headerStyle: any, 
headerHexColor: any, scaleTextArr: number[], textStringArr: any, textStylesArr: any, hexColorTextArr: any, legendColorArr: any, highlight_handles_style_object: any): void;
...
export function cvjs_makeStampUpperRightDiv(upperRightDeltaX: number, upperRightDeltaY: any, roomLayer: string, headerScale: number, headerStringArr: any, headerStyle: object, 
headerHexColor: string, scaleTextArr: number[], textStringArr: any, textStylesArr: any, hexColorTextArr: any, hexColorFrame: string, floorplan_div: string): void;
export function cvjs_makeStampUpperRight(upperRightDeltaX: number, upperRightDeltaY: any, roomLayer: any, headerScale: any, headerStringArr: any, headerStyle: any, 
headerHexColor: any, scaleTextArr: number[], textStringArr: any, textStylesArr: any, hexColorTextArr: any, hexColorFrame: any): void;
...
export function cvjs_displaySpaceObjectsStructureInternal(floorplan_div: any, userSiteName: any, dropFloor: any, dropFloorList: any, myCustomany: any): void;
...
export function cvjs_conversion_setApplicationServiceParameters(applicationPlatform: string, applicationPlatformUsername: string, applicationPlatformUserID: string, 
ServiceToken: string, leaveStreamOnServer: any): void;
...
export function cvjs_addSpaceObjectDirectXY(floorplan_div: string, svgImagePath: string, spaceObjectId: string, spaceObjectName: string, spaceObjectType: string, 
coordinate_flag: number, xcor: number, ycor: number, textArray: any, scaleFactor: number, colorObject: any, textStyles: any, scaleText: any, hexColorText: any, 
  leftFactor: number): void;
export function cvjs_addFixedSizeCustomSpaceObjectXY(floorplan_div: string, svgImagePath: string, spaceObjectId: string, spaceObjectName: string, spaceObjectType: string, 
spaceObjectLayer: any, xcor: number, ycor: number, coordinate_flag: number, textArray: any, scaleFactor: number, textStyles: any, scaleText: any, hexColorText: any, 
  leftFactor: number): void;
...
export function cvjs_addFixedSizeCustomSpaceObject(floorplan_div: string, svgImagePath: string, spaceObjectId: string, spaceObjectName: string, spaceObjectType: string, 
spaceObjectLayer: any): void;
...
export function cvjs_checkLicensePreThenLoad(floorplan_div: any, originatingContent: any, originatingFileNameNoExtension: any, originatingUsername: any, 
originatingPassword: any): void;
...
export function cvjs_addSingleSpaceObject(floorplan_div: string, currentNode_name: string, currentNode_id: string, currentNode_layer: string, currentNode_group: string, 
currentNode_attributes: string, currentNode_attributeStatus: string, currentNode_type: string, currentNode_tags: string, currentNode_occupancy: string, currentNode_Path: string): void;
...
export function cvjs_modifySpaceObjectDirectXY(floorplan_div: string, spaceObjectId: string, svgImagePath: string, textArray: any, scaleFactor: number, textStyles: any, 
scaleText: any, hexColorText: any, leftFactor: number): boolean;
...
export function cvjs_mouseenter_handleObjectStyles(hexColor: string, lineWeightFactor: number, opacity: number, tooltip: boolean, id: string, handle: string, 
customTooltip: string): void;
...
export function cvjs_executeCustomCanvasMethod_nodrag(generic_mousemove_method: any, generic_mousedown_method: any, generic_mouseup_method: any, generic_dblclick_method: any, 
generic_init_method: any): void;
export function cvjs_executeCustomCanvasMethod_click(generic_mousemove_method: any, generic_mousedown_method: any, generic_mouseup_method: any, generic_dblclick_method: any, 
generic_init_method: any): void;
...
export function cvjs_createSpaceObjectGroup(currentNode_underbar: string, baseGraphics: any, customSpaceObjectId: string, customSpaceObjectName: string, 
customSpaceObjectType: string, customLayer: string, customGroup: string): void;
...
export function cvjs_setImageSpaceObjectParameters(loadSpaceImage_LocationOrbase64Object: string, loadSpaceImage_ID: string, loadSpaceImage_Type: string, 
loadSpaceImage_Layer: string): void;
...
export function cvjs_AddTextOnSpaceObject(txtLayer: string, Id: string, leftScale: number, textStringArr: any, textStyleArr: any, scaleTextArr: any, 
hexColorTextArr: any, clipping: boolean, centering: boolean): void;
...
export function cvjs_setAllServerPaths_and_Handlers(ServerBackEndUrl: string, ServerUrl: string, ServerLocation: string, handlerType: string, frontEndType: string, 
floorplan_div: string, controllerPath: string): void;
...
export function cvjs_addSpaceObject(floorplan_div: any, ID: any, loadSpaceImage_LocationOr64byteEncoded: any, scale: any, width: any, height: any, rotate: any, unit: any, 
jsonSpaceObject: any): void;
export function cvjs_addLayeredSpaceObject(floorplan_div: any, ID: any, LocationOr64byteEncodedArr: any, layerArr: any, scale: any, width: any, height: any, rotate: any, 
unit: any, jsonSpaceObject: any): void;
