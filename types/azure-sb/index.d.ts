...
export function createWrapService(acsHost: string, issuer?: string, accessKey?: string): WrapService;
...
export namespace Azure.ServiceBus {
    ...
    export type TypedResultAndResponseCallback<T> = (error: Error | null, result: T, response: Response) => void;
