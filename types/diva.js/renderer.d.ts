...
export default class Renderer {
    ...
    load(config: object, viewportPosition: ViewportPosition, sourceResolver: SourceProvider): void;
    adjust(): void;
    goto(pageIndex: number, verticalOffset: number, horizontalOffset: number): void;
