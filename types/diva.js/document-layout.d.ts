import { Dimensions, Offset, PageGroup, PageInfo, RendererConfig, Region } from './interfaces';
...
export default class DocumentLayout {
    ...
    getPageToViewportCenterOffset(pageIndex: number, viewport: Region): { x: number; y: number };
}
