...
declare namespace gapi.client.youtube {
    ...
    interface ActivitiesResource {
        ...
        list(request: {        
            ...
            regionCode?: string;
        }): gapi.client.Request<ActivityListResponse>;        
    ...
    interface CaptionsResource {
        ...
        list(request: {        
            ...
            videoId: string;
        }): gapi.client.Request<CaptionListResponse>;        
    ...
    interface ChannelBannersResource {
        ...
        insert(request: {        
            ...
            onBehalfOfContentOwner?: string;
        }): gapi.client.Request<ChannelBannerResource>;        
    ...
    interface ChannelSectionsResource {
        ...
        insert(request: {        
            ...
            part: string;
        }): gapi.client.Request<ChannelSection>;        
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<ChannelSectionListResponse>;        
    ...
    interface ChannelsResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<ChannelListResponse>;        
    ...
    interface CommentThreadsResource {
        ...
        list(request: {        
            ...
            videoId?: string;
        }): gapi.client.Request<CommentThreadListResponse>;        
    ...
    interface CommentsResource {
        ...
        list(request: {        
            ...
            textFormat?: string;
        }): gapi.client.Request<CommentListResponse>;        
    ...
    interface FanFundingEventsResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<FanFundingEventListResponse>;        
    ...
    interface GuideCategoriesResource {
        ...
        list(request: {        
            ...
            regionCode?: string;
        }): gapi.client.Request<GuideCategoryListResponse>;        
    ...
    interface I18nLanguagesResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<I18nLanguageListResponse>;        
    ...
    interface I18nRegionsResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<I18nRegionListResponse>;        
    ...
    interface LiveBroadcastsResource {
        ...
        bind(request: {        
            ...
            streamId?: string;
        }): gapi.client.Request<LiveBroadcast>;        
        ...
        list(request: {        
            ...
            /** The part parameter specifies a comma-separated list of one or more liveBroadcast resource properties that the API response will include. The part names that you can include in the parameter value are id, snippet, contentDetails, and status. */
            part: string;
        }): gapi.client.Request<LiveBroadcastListResponse>;        
    ...
    interface LiveChatMessagesResource {
        ...
        }): gapi.client.Request<LiveChatMessageListResponse>;        
    ...
    interface LiveChatModeratorsResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<LiveChatModeratorListResponse>;        
    ...
    interface LiveStreamsResource {
        ...
        insert(request: {        
            ...
            part: string;
        }): gapi.client.Request<LiveStream>;        
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<LiveStreamListResponse>;        
    ...
    interface PlaylistItemsResource {
        ...
        insert(request: {        
            ...
            /** The part parameter serves two purposes in this operation. It identifies the properties that the write operation will set as well as the properties that the API response will include. */
            part: string;
        }): gapi.client.Request<PlaylistItem>;        
        ...
        list(request: {        
            ...
            videoId?: string;
        }): gapi.client.Request<PlaylistItemListResponse>;        
    ...
    interface PlaylistsResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<PlaylistListResponse>;        
    ...
    interface SearchResource {
        ...
        list(request: {        
            ...
            videoType?: string;
        }): gapi.client.Request<SearchListResponse>;        
    ...
    interface SponsorsResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<SponsorListResponse>;        
    ...
    interface ThumbnailsResource {
        ...
        set(request: {        
            ...
            videoId: string;
        }): gapi.client.Request<ThumbnailSetResponse>;        
    ...
    interface VideoAbuseReportReasonsResource {
        ...
        list(request: {        
            ...
            part: string;
        }): gapi.client.Request<VideoAbuseReportReasonListResponse>;        
    ...
    interface VideoCategoriesResource {
        ...
        list(request: {        
            ...
            regionCode?: string;
        }): gapi.client.Request<VideoCategoryListResponse>;        
    ...
    interface VideosResource {
        ...
        getRating(request: {        
            ...
            /** The onBehalfOfContentOwner parameter indicates that the request's authorization credentials identify a YouTube CMS user who is acting on behalf of the content owner specified in the parameter value. This parameter is intended for YouTube content partners that own and manage many different YouTube channels. It allows content owners to authenticate once and get access to all their video and channel data, without having to provide authentication credentials for each individual channel. The CMS account that the user authenticates with must be linked to the specified YouTube content owner. */
            onBehalfOfContentOwner?: string;
        }): gapi.client.Request<VideoGetRatingResponse>;        
        ...
        list(request: {        
            ...
            videoCategoryId?: string;
        }): gapi.client.Request<VideoListResponse>;        
...
declare namespace gapi.client {
    ...
    const activities: gapi.client.youtube.ActivitiesResource; 
    
    const captions: gapi.client.youtube.CaptionsResource; 
    
    const channelBanners: gapi.client.youtube.ChannelBannersResource; 
    
    const channelSections: gapi.client.youtube.ChannelSectionsResource; 
    
    const channels: gapi.client.youtube.ChannelsResource; 
    
    const commentThreads: gapi.client.youtube.CommentThreadsResource; 
    
    const comments: gapi.client.youtube.CommentsResource; 
    
    const fanFundingEvents: gapi.client.youtube.FanFundingEventsResource; 
    
    const guideCategories: gapi.client.youtube.GuideCategoriesResource; 
    
    const i18nLanguages: gapi.client.youtube.I18nLanguagesResource; 
    
    const i18nRegions: gapi.client.youtube.I18nRegionsResource; 
    
    const liveBroadcasts: gapi.client.youtube.LiveBroadcastsResource; 
    
    const liveChatBans: gapi.client.youtube.LiveChatBansResource; 
    
    const liveChatMessages: gapi.client.youtube.LiveChatMessagesResource; 
    
    const liveChatModerators: gapi.client.youtube.LiveChatModeratorsResource; 
    
    const liveStreams: gapi.client.youtube.LiveStreamsResource; 
    
    const playlistItems: gapi.client.youtube.PlaylistItemsResource; 
    
    const playlists: gapi.client.youtube.PlaylistsResource; 
    
    const search: gapi.client.youtube.SearchResource; 
    
    const sponsors: gapi.client.youtube.SponsorsResource; 
    
    const subscriptions: gapi.client.youtube.SubscriptionsResource; 
    
    const superChatEvents: gapi.client.youtube.SuperChatEventsResource; 
    
    const thumbnails: gapi.client.youtube.ThumbnailsResource; 
    
    const videoAbuseReportReasons: gapi.client.youtube.VideoAbuseReportReasonsResource; 
    
    const videoCategories: gapi.client.youtube.VideoCategoriesResource; 
    
    const videos: gapi.client.youtube.VideosResource; 
    
    const watermarks: gapi.client.youtube.WatermarksResource; 
