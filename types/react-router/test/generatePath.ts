...
generatePath('/posts/:postId(\\d+)?/comments/:commentId?', { postId: '1', commentId: '1' });
generatePath('/posts/:postId(\\d+)?/comments/:commentId?', { commentId: '1' });
