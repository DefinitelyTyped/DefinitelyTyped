...
export function scal (x: Float32Array, alpha: number): void;
export function scal (x: Float64Array, alpha: number): void;
...
//export function iamin (x: Float32Array|Float64Array): number;
