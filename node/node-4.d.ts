...
declare module "constants" {
	...
	export var EDQUOT: string;
	export var EMULTIHOP: string;
	export var ESTALE: string;
	export var O_DIRECT: string;
	export var O_DIRECTORY: string;
	export var O_NOCTTY: string;
	export var O_NOFOLLOW: string;
	export var O_NONBLOCK: string;
	export var O_SYNC: string;
	export var SIGALRM: string;
	export var SIGBUS: string;
	export var SIGCHLD: string;
	export var SIGCONT: string;
	export var SIGIO: string;
	export var SIGIOT: string;
	export var SIGPIPE: string;
	export var SIGPOLL: string;
	export var SIGPROF: string;
	export var SIGPWR: string;
	export var SIGQUIT: string;
	export var SIGSTKFLT: string;
	export var SIGSTOP: string;
	export var SIGSYS: string;
	export var SIGTRAP: string;
	export var SIGTSTP: string;
	export var SIGTTIN: string;
	export var SIGTTOU: string;
	export var SIGUNUSED: string;
	export var SIGURG: string;
	export var SIGUSR1: string;
	export var SIGUSR2: string;
	export var SIGVTALRM: string;
	export var SIGXCPU: string;
	export var SIGXFSZ: string;
	export var S_IFBLK: string;
	export var S_IFIFO: string;
	export var S_IFSOCK: string;
	export var S_IRGRP: string;
	export var S_IROTH: string;
	export var S_IRUSR: string;
	export var S_IRWXG: string;
	export var S_IRWXO: string;
	export var S_IRWXU: string;
	export var S_IWGRP: string;
	export var S_IWOTH: string;
	export var S_IWUSR: string;
	export var S_IXGRP: string;
	export var S_IXOTH: string;
	export var S_IXUSR: string;
