...
declare module "express" {
    import M = _ExternalShim_._Express_;
    export = M;
}
...
//
// Note that the type 'Request' is accessed via the variable 'express', meaning that
// Request must be not just a type, but also a property on 'express'. The 'pure' typings
// declared in the Express module below don't support this usage. With the _ExternalTypes_
...
//          request?: Express.Request;
//
// If all typings switch to using the pure internal types in Express, this shim can be removed.
declare module _ExternalShim_ {
    export var _Express_: Express;
    export module _Express_ {
...
interface Express {
    ...
    /**
        ...
        * @param options
        */
    bodyParser(options?: any): Express.Handler;
    ...
    /**
        ...
        */
    errorHandler(opts?: any): Express.Handler;
    ...
    /**
        ...
        * @param key
        */
    methodOverride(key?: string): Express.Handler;
    ...
    /**
        ...
        * @param options
        */
    static(root: string, options?: any): Express.Handler;
    ...
    /**
        ...
        * @param realm
        */
    basicAuth(callback: (user: string, pass: string, fn : Function) => void, realm?: string): Express.Handler;

    basicAuth(callback: (user: string, pass: string) => boolean, realm?: string): Express.Handler;

    basicAuth(user: string, pass: string, realm?: string): Express.Handler;
    ...
    /**
        ...
        * @param options
        */
    compress(options?: any): Express.Handler;
    ...
    /**
        ...
        * @param options
        */
    cookieSession(options?: any): Express.Handler;
    ...
    /**
        ...
        * @param options
        */
    csrf(options?: {value?: Function}): Express.Handler;
    ...
    /**
        ...
        * @param options
        */
    directory(root: string, options?: any): Express.Handler;
    ...
    /**
        ...
        * @param options
        */
    favicon(path?: string, options?: any): Express.Handler;
    ...
    /**
        ...
        * @param options
        */
    json(options?: any): Express.Handler;
    ...
    /**
        ...
        */
    limit(bytes: number): Express.Handler;

    limit(bytes: string): Express.Handler;
    ...
    /**
        ...
        */
    logger(options: string): Express.Handler;

    logger(options: Function): Express.Handler;

    logger(options?: any): Express.Handler;
    ...
    /**
        ...
        * @param fmt
        */
    compile(fmt: string): Express.Handler;
    ...
    /**
        ...
        */
    query(options: any): Express.Handler;
    ...
    /**
        ...
        */
    staticCache(options: any): Express.Handler;
    ...
    /**
        ...
        * well as `.status == 408`.
        */
    timeout(ms: number): Express.Handler;
    ...
    /**
        ...
        * @param server
        */
    vhost(hostname: string, server: any): Express.Handler;
