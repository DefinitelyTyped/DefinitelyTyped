...
declare module "material-ui" {
    ...
    // svg icons
    export import ActionAccessibility = __MaterialUI.ActionAccessibility; // require('material-ui/lib/svg-icon/action/accessibility');
    export import ActionAccessible = __MaterialUI.ActionAccessible; // require('material-ui/lib/svg-icon/action/accessible');
    export import ActionAccountBalance = __MaterialUI.ActionAccountBalance; // require('material-ui/lib/svg-icon/action/account-balance');
    export import ActionAccountBalanceWallet = __MaterialUI.ActionAccountBalanceWallet; // require('material-ui/lib/svg-icon/action/account-balance-wallet');
    export import ActionAccountBox = __MaterialUI.ActionAccountBox; // require('material-ui/lib/svg-icon/action/account-box');
    export import ActionAccountCircle = __MaterialUI.ActionAccountCircle; // require('material-ui/lib/svg-icon/action/account-circle');
    export import ActionAddShoppingCart = __MaterialUI.ActionAddShoppingCart; // require('material-ui/lib/svg-icon/action/add-shopping-cart');
    export import ActionAlarmAdd = __MaterialUI.ActionAlarmAdd; // require('material-ui/lib/svg-icon/action/alarm-add');
    export import ActionAlarm = __MaterialUI.ActionAlarm; // require('material-ui/lib/svg-icon/action/alarm');
    export import ActionAlarmOff = __MaterialUI.ActionAlarmOff; // require('material-ui/lib/svg-icon/action/alarm-off');
    export import ActionAlarmOn = __MaterialUI.ActionAlarmOn; // require('material-ui/lib/svg-icon/action/alarm-on');
    export import ActionAllOut = __MaterialUI.ActionAllOut; // require('material-ui/lib/svg-icon/action/all-out');
    export import ActionAndroid = __MaterialUI.ActionAndroid; // require('material-ui/lib/svg-icon/action/android');
    export import ActionAnnouncement = __MaterialUI.ActionAnnouncement; // require('material-ui/lib/svg-icon/action/announcement');
    export import ActionAspectRatio = __MaterialUI.ActionAspectRatio; // require('material-ui/lib/svg-icon/action/aspect-ratio');
    export import ActionAssessment = __MaterialUI.ActionAssessment; // require('material-ui/lib/svg-icon/action/assessment');
    export import ActionAssignmentInd = __MaterialUI.ActionAssignmentInd; // require('material-ui/lib/svg-icon/action/assignment-ind');
    export import ActionAssignmentLate = __MaterialUI.ActionAssignmentLate; // require('material-ui/lib/svg-icon/action/assignment-late');
    export import ActionAssignment = __MaterialUI.ActionAssignment; // require('material-ui/lib/svg-icon/action/assignment');
    export import ActionAssignmentReturned = __MaterialUI.ActionAssignmentReturned; // require('material-ui/lib/svg-icon/action/assignment-returned');
    export import ActionAssignmentReturn = __MaterialUI.ActionAssignmentReturn; // require('material-ui/lib/svg-icon/action/assignment-return');
    export import ActionAssignmentTurnedIn = __MaterialUI.ActionAssignmentTurnedIn; // require('material-ui/lib/svg-icon/action/assignment-turned-in');
    export import ActionAutorenew = __MaterialUI.ActionAutorenew; // require('material-ui/lib/svg-icon/action/autorenew');
    export import ActionBackup = __MaterialUI.ActionBackup; // require('material-ui/lib/svg-icon/action/backup');
    export import ActionBookmarkBorder = __MaterialUI.ActionBookmarkBorder; // require('material-ui/lib/svg-icon/action/bookmark-border');
    export import ActionBookmark = __MaterialUI.ActionBookmark; // require('material-ui/lib/svg-icon/action/bookmark');
    export import ActionBook = __MaterialUI.ActionBook; // require('material-ui/lib/svg-icon/action/book');
    export import ActionBugReport = __MaterialUI.ActionBugReport; // require('material-ui/lib/svg-icon/action/bug-report');
    export import ActionBuild = __MaterialUI.ActionBuild; // require('material-ui/lib/svg-icon/action/build');
    export import ActionCached = __MaterialUI.ActionCached; // require('material-ui/lib/svg-icon/action/cached');
    export import ActionCameraEnhance = __MaterialUI.ActionCameraEnhance; // require('material-ui/lib/svg-icon/action/camera-enhance');
    export import ActionCardGiftcard = __MaterialUI.ActionCardGiftcard; // require('material-ui/lib/svg-icon/action/card-giftcard');
    export import ActionCardMembership = __MaterialUI.ActionCardMembership; // require('material-ui/lib/svg-icon/action/card-membership');
    export import ActionCardTravel = __MaterialUI.ActionCardTravel; // require('material-ui/lib/svg-icon/action/card-travel');
    export import ActionChangeHistory = __MaterialUI.ActionChangeHistory; // require('material-ui/lib/svg-icon/action/change-history');
    export import ActionCheckCircle = __MaterialUI.ActionCheckCircle; // require('material-ui/lib/svg-icon/action/check-circle');
    export import ActionChromeReaderMode = __MaterialUI.ActionChromeReaderMode; // require('material-ui/lib/svg-icon/action/chrome-reader-mode');
    export import ActionClass = __MaterialUI.ActionClass; // require('material-ui/lib/svg-icon/action/class');
    export import ActionCode = __MaterialUI.ActionCode; // require('material-ui/lib/svg-icon/action/code');
    export import ActionCompareArrows = __MaterialUI.ActionCompareArrows; // require('material-ui/lib/svg-icon/action/compare-arrows');
    export import ActionCopyright = __MaterialUI.ActionCopyright; // require('material-ui/lib/svg-icon/action/copyright');
    export import ActionCreditCard = __MaterialUI.ActionCreditCard; // require('material-ui/lib/svg-icon/action/credit-card');
    export import ActionDashboard = __MaterialUI.ActionDashboard; // require('material-ui/lib/svg-icon/action/dashboard');
    export import ActionDateRange = __MaterialUI.ActionDateRange; // require('material-ui/lib/svg-icon/action/date-range');
    export import ActionDelete = __MaterialUI.ActionDelete; // require('material-ui/lib/svg-icon/action/delete');
    export import ActionDescription = __MaterialUI.ActionDescription; // require('material-ui/lib/svg-icon/action/description');
    export import ActionDns = __MaterialUI.ActionDns; // require('material-ui/lib/svg-icon/action/dns');
    export import ActionDoneAll = __MaterialUI.ActionDoneAll; // require('material-ui/lib/svg-icon/action/done-all');
    export import ActionDone = __MaterialUI.ActionDone; // require('material-ui/lib/svg-icon/action/done');
    export import ActionDonutLarge = __MaterialUI.ActionDonutLarge; // require('material-ui/lib/svg-icon/action/donut-large');
    export import ActionDonutSmall = __MaterialUI.ActionDonutSmall; // require('material-ui/lib/svg-icon/action/donut-small');
    export import ActionEject = __MaterialUI.ActionEject; // require('material-ui/lib/svg-icon/action/eject');
    export import ActionEvent = __MaterialUI.ActionEvent; // require('material-ui/lib/svg-icon/action/event');
    export import ActionEventSeat = __MaterialUI.ActionEventSeat; // require('material-ui/lib/svg-icon/action/event-seat');
    export import ActionExitToApp = __MaterialUI.ActionExitToApp; // require('material-ui/lib/svg-icon/action/exit-to-app');
    export import ActionExplore = __MaterialUI.ActionExplore; // require('material-ui/lib/svg-icon/action/explore');
    export import ActionExtension = __MaterialUI.ActionExtension; // require('material-ui/lib/svg-icon/action/extension');
    export import ActionFace = __MaterialUI.ActionFace; // require('material-ui/lib/svg-icon/action/face');
    export import ActionFavoriteBorder = __MaterialUI.ActionFavoriteBorder; // require('material-ui/lib/svg-icon/action/favorite-border');
    export import ActionFavorite = __MaterialUI.ActionFavorite; // require('material-ui/lib/svg-icon/action/favorite');
    export import ActionFeedback = __MaterialUI.ActionFeedback; // require('material-ui/lib/svg-icon/action/feedback');
    export import ActionFindInPage = __MaterialUI.ActionFindInPage; // require('material-ui/lib/svg-icon/action/find-in-page');
    export import ActionFindReplace = __MaterialUI.ActionFindReplace; // require('material-ui/lib/svg-icon/action/find-replace');
    export import ActionFingerprint = __MaterialUI.ActionFingerprint; // require('material-ui/lib/svg-icon/action/fingerprint');
    export import ActionFlightLand = __MaterialUI.ActionFlightLand; // require('material-ui/lib/svg-icon/action/flight-land');
    export import ActionFlightTakeoff = __MaterialUI.ActionFlightTakeoff; // require('material-ui/lib/svg-icon/action/flight-takeoff');
    export import ActionFlipToBack = __MaterialUI.ActionFlipToBack; // require('material-ui/lib/svg-icon/action/flip-to-back');
    export import ActionFlipToFront = __MaterialUI.ActionFlipToFront; // require('material-ui/lib/svg-icon/action/flip-to-front');
    export import ActionGavel = __MaterialUI.ActionGavel; // require('material-ui/lib/svg-icon/action/gavel');
    export import ActionGetApp = __MaterialUI.ActionGetApp; // require('material-ui/lib/svg-icon/action/get-app');
    export import ActionGif = __MaterialUI.ActionGif; // require('material-ui/lib/svg-icon/action/gif');
    export import ActionGrade = __MaterialUI.ActionGrade; // require('material-ui/lib/svg-icon/action/grade');
    export import ActionGroupWork = __MaterialUI.ActionGroupWork; // require('material-ui/lib/svg-icon/action/group-work');
    export import ActionHelp = __MaterialUI.ActionHelp; // require('material-ui/lib/svg-icon/action/help');
    export import ActionHelpOutline = __MaterialUI.ActionHelpOutline; // require('material-ui/lib/svg-icon/action/help-outline');
    export import ActionHighlightOff = __MaterialUI.ActionHighlightOff; // require('material-ui/lib/svg-icon/action/highlight-off');
    export import ActionHistory = __MaterialUI.ActionHistory; // require('material-ui/lib/svg-icon/action/history');
    export import ActionHome = __MaterialUI.ActionHome; // require('material-ui/lib/svg-icon/action/home');
    export import ActionHourglassEmpty = __MaterialUI.ActionHourglassEmpty; // require('material-ui/lib/svg-icon/action/hourglass-empty');
    export import ActionHourglassFull = __MaterialUI.ActionHourglassFull; // require('material-ui/lib/svg-icon/action/hourglass-full');
    export import ActionHttp = __MaterialUI.ActionHttp; // require('material-ui/lib/svg-icon/action/http');
    export import ActionHttps = __MaterialUI.ActionHttps; // require('material-ui/lib/svg-icon/action/https');
    export import ActionImportantDevices = __MaterialUI.ActionImportantDevices; // require('material-ui/lib/svg-icon/action/important-devices');
    export import ActionInfo = __MaterialUI.ActionInfo; // require('material-ui/lib/svg-icon/action/info');
    export import ActionInfoOutline = __MaterialUI.ActionInfoOutline; // require('material-ui/lib/svg-icon/action/info-outline');
    export import ActionInput = __MaterialUI.ActionInput; // require('material-ui/lib/svg-icon/action/input');
    export import ActionInvertColors = __MaterialUI.ActionInvertColors; // require('material-ui/lib/svg-icon/action/invert-colors');
    export import ActionLabel = __MaterialUI.ActionLabel; // require('material-ui/lib/svg-icon/action/label');
    export import ActionLabelOutline = __MaterialUI.ActionLabelOutline; // require('material-ui/lib/svg-icon/action/label-outline');
    export import ActionLanguage = __MaterialUI.ActionLanguage; // require('material-ui/lib/svg-icon/action/language');
    export import ActionLaunch = __MaterialUI.ActionLaunch; // require('material-ui/lib/svg-icon/action/launch');
    export import ActionLightbulbOutline = __MaterialUI.ActionLightbulbOutline; // require('material-ui/lib/svg-icon/action/lightbulb-outline');
    export import ActionLineStyle = __MaterialUI.ActionLineStyle; // require('material-ui/lib/svg-icon/action/line-style');
    export import ActionLineWeight = __MaterialUI.ActionLineWeight; // require('material-ui/lib/svg-icon/action/line-weight');
    export import ActionList = __MaterialUI.ActionList; // require('material-ui/lib/svg-icon/action/list');
    export import ActionLock = __MaterialUI.ActionLock; // require('material-ui/lib/svg-icon/action/lock');
    export import ActionLockOpen = __MaterialUI.ActionLockOpen; // require('material-ui/lib/svg-icon/action/lock-open');
    export import ActionLockOutline = __MaterialUI.ActionLockOutline; // require('material-ui/lib/svg-icon/action/lock-outline');
    export import ActionLoyalty = __MaterialUI.ActionLoyalty; // require('material-ui/lib/svg-icon/action/loyalty');
    export import ActionMarkunreadMailbox = __MaterialUI.ActionMarkunreadMailbox; // require('material-ui/lib/svg-icon/action/markunread-mailbox');
    export import ActionMotorcycle = __MaterialUI.ActionMotorcycle; // require('material-ui/lib/svg-icon/action/motorcycle');
    export import ActionNoteAdd = __MaterialUI.ActionNoteAdd; // require('material-ui/lib/svg-icon/action/note-add');
    export import ActionOfflinePin = __MaterialUI.ActionOfflinePin; // require('material-ui/lib/svg-icon/action/offline-pin');
    export import ActionOpacity = __MaterialUI.ActionOpacity; // require('material-ui/lib/svg-icon/action/opacity');
    export import ActionOpenInBrowser = __MaterialUI.ActionOpenInBrowser; // require('material-ui/lib/svg-icon/action/open-in-browser');
    export import ActionOpenInNew = __MaterialUI.ActionOpenInNew; // require('material-ui/lib/svg-icon/action/open-in-new');
    export import ActionOpenWith = __MaterialUI.ActionOpenWith; // require('material-ui/lib/svg-icon/action/open-with');
    export import ActionPageview = __MaterialUI.ActionPageview; // require('material-ui/lib/svg-icon/action/pageview');
    export import ActionPanTool = __MaterialUI.ActionPanTool; // require('material-ui/lib/svg-icon/action/pan-tool');
    export import ActionPayment = __MaterialUI.ActionPayment; // require('material-ui/lib/svg-icon/action/payment');
    export import ActionPermCameraMic = __MaterialUI.ActionPermCameraMic; // require('material-ui/lib/svg-icon/action/perm-camera-mic');
    export import ActionPermContactCalendar = __MaterialUI.ActionPermContactCalendar; // require('material-ui/lib/svg-icon/action/perm-contact-calendar');
    export import ActionPermDataSetting = __MaterialUI.ActionPermDataSetting; // require('material-ui/lib/svg-icon/action/perm-data-setting');
    export import ActionPermDeviceInformation = __MaterialUI.ActionPermDeviceInformation; // require('material-ui/lib/svg-icon/action/perm-device-information');
    export import ActionPermIdentity = __MaterialUI.ActionPermIdentity; // require('material-ui/lib/svg-icon/action/perm-identity');
    export import ActionPermMedia = __MaterialUI.ActionPermMedia; // require('material-ui/lib/svg-icon/action/perm-media');
    export import ActionPermPhoneMsg = __MaterialUI.ActionPermPhoneMsg; // require('material-ui/lib/svg-icon/action/perm-phone-msg');
    export import ActionPermScanWifi = __MaterialUI.ActionPermScanWifi; // require('material-ui/lib/svg-icon/action/perm-scan-wifi');
    export import ActionPets = __MaterialUI.ActionPets; // require('material-ui/lib/svg-icon/action/pets');
    export import ActionPictureInPictureAlt = __MaterialUI.ActionPictureInPictureAlt; // require('material-ui/lib/svg-icon/action/picture-in-picture-alt');
    export import ActionPictureInPicture = __MaterialUI.ActionPictureInPicture; // require('material-ui/lib/svg-icon/action/picture-in-picture');
    export import ActionPlayForWork = __MaterialUI.ActionPlayForWork; // require('material-ui/lib/svg-icon/action/play-for-work');
    export import ActionPolymer = __MaterialUI.ActionPolymer; // require('material-ui/lib/svg-icon/action/polymer');
    export import ActionPowerSettingsNew = __MaterialUI.ActionPowerSettingsNew; // require('material-ui/lib/svg-icon/action/power-settings-new');
    export import ActionPregnantWoman = __MaterialUI.ActionPregnantWoman; // require('material-ui/lib/svg-icon/action/pregnant-woman');
    export import ActionPrint = __MaterialUI.ActionPrint; // require('material-ui/lib/svg-icon/action/print');
    export import ActionQueryBuilder = __MaterialUI.ActionQueryBuilder; // require('material-ui/lib/svg-icon/action/query-builder');
    export import ActionQuestionAnswer = __MaterialUI.ActionQuestionAnswer; // require('material-ui/lib/svg-icon/action/question-answer');
    export import ActionReceipt = __MaterialUI.ActionReceipt; // require('material-ui/lib/svg-icon/action/receipt');
    export import ActionRecordVoiceOver = __MaterialUI.ActionRecordVoiceOver; // require('material-ui/lib/svg-icon/action/record-voice-over');
    export import ActionRedeem = __MaterialUI.ActionRedeem; // require('material-ui/lib/svg-icon/action/redeem');
    export import ActionReorder = __MaterialUI.ActionReorder; // require('material-ui/lib/svg-icon/action/reorder');
    export import ActionReportProblem = __MaterialUI.ActionReportProblem; // require('material-ui/lib/svg-icon/action/report-problem');
    export import ActionRestore = __MaterialUI.ActionRestore; // require('material-ui/lib/svg-icon/action/restore');
    export import ActionRoom = __MaterialUI.ActionRoom; // require('material-ui/lib/svg-icon/action/room');
    export import ActionRoundedCorner = __MaterialUI.ActionRoundedCorner; // require('material-ui/lib/svg-icon/action/rounded-corner');
    export import ActionRowing = __MaterialUI.ActionRowing; // require('material-ui/lib/svg-icon/action/rowing');
    export import ActionSchedule = __MaterialUI.ActionSchedule; // require('material-ui/lib/svg-icon/action/schedule');
    export import ActionSearch = __MaterialUI.ActionSearch; // require('material-ui/lib/svg-icon/action/search');
    export import ActionSettingsApplications = __MaterialUI.ActionSettingsApplications; // require('material-ui/lib/svg-icon/action/settings-applications');
    export import ActionSettingsBackupRestore = __MaterialUI.ActionSettingsBackupRestore; // require('material-ui/lib/svg-icon/action/settings-backup-restore');
    export import ActionSettingsBluetooth = __MaterialUI.ActionSettingsBluetooth; // require('material-ui/lib/svg-icon/action/settings-bluetooth');
    export import ActionSettingsBrightness = __MaterialUI.ActionSettingsBrightness; // require('material-ui/lib/svg-icon/action/settings-brightness');
    export import ActionSettingsCell = __MaterialUI.ActionSettingsCell; // require('material-ui/lib/svg-icon/action/settings-cell');
    export import ActionSettingsEthernet = __MaterialUI.ActionSettingsEthernet; // require('material-ui/lib/svg-icon/action/settings-ethernet');
    export import ActionSettingsInputAntenna = __MaterialUI.ActionSettingsInputAntenna; // require('material-ui/lib/svg-icon/action/settings-input-antenna');
    export import ActionSettingsInputComponent = __MaterialUI.ActionSettingsInputComponent; // require('material-ui/lib/svg-icon/action/settings-input-component');
    export import ActionSettingsInputComposite = __MaterialUI.ActionSettingsInputComposite; // require('material-ui/lib/svg-icon/action/settings-input-composite');
    export import ActionSettingsInputHdmi = __MaterialUI.ActionSettingsInputHdmi; // require('material-ui/lib/svg-icon/action/settings-input-hdmi');
    export import ActionSettingsInputSvideo = __MaterialUI.ActionSettingsInputSvideo; // require('material-ui/lib/svg-icon/action/settings-input-svideo');
    export import ActionSettings = __MaterialUI.ActionSettings; // require('material-ui/lib/svg-icon/action/settings');
    export import ActionSettingsOverscan = __MaterialUI.ActionSettingsOverscan; // require('material-ui/lib/svg-icon/action/settings-overscan');
    export import ActionSettingsPhone = __MaterialUI.ActionSettingsPhone; // require('material-ui/lib/svg-icon/action/settings-phone');
    export import ActionSettingsPower = __MaterialUI.ActionSettingsPower; // require('material-ui/lib/svg-icon/action/settings-power');
    export import ActionSettingsRemote = __MaterialUI.ActionSettingsRemote; // require('material-ui/lib/svg-icon/action/settings-remote');
    export import ActionSettingsVoice = __MaterialUI.ActionSettingsVoice; // require('material-ui/lib/svg-icon/action/settings-voice');
    export import ActionShop = __MaterialUI.ActionShop; // require('material-ui/lib/svg-icon/action/shop');
    export import ActionShoppingBasket = __MaterialUI.ActionShoppingBasket; // require('material-ui/lib/svg-icon/action/shopping-basket');
    export import ActionShoppingCart = __MaterialUI.ActionShoppingCart; // require('material-ui/lib/svg-icon/action/shopping-cart');
    export import ActionShopTwo = __MaterialUI.ActionShopTwo; // require('material-ui/lib/svg-icon/action/shop-two');
    export import ActionSpeakerNotes = __MaterialUI.ActionSpeakerNotes; // require('material-ui/lib/svg-icon/action/speaker-notes');
    export import ActionSpellcheck = __MaterialUI.ActionSpellcheck; // require('material-ui/lib/svg-icon/action/spellcheck');
    export import ActionStars = __MaterialUI.ActionStars; // require('material-ui/lib/svg-icon/action/stars');
    export import ActionStore = __MaterialUI.ActionStore; // require('material-ui/lib/svg-icon/action/store');
    export import ActionSubject = __MaterialUI.ActionSubject; // require('material-ui/lib/svg-icon/action/subject');
    export import ActionSupervisorAccount = __MaterialUI.ActionSupervisorAccount; // require('material-ui/lib/svg-icon/action/supervisor-account');
    export import ActionSwapHoriz = __MaterialUI.ActionSwapHoriz; // require('material-ui/lib/svg-icon/action/swap-horiz');
    export import ActionSwapVerticalCircle = __MaterialUI.ActionSwapVerticalCircle; // require('material-ui/lib/svg-icon/action/swap-vertical-circle');
    export import ActionSwapVert = __MaterialUI.ActionSwapVert; // require('material-ui/lib/svg-icon/action/swap-vert');
    export import ActionSystemUpdateAlt = __MaterialUI.ActionSystemUpdateAlt; // require('material-ui/lib/svg-icon/action/system-update-alt');
    export import ActionTab = __MaterialUI.ActionTab; // require('material-ui/lib/svg-icon/action/tab');
    export import ActionTabUnselected = __MaterialUI.ActionTabUnselected; // require('material-ui/lib/svg-icon/action/tab-unselected');
    export import ActionTheaters = __MaterialUI.ActionTheaters; // require('material-ui/lib/svg-icon/action/theaters');
    export import ActionThreeDRotation = __MaterialUI.ActionThreeDRotation; // require('material-ui/lib/svg-icon/action/three-d-rotation');
    export import ActionThumbDown = __MaterialUI.ActionThumbDown; // require('material-ui/lib/svg-icon/action/thumb-down');
    export import ActionThumbsUpDown = __MaterialUI.ActionThumbsUpDown; // require('material-ui/lib/svg-icon/action/thumbs-up-down');
    export import ActionThumbUp = __MaterialUI.ActionThumbUp; // require('material-ui/lib/svg-icon/action/thumb-up');
    export import ActionTimeline = __MaterialUI.ActionTimeline; // require('material-ui/lib/svg-icon/action/timeline');
    export import ActionToc = __MaterialUI.ActionToc; // require('material-ui/lib/svg-icon/action/toc');
    export import ActionToday = __MaterialUI.ActionToday; // require('material-ui/lib/svg-icon/action/today');
    export import ActionToll = __MaterialUI.ActionToll; // require('material-ui/lib/svg-icon/action/toll');
    export import ActionTouchApp = __MaterialUI.ActionTouchApp; // require('material-ui/lib/svg-icon/action/touch-app');
    export import ActionTrackChanges = __MaterialUI.ActionTrackChanges; // require('material-ui/lib/svg-icon/action/track-changes');
    export import ActionTranslate = __MaterialUI.ActionTranslate; // require('material-ui/lib/svg-icon/action/translate');
    export import ActionTrendingDown = __MaterialUI.ActionTrendingDown; // require('material-ui/lib/svg-icon/action/trending-down');
    export import ActionTrendingFlat = __MaterialUI.ActionTrendingFlat; // require('material-ui/lib/svg-icon/action/trending-flat');
    export import ActionTrendingUp = __MaterialUI.ActionTrendingUp; // require('material-ui/lib/svg-icon/action/trending-up');
    export import ActionTurnedIn = __MaterialUI.ActionTurnedIn; // require('material-ui/lib/svg-icon/action/turned-in');
    export import ActionTurnedInNot = __MaterialUI.ActionTurnedInNot; // require('material-ui/lib/svg-icon/action/turned-in-not');
    export import ActionUpdate = __MaterialUI.ActionUpdate; // require('material-ui/lib/svg-icon/action/update');
    export import ActionVerifiedUser = __MaterialUI.ActionVerifiedUser; // require('material-ui/lib/svg-icon/action/verified-user');
    export import ActionViewAgenda = __MaterialUI.ActionViewAgenda; // require('material-ui/lib/svg-icon/action/view-agenda');
    export import ActionViewArray = __MaterialUI.ActionViewArray; // require('material-ui/lib/svg-icon/action/view-array');
    export import ActionViewCarousel = __MaterialUI.ActionViewCarousel; // require('material-ui/lib/svg-icon/action/view-carousel');
    export import ActionViewColumn = __MaterialUI.ActionViewColumn; // require('material-ui/lib/svg-icon/action/view-column');
    export import ActionViewDay = __MaterialUI.ActionViewDay; // require('material-ui/lib/svg-icon/action/view-day');
    export import ActionViewHeadline = __MaterialUI.ActionViewHeadline; // require('material-ui/lib/svg-icon/action/view-headline');
    export import ActionViewList = __MaterialUI.ActionViewList; // require('material-ui/lib/svg-icon/action/view-list');
    export import ActionViewModule = __MaterialUI.ActionViewModule; // require('material-ui/lib/svg-icon/action/view-module');
    export import ActionViewQuilt = __MaterialUI.ActionViewQuilt; // require('material-ui/lib/svg-icon/action/view-quilt');
    export import ActionViewStream = __MaterialUI.ActionViewStream; // require('material-ui/lib/svg-icon/action/view-stream');
    export import ActionViewWeek = __MaterialUI.ActionViewWeek; // require('material-ui/lib/svg-icon/action/view-week');
    export import ActionVisibility = __MaterialUI.ActionVisibility; // require('material-ui/lib/svg-icon/action/visibility');
    export import ActionVisibilityOff = __MaterialUI.ActionVisibilityOff; // require('material-ui/lib/svg-icon/action/visibility-off');
    export import ActionWatchLater = __MaterialUI.ActionWatchLater; // require('material-ui/lib/svg-icon/action/watch-later');
    export import ActionWork = __MaterialUI.ActionWork; // require('material-ui/lib/svg-icon/action/work');
    export import ActionYoutubeSearchedFor = __MaterialUI.ActionYoutubeSearchedFor; // require('material-ui/lib/svg-icon/action/youtube-searched-for');
    export import ActionZoomIn = __MaterialUI.ActionZoomIn; // require('material-ui/lib/svg-icon/action/zoom-in');
    export import ActionZoomOut = __MaterialUI.ActionZoomOut; // require('material-ui/lib/svg-icon/action/zoom-out');
    export import AlertAddAlert = __MaterialUI.AlertAddAlert; // require('material-ui/lib/svg-icon/alert/add-alert');
    export import AlertError = __MaterialUI.AlertError; // require('material-ui/lib/svg-icon/alert/error');
    export import AlertErrorOutline = __MaterialUI.AlertErrorOutline; // require('material-ui/lib/svg-icon/alert/error-outline');
    export import AlertWarning = __MaterialUI.AlertWarning; // require('material-ui/lib/svg-icon/alert/warning');
    export import AvAddToQueue = __MaterialUI.AvAddToQueue; // require('material-ui/lib/svg-icon/av/add-to-queue');
    export import AvAirplay = __MaterialUI.AvAirplay; // require('material-ui/lib/svg-icon/av/airplay');
    export import AvAlbum = __MaterialUI.AvAlbum; // require('material-ui/lib/svg-icon/av/album');
    export import AvArtTrack = __MaterialUI.AvArtTrack; // require('material-ui/lib/svg-icon/av/art-track');
    export import AvAvTimer = __MaterialUI.AvAvTimer; // require('material-ui/lib/svg-icon/av/av-timer');
    export import AvClosedCaption = __MaterialUI.AvClosedCaption; // require('material-ui/lib/svg-icon/av/closed-caption');
    export import AvEqualizer = __MaterialUI.AvEqualizer; // require('material-ui/lib/svg-icon/av/equalizer');
    export import AvExplicit = __MaterialUI.AvExplicit; // require('material-ui/lib/svg-icon/av/explicit');
    export import AvFastForward = __MaterialUI.AvFastForward; // require('material-ui/lib/svg-icon/av/fast-forward');
    export import AvFastRewind = __MaterialUI.AvFastRewind; // require('material-ui/lib/svg-icon/av/fast-rewind');
    export import AvFiberDvr = __MaterialUI.AvFiberDvr; // require('material-ui/lib/svg-icon/av/fiber-dvr');
    export import AvFiberManualRecord = __MaterialUI.AvFiberManualRecord; // require('material-ui/lib/svg-icon/av/fiber-manual-record');
    export import AvFiberNew = __MaterialUI.AvFiberNew; // require('material-ui/lib/svg-icon/av/fiber-new');
    export import AvFiberPin = __MaterialUI.AvFiberPin; // require('material-ui/lib/svg-icon/av/fiber-pin');
    export import AvFiberSmartRecord = __MaterialUI.AvFiberSmartRecord; // require('material-ui/lib/svg-icon/av/fiber-smart-record');
    export import AvForward10 = __MaterialUI.AvForward10; // require('material-ui/lib/svg-icon/av/forward-10');
    export import AvForward30 = __MaterialUI.AvForward30; // require('material-ui/lib/svg-icon/av/forward-30');
    export import AvForward5 = __MaterialUI.AvForward5; // require('material-ui/lib/svg-icon/av/forward-5');
    export import AvGames = __MaterialUI.AvGames; // require('material-ui/lib/svg-icon/av/games');
    export import AvHd = __MaterialUI.AvHd; // require('material-ui/lib/svg-icon/av/hd');
    export import AvHearing = __MaterialUI.AvHearing; // require('material-ui/lib/svg-icon/av/hearing');
    export import AvHighQuality = __MaterialUI.AvHighQuality; // require('material-ui/lib/svg-icon/av/high-quality');
    export import AvLibraryAdd = __MaterialUI.AvLibraryAdd; // require('material-ui/lib/svg-icon/av/library-add');
    export import AvLibraryBooks = __MaterialUI.AvLibraryBooks; // require('material-ui/lib/svg-icon/av/library-books');
    export import AvLibraryMusic = __MaterialUI.AvLibraryMusic; // require('material-ui/lib/svg-icon/av/library-music');
    export import AvLoop = __MaterialUI.AvLoop; // require('material-ui/lib/svg-icon/av/loop');
    export import AvMic = __MaterialUI.AvMic; // require('material-ui/lib/svg-icon/av/mic');
    export import AvMicNone = __MaterialUI.AvMicNone; // require('material-ui/lib/svg-icon/av/mic-none');
    export import AvMicOff = __MaterialUI.AvMicOff; // require('material-ui/lib/svg-icon/av/mic-off');
    export import AvMovie = __MaterialUI.AvMovie; // require('material-ui/lib/svg-icon/av/movie');
    export import AvMusicVideo = __MaterialUI.AvMusicVideo; // require('material-ui/lib/svg-icon/av/music-video');
    export import AvNewReleases = __MaterialUI.AvNewReleases; // require('material-ui/lib/svg-icon/av/new-releases');
    export import AvNotInterested = __MaterialUI.AvNotInterested; // require('material-ui/lib/svg-icon/av/not-interested');
    export import AvPauseCircleFilled = __MaterialUI.AvPauseCircleFilled; // require('material-ui/lib/svg-icon/av/pause-circle-filled');
    export import AvPauseCircleOutline = __MaterialUI.AvPauseCircleOutline; // require('material-ui/lib/svg-icon/av/pause-circle-outline');
    export import AvPause = __MaterialUI.AvPause; // require('material-ui/lib/svg-icon/av/pause');
    export import AvPlayArrow = __MaterialUI.AvPlayArrow; // require('material-ui/lib/svg-icon/av/play-arrow');
    export import AvPlayCircleFilled = __MaterialUI.AvPlayCircleFilled; // require('material-ui/lib/svg-icon/av/play-circle-filled');
    export import AvPlayCircleOutline = __MaterialUI.AvPlayCircleOutline; // require('material-ui/lib/svg-icon/av/play-circle-outline');
    export import AvPlaylistAddCheck = __MaterialUI.AvPlaylistAddCheck; // require('material-ui/lib/svg-icon/av/playlist-add-check');
    export import AvPlaylistAdd = __MaterialUI.AvPlaylistAdd; // require('material-ui/lib/svg-icon/av/playlist-add');
    export import AvPlaylistPlay = __MaterialUI.AvPlaylistPlay; // require('material-ui/lib/svg-icon/av/playlist-play');
    export import AvQueue = __MaterialUI.AvQueue; // require('material-ui/lib/svg-icon/av/queue');
    export import AvQueueMusic = __MaterialUI.AvQueueMusic; // require('material-ui/lib/svg-icon/av/queue-music');
    export import AvQueuePlayNext = __MaterialUI.AvQueuePlayNext; // require('material-ui/lib/svg-icon/av/queue-play-next');
    export import AvRadio = __MaterialUI.AvRadio; // require('material-ui/lib/svg-icon/av/radio');
    export import AvRecentActors = __MaterialUI.AvRecentActors; // require('material-ui/lib/svg-icon/av/recent-actors');
    export import AvRemoveFromQueue = __MaterialUI.AvRemoveFromQueue; // require('material-ui/lib/svg-icon/av/remove-from-queue');
    export import AvRepeat = __MaterialUI.AvRepeat; // require('material-ui/lib/svg-icon/av/repeat');
    export import AvRepeatOne = __MaterialUI.AvRepeatOne; // require('material-ui/lib/svg-icon/av/repeat-one');
    export import AvReplay10 = __MaterialUI.AvReplay10; // require('material-ui/lib/svg-icon/av/replay-10');
    export import AvReplay30 = __MaterialUI.AvReplay30; // require('material-ui/lib/svg-icon/av/replay-30');
    export import AvReplay5 = __MaterialUI.AvReplay5; // require('material-ui/lib/svg-icon/av/replay-5');
    export import AvReplay = __MaterialUI.AvReplay; // require('material-ui/lib/svg-icon/av/replay');
    export import AvShuffle = __MaterialUI.AvShuffle; // require('material-ui/lib/svg-icon/av/shuffle');
    export import AvSkipNext = __MaterialUI.AvSkipNext; // require('material-ui/lib/svg-icon/av/skip-next');
    export import AvSkipPrevious = __MaterialUI.AvSkipPrevious; // require('material-ui/lib/svg-icon/av/skip-previous');
    export import AvSlowMotionVideo = __MaterialUI.AvSlowMotionVideo; // require('material-ui/lib/svg-icon/av/slow-motion-video');
    export import AvSnooze = __MaterialUI.AvSnooze; // require('material-ui/lib/svg-icon/av/snooze');
    export import AvSortByAlpha = __MaterialUI.AvSortByAlpha; // require('material-ui/lib/svg-icon/av/sort-by-alpha');
    export import AvStop = __MaterialUI.AvStop; // require('material-ui/lib/svg-icon/av/stop');
    export import AvSubscriptions = __MaterialUI.AvSubscriptions; // require('material-ui/lib/svg-icon/av/subscriptions');
    export import AvSubtitles = __MaterialUI.AvSubtitles; // require('material-ui/lib/svg-icon/av/subtitles');
    export import AvSurroundSound = __MaterialUI.AvSurroundSound; // require('material-ui/lib/svg-icon/av/surround-sound');
    export import AvVideocam = __MaterialUI.AvVideocam; // require('material-ui/lib/svg-icon/av/videocam');
    export import AvVideocamOff = __MaterialUI.AvVideocamOff; // require('material-ui/lib/svg-icon/av/videocam-off');
    export import AvVideoLibrary = __MaterialUI.AvVideoLibrary; // require('material-ui/lib/svg-icon/av/video-library');
    export import AvVolumeDown = __MaterialUI.AvVolumeDown; // require('material-ui/lib/svg-icon/av/volume-down');
    export import AvVolumeMute = __MaterialUI.AvVolumeMute; // require('material-ui/lib/svg-icon/av/volume-mute');
    export import AvVolumeOff = __MaterialUI.AvVolumeOff; // require('material-ui/lib/svg-icon/av/volume-off');
    export import AvVolumeUp = __MaterialUI.AvVolumeUp; // require('material-ui/lib/svg-icon/av/volume-up');
    export import AvWebAsset = __MaterialUI.AvWebAsset; // require('material-ui/lib/svg-icon/av/web-asset');
    export import AvWeb = __MaterialUI.AvWeb; // require('material-ui/lib/svg-icon/av/web');
    export import CommunicationBusiness = __MaterialUI.CommunicationBusiness; // require('material-ui/lib/svg-icon/communication/business');
    export import CommunicationCallEnd = __MaterialUI.CommunicationCallEnd; // require('material-ui/lib/svg-icon/communication/call-end');
    export import CommunicationCallMade = __MaterialUI.CommunicationCallMade; // require('material-ui/lib/svg-icon/communication/call-made');
    export import CommunicationCall = __MaterialUI.CommunicationCall; // require('material-ui/lib/svg-icon/communication/call');
    export import CommunicationCallMerge = __MaterialUI.CommunicationCallMerge; // require('material-ui/lib/svg-icon/communication/call-merge');
    export import CommunicationCallMissed = __MaterialUI.CommunicationCallMissed; // require('material-ui/lib/svg-icon/communication/call-missed');
    export import CommunicationCallMissedOutgoing = __MaterialUI.CommunicationCallMissedOutgoing; // require('material-ui/lib/svg-icon/communication/call-missed-outgoing');
    export import CommunicationCallReceived = __MaterialUI.CommunicationCallReceived; // require('material-ui/lib/svg-icon/communication/call-received');
    export import CommunicationCallSplit = __MaterialUI.CommunicationCallSplit; // require('material-ui/lib/svg-icon/communication/call-split');
    export import CommunicationChatBubble = __MaterialUI.CommunicationChatBubble; // require('material-ui/lib/svg-icon/communication/chat-bubble');
    export import CommunicationChatBubbleOutline = __MaterialUI.CommunicationChatBubbleOutline; // require('material-ui/lib/svg-icon/communication/chat-bubble-outline');
    export import CommunicationChat = __MaterialUI.CommunicationChat; // require('material-ui/lib/svg-icon/communication/chat');
    export import CommunicationClearAll = __MaterialUI.CommunicationClearAll; // require('material-ui/lib/svg-icon/communication/clear-all');
    export import CommunicationComment = __MaterialUI.CommunicationComment; // require('material-ui/lib/svg-icon/communication/comment');
    export import CommunicationContactMail = __MaterialUI.CommunicationContactMail; // require('material-ui/lib/svg-icon/communication/contact-mail');
    export import CommunicationContactPhone = __MaterialUI.CommunicationContactPhone; // require('material-ui/lib/svg-icon/communication/contact-phone');
    export import CommunicationContacts = __MaterialUI.CommunicationContacts; // require('material-ui/lib/svg-icon/communication/contacts');
    export import CommunicationDialerSip = __MaterialUI.CommunicationDialerSip; // require('material-ui/lib/svg-icon/communication/dialer-sip');
    export import CommunicationDialpad = __MaterialUI.CommunicationDialpad; // require('material-ui/lib/svg-icon/communication/dialpad');
    export import CommunicationEmail = __MaterialUI.CommunicationEmail; // require('material-ui/lib/svg-icon/communication/email');
    export import CommunicationForum = __MaterialUI.CommunicationForum; // require('material-ui/lib/svg-icon/communication/forum');
    export import CommunicationImportContacts = __MaterialUI.CommunicationImportContacts; // require('material-ui/lib/svg-icon/communication/import-contacts');
    export import CommunicationImportExport = __MaterialUI.CommunicationImportExport; // require('material-ui/lib/svg-icon/communication/import-export');
    export import CommunicationInvertColorsOff = __MaterialUI.CommunicationInvertColorsOff; // require('material-ui/lib/svg-icon/communication/invert-colors-off');
    export import CommunicationLiveHelp = __MaterialUI.CommunicationLiveHelp; // require('material-ui/lib/svg-icon/communication/live-help');
    export import CommunicationLocationOff = __MaterialUI.CommunicationLocationOff; // require('material-ui/lib/svg-icon/communication/location-off');
    export import CommunicationLocationOn = __MaterialUI.CommunicationLocationOn; // require('material-ui/lib/svg-icon/communication/location-on');
    export import CommunicationMailOutline = __MaterialUI.CommunicationMailOutline; // require('material-ui/lib/svg-icon/communication/mail-outline');
    export import CommunicationMessage = __MaterialUI.CommunicationMessage; // require('material-ui/lib/svg-icon/communication/message');
    export import CommunicationNoSim = __MaterialUI.CommunicationNoSim; // require('material-ui/lib/svg-icon/communication/no-sim');
    export import CommunicationPhonelinkErase = __MaterialUI.CommunicationPhonelinkErase; // require('material-ui/lib/svg-icon/communication/phonelink-erase');
    export import CommunicationPhonelinkLock = __MaterialUI.CommunicationPhonelinkLock; // require('material-ui/lib/svg-icon/communication/phonelink-lock');
    export import CommunicationPhonelinkRing = __MaterialUI.CommunicationPhonelinkRing; // require('material-ui/lib/svg-icon/communication/phonelink-ring');
    export import CommunicationPhonelinkSetup = __MaterialUI.CommunicationPhonelinkSetup; // require('material-ui/lib/svg-icon/communication/phonelink-setup');
    export import CommunicationPhone = __MaterialUI.CommunicationPhone; // require('material-ui/lib/svg-icon/communication/phone');
    export import CommunicationPortableWifiOff = __MaterialUI.CommunicationPortableWifiOff; // require('material-ui/lib/svg-icon/communication/portable-wifi-off');
    export import CommunicationPresentToAll = __MaterialUI.CommunicationPresentToAll; // require('material-ui/lib/svg-icon/communication/present-to-all');
    export import CommunicationRingVolume = __MaterialUI.CommunicationRingVolume; // require('material-ui/lib/svg-icon/communication/ring-volume');
    export import CommunicationScreenShare = __MaterialUI.CommunicationScreenShare; // require('material-ui/lib/svg-icon/communication/screen-share');
    export import CommunicationSpeakerPhone = __MaterialUI.CommunicationSpeakerPhone; // require('material-ui/lib/svg-icon/communication/speaker-phone');
    export import CommunicationStayCurrentLandscape = __MaterialUI.CommunicationStayCurrentLandscape; // require('material-ui/lib/svg-icon/communication/stay-current-landscape');
    export import CommunicationStayCurrentPortrait = __MaterialUI.CommunicationStayCurrentPortrait; // require('material-ui/lib/svg-icon/communication/stay-current-portrait');
    export import CommunicationStayPrimaryLandscape = __MaterialUI.CommunicationStayPrimaryLandscape; // require('material-ui/lib/svg-icon/communication/stay-primary-landscape');
    export import CommunicationStayPrimaryPortrait = __MaterialUI.CommunicationStayPrimaryPortrait; // require('material-ui/lib/svg-icon/communication/stay-primary-portrait');
    export import CommunicationStopScreenShare = __MaterialUI.CommunicationStopScreenShare; // require('material-ui/lib/svg-icon/communication/stop-screen-share');
    export import CommunicationSwapCalls = __MaterialUI.CommunicationSwapCalls; // require('material-ui/lib/svg-icon/communication/swap-calls');
    export import CommunicationTactMail = __MaterialUI.CommunicationTactMail; // require('material-ui/lib/svg-icon/communication/tact-mail');
    export import CommunicationTextsms = __MaterialUI.CommunicationTextsms; // require('material-ui/lib/svg-icon/communication/textsms');
    export import CommunicationVoicemail = __MaterialUI.CommunicationVoicemail; // require('material-ui/lib/svg-icon/communication/voicemail');
    export import CommunicationVpnKey = __MaterialUI.CommunicationVpnKey; // require('material-ui/lib/svg-icon/communication/vpn-key');
    export import ContentAddBox = __MaterialUI.ContentAddBox; // require('material-ui/lib/svg-icon/content/add-box');
    export import ContentAddCircle = __MaterialUI.ContentAddCircle; // require('material-ui/lib/svg-icon/content/add-circle');
    export import ContentAddCircleOutline = __MaterialUI.ContentAddCircleOutline; // require('material-ui/lib/svg-icon/content/add-circle-outline');
    export import ContentAdd = __MaterialUI.ContentAdd; // require('material-ui/lib/svg-icon/content/add');
    export import ContentArchive = __MaterialUI.ContentArchive; // require('material-ui/lib/svg-icon/content/archive');
    export import ContentBackspace = __MaterialUI.ContentBackspace; // require('material-ui/lib/svg-icon/content/backspace');
    export import ContentBlock = __MaterialUI.ContentBlock; // require('material-ui/lib/svg-icon/content/block');
    export import ContentClear = __MaterialUI.ContentClear; // require('material-ui/lib/svg-icon/content/clear');
    export import ContentContentCopy = __MaterialUI.ContentContentCopy; // require('material-ui/lib/svg-icon/content/content-copy');
    export import ContentContentCut = __MaterialUI.ContentContentCut; // require('material-ui/lib/svg-icon/content/content-cut');
    export import ContentContentPaste = __MaterialUI.ContentContentPaste; // require('material-ui/lib/svg-icon/content/content-paste');
    export import ContentCreate = __MaterialUI.ContentCreate; // require('material-ui/lib/svg-icon/content/create');
    export import ContentDrafts = __MaterialUI.ContentDrafts; // require('material-ui/lib/svg-icon/content/drafts');
    export import ContentFilterList = __MaterialUI.ContentFilterList; // require('material-ui/lib/svg-icon/content/filter-list');
    export import ContentFlag = __MaterialUI.ContentFlag; // require('material-ui/lib/svg-icon/content/flag');
    export import ContentFontDownload = __MaterialUI.ContentFontDownload; // require('material-ui/lib/svg-icon/content/font-download');
    export import ContentForward = __MaterialUI.ContentForward; // require('material-ui/lib/svg-icon/content/forward');
    export import ContentGesture = __MaterialUI.ContentGesture; // require('material-ui/lib/svg-icon/content/gesture');
    export import ContentInbox = __MaterialUI.ContentInbox; // require('material-ui/lib/svg-icon/content/inbox');
    export import ContentLink = __MaterialUI.ContentLink; // require('material-ui/lib/svg-icon/content/link');
    export import ContentMail = __MaterialUI.ContentMail; // require('material-ui/lib/svg-icon/content/mail');
    export import ContentMarkunread = __MaterialUI.ContentMarkunread; // require('material-ui/lib/svg-icon/content/markunread');
    export import ContentMoveToInbox = __MaterialUI.ContentMoveToInbox; // require('material-ui/lib/svg-icon/content/move-to-inbox');
    export import ContentNextWeek = __MaterialUI.ContentNextWeek; // require('material-ui/lib/svg-icon/content/next-week');
    export import ContentRedo = __MaterialUI.ContentRedo; // require('material-ui/lib/svg-icon/content/redo');
    export import ContentRemoveCircle = __MaterialUI.ContentRemoveCircle; // require('material-ui/lib/svg-icon/content/remove-circle');
    export import ContentRemoveCircleOutline = __MaterialUI.ContentRemoveCircleOutline; // require('material-ui/lib/svg-icon/content/remove-circle-outline');
    export import ContentRemove = __MaterialUI.ContentRemove; // require('material-ui/lib/svg-icon/content/remove');
    export import ContentReplyAll = __MaterialUI.ContentReplyAll; // require('material-ui/lib/svg-icon/content/reply-all');
    export import ContentReply = __MaterialUI.ContentReply; // require('material-ui/lib/svg-icon/content/reply');
    export import ContentReport = __MaterialUI.ContentReport; // require('material-ui/lib/svg-icon/content/report');
    export import ContentSave = __MaterialUI.ContentSave; // require('material-ui/lib/svg-icon/content/save');
    export import ContentSelectAll = __MaterialUI.ContentSelectAll; // require('material-ui/lib/svg-icon/content/select-all');
    export import ContentSend = __MaterialUI.ContentSend; // require('material-ui/lib/svg-icon/content/send');
    export import ContentSort = __MaterialUI.ContentSort; // require('material-ui/lib/svg-icon/content/sort');
    export import ContentTextFormat = __MaterialUI.ContentTextFormat; // require('material-ui/lib/svg-icon/content/text-format');
    export import ContentUnarchive = __MaterialUI.ContentUnarchive; // require('material-ui/lib/svg-icon/content/unarchive');
    export import ContentUndo = __MaterialUI.ContentUndo; // require('material-ui/lib/svg-icon/content/undo');
    export import ContentWeekend = __MaterialUI.ContentWeekend; // require('material-ui/lib/svg-icon/content/weekend');
    export import DeviceAccessAlarm = __MaterialUI.DeviceAccessAlarm; // require('material-ui/lib/svg-icon/device/access-alarm');
    export import DeviceAccessAlarms = __MaterialUI.DeviceAccessAlarms; // require('material-ui/lib/svg-icon/device/access-alarms');
    export import DeviceAccessTime = __MaterialUI.DeviceAccessTime; // require('material-ui/lib/svg-icon/device/access-time');
    export import DeviceAddAlarm = __MaterialUI.DeviceAddAlarm; // require('material-ui/lib/svg-icon/device/add-alarm');
    export import DeviceAirplanemodeActive = __MaterialUI.DeviceAirplanemodeActive; // require('material-ui/lib/svg-icon/device/airplanemode-active');
    export import DeviceAirplanemodeInactive = __MaterialUI.DeviceAirplanemodeInactive; // require('material-ui/lib/svg-icon/device/airplanemode-inactive');
    export import DeviceBattery20 = __MaterialUI.DeviceBattery20; // require('material-ui/lib/svg-icon/device/battery-20');
    export import DeviceBattery30 = __MaterialUI.DeviceBattery30; // require('material-ui/lib/svg-icon/device/battery-30');
    export import DeviceBattery50 = __MaterialUI.DeviceBattery50; // require('material-ui/lib/svg-icon/device/battery-50');
    export import DeviceBattery60 = __MaterialUI.DeviceBattery60; // require('material-ui/lib/svg-icon/device/battery-60');
    export import DeviceBattery80 = __MaterialUI.DeviceBattery80; // require('material-ui/lib/svg-icon/device/battery-80');
    export import DeviceBattery90 = __MaterialUI.DeviceBattery90; // require('material-ui/lib/svg-icon/device/battery-90');
    export import DeviceBatteryAlert = __MaterialUI.DeviceBatteryAlert; // require('material-ui/lib/svg-icon/device/battery-alert');
    export import DeviceBatteryCharging20 = __MaterialUI.DeviceBatteryCharging20; // require('material-ui/lib/svg-icon/device/battery-charging-20');
    export import DeviceBatteryCharging30 = __MaterialUI.DeviceBatteryCharging30; // require('material-ui/lib/svg-icon/device/battery-charging-30');
    export import DeviceBatteryCharging50 = __MaterialUI.DeviceBatteryCharging50; // require('material-ui/lib/svg-icon/device/battery-charging-50');
    export import DeviceBatteryCharging60 = __MaterialUI.DeviceBatteryCharging60; // require('material-ui/lib/svg-icon/device/battery-charging-60');
    export import DeviceBatteryCharging80 = __MaterialUI.DeviceBatteryCharging80; // require('material-ui/lib/svg-icon/device/battery-charging-80');
    export import DeviceBatteryCharging90 = __MaterialUI.DeviceBatteryCharging90; // require('material-ui/lib/svg-icon/device/battery-charging-90');
    export import DeviceBatteryChargingFull = __MaterialUI.DeviceBatteryChargingFull; // require('material-ui/lib/svg-icon/device/battery-charging-full');
    export import DeviceBatteryFull = __MaterialUI.DeviceBatteryFull; // require('material-ui/lib/svg-icon/device/battery-full');
    export import DeviceBatteryStd = __MaterialUI.DeviceBatteryStd; // require('material-ui/lib/svg-icon/device/battery-std');
    export import DeviceBatteryUnknown = __MaterialUI.DeviceBatteryUnknown; // require('material-ui/lib/svg-icon/device/battery-unknown');
    export import DeviceBluetoothConnected = __MaterialUI.DeviceBluetoothConnected; // require('material-ui/lib/svg-icon/device/bluetooth-connected');
    export import DeviceBluetoothDisabled = __MaterialUI.DeviceBluetoothDisabled; // require('material-ui/lib/svg-icon/device/bluetooth-disabled');
    export import DeviceBluetooth = __MaterialUI.DeviceBluetooth; // require('material-ui/lib/svg-icon/device/bluetooth');
    export import DeviceBluetoothSearching = __MaterialUI.DeviceBluetoothSearching; // require('material-ui/lib/svg-icon/device/bluetooth-searching');
    export import DeviceBrightnessAuto = __MaterialUI.DeviceBrightnessAuto; // require('material-ui/lib/svg-icon/device/brightness-auto');
    export import DeviceBrightnessHigh = __MaterialUI.DeviceBrightnessHigh; // require('material-ui/lib/svg-icon/device/brightness-high');
    export import DeviceBrightnessLow = __MaterialUI.DeviceBrightnessLow; // require('material-ui/lib/svg-icon/device/brightness-low');
    export import DeviceBrightnessMedium = __MaterialUI.DeviceBrightnessMedium; // require('material-ui/lib/svg-icon/device/brightness-medium');
    export import DeviceDataUsage = __MaterialUI.DeviceDataUsage; // require('material-ui/lib/svg-icon/device/data-usage');
    export import DeviceDeveloperMode = __MaterialUI.DeviceDeveloperMode; // require('material-ui/lib/svg-icon/device/developer-mode');
    export import DeviceDevices = __MaterialUI.DeviceDevices; // require('material-ui/lib/svg-icon/device/devices');
    export import DeviceDvr = __MaterialUI.DeviceDvr; // require('material-ui/lib/svg-icon/device/dvr');
    export import DeviceGpsFixed = __MaterialUI.DeviceGpsFixed; // require('material-ui/lib/svg-icon/device/gps-fixed');
    export import DeviceGpsNotFixed = __MaterialUI.DeviceGpsNotFixed; // require('material-ui/lib/svg-icon/device/gps-not-fixed');
    export import DeviceGpsOff = __MaterialUI.DeviceGpsOff; // require('material-ui/lib/svg-icon/device/gps-off');
    export import DeviceGraphicEq = __MaterialUI.DeviceGraphicEq; // require('material-ui/lib/svg-icon/device/graphic-eq');
    export import DeviceLocationDisabled = __MaterialUI.DeviceLocationDisabled; // require('material-ui/lib/svg-icon/device/location-disabled');
    export import DeviceLocationSearching = __MaterialUI.DeviceLocationSearching; // require('material-ui/lib/svg-icon/device/location-searching');
    export import DeviceNetworkCell = __MaterialUI.DeviceNetworkCell; // require('material-ui/lib/svg-icon/device/network-cell');
    export import DeviceNetworkWifi = __MaterialUI.DeviceNetworkWifi; // require('material-ui/lib/svg-icon/device/network-wifi');
    export import DeviceNfc = __MaterialUI.DeviceNfc; // require('material-ui/lib/svg-icon/device/nfc');
    export import DeviceScreenLockLandscape = __MaterialUI.DeviceScreenLockLandscape; // require('material-ui/lib/svg-icon/device/screen-lock-landscape');
    export import DeviceScreenLockPortrait = __MaterialUI.DeviceScreenLockPortrait; // require('material-ui/lib/svg-icon/device/screen-lock-portrait');
    export import DeviceScreenLockRotation = __MaterialUI.DeviceScreenLockRotation; // require('material-ui/lib/svg-icon/device/screen-lock-rotation');
    export import DeviceScreenRotation = __MaterialUI.DeviceScreenRotation; // require('material-ui/lib/svg-icon/device/screen-rotation');
    export import DeviceSdStorage = __MaterialUI.DeviceSdStorage; // require('material-ui/lib/svg-icon/device/sd-storage');
    export import DeviceSettingsSystemDaydream = __MaterialUI.DeviceSettingsSystemDaydream; // require('material-ui/lib/svg-icon/device/settings-system-daydream');
    export import DeviceSignalCellular0Bar = __MaterialUI.DeviceSignalCellular0Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-0-bar');
    export import DeviceSignalCellular1Bar = __MaterialUI.DeviceSignalCellular1Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-1-bar');
    export import DeviceSignalCellular2Bar = __MaterialUI.DeviceSignalCellular2Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-2-bar');
    export import DeviceSignalCellular3Bar = __MaterialUI.DeviceSignalCellular3Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-3-bar');
    export import DeviceSignalCellular4Bar = __MaterialUI.DeviceSignalCellular4Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-4-bar');
    export import DeviceSignalCellularConnectedNoInternet0Bar = __MaterialUI.DeviceSignalCellularConnectedNoInternet0Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-connected-no-internet-0-bar');
    export import DeviceSignalCellularConnectedNoInternet1Bar = __MaterialUI.DeviceSignalCellularConnectedNoInternet1Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-connected-no-internet-1-bar');
    export import DeviceSignalCellularConnectedNoInternet2Bar = __MaterialUI.DeviceSignalCellularConnectedNoInternet2Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-connected-no-internet-2-bar');
    export import DeviceSignalCellularConnectedNoInternet3Bar = __MaterialUI.DeviceSignalCellularConnectedNoInternet3Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-connected-no-internet-3-bar');
    export import DeviceSignalCellularConnectedNoInternet4Bar = __MaterialUI.DeviceSignalCellularConnectedNoInternet4Bar; // require('material-ui/lib/svg-icon/device/signal-cellular-connected-no-internet-4-bar');
    export import DeviceSignalCellularNoSim = __MaterialUI.DeviceSignalCellularNoSim; // require('material-ui/lib/svg-icon/device/signal-cellular-no-sim');
    export import DeviceSignalCellularNull = __MaterialUI.DeviceSignalCellularNull; // require('material-ui/lib/svg-icon/device/signal-cellular-null');
    export import DeviceSignalCellularOff = __MaterialUI.DeviceSignalCellularOff; // require('material-ui/lib/svg-icon/device/signal-cellular-off');
    export import DeviceSignalWifi0Bar = __MaterialUI.DeviceSignalWifi0Bar; // require('material-ui/lib/svg-icon/device/signal-wifi-0-bar');
    export import DeviceSignalWifi1BarLock = __MaterialUI.DeviceSignalWifi1BarLock; // require('material-ui/lib/svg-icon/device/signal-wifi-1-bar-lock');
    export import DeviceSignalWifi1Bar = __MaterialUI.DeviceSignalWifi1Bar; // require('material-ui/lib/svg-icon/device/signal-wifi-1-bar');
    export import DeviceSignalWifi2BarLock = __MaterialUI.DeviceSignalWifi2BarLock; // require('material-ui/lib/svg-icon/device/signal-wifi-2-bar-lock');
    export import DeviceSignalWifi2Bar = __MaterialUI.DeviceSignalWifi2Bar; // require('material-ui/lib/svg-icon/device/signal-wifi-2-bar');
    export import DeviceSignalWifi3BarLock = __MaterialUI.DeviceSignalWifi3BarLock; // require('material-ui/lib/svg-icon/device/signal-wifi-3-bar-lock');
    export import DeviceSignalWifi3Bar = __MaterialUI.DeviceSignalWifi3Bar; // require('material-ui/lib/svg-icon/device/signal-wifi-3-bar');
    export import DeviceSignalWifi4BarLock = __MaterialUI.DeviceSignalWifi4BarLock; // require('material-ui/lib/svg-icon/device/signal-wifi-4-bar-lock');
    export import DeviceSignalWifi4Bar = __MaterialUI.DeviceSignalWifi4Bar; // require('material-ui/lib/svg-icon/device/signal-wifi-4-bar');
    export import DeviceSignalWifiOff = __MaterialUI.DeviceSignalWifiOff; // require('material-ui/lib/svg-icon/device/signal-wifi-off');
    export import DeviceStorage = __MaterialUI.DeviceStorage; // require('material-ui/lib/svg-icon/device/storage');
    export import DeviceUsb = __MaterialUI.DeviceUsb; // require('material-ui/lib/svg-icon/device/usb');
    export import DeviceWallpaper = __MaterialUI.DeviceWallpaper; // require('material-ui/lib/svg-icon/device/wallpaper');
    export import DeviceWidgets = __MaterialUI.DeviceWidgets; // require('material-ui/lib/svg-icon/device/widgets');
    export import DeviceWifiLock = __MaterialUI.DeviceWifiLock; // require('material-ui/lib/svg-icon/device/wifi-lock');
    export import DeviceWifiTethering = __MaterialUI.DeviceWifiTethering; // require('material-ui/lib/svg-icon/device/wifi-tethering');
    export import EditorAttachFile = __MaterialUI.EditorAttachFile; // require('material-ui/lib/svg-icon/editor/attach-file');
    export import EditorAttachMoney = __MaterialUI.EditorAttachMoney; // require('material-ui/lib/svg-icon/editor/attach-money');
    export import EditorBorderAll = __MaterialUI.EditorBorderAll; // require('material-ui/lib/svg-icon/editor/border-all');
    export import EditorBorderBottom = __MaterialUI.EditorBorderBottom; // require('material-ui/lib/svg-icon/editor/border-bottom');
    export import EditorBorderClear = __MaterialUI.EditorBorderClear; // require('material-ui/lib/svg-icon/editor/border-clear');
    export import EditorBorderColor = __MaterialUI.EditorBorderColor; // require('material-ui/lib/svg-icon/editor/border-color');
    export import EditorBorderHorizontal = __MaterialUI.EditorBorderHorizontal; // require('material-ui/lib/svg-icon/editor/border-horizontal');
    export import EditorBorderInner = __MaterialUI.EditorBorderInner; // require('material-ui/lib/svg-icon/editor/border-inner');
    export import EditorBorderLeft = __MaterialUI.EditorBorderLeft; // require('material-ui/lib/svg-icon/editor/border-left');
    export import EditorBorderOuter = __MaterialUI.EditorBorderOuter; // require('material-ui/lib/svg-icon/editor/border-outer');
    export import EditorBorderRight = __MaterialUI.EditorBorderRight; // require('material-ui/lib/svg-icon/editor/border-right');
    export import EditorBorderStyle = __MaterialUI.EditorBorderStyle; // require('material-ui/lib/svg-icon/editor/border-style');
    export import EditorBorderTop = __MaterialUI.EditorBorderTop; // require('material-ui/lib/svg-icon/editor/border-top');
    export import EditorBorderVertical = __MaterialUI.EditorBorderVertical; // require('material-ui/lib/svg-icon/editor/border-vertical');
    export import EditorDragHandle = __MaterialUI.EditorDragHandle; // require('material-ui/lib/svg-icon/editor/drag-handle');
    export import EditorFormatAlignCenter = __MaterialUI.EditorFormatAlignCenter; // require('material-ui/lib/svg-icon/editor/format-align-center');
    export import EditorFormatAlignJustify = __MaterialUI.EditorFormatAlignJustify; // require('material-ui/lib/svg-icon/editor/format-align-justify');
    export import EditorFormatAlignLeft = __MaterialUI.EditorFormatAlignLeft; // require('material-ui/lib/svg-icon/editor/format-align-left');
    export import EditorFormatAlignRight = __MaterialUI.EditorFormatAlignRight; // require('material-ui/lib/svg-icon/editor/format-align-right');
    export import EditorFormatBold = __MaterialUI.EditorFormatBold; // require('material-ui/lib/svg-icon/editor/format-bold');
    export import EditorFormatClear = __MaterialUI.EditorFormatClear; // require('material-ui/lib/svg-icon/editor/format-clear');
    export import EditorFormatColorFill = __MaterialUI.EditorFormatColorFill; // require('material-ui/lib/svg-icon/editor/format-color-fill');
    export import EditorFormatColorReset = __MaterialUI.EditorFormatColorReset; // require('material-ui/lib/svg-icon/editor/format-color-reset');
    export import EditorFormatColorText = __MaterialUI.EditorFormatColorText; // require('material-ui/lib/svg-icon/editor/format-color-text');
    export import EditorFormatIndentDecrease = __MaterialUI.EditorFormatIndentDecrease; // require('material-ui/lib/svg-icon/editor/format-indent-decrease');
    export import EditorFormatIndentIncrease = __MaterialUI.EditorFormatIndentIncrease; // require('material-ui/lib/svg-icon/editor/format-indent-increase');
    export import EditorFormatItalic = __MaterialUI.EditorFormatItalic; // require('material-ui/lib/svg-icon/editor/format-italic');
    export import EditorFormatLineSpacing = __MaterialUI.EditorFormatLineSpacing; // require('material-ui/lib/svg-icon/editor/format-line-spacing');
    export import EditorFormatListBulleted = __MaterialUI.EditorFormatListBulleted; // require('material-ui/lib/svg-icon/editor/format-list-bulleted');
    export import EditorFormatListNumbered = __MaterialUI.EditorFormatListNumbered; // require('material-ui/lib/svg-icon/editor/format-list-numbered');
    export import EditorFormatPaint = __MaterialUI.EditorFormatPaint; // require('material-ui/lib/svg-icon/editor/format-paint');
    export import EditorFormatQuote = __MaterialUI.EditorFormatQuote; // require('material-ui/lib/svg-icon/editor/format-quote');
    export import EditorFormatShapes = __MaterialUI.EditorFormatShapes; // require('material-ui/lib/svg-icon/editor/format-shapes');
    export import EditorFormatSize = __MaterialUI.EditorFormatSize; // require('material-ui/lib/svg-icon/editor/format-size');
    export import EditorFormatStrikethrough = __MaterialUI.EditorFormatStrikethrough; // require('material-ui/lib/svg-icon/editor/format-strikethrough');
    export import EditorFormatTextdirectionLToR = __MaterialUI.EditorFormatTextdirectionLToR; // require('material-ui/lib/svg-icon/editor/format-textdirection-l-to-r');
    export import EditorFormatTextdirectionRToL = __MaterialUI.EditorFormatTextdirectionRToL; // require('material-ui/lib/svg-icon/editor/format-textdirection-r-to-l');
    export import EditorFormatUnderlined = __MaterialUI.EditorFormatUnderlined; // require('material-ui/lib/svg-icon/editor/format-underlined');
    export import EditorFunctions = __MaterialUI.EditorFunctions; // require('material-ui/lib/svg-icon/editor/functions');
    export import EditorHighlight = __MaterialUI.EditorHighlight; // require('material-ui/lib/svg-icon/editor/highlight');
    export import EditorInsertChart = __MaterialUI.EditorInsertChart; // require('material-ui/lib/svg-icon/editor/insert-chart');
    export import EditorInsertComment = __MaterialUI.EditorInsertComment; // require('material-ui/lib/svg-icon/editor/insert-comment');
    export import EditorInsertDriveFile = __MaterialUI.EditorInsertDriveFile; // require('material-ui/lib/svg-icon/editor/insert-drive-file');
    export import EditorInsertEmoticon = __MaterialUI.EditorInsertEmoticon; // require('material-ui/lib/svg-icon/editor/insert-emoticon');
    export import EditorInsertInvitation = __MaterialUI.EditorInsertInvitation; // require('material-ui/lib/svg-icon/editor/insert-invitation');
    export import EditorInsertLink = __MaterialUI.EditorInsertLink; // require('material-ui/lib/svg-icon/editor/insert-link');
    export import EditorInsertPhoto = __MaterialUI.EditorInsertPhoto; // require('material-ui/lib/svg-icon/editor/insert-photo');
    export import EditorLinearScale = __MaterialUI.EditorLinearScale; // require('material-ui/lib/svg-icon/editor/linear-scale');
    export import EditorMergeType = __MaterialUI.EditorMergeType; // require('material-ui/lib/svg-icon/editor/merge-type');
    export import EditorModeComment = __MaterialUI.EditorModeComment; // require('material-ui/lib/svg-icon/editor/mode-comment');
    export import EditorModeEdit = __MaterialUI.EditorModeEdit; // require('material-ui/lib/svg-icon/editor/mode-edit');
    export import EditorMoneyOff = __MaterialUI.EditorMoneyOff; // require('material-ui/lib/svg-icon/editor/money-off');
    export import EditorPublish = __MaterialUI.EditorPublish; // require('material-ui/lib/svg-icon/editor/publish');
    export import EditorShortText = __MaterialUI.EditorShortText; // require('material-ui/lib/svg-icon/editor/short-text');
    export import EditorSpaceBar = __MaterialUI.EditorSpaceBar; // require('material-ui/lib/svg-icon/editor/space-bar');
    export import EditorStrikethroughS = __MaterialUI.EditorStrikethroughS; // require('material-ui/lib/svg-icon/editor/strikethrough-s');
    export import EditorTextFields = __MaterialUI.EditorTextFields; // require('material-ui/lib/svg-icon/editor/text-fields');
    export import EditorVerticalAlignBottom = __MaterialUI.EditorVerticalAlignBottom; // require('material-ui/lib/svg-icon/editor/vertical-align-bottom');
    export import EditorVerticalAlignCenter = __MaterialUI.EditorVerticalAlignCenter; // require('material-ui/lib/svg-icon/editor/vertical-align-center');
    export import EditorVerticalAlignTop = __MaterialUI.EditorVerticalAlignTop; // require('material-ui/lib/svg-icon/editor/vertical-align-top');
    export import EditorWrapText = __MaterialUI.EditorWrapText; // require('material-ui/lib/svg-icon/editor/wrap-text');
    export import FileAttachment = __MaterialUI.FileAttachment; // require('material-ui/lib/svg-icon/file/attachment');
    export import FileCloudCircle = __MaterialUI.FileCloudCircle; // require('material-ui/lib/svg-icon/file/cloud-circle');
    export import FileCloudDone = __MaterialUI.FileCloudDone; // require('material-ui/lib/svg-icon/file/cloud-done');
    export import FileCloudDownload = __MaterialUI.FileCloudDownload; // require('material-ui/lib/svg-icon/file/cloud-download');
    export import FileCloud = __MaterialUI.FileCloud; // require('material-ui/lib/svg-icon/file/cloud');
    export import FileCloudOff = __MaterialUI.FileCloudOff; // require('material-ui/lib/svg-icon/file/cloud-off');
    export import FileCloudQueue = __MaterialUI.FileCloudQueue; // require('material-ui/lib/svg-icon/file/cloud-queue');
    export import FileCloudUpload = __MaterialUI.FileCloudUpload; // require('material-ui/lib/svg-icon/file/cloud-upload');
    export import FileCreateNewFolder = __MaterialUI.FileCreateNewFolder; // require('material-ui/lib/svg-icon/file/create-new-folder');
    export import FileFileDownload = __MaterialUI.FileFileDownload; // require('material-ui/lib/svg-icon/file/file-download');
    export import FileFileUpload = __MaterialUI.FileFileUpload; // require('material-ui/lib/svg-icon/file/file-upload');
    export import FileFolder = __MaterialUI.FileFolder; // require('material-ui/lib/svg-icon/file/folder');
    export import FileFolderOpen = __MaterialUI.FileFolderOpen; // require('material-ui/lib/svg-icon/file/folder-open');
    export import FileFolderShared = __MaterialUI.FileFolderShared; // require('material-ui/lib/svg-icon/file/folder-shared');
    export import HardwareCastConnected = __MaterialUI.HardwareCastConnected; // require('material-ui/lib/svg-icon/hardware/cast-connected');
    export import HardwareCast = __MaterialUI.HardwareCast; // require('material-ui/lib/svg-icon/hardware/cast');
    export import HardwareComputer = __MaterialUI.HardwareComputer; // require('material-ui/lib/svg-icon/hardware/computer');
    export import HardwareDesktopMac = __MaterialUI.HardwareDesktopMac; // require('material-ui/lib/svg-icon/hardware/desktop-mac');
    export import HardwareDesktopWindows = __MaterialUI.HardwareDesktopWindows; // require('material-ui/lib/svg-icon/hardware/desktop-windows');
    export import HardwareDeveloperBoard = __MaterialUI.HardwareDeveloperBoard; // require('material-ui/lib/svg-icon/hardware/developer-board');
    export import HardwareDeviceHub = __MaterialUI.HardwareDeviceHub; // require('material-ui/lib/svg-icon/hardware/device-hub');
    export import HardwareDevicesOther = __MaterialUI.HardwareDevicesOther; // require('material-ui/lib/svg-icon/hardware/devices-other');
    export import HardwareDock = __MaterialUI.HardwareDock; // require('material-ui/lib/svg-icon/hardware/dock');
    export import HardwareGamepad = __MaterialUI.HardwareGamepad; // require('material-ui/lib/svg-icon/hardware/gamepad');
    export import HardwareHeadset = __MaterialUI.HardwareHeadset; // require('material-ui/lib/svg-icon/hardware/headset');
    export import HardwareHeadsetMic = __MaterialUI.HardwareHeadsetMic; // require('material-ui/lib/svg-icon/hardware/headset-mic');
    export import HardwareKeyboardArrowDown = __MaterialUI.HardwareKeyboardArrowDown; // require('material-ui/lib/svg-icon/hardware/keyboard-arrow-down');
    export import HardwareKeyboardArrowLeft = __MaterialUI.HardwareKeyboardArrowLeft; // require('material-ui/lib/svg-icon/hardware/keyboard-arrow-left');
    export import HardwareKeyboardArrowRight = __MaterialUI.HardwareKeyboardArrowRight; // require('material-ui/lib/svg-icon/hardware/keyboard-arrow-right');
    export import HardwareKeyboardArrowUp = __MaterialUI.HardwareKeyboardArrowUp; // require('material-ui/lib/svg-icon/hardware/keyboard-arrow-up');
    export import HardwareKeyboardBackspace = __MaterialUI.HardwareKeyboardBackspace; // require('material-ui/lib/svg-icon/hardware/keyboard-backspace');
    export import HardwareKeyboardCapslock = __MaterialUI.HardwareKeyboardCapslock; // require('material-ui/lib/svg-icon/hardware/keyboard-capslock');
    export import HardwareKeyboardHide = __MaterialUI.HardwareKeyboardHide; // require('material-ui/lib/svg-icon/hardware/keyboard-hide');
    export import HardwareKeyboard = __MaterialUI.HardwareKeyboard; // require('material-ui/lib/svg-icon/hardware/keyboard');
    export import HardwareKeyboardReturn = __MaterialUI.HardwareKeyboardReturn; // require('material-ui/lib/svg-icon/hardware/keyboard-return');
    export import HardwareKeyboardTab = __MaterialUI.HardwareKeyboardTab; // require('material-ui/lib/svg-icon/hardware/keyboard-tab');
    export import HardwareKeyboardVoice = __MaterialUI.HardwareKeyboardVoice; // require('material-ui/lib/svg-icon/hardware/keyboard-voice');
    export import HardwareLaptopChromebook = __MaterialUI.HardwareLaptopChromebook; // require('material-ui/lib/svg-icon/hardware/laptop-chromebook');
    export import HardwareLaptopMac = __MaterialUI.HardwareLaptopMac; // require('material-ui/lib/svg-icon/hardware/laptop-mac');
    export import HardwareLaptop = __MaterialUI.HardwareLaptop; // require('material-ui/lib/svg-icon/hardware/laptop');
    export import HardwareLaptopWindows = __MaterialUI.HardwareLaptopWindows; // require('material-ui/lib/svg-icon/hardware/laptop-windows');
    export import HardwareMemory = __MaterialUI.HardwareMemory; // require('material-ui/lib/svg-icon/hardware/memory');
    export import HardwareMouse = __MaterialUI.HardwareMouse; // require('material-ui/lib/svg-icon/hardware/mouse');
    export import HardwarePhoneAndroid = __MaterialUI.HardwarePhoneAndroid; // require('material-ui/lib/svg-icon/hardware/phone-android');
    export import HardwarePhoneIphone = __MaterialUI.HardwarePhoneIphone; // require('material-ui/lib/svg-icon/hardware/phone-iphone');
    export import HardwarePhonelink = __MaterialUI.HardwarePhonelink; // require('material-ui/lib/svg-icon/hardware/phonelink');
    export import HardwarePhonelinkOff = __MaterialUI.HardwarePhonelinkOff; // require('material-ui/lib/svg-icon/hardware/phonelink-off');
    export import HardwarePowerInput = __MaterialUI.HardwarePowerInput; // require('material-ui/lib/svg-icon/hardware/power-input');
    export import HardwareRouter = __MaterialUI.HardwareRouter; // require('material-ui/lib/svg-icon/hardware/router');
    export import HardwareScanner = __MaterialUI.HardwareScanner; // require('material-ui/lib/svg-icon/hardware/scanner');
    export import HardwareSecurity = __MaterialUI.HardwareSecurity; // require('material-ui/lib/svg-icon/hardware/security');
    export import HardwareSimCard = __MaterialUI.HardwareSimCard; // require('material-ui/lib/svg-icon/hardware/sim-card');
    export import HardwareSmartphone = __MaterialUI.HardwareSmartphone; // require('material-ui/lib/svg-icon/hardware/smartphone');
    export import HardwareSpeakerGroup = __MaterialUI.HardwareSpeakerGroup; // require('material-ui/lib/svg-icon/hardware/speaker-group');
    export import HardwareSpeaker = __MaterialUI.HardwareSpeaker; // require('material-ui/lib/svg-icon/hardware/speaker');
    export import HardwareTabletAndroid = __MaterialUI.HardwareTabletAndroid; // require('material-ui/lib/svg-icon/hardware/tablet-android');
    export import HardwareTabletMac = __MaterialUI.HardwareTabletMac; // require('material-ui/lib/svg-icon/hardware/tablet-mac');
    export import HardwareTablet = __MaterialUI.HardwareTablet; // require('material-ui/lib/svg-icon/hardware/tablet');
    export import HardwareToys = __MaterialUI.HardwareToys; // require('material-ui/lib/svg-icon/hardware/toys');
    export import HardwareTv = __MaterialUI.HardwareTv; // require('material-ui/lib/svg-icon/hardware/tv');
    export import HardwareVideogameAsset = __MaterialUI.HardwareVideogameAsset; // require('material-ui/lib/svg-icon/hardware/videogame-asset');
    export import HardwareWatch = __MaterialUI.HardwareWatch; // require('material-ui/lib/svg-icon/hardware/watch');
    export import ImageAddAPhoto = __MaterialUI.ImageAddAPhoto; // require('material-ui/lib/svg-icon/image/add-a-photo');
    export import ImageAddToPhotos = __MaterialUI.ImageAddToPhotos; // require('material-ui/lib/svg-icon/image/add-to-photos');
    export import ImageAdjust = __MaterialUI.ImageAdjust; // require('material-ui/lib/svg-icon/image/adjust');
    export import ImageAssistant = __MaterialUI.ImageAssistant; // require('material-ui/lib/svg-icon/image/assistant');
    export import ImageAssistantPhoto = __MaterialUI.ImageAssistantPhoto; // require('material-ui/lib/svg-icon/image/assistant-photo');
    export import ImageAudiotrack = __MaterialUI.ImageAudiotrack; // require('material-ui/lib/svg-icon/image/audiotrack');
    export import ImageBlurCircular = __MaterialUI.ImageBlurCircular; // require('material-ui/lib/svg-icon/image/blur-circular');
    export import ImageBlurLinear = __MaterialUI.ImageBlurLinear; // require('material-ui/lib/svg-icon/image/blur-linear');
    export import ImageBlurOff = __MaterialUI.ImageBlurOff; // require('material-ui/lib/svg-icon/image/blur-off');
    export import ImageBlurOn = __MaterialUI.ImageBlurOn; // require('material-ui/lib/svg-icon/image/blur-on');
    export import ImageBrightness1 = __MaterialUI.ImageBrightness1; // require('material-ui/lib/svg-icon/image/brightness-1');
    export import ImageBrightness2 = __MaterialUI.ImageBrightness2; // require('material-ui/lib/svg-icon/image/brightness-2');
    export import ImageBrightness3 = __MaterialUI.ImageBrightness3; // require('material-ui/lib/svg-icon/image/brightness-3');
    export import ImageBrightness4 = __MaterialUI.ImageBrightness4; // require('material-ui/lib/svg-icon/image/brightness-4');
    export import ImageBrightness5 = __MaterialUI.ImageBrightness5; // require('material-ui/lib/svg-icon/image/brightness-5');
    export import ImageBrightness6 = __MaterialUI.ImageBrightness6; // require('material-ui/lib/svg-icon/image/brightness-6');
    export import ImageBrightness7 = __MaterialUI.ImageBrightness7; // require('material-ui/lib/svg-icon/image/brightness-7');
    export import ImageBrokenImage = __MaterialUI.ImageBrokenImage; // require('material-ui/lib/svg-icon/image/broken-image');
    export import ImageBrush = __MaterialUI.ImageBrush; // require('material-ui/lib/svg-icon/image/brush');
    export import ImageCameraAlt = __MaterialUI.ImageCameraAlt; // require('material-ui/lib/svg-icon/image/camera-alt');
    export import ImageCameraFront = __MaterialUI.ImageCameraFront; // require('material-ui/lib/svg-icon/image/camera-front');
    export import ImageCamera = __MaterialUI.ImageCamera; // require('material-ui/lib/svg-icon/image/camera');
    export import ImageCameraRear = __MaterialUI.ImageCameraRear; // require('material-ui/lib/svg-icon/image/camera-rear');
    export import ImageCameraRoll = __MaterialUI.ImageCameraRoll; // require('material-ui/lib/svg-icon/image/camera-roll');
    export import ImageCenterFocusStrong = __MaterialUI.ImageCenterFocusStrong; // require('material-ui/lib/svg-icon/image/center-focus-strong');
    export import ImageCenterFocusWeak = __MaterialUI.ImageCenterFocusWeak; // require('material-ui/lib/svg-icon/image/center-focus-weak');
    export import ImageCollectionsBookmark = __MaterialUI.ImageCollectionsBookmark; // require('material-ui/lib/svg-icon/image/collections-bookmark');
    export import ImageCollections = __MaterialUI.ImageCollections; // require('material-ui/lib/svg-icon/image/collections');
    export import ImageColorize = __MaterialUI.ImageColorize; // require('material-ui/lib/svg-icon/image/colorize');
    export import ImageColorLens = __MaterialUI.ImageColorLens; // require('material-ui/lib/svg-icon/image/color-lens');
    export import ImageCompare = __MaterialUI.ImageCompare; // require('material-ui/lib/svg-icon/image/compare');
    export import ImageControlPointDuplicate = __MaterialUI.ImageControlPointDuplicate; // require('material-ui/lib/svg-icon/image/control-point-duplicate');
    export import ImageControlPoint = __MaterialUI.ImageControlPoint; // require('material-ui/lib/svg-icon/image/control-point');
    export import ImageCrop169 = __MaterialUI.ImageCrop169; // require('material-ui/lib/svg-icon/image/crop-16-9');
    export import ImageCrop32 = __MaterialUI.ImageCrop32; // require('material-ui/lib/svg-icon/image/crop-3-2');
    export import ImageCrop54 = __MaterialUI.ImageCrop54; // require('material-ui/lib/svg-icon/image/crop-5-4');
    export import ImageCrop75 = __MaterialUI.ImageCrop75; // require('material-ui/lib/svg-icon/image/crop-7-5');
    export import ImageCropDin = __MaterialUI.ImageCropDin; // require('material-ui/lib/svg-icon/image/crop-din');
    export import ImageCropFree = __MaterialUI.ImageCropFree; // require('material-ui/lib/svg-icon/image/crop-free');
    export import ImageCropLandscape = __MaterialUI.ImageCropLandscape; // require('material-ui/lib/svg-icon/image/crop-landscape');
    export import ImageCrop = __MaterialUI.ImageCrop; // require('material-ui/lib/svg-icon/image/crop');
    export import ImageCropOriginal = __MaterialUI.ImageCropOriginal; // require('material-ui/lib/svg-icon/image/crop-original');
    export import ImageCropPortrait = __MaterialUI.ImageCropPortrait; // require('material-ui/lib/svg-icon/image/crop-portrait');
    export import ImageCropRotate = __MaterialUI.ImageCropRotate; // require('material-ui/lib/svg-icon/image/crop-rotate');
    export import ImageCropSquare = __MaterialUI.ImageCropSquare; // require('material-ui/lib/svg-icon/image/crop-square');
    export import ImageDehaze = __MaterialUI.ImageDehaze; // require('material-ui/lib/svg-icon/image/dehaze');
    export import ImageDetails = __MaterialUI.ImageDetails; // require('material-ui/lib/svg-icon/image/details');
    export import ImageEdit = __MaterialUI.ImageEdit; // require('material-ui/lib/svg-icon/image/edit');
    export import ImageExposure = __MaterialUI.ImageExposure; // require('material-ui/lib/svg-icon/image/exposure');
    export import ImageExposureNeg1 = __MaterialUI.ImageExposureNeg1; // require('material-ui/lib/svg-icon/image/exposure-neg-1');
    export import ImageExposureNeg2 = __MaterialUI.ImageExposureNeg2; // require('material-ui/lib/svg-icon/image/exposure-neg-2');
    export import ImageExposurePlus1 = __MaterialUI.ImageExposurePlus1; // require('material-ui/lib/svg-icon/image/exposure-plus-1');
    export import ImageExposurePlus2 = __MaterialUI.ImageExposurePlus2; // require('material-ui/lib/svg-icon/image/exposure-plus-2');
    export import ImageExposureZero = __MaterialUI.ImageExposureZero; // require('material-ui/lib/svg-icon/image/exposure-zero');
    export import ImageFilter1 = __MaterialUI.ImageFilter1; // require('material-ui/lib/svg-icon/image/filter-1');
    export import ImageFilter2 = __MaterialUI.ImageFilter2; // require('material-ui/lib/svg-icon/image/filter-2');
    export import ImageFilter3 = __MaterialUI.ImageFilter3; // require('material-ui/lib/svg-icon/image/filter-3');
    export import ImageFilter4 = __MaterialUI.ImageFilter4; // require('material-ui/lib/svg-icon/image/filter-4');
    export import ImageFilter5 = __MaterialUI.ImageFilter5; // require('material-ui/lib/svg-icon/image/filter-5');
    export import ImageFilter6 = __MaterialUI.ImageFilter6; // require('material-ui/lib/svg-icon/image/filter-6');
    export import ImageFilter7 = __MaterialUI.ImageFilter7; // require('material-ui/lib/svg-icon/image/filter-7');
    export import ImageFilter8 = __MaterialUI.ImageFilter8; // require('material-ui/lib/svg-icon/image/filter-8');
    export import ImageFilter9 = __MaterialUI.ImageFilter9; // require('material-ui/lib/svg-icon/image/filter-9');
    export import ImageFilter9Plus = __MaterialUI.ImageFilter9Plus; // require('material-ui/lib/svg-icon/image/filter-9-plus');
    export import ImageFilterBAndW = __MaterialUI.ImageFilterBAndW; // require('material-ui/lib/svg-icon/image/filter-b-and-w');
    export import ImageFilterCenterFocus = __MaterialUI.ImageFilterCenterFocus; // require('material-ui/lib/svg-icon/image/filter-center-focus');
    export import ImageFilterDrama = __MaterialUI.ImageFilterDrama; // require('material-ui/lib/svg-icon/image/filter-drama');
    export import ImageFilterFrames = __MaterialUI.ImageFilterFrames; // require('material-ui/lib/svg-icon/image/filter-frames');
    export import ImageFilterHdr = __MaterialUI.ImageFilterHdr; // require('material-ui/lib/svg-icon/image/filter-hdr');
    export import ImageFilter = __MaterialUI.ImageFilter; // require('material-ui/lib/svg-icon/image/filter');
    export import ImageFilterNone = __MaterialUI.ImageFilterNone; // require('material-ui/lib/svg-icon/image/filter-none');
    export import ImageFilterTiltShift = __MaterialUI.ImageFilterTiltShift; // require('material-ui/lib/svg-icon/image/filter-tilt-shift');
    export import ImageFilterVintage = __MaterialUI.ImageFilterVintage; // require('material-ui/lib/svg-icon/image/filter-vintage');
    export import ImageFlare = __MaterialUI.ImageFlare; // require('material-ui/lib/svg-icon/image/flare');
    export import ImageFlashAuto = __MaterialUI.ImageFlashAuto; // require('material-ui/lib/svg-icon/image/flash-auto');
    export import ImageFlashOff = __MaterialUI.ImageFlashOff; // require('material-ui/lib/svg-icon/image/flash-off');
    export import ImageFlashOn = __MaterialUI.ImageFlashOn; // require('material-ui/lib/svg-icon/image/flash-on');
    export import ImageFlip = __MaterialUI.ImageFlip; // require('material-ui/lib/svg-icon/image/flip');
    export import ImageGradient = __MaterialUI.ImageGradient; // require('material-ui/lib/svg-icon/image/gradient');
    export import ImageGrain = __MaterialUI.ImageGrain; // require('material-ui/lib/svg-icon/image/grain');
    export import ImageGridOff = __MaterialUI.ImageGridOff; // require('material-ui/lib/svg-icon/image/grid-off');
    export import ImageGridOn = __MaterialUI.ImageGridOn; // require('material-ui/lib/svg-icon/image/grid-on');
    export import ImageHdrOff = __MaterialUI.ImageHdrOff; // require('material-ui/lib/svg-icon/image/hdr-off');
    export import ImageHdrOn = __MaterialUI.ImageHdrOn; // require('material-ui/lib/svg-icon/image/hdr-on');
    export import ImageHdrStrong = __MaterialUI.ImageHdrStrong; // require('material-ui/lib/svg-icon/image/hdr-strong');
    export import ImageHdrWeak = __MaterialUI.ImageHdrWeak; // require('material-ui/lib/svg-icon/image/hdr-weak');
    export import ImageHealing = __MaterialUI.ImageHealing; // require('material-ui/lib/svg-icon/image/healing');
    export import ImageImageAspectRatio = __MaterialUI.ImageImageAspectRatio; // require('material-ui/lib/svg-icon/image/image-aspect-ratio');
    export import ImageImage = __MaterialUI.ImageImage; // require('material-ui/lib/svg-icon/image/image');
    export import ImageIso = __MaterialUI.ImageIso; // require('material-ui/lib/svg-icon/image/iso');
    export import ImageLandscape = __MaterialUI.ImageLandscape; // require('material-ui/lib/svg-icon/image/landscape');
    export import ImageLeakAdd = __MaterialUI.ImageLeakAdd; // require('material-ui/lib/svg-icon/image/leak-add');
    export import ImageLeakRemove = __MaterialUI.ImageLeakRemove; // require('material-ui/lib/svg-icon/image/leak-remove');
    export import ImageLens = __MaterialUI.ImageLens; // require('material-ui/lib/svg-icon/image/lens');
    export import ImageLinkedCamera = __MaterialUI.ImageLinkedCamera; // require('material-ui/lib/svg-icon/image/linked-camera');
    export import ImageLooks3 = __MaterialUI.ImageLooks3; // require('material-ui/lib/svg-icon/image/looks-3');
    export import ImageLooks4 = __MaterialUI.ImageLooks4; // require('material-ui/lib/svg-icon/image/looks-4');
    export import ImageLooks5 = __MaterialUI.ImageLooks5; // require('material-ui/lib/svg-icon/image/looks-5');
    export import ImageLooks6 = __MaterialUI.ImageLooks6; // require('material-ui/lib/svg-icon/image/looks-6');
    export import ImageLooks = __MaterialUI.ImageLooks; // require('material-ui/lib/svg-icon/image/looks');
    export import ImageLooksOne = __MaterialUI.ImageLooksOne; // require('material-ui/lib/svg-icon/image/looks-one');
    export import ImageLooksTwo = __MaterialUI.ImageLooksTwo; // require('material-ui/lib/svg-icon/image/looks-two');
    export import ImageLoupe = __MaterialUI.ImageLoupe; // require('material-ui/lib/svg-icon/image/loupe');
    export import ImageMonochromePhotos = __MaterialUI.ImageMonochromePhotos; // require('material-ui/lib/svg-icon/image/monochrome-photos');
    export import ImageMovieCreation = __MaterialUI.ImageMovieCreation; // require('material-ui/lib/svg-icon/image/movie-creation');
    export import ImageMovieFilter = __MaterialUI.ImageMovieFilter; // require('material-ui/lib/svg-icon/image/movie-filter');
    export import ImageMusicNote = __MaterialUI.ImageMusicNote; // require('material-ui/lib/svg-icon/image/music-note');
    export import ImageNature = __MaterialUI.ImageNature; // require('material-ui/lib/svg-icon/image/nature');
    export import ImageNaturePeople = __MaterialUI.ImageNaturePeople; // require('material-ui/lib/svg-icon/image/nature-people');
    export import ImageNavigateBefore = __MaterialUI.ImageNavigateBefore; // require('material-ui/lib/svg-icon/image/navigate-before');
    export import ImageNavigateNext = __MaterialUI.ImageNavigateNext; // require('material-ui/lib/svg-icon/image/navigate-next');
    export import ImagePalette = __MaterialUI.ImagePalette; // require('material-ui/lib/svg-icon/image/palette');
    export import ImagePanoramaFishEye = __MaterialUI.ImagePanoramaFishEye; // require('material-ui/lib/svg-icon/image/panorama-fish-eye');
    export import ImagePanoramaHorizontal = __MaterialUI.ImagePanoramaHorizontal; // require('material-ui/lib/svg-icon/image/panorama-horizontal');
    export import ImagePanorama = __MaterialUI.ImagePanorama; // require('material-ui/lib/svg-icon/image/panorama');
    export import ImagePanoramaVertical = __MaterialUI.ImagePanoramaVertical; // require('material-ui/lib/svg-icon/image/panorama-vertical');
    export import ImagePanoramaWideAngle = __MaterialUI.ImagePanoramaWideAngle; // require('material-ui/lib/svg-icon/image/panorama-wide-angle');
    export import ImagePhotoAlbum = __MaterialUI.ImagePhotoAlbum; // require('material-ui/lib/svg-icon/image/photo-album');
    export import ImagePhotoCamera = __MaterialUI.ImagePhotoCamera; // require('material-ui/lib/svg-icon/image/photo-camera');
    export import ImagePhotoFilter = __MaterialUI.ImagePhotoFilter; // require('material-ui/lib/svg-icon/image/photo-filter');
    export import ImagePhotoLibrary = __MaterialUI.ImagePhotoLibrary; // require('material-ui/lib/svg-icon/image/photo-library');
    export import ImagePhoto = __MaterialUI.ImagePhoto; // require('material-ui/lib/svg-icon/image/photo');
    export import ImagePhotoSizeSelectActual = __MaterialUI.ImagePhotoSizeSelectActual; // require('material-ui/lib/svg-icon/image/photo-size-select-actual');
    export import ImagePhotoSizeSelectLarge = __MaterialUI.ImagePhotoSizeSelectLarge; // require('material-ui/lib/svg-icon/image/photo-size-select-large');
    export import ImagePhotoSizeSelectSmall = __MaterialUI.ImagePhotoSizeSelectSmall; // require('material-ui/lib/svg-icon/image/photo-size-select-small');
    export import ImagePictureAsPdf = __MaterialUI.ImagePictureAsPdf; // require('material-ui/lib/svg-icon/image/picture-as-pdf');
    export import ImagePortrait = __MaterialUI.ImagePortrait; // require('material-ui/lib/svg-icon/image/portrait');
    export import ImageRemoveRedEye = __MaterialUI.ImageRemoveRedEye; // require('material-ui/lib/svg-icon/image/remove-red-eye');
    export import ImageRotate90DegreesCcw = __MaterialUI.ImageRotate90DegreesCcw; // require('material-ui/lib/svg-icon/image/rotate-90-degrees-ccw');
    export import ImageRotateLeft = __MaterialUI.ImageRotateLeft; // require('material-ui/lib/svg-icon/image/rotate-left');
    export import ImageRotateRight = __MaterialUI.ImageRotateRight; // require('material-ui/lib/svg-icon/image/rotate-right');
    export import ImageSlideshow = __MaterialUI.ImageSlideshow; // require('material-ui/lib/svg-icon/image/slideshow');
    export import ImageStraighten = __MaterialUI.ImageStraighten; // require('material-ui/lib/svg-icon/image/straighten');
    export import ImageStyle = __MaterialUI.ImageStyle; // require('material-ui/lib/svg-icon/image/style');
    export import ImageSwitchCamera = __MaterialUI.ImageSwitchCamera; // require('material-ui/lib/svg-icon/image/switch-camera');
    export import ImageSwitchVideo = __MaterialUI.ImageSwitchVideo; // require('material-ui/lib/svg-icon/image/switch-video');
    export import ImageTagFaces = __MaterialUI.ImageTagFaces; // require('material-ui/lib/svg-icon/image/tag-faces');
    export import ImageTexture = __MaterialUI.ImageTexture; // require('material-ui/lib/svg-icon/image/texture');
    export import ImageTimelapse = __MaterialUI.ImageTimelapse; // require('material-ui/lib/svg-icon/image/timelapse');
    export import ImageTimer10 = __MaterialUI.ImageTimer10; // require('material-ui/lib/svg-icon/image/timer-10');
    export import ImageTimer3 = __MaterialUI.ImageTimer3; // require('material-ui/lib/svg-icon/image/timer-3');
    export import ImageTimer = __MaterialUI.ImageTimer; // require('material-ui/lib/svg-icon/image/timer');
    export import ImageTimerOff = __MaterialUI.ImageTimerOff; // require('material-ui/lib/svg-icon/image/timer-off');
    export import ImageTonality = __MaterialUI.ImageTonality; // require('material-ui/lib/svg-icon/image/tonality');
    export import ImageTransform = __MaterialUI.ImageTransform; // require('material-ui/lib/svg-icon/image/transform');
    export import ImageTune = __MaterialUI.ImageTune; // require('material-ui/lib/svg-icon/image/tune');
    export import ImageViewComfy = __MaterialUI.ImageViewComfy; // require('material-ui/lib/svg-icon/image/view-comfy');
    export import ImageViewCompact = __MaterialUI.ImageViewCompact; // require('material-ui/lib/svg-icon/image/view-compact');
    export import ImageVignette = __MaterialUI.ImageVignette; // require('material-ui/lib/svg-icon/image/vignette');
    export import ImageWbAuto = __MaterialUI.ImageWbAuto; // require('material-ui/lib/svg-icon/image/wb-auto');
    export import ImageWbCloudy = __MaterialUI.ImageWbCloudy; // require('material-ui/lib/svg-icon/image/wb-cloudy');
    export import ImageWbIncandescent = __MaterialUI.ImageWbIncandescent; // require('material-ui/lib/svg-icon/image/wb-incandescent');
    export import ImageWbIridescent = __MaterialUI.ImageWbIridescent; // require('material-ui/lib/svg-icon/image/wb-iridescent');
    export import ImageWbSunny = __MaterialUI.ImageWbSunny; // require('material-ui/lib/svg-icon/image/wb-sunny');
    export import IndexGenerator = __MaterialUI.IndexGenerator; // require('material-ui/lib/svg-icon/index-generator');
    export import Index = __MaterialUI.Index; // require('material-ui/lib/svg-icon/index');
    export import MapsAddLocation = __MaterialUI.MapsAddLocation; // require('material-ui/lib/svg-icon/maps/add-location');
    export import MapsBeenhere = __MaterialUI.MapsBeenhere; // require('material-ui/lib/svg-icon/maps/beenhere');
    export import MapsDirectionsBike = __MaterialUI.MapsDirectionsBike; // require('material-ui/lib/svg-icon/maps/directions-bike');
    export import MapsDirectionsBoat = __MaterialUI.MapsDirectionsBoat; // require('material-ui/lib/svg-icon/maps/directions-boat');
    export import MapsDirectionsBus = __MaterialUI.MapsDirectionsBus; // require('material-ui/lib/svg-icon/maps/directions-bus');
    export import MapsDirectionsCar = __MaterialUI.MapsDirectionsCar; // require('material-ui/lib/svg-icon/maps/directions-car');
    export import MapsDirections = __MaterialUI.MapsDirections; // require('material-ui/lib/svg-icon/maps/directions');
    export import MapsDirectionsRailway = __MaterialUI.MapsDirectionsRailway; // require('material-ui/lib/svg-icon/maps/directions-railway');
    export import MapsDirectionsRun = __MaterialUI.MapsDirectionsRun; // require('material-ui/lib/svg-icon/maps/directions-run');
    export import MapsDirectionsSubway = __MaterialUI.MapsDirectionsSubway; // require('material-ui/lib/svg-icon/maps/directions-subway');
    export import MapsDirectionsTransit = __MaterialUI.MapsDirectionsTransit; // require('material-ui/lib/svg-icon/maps/directions-transit');
    export import MapsDirectionsWalk = __MaterialUI.MapsDirectionsWalk; // require('material-ui/lib/svg-icon/maps/directions-walk');
    export import MapsEditLocation = __MaterialUI.MapsEditLocation; // require('material-ui/lib/svg-icon/maps/edit-location');
    export import MapsFlight = __MaterialUI.MapsFlight; // require('material-ui/lib/svg-icon/maps/flight');
    export import MapsHotel = __MaterialUI.MapsHotel; // require('material-ui/lib/svg-icon/maps/hotel');
    export import MapsLayersClear = __MaterialUI.MapsLayersClear; // require('material-ui/lib/svg-icon/maps/layers-clear');
    export import MapsLayers = __MaterialUI.MapsLayers; // require('material-ui/lib/svg-icon/maps/layers');
    export import MapsLocalActivity = __MaterialUI.MapsLocalActivity; // require('material-ui/lib/svg-icon/maps/local-activity');
    export import MapsLocalAirport = __MaterialUI.MapsLocalAirport; // require('material-ui/lib/svg-icon/maps/local-airport');
    export import MapsLocalAtm = __MaterialUI.MapsLocalAtm; // require('material-ui/lib/svg-icon/maps/local-atm');
    export import MapsLocalBar = __MaterialUI.MapsLocalBar; // require('material-ui/lib/svg-icon/maps/local-bar');
    export import MapsLocalCafe = __MaterialUI.MapsLocalCafe; // require('material-ui/lib/svg-icon/maps/local-cafe');
    export import MapsLocalCarWash = __MaterialUI.MapsLocalCarWash; // require('material-ui/lib/svg-icon/maps/local-car-wash');
    export import MapsLocalConvenienceStore = __MaterialUI.MapsLocalConvenienceStore; // require('material-ui/lib/svg-icon/maps/local-convenience-store');
    export import MapsLocalDining = __MaterialUI.MapsLocalDining; // require('material-ui/lib/svg-icon/maps/local-dining');
    export import MapsLocalDrink = __MaterialUI.MapsLocalDrink; // require('material-ui/lib/svg-icon/maps/local-drink');
    export import MapsLocalFlorist = __MaterialUI.MapsLocalFlorist; // require('material-ui/lib/svg-icon/maps/local-florist');
    export import MapsLocalGasStation = __MaterialUI.MapsLocalGasStation; // require('material-ui/lib/svg-icon/maps/local-gas-station');
    export import MapsLocalGroceryStore = __MaterialUI.MapsLocalGroceryStore; // require('material-ui/lib/svg-icon/maps/local-grocery-store');
    export import MapsLocalHospital = __MaterialUI.MapsLocalHospital; // require('material-ui/lib/svg-icon/maps/local-hospital');
    export import MapsLocalHotel = __MaterialUI.MapsLocalHotel; // require('material-ui/lib/svg-icon/maps/local-hotel');
    export import MapsLocalLaundryService = __MaterialUI.MapsLocalLaundryService; // require('material-ui/lib/svg-icon/maps/local-laundry-service');
    export import MapsLocalLibrary = __MaterialUI.MapsLocalLibrary; // require('material-ui/lib/svg-icon/maps/local-library');
    export import MapsLocalMall = __MaterialUI.MapsLocalMall; // require('material-ui/lib/svg-icon/maps/local-mall');
    export import MapsLocalMovies = __MaterialUI.MapsLocalMovies; // require('material-ui/lib/svg-icon/maps/local-movies');
    export import MapsLocalOffer = __MaterialUI.MapsLocalOffer; // require('material-ui/lib/svg-icon/maps/local-offer');
    export import MapsLocalParking = __MaterialUI.MapsLocalParking; // require('material-ui/lib/svg-icon/maps/local-parking');
    export import MapsLocalPharmacy = __MaterialUI.MapsLocalPharmacy; // require('material-ui/lib/svg-icon/maps/local-pharmacy');
    export import MapsLocalPhone = __MaterialUI.MapsLocalPhone; // require('material-ui/lib/svg-icon/maps/local-phone');
    export import MapsLocalPizza = __MaterialUI.MapsLocalPizza; // require('material-ui/lib/svg-icon/maps/local-pizza');
    export import MapsLocalPlay = __MaterialUI.MapsLocalPlay; // require('material-ui/lib/svg-icon/maps/local-play');
    export import MapsLocalPostOffice = __MaterialUI.MapsLocalPostOffice; // require('material-ui/lib/svg-icon/maps/local-post-office');
    export import MapsLocalPrintshop = __MaterialUI.MapsLocalPrintshop; // require('material-ui/lib/svg-icon/maps/local-printshop');
    export import MapsLocalSee = __MaterialUI.MapsLocalSee; // require('material-ui/lib/svg-icon/maps/local-see');
    export import MapsLocalShipping = __MaterialUI.MapsLocalShipping; // require('material-ui/lib/svg-icon/maps/local-shipping');
    export import MapsLocalTaxi = __MaterialUI.MapsLocalTaxi; // require('material-ui/lib/svg-icon/maps/local-taxi');
    export import MapsMap = __MaterialUI.MapsMap; // require('material-ui/lib/svg-icon/maps/map');
    export import MapsMyLocation = __MaterialUI.MapsMyLocation; // require('material-ui/lib/svg-icon/maps/my-location');
    export import MapsNavigation = __MaterialUI.MapsNavigation; // require('material-ui/lib/svg-icon/maps/navigation');
    export import MapsNearMe = __MaterialUI.MapsNearMe; // require('material-ui/lib/svg-icon/maps/near-me');
    export import MapsPersonPinCircle = __MaterialUI.MapsPersonPinCircle; // require('material-ui/lib/svg-icon/maps/person-pin-circle');
    export import MapsPersonPin = __MaterialUI.MapsPersonPin; // require('material-ui/lib/svg-icon/maps/person-pin');
    export import MapsPinDrop = __MaterialUI.MapsPinDrop; // require('material-ui/lib/svg-icon/maps/pin-drop');
    export import MapsPlace = __MaterialUI.MapsPlace; // require('material-ui/lib/svg-icon/maps/place');
    export import MapsRateReview = __MaterialUI.MapsRateReview; // require('material-ui/lib/svg-icon/maps/rate-review');
    export import MapsRestaurantMenu = __MaterialUI.MapsRestaurantMenu; // require('material-ui/lib/svg-icon/maps/restaurant-menu');
    export import MapsSatellite = __MaterialUI.MapsSatellite; // require('material-ui/lib/svg-icon/maps/satellite');
    export import MapsStoreMallDirectory = __MaterialUI.MapsStoreMallDirectory; // require('material-ui/lib/svg-icon/maps/store-mall-directory');
    export import MapsTerrain = __MaterialUI.MapsTerrain; // require('material-ui/lib/svg-icon/maps/terrain');
    export import MapsTraffic = __MaterialUI.MapsTraffic; // require('material-ui/lib/svg-icon/maps/traffic');
    export import MapsZoomOutMap = __MaterialUI.MapsZoomOutMap; // require('material-ui/lib/svg-icon/maps/zoom-out-map');
    export import NavigationApps = __MaterialUI.NavigationApps; // require('material-ui/lib/svg-icon/navigation/apps');
    export import NavigationArrowBack = __MaterialUI.NavigationArrowBack; // require('material-ui/lib/svg-icon/navigation/arrow-back');
    export import NavigationArrowDownward = __MaterialUI.NavigationArrowDownward; // require('material-ui/lib/svg-icon/navigation/arrow-downward');
    export import NavigationArrowDropDownCircle = __MaterialUI.NavigationArrowDropDownCircle; // require('material-ui/lib/svg-icon/navigation/arrow-drop-down-circle');
    export import NavigationArrowDropDown = __MaterialUI.NavigationArrowDropDown; // require('material-ui/lib/svg-icon/navigation/arrow-drop-down');
    export import NavigationArrowDropRight = __MaterialUI.NavigationArrowDropRight; // require('material-ui/lib/svg-icon/navigation-arrow-drop-right');
    export import NavigationArrowDropUp = __MaterialUI.NavigationArrowDropUp; // require('material-ui/lib/svg-icon/navigation/arrow-drop-up');
    export import NavigationArrowForward = __MaterialUI.NavigationArrowForward; // require('material-ui/lib/svg-icon/navigation/arrow-forward');
    export import NavigationArrowUpward = __MaterialUI.NavigationArrowUpward; // require('material-ui/lib/svg-icon/navigation/arrow-upward');
    export import NavigationCancel = __MaterialUI.NavigationCancel; // require('material-ui/lib/svg-icon/navigation/cancel');
    export import NavigationCheck = __MaterialUI.NavigationCheck; // require('material-ui/lib/svg-icon/navigation/check');
    export import NavigationChevronLeft = __MaterialUI.NavigationChevronLeft; // require('material-ui/lib/svg-icon/navigation/chevron-left');
    export import NavigationChevronRight = __MaterialUI.NavigationChevronRight; // require('material-ui/lib/svg-icon/navigation/chevron-right');
    export import NavigationClose = __MaterialUI.NavigationClose; // require('material-ui/lib/svg-icon/navigation/close');
    export import NavigationExpandLess = __MaterialUI.NavigationExpandLess; // require('material-ui/lib/svg-icon/navigation/expand-less');
    export import NavigationExpandMore = __MaterialUI.NavigationExpandMore; // require('material-ui/lib/svg-icon/navigation/expand-more');
    export import NavigationFullscreenExit = __MaterialUI.NavigationFullscreenExit; // require('material-ui/lib/svg-icon/navigation/fullscreen-exit');
    export import NavigationFullscreen = __MaterialUI.NavigationFullscreen; // require('material-ui/lib/svg-icon/navigation/fullscreen');
    export import NavigationMenu = __MaterialUI.NavigationMenu; // require('material-ui/lib/svg-icon/navigation/menu');
    export import NavigationMoreHoriz = __MaterialUI.NavigationMoreHoriz; // require('material-ui/lib/svg-icon/navigation/more-horiz');
    export import NavigationMoreVert = __MaterialUI.NavigationMoreVert; // require('material-ui/lib/svg-icon/navigation/more-vert');
    export import NavigationRefresh = __MaterialUI.NavigationRefresh; // require('material-ui/lib/svg-icon/navigation/refresh');
    export import NavigationSubdirectoryArrowLeft = __MaterialUI.NavigationSubdirectoryArrowLeft; // require('material-ui/lib/svg-icon/navigation/subdirectory-arrow-left');
    export import NavigationSubdirectoryArrowRight = __MaterialUI.NavigationSubdirectoryArrowRight; // require('material-ui/lib/svg-icon/navigation/subdirectory-arrow-right');
    export import NavigationUnfoldLess = __MaterialUI.NavigationUnfoldLess; // require('material-ui/lib/svg-icon/navigation/unfold-less');
    export import NavigationUnfoldMore = __MaterialUI.NavigationUnfoldMore; // require('material-ui/lib/svg-icon/navigation/unfold-more');
    export import NotificationAdb = __MaterialUI.NotificationAdb; // require('material-ui/lib/svg-icon/notification/adb');
    export import NotificationAirlineSeatFlatAngled = __MaterialUI.NotificationAirlineSeatFlatAngled; // require('material-ui/lib/svg-icon/notification/airline-seat-flat-angled');
    export import NotificationAirlineSeatFlat = __MaterialUI.NotificationAirlineSeatFlat; // require('material-ui/lib/svg-icon/notification/airline-seat-flat');
    export import NotificationAirlineSeatIndividualSuite = __MaterialUI.NotificationAirlineSeatIndividualSuite; // require('material-ui/lib/svg-icon/notification/airline-seat-individual-suite');
    export import NotificationAirlineSeatLegroomExtra = __MaterialUI.NotificationAirlineSeatLegroomExtra; // require('material-ui/lib/svg-icon/notification/airline-seat-legroom-extra');
    export import NotificationAirlineSeatLegroomNormal = __MaterialUI.NotificationAirlineSeatLegroomNormal; // require('material-ui/lib/svg-icon/notification/airline-seat-legroom-normal');
    export import NotificationAirlineSeatLegroomReduced = __MaterialUI.NotificationAirlineSeatLegroomReduced; // require('material-ui/lib/svg-icon/notification/airline-seat-legroom-reduced');
    export import NotificationAirlineSeatReclineExtra = __MaterialUI.NotificationAirlineSeatReclineExtra; // require('material-ui/lib/svg-icon/notification/airline-seat-recline-extra');
    export import NotificationAirlineSeatReclineNormal = __MaterialUI.NotificationAirlineSeatReclineNormal; // require('material-ui/lib/svg-icon/notification/airline-seat-recline-normal');
    export import NotificationBluetoothAudio = __MaterialUI.NotificationBluetoothAudio; // require('material-ui/lib/svg-icon/notification/bluetooth-audio');
    export import NotificationConfirmationNumber = __MaterialUI.NotificationConfirmationNumber; // require('material-ui/lib/svg-icon/notification/confirmation-number');
    export import NotificationDiscFull = __MaterialUI.NotificationDiscFull; // require('material-ui/lib/svg-icon/notification/disc-full');
    export import NotificationDoNotDisturbAlt = __MaterialUI.NotificationDoNotDisturbAlt; // require('material-ui/lib/svg-icon/notification/do-not-disturb-alt');
    export import NotificationDoNotDisturb = __MaterialUI.NotificationDoNotDisturb; // require('material-ui/lib/svg-icon/notification/do-not-disturb');
    export import NotificationDriveEta = __MaterialUI.NotificationDriveEta; // require('material-ui/lib/svg-icon/notification/drive-eta');
    export import NotificationEnhancedEncryption = __MaterialUI.NotificationEnhancedEncryption; // require('material-ui/lib/svg-icon/notification/enhanced-encryption');
    export import NotificationEventAvailable = __MaterialUI.NotificationEventAvailable; // require('material-ui/lib/svg-icon/notification/event-available');
    export import NotificationEventBusy = __MaterialUI.NotificationEventBusy; // require('material-ui/lib/svg-icon/notification/event-busy');
    export import NotificationEventNote = __MaterialUI.NotificationEventNote; // require('material-ui/lib/svg-icon/notification/event-note');
    export import NotificationFolderSpecial = __MaterialUI.NotificationFolderSpecial; // require('material-ui/lib/svg-icon/notification/folder-special');
    export import NotificationLiveTv = __MaterialUI.NotificationLiveTv; // require('material-ui/lib/svg-icon/notification/live-tv');
    export import NotificationMms = __MaterialUI.NotificationMms; // require('material-ui/lib/svg-icon/notification/mms');
    export import NotificationMore = __MaterialUI.NotificationMore; // require('material-ui/lib/svg-icon/notification/more');
    export import NotificationNetworkCheck = __MaterialUI.NotificationNetworkCheck; // require('material-ui/lib/svg-icon/notification/network-check');
    export import NotificationNetworkLocked = __MaterialUI.NotificationNetworkLocked; // require('material-ui/lib/svg-icon/notification/network-locked');
    export import NotificationNoEncryption = __MaterialUI.NotificationNoEncryption; // require('material-ui/lib/svg-icon/notification/no-encryption');
    export import NotificationOndemandVideo = __MaterialUI.NotificationOndemandVideo; // require('material-ui/lib/svg-icon/notification/ondemand-video');
    export import NotificationPersonalVideo = __MaterialUI.NotificationPersonalVideo; // require('material-ui/lib/svg-icon/notification/personal-video');
    export import NotificationPhoneBluetoothSpeaker = __MaterialUI.NotificationPhoneBluetoothSpeaker; // require('material-ui/lib/svg-icon/notification/phone-bluetooth-speaker');
    export import NotificationPhoneForwarded = __MaterialUI.NotificationPhoneForwarded; // require('material-ui/lib/svg-icon/notification/phone-forwarded');
    export import NotificationPhoneInTalk = __MaterialUI.NotificationPhoneInTalk; // require('material-ui/lib/svg-icon/notification/phone-in-talk');
    export import NotificationPhoneLocked = __MaterialUI.NotificationPhoneLocked; // require('material-ui/lib/svg-icon/notification/phone-locked');
    export import NotificationPhoneMissed = __MaterialUI.NotificationPhoneMissed; // require('material-ui/lib/svg-icon/notification/phone-missed');
    export import NotificationPhonePaused = __MaterialUI.NotificationPhonePaused; // require('material-ui/lib/svg-icon/notification/phone-paused');
    export import NotificationPower = __MaterialUI.NotificationPower; // require('material-ui/lib/svg-icon/notification/power');
    export import NotificationRvHookup = __MaterialUI.NotificationRvHookup; // require('material-ui/lib/svg-icon/notification/rv-hookup');
    export import NotificationSdCard = __MaterialUI.NotificationSdCard; // require('material-ui/lib/svg-icon/notification/sd-card');
    export import NotificationSimCardAlert = __MaterialUI.NotificationSimCardAlert; // require('material-ui/lib/svg-icon/notification/sim-card-alert');
    export import NotificationSmsFailed = __MaterialUI.NotificationSmsFailed; // require('material-ui/lib/svg-icon/notification/sms-failed');
    export import NotificationSms = __MaterialUI.NotificationSms; // require('material-ui/lib/svg-icon/notification/sms');
    export import NotificationSyncDisabled = __MaterialUI.NotificationSyncDisabled; // require('material-ui/lib/svg-icon/notification/sync-disabled');
    export import NotificationSync = __MaterialUI.NotificationSync; // require('material-ui/lib/svg-icon/notification/sync');
    export import NotificationSyncProblem = __MaterialUI.NotificationSyncProblem; // require('material-ui/lib/svg-icon/notification/sync-problem');
    export import NotificationSystemUpdate = __MaterialUI.NotificationSystemUpdate; // require('material-ui/lib/svg-icon/notification/system-update');
    export import NotificationTapAndPlay = __MaterialUI.NotificationTapAndPlay; // require('material-ui/lib/svg-icon/notification/tap-and-play');
    export import NotificationTimeToLeave = __MaterialUI.NotificationTimeToLeave; // require('material-ui/lib/svg-icon/notification/time-to-leave');
    export import NotificationVibration = __MaterialUI.NotificationVibration; // require('material-ui/lib/svg-icon/notification/vibration');
    export import NotificationVoiceChat = __MaterialUI.NotificationVoiceChat; // require('material-ui/lib/svg-icon/notification/voice-chat');
    export import NotificationVpnLock = __MaterialUI.NotificationVpnLock; // require('material-ui/lib/svg-icon/notification/vpn-lock');
    export import NotificationWc = __MaterialUI.NotificationWc; // require('material-ui/lib/svg-icon/notification/wc');
    export import NotificationWifi = __MaterialUI.NotificationWifi; // require('material-ui/lib/svg-icon/notification/wifi');
    export import PlacesAcUnit = __MaterialUI.PlacesAcUnit; // require('material-ui/lib/svg-icon/places/ac-unit');
    export import PlacesAirportShuttle = __MaterialUI.PlacesAirportShuttle; // require('material-ui/lib/svg-icon/places/airport-shuttle');
    export import PlacesAllInclusive = __MaterialUI.PlacesAllInclusive; // require('material-ui/lib/svg-icon/places/all-inclusive');
    export import PlacesBeachAccess = __MaterialUI.PlacesBeachAccess; // require('material-ui/lib/svg-icon/places/beach-access');
    export import PlacesBusinessCenter = __MaterialUI.PlacesBusinessCenter; // require('material-ui/lib/svg-icon/places/business-center');
    export import PlacesCasino = __MaterialUI.PlacesCasino; // require('material-ui/lib/svg-icon/places/casino');
    export import PlacesChildCare = __MaterialUI.PlacesChildCare; // require('material-ui/lib/svg-icon/places/child-care');
    export import PlacesChildFriendly = __MaterialUI.PlacesChildFriendly; // require('material-ui/lib/svg-icon/places/child-friendly');
    export import PlacesFitnessCenter = __MaterialUI.PlacesFitnessCenter; // require('material-ui/lib/svg-icon/places/fitness-center');
    export import PlacesFreeBreakfast = __MaterialUI.PlacesFreeBreakfast; // require('material-ui/lib/svg-icon/places/free-breakfast');
    export import PlacesGolfCourse = __MaterialUI.PlacesGolfCourse; // require('material-ui/lib/svg-icon/places/golf-course');
    export import PlacesHotTub = __MaterialUI.PlacesHotTub; // require('material-ui/lib/svg-icon/places/hot-tub');
    export import PlacesKitchen = __MaterialUI.PlacesKitchen; // require('material-ui/lib/svg-icon/places/kitchen');
    export import PlacesPool = __MaterialUI.PlacesPool; // require('material-ui/lib/svg-icon/places/pool');
    export import PlacesRoomService = __MaterialUI.PlacesRoomService; // require('material-ui/lib/svg-icon/places/room-service');
    export import PlacesSmokeFree = __MaterialUI.PlacesSmokeFree; // require('material-ui/lib/svg-icon/places/smoke-free');
    export import PlacesSmokingRooms = __MaterialUI.PlacesSmokingRooms; // require('material-ui/lib/svg-icon/places/smoking-rooms');
    export import PlacesSpa = __MaterialUI.PlacesSpa; // require('material-ui/lib/svg-icon/places/spa');
    export import SocialCake = __MaterialUI.SocialCake; // require('material-ui/lib/svg-icon/social/cake');
    export import SocialDomain = __MaterialUI.SocialDomain; // require('material-ui/lib/svg-icon/social/domain');
    export import SocialGroupAdd = __MaterialUI.SocialGroupAdd; // require('material-ui/lib/svg-icon/social/group-add');
    export import SocialGroup = __MaterialUI.SocialGroup; // require('material-ui/lib/svg-icon/social/group');
    export import SocialLocationCity = __MaterialUI.SocialLocationCity; // require('material-ui/lib/svg-icon/social/location-city');
    export import SocialMoodBad = __MaterialUI.SocialMoodBad; // require('material-ui/lib/svg-icon/social/mood-bad');
    export import SocialMood = __MaterialUI.SocialMood; // require('material-ui/lib/svg-icon/social/mood');
    export import SocialNotificationsActive = __MaterialUI.SocialNotificationsActive; // require('material-ui/lib/svg-icon/social/notifications-active');
    export import SocialNotifications = __MaterialUI.SocialNotifications; // require('material-ui/lib/svg-icon/social/notifications');
    export import SocialNotificationsNone = __MaterialUI.SocialNotificationsNone; // require('material-ui/lib/svg-icon/social/notifications-none');
    export import SocialNotificationsOff = __MaterialUI.SocialNotificationsOff; // require('material-ui/lib/svg-icon/social/notifications-off');
    export import SocialNotificationsPaused = __MaterialUI.SocialNotificationsPaused; // require('material-ui/lib/svg-icon/social/notifications-paused');
    export import SocialPages = __MaterialUI.SocialPages; // require('material-ui/lib/svg-icon/social/pages');
    export import SocialPartyMode = __MaterialUI.SocialPartyMode; // require('material-ui/lib/svg-icon/social/party-mode');
    export import SocialPeople = __MaterialUI.SocialPeople; // require('material-ui/lib/svg-icon/social/people');
    export import SocialPeopleOutline = __MaterialUI.SocialPeopleOutline; // require('material-ui/lib/svg-icon/social/people-outline');
    export import SocialPersonAdd = __MaterialUI.SocialPersonAdd; // require('material-ui/lib/svg-icon/social/person-add');
    export import SocialPerson = __MaterialUI.SocialPerson; // require('material-ui/lib/svg-icon/social/person');
    export import SocialPersonOutline = __MaterialUI.SocialPersonOutline; // require('material-ui/lib/svg-icon/social/person-outline');
    export import SocialPlusOne = __MaterialUI.SocialPlusOne; // require('material-ui/lib/svg-icon/social/plus-one');
    export import SocialPoll = __MaterialUI.SocialPoll; // require('material-ui/lib/svg-icon/social/poll');
    export import SocialPublic = __MaterialUI.SocialPublic; // require('material-ui/lib/svg-icon/social/public');
    export import SocialSchool = __MaterialUI.SocialSchool; // require('material-ui/lib/svg-icon/social/school');
    export import SocialShare = __MaterialUI.SocialShare; // require('material-ui/lib/svg-icon/social/share');
    export import SocialWhatshot = __MaterialUI.SocialWhatshot; // require('material-ui/lib/svg-icon/social/whatshot');
    export import ToggleCheckBox = __MaterialUI.ToggleCheckBox; // require('material-ui/lib/svg-icon/toggle/check-box');
    export import ToggleCheckBoxOutlineBlank = __MaterialUI.ToggleCheckBoxOutlineBlank; // require('material-ui/lib/svg-icon/toggle/check-box-outline-blank');
    export import ToggleIndeterminateCheckBox = __MaterialUI.ToggleIndeterminateCheckBox; // require('material-ui/lib/svg-icon/toggle/indeterminate-check-box');
    export import ToggleRadioButtonChecked = __MaterialUI.ToggleRadioButtonChecked; // require('material-ui/lib/svg-icon/toggle/radio-button-checked');
    export import ToggleRadioButtonUnchecked = __MaterialUI.ToggleRadioButtonUnchecked; // require('material-ui/lib/svg-icon/toggle/radio-button-unchecked');
    export import ToggleStarBorder = __MaterialUI.ToggleStarBorder; // require('material-ui/lib/svg-icon/toggle/star-border');
    export import ToggleStarHalf = __MaterialUI.ToggleStarHalf; // require('material-ui/lib/svg-icon/toggle/star-half');
    export import ToggleStar = __MaterialUI.ToggleStar; // require('material-ui/lib/svg-icon/toggle/star');
