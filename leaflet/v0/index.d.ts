...
/**
  ...
  */
export function circle(latlng: LatLngExpression, radius: number, options?: PathOptions): Circle;
...
/**
  ...
  */
export function circleMarker(latlng: LatLngExpression, options?: PathOptions): CircleMarker;
...
export namespace Control {
    ...
    export interface Layers extends Control, IEventPowered<Layers> {
        /**
...
export namespace control {
    ...
    /**
      * Creates an attribution control.
      */
    export function attribution(options?: AttributionOptions): Control.Attribution;

    /**
        * Creates an attribution control with the given layers. Base layers will be
        * switched with radio buttons, while overlays will be switched with checkboxes.
        */
    export function layers(baseLayers?: any, overlays?: any, options?: LayersOptions): Control.Layers;

    /**
      * Creates an scale control with the given options.
      */
    export function scale(options?: ScaleOptions): Control.Scale;
}
...
/**
  ...
  */
export function featureGroup<T extends ILayer>(layers?: T[]): FeatureGroup<T>;
...
/**
  ...
  */
export function imageOverlay(imageUrl: string, bounds: LatLngBounds, options?: ImageOverlayOptions): ImageOverlay;
...
/**
  ...
  * and longitude.
  */
export function latLng(coords: LatLngExpression): LatLng;
...
/**
  ...
  */
export function latLngBounds(latlngs: LatLngBoundsExpression): LatLngBounds;
...
/**
  * Create a layer group, optionally given an initial set of layers.
  */
export function layerGroup<T extends ILayer>(layers?: T[]): LayerGroup<T>;
...
/**
  ...
  */
export function map(id: HTMLElement, options?: Map.MapOptions): Map;

/**
  * Instantiates a map object given a div element id and optionally an
  * object literal with map options described below.
  */
export function map(id: string, options?: Map.MapOptions): Map;
...
/**
  ...
  */
export function multiPolygon(latlngs: LatLng[][], options?: PolylineOptions): MultiPolygon;
...
/**
  ...
  */
export function multiPolyline(latlngs: LatLng[][], options?: PolylineOptions): MultiPolyline;
...
/**
  ...
  * the holes inside.
  */
export function polygon(latlngs: LatLngBoundsExpression, options?: PolylineOptions): Polygon;
...
/**
  ...
  */
export function polyline(latlngs: LatLngBoundsExpression, options?: PolylineOptions): Polyline;
...
/**
  ...
  */
export function popup(options?: PopupOptions, source?: any): Popup;
...
/**
  ...
  * optionally an options object.
  */
export function rectangle(bounds: LatLngBounds, options?: PathOptions): Rectangle;
...
export interface TileLayerFactory {
    ...
    /**
      * Instantiates a Canvas tile layer object given an options object (optionally).
      */
    canvas(options?: TileLayerOptions): TileLayer.Canvas;
}
