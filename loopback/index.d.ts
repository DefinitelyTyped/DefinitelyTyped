...
// declare interface ILoopbackAplication extends express.Application { };
...
declare class LoopBackApplication {
      ...
      static connector(name: string, connector: any): void;
      ...
      static dataSource(name: string, config: any): void;
      ...
      */
      ...
      static listen(port?: number, cb?: () => void): any;
      ...
      static model(Model: any|string, config: {dataSource: string|any, public?: boolean, relations?: any}): any;
      ...
      static middlewareFromConfig(factory: () => void, config: {phase: string, enabled?: boolean, params?: any[]|any, paths?: any[]|string|RegExp}): any;
      ...
      static defineMiddlewarePhases(nameOrArray: string|string[]): any;
      ...
      static middleware(name: string, paths?: any[]|string|RegExp, handler?: () => void): any;
}
...
declare function rewriteUserLiteral(): void;
...
declare class Change extends PersistedModel {
...
declare class RoleMapping extends PersistedModel {
...
declare class User extends PersistedModel {
